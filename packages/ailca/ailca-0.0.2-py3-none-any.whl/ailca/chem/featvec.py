...
def load_dataset(path_data_file: str,
    ...
    for i in iter_range:
        ...
        if idx_target is None:
            list_data.append(Data(x=feat_vec, dtype=DTYPE_FVEC))
        else:
            list_data.append(Data(x=feat_vec, y=data[i, idx_target], dtype=DTYPE_FVEC))

    return Dataset(list_data, idx_feat=idx_feat, idx_target=idx_target)
