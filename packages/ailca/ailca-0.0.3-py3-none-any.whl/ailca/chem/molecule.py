...
def load_dataset(path_data_file: str,
    ...
    for i in iter_range:
        ...
        if idx_target is None:
            list_data.append(Data(x=mol_graph, dtype=DTYPE_MSTRUCT))
        else:
            list_data.append(Data(x=mol_graph, y=data[i, idx_target], dtype=DTYPE_MSTRUCT))

    return Dataset(list_data, idx_smiles=idx_smiles, idx_target=idx_target, add_h=add_h)
