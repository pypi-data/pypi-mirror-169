...
def load_dataset(path_data_file: str,
    ...
    data = numpy.array(pandas.read_excel(path_data_file))
    ...
    for i in iter_range:
        ...
        if idx_target is None:
            list_data.append(Data(x=form_vec, dtype=DTYPE_FORM))
        else:
            list_data.append(Data(x=form_vec, y=data[i, idx_target], dtype=DTYPE_FORM))

    return Dataset(list_data, idx_form=idx_form, idx_target=idx_target, form_rep_type=form_rep_type)
