...
class AdminVisualSortableBaseMixin:
    ...
    ''' Admin Model mandatory if Inlines has Sortable Elements '''
...
class AdminVisualSortableMixin(AdminVisualSortableBaseMixin):
    ''' Admin Model for the Sortable Parent Model'''
    is_adminvisualsortable = True
    @property
...
class AdminVisualSortableTabbedMixin(AdminVisualSortableMixin):
    ''' Admin Model With Correct Template if Tabbed Admin is in Use '''
    is_adminvisualsortable = True
    change_form_template =  str(Path('tabbed_change_form.html'))

class AdminVisualSortableBaseTabbedMixin(AdminVisualSortableMixin):
    ''' Admin Model With Correct Template if Tabbed Admin is in Use '''
    is_adminvisualsortable = False
    change_form_template =  str(Path('tabbed_change_form.html'))
