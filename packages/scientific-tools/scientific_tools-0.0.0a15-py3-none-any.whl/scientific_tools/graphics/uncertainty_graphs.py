...
def plot_uncertainty_function(f, u_f, min_x, max_x, values_number, args_before_x=[], args_after_x=[], function_color='red', uncertainty_color='blue', function_linestyle="-", uncertainty_linestyle="-", title="", label_x="", label_y="", function_label="f(x)", uncertainty_label="f(x)±u(f(x))", **kwargs) :
    ...
    """
    plot_2Dfunction(f, min_x, max_x, values_number, args_before_x, args_after_x, color=function_color, linestyle =function_linestyle, title=title, label_x=label_x, label_y=label_y, function_label=function_label, **kwargs)#draw f
...
def plot_z_score_graph(f1, u_f1, f2, u_f2, min_x, max_x, values_nb, args_f1_before_x=[], args_f1_after_x=[], kwargs_f1={}, args_f2_before_x=[], args_f2_after_x=[], kwargs_f2={},z_score_limit=2, limit_color='red', z_score_color='blue', limit_linestyle="-", z_score_linestyle="-", title="", label_x="", label_y="", limit_label="Limits of z-score validity", z_score_label="Z-score") :
