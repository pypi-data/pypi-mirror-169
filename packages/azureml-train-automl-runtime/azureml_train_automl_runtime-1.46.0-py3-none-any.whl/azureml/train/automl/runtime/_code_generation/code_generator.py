...
def get_scriptrun_code(
    ...
    if(is_autofeaturization):
        ...
        function += get_save_mlflow_model_code('model', 'outputs/', 'outputs/')

    return function.generate_code()


def get_save_mlflow_model_code(model_name: str, output_dir: str, artifacts_path: str) -> List[str]:
    return ["cd = inference.get_conda_deps_as_dict(True)",
            "",
