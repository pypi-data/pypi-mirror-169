...
.. list-table:: Basic terms
   ...
   * - dw_biot
     ...
     - :ref:`bio.npb.lag <multi_physics-biot_npbc_lagrange>`, :ref:`the.ela <multi_physics-thermo_elasticity>`, :ref:`bio.npb <multi_physics-biot_npbc>`, :ref:`bio.sho.syn <multi_physics-biot_short_syntax>`, :ref:`bio <multi_physics-biot>`, :ref:`the.ela.ess <multi_physics-thermo_elasticity_ess>`
   * - ev_biot_stress
   ...
   * - dw_diffusion
     ...
     - .. math::
            \int_{\Omega} K_{ij} \nabla_i q \nabla_j p
     - :ref:`bio.npb.lag <multi_physics-biot_npbc_lagrange>`, :ref:`pie.ela <multi_physics-piezo_elasticity>`, :ref:`bio.npb <multi_physics-biot_npbc>`, :ref:`bio.sho.syn <multi_physics-biot_short_syntax>`, :ref:`poi.neu <diffusion-poisson_neumann>`, :ref:`bio <multi_physics-biot>`, :ref:`dar.flo.mul <diffusion-darcy_flow_multicomp>`
   ...
   * - dw_div_grad
     ...
     - :ref:`sta.nav.sto <navier_stokes-stabilized_navier_stokes>`, :ref:`sto.sli.bc <navier_stokes-stokes_slip_bc>`, :ref:`nav.sto.iga <navier_stokes-navier_stokes2d_iga>`, :ref:`nav.sto <navier_stokes-navier_stokes2d>`, :ref:`nav.sto <navier_stokes-navier_stokes>`, :ref:`sto <navier_stokes-stokes>`
   * - dw_dot
     ...
     - :ref:`sto.sli.bc <navier_stokes-stokes_slip_bc>`, :ref:`lin.ela.up <linear_elasticity-linear_elastic_up>`, :ref:`poi.per.bou.con <diffusion-poisson_periodic_boundary_condition>`, :ref:`bal <large_deformation-balloon>`, :ref:`ela <linear_elasticity-elastodynamic>`, :ref:`osc <quantum-oscillator>`, :ref:`aco <acoustics-acoustics3d>`, :ref:`lin.ela.dam <linear_elasticity-linear_elastic_damping>`, :ref:`hyd <quantum-hydrogen>`, :ref:`pie.ela <multi_physics-piezo_elasticity>`, :ref:`bor <quantum-boron>`, :ref:`adv.1D <dg-advection_1D>`, :ref:`poi.fun <diffusion-poisson_functions>`, :ref:`bur.2D <dg-burgers_2D>`, :ref:`adv.2D <dg-advection_2D>`, :ref:`tim.poi.exp <diffusion-time_poisson_explicit>`, :ref:`vib.aco <acoustics-vibro_acoustic3d>`, :ref:`wel <quantum-well>`, :ref:`tim.adv.dif <diffusion-time_advection_diffusion>`, :ref:`dar.flo.mul <diffusion-darcy_flow_multicomp>`, :ref:`the.ele <multi_physics-thermal_electric>`, :ref:`tim.poi <diffusion-time_poisson>`, :ref:`aco <acoustics-acoustics>`
   * - dw_elastic_wave
   ...
   * - dw_integrate
     ...
     - :ref:`aco <acoustics-acoustics3d>`, :ref:`poi.per.bou.con <diffusion-poisson_periodic_boundary_condition>`, :ref:`poi.neu <diffusion-poisson_neumann>`, :ref:`dar.flo.mul <diffusion-darcy_flow_multicomp>`, :ref:`aco <acoustics-acoustics>`, :ref:`vib.aco <acoustics-vibro_acoustic3d>`
   * - ev_integrate_mat
   ...
   * - dw_laplace
     ...
     - .. math::
            \int_{\Omega} c \nabla q \cdot \nabla p
     - :ref:`adv.dif.2D <dg-advection_diffusion_2D>`, :ref:`sto.sli.bc <navier_stokes-stokes_slip_bc>`, :ref:`poi.per.bou.con <diffusion-poisson_periodic_boundary_condition>`, :ref:`osc <quantum-oscillator>`, :ref:`poi.fie.dep.mat <diffusion-poisson_field_dependent_material>`, :ref:`aco <acoustics-acoustics3d>`, :ref:`hyd <quantum-hydrogen>`, :ref:`bor <quantum-boron>`, :ref:`poi.fun <diffusion-poisson_functions>`, :ref:`the.ela.ess <multi_physics-thermo_elasticity_ess>`, :ref:`bur.2D <dg-burgers_2D>`, :ref:`tim.poi.exp <diffusion-time_poisson_explicit>`, :ref:`sin <diffusion-sinbc>`, :ref:`lap.2D <dg-laplace_2D>`, :ref:`lap.tim.ebc <diffusion-laplace_time_ebcs>`, :ref:`vib.aco <acoustics-vibro_acoustic3d>`, :ref:`lap.cou.lcb <diffusion-laplace_coupling_lcbcs>`, :ref:`lap.flu.2d <diffusion-laplace_fluid_2d>`, :ref:`cub <diffusion-cube>`, :ref:`poi <diffusion-poisson>`, :ref:`wel <quantum-well>`, :ref:`tim.adv.dif <diffusion-time_advection_diffusion>`, :ref:`poi.par.stu <diffusion-poisson_parametric_study>`, :ref:`poi.iga <diffusion-poisson_iga>`, :ref:`the.ele <multi_physics-thermal_electric>`, :ref:`tim.poi <diffusion-time_poisson>`, :ref:`lap.1d <diffusion-laplace_1d>`, :ref:`poi.sho.syn <diffusion-poisson_short_syntax>`, :ref:`aco <acoustics-acoustics>`
   * - dw_lin_convect
   ...
   * - dw_lin_elastic
     ...
     - :ref:`lin.vis <linear_elasticity-linear_viscoelastic>`, :ref:`two.bod.con <linear_elasticity-two_bodies_contact>`, :ref:`lin.ela.iga <linear_elasticity-linear_elastic_iga>`, :ref:`bio.npb <multi_physics-biot_npbc>`, :ref:`lin.ela.up <linear_elasticity-linear_elastic_up>`, :ref:`ela.shi.per <linear_elasticity-elastic_shifted_periodic>`, :ref:`mat.non <linear_elasticity-material_nonlinearity>`, :ref:`ela <linear_elasticity-elastodynamic>`, :ref:`its.4 <linear_elasticity-its2D_4>`, :ref:`lin.ela.dam <linear_elasticity-linear_elastic_damping>`, :ref:`bio.npb.lag <multi_physics-biot_npbc_lagrange>`, :ref:`pie.ela <multi_physics-piezo_elasticity>`, :ref:`the.ela <multi_physics-thermo_elasticity>`, :ref:`bio <multi_physics-biot>`, :ref:`the.ela.ess <multi_physics-thermo_elasticity_ess>`, :ref:`lin.ela.mM <homogenization-linear_elastic_mM>`, :ref:`lin.ela <linear_elasticity-linear_elastic>`, :ref:`its.1 <linear_elasticity-its2D_1>`, :ref:`ela.con.sph <linear_elasticity-elastic_contact_sphere>`, :ref:`bio.sho.syn <multi_physics-biot_short_syntax>`, :ref:`ela.con.pla <linear_elasticity-elastic_contact_planes>`, :ref:`lin.ela.opt <homogenization-linear_elasticity_opt>`, :ref:`its.2 <linear_elasticity-its2D_2>`, :ref:`lin.ela.tra <linear_elasticity-linear_elastic_tractions>`, :ref:`com.ela.mat <large_deformation-compare_elastic_materials>`, :ref:`its.3 <linear_elasticity-its2D_3>`, :ref:`pie.ela.mac <multi_physics-piezo_elasticity_macro>`, :ref:`nod.lcb <linear_elasticity-nodal_lcbcs>`, :ref:`pre.fib <linear_elasticity-prestress_fibres>`
   * - dw_lin_elastic_iso
   ...
   * - dw_point_load
     ...
     - .. math::
           ...
           \mbox{ in a region }
     - :ref:`she.can <linear_elasticity-shell10x_cantilever>`, :ref:`its.2 <linear_elasticity-its2D_2>`, :ref:`its.1 <linear_elasticity-its2D_1>`, :ref:`its.3 <linear_elasticity-its2D_3>`, :ref:`its.4 <linear_elasticity-its2D_4>`
   * - dw_point_lspring
   ...
   * - dw_stokes
     ...
     - .. math::
           ...
           \cdot \ul{u}
     - :ref:`sta.nav.sto <navier_stokes-stabilized_navier_stokes>`, :ref:`sto.sli.bc <navier_stokes-stokes_slip_bc>`, :ref:`nav.sto.iga <navier_stokes-navier_stokes2d_iga>`, :ref:`nav.sto <navier_stokes-navier_stokes2d>`, :ref:`lin.ela.up <linear_elasticity-linear_elastic_up>`, :ref:`nav.sto <navier_stokes-navier_stokes>`, :ref:`sto <navier_stokes-stokes>`
   * - dw_stokes_wave
   ...
   * - dw_volume_lvf
     ...
     - .. math::
           ...
           \int_{\Omega} f q
     - :ref:`poi.iga <diffusion-poisson_iga>`, :ref:`adv.dif.2D <dg-advection_diffusion_2D>`, :ref:`bur.2D <dg-burgers_2D>`, :ref:`poi.par.stu <diffusion-poisson_parametric_study>`
   * - ev_volume_surface
...
.. list-table:: Large deformation terms
   ...
   * - dw_tl_he_neohook
     ...
     - .. math::
            \int_{\Omega} S_{ij}(\ul{u}) \delta E_{ij}(\ul{u};\ul{v})
     - :ref:`hyp <large_deformation-hyperelastic>`, :ref:`bal <large_deformation-balloon>`, :ref:`com.ela.mat <large_deformation-compare_elastic_materials>`, :ref:`per.tl <large_deformation-perfusion_tl>`, :ref:`act.fib <large_deformation-active_fibres>`
   * - dw_tl_he_ogden
