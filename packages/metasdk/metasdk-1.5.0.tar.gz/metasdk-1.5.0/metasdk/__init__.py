...
class MetaApp(object):
    ...
    def __init__(self, service_id: str = None, debug: bool = None,
        ...
        if os.environ.get("META_URL") is None:
            defaultEnvParamList.append("META_URL")
        if os.environ.get("API_PROXY_URL") is None:
            defaultEnvParamList.append("API_PROXY_URL")
        if os.environ.get("STARTER_URL") is None:
            defaultEnvParamList.append("STARTER_URL")
        if os.environ.get("GCLOUD_LOG_HOST_PORT") is None:
