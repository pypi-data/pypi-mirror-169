...
class AnalogIn(AbstractDwfDeviceSubApi):
    ...
    def triggerTypeInfo(self) -> List[DwfAnalogInTriggerType]:
        ...
        trigger_detector_type_list = [trigger_detector_type for trigger_detector_type in DwfAnalogInTriggerType
    ...
    def triggerFilterInfo(self) -> List[DwfAnalogInFilter]:
        ...
        trigger_detector_filter_list = [trigger_detector_filter for trigger_detector_filter in DwfAnalogInFilter
    ...
    def triggerHysteresisInfo(self) -> Tuple[float, float, int]:
        ...
        return (trigger_detector_hysteresis_min, trigger_detector_hysteresis_max, trigger_detector_hysteresis_num_steps)
    ...
    def triggerConditionInfo(self) -> List[DwfTriggerSlope]:
        ...
        trigger_detector_condition_list = [trigger_detector_condition for trigger_detector_condition in DwfTriggerSlope
    ...
    def triggerLengthConditionGet(self) -> DwfAnalogInTriggerLengthCondition:
        ...
        """
        c_trigger_detector_length_condition = typespec_ctypes.DwfAnalogInTriggerLengthCondition()
        result = self.lib.FDwfAnalogInTriggerLengthConditionGet(
            self.hdwf,
            c_trigger_detector_length_condition)
        if result != RESULT_SUCCESS:
            raise self.dwf.exception()
        trigger_detector_length_condition = DwfAnalogInTriggerLengthCondition(c_trigger_detector_length_condition.value)
        return trigger_detector_length_condition
