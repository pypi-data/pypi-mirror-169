...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListAlerts = channel.unary_unary(
                '/batchx.user.UserService/ListAlerts',
                request_serializer=user__pb2.ListAlertsRequest.SerializeToString,
                response_deserializer=user__pb2.ListAlertsResponse.FromString,
                )
...
def add_UserServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ListAlerts': grpc.unary_unary_rpc_method_handler(
                    servicer.ListAlerts,
                    request_deserializer=user__pb2.ListAlertsRequest.FromString,
                    response_serializer=user__pb2.ListAlertsResponse.SerializeToString,
            ),
    }
...
class UserService(object):
    ...
    def ListAlerts(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/batchx.user.UserService/ListAlerts',
            user__pb2.ListAlertsRequest.SerializeToString,
            user__pb2.ListAlertsResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
