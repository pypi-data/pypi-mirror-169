        ...
        if protocol == " ":
            ...
            if hex_dump == True:
                with open("hex dump.txt", "a") as file:
                    ...
                    offset_hex_tracker += 10
                    zeroes = ""
                    
                    if len(str(offset_hex_tracker)) == 1:
                        zeroes = "0000000"

                    if len(str(offset_hex_tracker)) == 2:
                        zeroes = "000000"

                    if len(str(offset_hex_tracker)) == 3:
                        zeroes = "00000"

                    if len(str(offset_hex_tracker)) == 4:
                        zeroes = "0000"

                    if len(str(offset_hex_tracker)) == 5:
                        zeroes = "000"

                    if len(str(offset_hex_tracker)) == 6:
                        zeroes = "00"

                    if len(str(offset_hex_tracker)) == 7:
                        zeroes = "0"

                    file.write(zeroes + str(offset_hex_tracker) + " " + result + "\n")
