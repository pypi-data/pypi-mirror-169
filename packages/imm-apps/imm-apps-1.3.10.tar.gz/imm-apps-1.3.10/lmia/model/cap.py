    ...
    def C(self):
        return len(
            [
                ...
                and not tfw.designated_position
            ]
        )
    ...
    def D(self):
        return len(
            [
                ...
                and (not tfw.pr_support_only_lmia or not tfw.designated_position)
            ]
        )
...
class CapModelE(CommonModel, CapModel):
    def __init__(
        self, excels=None, output_excel_file=None, language: str | None = None
    ):
