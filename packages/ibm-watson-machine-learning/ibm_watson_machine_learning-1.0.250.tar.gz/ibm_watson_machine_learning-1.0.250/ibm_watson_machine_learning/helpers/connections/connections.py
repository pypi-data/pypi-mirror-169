...
from ibm_watson_machine_learning.utils.autoai.enums import PredictionType, DataConnectionTypes, SamplingTypes
from ibm_watson_machine_learning.utils.autoai.errors import (
    ...
    InvalidCOSCredentials, MissingLocalAsset, InvalidIdType, NotWSDEnvironment,
...
class DataConnection(BaseDataConnection):
    ...
    def read(self,
        ...
        if sampling_type is None:
            sampling_type = DEFAULT_SAMPLING_TYPE if self.auto_pipeline_params.get('prediction_type') \
                                                     != PredictionType.FORECASTING else SamplingTypes.LAST_VALUES
        else:
