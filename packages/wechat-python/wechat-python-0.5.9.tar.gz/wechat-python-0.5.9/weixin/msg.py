...
from weixin.base import WeixinError
...
class WeixinMsg(object):
    ...
    def validate(self, signature, timestamp, nonce):
        print("signature: %s, timestamp: %s, nonce: %s" %
    ...
    def reply(self, username=None, type='text', sender=None, **kwargs):
        print("reply: username: %s, type: %s, sender: %s, kwargs: %s" %
              (username, type, sender, kwargs))
...
def text_reply(username, sender, content):
    print("username: %s, sender: %s, content: %s" %
...
def music_reply(username, sender, **kwargs):
    print("username: %s, sender: %s, kwargs: %s" % (username, sender, kwargs))
...
def news_reply(username, sender, *items):
    print("username: %s, sender: %s, items: %s" % (username, sender, items))
    item_template = (
        '<item>'
        '<Title><![CDATA[%(title)s]]></Title>'
        '<Description><![CDATA[%(description)s]]></Description>'
...
def image_reply(username, sender, media_id):
    print("username: %s, sender: %s, media_id: %s" %
          (username, sender, media_id))
...
def _shared_reply(username, sender, type):
    print("username: %s, sender: %s, type: %s" % (username, sender, type))
    dct = {
        'username': username,
        'sender': sender,
        'type': type,
