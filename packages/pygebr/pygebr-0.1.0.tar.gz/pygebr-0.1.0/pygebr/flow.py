...
def NewFromMenu(menulist, title, description="", filename="", par=None):
    """
    ...
    description: str (optional)
        One-line sentenc describing the new flow

    filename: str (optional)
        Filename to save the new flow

    par: dict
        Dictionary of variables to defined in local scope to evalute programs' parameters
    """
