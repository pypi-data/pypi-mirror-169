...
class graphinx:
    ...
    def volumen(self):
        vol = self.altura*self.anchura*self.longitud
        print("volume is " + str(vol))
      
    def area_tapa(self):
        tapa = self.anchura*self.longitud
        print("Area tapa is " + str(tapa))
      
    def area_lateral(self):
        lateral = self.altura*self.longitud
        print("Area lateral is " + str(lateral))
      
    def area_frontal(self):
        frontal = self.anchura*self.altura
        print("Area frontal is " + str(frontal))
...
def confussion_matrix_pretyy(cm, labels):
