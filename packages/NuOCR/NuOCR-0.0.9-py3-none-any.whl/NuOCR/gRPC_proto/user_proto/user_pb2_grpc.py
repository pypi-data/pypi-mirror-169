...
class UserControllerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ChangePassword = channel.unary_unary(
                ...
                request_serializer=user__proto_dot_user__pb2.PasswordRequest.SerializeToString,
                response_deserializer=user__proto_dot_user__pb2.User.FromString,
                )
        self.ChangeKey = channel.unary_unary(
                '/user_proto.UserController/ChangeKey',
                request_serializer=user__proto_dot_user__pb2.KeyRequest.SerializeToString,
                response_deserializer=user__proto_dot_user__pb2.User.FromString,
                )
...
def add_UserControllerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ChangePassword': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=user__proto_dot_user__pb2.PasswordRequest.FromString,
                    response_serializer=user__proto_dot_user__pb2.User.SerializeToString,
            ),
            'ChangeKey': grpc.unary_unary_rpc_method_handler(
                    servicer.ChangeKey,
                    request_deserializer=user__proto_dot_user__pb2.KeyRequest.FromString,
                    response_serializer=user__proto_dot_user__pb2.User.SerializeToString,
            ),
...
class UserController(object):
    ...
    def ChangePassword(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/user_proto.UserController/ChangePassword',
            user__proto_dot_user__pb2.PasswordRequest.SerializeToString,
            user__proto_dot_user__pb2.User.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def ChangeKey(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/user_proto.UserController/ChangeKey',
            user__proto_dot_user__pb2.KeyRequest.SerializeToString,
            user__proto_dot_user__pb2.User.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
