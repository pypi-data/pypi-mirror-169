    ...
    def OnMenubar(self,event:wx.CommandEvent):
        ...
        if id==wx.ID_OPEN:
            ...
            if '_left_' in zonename or '_right_' in zonename:
                ...
                msg = wx.MessageDialog(self,_('Left and Right polygons are detected \nWould you like to plot left and right polygons in the same plot ?'),style=wx.YES_NO|wx.YES_DEFAULT)
                ret=msg.ShowModal()
                msg.Destroy()
                if ret==wx.ID_NO:
