...
def post(connection: str,
    ...
    while req.status_code == 429 and number_of_attempts < 5:  # only try 5 times
        req = _post(f"{endpoint}?e={int(random.random() * 100)}",
                    json={
