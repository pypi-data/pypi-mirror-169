...
async def datasource_delete(ctx: Context, datasource_name: str, yes: bool):
    ...
    if yes or click.confirm(FeedbackManager.warning_confirm_delete_datasource(datasource=datasource_name, dependencies_information=dependencies_information)):
        try:
