...
class TaskScheduler(object):
    ...
    def __init__(self,
        ...
        self.jobs_key = self.project_name + ':apscheduler:jobs:' + str(uuid_number).strip() + str(os.getpid())
        self.run_times_key = self.project_name + ':apscheduler:run_times:' + str(uuid_number).strip() + str(os.getpid())
