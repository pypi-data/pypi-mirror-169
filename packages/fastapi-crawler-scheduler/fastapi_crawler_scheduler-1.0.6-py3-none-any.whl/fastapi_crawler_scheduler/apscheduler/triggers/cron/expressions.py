...
from fastapi_crawler_scheduler.apscheduler.util import asint
...
class AllExpression(object):
    ...
    def validate_range(self, field_name):
        from fastapi_crawler_scheduler.apscheduler.triggers.cron.fields import MIN_VALUES, MAX_VALUES
