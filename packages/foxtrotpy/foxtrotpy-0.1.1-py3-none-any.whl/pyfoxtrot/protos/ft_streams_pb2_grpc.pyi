...
class streamsServicer(metaclass=abc.ABCMeta):
    @abc.abstractmethod
    def CreateStreamThread(self,
        request: ft_streams_pb2.stream_thread_request,
        context: grpc.ServicerContext,
    ) -> ft_streams_pb2.stream_thread_response: ...

    @abc.abstractmethod
    def ListStreamThread(self,
        request: ft_types_pb2.empty,
        context: grpc.ServicerContext,
    ) -> ft_streams_pb2.streamthreadlist: ...

    @abc.abstractmethod
    def DestroyStreamThread(self,
        request: ft_streams_pb2.stream_thread_request,
        context: grpc.ServicerContext,
    ) -> ft_streams_pb2.stream_thread_response: ...
    ...
    def ReceiveStream(self,
        request: typing.Iterator[ft_streams_pb2.stream_control],
        context: grpc.ServicerContext,
    ) -> typing.Iterator[ft_capability_pb2.capability_response]: ...

    @abc.abstractmethod
    def DestroyStream(self,
        request: ft_streams_pb2.stream_registration_request,
        context: grpc.ServicerContext,
    ) -> ft_streams_pb2.stream_registration_response: ...

    @abc.abstractmethod
    def StreamFlagUpdates(self,
        request: typing.Iterator[ft_streams_pb2.stream_control],
        context: grpc.ServicerContext,
    ) -> typing.Iterator[ft_streams_pb2.serverflagupdate]: ...
