...
class authServicer(metaclass=abc.ABCMeta):
    @abc.abstractmethod
    def RequestAuthChallenge(self,
        request: ft_auth_pb2.auth_request,
        context: grpc.ServicerContext,
    ) -> ft_auth_pb2.auth_challenge: ...

    @abc.abstractmethod
    def RespondAuthChallenge(self,
        request: ft_auth_pb2.auth_response,
        context: grpc.ServicerContext,
    ) -> ft_auth_pb2.auth_confirm: ...

    @abc.abstractmethod
    def GetSupportedAuthMechanisms(self,
        request: ft_types_pb2.empty,
        context: grpc.ServicerContext,
    ) -> ft_auth_pb2.auth_type_list: ...

    @abc.abstractmethod
    def SaslAuthProcess(self,
        request: typing.Iterator[ft_auth_pb2.sasl_auth_data],
        context: grpc.ServicerContext,
    ) -> typing.Iterator[ft_auth_pb2.sasl_auth_data]: ...
