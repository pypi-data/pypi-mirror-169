...
class MPIEnvironment:
    ...
    # CAS-13683 work-around
    if is_mpi_enabled:
        if 'USE_SMALL_SUMMARYMINOR' not in os.environ:
            import sys
            print('Setting environment variable "USE_SMALL_SUMMARYMINOR" in MPIEnvironment.py', file=sys.stderr)
            os.environ['USE_SMALL_SUMMARYMINOR'] = 'true'
            print('os.environ["USE_SMALL_SUMMARYMINOR"]=' + os.environ["USE_SMALL_SUMMARYMINOR"], file=sys.stderr)
