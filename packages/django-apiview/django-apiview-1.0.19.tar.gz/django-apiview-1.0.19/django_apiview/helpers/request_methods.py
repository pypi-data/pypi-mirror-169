...
_default_allow_methods = get_setting_value("DJANGO_APIVIEW_DEFAULT_ALLOW_METHODS", ["get", "post"])
...
class RequestMethodCheckPlugin(ApiviewPluginBase):
    ...
    def __call__(self, _django_apiview_request):
        ...
        _django_apiview_allow_get = getattr(_django_apiview_func, "_django_apiview_allow_get", None)
        if _django_apiview_allow_get:
            _allow_methods.add("get")
        _django_apiview_allow_post = getattr(_django_apiview_func, "_django_apiview_allow_post", None)
        if _django_apiview_allow_post:
            _allow_methods.add("post")
        _django_apiview_allow_put = getattr(_django_apiview_func, "_django_apiview_allow_put", None)
        if _django_apiview_allow_put:
            _allow_methods.add("put")
        _django_apiview_allow_delete = getattr(_django_apiview_func, "_django_apiview_allow_delete", None)
        if _django_apiview_allow_delete:
            _allow_methods.add("delete")
        _django_apiview_allow_patch = getattr(_django_apiview_func, "_django_apiview_allow_patch", None)
        if _django_apiview_allow_patch:
            _allow_methods.add("patch")
        _django_apiview_allow_head = getattr(_django_apiview_func, "_django_apiview_allow_head", None)
        if _django_apiview_allow_head:
            _allow_methods.add("head")
        _django_apiview_allow_options = getattr(_django_apiview_func, "_django_apiview_allow_options", None)
