...
_django_apiview_packer = get_setting_value("DJANGO_APIVIEW_PACKER", SimpleJsonResultPacker)
_django_apiview_plugins = get_setting_value("DJANGO_APIVIEW_PLUGINS", [RequestMethodCheckPlugin])
...
apiview = Apiview(_django_apiview_packer, preload_plugins=_django_apiview_plugins, **_django_apiview_kwargs)
