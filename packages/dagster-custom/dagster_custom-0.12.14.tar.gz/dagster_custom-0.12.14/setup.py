...
if __name__ == "__main__":
    setup(
        ...
        install_requires=[
            ...
            "packaging>=20.9",
            "pendulum",
            "protobuf>=3.20.*",  # ensure version we require is >= that with which we generated the proto code (set in dev-requirements)
            "python-dateutil",
            "pytz",
        ...
        extras_require={
            ...
            "test": [
                ...
                "isort>=4.3.21,<5",
                "mock==3.0.5",
                "protobuf>=3.20.*", # without this, pip will install the most up-to-date protobuf
                "pylint==2.6.0",
                "pytest-cov==2.10.1",
