...
function create_fragment$1(ctx) {
	...
	return {
		c() {
			...
			attr(input0, "class", input0_class_value = "gr-box gr-input gr-text-input text-center h-6 " + /*classes*/ ctx[7]);
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*$$scope, label*/ 8224) {
				blocktitle_changes.$$scope = { dirty, ctx };
			}

			blocktitle.$set(blocktitle_changes);

			if (!current || dirty & /*classes*/ 128 && input0_class_value !== (input0_class_value = "gr-box gr-input gr-text-input text-center h-6 " + /*classes*/ ctx[7])) {
...
function instance$1($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		...
		if ($$self.$$.dirty & /*style*/ 512) {
			$$invalidate(7, { classes } = get_styles(style, ["rounded", "border"]), classes);
		}
	};
