...
class AssignedCharacteristicType(object):
    ...
    def __init__(self, maximum_occurrences=None, assigned_resource_id=None, assigned_resource_type=None, minimum_occurrences=None, system=None, read_only=None, id=None, local_vars_configuration=None):  # noqa: E501
