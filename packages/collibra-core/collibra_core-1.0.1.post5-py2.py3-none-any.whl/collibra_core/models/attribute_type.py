...
class AttributeType(object):
    ...
    def __init__(self, description=None, name=None, resource_type=None, last_modified_by=None, created_on=None, last_modified_on=None, created_by=None, system=None, id=None, local_vars_configuration=None):  # noqa: E501
