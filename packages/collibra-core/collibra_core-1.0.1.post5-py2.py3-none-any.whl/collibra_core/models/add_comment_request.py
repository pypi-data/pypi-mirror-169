...
class AddCommentRequest(object):
    ...
    def __init__(self, content=None, base_resource=None, parent_id=None, base_resource_type=None, base_resource_id=None, local_vars_configuration=None):  # noqa: E501
