...
class TestCase(*_TEST_BASE_CLASSES):
  ...
  def compute_max_gradient_error(self, f, args, delta=1e-3):
    ...
    def _compute_error():
      from tensorflow_probability.python.internal.backend.jax import private as gradient_checker_v2  # pylint: disable=g-direct-tensorflow-import,g-import-not-at-top
