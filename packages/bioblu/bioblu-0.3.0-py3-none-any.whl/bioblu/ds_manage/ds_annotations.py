...
def get_invalid_yolo_boxes(fdir, print_output=True) -> List[dict]:
    ...
    """
    materials_dict = create_fallback_yolo_materials_dict(fdir)
    logging.debug(f"Materials dict: {materials_dict}")
    invalid_bboxes = []
...
def set_all_yolo_classes_to_zero(fdir, exist_ok=False):
...
if __name__ == '__main__':
    ...
    set_all_yolo_classes_to_zero("/home/findux/Desktop/tests/")