...
class SekkayBot(commands.Bot):
    def __init__(self, device_id: str, account_id: str, secret: str, loop=asyncio.get_event_loop(), **kwargs) -> None:
        ...
        def get_random_code(self):
            return py_random.choice(self.creator_codes)

        def get_welcome(self):
            code = get_random_code(self)
            i = "WELCOME {DISPLAY_NAME} !\n" + f"Want FREE SKINS & BATTLE PASS ? \n 1. Invite 5 friends on this Lobby \n 2. Add me on Fortnite : {code}\n Want FREE SKINS & BATTLE PASS ? \n 1. Invite 5 friends on this Lobby \n 2. Add me on Fortnite : {code}\n Want FREE SKINS & BATTLE PASS ? \n 1. Invite 5 friends on this Lobby \n 2. Add me on Fortnite : {code}\n Want FREE SKINS & BATTLE PASS ? \n 1. Invite 5 friends on this Lobby \n 2. Add me on Fortnite : {code}\n Want FREE SKINS & BATTLE PASS ? \n 1. Invite 5 friends on this Lobby \n 2. Add me on Fortnite : {code}\n "
            return i

        self.welcome_message =  get_welcome(self)
