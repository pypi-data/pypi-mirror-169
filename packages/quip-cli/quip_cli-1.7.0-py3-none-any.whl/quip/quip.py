...
class Quip:
    ...
    def parse_arguments(self):
        ...
        parser_icon.add_argument('--sonarqube', action='store_true', help='create SonarQube Project')
        parser_icon.add_argument('name', nargs="?", help='name of the project')
    ...
    def create_external_systems(self):
        ...
        if jnks_config is not None:
            ...
            self.setup_jenkins(jnks, jnks_group_name, jnks_repository_name)
    ...
    def setup_jenkins(self, jnks, jnks_group_name, jnks_repository_name):
        ...
        if jnks.check_job_exists(jnks_group_name, jnks_repository_name):
            ...
            if yes_or_no("Do you want to create Jenkins Job?", default=True):
                jnks.create_job(jnks_group_name, jnks_repository_name, self.project_name)
