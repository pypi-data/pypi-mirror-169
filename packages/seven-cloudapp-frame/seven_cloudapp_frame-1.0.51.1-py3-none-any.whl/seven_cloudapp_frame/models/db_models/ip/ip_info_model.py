...
@LastEditTime: 2022-06-10 13:32:59
...
class IpInfo:
    ...
    def get_field_list(self):
        return ['id', 'app_id', 'act_id', 'ip_name', 'ip_type', 'ip_pic', 'show_pic', 'ip_summary', 'sort_index', 'is_release', 'is_del', 'del_date', 'create_date', 'modify_date']
