...
BROKER_WS_HTTP_ERR_CODE_TO_MSG = {
    429: "Reached the concurrent session limit, couldn't start Serverless Debugger.",
    401: "Authentication is failed, check your Serverless Debugger authentication token.",
...
def handle_close_message(code, message):
    if code is None and message is None:
        print("Serverless Debugger broker connection is closed")
    elif code:
        print("Serverless Debugger broker closed with code:{}".format(code))
    else:
        print("Serverless Debugger broker closed with code:{}, message:{}".format(code, message))
