...
'''
    ...
    def __print_help(self):
        ...
        for arg in args:
            ...
            if len(self.__get_arg_short(arg)) > 0:
                ...
                arg_short_help = f'{"": <4}'
            help_info += f'{arg_short_help}{"--"+self.__get_arg_long(arg): <20}{self.__get_arg_help(arg): <50}{required}\n'
        print(help_info)
        sys.exit(0)
    ...
    def __enabled(self, short_name = "", long_name = ""):
        ...
        return short_name in self.sys_short_args or long_name in self.sys_args
