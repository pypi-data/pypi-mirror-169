...
##################### bbac61fc53d9565e654e4da758072012 ##############################
...
class _listpartition:
    ...
    def __call__( self, vis='', createdict=False, listfile='' ):
        schema = {'vis': {'type': 'cReqPath', 'coerce': _coerce.expand_path}, 'createdict': {'type': 'cBool'}, 'listfile': {'type': 'cStr', 'coerce': _coerce.to_str}}
