...
##################### f295fbbea130340b2f16c00f35099047 ##############################
...
from .private.task_apparentsens import apparentsens as _apparentsens_t
...
class _apparentsens:
    """
    apparentsens ---- Imaging sensitivity estimataion
    ...
    _info_desc_ = """Imaging sensitivity estimataion"""

    def __call__( self, vis='', field='', spw='', intent='', selectdata=True, timerange='', uvrange='', antenna='', scan='', observation='', imsize=[ int(100) ], cell=[  ], stokes='I', specmode='mfs', weighting='natural', robust=float(0.5), npixels=int(0), uvtaper=[ '' ] ):
        ...
        doc = {'vis': vis, 'field': field, 'spw': spw, 'intent': intent, 'selectdata': selectdata, 'timerange': timerange, 'uvrange': uvrange, 'antenna': antenna, 'scan': scan, 'observation': observation, 'imsize': imsize, 'cell': cell, 'stokes': stokes, 'specmode': specmode, 'weighting': weighting, 'robust': robust, 'npixels': npixels, 'uvtaper': uvtaper}
