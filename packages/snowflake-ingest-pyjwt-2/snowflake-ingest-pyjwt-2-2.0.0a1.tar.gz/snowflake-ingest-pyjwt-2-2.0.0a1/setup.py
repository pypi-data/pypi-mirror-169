...
setup(
    ...
    version=__version__,
    description='''
    Unofficial & (hopefully) temporary fork of SnowflakeDB File Ingest SDK to allow use 
    of newer versions of PyJWT (>=2.0.0) & requests (>=2.24.0).
    ''',
    long_description=long_description,
    author='Joshua Skrzypek',
    author_email='jskrzypek@gmail.com',
