...
class BaseDescr:
    ...
    """
    def __init__(self, nested: str = None, doc=None):
        """
        Args:
    ...
    def _get_object(self, obj: object) -> object:
        ...
        if self.nested is None:
            ...
            if obj is None:
                return self
            return obj[self.public_name]

        nestedObj = self.__traverse_nested_objects(obj)

        return nestedObj[self.public_name]
    ...
    def _set_object(self, obj: object, value: object) -> None:
        ...
        """
        if self.nested is None:
            return obj._set_item(self.public_name, value)
        ...
        if desc is not None:
            ...
            nestedObj[self.public_name] = value
