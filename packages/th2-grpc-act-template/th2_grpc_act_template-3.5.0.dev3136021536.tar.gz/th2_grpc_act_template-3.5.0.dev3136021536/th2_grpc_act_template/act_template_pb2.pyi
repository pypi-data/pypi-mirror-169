...
class PlaceSecurityListResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["checkpoint_id",b"checkpoint_id","status",b"status"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["checkpoint_id",b"checkpoint_id","securityListDictionary",b"securityListDictionary","status",b"status"]) -> None: ...
