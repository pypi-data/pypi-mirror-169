...
class ExcelRenderer:
    ...
    global res
    res = ''
    def __init__(self, analysis_run, tenantId, client_name, excel_data, report_gen_start_time, report_gen_completed_time):
        """
    ...
    def generate_summary(self, res, tenantId, client_name, report_gen_start_time, report_gen_completed_time):
        """
        add summary sheet
        """
        ws = self.wb.active
        ...
        client_res = client_name[0]['client_names']
    ...
    def render(self):
        ...
        self.generate_summary(res, tenantId, client_name, report_gen_start_time, report_gen_completed_time)
