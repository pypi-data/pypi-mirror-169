...
# =============================================================================
    ...
    Nqs, kpoints_scal, kpoints = util.get_kgrid(interp,interp,interp, Hk)
    N1N2N3_k = interp*interp*interp
    Nqs_irr, irr_ks, irr_ks_sc, weights, permutation_types = util.get_irr_ks(kpoints, kpoints_scal)    
    for i in range(Nqs_irr):
        k = irr_ks[i]
        weight = weights[i]
