    ...
    try:
        ...
        for query in queries:
            if type(query) in (list, tuple, set):
                for q in query:
                    result = cursor.execute(query_replace(q, is_replace_none_to_null=is_replace_none_to_null, is_replace_none_to_blank=is_replace_none_to_blank, is_replace_blank_to_null=is_replace_blank_to_null, is_replace_blank_none_to_null=is_replace_blank_none_to_null))
            else:
                result = cursor.execute(query_replace(query, is_replace_none_to_null=is_replace_none_to_null, is_replace_none_to_blank=is_replace_none_to_blank, is_replace_blank_to_null=is_replace_blank_to_null, is_replace_blank_none_to_null=is_replace_blank_none_to_null))
        conn.commit()
        return True, result
    except Exception as e:
        if conn is not None:
