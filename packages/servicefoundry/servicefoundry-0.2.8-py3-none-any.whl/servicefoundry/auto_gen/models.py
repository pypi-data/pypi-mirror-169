...
#   timestamp: 2022-09-27T05:52:09+00:00
...
class InstanceConfig(BaseModel):
    instance_family: List[str] = Field(
        ...,
        description="+usage=Instance family of the underlying machine to use - https://aws.amazon.com/ec2/instance-types/.\nMultiple instance families can be supplied. The workload is guranteed to be scheduled on one of them.\nExample:- `C6i`, `C4`, `R5`, etc.",
    )
