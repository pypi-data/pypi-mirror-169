...
with codecs.open(r"C:\Users\Gamer\anaconda3\envs\dfdir\_tmp_PyGitUpload_000017\README.md", encoding="utf-8") as fh:
    long_description = "\n" + fh.read()

VERSION = '0.1'
DESCRIPTION = "Library to handle any nested iterable (list, tuple, dict, json, etc.) in Pandas - no matter how deep it is nested!"
...
setup(
    ...
    keywords=['iter', 'nested', 'iterable', 'flatten', 'lists of lists', 'flatten json', 'pandas', 'numpy', 'explode', 'squeeze'],
