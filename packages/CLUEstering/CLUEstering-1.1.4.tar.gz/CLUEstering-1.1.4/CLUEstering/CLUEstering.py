...
try:
	...
	print('The CLUEsteringCPP module is missing. \nYou have to clone the GitHub repo "git@github.com:SimonB00/CLUEstering.git" and inside it run the "pip install ." command.')
