...
max_date = m_date.max_date[0].strftime('%Y-%m-%d')
...
truncate_q = f""" DELETE FROM {table_name1_pg} where exists (select patient_id from dexter_medicine_suggestion_update)"""
