...
set_target_properties(octomath PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/liboctomath.1.9.8.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/liboctomath.1.9.dylib"
  )

list(APPEND _cmake_import_check_targets octomath )
list(APPEND _cmake_import_check_files_for_octomath "${_IMPORT_PREFIX}/lib/liboctomath.1.9.8.dylib" )
...
set_target_properties(octomap PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/liboctomap.1.9.8.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/liboctomap.1.9.dylib"
  )

list(APPEND _cmake_import_check_targets octomap )
list(APPEND _cmake_import_check_files_for_octomap "${_IMPORT_PREFIX}/lib/liboctomap.1.9.8.dylib" )
