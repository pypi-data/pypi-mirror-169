...
def bool_from_env(key: str, default: bool):
...
_azure_credential = DefaultAzureCredential(
    exclude_cli_credential=bool_from_env("AZURE_EXCLUDE_CLI_CREDENTIAL", False),
    exclude_environment_credential=bool_from_env("AZURE_EXCLUDE_ENVIRONMENT_CREDENTIAL", False),
    exclude_managed_identity_credential=bool_from_env("AZURE_EXCLUDE_MANAGED_IDENTITY_CREDENTIAL", False),
    exclude_powershell_credential=bool_from_env("AZURE_EXCLUDE_POWERSHELL_CREDENTIAL", False),
    exclude_visual_studio_code_credential=bool_from_env("AZURE_VISUAL_STUDIO_CODE_CREDENTIAL", True),
    exclude_shared_token_cache_credential=bool_from_env("AZURE_SHARED_TOKEN_CACHE_CREDENTIAL", False),
    exclude_interactive_browser_credential=bool_from_env("AZURE_INTERACTIVE_BROWSER_CREDENTIAL", True),
)
