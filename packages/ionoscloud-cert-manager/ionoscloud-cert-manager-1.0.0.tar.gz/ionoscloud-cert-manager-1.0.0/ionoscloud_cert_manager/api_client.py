...
import ionoscloud_cert_manager.models
from ionoscloud_cert_manager import rest
from ionoscloud_cert_manager.exceptions import ApiValueError, ApiException, ApiFailedRequest, ApiTimeout
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'ionos-cloud-sdk-python/v1.0.0'
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(ionoscloud_cert_manager.models, klass)
