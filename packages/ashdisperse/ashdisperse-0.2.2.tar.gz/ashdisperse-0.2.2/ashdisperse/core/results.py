...
from ..mapping import (BindColormap, add_north_arrow, add_scale_bar,
                       add_stamen_basemap, ax_ticks, latlon_to_utm_epsg,
...
class AshDisperseResult:
    ...
    def to_netcdf(self, filename="AshDisperse.nc", engine='hdf5' compress=True, complevel=5):
        da = xa.Dataset(
            data_vars=dict(
