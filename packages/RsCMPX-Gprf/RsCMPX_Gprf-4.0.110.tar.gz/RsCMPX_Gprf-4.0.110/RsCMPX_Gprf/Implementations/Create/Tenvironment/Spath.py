...
class SpathCls:
	...
	def set(self, name_signal_path: str, name_antenna: str, name_connector: List[str]) -> None:
		...
		"""
		param = ArgSingleList().compose_cmd_string(ArgSingle('name_signal_path', name_signal_path, DataType.String), ArgSingle('name_antenna', name_antenna, DataType.String), ArgSingle.as_open_list('name_connector', name_connector, DataType.StringList, None))
