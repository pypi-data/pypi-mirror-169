...
class AmbientCls:
	...
	def get(self, all_py: enums.Scope = None) -> GetStruct:
		"""SCPI: SENSe:BASE:TEMPerature:OPERating:AMBient \n
		Snippet: value: GetStruct = driver.sense.base.temperature.operating.ambient.get(all_py = enums.Scope.ALL) \n
		No command help available \n
			:param all_py: No help available
			:return: structure: for return value, see the help for GetStruct structure arguments."""
		param = ArgSingleList().compose_cmd_string(ArgSingle('all_py', all_py, DataType.Enum, enums.Scope, is_optional=True))
