...
class OfrequencyCls:
	...
	def set(self, frequency: float, frequencySource=repcap.FrequencySource.Default) -> None:
		...
		Selects a positive or negative offset frequency. The frequency of the modulated signal is equal to the base frequency
		(see method RsCMPX_Gprf.Source.Gprf.Generator.RfSettings.frequency) plus the offset frequency. \n
