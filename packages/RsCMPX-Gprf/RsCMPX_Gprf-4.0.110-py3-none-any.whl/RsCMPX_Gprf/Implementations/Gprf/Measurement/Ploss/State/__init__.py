...
class StateCls:
	...
	def fetch(self) -> enums.ResourceState:
		...
		Snippet: value: enums.ResourceState = driver.gprf.measurement.ploss.state.fetch() \n
		No command help available \n
			:return: meas_state: No help available"""
		response = self._core.io.query_str(f'FETCh:GPRF:MEASurement<Instance>:PLOSs:STATe?')
