...
# La somme effectivement mise en répartition au profit des communes de métropole s'élève à
# 2 164 552 909 €
dsu_effective_2019 = 2_164_552_909
# La somme effectivement mise en répartition au profit des communes de métropole s'élève à
# 2 244 240 555 €
dsu_effective_2020 = 2_079_328_714
# La somme effectivement mise en répartition au profit des communes de métropole s'élève à
# 2 320 959 120 €
dsu_effective_2021 = 2_320_959_120
dsu_accroissement_2020 = 90_000_000
dsu_accroissement_2021 = 90_000_000

pourcentage_accroissement_dsu_2020 = (dsu_effective_2019 - dsu_effective_2020) / dsu_accroissement_2020
...
class dsu_montant_total(Variable):
    ...
    def formula_2021_01(commune, period, parameters):
        ...
        return montants_an_precedent + accroissement * pourcentage_accroissement_dsu_2021

    def formula_2020_01(commune, period, parameters):
        montants_an_precedent = commune('dsu_montant_total', period.last_year)
        accroissement = parameters(period).dotation_solidarite_urbaine.augmentation_montant
        return montants_an_precedent + accroissement * pourcentage_accroissement_dsu_2020
