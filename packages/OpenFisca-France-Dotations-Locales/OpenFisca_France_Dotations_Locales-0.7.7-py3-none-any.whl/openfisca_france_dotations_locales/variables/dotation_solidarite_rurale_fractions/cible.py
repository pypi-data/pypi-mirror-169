...
# TODO: Sortir les montants dans des fichiers YAML en utilisant les parametres OpenFisca
# Identifier les communes nouvelles et radie : en comparant le fichier de cette annee vs celui de l'an dernier.
# wikipedia et data.gouv.fr
accroissement_dsr_2019 = 90_000_000
accroissement_dsr_2020 = 90_000_000
accroissement_dsr_2021 = 90_000_000

# 323 780 451 € au titre de la fraction
# « cible » (13,43 %) pour l’année 2019.
dsr_fraction_cible_2019 = 323_780_451
# 360 336 634 € au titre de la fraction « cible » (soit une hausse de 11,29 %) pour l’année
# 2020. Source : note_dinformation_2020_dsr.pdf
dsr_fraction_cible_2020 = 360_336_634
# 395 878 229€ au titre de la fraction « cible » (soit une hausse de 9,86 %) pour l’année
# 2021. Source : note_dinformation_2021_dsr.pdf page 2
dsr_fraction_cible_2021 = 395_878_229
pourcentage_accroissement_dsr_cible_2020 = (dsr_fraction_cible_2020 - dsr_fraction_cible_2019) / accroissement_dsr_2020
pourcentage_accroissement_dsr_cible_2021 = (dsr_fraction_cible_2021 - dsr_fraction_cible_2020) / accroissement_dsr_2021
...
class dsr_montant_total_fraction_cible(Variable):
    ...
    def formula_2020_01(commune, period, parameters):
        ...
        return montants_an_precedent + accroissement * pourcentage_accroissement_dsr_cible_2020

    def formula_2021_01(commune, period, parameters):
        montants_an_precedent = commune('dsr_montant_total_fraction_cible', period.last_year)
        accroissement = parameters(period).dotation_solidarite_rurale.augmentation_montant
        return montants_an_precedent + accroissement * pourcentage_accroissement_dsr_cible_2021
