...
# 653 174 468 € au titre de la fraction « péréquation »
dsr_fraction_pq_2020 = 653_174_468
dsr_fraction_pq_2019 = 645_050_872
# Source : note_dinformation_2021_dsr.pdf page 2
dsr_fraction_pq_2021 = 661_072_600
pourcentage_accroissement_dsr_pq_2020 = (dsr_fraction_pq_2020 - dsr_fraction_pq_2019) / accroissement_dsr_2020
pourcentage_accroissement_dsr_pq_2021 = (dsr_fraction_pq_2021 - dsr_fraction_pq_2020) / accroissement_dsr_2021
...
class dsr_montant_total_fraction_perequation(Variable):
    ...
    def formula_2020_01(commune, period, parameters):
        ...
        return montants_an_precedent + accroissement * pourcentage_accroissement_dsr_pq_2020

    def formula_2021_01(commune, period, parameters):
        montants_an_precedent = commune('dsr_montant_total_fraction_perequation', period.last_year)
        accroissement = parameters(period).dotation_solidarite_rurale.augmentation_montant
        return montants_an_precedent + accroissement * pourcentage_accroissement_dsr_pq_2021
