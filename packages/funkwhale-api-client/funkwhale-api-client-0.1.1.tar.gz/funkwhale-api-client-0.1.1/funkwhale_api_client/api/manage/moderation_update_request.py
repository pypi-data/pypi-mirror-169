...
from ...models.manage_user_request_request import ManageUserRequestRequest
...
def _get_kwargs(
    ...
    *,
    ...
    form_data: ManageUserRequestRequest,
    multipart_data: ManageUserRequestRequest,
    json_body: ManageUserRequestRequest,
) -> Dict[str, Any]:
