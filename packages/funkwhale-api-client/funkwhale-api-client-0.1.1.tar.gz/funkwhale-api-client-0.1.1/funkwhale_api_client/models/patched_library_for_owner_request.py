...
T = TypeVar("T", bound="PatchedLibraryForOwnerRequest")


@attr.s(auto_attribs=True)
class PatchedLibraryForOwnerRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        patched_library_for_owner_request = cls(
            name=name,
            description=description,
            privacy_level=privacy_level,
        )

        patched_library_for_owner_request.additional_properties = d
        return patched_library_for_owner_request
