...
from ...models.patched_manage_report_request import PatchedManageReportRequest
...
def _get_kwargs(
    ...
    *,
    ...
    form_data: PatchedManageReportRequest,
    multipart_data: PatchedManageReportRequest,
    json_body: PatchedManageReportRequest,
) -> Dict[str, Any]:
