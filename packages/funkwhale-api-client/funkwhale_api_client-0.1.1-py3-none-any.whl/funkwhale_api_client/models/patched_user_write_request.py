...
T = TypeVar("T", bound="PatchedUserWriteRequest")


@attr.s(auto_attribs=True)
class PatchedUserWriteRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        patched_user_write_request = cls(
            name=name,
        ...
        patched_user_write_request.additional_properties = d
        return patched_user_write_request
