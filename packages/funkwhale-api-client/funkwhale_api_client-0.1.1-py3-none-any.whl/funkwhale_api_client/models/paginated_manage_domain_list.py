...
class PaginatedManageDomainList:
    ...
    Attributes:
        ...
        results (Union[Unset, List[ManageDomain]]):
    """

    count: Union[Unset, int] = UNSET
    next_: Union[Unset, None, str] = UNSET
    previous: Union[Unset, None, str] = UNSET
    results: Union[Unset, List[ManageDomain]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for results_item_data in _results or []:
            results_item = ManageDomain.from_dict(results_item_data)

            results.append(results_item)

        paginated_manage_domain_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
        ...
        paginated_manage_domain_list.additional_properties = d
        return paginated_manage_domain_list
