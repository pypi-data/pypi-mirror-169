...
from ..models.manage_domain_update_nodeinfo import ManageDomainUpdateNodeinfo
from ..types import UNSET, Unset

T = TypeVar("T", bound="ManageDomainUpdate")


@attr.s(auto_attribs=True)
class ManageDomainUpdate:
    """
    Attributes:
        name (str):
        ...
        nodeinfo (ManageDomainUpdateNodeinfo):
        instance_policy (int):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        nodeinfo = ManageDomainUpdateNodeinfo.from_dict(d.pop("nodeinfo"))
        ...
        manage_domain_update.additional_properties = d
        return manage_domain_update
