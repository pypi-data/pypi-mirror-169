...
T = TypeVar("T", bound="ManageTrackAlbumRequest")


@attr.s(auto_attribs=True)
class ManageTrackAlbumRequest:
    """
    Attributes:
        title (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        manage_track_album_request = cls(
            title=title,
            cover=cover,
            domain=domain,
            artist=artist,
        ...
        manage_track_album_request.additional_properties = d
        return manage_track_album_request
