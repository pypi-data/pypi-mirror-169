...
from ...models.manage_domain_request import ManageDomainRequest
...
def _get_kwargs(
    *,
    ...
    form_data: ManageDomainRequest,
    multipart_data: ManageDomainRequest,
    json_body: ManageDomainRequest,
) -> Dict[str, Any]:
    url = "{}/api/v1/manage/federation/domains/action/".format(client.base_url)
