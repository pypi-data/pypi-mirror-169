...
from ...models.patched_manage_instance_policy_request import PatchedManageInstancePolicyRequest
...
def _get_kwargs(
    ...
    *,
    ...
    form_data: PatchedManageInstancePolicyRequest,
    multipart_data: PatchedManageInstancePolicyRequest,
    json_body: PatchedManageInstancePolicyRequest,
) -> Dict[str, Any]:
