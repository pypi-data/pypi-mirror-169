...
def _get_kwargs(
    *,
    ...
    url = "{}/api/v1/tracks/".format(client.base_url)
...
def _parse_response(*, response: httpx.Response) -> Optional[PaginatedTrackList]:
    if response.status_code == 200:
        response_200 = PaginatedTrackList.from_dict(response.json())

        return response_200
    return None


def _build_response(*, response: httpx.Response) -> Response[PaginatedTrackList]:
    return Response(
