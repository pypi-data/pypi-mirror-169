...
T = TypeVar("T", bound="PaginatedArtistWithAlbumsList")


@attr.s(auto_attribs=True)
class PaginatedArtistWithAlbumsList:
    """
    Attributes:
        ...
        results (Union[Unset, List[ArtistWithAlbums]]):
    """

    count: Union[Unset, int] = UNSET
    next_: Union[Unset, None, str] = UNSET
    previous: Union[Unset, None, str] = UNSET
    results: Union[Unset, List[ArtistWithAlbums]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        paginated_artist_with_albums_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
        ...
        paginated_artist_with_albums_list.additional_properties = d
        return paginated_artist_with_albums_list
