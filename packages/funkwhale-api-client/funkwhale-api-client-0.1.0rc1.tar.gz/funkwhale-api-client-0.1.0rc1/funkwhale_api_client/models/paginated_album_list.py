...
T = TypeVar("T", bound="PaginatedAlbumList")


@attr.s(auto_attribs=True)
class PaginatedAlbumList:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        paginated_album_list.additional_properties = d
        return paginated_album_list
