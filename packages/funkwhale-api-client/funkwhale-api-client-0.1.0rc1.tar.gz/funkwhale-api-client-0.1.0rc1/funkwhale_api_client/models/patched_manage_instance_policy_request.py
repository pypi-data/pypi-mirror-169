...
T = TypeVar("T", bound="PatchedManageInstancePolicyRequest")


@attr.s(auto_attribs=True)
class PatchedManageInstancePolicyRequest:
    """
    Attributes:
        target (Union[Unset, ManageTargetRequest]):
    ...
    target: Union[Unset, ManageTargetRequest] = UNSET
    ...
    def to_multipart(self) -> Dict[str, Any]:
        target: Union[Unset, Tuple[None, bytes, str]] = UNSET
        if not isinstance(self.target, Unset):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_target, Unset):
            ...
            target = ManageTargetRequest.from_dict(_target)
        ...
        patched_manage_instance_policy_request = cls(
            target=target,
            summary=summary,
            is_active=is_active,
            block_all=block_all,
        ...
        patched_manage_instance_policy_request.additional_properties = d
        return patched_manage_instance_policy_request
