...
T = TypeVar("T", bound="ManageNestedTrack")


@attr.s(auto_attribs=True)
class ManageNestedTrack:
    """
    Attributes:
        id (int):
        title (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        manage_nested_track.additional_properties = d
        return manage_nested_track
