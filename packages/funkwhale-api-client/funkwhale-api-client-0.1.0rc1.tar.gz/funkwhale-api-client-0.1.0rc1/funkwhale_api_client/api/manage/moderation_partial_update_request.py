...
from ...models.patched_manage_user_request_request import PatchedManageUserRequestRequest
...
def _get_kwargs(
    ...
    *,
    ...
    form_data: PatchedManageUserRequestRequest,
    multipart_data: PatchedManageUserRequestRequest,
    json_body: PatchedManageUserRequestRequest,
) -> Dict[str, Any]:
