...
class TencentCOSStorage(Storage):
    ...
    def __init__(self, bucket=None, root_path=None, config=None):
        ...
        self.upload_part_size = setting.get("UPLOAD_PART_SIZE", 1)
        self.upload_max_thread = setting.get("UPLOAD_MAX_THREAD", 20)
        self.upload_enable_md5 = setting.get("UPLOAD_ENABLE_MD5", False)
    ...
    def _save(self, name, content):
        ...
        if self.upload_enable_md5 is not None:
            upload_kwargs["EnableMD5"] = self.upload_enable_md5
