...
class TakemeClient:
    ...
    def verify_user(self, akta_url, npwp_url, nib_url, identity_url, nik, legal_name, legal_address, user_id):
        endpoint = "user/verify"

        akta = open(akta_url, 'rb')
        npwp = open(npwp_url, 'rb')
        nib = open(nib_url, 'rb')
        identity = open(identity_url, 'rb')
