...
print("")
instance = (1,1,1,1)
explainer = Explainer.ExplainerRandomForest(forest, instance=instance)
            Explainer.BoostedTrees    
...
for c in minimal_contrastives:
  assert explainer.is_contrastive(c), "..."
...
minimal = explainer.minimal_sufficient_reason()
print("minimal:", minimal)
assert minimal == (-4, ), "The minimal reason is not good !" # It is the good minimal, a little mistake in the paper. 
