...
for sufficient in sufficient_reasons:
  assert explainer.is_sufficient(sufficient), "This is have to be a sufficient reason !"

minimals = explainer.minimal_sufficient_reason(n=Explainer.ALL)
print("Minimal sufficient reasons:", minimals)
assert minimals == (1, 4), "The minimal sufficient reasons are not good !"

preferred_reasons = explainer.preferred_reason(method=Explainer.MINIMAL, n=Explainer.ALL)
print("\npreferred reasons:", preferred_reasons)
assert explainer.is_sufficient(preferred_reasons), "..."
...
contrastives2 = explainer.contrastive_reason_maxsat(n=Explainer.ALL)
print("Contrastives2:", contrastives2)
