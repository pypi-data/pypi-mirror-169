...
class Binomial(Distribution):
    ...
    Attributes:
        ...
        data (list of floats) a list of numbers extracted from the data file
        p (float) probability of an event occuring
        n (float) number of binomial trials
    """
    ...
    def calculate_stdev(self):
        ...
        """
        Method to calculate the standard deviation of the distribution from p and n
    ...
    def pdf(self, k):
        ...
        num_1 = math.factorial(self.n) / (math.factorial(k) * (math.factorial(self.n - k)))
        num_2 = (self.p ** k) * (1 - self.p) ** (self.n - k)
