...
class DefaultApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.dump_data_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [],
                'endpoint_path': '/api/v1/',
                'operation_id': 'dump_data',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def dump_data(
        ...
        **kwargs
        ...
        >>> thread = api.dump_data(data, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['data'] = \
            data
        return self.dump_data_endpoint.call_with_http_info(**kwargs)
