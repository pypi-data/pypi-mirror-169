...
class RepositoriesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_repository_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [],
                'endpoint_path': '/api/v1/repositories/{id}',
        ...
        self.read_repository_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [],
                'endpoint_path': '/api/v1/repositories/',
                'operation_id': 'read_repository',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.read_repository_id_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [],
                'endpoint_path': '/api/v1/repositories/{id}',
                'operation_id': 'read_repository_id',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.update_repository_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [],
                'endpoint_path': '/api/v1/repositories/{id}',
    ...
    def create_repository(
        ...
        **kwargs
        ...
        >>> thread = api.create_repository(repository_create, async_req=True)
        >>> result = thread.get()
    ...
    def delete_repository(
        ...
        **kwargs
        ...
        >>> thread = api.delete_repository(id, async_req=True)
        >>> result = thread.get()
    ...
    def read_repository(
        ...
        **kwargs
        ...
        >>> thread = api.read_repository(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.read_repository_endpoint.call_with_http_info(**kwargs)
    ...
    def read_repository_id(
        ...
        **kwargs
        ...
        >>> thread = api.read_repository_id(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.read_repository_id_endpoint.call_with_http_info(**kwargs)
    ...
    def update_repository(
        ...
        **kwargs
        ...
        >>> thread = api.update_repository(id, repository_update, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        kwargs['repository_update'] = \
            repository_update
        return self.update_repository_endpoint.call_with_http_info(**kwargs)
