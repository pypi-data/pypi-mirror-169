...
class ProjectsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.read_project_id_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [],
                'endpoint_path': '/api/v1/projects/{id}',
                'operation_id': 'read_project_id',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def read_project(
        ...
        **kwargs
        ...
        >>> thread = api.read_project(async_req=True)
        >>> result = thread.get()
    ...
    def read_project_id(
        ...
        **kwargs
        ...
        >>> thread = api.read_project_id(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.read_project_id_endpoint.call_with_http_info(**kwargs)
    ...
    def update_project(
        ...
        **kwargs
        ...
        >>> thread = api.update_project(id, project_group_update, async_req=True)
        >>> result = thread.get()
