...
class FinFlotransition():
    ...
    def __init__(self, action :str  , type : str , t_id : str , source : str ,interim : str , target : str , *args, **kwargs) -> None :
    ...
    def get_record_datas(self):
        ...
        try:
            ...
            for iter in work_model:
                ...
                # print(gets_model)
                try:
                    datas = gets_model.objects.filter(id = overall_model.workflowitems.transitionmanager.t_id).first()
    ...
    def manualtransitions(self):
        try:
            ...
            workevents.objects.create(workflowitems = wf , event_user=get_current_user(),  initial_state=self.source  , 
                    interim_state = self.interim , final_state=self.target ,type=self.type.upper() , record_datas = self.get_record_datas())
        except:
            return None  
