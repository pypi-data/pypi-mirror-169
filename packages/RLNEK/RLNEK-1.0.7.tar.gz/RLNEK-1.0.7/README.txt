...
Test files:
Data files to test the functionality of RLNEK are provided in the "RLNEK_tests" folder. Module_0A_test contains files to be used to test Module_0A, Module_0B_test contains files to be used to test Module_0B, etc.
