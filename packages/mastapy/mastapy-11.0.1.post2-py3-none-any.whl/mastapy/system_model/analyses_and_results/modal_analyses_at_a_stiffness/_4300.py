...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4299, _4298, _4241
...
class HypoidGearSetModalAnalysisAtAStiffness(_4241.AGMAGleasonConicalGearSetModalAnalysisAtAStiffness):
    ...
    @property
    def hypoid_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4299.HypoidGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsModalAnalysisAtAStiffness, constructor.new(_4299.HypoidGearModalAnalysisAtAStiffness))
        return value

    @property
    def hypoid_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4298.HypoidGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesModalAnalysisAtAStiffness, constructor.new(_4298.HypoidGearMeshModalAnalysisAtAStiffness))
        return value
