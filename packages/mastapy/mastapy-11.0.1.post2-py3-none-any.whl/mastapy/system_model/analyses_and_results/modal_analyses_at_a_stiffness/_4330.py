...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _2312, _4242
...
class RootAssemblyModalAnalysisAtAStiffness(_4242.AssemblyModalAnalysisAtAStiffness):
    ...
    @property
    def modal_analysis_at_a_stiffness_inputs(self) -> '_2312.ModalAnalysisAtAStiffness':
        ...
        return constructor.new(_2312.ModalAnalysisAtAStiffness)(self.wrapped.ModalAnalysisAtAStiffnessInputs) if self.wrapped.ModalAnalysisAtAStiffnessInputs else None
