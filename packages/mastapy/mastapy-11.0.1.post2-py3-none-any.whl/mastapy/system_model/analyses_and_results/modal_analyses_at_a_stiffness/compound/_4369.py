...
class AGMAGleasonConicalGearCompoundModalAnalysisAtAStiffness(_4397.ConicalGearCompoundModalAnalysisAtAStiffness):
    '''AGMAGleasonConicalGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4240.AGMAGleasonConicalGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4240.AGMAGleasonConicalGearModalAnalysisAtAStiffness))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4240.AGMAGleasonConicalGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4240.AGMAGleasonConicalGearModalAnalysisAtAStiffness))
        return value
