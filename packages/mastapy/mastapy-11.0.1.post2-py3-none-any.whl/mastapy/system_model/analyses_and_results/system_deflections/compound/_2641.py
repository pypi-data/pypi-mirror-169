...
class UnbalancedMassCompoundSystemDeflection(_2642.VirtualComponentCompoundSystemDeflection):
    '''UnbalancedMassCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2501.UnbalancedMassSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2501.UnbalancedMassSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2501.UnbalancedMassSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2501.UnbalancedMassSystemDeflection))
        return value
