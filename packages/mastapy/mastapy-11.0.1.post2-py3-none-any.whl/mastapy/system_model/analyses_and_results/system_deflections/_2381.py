...
class ClutchHalfSystemDeflection(_2399.CouplingHalfSystemDeflection):
    '''ClutchHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3719.ClutchHalfPowerFlow':
        ...
        return constructor.new(_3719.ClutchHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
