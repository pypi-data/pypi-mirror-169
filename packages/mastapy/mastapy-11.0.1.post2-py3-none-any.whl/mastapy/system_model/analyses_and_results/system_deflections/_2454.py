...
class PartToPartShearCouplingHalfSystemDeflection(_2399.CouplingHalfSystemDeflection):
    '''PartToPartShearCouplingHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3779.PartToPartShearCouplingHalfPowerFlow':
        ...
        return constructor.new(_3779.PartToPartShearCouplingHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
