...
class WormGearMeshSystemDeflection(_2426.GearMeshSystemDeflection):
    '''WormGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3824.WormGearMeshPowerFlow':
        ...
        return constructor.new(_3824.WormGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
