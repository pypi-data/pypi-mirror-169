...
class DatumSystemDeflection(_2384.ComponentSystemDeflection):
    '''DatumSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3749.DatumPowerFlow':
        ...
        return constructor.new(_3749.DatumPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
