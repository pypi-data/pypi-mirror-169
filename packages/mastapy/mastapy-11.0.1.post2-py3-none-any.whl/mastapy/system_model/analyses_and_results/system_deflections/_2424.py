...
class FEPartSystemDeflection(_2360.AbstractShaftOrHousingSystemDeflection):
    '''FEPartSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3754.FEPartPowerFlow':
        ...
        return constructor.new(_3754.FEPartPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def export(self) -> '_2088.SystemDeflectionFEExportOptions':
        ...
        return constructor.new(_2088.SystemDeflectionFEExportOptions)(self.wrapped.Export) if self.wrapped.Export else None
