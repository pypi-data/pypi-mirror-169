...
class WormGearSystemDeflection(_2428.GearSystemDeflection):
    '''WormGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3825.WormGearPowerFlow':
        ...
        return constructor.new(_3825.WormGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
