...
class RingPinsSystemDeflection(_2449.MountableComponentSystemDeflection):
    '''RingPinsSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3789.RingPinsPowerFlow':
        ...
        return constructor.new(_3789.RingPinsPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
