...
from mastapy.system_model.analyses_and_results.system_deflections import _2482, _2480, _2376
...
class StraightBevelDiffGearSetSystemDeflection(_2376.BevelGearSetSystemDeflection):
    '''StraightBevelDiffGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3807.StraightBevelDiffGearSetPowerFlow':
        ...
        return constructor.new(_3807.StraightBevelDiffGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def straight_bevel_diff_gears_system_deflection(self) -> 'List[_2482.StraightBevelDiffGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsSystemDeflection, constructor.new(_2482.StraightBevelDiffGearSystemDeflection))
        return value

    @property
    def straight_bevel_diff_meshes_system_deflection(self) -> 'List[_2480.StraightBevelDiffGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesSystemDeflection, constructor.new(_2480.StraightBevelDiffGearMeshSystemDeflection))
        return value
