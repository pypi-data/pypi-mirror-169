...
class CycloidalDiscCentralBearingConnectionSystemDeflection(_2383.CoaxialConnectionSystemDeflection):
    '''CycloidalDiscCentralBearingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3741.CycloidalDiscCentralBearingConnectionPowerFlow':
        ...
        return constructor.new(_3741.CycloidalDiscCentralBearingConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
