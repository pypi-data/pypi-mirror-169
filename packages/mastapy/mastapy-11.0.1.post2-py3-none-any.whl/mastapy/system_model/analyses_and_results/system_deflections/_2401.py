...
class CVTBeltConnectionSystemDeflection(_2368.BeltConnectionSystemDeflection):
    '''CVTBeltConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3737.CVTBeltConnectionPowerFlow':
        ...
        return constructor.new(_3737.CVTBeltConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
