...
class ZerolBevelGearMeshSystemDeflection(_2375.BevelGearMeshSystemDeflection):
    '''ZerolBevelGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3827.ZerolBevelGearMeshPowerFlow':
        ...
        return constructor.new(_3827.ZerolBevelGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
