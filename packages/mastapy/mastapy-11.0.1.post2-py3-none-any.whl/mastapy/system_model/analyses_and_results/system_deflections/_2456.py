...
class PlanetaryConnectionSystemDeflection(_2472.ShaftToMountableComponentConnectionSystemDeflection):
    '''PlanetaryConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3781.PlanetaryConnectionPowerFlow':
        ...
        return constructor.new(_3781.PlanetaryConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
