...
class ZerolBevelGearSystemDeflection(_2378.BevelGearSystemDeflection):
    '''ZerolBevelGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3829.ZerolBevelGearPowerFlow':
        ...
        return constructor.new(_3829.ZerolBevelGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
