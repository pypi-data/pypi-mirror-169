...
class StraightBevelSunGearSystemDeflection(_2482.StraightBevelDiffGearSystemDeflection):
    '''StraightBevelSunGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3812.StraightBevelSunGearPowerFlow':
        ...
        return constructor.new(_3812.StraightBevelSunGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
