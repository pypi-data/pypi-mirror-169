...
class AGMAGleasonConicalGearMeshSystemDeflection(_2393.ConicalGearMeshSystemDeflection):
    '''AGMAGleasonConicalGearMeshSystemDeflection
    ...
    @property
    def connection_design(self) -> '_1980.AGMAGleasonConicalGearMesh':
    ...
    @property
    def power_flow_results(self) -> '_3701.AGMAGleasonConicalGearMeshPowerFlow':
