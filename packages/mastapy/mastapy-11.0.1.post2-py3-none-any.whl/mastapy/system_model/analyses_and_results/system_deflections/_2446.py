...
class MassDiscSystemDeflection(_2502.VirtualComponentSystemDeflection):
    '''MassDiscSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3773.MassDiscPowerFlow':
        ...
        return constructor.new(_3773.MassDiscPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
