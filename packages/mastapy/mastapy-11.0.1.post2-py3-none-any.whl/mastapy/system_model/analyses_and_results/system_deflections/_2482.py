...
from mastapy.system_model.analyses_and_results.power_flows import _3806, _3811, _3812
...
class StraightBevelDiffGearSystemDeflection(_2377.BevelGearSystemDeflection):
    '''StraightBevelDiffGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3806.StraightBevelDiffGearPowerFlow':
