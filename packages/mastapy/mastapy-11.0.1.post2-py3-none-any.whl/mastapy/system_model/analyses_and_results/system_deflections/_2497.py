...
class TorqueConverterSystemDeflection(_2400.CouplingSystemDeflection):
    '''TorqueConverterSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3819.TorqueConverterPowerFlow':
        ...
        return constructor.new(_3819.TorqueConverterPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
