...
class KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection(_2437.KlingelnbergCycloPalloidConicalGearSystemDeflection):
    '''KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3771.KlingelnbergCycloPalloidSpiralBevelGearPowerFlow':
        ...
        return constructor.new(_3771.KlingelnbergCycloPalloidSpiralBevelGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
