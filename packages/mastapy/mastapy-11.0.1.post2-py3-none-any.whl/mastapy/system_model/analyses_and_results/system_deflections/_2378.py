...
class BoltedJointSystemDeflection(_2473.SpecialisedAssemblySystemDeflection):
    '''BoltedJointSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3716.BoltedJointPowerFlow':
        ...
        return constructor.new(_3716.BoltedJointPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
