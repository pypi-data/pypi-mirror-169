...
class ConceptCouplingConnectionSystemDeflection(_2398.CouplingConnectionSystemDeflection):
    '''ConceptCouplingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3723.ConceptCouplingConnectionPowerFlow':
        ...
        return constructor.new(_3723.ConceptCouplingConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
