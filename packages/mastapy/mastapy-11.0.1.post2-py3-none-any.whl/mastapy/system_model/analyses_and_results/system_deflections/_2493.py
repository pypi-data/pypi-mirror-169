...
from mastapy.system_model.drawing import _1936, _1926
...
class SystemDeflectionDrawStyle(_1926.ContourDrawStyle):
    '''SystemDeflectionDrawStyle
    ...
    @property
    def force_arrow_scaling(self) -> '_1936.ScalingDrawStyle':
        ...
        return constructor.new(_1936.ScalingDrawStyle)(self.wrapped.ForceArrowScaling) if self.wrapped.ForceArrowScaling else None
