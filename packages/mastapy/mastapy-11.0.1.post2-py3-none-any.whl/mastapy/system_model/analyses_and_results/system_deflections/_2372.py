...
from mastapy.system_model.analyses_and_results.power_flows import _3709, _3711, _3712
...
class BevelDifferentialGearSystemDeflection(_2377.BevelGearSystemDeflection):
    '''BevelDifferentialGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3709.BevelDifferentialGearPowerFlow':
