...
class PlanetCarrierSystemDeflection(_2449.MountableComponentSystemDeflection):
    '''PlanetCarrierSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3783.PlanetCarrierPowerFlow':
        ...
        return constructor.new(_3783.PlanetCarrierPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def windup(self) -> 'List[_2513.PlanetCarrierWindup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Windup, constructor.new(_2513.PlanetCarrierWindup))
        return value
