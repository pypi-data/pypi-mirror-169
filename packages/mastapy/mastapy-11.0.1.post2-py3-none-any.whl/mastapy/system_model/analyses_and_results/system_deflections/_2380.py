...
class ClutchConnectionSystemDeflection(_2398.CouplingConnectionSystemDeflection):
    '''ClutchConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3718.ClutchConnectionPowerFlow':
        ...
        return constructor.new(_3718.ClutchConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
