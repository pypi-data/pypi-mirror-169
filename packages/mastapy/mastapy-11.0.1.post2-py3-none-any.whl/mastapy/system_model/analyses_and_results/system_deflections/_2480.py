...
class StraightBevelDiffGearMeshSystemDeflection(_2375.BevelGearMeshSystemDeflection):
    '''StraightBevelDiffGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3805.StraightBevelDiffGearMeshPowerFlow':
        ...
        return constructor.new(_3805.StraightBevelDiffGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
