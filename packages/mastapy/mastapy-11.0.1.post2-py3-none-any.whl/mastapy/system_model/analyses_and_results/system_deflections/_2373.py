...
class BevelDifferentialPlanetGearSystemDeflection(_2372.BevelDifferentialGearSystemDeflection):
    '''BevelDifferentialPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3711.BevelDifferentialPlanetGearPowerFlow':
        ...
        return constructor.new(_3711.BevelDifferentialPlanetGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
