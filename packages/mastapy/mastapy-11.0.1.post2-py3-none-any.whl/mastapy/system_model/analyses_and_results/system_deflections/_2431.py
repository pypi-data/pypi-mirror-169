...
from mastapy.system_model.analyses_and_results.system_deflections import _2432, _2430, _2364
...
class HypoidGearSetSystemDeflection(_2364.AGMAGleasonConicalGearSetSystemDeflection):
    '''HypoidGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3762.HypoidGearSetPowerFlow':
        ...
        return constructor.new(_3762.HypoidGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def hypoid_gears_system_deflection(self) -> 'List[_2432.HypoidGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsSystemDeflection, constructor.new(_2432.HypoidGearSystemDeflection))
        return value

    @property
    def hypoid_meshes_system_deflection(self) -> 'List[_2430.HypoidGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesSystemDeflection, constructor.new(_2430.HypoidGearMeshSystemDeflection))
        return value
