...
from mastapy.system_model.analyses_and_results.system_deflections import _2444, _2494
...
class SystemDeflection(_7192.FEAnalysis):
    '''SystemDeflection
    ...
    @property
    def overall_efficiency_results(self) -> '_2444.LoadCaseOverallEfficiencyResult':
        ...
        return constructor.new(_2444.LoadCaseOverallEfficiencyResult)(self.wrapped.OverallEfficiencyResults) if self.wrapped.OverallEfficiencyResults else None

    @property
    def analysis_options(self) -> '_2494.SystemDeflectionOptions':
        ...
        return constructor.new(_2494.SystemDeflectionOptions)(self.wrapped.AnalysisOptions) if self.wrapped.AnalysisOptions else None
