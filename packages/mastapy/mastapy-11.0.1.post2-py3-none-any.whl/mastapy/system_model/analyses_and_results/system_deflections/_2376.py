...
class BevelGearSetSystemDeflection(_2364.AGMAGleasonConicalGearSetSystemDeflection):
    '''BevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3715.BevelGearSetPowerFlow':
