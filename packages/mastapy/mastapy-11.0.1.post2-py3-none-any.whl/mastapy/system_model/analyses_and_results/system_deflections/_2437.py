...
class KlingelnbergCycloPalloidConicalGearSystemDeflection(_2395.ConicalGearSystemDeflection):
    '''KlingelnbergCycloPalloidConicalGearSystemDeflection
    ...
    @property
    def component_design(self) -> '_2212.KlingelnbergCycloPalloidConicalGear':
    ...
    @property
    def power_flow_results(self) -> '_3765.KlingelnbergCycloPalloidConicalGearPowerFlow':
