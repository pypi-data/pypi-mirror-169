...
class TorqueConverterConnectionSystemDeflection(_2398.CouplingConnectionSystemDeflection):
    '''TorqueConverterConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3818.TorqueConverterConnectionPowerFlow':
        ...
        return constructor.new(_3818.TorqueConverterConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
