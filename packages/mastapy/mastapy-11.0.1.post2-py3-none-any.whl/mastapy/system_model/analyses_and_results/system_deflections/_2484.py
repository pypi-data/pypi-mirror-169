...
from mastapy.system_model.analyses_and_results.system_deflections import _2485, _2483, _2376
...
class StraightBevelGearSetSystemDeflection(_2376.BevelGearSetSystemDeflection):
    '''StraightBevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3810.StraightBevelGearSetPowerFlow':
        ...
        return constructor.new(_3810.StraightBevelGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def straight_bevel_gears_system_deflection(self) -> 'List[_2485.StraightBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsSystemDeflection, constructor.new(_2485.StraightBevelGearSystemDeflection))
        return value

    @property
    def straight_bevel_meshes_system_deflection(self) -> 'List[_2483.StraightBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesSystemDeflection, constructor.new(_2483.StraightBevelGearMeshSystemDeflection))
        return value
