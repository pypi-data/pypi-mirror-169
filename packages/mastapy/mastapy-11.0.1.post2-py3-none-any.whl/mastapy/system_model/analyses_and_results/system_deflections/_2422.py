...
from mastapy.system_model.analyses_and_results.system_deflections import _2423, _2421, _2427
...
class FaceGearSetSystemDeflection(_2427.GearSetSystemDeflection):
    '''FaceGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3753.FaceGearSetPowerFlow':
        ...
        return constructor.new(_3753.FaceGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def face_gears_system_deflection(self) -> 'List[_2423.FaceGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsSystemDeflection, constructor.new(_2423.FaceGearSystemDeflection))
        return value

    @property
    def face_meshes_system_deflection(self) -> 'List[_2421.FaceGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesSystemDeflection, constructor.new(_2421.FaceGearMeshSystemDeflection))
        return value
