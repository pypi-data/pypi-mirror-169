...
class BevelDifferentialGearMeshCompoundSteadyStateSynchronousResponseAtASpeed(_3389.BevelGearMeshCompoundSteadyStateSynchronousResponseAtASpeed):
    '''BevelDifferentialGearMeshCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3253.BevelDifferentialGearMeshSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3253.BevelDifferentialGearMeshSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_3253.BevelDifferentialGearMeshSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3253.BevelDifferentialGearMeshSteadyStateSynchronousResponseAtASpeed))
        return value
