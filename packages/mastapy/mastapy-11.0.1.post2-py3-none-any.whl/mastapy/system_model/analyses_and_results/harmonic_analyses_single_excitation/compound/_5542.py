...
class MountableComponentCompoundHarmonicAnalysisOfSingleExcitation(_5490.ComponentCompoundHarmonicAnalysisOfSingleExcitation):
    '''MountableComponentCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5413.MountableComponentHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5413.MountableComponentHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5413.MountableComponentHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5413.MountableComponentHarmonicAnalysisOfSingleExcitation))
        return value
