...
class AGMAGleasonConicalGearSetCompoundHarmonicAnalysisOfSingleExcitation(_5499.ConicalGearSetCompoundHarmonicAnalysisOfSingleExcitation):
    '''AGMAGleasonConicalGearSetCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5341.AGMAGleasonConicalGearSetHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5341.AGMAGleasonConicalGearSetHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5341.AGMAGleasonConicalGearSetHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5341.AGMAGleasonConicalGearSetHarmonicAnalysisOfSingleExcitation))
        return value
