...
class GuideDxfModelAdvancedTimeSteppingAnalysisForModulation(_6684.ComponentAdvancedTimeSteppingAnalysisForModulation):
    '''GuideDxfModelAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2429.GuideDxfModelSystemDeflection':
        ...
        return constructor.new(_2429.GuideDxfModelSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
