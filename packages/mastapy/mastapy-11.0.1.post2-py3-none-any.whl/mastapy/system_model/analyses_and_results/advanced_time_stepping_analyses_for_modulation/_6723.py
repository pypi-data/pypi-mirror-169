...
class HypoidGearMeshAdvancedTimeSteppingAnalysisForModulation(_6663.AGMAGleasonConicalGearMeshAdvancedTimeSteppingAnalysisForModulation):
    '''HypoidGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2430.HypoidGearMeshSystemDeflection':
        ...
        return constructor.new(_2430.HypoidGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
