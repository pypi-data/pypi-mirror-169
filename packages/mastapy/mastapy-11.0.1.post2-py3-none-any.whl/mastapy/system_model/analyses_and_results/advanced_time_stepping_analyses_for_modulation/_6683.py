...
from mastapy.system_model.analyses_and_results.static_loads import _6480, _6502
from mastapy.system_model.analyses_and_results.system_deflections import _2383, _2405
...
class CoaxialConnectionAdvancedTimeSteppingAnalysisForModulation(_6757.ShaftToMountableComponentConnectionAdvancedTimeSteppingAnalysisForModulation):
    '''CoaxialConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6480.CoaxialConnectionLoadCase':
        ...
        if _6480.CoaxialConnectionLoadCase.TYPE not in self.wrapped.ConnectionLoadCase.__class__.__mro__:
    ...
    @property
    def system_deflection_results(self) -> '_2383.CoaxialConnectionSystemDeflection':
