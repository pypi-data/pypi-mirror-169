...
class StraightBevelGearAdvancedTimeSteppingAnalysisForModulation(_6675.BevelGearAdvancedTimeSteppingAnalysisForModulation):
    '''StraightBevelGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2485.StraightBevelGearSystemDeflection':
        ...
        return constructor.new(_2485.StraightBevelGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
