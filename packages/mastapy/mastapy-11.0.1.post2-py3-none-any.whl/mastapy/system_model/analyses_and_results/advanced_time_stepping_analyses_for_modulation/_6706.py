...
class CylindricalGearAdvancedTimeSteppingAnalysisForModulation(_6717.GearAdvancedTimeSteppingAnalysisForModulation):
    '''CylindricalGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2414.CylindricalGearSystemDeflection':
