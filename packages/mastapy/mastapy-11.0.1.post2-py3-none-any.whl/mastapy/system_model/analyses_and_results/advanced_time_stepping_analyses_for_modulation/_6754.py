...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _2299, _6665
...
class RootAssemblyAdvancedTimeSteppingAnalysisForModulation(_6665.AssemblyAdvancedTimeSteppingAnalysisForModulation):
    '''RootAssemblyAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def advanced_time_stepping_analysis_for_modulation_inputs(self) -> '_2299.AdvancedTimeSteppingAnalysisForModulation':
        ...
        return constructor.new(_2299.AdvancedTimeSteppingAnalysisForModulation)(self.wrapped.AdvancedTimeSteppingAnalysisForModulationInputs) if self.wrapped.AdvancedTimeSteppingAnalysisForModulationInputs else None
