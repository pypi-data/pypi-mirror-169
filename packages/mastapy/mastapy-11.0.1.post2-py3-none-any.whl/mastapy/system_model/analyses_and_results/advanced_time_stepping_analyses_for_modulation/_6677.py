...
class BevelGearSetAdvancedTimeSteppingAnalysisForModulation(_6664.AGMAGleasonConicalGearSetAdvancedTimeSteppingAnalysisForModulation):
    '''BevelGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_design(self) -> '_2196.BevelGearSet':
    ...
    @property
    def system_deflection_results(self) -> '_2376.BevelGearSetSystemDeflection':
