...
class AGMAGleasonConicalGearSetAdvancedTimeSteppingAnalysisForModulation(_6693.ConicalGearSetAdvancedTimeSteppingAnalysisForModulation):
    '''AGMAGleasonConicalGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2364.AGMAGleasonConicalGearSetSystemDeflection':
