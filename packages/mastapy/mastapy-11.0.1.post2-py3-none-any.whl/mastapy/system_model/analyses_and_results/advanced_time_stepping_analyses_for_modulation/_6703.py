...
class CycloidalDiscAdvancedTimeSteppingAnalysisForModulation(_6656.AbstractShaftAdvancedTimeSteppingAnalysisForModulation):
    '''CycloidalDiscAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2407.CycloidalDiscSystemDeflection':
        ...
        return constructor.new(_2407.CycloidalDiscSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
