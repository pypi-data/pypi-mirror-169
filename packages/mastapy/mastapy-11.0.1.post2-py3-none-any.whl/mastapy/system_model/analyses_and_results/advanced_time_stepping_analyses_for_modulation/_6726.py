...
class KlingelnbergCycloPalloidConicalGearAdvancedTimeSteppingAnalysisForModulation(_6691.ConicalGearAdvancedTimeSteppingAnalysisForModulation):
    '''KlingelnbergCycloPalloidConicalGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2437.KlingelnbergCycloPalloidConicalGearSystemDeflection':
