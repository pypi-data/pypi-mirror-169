...
class AGMAGleasonConicalGearMeshAdvancedTimeSteppingAnalysisForModulation(_6692.ConicalGearMeshAdvancedTimeSteppingAnalysisForModulation):
    '''AGMAGleasonConicalGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2363.AGMAGleasonConicalGearMeshSystemDeflection':
