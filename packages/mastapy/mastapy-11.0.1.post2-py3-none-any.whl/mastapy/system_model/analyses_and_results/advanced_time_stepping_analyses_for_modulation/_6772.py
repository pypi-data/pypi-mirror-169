...
class StraightBevelSunGearAdvancedTimeSteppingAnalysisForModulation(_6765.StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation):
    '''StraightBevelSunGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2226.StraightBevelSunGear':
        ...
        return constructor.new(_2226.StraightBevelSunGear)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None

    @property
    def system_deflection_results(self) -> '_2487.StraightBevelSunGearSystemDeflection':
        ...
        return constructor.new(_2487.StraightBevelSunGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
