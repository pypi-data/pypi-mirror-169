...
class CVTBeltConnectionAdvancedTimeSteppingAnalysisForModulation(_6668.BeltConnectionAdvancedTimeSteppingAnalysisForModulation):
    '''CVTBeltConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_design(self) -> '_1954.CVTBeltConnection':
        ...
        return constructor.new(_1954.CVTBeltConnection)(self.wrapped.ConnectionDesign) if self.wrapped.ConnectionDesign else None

    @property
    def system_deflection_results(self) -> '_2401.CVTBeltConnectionSystemDeflection':
        ...
        return constructor.new(_2401.CVTBeltConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
