...
from mastapy.system_model.analyses_and_results.analysis_cases import _7194
...
class PartCompoundAdvancedTimeSteppingAnalysisForModulation(_7194.PartCompoundAnalysis):
    '''PartCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6739.PartAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6739.PartAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_6739.PartAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6739.PartAdvancedTimeSteppingAnalysisForModulation))
        return value
