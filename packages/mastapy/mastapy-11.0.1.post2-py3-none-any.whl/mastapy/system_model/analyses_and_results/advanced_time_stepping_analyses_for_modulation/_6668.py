...
from mastapy.system_model.analyses_and_results.static_loads import _6465, _6498
from mastapy.system_model.analyses_and_results.system_deflections import _2368, _2401
...
class BeltConnectionAdvancedTimeSteppingAnalysisForModulation(_6725.InterMountableComponentConnectionAdvancedTimeSteppingAnalysisForModulation):
    '''BeltConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6465.BeltConnectionLoadCase':
        ...
        if _6465.BeltConnectionLoadCase.TYPE not in self.wrapped.ConnectionLoadCase.__class__.__mro__:
    ...
    @property
    def system_deflection_results(self) -> '_2368.BeltConnectionSystemDeflection':
