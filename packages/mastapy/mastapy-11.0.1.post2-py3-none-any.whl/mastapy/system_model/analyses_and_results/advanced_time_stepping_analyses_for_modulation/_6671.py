...
class BevelDifferentialGearMeshAdvancedTimeSteppingAnalysisForModulation(_6676.BevelGearMeshAdvancedTimeSteppingAnalysisForModulation):
    '''BevelDifferentialGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6468.BevelDifferentialGearMeshLoadCase':
        ...
        return constructor.new(_6468.BevelDifferentialGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def system_deflection_results(self) -> '_2370.BevelDifferentialGearMeshSystemDeflection':
        ...
        return constructor.new(_2370.BevelDifferentialGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
