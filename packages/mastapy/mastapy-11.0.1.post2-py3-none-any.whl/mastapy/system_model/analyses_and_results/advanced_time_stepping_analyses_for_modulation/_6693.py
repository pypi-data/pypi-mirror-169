...
class ConicalGearSetAdvancedTimeSteppingAnalysisForModulation(_6719.GearSetAdvancedTimeSteppingAnalysisForModulation):
    '''ConicalGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2394.ConicalGearSetSystemDeflection':
