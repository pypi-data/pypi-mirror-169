...
class BearingAdvancedSystemDeflection(_6957.ConnectorAdvancedSystemDeflection):
    '''BearingAdvancedSystemDeflection
    ...
    @property
    def duty_cycle(self) -> '_1651.LoadedBearingDutyCycle':
        ...
        if _1651.LoadedBearingDutyCycle.TYPE not in self.wrapped.DutyCycle.__class__.__mro__:
