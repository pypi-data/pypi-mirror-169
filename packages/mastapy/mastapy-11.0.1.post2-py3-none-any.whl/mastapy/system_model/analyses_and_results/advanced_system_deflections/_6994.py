...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6992, _6993, _6991
...
class KlingelnbergCycloPalloidHypoidGearSetAdvancedSystemDeflection(_6991.KlingelnbergCycloPalloidConicalGearSetAdvancedSystemDeflection):
    '''KlingelnbergCycloPalloidHypoidGearSetAdvancedSystemDeflection
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_advanced_system_deflection(self) -> 'List[_6992.KlingelnbergCycloPalloidHypoidGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidGearsAdvancedSystemDeflection, constructor.new(_6992.KlingelnbergCycloPalloidHypoidGearAdvancedSystemDeflection))
        return value

    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_advanced_system_deflection(self) -> 'List[_6993.KlingelnbergCycloPalloidHypoidGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidMeshesAdvancedSystemDeflection, constructor.new(_6993.KlingelnbergCycloPalloidHypoidGearMeshAdvancedSystemDeflection))
        return value
