...
class InterMountableComponentConnectionCompoundAdvancedSystemDeflection(_7089.ConnectionCompoundAdvancedSystemDeflection):
    '''InterMountableComponentConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6988.InterMountableComponentConnectionAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6988.InterMountableComponentConnectionAdvancedSystemDeflection))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_6988.InterMountableComponentConnectionAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6988.InterMountableComponentConnectionAdvancedSystemDeflection))
        return value
