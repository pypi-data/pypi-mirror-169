...
from mastapy.math_utility.convergence import _1335, _1334
...
class PartAdvancedSystemDeflection(_7196.PartStaticLoadAnalysisCase):
    '''PartAdvancedSystemDeflection
    ...
    @property
    def advanced_system_deflection(self) -> '_6922.AdvancedSystemDeflection':
        ...
        return constructor.new(_6922.AdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflection) if self.wrapped.AdvancedSystemDeflection else None

    @property
    def data_logger(self) -> '_1335.DataLogger':
        ...
        if _1335.DataLogger.TYPE not in self.wrapped.DataLogger.__class__.__mro__:
    ...
    def create_viewable(self) -> '_1924.AdvancedSystemDeflectionViewable':
