...
from mastapy.system_model.analyses_and_results.static_loads import _6608, _6614, _6615
...
class StraightBevelDiffGearAdvancedSystemDeflection(_6937.BevelGearAdvancedSystemDeflection):
    '''StraightBevelDiffGearAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6608.StraightBevelDiffGearLoadCase':
        ...
        if _6608.StraightBevelDiffGearLoadCase.TYPE not in self.wrapped.ComponentLoadCase.__class__.__mro__:
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2482.StraightBevelDiffGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2482.StraightBevelDiffGearSystemDeflection))
        return value
