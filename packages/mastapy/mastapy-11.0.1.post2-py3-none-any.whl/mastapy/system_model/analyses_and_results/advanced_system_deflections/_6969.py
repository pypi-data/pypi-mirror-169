...
from mastapy.system_model.analyses_and_results.static_loads import _6505, _6510
from mastapy.gears.rating.cylindrical import _418
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6970, _6972, _6981
...
class CylindricalGearAdvancedSystemDeflection(_6981.GearAdvancedSystemDeflection):
    '''CylindricalGearAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6505.CylindricalGearLoadCase':
        ...
        if _6505.CylindricalGearLoadCase.TYPE not in self.wrapped.ComponentLoadCase.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_advanced_system_deflection_meshes(self) -> 'List[_6970.CylindricalGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearAdvancedSystemDeflectionMeshes, constructor.new(_6970.CylindricalGearMeshAdvancedSystemDeflection))
        return value

    @property
    def cylindrical_meshed_gear_advanced_system_deflections(self) -> 'List[_6972.CylindricalMeshedGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshedGearAdvancedSystemDeflections, constructor.new(_6972.CylindricalMeshedGearAdvancedSystemDeflection))
        return value

    @property
    def cylindrical_gear_advanced_system_deflections_in_meshes(self) -> 'List[_6972.CylindricalMeshedGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearAdvancedSystemDeflectionsInMeshes, constructor.new(_6972.CylindricalMeshedGearAdvancedSystemDeflection))
        return value
