...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _2379, _4854
...
class RootAssemblyModalAnalysisAtASpeed(_4854.AssemblyModalAnalysisAtASpeed):
    '''RootAssemblyModalAnalysisAtASpeed
    ...
    @property
    def modal_analysis_at_a_speed_inputs(self) -> '_2379.ModalAnalysisAtASpeed':
        ...
        return constructor.new(_2379.ModalAnalysisAtASpeed)(self.wrapped.ModalAnalysisAtASpeedInputs) if self.wrapped.ModalAnalysisAtASpeedInputs is not None else None
