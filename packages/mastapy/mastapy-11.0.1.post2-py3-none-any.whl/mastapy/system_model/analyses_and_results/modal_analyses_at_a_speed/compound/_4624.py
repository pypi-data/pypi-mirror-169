...
class AbstractShaftCompoundModalAnalysisAtASpeed(_4625.AbstractShaftOrHousingCompoundModalAnalysisAtASpeed):
    '''AbstractShaftCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4495.AbstractShaftModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4495.AbstractShaftModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4495.AbstractShaftModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4495.AbstractShaftModalAnalysisAtASpeed))
        return value
