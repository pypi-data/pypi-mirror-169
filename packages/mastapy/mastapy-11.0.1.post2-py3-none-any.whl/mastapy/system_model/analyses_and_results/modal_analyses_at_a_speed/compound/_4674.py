...
class DatumCompoundModalAnalysisAtASpeed(_4648.ComponentCompoundModalAnalysisAtASpeed):
    '''DatumCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4545.DatumModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4545.DatumModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4545.DatumModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4545.DatumModalAnalysisAtASpeed))
        return value
