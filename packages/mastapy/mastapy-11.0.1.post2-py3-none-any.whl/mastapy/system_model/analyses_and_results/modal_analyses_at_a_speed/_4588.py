...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _2311, _4501
...
class RootAssemblyModalAnalysisAtASpeed(_4501.AssemblyModalAnalysisAtASpeed):
    '''RootAssemblyModalAnalysisAtASpeed
    ...
    @property
    def modal_analysis_at_a_speed_inputs(self) -> '_2311.ModalAnalysisAtASpeed':
        ...
        return constructor.new(_2311.ModalAnalysisAtASpeed)(self.wrapped.ModalAnalysisAtASpeedInputs) if self.wrapped.ModalAnalysisAtASpeedInputs else None
