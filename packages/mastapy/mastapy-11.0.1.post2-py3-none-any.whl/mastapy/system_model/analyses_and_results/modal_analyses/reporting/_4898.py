...
class PerModeResultsReport(_1491.CustomReportChart):
    '''PerModeResultsReport
    ...
    @property
    def display_option(self) -> '_1549.TableAndChartOptions':
    ...
    def display_option(self, value: '_1549.TableAndChartOptions'):
