...
class KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysis(_4973.KlingelnbergCycloPalloidConicalGearSetCompoundModalAnalysis):
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4825.KlingelnbergCycloPalloidHypoidGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4825.KlingelnbergCycloPalloidHypoidGearSetModalAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4825.KlingelnbergCycloPalloidHypoidGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4825.KlingelnbergCycloPalloidHypoidGearSetModalAnalysis))
        return value
