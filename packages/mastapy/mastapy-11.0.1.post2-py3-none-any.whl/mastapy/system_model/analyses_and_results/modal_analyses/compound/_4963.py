...
class GearCompoundModalAnalysis(_4982.MountableComponentCompoundModalAnalysis):
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4813.GearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4813.GearModalAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4813.GearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4813.GearModalAnalysis))
        return value
