...
class ComponentCompoundModalAnalysis(_4984.PartCompoundModalAnalysis):
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4777.ComponentModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4777.ComponentModalAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4777.ComponentModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4777.ComponentModalAnalysis))
        return value
