...
class RollingRingConnectionCompoundModalAnalysis(_4970.InterMountableComponentConnectionCompoundModalAnalysis):
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4850.RollingRingConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4850.RollingRingConnectionModalAnalysis))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4850.RollingRingConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4850.RollingRingConnectionModalAnalysis))
        return value
