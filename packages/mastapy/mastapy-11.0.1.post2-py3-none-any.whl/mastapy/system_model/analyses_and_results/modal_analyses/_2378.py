...
from mastapy.system_model.analyses_and_results.modal_analyses import _2372, _4387, _4385
...
class ModalAnalysis(_7270.StaticLoadAnalysisCase):
    '''ModalAnalysis
    ...
    @property
    def modal_analysis_results(self) -> '_2369.DynamicAnalysis':
        ...
        if _2369.DynamicAnalysis.TYPE not in self.wrapped.ModalAnalysisResults.__class__.__mro__:
    ...
    @property
    def analysis_settings(self) -> '_4387.ModalAnalysisOptions':
        ...
        return constructor.new(_4387.ModalAnalysisOptions)(self.wrapped.AnalysisSettings) if self.wrapped.AnalysisSettings is not None else None

    @property
    def bar_model_export(self) -> '_4385.ModalAnalysisBarModelFEExportOptions':
        ...
        return constructor.new(_4385.ModalAnalysisBarModelFEExportOptions)(self.wrapped.BarModelExport) if self.wrapped.BarModelExport is not None else None
