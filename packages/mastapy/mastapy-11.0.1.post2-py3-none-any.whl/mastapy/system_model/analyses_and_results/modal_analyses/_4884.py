...
TMeasurement = TypeVar('TMeasurement', bound='_1361.MeasurementBase')


class WhineWaterfallReferenceValues(_4885.WhineWaterfallReferenceValuesBase, Generic[TMeasurement]):
    '''WhineWaterfallReferenceValues
