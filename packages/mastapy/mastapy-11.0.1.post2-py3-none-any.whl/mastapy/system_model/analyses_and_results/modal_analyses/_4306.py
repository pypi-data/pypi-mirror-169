...
from mastapy.system_model.analyses_and_results.modal_analyses import _4331, _4366, _4391
...
class AbstractAssemblyModalAnalysis(_4391.PartModalAnalysis):
    '''AbstractAssemblyModalAnalysis
    ...
    @property
    def rigidly_connected_groups(self) -> 'List[_4331.ComponentModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RigidlyConnectedGroups, constructor.new(_4331.ComponentModalAnalysis))
        return value

    @property
    def gear_meshes(self) -> 'List[_4366.GearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshes, constructor.new(_4366.GearMeshModalAnalysis))
        return value
