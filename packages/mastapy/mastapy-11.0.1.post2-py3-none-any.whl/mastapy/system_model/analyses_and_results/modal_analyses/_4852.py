...
from mastapy.system_model.analyses_and_results.modal_analyses import _2310, _4759
...
class RootAssemblyModalAnalysis(_4759.AssemblyModalAnalysis):
    '''RootAssemblyModalAnalysis
    ...
    @property
    def modal_analysis_inputs(self) -> '_2310.ModalAnalysis':
        ...
        if _2310.ModalAnalysis.TYPE not in self.wrapped.ModalAnalysisInputs.__class__.__mro__:
