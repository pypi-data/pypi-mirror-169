...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3274, _3175
...
class RootAssemblySteadyStateSynchronousResponse(_3175.AssemblySteadyStateSynchronousResponse):
    '''RootAssemblySteadyStateSynchronousResponse
    ...
    @property
    def steady_state_synchronous_response_inputs(self) -> '_3274.SteadyStateSynchronousResponse':
        ...
        return constructor.new(_3274.SteadyStateSynchronousResponse)(self.wrapped.SteadyStateSynchronousResponseInputs) if self.wrapped.SteadyStateSynchronousResponseInputs else None
