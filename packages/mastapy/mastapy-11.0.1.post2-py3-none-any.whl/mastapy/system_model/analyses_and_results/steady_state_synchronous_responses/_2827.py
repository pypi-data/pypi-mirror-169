...
class SteadyStateSynchronousResponse(_7257.CompoundAnalysisCase):
    '''SteadyStateSynchronousResponse
    ...
    @property
    def steady_state_analysis_options(self) -> '_2829.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_2829.SteadyStateSynchronousResponseOptions)(self.wrapped.SteadyStateAnalysisOptions) if self.wrapped.SteadyStateAnalysisOptions is not None else None
