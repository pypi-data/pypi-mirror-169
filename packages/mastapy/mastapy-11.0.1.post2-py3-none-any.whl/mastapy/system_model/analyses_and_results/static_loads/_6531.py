...
from mastapy.system_model.analyses_and_results.static_loads import _6529, _6530, _6540
...
class FaceGearSetLoadCase(_6540.GearSetLoadCase):
    '''FaceGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6529.FaceGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6529.FaceGearLoadCase))
        return value

    @property
    def face_gears_load_case(self) -> 'List[_6529.FaceGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsLoadCase, constructor.new(_6529.FaceGearLoadCase))
        return value

    @property
    def face_meshes_load_case(self) -> 'List[_6530.FaceGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesLoadCase, constructor.new(_6530.FaceGearMeshLoadCase))
        return value
