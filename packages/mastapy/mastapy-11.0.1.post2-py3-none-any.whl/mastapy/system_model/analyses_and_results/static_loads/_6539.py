...
from mastapy.system_model.analyses_and_results.static_loads import _6538, _6543
...
class GearSetHarmonicLoadData(_6543.HarmonicLoadDataBase):
    '''GearSetHarmonicLoadData
    ...
    @property
    def gear_mesh_te_order_type(self) -> '_6538.GearMeshTEOrderType':
        ...
        return constructor.new(_6538.GearMeshTEOrderType)(value) if value else None

    @gear_mesh_te_order_type.setter
    def gear_mesh_te_order_type(self, value: '_6538.GearMeshTEOrderType'):
