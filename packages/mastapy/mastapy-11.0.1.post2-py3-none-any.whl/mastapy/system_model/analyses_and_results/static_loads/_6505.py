...
from mastapy.system_model.analyses_and_results.static_loads import _6506, _6535
...
class CylindricalGearLoadCase(_6535.GearLoadCase):
    '''CylindricalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6506.CylindricalGearManufactureError':
        ...
        return constructor.new(_6506.CylindricalGearManufactureError)(self.wrapped.GearManufactureErrors) if self.wrapped.GearManufactureErrors else None
