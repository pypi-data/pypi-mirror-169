...
from mastapy.system_model.analyses_and_results.static_loads import _6517, _6525
...
class ElectricMachineHarmonicLoadDataFromMotorPackages(_6517.ElectricMachineHarmonicLoadData, Generic[T]):
    '''ElectricMachineHarmonicLoadDataFromMotorPackages
