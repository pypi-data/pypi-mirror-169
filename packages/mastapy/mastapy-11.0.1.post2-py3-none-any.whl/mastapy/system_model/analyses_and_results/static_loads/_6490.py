...
from mastapy.gears.gear_designs.conical import _1078, _1072
from mastapy.system_model.analyses_and_results.static_loads import _6491, _6537
...
class ConicalGearMeshLoadCase(_6537.GearMeshLoadCase):
    '''ConicalGearMeshLoadCase
    ...
    @property
    def results_from_imported_xml(self) -> '_1078.KimosBevelHypoidSingleLoadCaseResultsData':
        ...
        return constructor.new(_1078.KimosBevelHypoidSingleLoadCaseResultsData)(self.wrapped.ResultsFromImportedXML) if self.wrapped.ResultsFromImportedXML else None

    @property
    def user_specified_misalignments(self) -> '_1072.ConicalMeshMisalignments':
        ...
        return constructor.new(_1072.ConicalMeshMisalignments)(self.wrapped.UserSpecifiedMisalignments) if self.wrapped.UserSpecifiedMisalignments else None

    def get_harmonic_load_data_for_import(self) -> '_6491.ConicalGearSetHarmonicLoadData':
