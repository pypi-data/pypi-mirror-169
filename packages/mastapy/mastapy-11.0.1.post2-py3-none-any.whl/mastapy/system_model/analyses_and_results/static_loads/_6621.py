...
class TimeSeriesLoadCase(_6450.LoadCase):
    '''TimeSeriesLoadCase
    ...
    @property
    def driva_analysis_options(self) -> '_5119.MBDAnalysisOptions':
        ...
        return constructor.new(_5119.MBDAnalysisOptions)(self.wrapped.DRIVAAnalysisOptions) if self.wrapped.DRIVAAnalysisOptions else None
