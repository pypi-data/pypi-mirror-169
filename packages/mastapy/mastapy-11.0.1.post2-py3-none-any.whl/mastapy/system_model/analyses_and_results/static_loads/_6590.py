...
from mastapy.system_model.analyses_and_results.static_loads import _6461, _6571
...
class RingPinsLoadCase(_6571.MountableComponentLoadCase):
    '''RingPinsLoadCase
    ...
    @property
    def all_ring_pins_manufacturing_error(self) -> '_6461.AllRingPinsManufacturingError':
        ...
        return constructor.new(_6461.AllRingPinsManufacturingError)(self.wrapped.AllRingPinsManufacturingError) if self.wrapped.AllRingPinsManufacturingError else None
