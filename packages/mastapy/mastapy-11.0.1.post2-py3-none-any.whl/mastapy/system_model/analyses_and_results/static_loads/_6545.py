...
from mastapy.system_model.analyses_and_results.static_loads import _6572, _6547, _6523
...
class HarmonicLoadDataExcelImport(_6547.HarmonicLoadDataImportBase['_6523.ElectricMachineHarmonicLoadExcelImportOptions']):
    '''HarmonicLoadDataExcelImport
    ...
    @property
    def speeds(self) -> 'List[_6572.NamedSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Speeds, constructor.new(_6572.NamedSpeed))
        return value
