...
from mastapy.system_model.analyses_and_results.static_loads import _6485, _6486, _6540
...
class ConceptGearSetLoadCase(_6540.GearSetLoadCase):
    '''ConceptGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6485.ConceptGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6485.ConceptGearLoadCase))
        return value

    @property
    def concept_gears_load_case(self) -> 'List[_6485.ConceptGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsLoadCase, constructor.new(_6485.ConceptGearLoadCase))
        return value

    @property
    def concept_meshes_load_case(self) -> 'List[_6486.ConceptGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesLoadCase, constructor.new(_6486.ConceptGearMeshLoadCase))
        return value
