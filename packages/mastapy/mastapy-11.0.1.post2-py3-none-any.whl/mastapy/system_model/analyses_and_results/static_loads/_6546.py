...
from mastapy.system_model.analyses_and_results.static_loads import _6557, _6544, _6524
...
class HarmonicLoadDataFluxImport(_6544.HarmonicLoadDataCSVImport['_6524.ElectricMachineHarmonicLoadFluxImportOptions']):
    '''HarmonicLoadDataFluxImport
    ...
    @property
    def inner_diameter_reference(self) -> '_6557.InnerDiameterReference':
        ...
        return constructor.new(_6557.InnerDiameterReference)(value) if value else None

    @inner_diameter_reference.setter
    def inner_diameter_reference(self, value: '_6557.InnerDiameterReference'):
