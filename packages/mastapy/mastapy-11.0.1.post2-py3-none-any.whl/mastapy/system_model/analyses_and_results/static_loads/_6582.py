...
from mastapy.system_model.analyses_and_results.static_loads import _6581, _6571
...
class PlanetCarrierLoadCase(_6571.MountableComponentLoadCase):
    '''PlanetCarrierLoadCase
    ...
    @property
    def planet_manufacture_errors(self) -> 'List[_6581.PlanetarySocketManufactureError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetManufactureErrors, constructor.new(_6581.PlanetarySocketManufactureError))
        return value
