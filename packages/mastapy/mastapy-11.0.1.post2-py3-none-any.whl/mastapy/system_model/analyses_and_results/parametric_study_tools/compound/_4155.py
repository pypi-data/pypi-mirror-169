...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4153, _4154, _4166
...
class CylindricalGearSetCompoundParametricStudyTool(_4166.GearSetCompoundParametricStudyTool):
    '''CylindricalGearSetCompoundParametricStudyTool
    ...
    @property
    def cylindrical_gears_compound_parametric_study_tool(self) -> 'List[_4153.CylindricalGearCompoundParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsCompoundParametricStudyTool, constructor.new(_4153.CylindricalGearCompoundParametricStudyTool))
        return value

    @property
    def cylindrical_meshes_compound_parametric_study_tool(self) -> 'List[_4154.CylindricalGearMeshCompoundParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesCompoundParametricStudyTool, constructor.new(_4154.CylindricalGearMeshCompoundParametricStudyTool))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4008.CylindricalGearSetParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4008.CylindricalGearSetParametricStudyTool))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4008.CylindricalGearSetParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4008.CylindricalGearSetParametricStudyTool))
        return value
