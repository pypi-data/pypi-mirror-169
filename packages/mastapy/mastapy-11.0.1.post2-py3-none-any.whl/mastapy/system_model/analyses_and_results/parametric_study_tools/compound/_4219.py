...
class SynchroniserCompoundParametricStudyTool(_4204.SpecialisedAssemblyCompoundParametricStudyTool):
    '''SynchroniserCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4091.SynchroniserParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4091.SynchroniserParametricStudyTool))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4091.SynchroniserParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4091.SynchroniserParametricStudyTool))
        return value
