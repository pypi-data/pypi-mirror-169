...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4029, _4028, _3965
...
class HypoidGearSetParametricStudyTool(_3965.AGMAGleasonConicalGearSetParametricStudyTool):
    '''HypoidGearSetParametricStudyTool
    ...
    @property
    def hypoid_gears_parametric_study_tool(self) -> 'List[_4029.HypoidGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsParametricStudyTool, constructor.new(_4029.HypoidGearParametricStudyTool))
        return value
