...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4172, _4171, _4045
...
class ZerolBevelGearSetParametricStudyTool(_4045.BevelGearSetParametricStudyTool):
    '''ZerolBevelGearSetParametricStudyTool
    ...
    @property
    def zerol_bevel_gears_parametric_study_tool(self) -> 'List[_4172.ZerolBevelGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsParametricStudyTool, constructor.new(_4172.ZerolBevelGearParametricStudyTool))
        return value

    @property
    def zerol_bevel_meshes_parametric_study_tool(self) -> 'List[_4171.ZerolBevelGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesParametricStudyTool, constructor.new(_4171.ZerolBevelGearMeshParametricStudyTool))
        return value
