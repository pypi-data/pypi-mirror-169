...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4046, _4043
...
class ParametricStudyVariable(_2323.AnalysisCaseVariable):
    '''ParametricStudyVariable
    ...
    @property
    def dimension(self) -> '_4046.ParametricStudyDimension':
        ...
        return constructor.new(_4046.ParametricStudyDimension)(value) if value else None

    @dimension.setter
    def dimension(self, value: '_4046.ParametricStudyDimension'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.Dimension = value

    @property
    def distribution(self) -> '_4043.MonteCarloDistribution':
        ...
        return constructor.new(_4043.MonteCarloDistribution)(value) if value else None

    @distribution.setter
    def distribution(self, value: '_4043.MonteCarloDistribution'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
