...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4051, _4053, _3966
...
class RootAssemblyParametricStudyTool(_3966.AssemblyParametricStudyTool):
    '''RootAssemblyParametricStudyTool
    ...
    @property
    def parametric_study_tool_inputs(self) -> '_4051.ParametricStudyTool':
        ...
        return constructor.new(_4051.ParametricStudyTool)(self.wrapped.ParametricStudyToolInputs) if self.wrapped.ParametricStudyToolInputs else None
    ...
    @property
    def root_assembly_duty_cycle_results(self) -> 'List[_2570.DutyCycleEfficiencyResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RootAssemblyDutyCycleResults, constructor.new(_2570.DutyCycleEfficiencyResults))
        return value
