...
from mastapy.system_model.analyses_and_results.power_flows import _3813, _3798
...
class SynchroniserPowerFlow(_3798.SpecialisedAssemblyPowerFlow):
    '''SynchroniserPowerFlow
    ...
    @property
    def cones(self) -> 'List[_3813.SynchroniserHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_3813.SynchroniserHalfPowerFlow))
        return value
