...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3877, _3878, _3890
...
class CylindricalGearSetCompoundPowerFlow(_3890.GearSetCompoundPowerFlow):
    '''CylindricalGearSetCompoundPowerFlow
    ...
    @property
    def cylindrical_gears_compound_power_flow(self) -> 'List[_3877.CylindricalGearCompoundPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsCompoundPowerFlow, constructor.new(_3877.CylindricalGearCompoundPowerFlow))
        return value

    @property
    def cylindrical_meshes_compound_power_flow(self) -> 'List[_3878.CylindricalGearMeshCompoundPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesCompoundPowerFlow, constructor.new(_3878.CylindricalGearMeshCompoundPowerFlow))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3747.CylindricalGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3747.CylindricalGearSetPowerFlow))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3747.CylindricalGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3747.CylindricalGearSetPowerFlow))
        return value
