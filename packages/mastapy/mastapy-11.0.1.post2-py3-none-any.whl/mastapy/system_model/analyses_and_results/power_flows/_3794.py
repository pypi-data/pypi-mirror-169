...
from mastapy.system_model.analyses_and_results.power_flows import _3785, _3704
...
class RootAssemblyPowerFlow(_3704.AssemblyPowerFlow):
    '''RootAssemblyPowerFlow
    ...
    @property
    def power_flow_inputs(self) -> '_3785.PowerFlow':
        ...
        return constructor.new(_3785.PowerFlow)(self.wrapped.PowerFlowInputs) if self.wrapped.PowerFlowInputs else None
