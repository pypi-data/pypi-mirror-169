...
class SingleAnalysis:
    ...
    def perform_analysis_with_progress(self, task_progress: '_7205.TaskProgress'):
        ''' 'PerformAnalysis' is the original name of this method.
    ...
    def results_for(self, design_entity: '_1892.DesignEntity') -> '_2326.DesignEntityAnalysis':
    ...
    def results_for_design_entity_analysis(self, design_entity_analysis: '_2326.DesignEntityAnalysis') -> '_2326.DesignEntityAnalysis':
        ''' 'ResultsFor' is the original name of this method.
