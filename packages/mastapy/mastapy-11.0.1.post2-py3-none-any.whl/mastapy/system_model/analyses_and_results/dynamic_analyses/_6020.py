...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _2302, _5932
...
class RootAssemblyDynamicAnalysis(_5932.AssemblyDynamicAnalysis):
    '''RootAssemblyDynamicAnalysis
    ...
    @property
    def dynamic_analysis_inputs(self) -> '_2302.DynamicAnalysis':
        ...
        if _2302.DynamicAnalysis.TYPE not in self.wrapped.DynamicAnalysisInputs.__class__.__mro__:
