...
class SynchroniserCompoundDynamicAnalysis(_6153.SpecialisedAssemblyCompoundDynamicAnalysis):
    '''SynchroniserCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6039.SynchroniserDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6039.SynchroniserDynamicAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_6039.SynchroniserDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6039.SynchroniserDynamicAnalysis))
        return value
