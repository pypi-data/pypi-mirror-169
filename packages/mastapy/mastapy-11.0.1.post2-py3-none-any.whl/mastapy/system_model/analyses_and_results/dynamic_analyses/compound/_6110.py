...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6108, _6109, _6115
...
class FaceGearSetCompoundDynamicAnalysis(_6115.GearSetCompoundDynamicAnalysis):
    '''FaceGearSetCompoundDynamicAnalysis
    ...
    @property
    def face_gears_compound_dynamic_analysis(self) -> 'List[_6108.FaceGearCompoundDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsCompoundDynamicAnalysis, constructor.new(_6108.FaceGearCompoundDynamicAnalysis))
        return value

    @property
    def face_meshes_compound_dynamic_analysis(self) -> 'List[_6109.FaceGearMeshCompoundDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesCompoundDynamicAnalysis, constructor.new(_6109.FaceGearMeshCompoundDynamicAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5981.FaceGearSetDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5981.FaceGearSetDynamicAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_5981.FaceGearSetDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5981.FaceGearSetDynamicAnalysis))
        return value
