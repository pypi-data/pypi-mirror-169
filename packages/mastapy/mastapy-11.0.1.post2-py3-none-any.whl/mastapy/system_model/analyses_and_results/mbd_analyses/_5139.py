...
from mastapy.system_model.analyses_and_results.mbd_analyses import _2314, _5042
...
class RootAssemblyMultibodyDynamicsAnalysis(_5042.AssemblyMultibodyDynamicsAnalysis):
    '''RootAssemblyMultibodyDynamicsAnalysis
    ...
    @property
    def multibody_dynamics_analysis_inputs(self) -> '_2314.MultibodyDynamicsAnalysis':
        ...
        return constructor.new(_2314.MultibodyDynamicsAnalysis)(self.wrapped.MultibodyDynamicsAnalysisInputs) if self.wrapped.MultibodyDynamicsAnalysisInputs else None
