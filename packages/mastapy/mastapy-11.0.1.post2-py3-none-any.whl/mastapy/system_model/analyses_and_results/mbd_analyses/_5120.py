...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5106, _5145, _5140
...
class MBDRunUpAnalysisOptions(_7184.AbstractAnalysisOptions['_6621.TimeSeriesLoadCase']):
    '''MBDRunUpAnalysisOptions
    ...
    @property
    def input_velocity_processing_type(self) -> '_5106.InputVelocityForRunUpProcessingType':
        ...
        return constructor.new(_5106.InputVelocityForRunUpProcessingType)(value) if value else None

    @input_velocity_processing_type.setter
    def input_velocity_processing_type(self, value: '_5106.InputVelocityForRunUpProcessingType'):
    ...
    @property
    def shape_of_initial_acceleration_period(self) -> '_5145.ShapeOfInitialAccelerationPeriodForRunUp':
        ...
        return constructor.new(_5145.ShapeOfInitialAccelerationPeriodForRunUp)(value) if value else None

    @shape_of_initial_acceleration_period.setter
    def shape_of_initial_acceleration_period(self, value: '_5145.ShapeOfInitialAccelerationPeriodForRunUp'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ShapeOfInitialAccelerationPeriod = value

    @property
    def run_up_driving_mode(self) -> '_5140.RunUpDrivingMode':
        ...
        return constructor.new(_5140.RunUpDrivingMode)(value) if value else None

    @run_up_driving_mode.setter
    def run_up_driving_mode(self, value: '_5140.RunUpDrivingMode'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
