...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5097, _5095, _5146
...
class GearSetMultibodyDynamicsAnalysis(_5146.SpecialisedAssemblyMultibodyDynamicsAnalysis):
    '''GearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5097.GearMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_5097.GearMultibodyDynamicsAnalysis))
        return value

    @property
    def meshes(self) -> 'List[_5095.GearMeshMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_5095.GearMeshMultibodyDynamicsAnalysis))
        return value
