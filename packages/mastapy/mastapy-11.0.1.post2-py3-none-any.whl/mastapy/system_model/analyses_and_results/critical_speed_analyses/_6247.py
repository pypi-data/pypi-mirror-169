...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6245, _6246, _6252
...
class FaceGearSetCriticalSpeedAnalysis(_6252.GearSetCriticalSpeedAnalysis):
    '''FaceGearSetCriticalSpeedAnalysis
    ...
    @property
    def face_gears_critical_speed_analysis(self) -> 'List[_6245.FaceGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsCriticalSpeedAnalysis, constructor.new(_6245.FaceGearCriticalSpeedAnalysis))
        return value

    @property
    def face_meshes_critical_speed_analysis(self) -> 'List[_6246.FaceGearMeshCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesCriticalSpeedAnalysis, constructor.new(_6246.FaceGearMeshCriticalSpeedAnalysis))
        return value
