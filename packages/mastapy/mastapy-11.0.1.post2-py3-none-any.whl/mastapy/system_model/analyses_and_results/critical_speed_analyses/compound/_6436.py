...
class SynchroniserPartCompoundCriticalSpeedAnalysis(_6360.CouplingHalfCompoundCriticalSpeedAnalysis):
    '''SynchroniserPartCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6307.SynchroniserPartCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6307.SynchroniserPartCriticalSpeedAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_6307.SynchroniserPartCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6307.SynchroniserPartCriticalSpeedAnalysis))
        return value
