...
class GuideDxfModelCompoundSteadyStateSynchronousResponseOnAShaft(_2805.ComponentCompoundSteadyStateSynchronousResponseOnAShaft):
    '''GuideDxfModelCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2711.GuideDxfModelSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2711.GuideDxfModelSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2711.GuideDxfModelSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2711.GuideDxfModelSteadyStateSynchronousResponseOnAShaft))
        return value
