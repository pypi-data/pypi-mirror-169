...
class StraightBevelDiffGearCompoundSteadyStateSynchronousResponseOnAShaft(_2796.BevelGearCompoundSteadyStateSynchronousResponseOnAShaft):
    '''StraightBevelDiffGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2758.StraightBevelDiffGearSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2758.StraightBevelDiffGearSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2758.StraightBevelDiffGearSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2758.StraightBevelDiffGearSteadyStateSynchronousResponseOnAShaft))
        return value
