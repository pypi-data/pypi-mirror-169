...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _2375
...
class HarmonicAnalysisForAdvancedTimeSteppingAnalysisForModulation(_2375.HarmonicAnalysis):
    '''HarmonicAnalysisForAdvancedTimeSteppingAnalysisForModulation
