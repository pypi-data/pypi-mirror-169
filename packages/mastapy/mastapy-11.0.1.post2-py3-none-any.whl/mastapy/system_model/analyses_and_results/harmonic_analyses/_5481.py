...
class GearMeshHarmonicAnalysis(_5496.InterMountableComponentConnectionHarmonicAnalysis):
    '''GearMeshHarmonicAnalysis
    ...
    @property
    def tooth_passing_harmonics(self) -> 'List[_3888.ToothPassingHarmonic]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ToothPassingHarmonics, constructor.new(_3888.ToothPassingHarmonic))
        return value
