...
from mastapy.system_model.analyses_and_results.system_deflections import _2361, _2407, _2471
...
class AbstractShaftHarmonicAnalysis(_5597.AbstractShaftOrHousingHarmonicAnalysis):
    '''AbstractShaftHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2361.AbstractShaftSystemDeflection':
