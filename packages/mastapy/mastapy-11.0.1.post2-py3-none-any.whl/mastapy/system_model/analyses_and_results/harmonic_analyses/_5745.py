...
class VirtualComponentHarmonicAnalysis(_5696.MountableComponentHarmonicAnalysis):
    '''VirtualComponentHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2502.VirtualComponentSystemDeflection':
