...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5720, _5666
...
class HarmonicAnalysisOptions(_0.APIBase):
    ...
    @property
    def modal_analysis_options(self) -> '_4833.ModalAnalysisOptions':
        ...
        return constructor.new(_4833.ModalAnalysisOptions)(self.wrapped.ModalAnalysisOptions) if self.wrapped.ModalAnalysisOptions else None
