...
class CylindricalGearMeshHarmonicAnalysis(_5669.GearMeshHarmonicAnalysis):
    '''CylindricalGearMeshHarmonicAnalysis
    ...
    @property
    def advanced_system_deflection_results(self) -> '_6970.CylindricalGearMeshAdvancedSystemDeflection':
        ...
        return constructor.new(_6970.CylindricalGearMeshAdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflectionResults) if self.wrapped.AdvancedSystemDeflectionResults else None
