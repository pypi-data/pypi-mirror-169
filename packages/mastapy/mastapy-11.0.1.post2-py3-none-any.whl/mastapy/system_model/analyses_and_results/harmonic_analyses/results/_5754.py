...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5759, _5755
...
class ExcitationSourceSelection(_5755.ExcitationSourceSelectionBase):
    ...
    @property
    def harmonic_selections(self) -> 'List[_5759.HarmonicSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HarmonicSelections, constructor.new(_5759.HarmonicSelection))
        return value
