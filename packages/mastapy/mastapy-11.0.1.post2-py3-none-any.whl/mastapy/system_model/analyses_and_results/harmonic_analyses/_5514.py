...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5407
...
class PeriodicExcitationWithReferenceShaft(_5407.AbstractPeriodicExcitationDetail):
    '''PeriodicExcitationWithReferenceShaft
