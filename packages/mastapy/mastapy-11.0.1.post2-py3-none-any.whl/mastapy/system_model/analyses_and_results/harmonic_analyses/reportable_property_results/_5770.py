...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5780, _5766
...
class FEPartSingleWhineAnalysisResultsPropertyAccessor(_5766.AbstractSingleWhineAnalysisResultsPropertyAccessor):
    '''FEPartSingleWhineAnalysisResultsPropertyAccessor
    ...
    @property
    def orders(self) -> 'List[_5780.ResultsForOrderIncludingSurfaces]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Orders, constructor.new(_5780.ResultsForOrderIncludingSurfaces))
        return value
