...
from mastapy.system_model.analyses_and_results.stability_analyses import _3540, _3538, _3447
...
class StraightBevelDiffGearSetStabilityAnalysis(_3447.BevelGearSetStabilityAnalysis):
    '''StraightBevelDiffGearSetStabilityAnalysis
    ...
    @property
    def straight_bevel_diff_gears_stability_analysis(self) -> 'List[_3540.StraightBevelDiffGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsStabilityAnalysis, constructor.new(_3540.StraightBevelDiffGearStabilityAnalysis))
        return value

    @property
    def straight_bevel_diff_meshes_stability_analysis(self) -> 'List[_3538.StraightBevelDiffGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesStabilityAnalysis, constructor.new(_3538.StraightBevelDiffGearMeshStabilityAnalysis))
        return value
