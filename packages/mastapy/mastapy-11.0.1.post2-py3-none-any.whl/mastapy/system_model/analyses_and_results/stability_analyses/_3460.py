...
from mastapy.system_model.analyses_and_results.stability_analyses import _3461, _3459, _3490
...
class ConceptGearSetStabilityAnalysis(_3490.GearSetStabilityAnalysis):
    '''ConceptGearSetStabilityAnalysis
    ...
    @property
    def concept_gears_stability_analysis(self) -> 'List[_3461.ConceptGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsStabilityAnalysis, constructor.new(_3461.ConceptGearStabilityAnalysis))
        return value

    @property
    def concept_meshes_stability_analysis(self) -> 'List[_3459.ConceptGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesStabilityAnalysis, constructor.new(_3459.ConceptGearMeshStabilityAnalysis))
        return value
