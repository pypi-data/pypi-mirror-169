...
from mastapy.system_model.analyses_and_results.stability_analyses import _3470, _3432
...
class ShaftStabilityAnalysis(_3432.AbstractShaftStabilityAnalysis):
    '''ShaftStabilityAnalysis
    ...
    @property
    def critical_speeds(self) -> 'List[_3470.CriticalSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CriticalSpeeds, constructor.new(_3470.CriticalSpeed))
        return value
