...
class CVTCompoundStabilityAnalysis(_3572.BeltDriveCompoundStabilityAnalysis):
    '''CVTCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3473.CVTStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3473.CVTStabilityAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3473.CVTStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3473.CVTStabilityAnalysis))
        return value
