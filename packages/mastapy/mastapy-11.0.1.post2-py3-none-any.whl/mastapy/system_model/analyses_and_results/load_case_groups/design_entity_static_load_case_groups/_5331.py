...
TConnection = TypeVar('TConnection', bound='_1953.Connection')
TConnectionStaticLoad = TypeVar('TConnectionStaticLoad', bound='_6493.ConnectionLoadCase')


class ConnectionStaticLoadCaseGroup(_5332.DesignEntityStaticLoadCaseGroup, Generic[TConnection, TConnectionStaticLoad]):
    '''ConnectionStaticLoadCaseGroup
