...
from mastapy.system_model.part_model import _2117, _2138
...
class LoadSharingSettings(_0.APIBase):
    ...
    @property
    def planetary_load_sharing_agma_application_level(self) -> '_2117.AGMALoadSharingTableApplicationLevel':
        ...
        return constructor.new(_2117.AGMALoadSharingTableApplicationLevel)(value) if value else None

    @planetary_load_sharing_agma_application_level.setter
    def planetary_load_sharing_agma_application_level(self, value: '_2117.AGMALoadSharingTableApplicationLevel'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.PlanetaryLoadSharingAGMAApplicationLevel = value

    @property
    def planetary_load_sharing(self) -> '_2138.LoadSharingModes':
        ...
        return constructor.new(_2138.LoadSharingModes)(value) if value else None

    @planetary_load_sharing.setter
    def planetary_load_sharing(self, value: '_2138.LoadSharingModes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
