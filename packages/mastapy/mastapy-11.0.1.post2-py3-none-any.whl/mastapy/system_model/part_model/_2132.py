...
class FlexiblePinAssembly(_2154.SpecialisedAssembly):
    '''FlexiblePinAssembly
    ...
    @property
    def planet_gear(self) -> '_2201.CylindricalGear':
        ...
        if _2201.CylindricalGear.TYPE not in self.wrapped.PlanetGear.__class__.__mro__:
