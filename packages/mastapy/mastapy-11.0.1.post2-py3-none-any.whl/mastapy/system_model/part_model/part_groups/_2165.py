...
from mastapy.system_model.part_model.part_groups import _2163, _2164, _2167
...
class ConcentricPartGroupParallelToThis(_0.APIBase):
    ...
    @property
    def parallel_group(self) -> '_2163.ConcentricOrParallelPartGroup':
        ...
        if _2163.ConcentricOrParallelPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
    ...
    @property
    def parallel_group_of_type_concentric_part_group(self) -> '_2164.ConcentricPartGroup':
        ...
        if _2164.ConcentricPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
    ...
    @property
    def parallel_group_of_type_parallel_part_group(self) -> '_2167.ParallelPartGroup':
        ...
        if _2167.ParallelPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
