...
from mastapy.system_model.connections_and_sockets import (
    _1957, _1947, _1948, _1955,
    _1960, _1961, _1963, _1964,
    _1965, _1966, _1967, _1969,
...
from mastapy.system_model.connections_and_sockets.gears import (
    _1991, _1980, _1982, _1984,
    _1986, _1988, _1990, _1992,
    _1994, _1996, _1999, _2000,
    _2001, _2004, _2006, _2008,
    _2010, _2012
)
from mastapy.system_model.connections_and_sockets.cycloidal import (
    _2014, _2015, _2017, _2018,
    _2020, _2021, _2016, _2019,
    _2022
)
from mastapy.system_model.connections_and_sockets.couplings import (
    _2024, _2026, _2028, _2030,
    _2032, _2034, _2035, _2023,
    _2025, _2027, _2029, _2031,
    _2033
)
from mastapy.system_model.part_model import _2115, _2124, _2123
...
class MountableComponent(_2123.Component):
    '''MountableComponent
    ...
    @property
    def inner_socket(self) -> '_1957.CylindricalSocket':
        ...
        if _1957.CylindricalSocket.TYPE not in self.wrapped.InnerSocket.__class__.__mro__:
    ...
    @property
    def inner_socket_of_type_bearing_inner_socket(self) -> '_1947.BearingInnerSocket':
        ...
        if _1947.BearingInnerSocket.TYPE not in self.wrapped.InnerSocket.__class__.__mro__:
    ...
    @property
    def inner_socket_of_type_bearing_outer_socket(self) -> '_1948.BearingOuterSocket':
        ...
        if _1948.BearingOuterSocket.TYPE not in self.wrapped.InnerSocket.__class__.__mro__:
    ...
    @property
    def inner_socket_of_type_cvt_pulley_socket(self) -> '_1955.CVTPulleySocket':
        ...
        if _1955.CVTPulleySocket.TYPE not in self.wrapped.InnerSocket.__class__.__mro__:
    ...
    @property
    def inner_socket_of_type_inner_shaft_socket(self) -> '_1960.InnerShaftSocket':
        ...
        if _1960.InnerShaftSocket.TYPE not in self.wrapped.InnerSocket.__class__.__mro__:
    ...
    @property
    def inner_socket_of_type_inner_shaft_socket_base(self) -> '_1961.InnerShaftSocketBase':
        ...
        if _1961.InnerShaftSocketBase.TYPE not in self.wrapped.InnerSocket.__class__.__mro__:
    ...
    @property
    def inner_socket_of_type_mountable_component_inner_socket(self) -> '_1963.MountableComponentInnerSocket':
        ...
        if _1963.MountableComponentInnerSocket.TYPE not in self.wrapped.InnerSocket.__class__.__mro__:
    ...
    @property
    def inner_socket_of_type_mountable_component_outer_socket(self) -> '_1964.MountableComponentOuterSocket':
        ...
        if _1964.MountableComponentOuterSocket.TYPE not in self.wrapped.InnerSocket.__class__.__mro__:
    ...
    @property
    def inner_socket_of_type_mountable_component_socket(self) -> '_1965.MountableComponentSocket':
        ...
        if _1965.MountableComponentSocket.TYPE not in self.wrapped.InnerSocket.__class__.__mro__:
    ...
    @property
    def inner_socket_of_type_outer_shaft_socket(self) -> '_1966.OuterShaftSocket':
        ...
        if _1966.OuterShaftSocket.TYPE not in self.wrapped.InnerSocket.__class__.__mro__:
    ...
    @property
    def inner_socket_of_type_outer_shaft_socket_base(self) -> '_1967.OuterShaftSocketBase':
        ...
        if _1967.OuterShaftSocketBase.TYPE not in self.wrapped.InnerSocket.__class__.__mro__:
    ...
    @property
    def inner_socket_of_type_planetary_socket(self) -> '_1969.PlanetarySocket':
        ...
        if _1969.PlanetarySocket.TYPE not in self.wrapped.InnerSocket.__class__.__mro__:
    ...
    @property
    def inner_socket_of_type_planetary_socket_base(self) -> '_1970.PlanetarySocketBase':
        ...
        if _1970.PlanetarySocketBase.TYPE not in self.wrapped.InnerSocket.__class__.__mro__:
    ...
    @property
    def inner_socket_of_type_pulley_socket(self) -> '_1971.PulleySocket':
        ...
        if _1971.PulleySocket.TYPE not in self.wrapped.InnerSocket.__class__.__mro__:
    ...
    @property
    def inner_socket_of_type_rolling_ring_socket(self) -> '_1974.RollingRingSocket':
        ...
        if _1974.RollingRingSocket.TYPE not in self.wrapped.InnerSocket.__class__.__mro__:
    ...
    @property
    def inner_socket_of_type_shaft_socket(self) -> '_1975.ShaftSocket':
        ...
        if _1975.ShaftSocket.TYPE not in self.wrapped.InnerSocket.__class__.__mro__:
    ...
    @property
    def inner_socket_of_type_cylindrical_gear_teeth_socket(self) -> '_1991.CylindricalGearTeethSocket':
        ...
        if _1991.CylindricalGearTeethSocket.TYPE not in self.wrapped.InnerSocket.__class__.__mro__:
    ...
    @property
    def inner_socket_of_type_cycloidal_disc_axial_left_socket(self) -> '_2014.CycloidalDiscAxialLeftSocket':
        ...
        if _2014.CycloidalDiscAxialLeftSocket.TYPE not in self.wrapped.InnerSocket.__class__.__mro__:
    ...
    @property
    def inner_socket_of_type_cycloidal_disc_axial_right_socket(self) -> '_2015.CycloidalDiscAxialRightSocket':
        ...
        if _2015.CycloidalDiscAxialRightSocket.TYPE not in self.wrapped.InnerSocket.__class__.__mro__:
    ...
    @property
    def inner_socket_of_type_cycloidal_disc_inner_socket(self) -> '_2017.CycloidalDiscInnerSocket':
        ...
        if _2017.CycloidalDiscInnerSocket.TYPE not in self.wrapped.InnerSocket.__class__.__mro__:
    ...
    @property
    def inner_socket_of_type_cycloidal_disc_outer_socket(self) -> '_2018.CycloidalDiscOuterSocket':
        ...
        if _2018.CycloidalDiscOuterSocket.TYPE not in self.wrapped.InnerSocket.__class__.__mro__:
    ...
    @property
    def inner_socket_of_type_cycloidal_disc_planetary_bearing_socket(self) -> '_2020.CycloidalDiscPlanetaryBearingSocket':
        ...
        if _2020.CycloidalDiscPlanetaryBearingSocket.TYPE not in self.wrapped.InnerSocket.__class__.__mro__:
    ...
    @property
    def inner_socket_of_type_ring_pins_socket(self) -> '_2021.RingPinsSocket':
        ...
        if _2021.RingPinsSocket.TYPE not in self.wrapped.InnerSocket.__class__.__mro__:
    ...
    @property
    def inner_socket_of_type_clutch_socket(self) -> '_2024.ClutchSocket':
        ...
        if _2024.ClutchSocket.TYPE not in self.wrapped.InnerSocket.__class__.__mro__:
    ...
    @property
    def inner_socket_of_type_concept_coupling_socket(self) -> '_2026.ConceptCouplingSocket':
        ...
        if _2026.ConceptCouplingSocket.TYPE not in self.wrapped.InnerSocket.__class__.__mro__:
    ...
    @property
    def inner_socket_of_type_coupling_socket(self) -> '_2028.CouplingSocket':
        ...
        if _2028.CouplingSocket.TYPE not in self.wrapped.InnerSocket.__class__.__mro__:
    ...
    @property
    def inner_socket_of_type_part_to_part_shear_coupling_socket(self) -> '_2030.PartToPartShearCouplingSocket':
        ...
        if _2030.PartToPartShearCouplingSocket.TYPE not in self.wrapped.InnerSocket.__class__.__mro__:
    ...
    @property
    def inner_socket_of_type_spring_damper_socket(self) -> '_2032.SpringDamperSocket':
        ...
        if _2032.SpringDamperSocket.TYPE not in self.wrapped.InnerSocket.__class__.__mro__:
    ...
    @property
    def inner_socket_of_type_torque_converter_pump_socket(self) -> '_2034.TorqueConverterPumpSocket':
        ...
        if _2034.TorqueConverterPumpSocket.TYPE not in self.wrapped.InnerSocket.__class__.__mro__:
    ...
    @property
    def inner_socket_of_type_torque_converter_turbine_socket(self) -> '_2035.TorqueConverterTurbineSocket':
        ...
        if _2035.TorqueConverterTurbineSocket.TYPE not in self.wrapped.InnerSocket.__class__.__mro__:
    ...
    @property
    def inner_connection(self) -> '_1953.Connection':
        ...
        if _1953.Connection.TYPE not in self.wrapped.InnerConnection.__class__.__mro__:
    ...
    @property
    def inner_connection_of_type_abstract_shaft_to_mountable_component_connection(self) -> '_1946.AbstractShaftToMountableComponentConnection':
        ...
        if _1946.AbstractShaftToMountableComponentConnection.TYPE not in self.wrapped.InnerConnection.__class__.__mro__:
    ...
    @property
    def inner_connection_of_type_belt_connection(self) -> '_1949.BeltConnection':
        ...
        if _1949.BeltConnection.TYPE not in self.wrapped.InnerConnection.__class__.__mro__:
    ...
    @property
    def inner_connection_of_type_coaxial_connection(self) -> '_1950.CoaxialConnection':
        ...
        if _1950.CoaxialConnection.TYPE not in self.wrapped.InnerConnection.__class__.__mro__:
    ...
    @property
    def inner_connection_of_type_cvt_belt_connection(self) -> '_1954.CVTBeltConnection':
        ...
        if _1954.CVTBeltConnection.TYPE not in self.wrapped.InnerConnection.__class__.__mro__:
    ...
    @property
    def inner_connection_of_type_inter_mountable_component_connection(self) -> '_1962.InterMountableComponentConnection':
        ...
        if _1962.InterMountableComponentConnection.TYPE not in self.wrapped.InnerConnection.__class__.__mro__:
    ...
    @property
    def inner_connection_of_type_planetary_connection(self) -> '_1968.PlanetaryConnection':
        ...
        if _1968.PlanetaryConnection.TYPE not in self.wrapped.InnerConnection.__class__.__mro__:
    ...
    @property
    def inner_connection_of_type_rolling_ring_connection(self) -> '_1973.RollingRingConnection':
        ...
        if _1973.RollingRingConnection.TYPE not in self.wrapped.InnerConnection.__class__.__mro__:
    ...
    @property
    def inner_connection_of_type_shaft_to_mountable_component_connection(self) -> '_1976.ShaftToMountableComponentConnection':
        ...
        if _1976.ShaftToMountableComponentConnection.TYPE not in self.wrapped.InnerConnection.__class__.__mro__:
    ...
    @property
    def inner_connection_of_type_agma_gleason_conical_gear_mesh(self) -> '_1980.AGMAGleasonConicalGearMesh':
        ...
        if _1980.AGMAGleasonConicalGearMesh.TYPE not in self.wrapped.InnerConnection.__class__.__mro__:
    ...
    @property
    def inner_connection_of_type_bevel_differential_gear_mesh(self) -> '_1982.BevelDifferentialGearMesh':
        ...
        if _1982.BevelDifferentialGearMesh.TYPE not in self.wrapped.InnerConnection.__class__.__mro__:
    ...
    @property
    def inner_connection_of_type_bevel_gear_mesh(self) -> '_1984.BevelGearMesh':
        ...
        if _1984.BevelGearMesh.TYPE not in self.wrapped.InnerConnection.__class__.__mro__:
    ...
    @property
    def inner_connection_of_type_concept_gear_mesh(self) -> '_1986.ConceptGearMesh':
        ...
        if _1986.ConceptGearMesh.TYPE not in self.wrapped.InnerConnection.__class__.__mro__:
    ...
    @property
    def inner_connection_of_type_conical_gear_mesh(self) -> '_1988.ConicalGearMesh':
        ...
        if _1988.ConicalGearMesh.TYPE not in self.wrapped.InnerConnection.__class__.__mro__:
    ...
    @property
    def inner_connection_of_type_cylindrical_gear_mesh(self) -> '_1990.CylindricalGearMesh':
        ...
        if _1990.CylindricalGearMesh.TYPE not in self.wrapped.InnerConnection.__class__.__mro__:
    ...
    @property
    def inner_connection_of_type_face_gear_mesh(self) -> '_1992.FaceGearMesh':
        ...
        if _1992.FaceGearMesh.TYPE not in self.wrapped.InnerConnection.__class__.__mro__:
    ...
    @property
    def inner_connection_of_type_gear_mesh(self) -> '_1994.GearMesh':
        ...
        if _1994.GearMesh.TYPE not in self.wrapped.InnerConnection.__class__.__mro__:
    ...
    @property
    def inner_connection_of_type_hypoid_gear_mesh(self) -> '_1996.HypoidGearMesh':
        ...
        if _1996.HypoidGearMesh.TYPE not in self.wrapped.InnerConnection.__class__.__mro__:
    ...
    @property
    def inner_connection_of_type_klingelnberg_cyclo_palloid_conical_gear_mesh(self) -> '_1999.KlingelnbergCycloPalloidConicalGearMesh':
        ...
        if _1999.KlingelnbergCycloPalloidConicalGearMesh.TYPE not in self.wrapped.InnerConnection.__class__.__mro__:
    ...
    @property
    def inner_connection_of_type_klingelnberg_cyclo_palloid_hypoid_gear_mesh(self) -> '_2000.KlingelnbergCycloPalloidHypoidGearMesh':
        ...
        if _2000.KlingelnbergCycloPalloidHypoidGearMesh.TYPE not in self.wrapped.InnerConnection.__class__.__mro__:
    ...
    @property
    def inner_connection_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_mesh(self) -> '_2001.KlingelnbergCycloPalloidSpiralBevelGearMesh':
        ...
        if _2001.KlingelnbergCycloPalloidSpiralBevelGearMesh.TYPE not in self.wrapped.InnerConnection.__class__.__mro__:
    ...
    @property
    def inner_connection_of_type_spiral_bevel_gear_mesh(self) -> '_2004.SpiralBevelGearMesh':
        ...
        if _2004.SpiralBevelGearMesh.TYPE not in self.wrapped.InnerConnection.__class__.__mro__:
    ...
    @property
    def inner_connection_of_type_straight_bevel_diff_gear_mesh(self) -> '_2006.StraightBevelDiffGearMesh':
        ...
        if _2006.StraightBevelDiffGearMesh.TYPE not in self.wrapped.InnerConnection.__class__.__mro__:
    ...
    @property
    def inner_connection_of_type_straight_bevel_gear_mesh(self) -> '_2008.StraightBevelGearMesh':
        ...
        if _2008.StraightBevelGearMesh.TYPE not in self.wrapped.InnerConnection.__class__.__mro__:
    ...
    @property
    def inner_connection_of_type_worm_gear_mesh(self) -> '_2010.WormGearMesh':
        ...
        if _2010.WormGearMesh.TYPE not in self.wrapped.InnerConnection.__class__.__mro__:
    ...
    @property
    def inner_connection_of_type_zerol_bevel_gear_mesh(self) -> '_2012.ZerolBevelGearMesh':
        ...
        if _2012.ZerolBevelGearMesh.TYPE not in self.wrapped.InnerConnection.__class__.__mro__:
    ...
    @property
    def inner_connection_of_type_cycloidal_disc_central_bearing_connection(self) -> '_2016.CycloidalDiscCentralBearingConnection':
        ...
        if _2016.CycloidalDiscCentralBearingConnection.TYPE not in self.wrapped.InnerConnection.__class__.__mro__:
    ...
    @property
    def inner_connection_of_type_cycloidal_disc_planetary_bearing_connection(self) -> '_2019.CycloidalDiscPlanetaryBearingConnection':
        ...
        if _2019.CycloidalDiscPlanetaryBearingConnection.TYPE not in self.wrapped.InnerConnection.__class__.__mro__:
    ...
    @property
    def inner_connection_of_type_ring_pins_to_disc_connection(self) -> '_2022.RingPinsToDiscConnection':
        ...
        if _2022.RingPinsToDiscConnection.TYPE not in self.wrapped.InnerConnection.__class__.__mro__:
    ...
    @property
    def inner_connection_of_type_clutch_connection(self) -> '_2023.ClutchConnection':
        ...
        if _2023.ClutchConnection.TYPE not in self.wrapped.InnerConnection.__class__.__mro__:
    ...
    @property
    def inner_connection_of_type_concept_coupling_connection(self) -> '_2025.ConceptCouplingConnection':
        ...
        if _2025.ConceptCouplingConnection.TYPE not in self.wrapped.InnerConnection.__class__.__mro__:
    ...
    @property
    def inner_connection_of_type_coupling_connection(self) -> '_2027.CouplingConnection':
        ...
        if _2027.CouplingConnection.TYPE not in self.wrapped.InnerConnection.__class__.__mro__:
    ...
    @property
    def inner_connection_of_type_part_to_part_shear_coupling_connection(self) -> '_2029.PartToPartShearCouplingConnection':
        ...
        if _2029.PartToPartShearCouplingConnection.TYPE not in self.wrapped.InnerConnection.__class__.__mro__:
    ...
    @property
    def inner_connection_of_type_spring_damper_connection(self) -> '_2031.SpringDamperConnection':
        ...
        if _2031.SpringDamperConnection.TYPE not in self.wrapped.InnerConnection.__class__.__mro__:
    ...
    @property
    def inner_connection_of_type_torque_converter_connection(self) -> '_2033.TorqueConverterConnection':
        ...
        if _2033.TorqueConverterConnection.TYPE not in self.wrapped.InnerConnection.__class__.__mro__:
    ...
    @property
    def inner_component(self) -> '_2115.AbstractShaft':
        ...
        if _2115.AbstractShaft.TYPE not in self.wrapped.InnerComponent.__class__.__mro__:
    ...
    @property
    def inner_component_of_type_shaft(self) -> '_2159.Shaft':
        ...
        if _2159.Shaft.TYPE not in self.wrapped.InnerComponent.__class__.__mro__:
    ...
    @property
    def inner_component_of_type_cycloidal_disc(self) -> '_2245.CycloidalDisc':
        ...
        if _2245.CycloidalDisc.TYPE not in self.wrapped.InnerComponent.__class__.__mro__:
    ...
    def try_mount_on(self, shaft: '_2115.AbstractShaft', offset: Optional['float'] = float('nan')) -> '_2124.ComponentsConnectedResult':
    ...
    def mount_on(self, shaft: '_2115.AbstractShaft', offset: Optional['float'] = float('nan')) -> '_1950.CoaxialConnection':
