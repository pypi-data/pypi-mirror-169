...
class SplineLeadRelief(_0.APIBase):
    ...
    @property
    def crowning(self) -> '_2261.CrowningSpecification':
        ...
        return constructor.new(_2261.CrowningSpecification)(self.wrapped.Crowning) if self.wrapped.Crowning else None
