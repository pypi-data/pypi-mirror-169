...
class PartToPartShearCoupling(_2259.Coupling):
    '''PartToPartShearCoupling
    ...
    @property
    def part_to_part_shear_coupling_connection(self) -> '_2029.PartToPartShearCouplingConnection':
        ...
        return constructor.new(_2029.PartToPartShearCouplingConnection)(self.wrapped.PartToPartShearCouplingConnection) if self.wrapped.PartToPartShearCouplingConnection else None
