...
class SpringDamper(_2259.Coupling):
    '''SpringDamper
    ...
    @property
    def connection(self) -> '_2031.SpringDamperConnection':
        ...
        return constructor.new(_2031.SpringDamperConnection)(self.wrapped.Connection) if self.wrapped.Connection else None
