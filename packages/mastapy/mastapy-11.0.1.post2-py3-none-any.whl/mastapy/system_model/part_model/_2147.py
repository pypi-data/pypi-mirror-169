...
from mastapy.system_model.part_model import _2139, _2142
...
class PlanetCarrier(_2142.MountableComponent):
    '''PlanetCarrier
    ...
    @property
    def planetary_sockets(self) -> 'List[_1969.PlanetarySocket]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetarySockets, constructor.new(_1969.PlanetarySocket))
        return value

    def attach_carrier_shaft(self, shaft: '_2159.Shaft', offset: Optional['float'] = float('nan')):
    ...
    def attach_pin_shaft(self, shaft: '_2159.Shaft', offset: Optional['float'] = float('nan')):
