...
from mastapy.system_model.part_model.gears import _2195, _2196
...
class BevelDifferentialGearSet(_2196.BevelGearSet):
    '''BevelDifferentialGearSet
    ...
    @property
    def conical_gear_set_design(self) -> '_1094.BevelGearSetDesign':
    ...
    @property
    def bevel_gear_set_design(self) -> '_1094.BevelGearSetDesign':
        ...
        if _1094.BevelGearSetDesign.TYPE not in self.wrapped.BevelGearSetDesign.__class__.__mro__:
    ...
    @property
    def bevel_gears(self) -> 'List[_2195.BevelGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelGears, constructor.new(_2195.BevelGear))
        return value

    @property
    def bevel_meshes(self) -> 'List[_1984.BevelGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelMeshes, constructor.new(_1984.BevelGearMesh))
        return value
