...
from mastapy.system_model.part_model.gears import _2227, _2208
...
class WormGearSet(_2208.GearSet):
    '''WormGearSet
    ...
    @property
    def worm_gears(self) -> 'List[_2227.WormGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGears, constructor.new(_2227.WormGear))
        return value

    @property
    def worm_meshes(self) -> 'List[_2010.WormGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshes, constructor.new(_2010.WormGearMesh))
        return value
