...
class BevelGear(_2189.AGMAGleasonConicalGear):
    '''BevelGear
    ...
    @property
    def conical_gear_design(self) -> '_1092.BevelGearDesign':
    ...
    @property
    def bevel_gear_design(self) -> '_1092.BevelGearDesign':
        ...
        if _1092.BevelGearDesign.TYPE not in self.wrapped.BevelGearDesign.__class__.__mro__:
