...
from mastapy.system_model.part_model.gears import _2214, _2213
...
class KlingelnbergCycloPalloidHypoidGearSet(_2213.KlingelnbergCycloPalloidConicalGearSet):
    '''KlingelnbergCycloPalloidHypoidGearSet
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears(self) -> 'List[_2214.KlingelnbergCycloPalloidHypoidGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidGears, constructor.new(_2214.KlingelnbergCycloPalloidHypoidGear))
        return value

    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes(self) -> 'List[_2000.KlingelnbergCycloPalloidHypoidGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidMeshes, constructor.new(_2000.KlingelnbergCycloPalloidHypoidGearMesh))
        return value
