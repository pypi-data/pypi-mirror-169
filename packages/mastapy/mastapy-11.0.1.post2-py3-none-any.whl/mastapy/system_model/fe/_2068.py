...
class FESubstructureWithSelection(_2041.BaseFEWithSelection):
    '''FESubstructureWithSelection
    ...
    @property
    def fe_substructure(self) -> '_2063.FESubstructure':
        ...
        return constructor.new(_2063.FESubstructure)(self.wrapped.FESubstructure) if self.wrapped.FESubstructure else None

    @property
    def element_face_groups(self) -> 'List[_2056.ElementFaceGroupWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElementFaceGroups, constructor.new(_2056.ElementFaceGroupWithSelection))
        return value

    @property
    def node_groups(self) -> 'List[_2079.NodeGroupWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeGroups, constructor.new(_2079.NodeGroupWithSelection))
        return value
