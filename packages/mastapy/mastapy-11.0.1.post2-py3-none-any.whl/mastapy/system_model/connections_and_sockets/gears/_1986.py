...
class ConceptGearMesh(_1994.GearMesh):
    '''ConceptGearMesh
    ...
    @property
    def concept_gear_mesh_design(self) -> '_1089.ConceptGearMeshDesign':
        ...
        return constructor.new(_1089.ConceptGearMeshDesign)(self.wrapped.ConceptGearMeshDesign) if self.wrapped.ConceptGearMeshDesign else None
