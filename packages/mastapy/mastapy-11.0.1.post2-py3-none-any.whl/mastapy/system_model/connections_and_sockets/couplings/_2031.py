...
class SpringDamperConnection(_2027.CouplingConnection):
    '''SpringDamperConnection
    ...
    @property
    def damping_option(self) -> '_1890.ComponentDampingOption':
        ...
        return constructor.new(_1890.ComponentDampingOption)(value) if value else None

    @damping_option.setter
    def damping_option(self, value: '_1890.ComponentDampingOption'):
