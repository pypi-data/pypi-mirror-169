...
class BearingSettings(_1350.PerMachineSettings):
    '''BearingSettings
    ...
    @property
    def failure_probability_for_rating_life_percent(self) -> '_1598.RatingLife':
        ...
        return constructor.new(_1598.RatingLife)(value) if value else None

    @failure_probability_for_rating_life_percent.setter
    def failure_probability_for_rating_life_percent(self, value: '_1598.RatingLife'):
    ...
    @property
    def include_exponent_and_reduction_factors_in_isots162812008(self) -> '_1591.ExponentAndReductionFactorsInISO16281Calculation':
        ...
        return constructor.new(_1591.ExponentAndReductionFactorsInISO16281Calculation)(value) if value else None

    @include_exponent_and_reduction_factors_in_isots162812008.setter
    def include_exponent_and_reduction_factors_in_isots162812008(self, value: '_1591.ExponentAndReductionFactorsInISO16281Calculation'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def skf_credentials(self) -> '_1793.SKFCredentials':
        ...
        return constructor.new(_1793.SKFCredentials)(self.wrapped.SKFCredentials) if self.wrapped.SKFCredentials else None
