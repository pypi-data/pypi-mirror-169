...
from mastapy.bearings.bearing_designs.rolling import _1852, _1853, _1851
...
class NonBarrelRollerBearing(_1851.RollerBearing):
    '''NonBarrelRollerBearing
    ...
    @property
    def roller_end_shape(self) -> '_1852.RollerEndShape':
        ...
        return constructor.new(_1852.RollerEndShape)(value) if value else None

    @roller_end_shape.setter
    def roller_end_shape(self, value: '_1852.RollerEndShape'):
    ...
    @property
    def ribs(self) -> 'List[_1853.RollerRibDetail]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Ribs, constructor.new(_1853.RollerRibDetail))
        return value
