...
class LinearBearing(_1825.BearingDesign):
    '''LinearBearing
    ...
    @property
    def stiffness_options(self) -> '_1590.BearingStiffnessMatrixOption':
        ...
        return constructor.new(_1590.BearingStiffnessMatrixOption)(value) if value else None

    @stiffness_options.setter
    def stiffness_options(self, value: '_1590.BearingStiffnessMatrixOption'):
