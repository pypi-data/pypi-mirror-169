...
class PlainGreaseFilledJournalBearing(_1879.PlainJournalBearing):
    '''PlainGreaseFilledJournalBearing
    ...
    @property
    def housing_type(self) -> '_1878.PlainGreaseFilledJournalBearingHousingType':
        ...
        return constructor.new(_1878.PlainGreaseFilledJournalBearingHousingType)(value) if value else None

    @housing_type.setter
    def housing_type(self, value: '_1878.PlainGreaseFilledJournalBearingHousingType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HousingType = value

    @property
    def housing_detail(self) -> '_1880.PlainJournalHousing':
        ...
        if _1880.PlainJournalHousing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
    ...
    @property
    def housing_detail_of_type_cylindrical_housing_journal_bearing(self) -> '_1873.CylindricalHousingJournalBearing':
        ...
        if _1873.CylindricalHousingJournalBearing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
    ...
    @property
    def housing_detail_of_type_machinery_encased_journal_bearing(self) -> '_1874.MachineryEncasedJournalBearing':
        ...
        if _1874.MachineryEncasedJournalBearing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
    ...
    @property
    def housing_detail_of_type_pedestal_journal_bearing(self) -> '_1876.PedestalJournalBearing':
        ...
        if _1876.PedestalJournalBearing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
