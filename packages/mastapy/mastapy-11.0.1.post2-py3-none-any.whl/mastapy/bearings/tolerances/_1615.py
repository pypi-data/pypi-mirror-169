...
from mastapy.bearings.tolerances import _1610, _1607
...
class InterferenceTolerance(_1607.BearingConnectionComponent):
    '''InterferenceTolerance
    ...
    @property
    def definition_option(self) -> '_1610.BearingToleranceDefinitionOptions':
    ...
    def definition_option(self, value: '_1610.BearingToleranceDefinitionOptions'):
    ...
    @property
    def mounting_point_surface_finish(self) -> '_1596.MountingPointSurfaceFinishes':
        ...
        return constructor.new(_1596.MountingPointSurfaceFinishes)(value) if value else None

    @mounting_point_surface_finish.setter
    def mounting_point_surface_finish(self, value: '_1596.MountingPointSurfaceFinishes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
