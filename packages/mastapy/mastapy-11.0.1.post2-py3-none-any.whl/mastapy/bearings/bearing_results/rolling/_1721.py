...
from mastapy.bearings.bearing_results.rolling import _1769, _1726
...
class LoadedNonBarrelRollerBearingResults(_1726.LoadedRollerBearingResults):
    '''LoadedNonBarrelRollerBearingResults
    ...
    @property
    def smt_rib_stress(self) -> '_1769.SMTRibStressResults':
        ...
        return constructor.new(_1769.SMTRibStressResults)(self.wrapped.SMTRibStress) if self.wrapped.SMTRibStress else None
