...
from mastapy.bearings.bearing_results.rolling import _1702, _1727
...
class LoadedCrossedRollerBearingRow(_1727.LoadedRollerBearingRow):
    '''LoadedCrossedRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1702.LoadedCrossedRollerBearingResults':
        ...
        return constructor.new(_1702.LoadedCrossedRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
