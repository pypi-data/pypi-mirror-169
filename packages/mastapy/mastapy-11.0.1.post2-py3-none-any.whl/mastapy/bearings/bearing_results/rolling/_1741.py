...
from mastapy.bearings.bearing_results.rolling import _1740, _1727
...
class LoadedSphericalRollerThrustBearingRow(_1727.LoadedRollerBearingRow):
    '''LoadedSphericalRollerThrustBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1740.LoadedSphericalRollerThrustBearingResults':
        ...
        return constructor.new(_1740.LoadedSphericalRollerThrustBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
