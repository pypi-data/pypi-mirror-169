...
from mastapy.bearings.bearing_results.rolling import _1680, _1683, _1700
...
class LoadedAngularContactBallBearingRow(_1700.LoadedBallBearingRow):
    '''LoadedAngularContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1680.LoadedAngularContactBallBearingResults':
