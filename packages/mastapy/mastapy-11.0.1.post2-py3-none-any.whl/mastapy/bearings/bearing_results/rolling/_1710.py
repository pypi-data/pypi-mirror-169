...
from mastapy.bearings.bearing_results.rolling import _1709, _1700
...
class LoadedDeepGrooveBallBearingRow(_1700.LoadedBallBearingRow):
    '''LoadedDeepGrooveBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1709.LoadedDeepGrooveBallBearingResults':
        ...
        return constructor.new(_1709.LoadedDeepGrooveBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
