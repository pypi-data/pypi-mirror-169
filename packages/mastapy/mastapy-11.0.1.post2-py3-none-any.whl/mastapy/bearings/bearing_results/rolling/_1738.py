...
from mastapy.bearings.bearing_results.rolling import _1737, _1727
...
class LoadedSphericalRollerRadialBearingRow(_1727.LoadedRollerBearingRow):
    '''LoadedSphericalRollerRadialBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1737.LoadedSphericalRollerRadialBearingResults':
        ...
        return constructor.new(_1737.LoadedSphericalRollerRadialBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
