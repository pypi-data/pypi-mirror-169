...
from mastapy.bearings.bearing_results.rolling import _1768, _1721
...
class LoadedCylindricalRollerBearingResults(_1721.LoadedNonBarrelRollerBearingResults):
    '''LoadedCylindricalRollerBearingResults
    ...
    @property
    def skf_maximal_constantly_acting_axial_load(self) -> '_1768.SKFMaximalConstantlyActingAxialLoadResults':
        ...
        return constructor.new(_1768.SKFMaximalConstantlyActingAxialLoadResults)(self.wrapped.SKFMaximalConstantlyActingAxialLoad) if self.wrapped.SKFMaximalConstantlyActingAxialLoad else None
