...
from mastapy.bearings.bearing_results.rolling import _1694, _1692
...
class LoadedAxialThrustNeedleRollerBearingRow(_1692.LoadedAxialThrustCylindricalRollerBearingRow):
    '''LoadedAxialThrustNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1694.LoadedAxialThrustNeedleRollerBearingResults':
        ...
        return constructor.new(_1694.LoadedAxialThrustNeedleRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
