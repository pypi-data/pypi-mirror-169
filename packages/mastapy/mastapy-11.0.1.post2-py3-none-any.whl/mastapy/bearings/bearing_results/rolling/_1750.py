...
from mastapy.bearings.bearing_results.rolling import _1749, _1700
...
class LoadedThreePointContactBallBearingRow(_1700.LoadedBallBearingRow):
    '''LoadedThreePointContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1749.LoadedThreePointContactBallBearingResults':
        ...
        return constructor.new(_1749.LoadedThreePointContactBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
