...
class GreaseLifeAndRelubricationInterval(_1792.SKFCalculationResult):
    '''GreaseLifeAndRelubricationInterval
    ...
    def grease(self) -> '_1783.Grease':
        ...
        return constructor.new(_1783.Grease)(self.wrapped.Grease) if self.wrapped.Grease else None

    @property
    def initial_fill(self) -> '_1786.InitialFill':
        ...
        return constructor.new(_1786.InitialFill)(self.wrapped.InitialFill) if self.wrapped.InitialFill else None

    @property
    def grease_quantity(self) -> '_1785.GreaseQuantity':
        ...
        return constructor.new(_1785.GreaseQuantity)(self.wrapped.GreaseQuantity) if self.wrapped.GreaseQuantity else None
