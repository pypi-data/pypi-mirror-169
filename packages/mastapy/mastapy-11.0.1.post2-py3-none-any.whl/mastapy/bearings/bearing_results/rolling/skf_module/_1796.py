...
from mastapy.bearings.bearing_results.rolling.skf_module import _1789, _1792
...
class Viscosities(_1792.SKFCalculationResult):
    '''Viscosities
    ...
    @property
    def operating_viscosity(self) -> '_1789.OperatingViscosity':
        ...
        return constructor.new(_1789.OperatingViscosity)(self.wrapped.OperatingViscosity) if self.wrapped.OperatingViscosity else None
