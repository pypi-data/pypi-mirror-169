...
from mastapy.bearings.bearing_results.rolling.skf_module import _1790, _1792
...
class DynamicAxialLoadCarryingCapacity(_1792.SKFCalculationResult):
    '''DynamicAxialLoadCarryingCapacity
    ...
    @property
    def permissible_axial_load(self) -> '_1790.PermissibleAxialLoad':
        ...
        return constructor.new(_1790.PermissibleAxialLoad)(self.wrapped.PermissibleAxialLoad) if self.wrapped.PermissibleAxialLoad else None
