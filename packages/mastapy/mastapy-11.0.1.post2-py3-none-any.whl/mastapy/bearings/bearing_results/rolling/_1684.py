...
from mastapy.bearings.bearing_results.rolling import _1683, _1681
...
class LoadedAngularContactThrustBallBearingRow(_1681.LoadedAngularContactBallBearingRow):
    '''LoadedAngularContactThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1683.LoadedAngularContactThrustBallBearingResults':
        ...
        return constructor.new(_1683.LoadedAngularContactThrustBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
