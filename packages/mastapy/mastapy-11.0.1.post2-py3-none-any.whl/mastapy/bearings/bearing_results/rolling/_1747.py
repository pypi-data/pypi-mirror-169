...
from mastapy.bearings.bearing_results.rolling import _1746, _1722
...
class LoadedTaperRollerBearingRow(_1722.LoadedNonBarrelRollerBearingRow):
    '''LoadedTaperRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1746.LoadedTaperRollerBearingResults':
        ...
        return constructor.new(_1746.LoadedTaperRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
