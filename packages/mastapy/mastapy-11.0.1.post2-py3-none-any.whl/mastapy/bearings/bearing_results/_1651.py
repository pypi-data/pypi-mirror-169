...
class LoadedBearingDutyCycle(_0.APIBase):
    ...
    @property
    def bearing_design(self) -> '_1825.BearingDesign':
        ...
        if _1825.BearingDesign.TYPE not in self.wrapped.BearingDesign.__class__.__mro__:
    ...
    @property
    def bearing_design_of_type_detailed_bearing(self) -> '_1826.DetailedBearing':
        ...
        if _1826.DetailedBearing.TYPE not in self.wrapped.BearingDesign.__class__.__mro__:
    ...
    @property
    def bearing_design_of_type_dummy_rolling_bearing(self) -> '_1827.DummyRollingBearing':
        ...
        if _1827.DummyRollingBearing.TYPE not in self.wrapped.BearingDesign.__class__.__mro__:
    ...
    @property
    def bearing_design_of_type_linear_bearing(self) -> '_1828.LinearBearing':
        ...
        if _1828.LinearBearing.TYPE not in self.wrapped.BearingDesign.__class__.__mro__:
    ...
    @property
    def bearing_design_of_type_non_linear_bearing(self) -> '_1829.NonLinearBearing':
        ...
        if _1829.NonLinearBearing.TYPE not in self.wrapped.BearingDesign.__class__.__mro__:
    ...
    @property
    def bearing_design_of_type_angular_contact_ball_bearing(self) -> '_1830.AngularContactBallBearing':
        ...
        if _1830.AngularContactBallBearing.TYPE not in self.wrapped.BearingDesign.__class__.__mro__:
    ...
    @property
    def bearing_design_of_type_angular_contact_thrust_ball_bearing(self) -> '_1831.AngularContactThrustBallBearing':
        ...
        if _1831.AngularContactThrustBallBearing.TYPE not in self.wrapped.BearingDesign.__class__.__mro__:
    ...
    @property
    def bearing_design_of_type_asymmetric_spherical_roller_bearing(self) -> '_1832.AsymmetricSphericalRollerBearing':
        ...
        if _1832.AsymmetricSphericalRollerBearing.TYPE not in self.wrapped.BearingDesign.__class__.__mro__:
    ...
    @property
    def bearing_design_of_type_axial_thrust_cylindrical_roller_bearing(self) -> '_1833.AxialThrustCylindricalRollerBearing':
        ...
        if _1833.AxialThrustCylindricalRollerBearing.TYPE not in self.wrapped.BearingDesign.__class__.__mro__:
    ...
    @property
    def bearing_design_of_type_axial_thrust_needle_roller_bearing(self) -> '_1834.AxialThrustNeedleRollerBearing':
        ...
        if _1834.AxialThrustNeedleRollerBearing.TYPE not in self.wrapped.BearingDesign.__class__.__mro__:
    ...
    @property
    def bearing_design_of_type_ball_bearing(self) -> '_1835.BallBearing':
        ...
        if _1835.BallBearing.TYPE not in self.wrapped.BearingDesign.__class__.__mro__:
    ...
    @property
    def bearing_design_of_type_barrel_roller_bearing(self) -> '_1837.BarrelRollerBearing':
        ...
        if _1837.BarrelRollerBearing.TYPE not in self.wrapped.BearingDesign.__class__.__mro__:
    ...
    @property
    def bearing_design_of_type_crossed_roller_bearing(self) -> '_1842.CrossedRollerBearing':
        ...
        if _1842.CrossedRollerBearing.TYPE not in self.wrapped.BearingDesign.__class__.__mro__:
    ...
    @property
    def bearing_design_of_type_cylindrical_roller_bearing(self) -> '_1843.CylindricalRollerBearing':
        ...
        if _1843.CylindricalRollerBearing.TYPE not in self.wrapped.BearingDesign.__class__.__mro__:
    ...
    @property
    def bearing_design_of_type_deep_groove_ball_bearing(self) -> '_1844.DeepGrooveBallBearing':
        ...
        if _1844.DeepGrooveBallBearing.TYPE not in self.wrapped.BearingDesign.__class__.__mro__:
    ...
    @property
    def bearing_design_of_type_four_point_contact_ball_bearing(self) -> '_1846.FourPointContactBallBearing':
        ...
        if _1846.FourPointContactBallBearing.TYPE not in self.wrapped.BearingDesign.__class__.__mro__:
    ...
    @property
    def bearing_design_of_type_multi_point_contact_ball_bearing(self) -> '_1848.MultiPointContactBallBearing':
        ...
        if _1848.MultiPointContactBallBearing.TYPE not in self.wrapped.BearingDesign.__class__.__mro__:
    ...
    @property
    def bearing_design_of_type_needle_roller_bearing(self) -> '_1849.NeedleRollerBearing':
        ...
        if _1849.NeedleRollerBearing.TYPE not in self.wrapped.BearingDesign.__class__.__mro__:
    ...
    @property
    def bearing_design_of_type_non_barrel_roller_bearing(self) -> '_1850.NonBarrelRollerBearing':
        ...
        if _1850.NonBarrelRollerBearing.TYPE not in self.wrapped.BearingDesign.__class__.__mro__:
    ...
    @property
    def bearing_design_of_type_roller_bearing(self) -> '_1851.RollerBearing':
        ...
        if _1851.RollerBearing.TYPE not in self.wrapped.BearingDesign.__class__.__mro__:
    ...
    @property
    def bearing_design_of_type_rolling_bearing(self) -> '_1854.RollingBearing':
        ...
        if _1854.RollingBearing.TYPE not in self.wrapped.BearingDesign.__class__.__mro__:
    ...
    @property
    def bearing_design_of_type_self_aligning_ball_bearing(self) -> '_1855.SelfAligningBallBearing':
        ...
        if _1855.SelfAligningBallBearing.TYPE not in self.wrapped.BearingDesign.__class__.__mro__:
    ...
    @property
    def bearing_design_of_type_spherical_roller_bearing(self) -> '_1857.SphericalRollerBearing':
        ...
        if _1857.SphericalRollerBearing.TYPE not in self.wrapped.BearingDesign.__class__.__mro__:
    ...
    @property
    def bearing_design_of_type_spherical_roller_thrust_bearing(self) -> '_1858.SphericalRollerThrustBearing':
        ...
        if _1858.SphericalRollerThrustBearing.TYPE not in self.wrapped.BearingDesign.__class__.__mro__:
    ...
    @property
    def bearing_design_of_type_taper_roller_bearing(self) -> '_1859.TaperRollerBearing':
        ...
        if _1859.TaperRollerBearing.TYPE not in self.wrapped.BearingDesign.__class__.__mro__:
    ...
    @property
    def bearing_design_of_type_three_point_contact_ball_bearing(self) -> '_1860.ThreePointContactBallBearing':
        ...
        if _1860.ThreePointContactBallBearing.TYPE not in self.wrapped.BearingDesign.__class__.__mro__:
    ...
    @property
    def bearing_design_of_type_thrust_ball_bearing(self) -> '_1861.ThrustBallBearing':
        ...
        if _1861.ThrustBallBearing.TYPE not in self.wrapped.BearingDesign.__class__.__mro__:
    ...
    @property
    def bearing_design_of_type_toroidal_roller_bearing(self) -> '_1862.ToroidalRollerBearing':
        ...
        if _1862.ToroidalRollerBearing.TYPE not in self.wrapped.BearingDesign.__class__.__mro__:
    ...
    @property
    def bearing_design_of_type_pad_fluid_film_bearing(self) -> '_1875.PadFluidFilmBearing':
        ...
        if _1875.PadFluidFilmBearing.TYPE not in self.wrapped.BearingDesign.__class__.__mro__:
    ...
    @property
    def bearing_design_of_type_plain_grease_filled_journal_bearing(self) -> '_1877.PlainGreaseFilledJournalBearing':
        ...
        if _1877.PlainGreaseFilledJournalBearing.TYPE not in self.wrapped.BearingDesign.__class__.__mro__:
    ...
    @property
    def bearing_design_of_type_plain_journal_bearing(self) -> '_1879.PlainJournalBearing':
        ...
        if _1879.PlainJournalBearing.TYPE not in self.wrapped.BearingDesign.__class__.__mro__:
    ...
    @property
    def bearing_design_of_type_plain_oil_fed_journal_bearing(self) -> '_1881.PlainOilFedJournalBearing':
        ...
        if _1881.PlainOilFedJournalBearing.TYPE not in self.wrapped.BearingDesign.__class__.__mro__:
    ...
    @property
    def bearing_design_of_type_tilting_pad_journal_bearing(self) -> '_1882.TiltingPadJournalBearing':
        ...
        if _1882.TiltingPadJournalBearing.TYPE not in self.wrapped.BearingDesign.__class__.__mro__:
    ...
    @property
    def bearing_design_of_type_tilting_pad_thrust_bearing(self) -> '_1883.TiltingPadThrustBearing':
        ...
        if _1883.TiltingPadThrustBearing.TYPE not in self.wrapped.BearingDesign.__class__.__mro__:
    ...
    @property
    def bearing_design_of_type_concept_axial_clearance_bearing(self) -> '_1885.ConceptAxialClearanceBearing':
        ...
        if _1885.ConceptAxialClearanceBearing.TYPE not in self.wrapped.BearingDesign.__class__.__mro__:
    ...
    @property
    def bearing_design_of_type_concept_clearance_bearing(self) -> '_1886.ConceptClearanceBearing':
        ...
        if _1886.ConceptClearanceBearing.TYPE not in self.wrapped.BearingDesign.__class__.__mro__:
    ...
    @property
    def bearing_design_of_type_concept_radial_clearance_bearing(self) -> '_1887.ConceptRadialClearanceBearing':
        ...
        if _1887.ConceptRadialClearanceBearing.TYPE not in self.wrapped.BearingDesign.__class__.__mro__:
    ...
    @property
    def radial_load_summary(self) -> '_1565.DutyCyclePropertySummaryForce[_1585.BearingLoadCaseResultsLightweight]':
        ...
        return constructor.new(_1565.DutyCyclePropertySummaryForce)[_1585.BearingLoadCaseResultsLightweight](self.wrapped.RadialLoadSummary) if self.wrapped.RadialLoadSummary else None

    @property
    def z_thrust_reaction_summary(self) -> '_1565.DutyCyclePropertySummaryForce[_1585.BearingLoadCaseResultsLightweight]':
        ...
        return constructor.new(_1565.DutyCyclePropertySummaryForce)[_1585.BearingLoadCaseResultsLightweight](self.wrapped.ZThrustReactionSummary) if self.wrapped.ZThrustReactionSummary else None

    @property
    def bearing_load_case_results(self) -> 'List[_1652.LoadedBearingResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingLoadCaseResults, constructor.new(_1652.LoadedBearingResults))
        return value
