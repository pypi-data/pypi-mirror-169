...
from mastapy.bearings.bearing_results.fluid_film import _1818, _1814
...
class LoadedPlainJournalBearingResults(_1814.LoadedFluidFilmBearingResults):
    '''LoadedPlainJournalBearingResults
    ...
    @property
    def journal_bearing_rows(self) -> 'List[_1818.LoadedPlainJournalBearingRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.JournalBearingRows, constructor.new(_1818.LoadedPlainJournalBearingRow))
        return value
