...
from mastapy.cycloidal import _1225, _1219, _1224
...
class CycloidalAssemblyDesign(_0.APIBase):
    ...
    @property
    def ring_pins(self) -> '_1225.RingPinsDesign':
        ...
        return constructor.new(_1225.RingPinsDesign)(self.wrapped.RingPins) if self.wrapped.RingPins else None

    @property
    def discs(self) -> 'List[_1219.CycloidalDiscDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Discs, constructor.new(_1219.CycloidalDiscDesign))
        return value

    @property
    def disc_phases(self) -> 'List[_1224.NamedDiscPhase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DiscPhases, constructor.new(_1224.NamedDiscPhase))
        return value
