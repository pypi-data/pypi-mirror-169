...
from mastapy.detailed_rigid_connectors.keyed_joints.rating import _1244
...
class KeywayRating(_1252.InterferenceFitRating):
    '''KeywayRating
    ...
    @property
    def keyed_joint_design(self) -> '_1240.KeyedJointDesign':
        ...
        return constructor.new(_1240.KeyedJointDesign)(self.wrapped.KeyedJointDesign) if self.wrapped.KeyedJointDesign is not None else None

    @property
    def keyway_half_ratings(self) -> 'List[_1244.KeywayHalfRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KeywayHalfRatings, constructor.new(_1244.KeywayHalfRating))
        return value
