...
class GearSetParetoOptimiser(_839.DesignSpaceSearchBase['_316.AbstractGearSetRating', '_844.GearSetOptimiserCandidate']):
    ...
    @property
    def selected_candidate_geometry_of_type_conical_gear_set_design(self) -> '_1068.ConicalGearSetDesign':
        ...
        if _1068.ConicalGearSetDesign.TYPE not in self.wrapped.SelectedCandidateGeometry.__class__.__mro__:
    ...
    @property
    def selected_candidate_geometry_of_type_concept_gear_set_design(self) -> '_1090.ConceptGearSetDesign':
        ...
        if _1090.ConceptGearSetDesign.TYPE not in self.wrapped.SelectedCandidateGeometry.__class__.__mro__:
    ...
    @property
    def selected_candidate_geometry_of_type_bevel_gear_set_design(self) -> '_1094.BevelGearSetDesign':
        ...
        if _1094.BevelGearSetDesign.TYPE not in self.wrapped.SelectedCandidateGeometry.__class__.__mro__:
    ...
    @property
    def selected_candidate_geometry_of_type_agma_gleason_conical_gear_set_design(self) -> '_1107.AGMAGleasonConicalGearSetDesign':
        ...
        if _1107.AGMAGleasonConicalGearSetDesign.TYPE not in self.wrapped.SelectedCandidateGeometry.__class__.__mro__:
