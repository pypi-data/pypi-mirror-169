...
from mastapy.gears.cylindrical import _1121, _1120
...
class CylindricalMeshedGearLoadDistributionAnalysis(_0.APIBase):
    ...
    @property
    def contact_charts(self) -> '_1121.CylindricalGearLTCAContactCharts':
        ...
        return constructor.new(_1121.CylindricalGearLTCAContactCharts)(self.wrapped.ContactCharts) if self.wrapped.ContactCharts else None

    @property
    def contact_charts_as_text_file(self) -> '_1120.CylindricalGearLTCAContactChartDataAsTextFile':
        ...
        return constructor.new(_1120.CylindricalGearLTCAContactChartDataAsTextFile)(self.wrapped.ContactChartsAsTextFile) if self.wrapped.ContactChartsAsTextFile else None

    def contact_patch_detailed(self, result_type: '_772.ContactResultType', number_of_face_width_steps: 'int', number_of_roll_distance_steps: 'int') -> '_1279.GriddedSurface':
    ...
    def contact_patch(self, result_type: '_772.ContactResultType', include_tip_contact: 'bool') -> '_1279.GriddedSurface':
        ''' 'ContactPatch' is the original name of this method.
