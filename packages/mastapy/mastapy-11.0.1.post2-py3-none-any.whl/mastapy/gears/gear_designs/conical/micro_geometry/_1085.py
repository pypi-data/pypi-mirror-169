...
from mastapy.gears.gear_designs.conical.micro_geometry import _1087, _1086, _1084
...
class ConicalGearFlankMicroGeometry(_518.FlankMicroGeometry):
    ...
    @property
    def profile_relief(self) -> '_1087.ConicalGearProfileModification':
        ...
        return constructor.new(_1087.ConicalGearProfileModification)(self.wrapped.ProfileRelief) if self.wrapped.ProfileRelief else None

    @property
    def lead_relief(self) -> '_1086.ConicalGearLeadModification':
        ...
        return constructor.new(_1086.ConicalGearLeadModification)(self.wrapped.LeadRelief) if self.wrapped.LeadRelief else None

    @property
    def bias(self) -> '_1084.ConicalGearBiasModification':
        ...
        return constructor.new(_1084.ConicalGearBiasModification)(self.wrapped.Bias) if self.wrapped.Bias else None

    @property
    def gear_design(self) -> '_1066.ConicalGearDesign':
        ...
        if _1066.ConicalGearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
    ...
    @property
    def gear_design_of_type_bevel_gear_design(self) -> '_1092.BevelGearDesign':
        ...
        if _1092.BevelGearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
    ...
    @property
    def gear_design_of_type_agma_gleason_conical_gear_design(self) -> '_1105.AGMAGleasonConicalGearDesign':
        ...
        if _1105.AGMAGleasonConicalGearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
