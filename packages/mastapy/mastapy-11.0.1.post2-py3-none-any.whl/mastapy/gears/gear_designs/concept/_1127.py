...
from mastapy.gears.gear_designs.concept import _1125, _1126
...
class ConceptGearSetDesign(_908.GearSetDesign):
    '''ConceptGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_1125.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_1125.ConceptGearDesign))
        return value

    @property
    def concept_gears(self) -> 'List[_1125.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGears, constructor.new(_1125.ConceptGearDesign))
        return value

    @property
    def concept_meshes(self) -> 'List[_1126.ConceptGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshes, constructor.new(_1126.ConceptGearMeshDesign))
        return value
