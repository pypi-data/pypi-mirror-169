...
from mastapy.gears.gear_designs.concept import _1090, _1088
...
class ConceptGearMeshDesign(_879.GearMeshDesign):
    ...
    @property
    def concept_gear_set(self) -> '_1090.ConceptGearSetDesign':
        ...
        return constructor.new(_1090.ConceptGearSetDesign)(self.wrapped.ConceptGearSet) if self.wrapped.ConceptGearSet else None
