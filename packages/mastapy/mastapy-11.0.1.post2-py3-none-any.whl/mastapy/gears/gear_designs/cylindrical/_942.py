...
from mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances import (
    _1053, _1057, _1048, _1050,
    _1046, _1047, _1049, _1051,
    _1054, _1055, _1056, _1052
)
...
class CylindricalGearDesign(_877.GearDesign):
    ...
    @property
    def iso_accuracy_grade(self) -> '_1057.ISO1328AccuracyGrades':
        ...
        return constructor.new(_1057.ISO1328AccuracyGrades)(self.wrapped.ISOAccuracyGrade) if self.wrapped.ISOAccuracyGrade else None
    ...
    @property
    def accuracy_grade_allowances_and_tolerances_of_type_iso1328_accuracy_grader_common(self) -> '_1056.ISO1328AccuracyGraderCommon':
        ...
        if _1056.ISO1328AccuracyGraderCommon.TYPE not in self.wrapped.AccuracyGradeAllowancesAndTolerances.__class__.__mro__:
    ...
    @property
    def accuracy_grades_specified_accuracy_of_type_iso1328_accuracy_grades(self) -> '_1057.ISO1328AccuracyGrades':
        ...
        if _1057.ISO1328AccuracyGrades.TYPE not in self.wrapped.AccuracyGradesSpecifiedAccuracy.__class__.__mro__:
    ...
    @property
    def accuracy_grades_specified_accuracy_of_type_agma_gleason_conical_accuracy_grades(self) -> '_1104.AGMAGleasonConicalAccuracyGrades':
        ...
        if _1104.AGMAGleasonConicalAccuracyGrades.TYPE not in self.wrapped.AccuracyGradesSpecifiedAccuracy.__class__.__mro__:
