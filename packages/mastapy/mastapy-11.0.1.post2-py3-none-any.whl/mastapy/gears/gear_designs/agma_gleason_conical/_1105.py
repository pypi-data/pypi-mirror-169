...
from mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances import _1048, _1052, _1057
...
class AGMAGleasonConicalGearDesign(_1066.ConicalGearDesign):
    '''AGMAGleasonConicalGearDesign
    ...
    @property
    def front_end_type(self) -> '_1076.FrontEndTypes':
        '''FrontEndTypes: 'FrontEndType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.FrontEndType)
        return constructor.new(_1076.FrontEndTypes)(value) if value else None

    @front_end_type.setter
    def front_end_type(self, value: '_1076.FrontEndTypes'):
    ...
    @property
    def cutter(self) -> '_1065.ConicalGearCutter':
        ...
        if _1065.ConicalGearCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
    ...
    @property
    def cutter_of_type_dummy_conical_gear_cutter(self) -> '_1075.DummyConicalGearCutter':
        ...
        if _1075.DummyConicalGearCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
    ...
    @property
    def accuracy_grades_of_type_iso1328_accuracy_grades(self) -> '_1057.ISO1328AccuracyGrades':
        ...
        if _1057.ISO1328AccuracyGrades.TYPE not in self.wrapped.AccuracyGrades.__class__.__mro__:
    ...
    @property
    def accuracy_grades_of_type_agma_gleason_conical_accuracy_grades(self) -> '_1104.AGMAGleasonConicalAccuracyGrades':
        ...
        if _1104.AGMAGleasonConicalAccuracyGrades.TYPE not in self.wrapped.AccuracyGrades.__class__.__mro__:
