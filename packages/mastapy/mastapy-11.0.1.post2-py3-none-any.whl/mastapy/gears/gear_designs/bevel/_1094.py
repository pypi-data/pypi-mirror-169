...
from mastapy.gears.gear_designs.bevel import _1102, _1103, _1101
...
class BevelGearSetDesign(_1107.AGMAGleasonConicalGearSetDesign):
    '''BevelGearSetDesign
    ...
    @property
    def backlash_used_for_tooth_thickness_calculation(self) -> '_1283.MaxMinMean':
        ...
        return constructor.new(_1283.MaxMinMean)(value) if value else None

    @backlash_used_for_tooth_thickness_calculation.setter
    def backlash_used_for_tooth_thickness_calculation(self, value: '_1283.MaxMinMean'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def round_cutter_specifications(self) -> '_1103.WheelFinishCutterPointWidthRestrictionMethod':
        ...
        return constructor.new(_1103.WheelFinishCutterPointWidthRestrictionMethod)(value) if value else None

    @round_cutter_specifications.setter
    def round_cutter_specifications(self, value: '_1103.WheelFinishCutterPointWidthRestrictionMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def tooth_proportions_input_method(self) -> '_1101.ToothProportionsInputMethod':
        ...
        return constructor.new(_1101.ToothProportionsInputMethod)(value) if value else None

    @tooth_proportions_input_method.setter
    def tooth_proportions_input_method(self, value: '_1101.ToothProportionsInputMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
