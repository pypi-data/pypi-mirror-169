...
class DesignConstraintsCollection(_1557.NamedDatabaseItem):
    '''DesignConstraintsCollection
    ...
    @property
    def design_constraints(self) -> 'List[_1563.DeletableCollectionMember[_874.DesignConstraint]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignConstraints, constructor.new(_1563.DeletableCollectionMember)[_874.DesignConstraint])
        return value
