...
class AbstractGearMeshAnalysis(_0.APIBase):
    ...
    @property
    def gear_a(self) -> '_1124.AbstractGearAnalysis':
        ...
        if _1124.AbstractGearAnalysis.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_gear_fe_model(self) -> '_1109.GearFEModel':
        ...
        if _1109.GearFEModel.TYPE not in self.wrapped.GearA.__class__.__mro__:
            raise CastException('Failed to cast gear_a to GearFEModel. Expected: {}.'.format(self.wrapped.GearA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.GearA.__class__)(self.wrapped.GearA) if self.wrapped.GearA else None

    @property
    def gear_a_of_type_cylindrical_gear_fe_model(self) -> '_1113.CylindricalGearFEModel':
        ...
        if _1113.CylindricalGearFEModel.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_conical_gear_fe_model(self) -> '_1116.ConicalGearFEModel':
        ...
        if _1116.ConicalGearFEModel.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_gear_design_analysis(self) -> '_1127.GearDesignAnalysis':
        ...
        if _1127.GearDesignAnalysis.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_gear_implementation_analysis(self) -> '_1128.GearImplementationAnalysis':
        ...
        if _1128.GearImplementationAnalysis.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_gear_implementation_analysis_duty_cycle(self) -> '_1129.GearImplementationAnalysisDutyCycle':
        ...
        if _1129.GearImplementationAnalysisDutyCycle.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_gear_implementation_detail(self) -> '_1130.GearImplementationDetail':
        ...
        if _1130.GearImplementationDetail.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_b(self) -> '_1124.AbstractGearAnalysis':
        ...
        if _1124.AbstractGearAnalysis.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_gear_fe_model(self) -> '_1109.GearFEModel':
        ...
        if _1109.GearFEModel.TYPE not in self.wrapped.GearB.__class__.__mro__:
            raise CastException('Failed to cast gear_b to GearFEModel. Expected: {}.'.format(self.wrapped.GearB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.GearB.__class__)(self.wrapped.GearB) if self.wrapped.GearB else None

    @property
    def gear_b_of_type_cylindrical_gear_fe_model(self) -> '_1113.CylindricalGearFEModel':
        ...
        if _1113.CylindricalGearFEModel.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_conical_gear_fe_model(self) -> '_1116.ConicalGearFEModel':
        ...
        if _1116.ConicalGearFEModel.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_gear_design_analysis(self) -> '_1127.GearDesignAnalysis':
        ...
        if _1127.GearDesignAnalysis.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_gear_implementation_analysis(self) -> '_1128.GearImplementationAnalysis':
        ...
        if _1128.GearImplementationAnalysis.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_gear_implementation_analysis_duty_cycle(self) -> '_1129.GearImplementationAnalysisDutyCycle':
        ...
        if _1129.GearImplementationAnalysisDutyCycle.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_gear_implementation_detail(self) -> '_1130.GearImplementationDetail':
        ...
        if _1130.GearImplementationDetail.TYPE not in self.wrapped.GearB.__class__.__mro__:
