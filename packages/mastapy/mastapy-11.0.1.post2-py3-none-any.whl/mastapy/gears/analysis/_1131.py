...
class GearMeshDesignAnalysis(_1125.AbstractGearMeshAnalysis):
    '''GearMeshDesignAnalysis
    ...
    @property
    def gear_a(self) -> '_1127.GearDesignAnalysis':
    ...
    @property
    def gear_b(self) -> '_1127.GearDesignAnalysis':
