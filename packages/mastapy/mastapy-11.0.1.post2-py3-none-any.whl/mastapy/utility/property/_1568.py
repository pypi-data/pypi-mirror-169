...
from mastapy.utility.units_and_measurements.measurements import _1454
...
class DutyCyclePropertySummaryStress(_1564.DutyCyclePropertySummary['_1454.Stress', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryStress
