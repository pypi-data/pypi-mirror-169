...
from mastapy.utility.units_and_measurements.measurements import _1371
...
class DutyCyclePropertySummarySmallAngle(_1564.DutyCyclePropertySummary['_1371.AngleSmall', 'T'], Generic[T]):
    '''DutyCyclePropertySummarySmallAngle
