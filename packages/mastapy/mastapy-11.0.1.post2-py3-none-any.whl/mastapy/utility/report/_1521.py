...
from mastapy.utility.report import _1520, _1513
...
class UserTextRow(_1513.CustomRow):
    '''UserTextRow
    ...
    @property
    def heading_size(self) -> '_1520.HeadingSize':
        '''HeadingSize: 'HeadingSize' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HeadingSize)
        return constructor.new(_1520.HeadingSize)(value) if value else None

    @heading_size.setter
    def heading_size(self, value: '_1520.HeadingSize'):
