...
class MeasurementBase(_0.APIBase):
    ...
    @property
    def rounding_method(self) -> '_1354.RoundingMethods':
        ...
        return constructor.new(_1354.RoundingMethods)(value) if value else None

    @rounding_method.setter
    def rounding_method(self, value: '_1354.RoundingMethods'):
    ...
    @property
    def current_unit(self) -> '_1366.Unit':
        ...
        if _1366.Unit.TYPE not in self.wrapped.CurrentUnit.__class__.__mro__:
