...
from mastapy.utility.databases import _1557, _1559, _1558
...
TValue = TypeVar('TValue', bound='_1557.NamedDatabaseItem')


class NamedDatabase(_1559.SQLDatabase['_1558.NamedKey', 'TValue'], Generic[TValue]):
    '''NamedDatabase
    ...
    def rename(self, item: '_1557.NamedDatabaseItem', new_name: 'str') -> 'bool':
    ...
    def duplicate(self, new_name: 'str', item: '_1557.NamedDatabaseItem') -> '_1557.NamedDatabaseItem':
