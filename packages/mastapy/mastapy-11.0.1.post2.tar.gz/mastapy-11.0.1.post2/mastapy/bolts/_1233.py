...
from mastapy.bolts import _1248, _1229
...
class BoltMaterial(_1229.BoltedJointMaterial):
    '''BoltMaterial
    ...
    @property
    def strength_grade(self) -> '_1248.StrengthGrades':
        ...
        return constructor.new(_1248.StrengthGrades)(value) if value else None

    @strength_grade.setter
    def strength_grade(self, value: '_1248.StrengthGrades'):
