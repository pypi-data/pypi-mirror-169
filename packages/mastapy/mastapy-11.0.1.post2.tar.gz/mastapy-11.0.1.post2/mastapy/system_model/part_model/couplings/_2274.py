...
from mastapy.system_model.part_model.couplings import (
    _2268, _2271, _2267, _2270,
    _2275, _2269
)
from mastapy.detailed_rigid_connectors.splines import (
    _1175, _1160, _1180, _1155,
    _1158, _1162, _1165, _1166,
    _1173, _1185
)
...
class ShaftHubConnection(_2126.Connector):
    '''ShaftHubConnection
    ...
    @property
    def tilt_stiffness_type(self) -> '_2268.RigidConnectorTiltStiffnessTypes':
        ...
        return constructor.new(_2268.RigidConnectorTiltStiffnessTypes)(value) if value else None

    @tilt_stiffness_type.setter
    def tilt_stiffness_type(self, value: '_2268.RigidConnectorTiltStiffnessTypes'):
    ...
    @property
    def spline_type(self) -> '_1175.SplineDesignTypes':
        '''SplineDesignTypes: 'SplineType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.SplineType)
        return constructor.new(_1175.SplineDesignTypes)(value) if value else None

    @spline_type.setter
    def spline_type(self, value: '_1175.SplineDesignTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def spline_joint_design(self) -> '_1180.SplineJointDesign':
        ...
        if _1180.SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_custom_spline_joint_design(self) -> '_1155.CustomSplineJointDesign':
        ...
        if _1155.CustomSplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_din5480_spline_joint_design(self) -> '_1158.DIN5480SplineJointDesign':
        ...
        if _1158.DIN5480SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_gbt3478_spline_joint_design(self) -> '_1162.GBT3478SplineJointDesign':
        ...
        if _1162.GBT3478SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_iso4156_spline_joint_design(self) -> '_1165.ISO4156SplineJointDesign':
        ...
        if _1165.ISO4156SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_jisb1603_spline_joint_design(self) -> '_1166.JISB1603SplineJointDesign':
        ...
        if _1166.JISB1603SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_sae_spline_joint_design(self) -> '_1173.SAESplineJointDesign':
        ...
        if _1173.SAESplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_standard_spline_joint_design(self) -> '_1185.StandardSplineJointDesign':
        ...
        if _1185.StandardSplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def interference_fit_design(self) -> '_1210.InterferenceFitDesign':
        ...
        if _1210.InterferenceFitDesign.TYPE not in self.wrapped.InterferenceFitDesign.__class__.__mro__:
    ...
    @property
    def left_flank_lead_relief(self) -> '_2275.SplineLeadRelief':
        ...
        return constructor.new(_2275.SplineLeadRelief)(self.wrapped.LeftFlankLeadRelief) if self.wrapped.LeftFlankLeadRelief else None

    @property
    def right_flank_lead_relief(self) -> '_2275.SplineLeadRelief':
        ...
        return constructor.new(_2275.SplineLeadRelief)(self.wrapped.RightFlankLeadRelief) if self.wrapped.RightFlankLeadRelief else None

    @property
    def tooth_locations_external_spline_half(self) -> 'List[_2269.RigidConnectorToothLocation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ToothLocationsExternalSplineHalf, constructor.new(_2269.RigidConnectorToothLocation))
        return value

    @property
    def lead_reliefs(self) -> 'List[_2275.SplineLeadRelief]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LeadReliefs, constructor.new(_2275.SplineLeadRelief))
        return value
