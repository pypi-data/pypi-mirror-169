...
from mastapy.system_model.part_model.couplings import _2284, _2286, _2259
...
class TorqueConverter(_2259.Coupling):
    '''TorqueConverter
    ...
    @property
    def pump(self) -> '_2284.TorqueConverterPump':
        ...
        return constructor.new(_2284.TorqueConverterPump)(self.wrapped.Pump) if self.wrapped.Pump else None

    @property
    def turbine(self) -> '_2286.TorqueConverterTurbine':
        ...
        return constructor.new(_2286.TorqueConverterTurbine)(self.wrapped.Turbine) if self.wrapped.Turbine else None
