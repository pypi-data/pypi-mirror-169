...
from mastapy.system_model.part_model.couplings import _2282, _2280
...
class Synchroniser(_2154.SpecialisedAssembly):
    '''Synchroniser
    ...
    @property
    def hub_and_sleeve(self) -> '_2282.SynchroniserSleeve':
        ...
        return constructor.new(_2282.SynchroniserSleeve)(self.wrapped.HubAndSleeve) if self.wrapped.HubAndSleeve else None

    @property
    def left_cone(self) -> '_2280.SynchroniserHalf':
        ...
        return constructor.new(_2280.SynchroniserHalf)(self.wrapped.LeftCone) if self.wrapped.LeftCone else None

    @property
    def right_cone(self) -> '_2280.SynchroniserHalf':
        ...
        return constructor.new(_2280.SynchroniserHalf)(self.wrapped.RightCone) if self.wrapped.RightCone else None

    @property
    def clutch_connection_left(self) -> '_2023.ClutchConnection':
        ...
        return constructor.new(_2023.ClutchConnection)(self.wrapped.ClutchConnectionLeft) if self.wrapped.ClutchConnectionLeft else None

    @property
    def clutch_connection_right(self) -> '_2023.ClutchConnection':
        ...
        return constructor.new(_2023.ClutchConnection)(self.wrapped.ClutchConnectionRight) if self.wrapped.ClutchConnectionRight else None
