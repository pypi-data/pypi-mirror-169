...
from mastapy.system_model.part_model.part_groups import _2165, _2163
...
class ConcentricPartGroup(_2163.ConcentricOrParallelPartGroup):
    '''ConcentricPartGroup
    ...
    @property
    def parallel_groups(self) -> 'List[_2165.ConcentricPartGroupParallelToThis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelGroups, constructor.new(_2165.ConcentricPartGroupParallelToThis))
        return value
