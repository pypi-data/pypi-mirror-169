...
from mastapy.system_model.part_model.part_groups import _2164, _2166, _2163
...
class ParallelPartGroup(_2163.ConcentricOrParallelPartGroup):
    '''ParallelPartGroup
    ...
    @property
    def concentric_part_groups(self) -> 'List[_2164.ConcentricPartGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConcentricPartGroups, constructor.new(_2164.ConcentricPartGroup))
        return value

    @property
    def design_measurements(self) -> 'List[_2166.DesignMeasurements]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignMeasurements, constructor.new(_2166.DesignMeasurements))
        return value
