...
from mastapy.system_model.part_model import _2158, _2156
...
class PowerLoad(_2156.VirtualComponent):
    '''PowerLoad
    ...
    @property
    def single_blade_details(self) -> '_2158.WindTurbineSingleBladeDetails':
        ...
        return constructor.new(_2158.WindTurbineSingleBladeDetails)(self.wrapped.SingleBladeDetails) if self.wrapped.SingleBladeDetails else None

    @property
    def electric_machine_detail(self) -> '_6515.ElectricMachineDetail':
        ...
        return constructor.new(_6515.ElectricMachineDetail)(self.wrapped.ElectricMachineDetail) if self.wrapped.ElectricMachineDetail else None
