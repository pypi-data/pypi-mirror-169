...
from mastapy.system_model.part_model.gears import _2219, _2196
...
class SpiralBevelGearSet(_2196.BevelGearSet):
    '''SpiralBevelGearSet
    ...
    @property
    def spiral_bevel_gears(self) -> 'List[_2219.SpiralBevelGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGears, constructor.new(_2219.SpiralBevelGear))
        return value

    @property
    def spiral_bevel_meshes(self) -> 'List[_2004.SpiralBevelGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshes, constructor.new(_2004.SpiralBevelGearMesh))
        return value
