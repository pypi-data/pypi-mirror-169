...
from mastapy.system_model.part_model.gears import _2201, _2208
...
class CylindricalGearSet(_2208.GearSet):
    '''CylindricalGearSet
    ...
    @property
    def supercharger_rotor_set(self) -> '_2239.SuperchargerRotorSet':
        ...
        return constructor.new(_2239.SuperchargerRotorSet)(self.wrapped.SuperchargerRotorSet) if self.wrapped.SuperchargerRotorSet else None

    @property
    def cylindrical_gears(self) -> 'List[_2201.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_2201.CylindricalGear))
        return value

    @property
    def cylindrical_meshes(self) -> 'List[_1990.CylindricalGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshes, constructor.new(_1990.CylindricalGearMesh))
        return value
