...
class Gear(_2142.MountableComponent):
    '''Gear
    ...
    @property
    def active_gear_design_of_type_conical_gear_design(self) -> '_1066.ConicalGearDesign':
        ...
        if _1066.ConicalGearDesign.TYPE not in self.wrapped.ActiveGearDesign.__class__.__mro__:
    ...
    @property
    def active_gear_design_of_type_concept_gear_design(self) -> '_1088.ConceptGearDesign':
        ...
        if _1088.ConceptGearDesign.TYPE not in self.wrapped.ActiveGearDesign.__class__.__mro__:
    ...
    @property
    def active_gear_design_of_type_bevel_gear_design(self) -> '_1092.BevelGearDesign':
        ...
        if _1092.BevelGearDesign.TYPE not in self.wrapped.ActiveGearDesign.__class__.__mro__:
    ...
    @property
    def active_gear_design_of_type_agma_gleason_conical_gear_design(self) -> '_1105.AGMAGleasonConicalGearDesign':
        ...
        if _1105.AGMAGleasonConicalGearDesign.TYPE not in self.wrapped.ActiveGearDesign.__class__.__mro__:
    ...
    @property
    def gear_set(self) -> '_2208.GearSet':
        ...
        if _2208.GearSet.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_agma_gleason_conical_gear_set(self) -> '_2190.AGMAGleasonConicalGearSet':
        ...
        if _2190.AGMAGleasonConicalGearSet.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_bevel_differential_gear_set(self) -> '_2192.BevelDifferentialGearSet':
        ...
        if _2192.BevelDifferentialGearSet.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_bevel_gear_set(self) -> '_2196.BevelGearSet':
        ...
        if _2196.BevelGearSet.TYPE not in self.wrapped.GearSet.__class__.__mro__:
            raise CastException('Failed to cast gear_set to BevelGearSet. Expected: {}.'.format(self.wrapped.GearSet.__class__.__qualname__))

        return constructor.new_override(self.wrapped.GearSet.__class__)(self.wrapped.GearSet) if self.wrapped.GearSet else None

    @property
    def gear_set_of_type_concept_gear_set(self) -> '_2198.ConceptGearSet':
        ...
        if _2198.ConceptGearSet.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_conical_gear_set(self) -> '_2200.ConicalGearSet':
        ...
        if _2200.ConicalGearSet.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_cylindrical_gear_set(self) -> '_2202.CylindricalGearSet':
        ...
        if _2202.CylindricalGearSet.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_face_gear_set(self) -> '_2205.FaceGearSet':
        ...
        if _2205.FaceGearSet.TYPE not in self.wrapped.GearSet.__class__.__mro__:
            raise CastException('Failed to cast gear_set to FaceGearSet. Expected: {}.'.format(self.wrapped.GearSet.__class__.__qualname__))

        return constructor.new_override(self.wrapped.GearSet.__class__)(self.wrapped.GearSet) if self.wrapped.GearSet else None

    @property
    def gear_set_of_type_hypoid_gear_set(self) -> '_2211.HypoidGearSet':
        ...
        if _2211.HypoidGearSet.TYPE not in self.wrapped.GearSet.__class__.__mro__:
            raise CastException('Failed to cast gear_set to HypoidGearSet. Expected: {}.'.format(self.wrapped.GearSet.__class__.__qualname__))

        return constructor.new_override(self.wrapped.GearSet.__class__)(self.wrapped.GearSet) if self.wrapped.GearSet else None

    @property
    def gear_set_of_type_klingelnberg_cyclo_palloid_conical_gear_set(self) -> '_2213.KlingelnbergCycloPalloidConicalGearSet':
        ...
        if _2213.KlingelnbergCycloPalloidConicalGearSet.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_klingelnberg_cyclo_palloid_hypoid_gear_set(self) -> '_2215.KlingelnbergCycloPalloidHypoidGearSet':
        ...
        if _2215.KlingelnbergCycloPalloidHypoidGearSet.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_set(self) -> '_2217.KlingelnbergCycloPalloidSpiralBevelGearSet':
        ...
        if _2217.KlingelnbergCycloPalloidSpiralBevelGearSet.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_planetary_gear_set(self) -> '_2218.PlanetaryGearSet':
        ...
        if _2218.PlanetaryGearSet.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_spiral_bevel_gear_set(self) -> '_2220.SpiralBevelGearSet':
        ...
        if _2220.SpiralBevelGearSet.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_straight_bevel_diff_gear_set(self) -> '_2222.StraightBevelDiffGearSet':
        ...
        if _2222.StraightBevelDiffGearSet.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_straight_bevel_gear_set(self) -> '_2224.StraightBevelGearSet':
        ...
        if _2224.StraightBevelGearSet.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_worm_gear_set(self) -> '_2228.WormGearSet':
        ...
        if _2228.WormGearSet.TYPE not in self.wrapped.GearSet.__class__.__mro__:
            raise CastException('Failed to cast gear_set to WormGearSet. Expected: {}.'.format(self.wrapped.GearSet.__class__.__qualname__))

        return constructor.new_override(self.wrapped.GearSet.__class__)(self.wrapped.GearSet) if self.wrapped.GearSet else None

    @property
    def gear_set_of_type_zerol_bevel_gear_set(self) -> '_2230.ZerolBevelGearSet':
        ...
        if _2230.ZerolBevelGearSet.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    def shaft(self) -> '_2159.Shaft':
        ...
        return constructor.new(_2159.Shaft)(self.wrapped.Shaft) if self.wrapped.Shaft else None
