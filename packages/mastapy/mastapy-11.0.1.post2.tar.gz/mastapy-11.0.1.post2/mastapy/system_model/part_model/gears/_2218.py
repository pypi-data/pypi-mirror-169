...
from mastapy.system_model.part_model.gears import _2201, _2203, _2202
...
class PlanetaryGearSet(_2202.CylindricalGearSet):
    '''PlanetaryGearSet
    ...
    @property
    def suns(self) -> 'List[_2201.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Suns, constructor.new(_2201.CylindricalGear))
        return value

    @property
    def planets(self) -> 'List[_2203.CylindricalPlanetGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Planets, constructor.new(_2203.CylindricalPlanetGear))
        return value

    @property
    def annuluses(self) -> 'List[_2201.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Annuluses, constructor.new(_2201.CylindricalGear))
        return value

    def add_sun(self) -> '_2201.CylindricalGear':
    ...
    def add_planet(self) -> '_2201.CylindricalGear':
    ...
    def add_annulus(self) -> '_2201.CylindricalGear':
