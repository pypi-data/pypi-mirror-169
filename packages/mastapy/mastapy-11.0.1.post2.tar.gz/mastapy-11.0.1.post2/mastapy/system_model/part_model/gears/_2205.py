...
from mastapy.system_model.part_model.gears import _2204, _2208
...
class FaceGearSet(_2208.GearSet):
    '''FaceGearSet
    ...
    @property
    def face_gears(self) -> 'List[_2204.FaceGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGears, constructor.new(_2204.FaceGear))
        return value

    @property
    def face_meshes(self) -> 'List[_1992.FaceGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshes, constructor.new(_1992.FaceGearMesh))
        return value
