...
from mastapy.system_model.part_model.gears import _2223, _2196
...
class StraightBevelGearSet(_2196.BevelGearSet):
    '''StraightBevelGearSet
    ...
    @property
    def straight_bevel_gears(self) -> 'List[_2223.StraightBevelGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGears, constructor.new(_2223.StraightBevelGear))
        return value

    @property
    def straight_bevel_meshes(self) -> 'List[_2008.StraightBevelGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshes, constructor.new(_2008.StraightBevelGearMesh))
        return value
