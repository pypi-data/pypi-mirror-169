...
from mastapy.system_model.part_model.gears import _2216, _2213
...
class KlingelnbergCycloPalloidSpiralBevelGearSet(_2213.KlingelnbergCycloPalloidConicalGearSet):
    '''KlingelnbergCycloPalloidSpiralBevelGearSet
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears(self) -> 'List[_2216.KlingelnbergCycloPalloidSpiralBevelGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidSpiralBevelGears, constructor.new(_2216.KlingelnbergCycloPalloidSpiralBevelGear))
        return value

    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes(self) -> 'List[_2001.KlingelnbergCycloPalloidSpiralBevelGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidSpiralBevelMeshes, constructor.new(_2001.KlingelnbergCycloPalloidSpiralBevelGearMesh))
        return value
