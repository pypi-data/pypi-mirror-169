...
from mastapy.cycloidal import _1225, _1226
...
class RingPins(_2142.MountableComponent):
    '''RingPins
    ...
    @property
    def ring_pins_design(self) -> '_1225.RingPinsDesign':
        ...
        return constructor.new(_1225.RingPinsDesign)(self.wrapped.RingPinsDesign) if self.wrapped.RingPinsDesign else None

    @property
    def ring_pins_material(self) -> '_1226.RingPinsMaterial':
        ...
        return constructor.new(_1226.RingPinsMaterial)(self.wrapped.RingPinsMaterial) if self.wrapped.RingPinsMaterial else None
