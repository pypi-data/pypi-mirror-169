...
from mastapy.system_model.part_model.gears import _2202, _2218, _2201
...
class CylindricalGearMesh(_1994.GearMesh):
    '''CylindricalGearMesh
    ...
    @property
    def cylindrical_gear_set(self) -> '_2202.CylindricalGearSet':
        ...
        if _2202.CylindricalGearSet.TYPE not in self.wrapped.CylindricalGearSet.__class__.__mro__:
