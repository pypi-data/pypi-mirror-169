...
from mastapy.system_model.fe import (
    _2043, _2066, _2089, _2037,
    _2039, _2064, _2087, _2065,
    _2061, _2073, _2074, _2072,
    _2069, _2070, _2071
)
from mastapy._internal.python_net import python_net_import
from mastapy.system_model.part_model import _2127, _2123, _2131
...
class FESubstructure(_60.FEStiffness):
    ...
    @property
    def bearing_node_alignment(self) -> '_2043.BearingNodeAlignmentOption':
        ...
        return constructor.new(_2043.BearingNodeAlignmentOption)(value) if value else None

    @bearing_node_alignment.setter
    def bearing_node_alignment(self, value: '_2043.BearingNodeAlignmentOption'):
    ...
    @property
    def alignment_method(self) -> '_2037.AlignmentMethod':
        ...
        return constructor.new(_2037.AlignmentMethod)(value) if value else None

    @alignment_method.setter
    def alignment_method(self, value: '_2037.AlignmentMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def alignment_to_component(self) -> '_1905.RelativeComponentAlignment[_2123.Component]':
        ...
        return constructor.new(_1905.RelativeComponentAlignment)[_2123.Component](self.wrapped.AlignmentToComponent) if self.wrapped.AlignmentToComponent else None

    @property
    def alignment_using_axial_node_positions(self) -> '_2039.AlignmentUsingAxialNodePositions':
        ...
        return constructor.new(_2039.AlignmentUsingAxialNodePositions)(self.wrapped.AlignmentUsingAxialNodePositions) if self.wrapped.AlignmentUsingAxialNodePositions else None

    @property
    def coordinate_system(self) -> '_1262.CoordinateSystem3D':
        ...
        return constructor.new(_1262.CoordinateSystem3D)(self.wrapped.CoordinateSystem) if self.wrapped.CoordinateSystem else None

    @property
    def export(self) -> '_2064.FESubstructureExportOptions':
        ...
        return constructor.new(_2064.FESubstructureExportOptions)(self.wrapped.Export) if self.wrapped.Export else None
    ...
    @property
    def shafts_that_can_be_replaced(self) -> 'List[_2087.ReplacedShaftSelectionHelper]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftsThatCanBeReplaced, constructor.new(_2087.ReplacedShaftSelectionHelper))
        return value
    ...
    @property
    def replaced_shafts(self) -> 'List[_2159.Shaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ReplacedShafts, constructor.new(_2159.Shaft))
        return value

    @property
    def links(self) -> 'List[_2096.FELink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_2096.FELink))
        return value
    ...
    @property
    def geometries(self) -> 'List[_2061.FEStiffnessGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Geometries, constructor.new(_2061.FEStiffnessGeometry))
        return value

    @property
    def gear_meshing_options(self) -> 'List[_2073.GearMeshingOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshingOptions, constructor.new(_2073.GearMeshingOptions))
        return value

    @property
    def independent_masta_created_condensation_nodes(self) -> 'List[_2074.IndependentMastaCreatedCondensationNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.IndependentMastaCreatedCondensationNodes, constructor.new(_2074.IndependentMastaCreatedCondensationNode))
        return value

    @property
    def fe_part(self) -> '_2131.FEPart':
        ...
        return constructor.new(_2131.FEPart)(self.wrapped.FEPart) if self.wrapped.FEPart else None
    ...
    def load_existing_masta_fe_file_with_progress(self, file_name: 'str', progress: '_7205.TaskProgress'):
        ''' 'LoadExistingMastaFEFile' is the original name of this method.
    ...
    def create_fe_substructure_with_selection_for_static_analysis(self) -> '_2072.FESubstructureWithSelectionForStaticAnalysis':
    ...
    def create_fe_substructure_with_selection_components(self) -> '_2069.FESubstructureWithSelectionComponents':
    ...
    def create_fe_substructure_with_selection_for_harmonic_analysis(self) -> '_2070.FESubstructureWithSelectionForHarmonicAnalysis':
    ...
    def create_fe_substructure_with_selection_for_modal_analysis(self) -> '_2071.FESubstructureWithSelectionForModalAnalysis':
    ...
    def import_fe_mesh(self, file_path: 'str', format_: '_149.FEExportFormat', length_scale: Optional['float'] = 1.0, force_scale: Optional['float'] = 1.0, progress: Optional['_7205.TaskProgress'] = None):
    ...
    def links_for(self, node: '_2065.FESubstructureNode') -> 'List[_2096.FELink]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.LinksFor(node.wrapped if node else None), constructor.new(_2096.FELink))
