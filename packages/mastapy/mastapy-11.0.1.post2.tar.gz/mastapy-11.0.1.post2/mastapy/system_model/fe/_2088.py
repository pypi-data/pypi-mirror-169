...
from mastapy.system_model.fe import _2083, _2082
...
class SystemDeflectionFEExportOptions(_0.APIBase):
    ...
    @property
    def nodes(self) -> 'List[_2083.PerNodeExportOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Nodes, constructor.new(_2083.PerNodeExportOptions))
        return value

    @property
    def links(self) -> 'List[_2082.PerLinkExportOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_2082.PerLinkExportOptions))
        return value
