...
from mastapy.system_model.fe import _2078, _2068
...
class FESubstructureWithSelectionForStaticAnalysis(_2068.FESubstructureWithSelection):
    '''FESubstructureWithSelectionForStaticAnalysis
    ...
    @property
    def boundary_conditions_selected_nodes(self) -> 'List[_2078.NodeBoundaryConditionStaticAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoundaryConditionsSelectedNodes, constructor.new(_2078.NodeBoundaryConditionStaticAnalysis))
        return value

    @property
    def boundary_conditions_all_nodes(self) -> 'List[_2078.NodeBoundaryConditionStaticAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoundaryConditionsAllNodes, constructor.new(_2078.NodeBoundaryConditionStaticAnalysis))
        return value
