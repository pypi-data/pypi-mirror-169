...
from mastapy.system_model.fe import _2038, _2045
...
class RaceBearingFE(_0.APIBase):
    ...
    @property
    def alignment_method(self) -> '_2038.AlignmentMethodForRaceBearing':
        ...
        return constructor.new(_2038.AlignmentMethodForRaceBearing)(value) if value else None

    @alignment_method.setter
    def alignment_method(self, value: '_2038.AlignmentMethodForRaceBearing'):
    ...
    @property
    def links(self) -> 'List[_2045.BearingRaceNodeLink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_2045.BearingRaceNodeLink))
        return value
