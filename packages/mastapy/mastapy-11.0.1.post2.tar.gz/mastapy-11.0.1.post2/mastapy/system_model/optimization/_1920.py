...
from mastapy.system_model.optimization import _1921, _1919
...
TStep = TypeVar('TStep', bound='_1919.OptimizationStep')


class OptimizationStrategy(_1921.OptimizationStrategyBase, Generic[TStep]):
    '''OptimizationStrategy
