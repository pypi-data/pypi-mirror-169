...
TReal = TypeVar('TReal', bound='_2123.Component')
TComponentStaticLoad = TypeVar('TComponentStaticLoad', bound='_6481.ComponentLoadCase')


class ComponentStaticLoadCaseGroup(_5334.PartStaticLoadCaseGroup, Generic[TReal, TComponentStaticLoad]):
    '''ComponentStaticLoadCaseGroup
