...
class MassDiscCompoundModalAnalysis(_5027.VirtualComponentCompoundModalAnalysis):
    '''MassDiscCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4829.MassDiscModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4829.MassDiscModalAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4829.MassDiscModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4829.MassDiscModalAnalysis))
        return value
