...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _2313
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4904, _4901, _4903
...
class PartModalAnalysis(_7196.PartStaticLoadAnalysisCase):
    '''PartModalAnalysis
    ...
    def modal_analysis(self) -> '_2310.ModalAnalysis':
        ...
        if _2310.ModalAnalysis.TYPE not in self.wrapped.ModalAnalysis.__class__.__mro__:
    ...
    @property
    def results_for_modes(self) -> 'List[_4904.SingleModeResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResultsForModes, constructor.new(_4904.SingleModeResults))
        return value

    @property
    def shaft_excitation_details(self) -> 'List[_4901.RigidlyConnectedDesignEntityGroupModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftExcitationDetails, constructor.new(_4901.RigidlyConnectedDesignEntityGroupModalAnalysis))
        return value

    @property
    def gear_mesh_excitation_details(self) -> 'List[_4901.RigidlyConnectedDesignEntityGroupModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshExcitationDetails, constructor.new(_4901.RigidlyConnectedDesignEntityGroupModalAnalysis))
        return value

    @property
    def excited_modes_summary(self) -> 'List[_4903.SingleExcitationResultsModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcitedModesSummary, constructor.new(_4903.SingleExcitationResultsModalAnalysis))
        return value
    ...
    def create_viewable(self) -> '_1931.ModalAnalysisViewable':
