...
from mastapy.utility.modal_analysis import _1528
...
class RigidlyConnectedDesignEntityGroupModalAnalysis(_2327.DesignEntityGroupAnalysis):
    '''RigidlyConnectedDesignEntityGroupModalAnalysis
    ...
    @property
    def excitation_frequencies_at_reference_speed(self) -> 'List[_1528.DesignEntityExcitationDescription]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcitationFrequenciesAtReferenceSpeed, constructor.new(_1528.DesignEntityExcitationDescription))
        return value
