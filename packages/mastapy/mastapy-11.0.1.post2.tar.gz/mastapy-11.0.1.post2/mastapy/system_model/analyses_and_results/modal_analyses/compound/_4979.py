...
class KlingelnbergCycloPalloidSpiralBevelGearSetCompoundModalAnalysis(_4973.KlingelnbergCycloPalloidConicalGearSetCompoundModalAnalysis):
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4828.KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4828.KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4828.KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4828.KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysis))
        return value
