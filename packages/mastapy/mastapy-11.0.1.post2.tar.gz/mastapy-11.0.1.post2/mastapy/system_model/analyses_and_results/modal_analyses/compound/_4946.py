...
class CVTCompoundModalAnalysis(_4915.BeltDriveCompoundModalAnalysis):
    '''CVTCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4794.CVTModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4794.CVTModalAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4794.CVTModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4794.CVTModalAnalysis))
        return value
