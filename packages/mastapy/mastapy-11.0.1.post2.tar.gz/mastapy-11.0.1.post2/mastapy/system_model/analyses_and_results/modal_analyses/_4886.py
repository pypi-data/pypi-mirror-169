...
from mastapy.math_utility import (
    _1270, _1297, _1258, _1284,
    _1269, _1253, _1268, _1290
)
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.system_model.analyses_and_results.modal_analyses import (
    _4789, _4883, _4882, _4836,
    _4884
)
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import (
    _5753, _5756, _5764, _5765
)
from mastapy.system_model.drawing.options import _1944, _1942
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5666, _5720
from mastapy.utility.units_and_measurements.measurements import (
    _1418, _1371, _1470, _1377,
    _1368, _1373, _1392, _1465,
    _1386, _1436, _1437, _1440
)
from mastapy.utility.property import _1569
...
class WhineWaterfallSettings(_0.APIBase):
    ...
    @property
    def translation_or_rotation(self) -> '_1297.TranslationRotation':
        ...
        return constructor.new(_1297.TranslationRotation)(value) if value else None

    @translation_or_rotation.setter
    def translation_or_rotation(self, value: '_1297.TranslationRotation'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TranslationOrRotation = value

    @property
    def coordinate_system(self) -> '_4789.CoordinateSystemForWhine':
        ...
        return constructor.new(_4789.CoordinateSystemForWhine)(value) if value else None

    @coordinate_system.setter
    def coordinate_system(self, value: '_4789.CoordinateSystemForWhine'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def vector_magnitude_method(self) -> '_1284.ComplexMagnitudeMethod':
        ...
        return constructor.new(_1284.ComplexMagnitudeMethod)(value) if value else None

    @vector_magnitude_method.setter
    def vector_magnitude_method(self, value: '_1284.ComplexMagnitudeMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def weighting(self) -> '_1253.AcousticWeighting':
        '''AcousticWeighting: 'Weighting' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Weighting)
        return constructor.new(_1253.AcousticWeighting)(value) if value else None

    @weighting.setter
    def weighting(self, value: '_1253.AcousticWeighting'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def chart_type(self) -> '_1268.DynamicsResponse3DChartType':
        ...
        return constructor.new(_1268.DynamicsResponse3DChartType)(value) if value else None

    @chart_type.setter
    def chart_type(self, value: '_1268.DynamicsResponse3DChartType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def whine_waterfall_export_option(self) -> '_4883.WhineWaterfallExportOption':
        ...
        return constructor.new(_4883.WhineWaterfallExportOption)(value) if value else None

    @whine_waterfall_export_option.setter
    def whine_waterfall_export_option(self, value: '_4883.WhineWaterfallExportOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def waterfall_chart_settings(self) -> '_4882.WaterfallChartSettings':
        ...
        return constructor.new(_4882.WaterfallChartSettings)(self.wrapped.WaterfallChartSettings) if self.wrapped.WaterfallChartSettings else None

    @property
    def order_cuts_chart_settings(self) -> '_4836.OrderCutsChartSettings':
        ...
        return constructor.new(_4836.OrderCutsChartSettings)(self.wrapped.OrderCutsChartSettings) if self.wrapped.OrderCutsChartSettings else None

    @property
    def modal_contribution_view_options(self) -> '_1944.ModalContributionViewOptions':
        ...
        return constructor.new(_1944.ModalContributionViewOptions)(self.wrapped.ModalContributionViewOptions) if self.wrapped.ModalContributionViewOptions else None

    @property
    def mode_view_options(self) -> '_1942.AdvancedTimeSteppingAnalysisForModulationModeViewOptions':
        ...
        return constructor.new(_1942.AdvancedTimeSteppingAnalysisForModulationModeViewOptions)(self.wrapped.ModeViewOptions) if self.wrapped.ModeViewOptions else None

    @property
    def frequency_options(self) -> '_5666.FrequencyOptionsForHarmonicAnalysisResults':
        ...
        return constructor.new(_5666.FrequencyOptionsForHarmonicAnalysisResults)(self.wrapped.FrequencyOptions) if self.wrapped.FrequencyOptions else None

    @property
    def reference_speed_options(self) -> '_5720.SpeedOptionsForHarmonicAnalysisResults':
        ...
        return constructor.new(_5720.SpeedOptionsForHarmonicAnalysisResults)(self.wrapped.ReferenceSpeedOptions) if self.wrapped.ReferenceSpeedOptions else None

    @property
    def very_short_length_reference_values(self) -> '_4884.WhineWaterfallReferenceValues[_1418.LengthVeryShort]':
        ...
        return constructor.new(_4884.WhineWaterfallReferenceValues)[_1418.LengthVeryShort](self.wrapped.VeryShortLengthReferenceValues) if self.wrapped.VeryShortLengthReferenceValues else None

    @property
    def small_angle_reference_values(self) -> '_4884.WhineWaterfallReferenceValues[_1371.AngleSmall]':
        ...
        return constructor.new(_4884.WhineWaterfallReferenceValues)[_1371.AngleSmall](self.wrapped.SmallAngleReferenceValues) if self.wrapped.SmallAngleReferenceValues else None

    @property
    def small_velocity_reference_values(self) -> '_4884.WhineWaterfallReferenceValues[_1470.VelocitySmall]':
        ...
        return constructor.new(_4884.WhineWaterfallReferenceValues)[_1470.VelocitySmall](self.wrapped.SmallVelocityReferenceValues) if self.wrapped.SmallVelocityReferenceValues else None

    @property
    def angular_velocity_reference_values(self) -> '_4884.WhineWaterfallReferenceValues[_1377.AngularVelocity]':
        ...
        return constructor.new(_4884.WhineWaterfallReferenceValues)[_1377.AngularVelocity](self.wrapped.AngularVelocityReferenceValues) if self.wrapped.AngularVelocityReferenceValues else None

    @property
    def acceleration_reference_values(self) -> '_4884.WhineWaterfallReferenceValues[_1368.Acceleration]':
        ...
        return constructor.new(_4884.WhineWaterfallReferenceValues)[_1368.Acceleration](self.wrapped.AccelerationReferenceValues) if self.wrapped.AccelerationReferenceValues else None

    @property
    def angular_acceleration_reference_values(self) -> '_4884.WhineWaterfallReferenceValues[_1373.AngularAcceleration]':
        ...
        return constructor.new(_4884.WhineWaterfallReferenceValues)[_1373.AngularAcceleration](self.wrapped.AngularAccelerationReferenceValues) if self.wrapped.AngularAccelerationReferenceValues else None

    @property
    def force_reference_values(self) -> '_4884.WhineWaterfallReferenceValues[_1392.Force]':
        ...
        return constructor.new(_4884.WhineWaterfallReferenceValues)[_1392.Force](self.wrapped.ForceReferenceValues) if self.wrapped.ForceReferenceValues else None

    @property
    def torque_reference_values(self) -> '_4884.WhineWaterfallReferenceValues[_1465.Torque]':
        ...
        return constructor.new(_4884.WhineWaterfallReferenceValues)[_1465.Torque](self.wrapped.TorqueReferenceValues) if self.wrapped.TorqueReferenceValues else None

    @property
    def energy_reference_values(self) -> '_4884.WhineWaterfallReferenceValues[_1386.Energy]':
        ...
        return constructor.new(_4884.WhineWaterfallReferenceValues)[_1386.Energy](self.wrapped.EnergyReferenceValues) if self.wrapped.EnergyReferenceValues else None

    @property
    def power_small_reference_values(self) -> '_4884.WhineWaterfallReferenceValues[_1436.PowerSmall]':
        ...
        return constructor.new(_4884.WhineWaterfallReferenceValues)[_1436.PowerSmall](self.wrapped.PowerSmallReferenceValues) if self.wrapped.PowerSmallReferenceValues else None

    @property
    def power_small_per_unit_area_reference_values(self) -> '_4884.WhineWaterfallReferenceValues[_1437.PowerSmallPerArea]':
        ...
        return constructor.new(_4884.WhineWaterfallReferenceValues)[_1437.PowerSmallPerArea](self.wrapped.PowerSmallPerUnitAreaReferenceValues) if self.wrapped.PowerSmallPerUnitAreaReferenceValues else None

    @property
    def pressure_reference_values(self) -> '_4884.WhineWaterfallReferenceValues[_1440.Pressure]':
        ...
        return constructor.new(_4884.WhineWaterfallReferenceValues)[_1440.Pressure](self.wrapped.PressureReferenceValues) if self.wrapped.PressureReferenceValues else None

    @property
    def result_location_selection_groups(self) -> '_5764.ResultLocationSelectionGroups':
        ...
        return constructor.new(_5764.ResultLocationSelectionGroups)(self.wrapped.ResultLocationSelectionGroups) if self.wrapped.ResultLocationSelectionGroups else None

    @property
    def active_result_locations(self) -> 'List[_5765.ResultNodeSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ActiveResultLocations, constructor.new(_5765.ResultNodeSelection))
        return value

    @property
    def degrees_of_freedom(self) -> 'List[_1569.EnumWithBool[_1290.ResultOptionsFor3DVector]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DegreesOfFreedom, constructor.new(_1569.EnumWithBool)[_1290.ResultOptionsFor3DVector])
        return value
