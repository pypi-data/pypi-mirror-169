...
class PlanetaryGearSetCompoundModalAnalysis(_4954.CylindricalGearSetCompoundModalAnalysis):
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4842.PlanetaryGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4842.PlanetaryGearSetModalAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4842.PlanetaryGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4842.PlanetaryGearSetModalAnalysis))
        return value
