...
class KlingelnbergCycloPalloidHypoidGearMeshCompoundModalAnalysis(_4972.KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysis):
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4823.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4823.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4823.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4823.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysis))
        return value
