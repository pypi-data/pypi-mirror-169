...
class CylindricalPlanetGearCompoundPowerFlow(_3877.CylindricalGearCompoundPowerFlow):
    '''CylindricalPlanetGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3748.CylindricalPlanetGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3748.CylindricalPlanetGearPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3748.CylindricalPlanetGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3748.CylindricalPlanetGearPowerFlow))
        return value
