...
class BevelGearCompoundPowerFlow(_3834.AGMAGleasonConicalGearCompoundPowerFlow):
    '''BevelGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3714.BevelGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3714.BevelGearPowerFlow))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3714.BevelGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3714.BevelGearPowerFlow))
        return value
