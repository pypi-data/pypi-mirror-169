...
class AbstractShaftCompoundPowerFlow(_3832.AbstractShaftOrHousingCompoundPowerFlow):
    '''AbstractShaftCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3699.AbstractShaftPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3699.AbstractShaftPowerFlow))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3699.AbstractShaftPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3699.AbstractShaftPowerFlow))
        return value
