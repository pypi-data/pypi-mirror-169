...
class PartParametricStudyTool(_7193.PartAnalysisCase):
    '''PartParametricStudyTool
    ...
    @property
    def parametric_study_tool(self) -> '_4051.ParametricStudyTool':
        ...
        return constructor.new(_4051.ParametricStudyTool)(self.wrapped.ParametricStudyTool) if self.wrapped.ParametricStudyTool else None

    @property
    def data_logger(self) -> '_1575.DataLoggerWithCharts':
        ...
        return constructor.new(_1575.DataLoggerWithCharts)(self.wrapped.DataLogger) if self.wrapped.DataLogger else None
