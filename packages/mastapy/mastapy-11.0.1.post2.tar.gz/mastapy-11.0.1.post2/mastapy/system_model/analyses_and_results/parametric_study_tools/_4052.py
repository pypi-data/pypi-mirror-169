...
from mastapy.system_model.analyses_and_results.static_loads import _6462, _6574
from mastapy.system_model import _1896
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4054, _4055
...
class ParametricStudyToolOptions(_0.APIBase):
    ...
    @property
    def parametric_study_type(self) -> '_6574.ParametricStudyType':
        ...
        return constructor.new(_6574.ParametricStudyType)(value) if value else None

    @parametric_study_type.setter
    def parametric_study_type(self, value: '_6574.ParametricStudyType'):
    ...
    @property
    def external_full_fe_loader(self) -> '_1896.ExternalFullFELoader':
        ...
        return constructor.new(_1896.ExternalFullFELoader)(self.wrapped.ExternalFullFELoader) if self.wrapped.ExternalFullFELoader else None

    @property
    def step_results(self) -> 'List[_4054.ParametricStudyToolStepResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StepResults, constructor.new(_4054.ParametricStudyToolStepResult))
        return value

    @property
    def study_variables(self) -> 'List[_4055.ParametricStudyVariable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StudyVariables, constructor.new(_4055.ParametricStudyVariable))
        return value
