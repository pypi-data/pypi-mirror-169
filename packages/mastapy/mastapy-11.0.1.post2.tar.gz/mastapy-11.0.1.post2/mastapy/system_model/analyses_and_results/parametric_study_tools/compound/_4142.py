...
class ConnectorCompoundParametricStudyTool(_4183.MountableComponentCompoundParametricStudyTool):
    '''ConnectorCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3995.ConnectorParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3995.ConnectorParametricStudyTool))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3995.ConnectorParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3995.ConnectorParametricStudyTool))
        return value
