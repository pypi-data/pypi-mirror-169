...
class CylindricalPlanetGearCompoundSteadyStateSynchronousResponseOnAShaft(_2827.CylindricalGearCompoundSteadyStateSynchronousResponseOnAShaft):
    '''CylindricalPlanetGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2700.CylindricalPlanetGearSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2700.CylindricalPlanetGearSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2700.CylindricalPlanetGearSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2700.CylindricalPlanetGearSteadyStateSynchronousResponseOnAShaft))
        return value
