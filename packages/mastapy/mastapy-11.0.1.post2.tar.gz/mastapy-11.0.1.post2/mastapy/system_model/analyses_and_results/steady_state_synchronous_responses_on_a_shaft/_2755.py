...
class SteadyStateSynchronousResponseOnAShaft(_7198.StaticLoadAnalysisCase):
    '''SteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def options(self) -> '_3276.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_3276.SteadyStateSynchronousResponseOptions)(self.wrapped.Options) if self.wrapped.Options else None
