...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed.compound import _3088
...
class PlanetaryGearSetCompoundSteadyStateSynchronousResponseAtASpeed(_3088.CylindricalGearSetCompoundSteadyStateSynchronousResponseAtASpeed):
    '''PlanetaryGearSetCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2993.PlanetaryGearSetSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2993.PlanetaryGearSetSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_2993.PlanetaryGearSetSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2993.PlanetaryGearSetSteadyStateSynchronousResponseAtASpeed))
        return value
