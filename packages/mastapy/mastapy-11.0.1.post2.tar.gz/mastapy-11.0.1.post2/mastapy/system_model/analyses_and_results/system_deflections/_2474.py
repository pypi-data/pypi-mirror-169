...
class SpiralBevelGearMeshSystemDeflection(_2375.BevelGearMeshSystemDeflection):
    '''SpiralBevelGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3799.SpiralBevelGearMeshPowerFlow':
        ...
        return constructor.new(_3799.SpiralBevelGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
