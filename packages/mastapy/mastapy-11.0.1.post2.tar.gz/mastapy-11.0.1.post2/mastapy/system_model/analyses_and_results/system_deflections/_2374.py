...
class BevelDifferentialSunGearSystemDeflection(_2372.BevelDifferentialGearSystemDeflection):
    '''BevelDifferentialSunGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3712.BevelDifferentialSunGearPowerFlow':
        ...
        return constructor.new(_3712.BevelDifferentialSunGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
