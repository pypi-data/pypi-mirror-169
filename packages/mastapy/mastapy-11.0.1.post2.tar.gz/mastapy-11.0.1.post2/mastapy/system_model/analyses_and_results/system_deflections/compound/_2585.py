...
class KlingelnbergCycloPalloidConicalGearCompoundSystemDeflection(_2550.ConicalGearCompoundSystemDeflection):
    '''KlingelnbergCycloPalloidConicalGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2437.KlingelnbergCycloPalloidConicalGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2437.KlingelnbergCycloPalloidConicalGearSystemDeflection))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_2437.KlingelnbergCycloPalloidConicalGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2437.KlingelnbergCycloPalloidConicalGearSystemDeflection))
        return value
