...
class CVTSystemDeflection(_2369.BeltDriveSystemDeflection):
    '''CVTSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3738.CVTPowerFlow':
        ...
        return constructor.new(_3738.CVTPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
