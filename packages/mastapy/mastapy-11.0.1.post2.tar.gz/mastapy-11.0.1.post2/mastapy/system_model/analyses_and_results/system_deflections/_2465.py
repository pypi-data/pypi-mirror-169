...
class RollingRingConnectionSystemDeflection(_2434.InterMountableComponentConnectionSystemDeflection):
    '''RollingRingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3792.RollingRingConnectionPowerFlow':
        ...
        return constructor.new(_3792.RollingRingConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
