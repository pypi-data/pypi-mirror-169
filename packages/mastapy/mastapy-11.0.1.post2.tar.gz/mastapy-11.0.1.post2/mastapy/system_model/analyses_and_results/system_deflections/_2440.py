...
class KlingelnbergCycloPalloidHypoidGearSystemDeflection(_2437.KlingelnbergCycloPalloidConicalGearSystemDeflection):
    '''KlingelnbergCycloPalloidHypoidGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3768.KlingelnbergCycloPalloidHypoidGearPowerFlow':
        ...
        return constructor.new(_3768.KlingelnbergCycloPalloidHypoidGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
