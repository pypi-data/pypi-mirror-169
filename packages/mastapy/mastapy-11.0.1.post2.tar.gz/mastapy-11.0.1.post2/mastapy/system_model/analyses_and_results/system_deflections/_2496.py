...
class TorqueConverterPumpSystemDeflection(_2399.CouplingHalfSystemDeflection):
    '''TorqueConverterPumpSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3820.TorqueConverterPumpPowerFlow':
        ...
        return constructor.new(_3820.TorqueConverterPumpPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
