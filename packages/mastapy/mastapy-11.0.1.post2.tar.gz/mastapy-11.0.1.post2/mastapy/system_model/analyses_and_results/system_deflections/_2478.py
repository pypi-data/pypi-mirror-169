...
class SpringDamperHalfSystemDeflection(_2399.CouplingHalfSystemDeflection):
    '''SpringDamperHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3803.SpringDamperHalfPowerFlow':
        ...
        return constructor.new(_3803.SpringDamperHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
