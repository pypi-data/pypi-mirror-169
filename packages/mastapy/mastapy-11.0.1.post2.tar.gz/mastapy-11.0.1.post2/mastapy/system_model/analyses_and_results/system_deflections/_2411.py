...
from mastapy.system_model.analyses_and_results.power_flows import _3747, _3782
from mastapy.gears.rating.cylindrical import _423
from mastapy.gears.manufacturing.cylindrical import _568
from mastapy.system_model.analyses_and_results.system_deflections import _2414, _2408, _2427
...
class CylindricalGearSetSystemDeflection(_2427.GearSetSystemDeflection):
    '''CylindricalGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3747.CylindricalGearSetPowerFlow':
    ...
    @property
    def cylindrical_gears_system_deflection(self) -> 'List[_2414.CylindricalGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsSystemDeflection, constructor.new(_2414.CylindricalGearSystemDeflection))
        return value

    @property
    def cylindrical_meshes_system_deflection(self) -> 'List[_2408.CylindricalGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesSystemDeflection, constructor.new(_2408.CylindricalGearMeshSystemDeflection))
        return value
