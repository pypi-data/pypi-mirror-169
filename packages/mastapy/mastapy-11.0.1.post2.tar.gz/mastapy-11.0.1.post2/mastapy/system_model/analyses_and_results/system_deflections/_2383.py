...
from mastapy.system_model.analyses_and_results.power_flows import _3721, _3741
...
class CoaxialConnectionSystemDeflection(_2472.ShaftToMountableComponentConnectionSystemDeflection):
    '''CoaxialConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3721.CoaxialConnectionPowerFlow':
