...
class RollingRingSystemDeflection(_2399.CouplingHalfSystemDeflection):
    '''RollingRingSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3793.RollingRingPowerFlow':
        ...
        return constructor.new(_3793.RollingRingPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
