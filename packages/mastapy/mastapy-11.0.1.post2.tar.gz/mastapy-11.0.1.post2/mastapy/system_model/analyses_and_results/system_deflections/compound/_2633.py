...
class SynchroniserCompoundSystemDeflection(_2618.SpecialisedAssemblyCompoundSystemDeflection):
    '''SynchroniserCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2491.SynchroniserSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2491.SynchroniserSystemDeflection))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_2491.SynchroniserSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2491.SynchroniserSystemDeflection))
        return value
