...
class SpiralBevelGearSystemDeflection(_2377.BevelGearSystemDeflection):
    '''SpiralBevelGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3800.SpiralBevelGearPowerFlow':
        ...
        return constructor.new(_3800.SpiralBevelGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
