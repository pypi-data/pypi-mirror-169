...
class GuideDxfModelSystemDeflection(_2384.ComponentSystemDeflection):
    '''GuideDxfModelSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3759.GuideDxfModelPowerFlow':
        ...
        return constructor.new(_3759.GuideDxfModelPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
