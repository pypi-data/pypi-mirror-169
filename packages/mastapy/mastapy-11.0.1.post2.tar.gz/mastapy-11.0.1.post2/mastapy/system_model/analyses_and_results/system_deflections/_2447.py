...
class MeasurementComponentSystemDeflection(_2502.VirtualComponentSystemDeflection):
    '''MeasurementComponentSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3774.MeasurementComponentPowerFlow':
        ...
        return constructor.new(_3774.MeasurementComponentPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
