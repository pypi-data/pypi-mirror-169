...
class UnbalancedMassSystemDeflection(_2502.VirtualComponentSystemDeflection):
    '''UnbalancedMassSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3822.UnbalancedMassPowerFlow':
        ...
        return constructor.new(_3822.UnbalancedMassPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
