...
class StraightBevelGearMeshSystemDeflection(_2375.BevelGearMeshSystemDeflection):
    '''StraightBevelGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3808.StraightBevelGearMeshPowerFlow':
        ...
        return constructor.new(_3808.StraightBevelGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
