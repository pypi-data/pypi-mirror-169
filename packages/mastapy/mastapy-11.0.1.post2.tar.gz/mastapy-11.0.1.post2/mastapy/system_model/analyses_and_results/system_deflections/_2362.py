...
class AbstractShaftToMountableComponentConnectionSystemDeflection(_2396.ConnectionSystemDeflection):
    '''AbstractShaftToMountableComponentConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3700.AbstractShaftToMountableComponentConnectionPowerFlow':
