...
class RollingRingAssemblySystemDeflection(_2473.SpecialisedAssemblySystemDeflection):
    '''RollingRingAssemblySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3791.RollingRingAssemblyPowerFlow':
        ...
        return constructor.new(_3791.RollingRingAssemblyPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
