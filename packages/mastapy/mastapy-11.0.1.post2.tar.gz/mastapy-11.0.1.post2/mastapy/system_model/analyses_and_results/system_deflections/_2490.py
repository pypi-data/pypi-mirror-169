...
class SynchroniserSleeveSystemDeflection(_2489.SynchroniserPartSystemDeflection):
    '''SynchroniserSleeveSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3816.SynchroniserSleevePowerFlow':
        ...
        return constructor.new(_3816.SynchroniserSleevePowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
