...
from mastapy.system_model.analyses_and_results.power_flows import _3699, _3743, _3796
...
class AbstractShaftSystemDeflection(_2360.AbstractShaftOrHousingSystemDeflection):
    '''AbstractShaftSystemDeflection
    ...
    @property
    def component_design(self) -> '_2115.AbstractShaft':
    ...
    @property
    def power_flow_results(self) -> '_3699.AbstractShaftPowerFlow':
