...
from mastapy.system_model.analyses_and_results.power_flows import _3746, _3748
...
class CylindricalGearSystemDeflection(_2428.GearSystemDeflection):
    '''CylindricalGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3746.CylindricalGearPowerFlow':
