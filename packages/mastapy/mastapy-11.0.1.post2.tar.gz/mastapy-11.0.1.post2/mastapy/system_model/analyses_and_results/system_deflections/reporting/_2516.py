...
class ShaftSystemDeflectionSectionsReport(_1491.CustomReportChart):
    '''ShaftSystemDeflectionSectionsReport
    ...
    @property
    def display(self) -> '_1549.TableAndChartOptions':
        '''TableAndChartOptions: 'Display' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Display)
        return constructor.new(_1549.TableAndChartOptions)(value) if value else None

    @display.setter
    def display(self, value: '_1549.TableAndChartOptions'):
