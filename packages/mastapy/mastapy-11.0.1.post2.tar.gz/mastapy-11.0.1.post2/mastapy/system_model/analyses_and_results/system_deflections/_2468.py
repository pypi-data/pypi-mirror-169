...
from mastapy.detailed_rigid_connectors.splines.ratings import (
    _1189, _1191, _1193, _1195,
    _1197
)
from mastapy._internal.cast_exception import CastException
from mastapy.detailed_rigid_connectors.keyed_joints.rating import _1207
from mastapy.detailed_rigid_connectors.interference_fits.rating import _1214
...
class ShaftHubConnectionSystemDeflection(_2397.ConnectorSystemDeflection):
    '''ShaftHubConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3795.ShaftHubConnectionPowerFlow':
        ...
        return constructor.new(_3795.ShaftHubConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def component_detailed_analysis(self) -> '_1201.ShaftHubConnectionRating':
        ...
        if _1201.ShaftHubConnectionRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_agma6123_spline_joint_rating(self) -> '_1189.AGMA6123SplineJointRating':
        ...
        if _1189.AGMA6123SplineJointRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_din5466_spline_rating(self) -> '_1191.DIN5466SplineRating':
        ...
        if _1191.DIN5466SplineRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_gbt17855_spline_joint_rating(self) -> '_1193.GBT17855SplineJointRating':
        ...
        if _1193.GBT17855SplineJointRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_sae_spline_joint_rating(self) -> '_1195.SAESplineJointRating':
        ...
        if _1195.SAESplineJointRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_spline_joint_rating(self) -> '_1197.SplineJointRating':
        ...
        if _1197.SplineJointRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_keyway_rating(self) -> '_1207.KeywayRating':
        ...
        if _1207.KeywayRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_interference_fit_rating(self) -> '_1214.InterferenceFitRating':
        ...
        if _1214.InterferenceFitRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def stiffness_matrix_in_local_coordinate_system(self) -> '_1646.BearingStiffnessMatrixReporter':
        ...
        return constructor.new(_1646.BearingStiffnessMatrixReporter)(self.wrapped.StiffnessMatrixInLocalCoordinateSystem) if self.wrapped.StiffnessMatrixInLocalCoordinateSystem else None

    @property
    def stiffness_matrix_in_unrotated_coordinate_system(self) -> '_1646.BearingStiffnessMatrixReporter':
        ...
        return constructor.new(_1646.BearingStiffnessMatrixReporter)(self.wrapped.StiffnessMatrixInUnrotatedCoordinateSystem) if self.wrapped.StiffnessMatrixInUnrotatedCoordinateSystem else None
    ...
    @property
    def left_flank_contacts(self) -> 'List[_2517.SplineFlankContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LeftFlankContacts, constructor.new(_2517.SplineFlankContactReporting))
        return value

    @property
    def right_flank_contacts(self) -> 'List[_2517.SplineFlankContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RightFlankContacts, constructor.new(_2517.SplineFlankContactReporting))
        return value

    @property
    def tip_contacts(self) -> 'List[_2517.SplineFlankContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TipContacts, constructor.new(_2517.SplineFlankContactReporting))
        return value
