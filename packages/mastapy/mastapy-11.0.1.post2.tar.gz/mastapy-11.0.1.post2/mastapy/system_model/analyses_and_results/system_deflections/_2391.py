...
class ConceptGearSystemDeflection(_2428.GearSystemDeflection):
    '''ConceptGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3727.ConceptGearPowerFlow':
        ...
        return constructor.new(_3727.ConceptGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
