...
class StraightBevelPlanetGearSystemDeflection(_2482.StraightBevelDiffGearSystemDeflection):
    '''StraightBevelPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3811.StraightBevelPlanetGearPowerFlow':
        ...
        return constructor.new(_3811.StraightBevelPlanetGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
