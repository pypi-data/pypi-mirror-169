...
class StraightBevelGearSystemDeflection(_2377.BevelGearSystemDeflection):
    '''StraightBevelGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3809.StraightBevelGearPowerFlow':
        ...
        return constructor.new(_3809.StraightBevelGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
