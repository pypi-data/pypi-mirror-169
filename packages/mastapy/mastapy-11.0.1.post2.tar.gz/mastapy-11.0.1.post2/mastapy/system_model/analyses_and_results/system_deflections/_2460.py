...
from mastapy.system_model.analyses_and_results.power_flows import _3788, _3739
...
class PulleySystemDeflection(_2399.CouplingHalfSystemDeflection):
    '''PulleySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3788.PulleyPowerFlow':
