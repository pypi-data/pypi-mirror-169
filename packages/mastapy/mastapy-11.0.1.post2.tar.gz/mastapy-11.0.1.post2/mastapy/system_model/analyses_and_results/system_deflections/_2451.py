...
class OilSealSystemDeflection(_2397.ConnectorSystemDeflection):
    '''OilSealSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3776.OilSealPowerFlow':
        ...
        return constructor.new(_3776.OilSealPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
