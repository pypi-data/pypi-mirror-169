...
class ConnectorSystemDeflection(_2449.MountableComponentSystemDeflection):
    '''ConnectorSystemDeflection
    ...
    @property
    def outer_fe_part(self) -> '_2424.FEPartSystemDeflection':
        ...
        return constructor.new(_2424.FEPartSystemDeflection)(self.wrapped.OuterFEPart) if self.wrapped.OuterFEPart else None
    ...
    @property
    def outer_fe_substructure_nodes(self) -> 'List[_2065.FESubstructureNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.OuterFESubstructureNodes, constructor.new(_2065.FESubstructureNode))
        return value

    @property
    def power_flow_results(self) -> '_3733.ConnectorPowerFlow':
