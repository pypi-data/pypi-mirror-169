...
class FaceGearSystemDeflection(_2428.GearSystemDeflection):
    '''FaceGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3752.FaceGearPowerFlow':
        ...
        return constructor.new(_3752.FaceGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
