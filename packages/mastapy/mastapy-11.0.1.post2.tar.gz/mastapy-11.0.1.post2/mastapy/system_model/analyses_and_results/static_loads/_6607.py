...
from mastapy.system_model.analyses_and_results.load_case_groups import _5318, _5319, _5320
...
class StaticLoadCase(_6450.LoadCase):
    '''StaticLoadCase
    ...
    @property
    def advanced_system_deflection_options(self) -> '_6923.AdvancedSystemDeflectionOptions':
        ...
        return constructor.new(_6923.AdvancedSystemDeflectionOptions)(self.wrapped.AdvancedSystemDeflectionOptions) if self.wrapped.AdvancedSystemDeflectionOptions else None

    @property
    def te_set_up_for_dynamic_analyses_options(self) -> '_2357.TESetUpForDynamicAnalysisOptions':
        ...
        return constructor.new(_2357.TESetUpForDynamicAnalysisOptions)(self.wrapped.TESetUpForDynamicAnalysesOptions) if self.wrapped.TESetUpForDynamicAnalysesOptions else None
    ...
    @property
    def harmonic_analysis_options_for_atsam(self) -> '_5678.HarmonicAnalysisOptions':
        ...
        if _5678.HarmonicAnalysisOptions.TYPE not in self.wrapped.HarmonicAnalysisOptionsForATSAM.__class__.__mro__:
    ...
    @property
    def clutch_engagements(self) -> 'List[_5318.ClutchEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ClutchEngagements, constructor.new(_5318.ClutchEngagementStatus))
        return value

    @property
    def concept_clutch_engagements(self) -> 'List[_5319.ConceptSynchroGearEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptClutchEngagements, constructor.new(_5319.ConceptSynchroGearEngagementStatus))
        return value
    ...
    def duplicate(self, new_design_state_group: '_5320.DesignState', name: Optional['str'] = 'None') -> 'StaticLoadCase':
