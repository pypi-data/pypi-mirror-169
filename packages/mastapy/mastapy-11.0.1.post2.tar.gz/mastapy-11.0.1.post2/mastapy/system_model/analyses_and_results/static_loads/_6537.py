...
from mastapy.system_model.analyses_and_results.static_loads import _6539, _6558
...
class GearMeshLoadCase(_6558.InterMountableComponentConnectionLoadCase):
    '''GearMeshLoadCase
    ...
    def get_harmonic_load_data_for_import(self) -> '_6539.GearSetHarmonicLoadData':
