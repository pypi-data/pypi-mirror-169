...
from mastapy.math_utility import _1267, _1277
...
class PointLoadHarmonicLoadData(_6600.SpeedDependentHarmonicLoadData):
    '''PointLoadHarmonicLoadData
    ...
    @property
    def degree_of_freedom(self) -> '_1267.DegreesOfFreedom':
        ...
        return constructor.new(_1267.DegreesOfFreedom)(value) if value else None

    @degree_of_freedom.setter
    def degree_of_freedom(self, value: '_1267.DegreesOfFreedom'):
