...
from mastapy.system_model import _1901, _1902, _1903
from mastapy.system_model.analyses_and_results.mbd_analyses import _5173
from mastapy.system_model.analyses_and_results.static_loads import _6627, _6517, _6631
from mastapy.system_model.fe import _2054
from mastapy.system_model.part_model import _2150
from mastapy.math_utility.control import _1336
...
class PowerLoadLoadCase(_6631.VirtualComponentLoadCase):
    '''PowerLoadLoadCase
    ...
    @property
    def drag_torque_specification_method(self) -> '_1901.PowerLoadDragTorqueSpecificationMethod':
        ...
        return constructor.new(_1901.PowerLoadDragTorqueSpecificationMethod)(value) if value else None

    @drag_torque_specification_method.setter
    def drag_torque_specification_method(self, value: '_1901.PowerLoadDragTorqueSpecificationMethod'):
    ...
    @property
    def wheel_slip_model(self) -> '_5173.WheelSlipType':
        ...
        return constructor.new(_5173.WheelSlipType)(value) if value else None

    @wheel_slip_model.setter
    def wheel_slip_model(self, value: '_5173.WheelSlipType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def target_speed_input_type(self) -> '_1903.PowerLoadPIDControlSpeedInputType':
        ...
        return constructor.new(_1903.PowerLoadPIDControlSpeedInputType)(value) if value else None

    @target_speed_input_type.setter
    def target_speed_input_type(self, value: '_1903.PowerLoadPIDControlSpeedInputType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def engine_idle_speed_control_pid_settings(self) -> '_1336.PIDControlSettings':
        ...
        return constructor.new(_1336.PIDControlSettings)(self.wrapped.EngineIdleSpeedControlPIDSettings) if self.wrapped.EngineIdleSpeedControlPIDSettings else None
    ...
    @property
    def pid_control_settings(self) -> '_1336.PIDControlSettings':
        ...
        return constructor.new(_1336.PIDControlSettings)(self.wrapped.PIDControlSettings) if self.wrapped.PIDControlSettings else None

    def get_harmonic_load_data_for_import(self) -> '_6517.ElectricMachineHarmonicLoadData':
