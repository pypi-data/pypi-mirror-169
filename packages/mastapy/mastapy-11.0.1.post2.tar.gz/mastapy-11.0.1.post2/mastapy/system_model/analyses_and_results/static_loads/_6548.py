...
from mastapy.system_model.analyses_and_results.static_loads import _6551, _6547, _6525
...
class HarmonicLoadDataImportFromMotorPackages(_6547.HarmonicLoadDataImportBase['T'], Generic[T]):
    '''HarmonicLoadDataImportFromMotorPackages
