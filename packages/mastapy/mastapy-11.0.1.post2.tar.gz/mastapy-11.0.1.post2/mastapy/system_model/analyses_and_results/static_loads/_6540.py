...
from mastapy.system_model.analyses_and_results.static_loads import _6537, _6535, _6599
...
class GearSetLoadCase(_6599.SpecialisedAssemblyLoadCase):
    '''GearSetLoadCase
    ...
    @property
    def gear_mesh_stiffness_model(self) -> '_5096.GearMeshStiffnessModel':
        ...
        return constructor.new(_5096.GearMeshStiffnessModel)(value) if value else None

    @gear_mesh_stiffness_model.setter
    def gear_mesh_stiffness_model(self, value: '_5096.GearMeshStiffnessModel'):
    ...
    @property
    def assembly_design(self) -> '_2208.GearSet':
    ...
    @property
    def advanced_time_stepping_analysis_for_modulation_options(self) -> '_6661.AdvancedTimeSteppingAnalysisForModulationOptions':
        ...
        return constructor.new(_6661.AdvancedTimeSteppingAnalysisForModulationOptions)(self.wrapped.AdvancedTimeSteppingAnalysisForModulationOptions) if self.wrapped.AdvancedTimeSteppingAnalysisForModulationOptions else None

    @property
    def meshes_without_planetary_duplicates(self) -> 'List[_6537.GearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesWithoutPlanetaryDuplicates, constructor.new(_6537.GearMeshLoadCase))
        return value

    @property
    def gears(self) -> 'List[_6535.GearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6535.GearLoadCase))
        return value

    @property
    def gears_without_clones(self) -> 'List[_6535.GearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsWithoutClones, constructor.new(_6535.GearLoadCase))
        return value
