...
class RootAssemblyLoadCase(_6463.AssemblyLoadCase):
    '''RootAssemblyLoadCase
    ...
    @property
    def drive_cycle_pid_control_settings(self) -> '_1336.PIDControlSettings':
        ...
        return constructor.new(_1336.PIDControlSettings)(self.wrapped.DriveCyclePIDControlSettings) if self.wrapped.DriveCyclePIDControlSettings else None
    ...
    @property
    def supercharger_rotor_sets(self) -> 'List[_6509.CylindricalGearSetLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SuperchargerRotorSets, constructor.new(_6509.CylindricalGearSetLoadCase))
        return value
