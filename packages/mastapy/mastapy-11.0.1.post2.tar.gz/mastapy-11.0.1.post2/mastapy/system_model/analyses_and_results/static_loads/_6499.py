...
from mastapy.system_model.analyses_and_results.static_loads import _6500, _6466
...
class CVTLoadCase(_6466.BeltDriveLoadCase):
    '''CVTLoadCase
    ...
    @property
    def pulleys(self) -> 'List[_6500.CVTPulleyLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_6500.CVTPulleyLoadCase))
        return value
