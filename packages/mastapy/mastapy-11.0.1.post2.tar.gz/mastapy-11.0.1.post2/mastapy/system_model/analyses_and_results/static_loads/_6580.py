...
class PlanetaryGearSetLoadCase(_6509.CylindricalGearSetLoadCase):
    '''PlanetaryGearSetLoadCase
    ...
    @property
    def include_gear_blank_elastic_distortion(self) -> '_1348.LoadCaseOverrideOption':
    ...
    def include_gear_blank_elastic_distortion(self, value: '_1348.LoadCaseOverrideOption'):
    ...
    @property
    def assembly_design(self) -> '_2218.PlanetaryGearSet':
        ...
        return constructor.new(_2218.PlanetaryGearSet)(self.wrapped.AssemblyDesign) if self.wrapped.AssemblyDesign else None
