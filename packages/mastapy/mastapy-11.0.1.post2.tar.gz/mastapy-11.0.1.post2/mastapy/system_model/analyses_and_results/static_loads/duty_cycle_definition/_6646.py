...
class MultiTimeSeriesDataInputFileOptions(_1574.DataInputFileOptions):
    '''MultiTimeSeriesDataInputFileOptions
    ...
    @property
    def delimiter_options(self) -> '_1548.TextFileDelimiterOptions':
        ...
        return constructor.new(_1548.TextFileDelimiterOptions)(self.wrapped.DelimiterOptions) if self.wrapped.DelimiterOptions else None
