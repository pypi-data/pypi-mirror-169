...
class SteadyStateSynchronousResponse(_7185.CompoundAnalysisCase):
    '''SteadyStateSynchronousResponse
    ...
    @property
    def steady_state_analysis_options(self) -> '_3276.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_3276.SteadyStateSynchronousResponseOptions)(self.wrapped.SteadyStateAnalysisOptions) if self.wrapped.SteadyStateAnalysisOptions else None
