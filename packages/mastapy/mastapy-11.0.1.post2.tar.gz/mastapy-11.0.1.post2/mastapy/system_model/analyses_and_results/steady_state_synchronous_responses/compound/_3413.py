...
class StraightBevelSunGearCompoundSteadyStateSynchronousResponse(_3406.StraightBevelDiffGearCompoundSteadyStateSynchronousResponse):
    '''StraightBevelSunGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3284.StraightBevelSunGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3284.StraightBevelSunGearSteadyStateSynchronousResponse))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3284.StraightBevelSunGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3284.StraightBevelSunGearSteadyStateSynchronousResponse))
        return value
