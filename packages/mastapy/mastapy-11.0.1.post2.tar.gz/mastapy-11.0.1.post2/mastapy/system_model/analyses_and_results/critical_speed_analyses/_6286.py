...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _2301, _6197
...
class RootAssemblyCriticalSpeedAnalysis(_6197.AssemblyCriticalSpeedAnalysis):
    '''RootAssemblyCriticalSpeedAnalysis
    ...
    @property
    def critical_speed_analysis_inputs(self) -> '_2301.CriticalSpeedAnalysis':
        ...
        return constructor.new(_2301.CriticalSpeedAnalysis)(self.wrapped.CriticalSpeedAnalysisInputs) if self.wrapped.CriticalSpeedAnalysisInputs else None
