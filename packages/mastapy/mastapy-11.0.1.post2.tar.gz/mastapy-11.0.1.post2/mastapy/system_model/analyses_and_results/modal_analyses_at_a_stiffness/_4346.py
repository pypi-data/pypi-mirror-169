...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4345, _4344, _4253
...
class StraightBevelGearSetModalAnalysisAtAStiffness(_4253.BevelGearSetModalAnalysisAtAStiffness):
    ...
    @property
    def straight_bevel_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4345.StraightBevelGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsModalAnalysisAtAStiffness, constructor.new(_4345.StraightBevelGearModalAnalysisAtAStiffness))
        return value

    @property
    def straight_bevel_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4344.StraightBevelGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesModalAnalysisAtAStiffness, constructor.new(_4344.StraightBevelGearMeshModalAnalysisAtAStiffness))
        return value
