...
from mastapy.system_model.analyses_and_results.stability_analyses import _3486, _3484, _3490
...
class FaceGearSetStabilityAnalysis(_3490.GearSetStabilityAnalysis):
    '''FaceGearSetStabilityAnalysis
    ...
    @property
    def face_gears_stability_analysis(self) -> 'List[_3486.FaceGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsStabilityAnalysis, constructor.new(_3486.FaceGearStabilityAnalysis))
        return value

    @property
    def face_meshes_stability_analysis(self) -> 'List[_3484.FaceGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesStabilityAnalysis, constructor.new(_3484.FaceGearMeshStabilityAnalysis))
        return value
