...
from mastapy.system_model.analyses_and_results.stability_analyses import _2317, _3437
...
class RootAssemblyStabilityAnalysis(_3437.AssemblyStabilityAnalysis):
    '''RootAssemblyStabilityAnalysis
    ...
    @property
    def stability_analysis_inputs(self) -> '_2317.StabilityAnalysis':
        ...
        return constructor.new(_2317.StabilityAnalysis)(self.wrapped.StabilityAnalysisInputs) if self.wrapped.StabilityAnalysisInputs else None
