...
class PartCompoundStabilityAnalysis(_7194.PartCompoundAnalysis):
    '''PartCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3510.PartStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3510.PartStabilityAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3510.PartStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3510.PartStabilityAnalysis))
        return value
