...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5677, _5597
...
class FEPartHarmonicAnalysis(_5597.AbstractShaftOrHousingHarmonicAnalysis):
    '''FEPartHarmonicAnalysis
    ...
    @property
    def coupled_modal_analysis(self) -> '_4809.FEPartModalAnalysis':
        ...
        return constructor.new(_4809.FEPartModalAnalysis)(self.wrapped.CoupledModalAnalysis) if self.wrapped.CoupledModalAnalysis else None
