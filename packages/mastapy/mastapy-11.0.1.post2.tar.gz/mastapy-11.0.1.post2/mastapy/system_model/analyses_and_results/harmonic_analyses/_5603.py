...
class BearingHarmonicAnalysis(_5632.ConnectorHarmonicAnalysis):
    '''BearingHarmonicAnalysis
    ...
    @property
    def rolling_bearing_speed_results(self) -> '_1767.RollingBearingSpeedResults':
        ...
        return constructor.new(_1767.RollingBearingSpeedResults)(self.wrapped.RollingBearingSpeedResults) if self.wrapped.RollingBearingSpeedResults else None
    ...
    @property
    def component_load_case(self) -> '_6464.BearingLoadCase':
        ...
        return constructor.new(_6464.BearingLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def system_deflection_results(self) -> '_2367.BearingSystemDeflection':
        ...
        return constructor.new(_2367.BearingSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
