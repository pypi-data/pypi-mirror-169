...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _2307
...
class HarmonicAnalysisForAdvancedTimeSteppingAnalysisForModulation(_2307.HarmonicAnalysis):
    '''HarmonicAnalysisForAdvancedTimeSteppingAnalysisForModulation
