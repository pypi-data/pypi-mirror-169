...
class RingPinsAdvancedSystemDeflection(_7001.MountableComponentAdvancedSystemDeflection):
    '''RingPinsAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2461.RingPinsSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2461.RingPinsSystemDeflection))
        return value
