...
from mastapy.system_model.analyses_and_results.static_loads import _6467, _6470, _6471
...
class BevelDifferentialGearAdvancedSystemDeflection(_6937.BevelGearAdvancedSystemDeflection):
    '''BevelDifferentialGearAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6467.BevelDifferentialGearLoadCase':
        ...
        if _6467.BevelDifferentialGearLoadCase.TYPE not in self.wrapped.ComponentLoadCase.__class__.__mro__:
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2372.BevelDifferentialGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2372.BevelDifferentialGearSystemDeflection))
        return value
