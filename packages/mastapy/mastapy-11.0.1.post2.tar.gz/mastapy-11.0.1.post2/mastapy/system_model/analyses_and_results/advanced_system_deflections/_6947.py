...
class ConceptCouplingAdvancedSystemDeflection(_6959.CouplingAdvancedSystemDeflection):
    '''ConceptCouplingAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2388.ConceptCouplingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2388.ConceptCouplingSystemDeflection))
        return value
