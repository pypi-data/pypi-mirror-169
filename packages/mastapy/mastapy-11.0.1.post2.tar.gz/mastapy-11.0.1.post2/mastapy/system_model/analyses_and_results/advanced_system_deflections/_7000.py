...
class MeasurementComponentAdvancedSystemDeflection(_7047.VirtualComponentAdvancedSystemDeflection):
    '''MeasurementComponentAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2447.MeasurementComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2447.MeasurementComponentSystemDeflection))
        return value
