...
class FaceGearAdvancedSystemDeflection(_6981.GearAdvancedSystemDeflection):
    '''FaceGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2423.FaceGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2423.FaceGearSystemDeflection))
        return value
