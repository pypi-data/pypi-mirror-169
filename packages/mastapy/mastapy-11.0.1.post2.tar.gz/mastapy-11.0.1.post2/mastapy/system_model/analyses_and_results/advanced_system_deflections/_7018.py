...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6922, _6928
...
class RootAssemblyAdvancedSystemDeflection(_6928.AssemblyAdvancedSystemDeflection):
    '''RootAssemblyAdvancedSystemDeflection
    ...
    @property
    def advanced_system_deflection_inputs(self) -> '_6922.AdvancedSystemDeflection':
        ...
        return constructor.new(_6922.AdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflectionInputs) if self.wrapped.AdvancedSystemDeflectionInputs else None
