...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6052, _6053, _5943
...
class ZerolBevelGearSetDynamicAnalysis(_5943.BevelGearSetDynamicAnalysis):
    '''ZerolBevelGearSetDynamicAnalysis
    ...
    @property
    def zerol_bevel_gears_dynamic_analysis(self) -> 'List[_6052.ZerolBevelGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsDynamicAnalysis, constructor.new(_6052.ZerolBevelGearDynamicAnalysis))
        return value

    @property
    def zerol_bevel_meshes_dynamic_analysis(self) -> 'List[_6053.ZerolBevelGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesDynamicAnalysis, constructor.new(_6053.ZerolBevelGearMeshDynamicAnalysis))
        return value
