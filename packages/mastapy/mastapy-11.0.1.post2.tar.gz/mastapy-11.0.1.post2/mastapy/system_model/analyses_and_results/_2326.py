...
from mastapy.utility.model_validation import _1525, _1526
...
class DesignEntityAnalysis(_0.APIBase):
    ...
    @property
    def component_design(self) -> '_1892.DesignEntity':
        ...
        if _1892.DesignEntity.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_connection(self) -> '_1953.Connection':
    ...
    @property
    def component_design_of_type_part(self) -> '_2146.Part':
    ...
    @property
    def all_status_errors(self) -> 'List[_1526.StatusItem]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllStatusErrors, constructor.new(_1526.StatusItem))
        return value
