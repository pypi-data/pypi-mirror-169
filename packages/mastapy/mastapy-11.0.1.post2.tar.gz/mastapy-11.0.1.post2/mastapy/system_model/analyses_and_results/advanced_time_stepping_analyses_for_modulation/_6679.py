...
class BoltedJointAdvancedTimeSteppingAnalysisForModulation(_6758.SpecialisedAssemblyAdvancedTimeSteppingAnalysisForModulation):
    '''BoltedJointAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2378.BoltedJointSystemDeflection':
        ...
        return constructor.new(_2378.BoltedJointSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
