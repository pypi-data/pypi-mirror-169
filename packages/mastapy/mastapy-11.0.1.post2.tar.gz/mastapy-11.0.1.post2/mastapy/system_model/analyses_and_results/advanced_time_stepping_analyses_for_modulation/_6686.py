...
class ConceptCouplingConnectionAdvancedTimeSteppingAnalysisForModulation(_6697.CouplingConnectionAdvancedTimeSteppingAnalysisForModulation):
    '''ConceptCouplingConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6482.ConceptCouplingConnectionLoadCase':
        ...
        return constructor.new(_6482.ConceptCouplingConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def system_deflection_results(self) -> '_2386.ConceptCouplingConnectionSystemDeflection':
        ...
        return constructor.new(_2386.ConceptCouplingConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
