...
class BevelGearMeshAdvancedTimeSteppingAnalysisForModulation(_6663.AGMAGleasonConicalGearMeshAdvancedTimeSteppingAnalysisForModulation):
    '''BevelGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_design(self) -> '_1984.BevelGearMesh':
    ...
    @property
    def system_deflection_results(self) -> '_2375.BevelGearMeshSystemDeflection':
