...
class ConnectorAdvancedTimeSteppingAnalysisForModulation(_6737.MountableComponentAdvancedTimeSteppingAnalysisForModulation):
    '''ConnectorAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2397.ConnectorSystemDeflection':
