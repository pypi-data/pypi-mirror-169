...
from mastapy.system_model.part_model.gears import _2221, _2225, _2226
...
class StraightBevelDiffGearCompoundAdvancedTimeSteppingAnalysisForModulation(_6805.BevelGearCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''StraightBevelDiffGearCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2221.StraightBevelDiffGear':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6765.StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6765.StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6765.StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6765.StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation))
        return value
