...
class ClutchConnectionAdvancedTimeSteppingAnalysisForModulation(_6697.CouplingConnectionAdvancedTimeSteppingAnalysisForModulation):
    '''ClutchConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6477.ClutchConnectionLoadCase':
        ...
        return constructor.new(_6477.ClutchConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def system_deflection_results(self) -> '_2380.ClutchConnectionSystemDeflection':
        ...
        return constructor.new(_2380.ClutchConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
