...
class ShaftHubConnectionAdvancedTimeSteppingAnalysisForModulation(_6695.ConnectorAdvancedTimeSteppingAnalysisForModulation):
    '''ShaftHubConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2468.ShaftHubConnectionSystemDeflection':
        ...
        return constructor.new(_2468.ShaftHubConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
