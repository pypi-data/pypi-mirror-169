...
class StraightBevelGearCompoundAdvancedTimeSteppingAnalysisForModulation(_6805.BevelGearCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''StraightBevelGearCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6768.StraightBevelGearAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6768.StraightBevelGearAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6768.StraightBevelGearAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6768.StraightBevelGearAdvancedTimeSteppingAnalysisForModulation))
        return value
