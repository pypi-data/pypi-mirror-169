...
class BevelDifferentialPlanetGearAdvancedTimeSteppingAnalysisForModulation(_6670.BevelDifferentialGearAdvancedTimeSteppingAnalysisForModulation):
    '''BevelDifferentialPlanetGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2193.BevelDifferentialPlanetGear':
        ...
        return constructor.new(_2193.BevelDifferentialPlanetGear)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None

    @property
    def system_deflection_results(self) -> '_2373.BevelDifferentialPlanetGearSystemDeflection':
        ...
        return constructor.new(_2373.BevelDifferentialPlanetGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
