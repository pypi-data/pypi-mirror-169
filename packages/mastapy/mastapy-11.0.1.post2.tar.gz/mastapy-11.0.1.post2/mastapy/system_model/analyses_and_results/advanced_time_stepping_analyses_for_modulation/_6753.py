...
class RollingRingConnectionAdvancedTimeSteppingAnalysisForModulation(_6725.InterMountableComponentConnectionAdvancedTimeSteppingAnalysisForModulation):
    '''RollingRingConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6593.RollingRingConnectionLoadCase':
        ...
        return constructor.new(_6593.RollingRingConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def system_deflection_results(self) -> '_2465.RollingRingConnectionSystemDeflection':
        ...
        return constructor.new(_2465.RollingRingConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
