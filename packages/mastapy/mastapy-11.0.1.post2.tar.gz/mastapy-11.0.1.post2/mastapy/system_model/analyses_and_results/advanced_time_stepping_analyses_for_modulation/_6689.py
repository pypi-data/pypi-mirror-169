...
class ConceptGearMeshAdvancedTimeSteppingAnalysisForModulation(_6718.GearMeshAdvancedTimeSteppingAnalysisForModulation):
    '''ConceptGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2389.ConceptGearMeshSystemDeflection':
        ...
        return constructor.new(_2389.ConceptGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
