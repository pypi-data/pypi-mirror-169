...
class SpringDamperAdvancedTimeSteppingAnalysisForModulation(_6696.CouplingAdvancedTimeSteppingAnalysisForModulation):
    '''SpringDamperAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2479.SpringDamperSystemDeflection':
        ...
        return constructor.new(_2479.SpringDamperSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
