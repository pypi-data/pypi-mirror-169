...
class ClutchHalfAdvancedTimeSteppingAnalysisForModulation(_6698.CouplingHalfAdvancedTimeSteppingAnalysisForModulation):
    '''ClutchHalfAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6478.ClutchHalfLoadCase':
        ...
        return constructor.new(_6478.ClutchHalfLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def system_deflection_results(self) -> '_2381.ClutchHalfSystemDeflection':
        ...
        return constructor.new(_2381.ClutchHalfSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
