...
class TorqueConverterConnectionAdvancedTimeSteppingAnalysisForModulation(_6697.CouplingConnectionAdvancedTimeSteppingAnalysisForModulation):
    '''TorqueConverterConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2495.TorqueConverterConnectionSystemDeflection':
        ...
        return constructor.new(_2495.TorqueConverterConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
