...
class BevelDifferentialSunGearAdvancedTimeSteppingAnalysisForModulation(_6670.BevelDifferentialGearAdvancedTimeSteppingAnalysisForModulation):
    '''BevelDifferentialSunGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2194.BevelDifferentialSunGear':
        ...
        return constructor.new(_2194.BevelDifferentialSunGear)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None

    @property
    def system_deflection_results(self) -> '_2374.BevelDifferentialSunGearSystemDeflection':
        ...
        return constructor.new(_2374.BevelDifferentialSunGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
