...
class PartToPartShearCouplingAdvancedTimeSteppingAnalysisForModulation(_6696.CouplingAdvancedTimeSteppingAnalysisForModulation):
    '''PartToPartShearCouplingAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2455.PartToPartShearCouplingSystemDeflection':
        ...
        return constructor.new(_2455.PartToPartShearCouplingSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
