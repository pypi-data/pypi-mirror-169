...
class StraightBevelGearMeshAdvancedTimeSteppingAnalysisForModulation(_6676.BevelGearMeshAdvancedTimeSteppingAnalysisForModulation):
    '''StraightBevelGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6612.StraightBevelGearMeshLoadCase':
        ...
        return constructor.new(_6612.StraightBevelGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def system_deflection_results(self) -> '_2483.StraightBevelGearMeshSystemDeflection':
        ...
        return constructor.new(_2483.StraightBevelGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
