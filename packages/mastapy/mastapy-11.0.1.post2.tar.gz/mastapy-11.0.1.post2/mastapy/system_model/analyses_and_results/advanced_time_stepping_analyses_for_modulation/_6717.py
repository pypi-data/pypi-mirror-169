...
class GearAdvancedTimeSteppingAnalysisForModulation(_6737.MountableComponentAdvancedTimeSteppingAnalysisForModulation):
    '''GearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2428.GearSystemDeflection':
