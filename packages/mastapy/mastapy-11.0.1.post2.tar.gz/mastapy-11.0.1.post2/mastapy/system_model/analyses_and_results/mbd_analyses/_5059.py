...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5057, _5076
...
class ClutchMultibodyDynamicsAnalysis(_5076.CouplingMultibodyDynamicsAnalysis):
    '''ClutchMultibodyDynamicsAnalysis
    ...
    @property
    def clutch_connection(self) -> '_5057.ClutchConnectionMultibodyDynamicsAnalysis':
        ...
        return constructor.new(_5057.ClutchConnectionMultibodyDynamicsAnalysis)(self.wrapped.ClutchConnection) if self.wrapped.ClutchConnection else None
