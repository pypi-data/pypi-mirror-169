...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5169, _5074
...
class TorqueConverterConnectionMultibodyDynamicsAnalysis(_5074.CouplingConnectionMultibodyDynamicsAnalysis):
    '''TorqueConverterConnectionMultibodyDynamicsAnalysis
    ...
    @property
    def locking_status(self) -> '_5169.TorqueConverterStatus':
        ...
        return constructor.new(_5169.TorqueConverterStatus)(value) if value else None
