...
from mastapy.system_model.drawing import _1936, _1932
...
class ContourDrawStyle(_271.DrawStyleBase):
    ...
    @property
    def contour(self) -> '_1550.ThreeDViewContourOption':
        '''ThreeDViewContourOption: 'Contour' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Contour)
        return constructor.new(_1550.ThreeDViewContourOption)(value) if value else None

    @contour.setter
    def contour(self, value: '_1550.ThreeDViewContourOption'):
    ...
    @property
    def deflection_scaling(self) -> '_1936.ScalingDrawStyle':
        ...
        return constructor.new(_1936.ScalingDrawStyle)(self.wrapped.DeflectionScaling) if self.wrapped.DeflectionScaling else None

    @property
    def model_view_options(self) -> '_1932.ModelViewOptionsDrawStyle':
        ...
        return constructor.new(_1932.ModelViewOptionsDrawStyle)(self.wrapped.ModelViewOptions) if self.wrapped.ModelViewOptions else None
