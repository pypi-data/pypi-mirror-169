...
from mastapy.utility.modal_analysis.gears import _1531, _1534, _1536
...
class GearOrderForTE(_1536.OrderWithRadius):
    '''GearOrderForTE
    ...
    @property
    def position(self) -> '_1531.GearPositions':
        ...
        return constructor.new(_1531.GearPositions)(value) if value else None

    @property
    def additional_orders_and_harmonics(self) -> 'List[_1534.OrderForTE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AdditionalOrdersAndHarmonics, constructor.new(_1534.OrderForTE))
        return value
