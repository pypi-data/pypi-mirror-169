...
from mastapy.utility.report import _1505, _1508
...
TItem = TypeVar('TItem', bound='_1508.CustomReportPropertyItem')


class CustomReportMultiPropertyItem(_1505.CustomReportMultiPropertyItemBase, Generic[TItem]):
    '''CustomReportMultiPropertyItem
