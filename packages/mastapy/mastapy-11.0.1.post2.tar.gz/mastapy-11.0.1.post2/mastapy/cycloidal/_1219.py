...
from mastapy.cycloidal import _1222
...
class CycloidalDiscDesign(_0.APIBase):
    ...
    @property
    def modifications_specification(self) -> '_1222.CycloidalDiscModificationsSpecification':
        ...
        return constructor.new(_1222.CycloidalDiscModificationsSpecification)(self.wrapped.ModificationsSpecification) if self.wrapped.ModificationsSpecification else None
