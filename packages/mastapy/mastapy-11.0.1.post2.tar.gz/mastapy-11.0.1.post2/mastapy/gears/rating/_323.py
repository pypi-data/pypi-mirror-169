...
class GearSetDutyCycleRating(_316.AbstractGearSetRating):
    ...
    @property
    def gear_set_design_of_type_conical_gear_set_design(self) -> '_1068.ConicalGearSetDesign':
        ...
        if _1068.ConicalGearSetDesign.TYPE not in self.wrapped.GearSetDesign.__class__.__mro__:
    ...
    @property
    def gear_set_design_of_type_concept_gear_set_design(self) -> '_1090.ConceptGearSetDesign':
        ...
        if _1090.ConceptGearSetDesign.TYPE not in self.wrapped.GearSetDesign.__class__.__mro__:
    ...
    @property
    def gear_set_design_of_type_bevel_gear_set_design(self) -> '_1094.BevelGearSetDesign':
        ...
        if _1094.BevelGearSetDesign.TYPE not in self.wrapped.GearSetDesign.__class__.__mro__:
    ...
    @property
    def gear_set_design_of_type_agma_gleason_conical_gear_set_design(self) -> '_1107.AGMAGleasonConicalGearSetDesign':
        ...
        if _1107.AGMAGleasonConicalGearSetDesign.TYPE not in self.wrapped.GearSetDesign.__class__.__mro__:
