...
class ConceptGearRating(_322.GearRating):
    ...
    @property
    def concept_gear(self) -> '_1088.ConceptGearDesign':
        ...
        return constructor.new(_1088.ConceptGearDesign)(self.wrapped.ConceptGear) if self.wrapped.ConceptGear else None
