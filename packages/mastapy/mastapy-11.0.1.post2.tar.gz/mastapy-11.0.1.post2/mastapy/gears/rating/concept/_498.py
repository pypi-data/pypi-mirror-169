...
class ConceptGearMeshRating(_321.GearMeshRating):
    ...
    @property
    def concept_gear_mesh(self) -> '_1089.ConceptGearMeshDesign':
        ...
        return constructor.new(_1089.ConceptGearMeshDesign)(self.wrapped.ConceptGearMesh) if self.wrapped.ConceptGearMesh else None
