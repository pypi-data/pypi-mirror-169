...
class BevelGearDesign(_1105.AGMAGleasonConicalGearDesign):
    '''BevelGearDesign
    ...
    @property
    def finishing_method(self) -> '_1098.FinishingMethods':
        ...
        return constructor.new(_1098.FinishingMethods)(value) if value else None

    @finishing_method.setter
    def finishing_method(self, value: '_1098.FinishingMethods'):
