...
from mastapy.gears.gear_designs.conical import _1080, _1068
...
class KlingelnbergConicalGearSetDesign(_1068.ConicalGearSetDesign):
    '''KlingelnbergConicalGearSetDesign
    ...
    @property
    def gear_finish(self) -> '_1080.KlingelnbergFinishingMethods':
        ...
        return constructor.new(_1080.KlingelnbergFinishingMethods)(value) if value else None

    @gear_finish.setter
    def gear_finish(self, value: '_1080.KlingelnbergFinishingMethods'):
