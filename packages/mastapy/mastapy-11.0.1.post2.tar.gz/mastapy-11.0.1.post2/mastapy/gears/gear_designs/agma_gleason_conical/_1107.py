...
from mastapy.gears.gear_designs.conical import _1077, _1068
...
class AGMAGleasonConicalGearSetDesign(_1068.ConicalGearSetDesign):
    '''AGMAGleasonConicalGearSetDesign
    ...
    @property
    def reliability_requirement_gleason(self) -> '_1077.GleasonSafetyRequirements':
        ...
        return constructor.new(_1077.GleasonSafetyRequirements)(value) if value else None

    @reliability_requirement_gleason.setter
    def reliability_requirement_gleason(self, value: '_1077.GleasonSafetyRequirements'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
