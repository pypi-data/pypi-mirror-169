...
class GearDesign(_878.GearDesignComponent):
    ...
    @property
    def tifffe_model(self) -> '_1109.GearFEModel':
        ...
        if _1109.GearFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
    ...
    @property
    def tifffe_model_of_type_cylindrical_gear_fe_model(self) -> '_1113.CylindricalGearFEModel':
        ...
        if _1113.CylindricalGearFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
    ...
    @property
    def tifffe_model_of_type_conical_gear_fe_model(self) -> '_1116.ConicalGearFEModel':
        ...
        if _1116.ConicalGearFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
