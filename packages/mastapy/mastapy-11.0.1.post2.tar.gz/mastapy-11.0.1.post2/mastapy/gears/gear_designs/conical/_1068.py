...
class ConicalGearSetDesign(_880.GearSetDesign):
    ...
    @property
    def conical_meshes(self) -> 'List[_1067.ConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshes, constructor.new(_1067.ConicalGearMeshDesign))
        return value
