...
class ConicalMeshMicroGeometryConfigBase(_1134.GearMeshImplementationDetail):
    '''ConicalMeshMicroGeometryConfigBase
    ...
    @property
    def mesh(self) -> '_1067.ConicalGearMeshDesign':
        ...
        if _1067.ConicalGearMeshDesign.TYPE not in self.wrapped.Mesh.__class__.__mro__:
    ...
    @property
    def mesh_of_type_bevel_gear_mesh_design(self) -> '_1093.BevelGearMeshDesign':
        ...
        if _1093.BevelGearMeshDesign.TYPE not in self.wrapped.Mesh.__class__.__mro__:
            raise CastException('Failed to cast mesh to BevelGearMeshDesign. Expected: {}.'.format(self.wrapped.Mesh.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Mesh.__class__)(self.wrapped.Mesh) if self.wrapped.Mesh else None

    @property
    def mesh_of_type_agma_gleason_conical_gear_mesh_design(self) -> '_1106.AGMAGleasonConicalGearMeshDesign':
        ...
        if _1106.AGMAGleasonConicalGearMeshDesign.TYPE not in self.wrapped.Mesh.__class__.__mro__:
