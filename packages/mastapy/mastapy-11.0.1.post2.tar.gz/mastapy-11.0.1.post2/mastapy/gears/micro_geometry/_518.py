...
from mastapy.utility.scripting import _1478
...
class FlankMicroGeometry(_0.APIBase):
    ...
    @property
    def user_specified_data(self) -> '_1478.UserSpecifiedData':
        ...
        return constructor.new(_1478.UserSpecifiedData)(self.wrapped.UserSpecifiedData) if self.wrapped.UserSpecifiedData else None
    ...
    @property
    def gear_design_of_type_conical_gear_design(self) -> '_1066.ConicalGearDesign':
    ...
    @property
    def gear_design_of_type_concept_gear_design(self) -> '_1088.ConceptGearDesign':
        ...
        if _1088.ConceptGearDesign.TYPE not in self.wrapped.GearDesign.__class__.__mro__:
