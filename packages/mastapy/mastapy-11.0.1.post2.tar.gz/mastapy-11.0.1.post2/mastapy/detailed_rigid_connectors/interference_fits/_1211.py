...
from mastapy.bearings.tolerances import _1627, _1613, _1619
...
class InterferenceFitHalfDesign(_1153.DetailedRigidConnectorHalfDesign):
    '''InterferenceFitHalfDesign
    ...
    @property
    def stress_region(self) -> '_1212.StressRegions':
        ...
        return constructor.new(_1212.StressRegions)(value) if value else None
    ...
    @property
    def tolerance(self) -> '_1627.SupportTolerance':
        ...
        if _1627.SupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
    ...
    @property
    def tolerance_of_type_inner_support_tolerance(self) -> '_1613.InnerSupportTolerance':
        ...
        if _1613.InnerSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
    ...
    @property
    def tolerance_of_type_outer_support_tolerance(self) -> '_1619.OuterSupportTolerance':
        ...
        if _1619.OuterSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
