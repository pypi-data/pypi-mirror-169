...
from mastapy.detailed_rigid_connectors.interference_fits import _1209, _1208, _1213
...
class InterferenceFitDesign(_1152.DetailedRigidConnectorDesign):
    '''InterferenceFitDesign
    ...
    @property
    def calculation_method(self) -> '_1209.CalculationMethods':
        ...
        return constructor.new(_1209.CalculationMethods)(value) if value else None

    @calculation_method.setter
    def calculation_method(self, value: '_1209.CalculationMethods'):
    ...
    @property
    def assembly_method(self) -> '_1208.AssemblyMethods':
        ...
        return constructor.new(_1208.AssemblyMethods)(value) if value else None

    @assembly_method.setter
    def assembly_method(self, value: '_1208.AssemblyMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
