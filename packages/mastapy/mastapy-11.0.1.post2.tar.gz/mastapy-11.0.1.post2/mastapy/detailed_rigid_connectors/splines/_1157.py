...
from mastapy.detailed_rigid_connectors.splines import _1167, _1176, _1184
...
class DIN5480SplineHalfDesign(_1184.StandardSplineHalfDesign):
    '''DIN5480SplineHalfDesign
    ...
    @property
    def manufacturing_type(self) -> '_1167.ManufacturingTypes':
        ...
        return constructor.new(_1167.ManufacturingTypes)(value) if value else None

    @manufacturing_type.setter
    def manufacturing_type(self, value: '_1167.ManufacturingTypes'):
    ...
    def finishing_method(self) -> '_1176.FinishingMethods':
        ...
        return constructor.new(_1176.FinishingMethods)(value) if value else None
