...
from mastapy.detailed_rigid_connectors.splines import (
    _1163, _1180, _1155, _1158,
    _1162, _1165, _1166, _1173,
    _1185
)
...
class SplineHalfDesign(_1153.DetailedRigidConnectorHalfDesign):
    '''SplineHalfDesign
    ...
    @property
    def heat_treatment(self) -> '_1163.HeatTreatmentTypes':
        ...
        return constructor.new(_1163.HeatTreatmentTypes)(value) if value else None

    @heat_treatment.setter
    def heat_treatment(self, value: '_1163.HeatTreatmentTypes'):
    ...
    @property
    def fit_and_tolerance(self) -> '_1186.FitAndTolerance':
        ...
        return constructor.new(_1186.FitAndTolerance)(self.wrapped.FitAndTolerance) if self.wrapped.FitAndTolerance else None
