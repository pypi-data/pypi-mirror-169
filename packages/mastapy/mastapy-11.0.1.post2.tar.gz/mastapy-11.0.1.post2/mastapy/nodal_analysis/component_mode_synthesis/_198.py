...
from mastapy.fe_tools.vfx_tools import _1147
...
class CMSOptions(_0.APIBase):
    ...
    @property
    def precision_when_saving_expansion_vectors(self) -> '_1266.DataPrecision':
        ...
        return constructor.new(_1266.DataPrecision)(value) if value else None

    @precision_when_saving_expansion_vectors.setter
    def precision_when_saving_expansion_vectors(self, value: '_1266.DataPrecision'):
    ...
    @property
    def solver_options(self) -> '_1147.ProSolveOptions':
        ...
        return constructor.new(_1147.ProSolveOptions)(self.wrapped.SolverOptions) if self.wrapped.SolverOptions else None
