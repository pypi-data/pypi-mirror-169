...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _1143
...
class ElementPropertiesBeam(_186.ElementPropertiesWithMaterial):
    ...
    @property
    def section_type(self) -> '_1143.BeamSectionType':
        ...
        return constructor.new(_1143.BeamSectionType)(value) if value else None
