...
from mastapy.fe_tools.vis_tools_visualisation.enums import _1141
...
class CoordinateSystemReporting(_0.APIBase):
    ...
    @property
    def type_(self) -> '_1141.CoordinateSystemType':
        ...
        return constructor.new(_1141.CoordinateSystemType)(value) if value else None
