...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _1146
...
class ElementPropertiesShell(_186.ElementPropertiesWithMaterial):
    ...
    @property
    def wall_type(self) -> '_1146.ElementPropertiesShellWallType':
        ...
        return constructor.new(_1146.ElementPropertiesShellWallType)(value) if value else None
