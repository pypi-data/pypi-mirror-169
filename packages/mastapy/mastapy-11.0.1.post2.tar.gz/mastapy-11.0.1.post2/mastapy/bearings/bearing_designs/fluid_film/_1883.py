...
class TiltingPadThrustBearing(_1875.PadFluidFilmBearing):
    '''TiltingPadThrustBearing
    ...
    @property
    def tilting_pad_type(self) -> '_1606.TiltingPadTypes':
        ...
        return constructor.new(_1606.TiltingPadTypes)(value) if value else None

    @tilting_pad_type.setter
    def tilting_pad_type(self, value: '_1606.TiltingPadTypes'):
