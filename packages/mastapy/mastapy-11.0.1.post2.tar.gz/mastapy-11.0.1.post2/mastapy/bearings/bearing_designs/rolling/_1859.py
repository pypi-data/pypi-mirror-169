...
from mastapy.bearings.bearing_designs.rolling import _1853, _1850
...
class TaperRollerBearing(_1850.NonBarrelRollerBearing):
    '''TaperRollerBearing
    ...
    @property
    def bearing_measurement_type(self) -> '_1586.BearingMeasurementType':
        ...
        return constructor.new(_1586.BearingMeasurementType)(value) if value else None

    @bearing_measurement_type.setter
    def bearing_measurement_type(self, value: '_1586.BearingMeasurementType'):
    ...
    @property
    def major_rib_detail(self) -> '_1853.RollerRibDetail':
        ...
        return constructor.new(_1853.RollerRibDetail)(self.wrapped.MajorRibDetail) if self.wrapped.MajorRibDetail else None
