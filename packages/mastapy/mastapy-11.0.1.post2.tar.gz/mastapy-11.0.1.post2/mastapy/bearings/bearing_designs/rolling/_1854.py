...
from mastapy.bearings import (
    _1600, _1603, _1579, _1580,
    _1581, _1582
)
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.bearings.bearing_designs.rolling import (
    _1863, _1847, _1845, _1841,
    _1856, _1838
)
...
class RollingBearing(_1826.DetailedBearing):
    '''RollingBearing
    ...
    @property
    def catalogue(self) -> '_1579.BearingCatalog':
        ...
        return constructor.new(_1579.BearingCatalog)(value) if value else None
    ...
    @property
    def type_information(self) -> '_1841.BearingTypeExtraInformation':
        ...
        return constructor.new(_1841.BearingTypeExtraInformation)(value) if value else None
    ...
    @property
    def cage_material(self) -> '_1582.BearingCageMaterial':
        ...
        return constructor.new(_1582.BearingCageMaterial)(value) if value else None

    @cage_material.setter
    def cage_material(self, value: '_1582.BearingCageMaterial'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.CageMaterial = value

    @property
    def sleeve_type(self) -> '_1856.SleeveType':
        ...
        return constructor.new(_1856.SleeveType)(value) if value else None
    ...
    @property
    def history(self) -> '_1342.FileHistory':
        ...
        return constructor.new(_1342.FileHistory)(self.wrapped.History) if self.wrapped.History else None

    @property
    def protection(self) -> '_1838.BearingProtection':
        ...
        return constructor.new(_1838.BearingProtection)(self.wrapped.Protection) if self.wrapped.Protection else None
