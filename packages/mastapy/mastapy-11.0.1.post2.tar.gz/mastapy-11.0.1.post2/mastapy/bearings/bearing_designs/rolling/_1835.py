...
from mastapy.bearings.bearing_designs.rolling import _1836, _1854
...
class BallBearing(_1854.RollingBearing):
    '''BallBearing
    ...
    @property
    def shoulders(self) -> 'List[_1836.BallBearingShoulderDefinition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Shoulders, constructor.new(_1836.BallBearingShoulderDefinition))
        return value
