...
class ThrustBallBearing(_1835.BallBearing):
    '''ThrustBallBearing
    ...
    @property
    def outer_ring_mounting(self) -> '_1597.OuterRingMounting':
        ...
        return constructor.new(_1597.OuterRingMounting)(value) if value else None

    @outer_ring_mounting.setter
    def outer_ring_mounting(self, value: '_1597.OuterRingMounting'):
