...
from mastapy.bearings.bearing_designs.concept import _1884, _1886
...
class ConceptAxialClearanceBearing(_1886.ConceptClearanceBearing):
    '''ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self) -> '_1884.BearingNodePosition':
        ...
        return constructor.new(_1884.BearingNodePosition)(value) if value else None

    @node_position.setter
    def node_position(self, value: '_1884.BearingNodePosition'):
