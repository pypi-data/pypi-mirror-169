...
from mastapy.bearings.tolerances import _1622, _1614
...
class SupportDetail(_1614.InterferenceDetail):
    '''SupportDetail
    ...
    @property
    def radial_specification_method(self) -> '_1622.RadialSpecificationMethod':
        ...
        return constructor.new(_1622.RadialSpecificationMethod)(value) if value else None

    @radial_specification_method.setter
    def radial_specification_method(self, value: '_1622.RadialSpecificationMethod'):
