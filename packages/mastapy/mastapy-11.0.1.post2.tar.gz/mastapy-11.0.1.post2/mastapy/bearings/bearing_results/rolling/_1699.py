...
from mastapy.bearings.bearing_results.rolling import _1772, _1730
...
class LoadedBallBearingResults(_1730.LoadedRollingBearingResults):
    '''LoadedBallBearingResults
    ...
    @property
    def track_truncation(self) -> '_1772.TrackTruncationSafetyFactorResults':
        ...
        return constructor.new(_1772.TrackTruncationSafetyFactorResults)(self.wrapped.TrackTruncation) if self.wrapped.TrackTruncation else None
