...
from mastapy.bearings.bearing_results.rolling.skf_module import _1787, _1792
...
class BearingRatingLife(_1792.SKFCalculationResult):
    '''BearingRatingLife
    ...
    @property
    def life_model(self) -> '_1787.LifeModel':
        ...
        return constructor.new(_1787.LifeModel)(self.wrapped.LifeModel) if self.wrapped.LifeModel else None
