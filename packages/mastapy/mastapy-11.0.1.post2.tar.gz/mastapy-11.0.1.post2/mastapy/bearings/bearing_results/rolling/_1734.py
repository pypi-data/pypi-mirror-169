...
from mastapy.bearings.bearing_results.rolling import _1733, _1700
...
class LoadedSelfAligningBallBearingRow(_1700.LoadedBallBearingRow):
    '''LoadedSelfAligningBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1733.LoadedSelfAligningBallBearingResults':
        ...
        return constructor.new(_1733.LoadedSelfAligningBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
