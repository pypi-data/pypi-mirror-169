...
from mastapy.bearings.bearing_results.rolling import _1755, _1727
...
class LoadedToroidalRollerBearingRow(_1727.LoadedRollerBearingRow):
    '''LoadedToroidalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1755.LoadedToroidalRollerBearingResults':
        ...
        return constructor.new(_1755.LoadedToroidalRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
