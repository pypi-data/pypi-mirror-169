...
from mastapy.bearings.bearing_results.rolling import _1752, _1700
...
class LoadedThrustBallBearingRow(_1700.LoadedBallBearingRow):
    '''LoadedThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1752.LoadedThrustBallBearingResults':
        ...
        return constructor.new(_1752.LoadedThrustBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
