...
from mastapy.bearings.bearing_results.rolling import _1686, _1727
...
class LoadedAsymmetricSphericalRollerBearingRow(_1727.LoadedRollerBearingRow):
    '''LoadedAsymmetricSphericalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1686.LoadedAsymmetricSphericalRollerBearingResults':
        ...
        return constructor.new(_1686.LoadedAsymmetricSphericalRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
