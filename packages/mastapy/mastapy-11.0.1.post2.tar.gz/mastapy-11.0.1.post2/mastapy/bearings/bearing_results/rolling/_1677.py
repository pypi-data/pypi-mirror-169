...
class ISO14179SettingsPerBearingType(_1345.IndependentReportablePropertiesBase['ISO14179SettingsPerBearingType']):
    '''ISO14179SettingsPerBearingType
    ...
    @property
    def rolling_bearing_type(self) -> '_1604.RollingBearingType':
        ...
        return constructor.new(_1604.RollingBearingType)(value) if value else None
