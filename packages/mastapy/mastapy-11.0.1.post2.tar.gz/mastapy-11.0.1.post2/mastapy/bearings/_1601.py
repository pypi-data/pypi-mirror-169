...
class RollingBearingDatabase(_1559.SQLDatabase['_1602.RollingBearingKey', '_1854.RollingBearing']):
    '''RollingBearingDatabase
    ...
    def add_to_database(self, bearing: '_1854.RollingBearing'):
    ...
    def remove_from_database(self, bearing: '_1854.RollingBearing'):
    ...
    def search_for_rolling_bearing(self, designation: 'str', catalog: '_1579.BearingCatalog', type_: '_1604.RollingBearingType', bore_range: '_1252.Range', outer_diameter_range: '_1252.Range', width_range: '_1252.Range', dynamic_capacity_range: '_1252.Range', number_of_rows: 'int', material_type: '_1593.HybridSteelAll') -> 'List[_1854.RollingBearing]':
    ...
    def search_for_rolling_bearing_with_name_catalog_and_type(self, designation: 'str', catalog: '_1579.BearingCatalog', type_: '_1604.RollingBearingType') -> 'List[_1854.RollingBearing]':
        ...
        catalog = conversion.mp_to_pn_enum(catalog)
        type_ = conversion.mp_to_pn_enum(type_)
        return conversion.pn_to_mp_objects_in_list(self.wrapped.SearchForRollingBearing.Overloads[_STRING, _BEARING_CATALOG, _ROLLING_BEARING_TYPE](designation if designation else None, catalog, type_), constructor.new(_1854.RollingBearing))

    def search_for_rolling_bearing_with_name_and_catalog(self, designation: 'str', catalog: '_1579.BearingCatalog') -> '_1854.RollingBearing':
        ''' 'SearchForRollingBearing' is the original name of this method.
    ...
    def search_for_rolling_bearing_with_catalog(self, catalog: '_1579.BearingCatalog') -> 'List[_1854.RollingBearing]':
        ''' 'SearchForRollingBearing' is the original name of this method.
        ...
        catalog = conversion.mp_to_pn_enum(catalog)
        return conversion.pn_to_mp_objects_in_list(self.wrapped.SearchForRollingBearing.Overloads[_BEARING_CATALOG](catalog), constructor.new(_1854.RollingBearing))

    def create_bearing(self, type_: '_1604.RollingBearingType', designation: Optional['str'] = 'None') -> '_1854.RollingBearing':
    ...
    def create_bearing_with_type_name(self, type_: 'str', designation: Optional['str'] = 'None') -> '_1854.RollingBearing':
        ''' 'CreateBearing' is the original name of this method.
    ...
    def create_key(self, type_: '_1604.RollingBearingType', designation: Optional['str'] = 'None') -> '_1602.RollingBearingKey':
    ...
    def create_key_with_type_name(self, type_: 'str', designation: Optional['str'] = 'None') -> '_1602.RollingBearingKey':
        ''' 'CreateKey' is the original name of this method.
