...
class RingFittingThermalResults(_0.APIBase):
    ...
    @property
    def interference_values(self) -> 'List[_1807.InterferenceComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InterferenceValues, constructor.new(_1807.InterferenceComponents))
        return value
