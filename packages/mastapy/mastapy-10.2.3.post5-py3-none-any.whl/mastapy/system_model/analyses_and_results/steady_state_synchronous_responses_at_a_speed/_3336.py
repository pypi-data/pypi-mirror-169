...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3347, _3249
...
class RootAssemblySteadyStateSynchronousResponseAtASpeed(_3249.AssemblySteadyStateSynchronousResponseAtASpeed):
    '''RootAssemblySteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def steady_state_synchronous_response_at_a_speed_inputs(self) -> '_3347.SteadyStateSynchronousResponseAtASpeed':
        ...
        return constructor.new(_3347.SteadyStateSynchronousResponseAtASpeed)(self.wrapped.SteadyStateSynchronousResponseAtASpeedInputs) if self.wrapped.SteadyStateSynchronousResponseAtASpeedInputs is not None else None
