...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6315, _6316, _6252
...
class WormGearSetCriticalSpeedAnalysis(_6252.GearSetCriticalSpeedAnalysis):
    '''WormGearSetCriticalSpeedAnalysis
    ...
    @property
    def worm_gears_critical_speed_analysis(self) -> 'List[_6315.WormGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsCriticalSpeedAnalysis, constructor.new(_6315.WormGearCriticalSpeedAnalysis))
        return value

    @property
    def worm_meshes_critical_speed_analysis(self) -> 'List[_6316.WormGearMeshCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesCriticalSpeedAnalysis, constructor.new(_6316.WormGearMeshCriticalSpeedAnalysis))
        return value
