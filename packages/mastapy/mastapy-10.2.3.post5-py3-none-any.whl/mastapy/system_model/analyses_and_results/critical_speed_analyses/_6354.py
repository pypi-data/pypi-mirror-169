...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _2365, _6265
...
class RootAssemblyCriticalSpeedAnalysis(_6265.AssemblyCriticalSpeedAnalysis):
    '''RootAssemblyCriticalSpeedAnalysis
    ...
    @property
    def critical_speed_analysis_inputs(self) -> '_2365.CriticalSpeedAnalysis':
        ...
        return constructor.new(_2365.CriticalSpeedAnalysis)(self.wrapped.CriticalSpeedAnalysisInputs) if self.wrapped.CriticalSpeedAnalysisInputs is not None else None
