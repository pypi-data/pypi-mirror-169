...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2567, _2603, _2526
...
class FlexiblePinAnalysisGearAndBearingRating(_5917.FlexiblePinAnalysis):
    '''FlexiblePinAnalysisGearAndBearingRating
    ...
    @property
    def gear_set_analysis(self) -> '_2567.CylindricalGearSetCompoundSystemDeflection':
        ...
        if _2567.CylindricalGearSetCompoundSystemDeflection.TYPE not in self.wrapped.GearSetAnalysis.__class__.__mro__:
    ...
    @property
    def bearing_analyses(self) -> 'List[_2526.BearingCompoundSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingAnalyses, constructor.new(_2526.BearingCompoundSystemDeflection))
        return value
