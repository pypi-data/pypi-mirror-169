...
class ZerolBevelGearSystemDeflection(_2377.BevelGearSystemDeflection):
    '''ZerolBevelGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3828.ZerolBevelGearPowerFlow':
        ...
        return constructor.new(_3828.ZerolBevelGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
