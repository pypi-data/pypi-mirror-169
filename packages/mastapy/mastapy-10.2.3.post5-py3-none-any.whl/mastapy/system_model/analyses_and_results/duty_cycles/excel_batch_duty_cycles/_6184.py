...
from mastapy.system_model.analyses_and_results.duty_cycles.excel_batch_duty_cycles import _6185
...
class ExcelBatchDutyCycleCreator(_0.APIBase):
    ...
    @property
    def batch_details(self) -> '_6185.ExcelBatchDutyCycleSpectraCreatorDetails':
        ...
        return constructor.new(_6185.ExcelBatchDutyCycleSpectraCreatorDetails)(self.wrapped.BatchDetails) if self.wrapped.BatchDetails else None
