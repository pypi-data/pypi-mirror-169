...
class FEPartModalAnalysis(_4308.AbstractShaftOrHousingModalAnalysis):
    '''FEPartModalAnalysis
    ...
    @property
    def modal_full_fe_results(self) -> 'List[_205.ModalCMSResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ModalFullFEResults, constructor.new(_205.ModalCMSResults))
        return value
