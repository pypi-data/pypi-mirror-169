...
from mastapy.system_model.analyses_and_results.modal_analyses import _4415
...
class SpringDamperConnectionCompoundModalAnalysis(_4497.CouplingConnectionCompoundModalAnalysis):
    '''SpringDamperConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4415.SpringDamperConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4415.SpringDamperConnectionModalAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4415.SpringDamperConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4415.SpringDamperConnectionModalAnalysis))
        return value
