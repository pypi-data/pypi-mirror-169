...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5775, _5779
...
class ResultsForOrderIncludingSurfaces(_5779.ResultsForOrderIncludingNodes):
    '''ResultsForOrderIncludingSurfaces
    ...
    @property
    def fe_surfaces(self) -> 'List[_5775.HarmonicAnalysisResultsBrokenDownBySurfaceWithinAHarmonic]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FESurfaces, constructor.new(_5775.HarmonicAnalysisResultsBrokenDownBySurfaceWithinAHarmonic))
        return value
