...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _2372
...
class HarmonicAnalysisForAdvancedTimeSteppingAnalysisForModulation(_2372.HarmonicAnalysis):
    '''HarmonicAnalysisForAdvancedTimeSteppingAnalysisForModulation
