...
class SynchroniserCompoundHarmonicAnalysis(_5697.SpecialisedAssemblyCompoundHarmonicAnalysis):
    '''SynchroniserCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5548.SynchroniserHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5548.SynchroniserHarmonicAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_5548.SynchroniserHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5548.SynchroniserHarmonicAnalysis))
        return value
