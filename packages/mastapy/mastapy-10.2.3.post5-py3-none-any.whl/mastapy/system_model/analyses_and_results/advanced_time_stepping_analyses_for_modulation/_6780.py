...
class TorqueConverterTurbineAdvancedTimeSteppingAnalysisForModulation(_6698.CouplingHalfAdvancedTimeSteppingAnalysisForModulation):
    '''TorqueConverterTurbineAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2498.TorqueConverterTurbineSystemDeflection':
        ...
        return constructor.new(_2498.TorqueConverterTurbineSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
