...
class WormGearMeshAdvancedTimeSteppingAnalysisForModulation(_6718.GearMeshAdvancedTimeSteppingAnalysisForModulation):
    '''WormGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6633.WormGearMeshLoadCase':
        ...
        return constructor.new(_6633.WormGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def system_deflection_results(self) -> '_2503.WormGearMeshSystemDeflection':
        ...
        return constructor.new(_2503.WormGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
