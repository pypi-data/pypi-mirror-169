...
class ZerolBevelGearMeshAdvancedTimeSteppingAnalysisForModulation(_6676.BevelGearMeshAdvancedTimeSteppingAnalysisForModulation):
    '''ZerolBevelGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2506.ZerolBevelGearMeshSystemDeflection':
        ...
        return constructor.new(_2506.ZerolBevelGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
