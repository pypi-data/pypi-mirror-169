...
class VirtualComponentCompoundDynamicAnalysis(_6200.MountableComponentCompoundDynamicAnalysis):
    '''VirtualComponentCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6116.VirtualComponentDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6116.VirtualComponentDynamicAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_6116.VirtualComponentDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6116.VirtualComponentDynamicAnalysis))
        return value
