...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4877, _4876, _4907
...
class ConceptGearSetModalAnalysisAtASpeed(_4907.GearSetModalAnalysisAtASpeed):
    '''ConceptGearSetModalAnalysisAtASpeed
    ...
    @property
    def concept_gears_modal_analysis_at_a_speed(self) -> 'List[_4877.ConceptGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsModalAnalysisAtASpeed, constructor.new(_4877.ConceptGearModalAnalysisAtASpeed))
        return value

    @property
    def concept_meshes_modal_analysis_at_a_speed(self) -> 'List[_4876.ConceptGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesModalAnalysisAtASpeed, constructor.new(_4876.ConceptGearMeshModalAnalysisAtASpeed))
        return value
