...
from mastapy.system_model.part_model.gears import _2229, _2196
...
class ZerolBevelGearSet(_2196.BevelGearSet):
    '''ZerolBevelGearSet
    ...
    @property
    def zerol_bevel_gears(self) -> 'List[_2229.ZerolBevelGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGears, constructor.new(_2229.ZerolBevelGear))
        return value

    @property
    def zerol_bevel_meshes(self) -> 'List[_2012.ZerolBevelGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshes, constructor.new(_2012.ZerolBevelGearMesh))
        return value
