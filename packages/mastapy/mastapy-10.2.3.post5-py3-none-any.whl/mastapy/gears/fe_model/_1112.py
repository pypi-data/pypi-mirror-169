...
from mastapy.gears.fe_model import _1110, _1109
...
class GearSetFEModel(_1140.GearSetImplementationDetail):
    '''GearSetFEModel
    ...
    @property
    def mesh_fe_models(self) -> 'List[_1110.GearMeshFEModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshFEModels, constructor.new(_1110.GearMeshFEModel))
        return value

    @property
    def gear_fe_models(self) -> 'List[_1109.GearFEModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearFEModels, constructor.new(_1109.GearFEModel))
        return value
