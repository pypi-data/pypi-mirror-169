...
class ShaperSimulationCalculator(_692.CutterSimulationCalc):
    '''ShaperSimulationCalculator
    ...
    @property
    def shaper(self) -> '_687.CylindricalGearShaperTangible':
        ...
        return constructor.new(_687.CylindricalGearShaperTangible)(self.wrapped.Shaper) if self.wrapped.Shaper is not None else None
