...
from mastapy.detailed_rigid_connectors.interference_fits import _1247, _1246, _1251
...
class InterferenceFitDesign(_1190.DetailedRigidConnectorDesign):
    '''InterferenceFitDesign
    ...
    @property
    def calculation_method(self) -> '_1247.CalculationMethods':
        ...
        return constructor.new(_1247.CalculationMethods)(value) if value is not None else None

    @calculation_method.setter
    def calculation_method(self, value: '_1247.CalculationMethods'):
    ...
    @property
    def assembly_method(self) -> '_1246.AssemblyMethods':
        ...
        return constructor.new(_1246.AssemblyMethods)(value) if value is not None else None

    @assembly_method.setter
    def assembly_method(self, value: '_1246.AssemblyMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
