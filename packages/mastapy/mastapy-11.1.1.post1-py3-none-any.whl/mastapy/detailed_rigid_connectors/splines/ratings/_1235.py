...
from mastapy.detailed_rigid_connectors.splines.ratings import _1234
...
class SplineJointRating(_1239.ShaftHubConnectionRating):
    '''SplineJointRating
    ...
    @property
    def spline_half_ratings(self) -> 'List[_1234.SplineHalfRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SplineHalfRatings, constructor.new(_1234.SplineHalfRating))
        return value
