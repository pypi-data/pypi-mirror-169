...
from mastapy.bearings.tolerances import _1675, _1667
...
class SupportDetail(_1667.InterferenceDetail):
    '''SupportDetail
    ...
    @property
    def radial_specification_method(self) -> '_1675.RadialSpecificationMethod':
        ...
        return constructor.new(_1675.RadialSpecificationMethod)(value) if value is not None else None

    @radial_specification_method.setter
    def radial_specification_method(self, value: '_1675.RadialSpecificationMethod'):
