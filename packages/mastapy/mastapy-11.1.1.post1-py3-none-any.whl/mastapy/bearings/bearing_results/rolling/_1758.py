...
from mastapy.bearings.bearing_results.rolling import _1757, _1782
...
class LoadedCrossedRollerBearingRow(_1782.LoadedRollerBearingRow):
    '''LoadedCrossedRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1757.LoadedCrossedRollerBearingResults':
        ...
        return constructor.new(_1757.LoadedCrossedRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
