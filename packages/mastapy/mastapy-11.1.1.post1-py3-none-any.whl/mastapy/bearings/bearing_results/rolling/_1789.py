...
from mastapy.bearings.bearing_results.rolling import _1788, _1755
...
class LoadedSelfAligningBallBearingRow(_1755.LoadedBallBearingRow):
    '''LoadedSelfAligningBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1788.LoadedSelfAligningBallBearingResults':
        ...
        return constructor.new(_1788.LoadedSelfAligningBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
