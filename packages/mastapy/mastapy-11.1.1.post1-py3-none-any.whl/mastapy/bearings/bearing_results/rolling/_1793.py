...
from mastapy.bearings.bearing_results.rolling import _1792, _1782
...
class LoadedSphericalRollerRadialBearingRow(_1782.LoadedRollerBearingRow):
    '''LoadedSphericalRollerRadialBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1792.LoadedSphericalRollerRadialBearingResults':
        ...
        return constructor.new(_1792.LoadedSphericalRollerRadialBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
