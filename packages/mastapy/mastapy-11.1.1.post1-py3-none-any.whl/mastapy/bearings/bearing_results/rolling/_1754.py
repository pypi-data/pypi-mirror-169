...
from mastapy.bearings.bearing_results.rolling import _1728, _1828, _1785
...
class LoadedBallBearingResults(_1785.LoadedRollingBearingResults):
    '''LoadedBallBearingResults
    ...
    @property
    def friction_model_for_gyroscopic_moment(self) -> '_1728.FrictionModelForGyroscopicMoment':
        ...
        return constructor.new(_1728.FrictionModelForGyroscopicMoment)(value) if value is not None else None

    @property
    def track_truncation(self) -> '_1828.TrackTruncationSafetyFactorResults':
        ...
        return constructor.new(_1828.TrackTruncationSafetyFactorResults)(self.wrapped.TrackTruncation) if self.wrapped.TrackTruncation is not None else None
