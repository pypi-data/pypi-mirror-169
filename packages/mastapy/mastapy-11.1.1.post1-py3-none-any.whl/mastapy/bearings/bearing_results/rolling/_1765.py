...
from mastapy.bearings.bearing_results.rolling import _1764, _1755
...
class LoadedDeepGrooveBallBearingRow(_1755.LoadedBallBearingRow):
    '''LoadedDeepGrooveBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1764.LoadedDeepGrooveBallBearingResults':
        ...
        return constructor.new(_1764.LoadedDeepGrooveBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
