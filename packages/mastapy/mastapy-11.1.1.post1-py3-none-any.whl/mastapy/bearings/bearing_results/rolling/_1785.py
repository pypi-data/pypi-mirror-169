...
from mastapy.bearings import _1644
from mastapy.bearings.bearing_results.rolling.fitting import _1865, _1863, _1866
from mastapy.bearings.bearing_results.rolling import (
    _1729, _1827, _1725, _1813,
    _1786
)
from mastapy._internal.cast_exception import CastException
from mastapy.bearings.bearing_results.rolling.abma import _1869, _1867, _1868
from mastapy.bearings.bearing_results.rolling.iso_rating_results import (
    _1856, _1854, _1860, _1859,
    _1855, _1861, _1857
)
from mastapy.bearings.bearing_results.rolling.skf_module import _1851
...
class LoadedRollingBearingResults(_1711.LoadedDetailedBearingResults):
    '''LoadedRollingBearingResults
    ...
    @property
    def fluid_film_temperature_source(self) -> '_1644.FluidFilmTemperatureOptions':
        ...
        return constructor.new(_1644.FluidFilmTemperatureOptions)(value) if value is not None else None
    ...
    @property
    def outer_ring_fitting_at_assembly(self) -> '_1865.OuterRingFittingThermalResults':
        ...
        return constructor.new(_1865.OuterRingFittingThermalResults)(self.wrapped.OuterRingFittingAtAssembly) if self.wrapped.OuterRingFittingAtAssembly is not None else None

    @property
    def outer_ring_fitting_at_operating_conditions(self) -> '_1865.OuterRingFittingThermalResults':
        ...
        return constructor.new(_1865.OuterRingFittingThermalResults)(self.wrapped.OuterRingFittingAtOperatingConditions) if self.wrapped.OuterRingFittingAtOperatingConditions is not None else None

    @property
    def inner_ring_fitting_at_assembly(self) -> '_1863.InnerRingFittingThermalResults':
        ...
        return constructor.new(_1863.InnerRingFittingThermalResults)(self.wrapped.InnerRingFittingAtAssembly) if self.wrapped.InnerRingFittingAtAssembly is not None else None

    @property
    def inner_ring_fitting_at_operating_conditions(self) -> '_1863.InnerRingFittingThermalResults':
        ...
        return constructor.new(_1863.InnerRingFittingThermalResults)(self.wrapped.InnerRingFittingAtOperatingConditions) if self.wrapped.InnerRingFittingAtOperatingConditions is not None else None
    ...
    @property
    def din732(self) -> '_1725.DIN732Results':
        ...
        return constructor.new(_1725.DIN732Results)(self.wrapped.DIN732) if self.wrapped.DIN732 is not None else None

    @property
    def ansiabma(self) -> '_1869.ANSIABMAResults':
        ...
        if _1869.ANSIABMAResults.TYPE not in self.wrapped.ANSIABMA.__class__.__mro__:
    ...
    @property
    def ansiabma_of_type_ansiabma112014_results(self) -> '_1867.ANSIABMA112014Results':
        ...
        if _1867.ANSIABMA112014Results.TYPE not in self.wrapped.ANSIABMA.__class__.__mro__:
    ...
    @property
    def ansiabma_of_type_ansiabma92015_results(self) -> '_1868.ANSIABMA92015Results':
        ...
        if _1868.ANSIABMA92015Results.TYPE not in self.wrapped.ANSIABMA.__class__.__mro__:
    ...
    @property
    def iso2812007(self) -> '_1856.ISO2812007Results':
        ...
        if _1856.ISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
    ...
    @property
    def iso2812007_of_type_ball_iso2812007_results(self) -> '_1854.BallISO2812007Results':
        ...
        if _1854.BallISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
    ...
    @property
    def iso2812007_of_type_roller_iso2812007_results(self) -> '_1860.RollerISO2812007Results':
        ...
        if _1860.RollerISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
    ...
    @property
    def isots162812008(self) -> '_1859.ISOTS162812008Results':
        ...
        if _1859.ISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
    ...
    @property
    def isots162812008_of_type_ball_isots162812008_results(self) -> '_1855.BallISOTS162812008Results':
        ...
        if _1855.BallISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
    ...
    @property
    def isots162812008_of_type_roller_isots162812008_results(self) -> '_1861.RollerISOTS162812008Results':
        ...
        if _1861.RollerISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
    ...
    @property
    def iso762006(self) -> '_1857.ISO762006Results':
        ...
        return constructor.new(_1857.ISO762006Results)(self.wrapped.ISO762006) if self.wrapped.ISO762006 is not None else None

    @property
    def maximum_static_contact_stress(self) -> '_1813.MaximumStaticContactStress':
        ...
        return constructor.new(_1813.MaximumStaticContactStress)(self.wrapped.MaximumStaticContactStress) if self.wrapped.MaximumStaticContactStress is not None else None

    @property
    def skf_module_results(self) -> '_1851.SKFModuleResults':
        ...
        return constructor.new(_1851.SKFModuleResults)(self.wrapped.SKFModuleResults) if self.wrapped.SKFModuleResults is not None else None

    @property
    def rows(self) -> 'List[_1786.LoadedRollingBearingRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Rows, constructor.new(_1786.LoadedRollingBearingRow))
        return value

    @property
    def all_mounting_results(self) -> 'List[_1866.RingFittingThermalResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllMountingResults, constructor.new(_1866.RingFittingThermalResults))
        return value
