...
from mastapy.bearings.bearing_results.rolling import _1741, _1782
...
class LoadedAsymmetricSphericalRollerBearingRow(_1782.LoadedRollerBearingRow):
    '''LoadedAsymmetricSphericalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1741.LoadedAsymmetricSphericalRollerBearingResults':
        ...
        return constructor.new(_1741.LoadedAsymmetricSphericalRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
