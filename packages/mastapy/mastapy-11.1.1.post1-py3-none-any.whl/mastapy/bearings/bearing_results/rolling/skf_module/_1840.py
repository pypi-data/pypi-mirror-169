...
class GreaseLifeAndRelubricationInterval(_1849.SKFCalculationResult):
    '''GreaseLifeAndRelubricationInterval
    ...
    def grease(self) -> '_1839.Grease':
        ...
        return constructor.new(_1839.Grease)(self.wrapped.Grease) if self.wrapped.Grease is not None else None

    @property
    def initial_fill(self) -> '_1842.InitialFill':
        ...
        return constructor.new(_1842.InitialFill)(self.wrapped.InitialFill) if self.wrapped.InitialFill is not None else None

    @property
    def grease_quantity(self) -> '_1841.GreaseQuantity':
        ...
        return constructor.new(_1841.GreaseQuantity)(self.wrapped.GreaseQuantity) if self.wrapped.GreaseQuantity is not None else None
