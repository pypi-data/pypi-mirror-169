...
from mastapy.bearings.bearing_designs.rolling import _1913, _1914, _1912
...
class NonBarrelRollerBearing(_1912.RollerBearing):
    '''NonBarrelRollerBearing
    ...
    @property
    def roller_end_shape(self) -> '_1913.RollerEndShape':
        ...
        return constructor.new(_1913.RollerEndShape)(value) if value is not None else None

    @roller_end_shape.setter
    def roller_end_shape(self, value: '_1913.RollerEndShape'):
    ...
    @property
    def ribs(self) -> 'List[_1914.RollerRibDetail]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Ribs, constructor.new(_1914.RollerRibDetail))
        return value
