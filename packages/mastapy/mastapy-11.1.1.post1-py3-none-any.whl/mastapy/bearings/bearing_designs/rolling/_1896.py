...
from mastapy.bearings.bearing_designs.rolling import _1897
...
class BearingProtectionDetailsModifier(_0.APIBase):
    ...
    @property
    def current_protection_level(self) -> '_1897.BearingProtectionLevel':
        ...
        return constructor.new(_1897.BearingProtectionLevel)(value) if value is not None else None

    @property
    def new_protection_level(self) -> '_1897.BearingProtectionLevel':
    ...
    def new_protection_level(self, value: '_1897.BearingProtectionLevel'):
