...
from mastapy.bearings.bearing_designs.rolling.xml_import import _1927, _1926
...
class XmlBearingTypeMapping(_0.APIBase):
    ...
    @property
    def files(self) -> 'List[_1927.BearingImportFile]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Files, constructor.new(_1927.BearingImportFile))
        return value

    @property
    def variables(self) -> 'List[_1926.AbstractXmlVariableAssignment]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Variables, constructor.new(_1926.AbstractXmlVariableAssignment))
        return value
