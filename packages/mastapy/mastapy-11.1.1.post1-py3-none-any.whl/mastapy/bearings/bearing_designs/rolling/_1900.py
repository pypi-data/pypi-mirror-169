...
from mastapy.bearings.bearing_designs.rolling import _1911
...
class CylindricalRollerBearing(_1911.NonBarrelRollerBearing):
    '''CylindricalRollerBearing
    ...
    @property
    def permissible_axial_load_default_calculation_method(self) -> '_1700.CylindricalRollerMaxAxialLoadMethod':
        ...
        return constructor.new(_1700.CylindricalRollerMaxAxialLoadMethod)(value) if value is not None else None

    @permissible_axial_load_default_calculation_method.setter
    def permissible_axial_load_default_calculation_method(self, value: '_1700.CylindricalRollerMaxAxialLoadMethod'):
