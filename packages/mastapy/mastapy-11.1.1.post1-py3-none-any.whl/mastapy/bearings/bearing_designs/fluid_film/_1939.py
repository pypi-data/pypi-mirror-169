...
class PlainGreaseFilledJournalBearing(_1941.PlainJournalBearing):
    '''PlainGreaseFilledJournalBearing
    ...
    @property
    def housing_type(self) -> '_1940.PlainGreaseFilledJournalBearingHousingType':
        ...
        return constructor.new(_1940.PlainGreaseFilledJournalBearingHousingType)(value) if value is not None else None

    @housing_type.setter
    def housing_type(self, value: '_1940.PlainGreaseFilledJournalBearingHousingType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HousingType = value

    @property
    def housing_detail(self) -> '_1942.PlainJournalHousing':
        ...
        if _1942.PlainJournalHousing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
    ...
    @property
    def housing_detail_of_type_cylindrical_housing_journal_bearing(self) -> '_1935.CylindricalHousingJournalBearing':
        ...
        if _1935.CylindricalHousingJournalBearing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
    ...
    @property
    def housing_detail_of_type_machinery_encased_journal_bearing(self) -> '_1936.MachineryEncasedJournalBearing':
        ...
        if _1936.MachineryEncasedJournalBearing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
    ...
    @property
    def housing_detail_of_type_pedestal_journal_bearing(self) -> '_1938.PedestalJournalBearing':
        ...
        if _1938.PedestalJournalBearing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
