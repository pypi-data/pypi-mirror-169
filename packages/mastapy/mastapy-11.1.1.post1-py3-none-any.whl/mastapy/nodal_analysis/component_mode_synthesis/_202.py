...
from mastapy.fe_tools.vfx_tools import _1185
...
class CMSOptions(_0.APIBase):
    ...
    @property
    def precision_when_saving_expansion_vectors(self) -> '_1304.DataPrecision':
        ...
        return constructor.new(_1304.DataPrecision)(value) if value is not None else None

    @precision_when_saving_expansion_vectors.setter
    def precision_when_saving_expansion_vectors(self, value: '_1304.DataPrecision'):
    ...
    @property
    def internal_mode_options(self) -> '_155.EigenvalueOptions':
        ...
        return constructor.new(_155.EigenvalueOptions)(self.wrapped.InternalModeOptions) if self.wrapped.InternalModeOptions is not None else None

    @property
    def solver_options(self) -> '_1185.ProSolveOptions':
        ...
        return constructor.new(_1185.ProSolveOptions)(self.wrapped.SolverOptions) if self.wrapped.SolverOptions is not None else None
