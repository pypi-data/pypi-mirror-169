...
class LineContactStiffnessEntity(_121.ArbitraryNodalComponent):
    ...
    def stiffness_in_local_coordinate_system(self) -> '_75.NodalMatrix':
        ...
        return constructor.new(_75.NodalMatrix)(self.wrapped.StiffnessInLocalCoordinateSystem) if self.wrapped.StiffnessInLocalCoordinateSystem is not None else None
