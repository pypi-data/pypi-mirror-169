...
class FEModel(_0.APIBase):
    ...
    @property
    def rigid_element_properties(self) -> 'List[_186.ElementPropertiesRigid]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RigidElementProperties, constructor.new(_186.ElementPropertiesRigid))
        return value
    ...
    @property
    def shell_element_properties(self) -> 'List[_187.ElementPropertiesShell]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShellElementProperties, constructor.new(_187.ElementPropertiesShell))
        return value

    @property
    def beam_element_properties(self) -> 'List[_183.ElementPropertiesBeam]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BeamElementProperties, constructor.new(_183.ElementPropertiesBeam))
        return value

    @property
    def spring_dashpot_element_properties(self) -> 'List[_189.ElementPropertiesSpringDashpot]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpringDashpotElementProperties, constructor.new(_189.ElementPropertiesSpringDashpot))
        return value

    @property
    def mass_element_properties(self) -> 'List[_185.ElementPropertiesMass]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MassElementProperties, constructor.new(_185.ElementPropertiesMass))
        return value

    @property
    def interface_element_properties(self) -> 'List[_184.ElementPropertiesInterface]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InterfaceElementProperties, constructor.new(_184.ElementPropertiesInterface))
        return value

    @property
    def other_element_properties(self) -> 'List[_182.ElementPropertiesBase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.OtherElementProperties, constructor.new(_182.ElementPropertiesBase))
        return value

    @property
    def materials(self) -> 'List[_191.MaterialPropertiesReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Materials, constructor.new(_191.MaterialPropertiesReporting))
        return value

    @property
    def coordinate_systems(self) -> 'List[_178.CoordinateSystemReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CoordinateSystems, constructor.new(_178.CoordinateSystemReporting))
        return value

    @property
    def contact_pairs(self) -> 'List[_177.ContactPairReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ContactPairs, constructor.new(_177.ContactPairReporting))
        return value
    ...
    def get_all_element_details(self) -> '_181.ElementDetailsForFEModel':
    ...
    def get_all_node_details(self) -> '_192.NodeDetailsForFEModel':
