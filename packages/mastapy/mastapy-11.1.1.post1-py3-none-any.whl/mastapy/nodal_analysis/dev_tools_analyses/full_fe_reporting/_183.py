...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _1181
...
class ElementPropertiesBeam(_190.ElementPropertiesWithMaterial):
    '''ElementPropertiesBeam
    ...
    @property
    def section_type(self) -> '_1181.BeamSectionType':
        ...
        return constructor.new(_1181.BeamSectionType)(value) if value is not None else None
