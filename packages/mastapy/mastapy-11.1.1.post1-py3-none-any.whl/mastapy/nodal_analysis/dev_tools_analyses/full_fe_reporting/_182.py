...
from mastapy.fe_tools.enums import _1188
...
class ElementPropertiesBase(_0.APIBase):
    ...
    @property
    def class_(self) -> '_1188.ElementPropertyClass':
        ...
        return constructor.new(_1188.ElementPropertyClass)(value) if value is not None else None
