...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _1184
...
class ElementPropertiesShell(_190.ElementPropertiesWithMaterial):
    '''ElementPropertiesShell
    ...
    @property
    def wall_type(self) -> '_1184.ElementPropertiesShellWallType':
        ...
        return constructor.new(_1184.ElementPropertiesShellWallType)(value) if value is not None else None
