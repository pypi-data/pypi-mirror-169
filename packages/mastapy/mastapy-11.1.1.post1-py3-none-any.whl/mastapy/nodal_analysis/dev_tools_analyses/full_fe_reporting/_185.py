...
class ElementPropertiesMass(_182.ElementPropertiesBase):
    '''ElementPropertiesMass
    ...
    @property
    def inertia(self) -> '_1319.InertiaTensor':
        ...
        return constructor.new(_1319.InertiaTensor)(self.wrapped.Inertia) if self.wrapped.Inertia is not None else None
