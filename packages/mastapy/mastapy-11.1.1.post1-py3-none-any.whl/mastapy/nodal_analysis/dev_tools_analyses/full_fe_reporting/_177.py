...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _1183, _1182
...
class ContactPairReporting(_0.APIBase):
    ...
    @property
    def reference_surface_type(self) -> '_1183.ContactPairReferenceSurfaceType':
        ...
        return constructor.new(_1183.ContactPairReferenceSurfaceType)(value) if value is not None else None

    @property
    def constrained_surface_type(self) -> '_1182.ContactPairConstrainedSurfaceType':
        ...
        return constructor.new(_1182.ContactPairConstrainedSurfaceType)(value) if value is not None else None
