...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _194, _182
...
class ElementPropertiesRigid(_182.ElementPropertiesBase):
    '''ElementPropertiesRigid
    ...
    @property
    def degrees_of_freedom_list(self) -> 'List[_194.RigidElementNodeDegreesOfFreedom]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DegreesOfFreedomList, constructor.new(_194.RigidElementNodeDegreesOfFreedom))
        return value
