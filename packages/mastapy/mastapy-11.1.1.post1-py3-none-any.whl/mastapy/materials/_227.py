...
class GeneralTransmissionProperties(_0.APIBase):
    ...
    @property
    def transmission_application(self) -> '_256.TransmissionApplications':
        ...
        return constructor.new(_256.TransmissionApplications)(value) if value is not None else None

    @transmission_application.setter
    def transmission_application(self, value: '_256.TransmissionApplications'):
    ...
    @property
    def bearing_iso762006_static_safety_factor_limit(self) -> '_230.ISO76StaticSafetyFactorLimits':
        ...
        return constructor.new(_230.ISO76StaticSafetyFactorLimits)(value) if value is not None else None

    @bearing_iso762006_static_safety_factor_limit.setter
    def bearing_iso762006_static_safety_factor_limit(self, value: '_230.ISO76StaticSafetyFactorLimits'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def wind_turbine_standard(self) -> '_259.WindTurbineStandards':
        ...
        return constructor.new(_259.WindTurbineStandards)(value) if value is not None else None

    @wind_turbine_standard.setter
    def wind_turbine_standard(self, value: '_259.WindTurbineStandards'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def driving_machine_characteristics(self) -> '_260.WorkingCharacteristics':
        ...
        return constructor.new(_260.WorkingCharacteristics)(value) if value is not None else None

    @driving_machine_characteristics.setter
    def driving_machine_characteristics(self, value: '_260.WorkingCharacteristics'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.DrivingMachineCharacteristics = value

    @property
    def driven_machine_characteristics(self) -> '_260.WorkingCharacteristics':
    ...
    def driven_machine_characteristics(self, value: '_260.WorkingCharacteristics'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.DrivenMachineCharacteristics = value

    @property
    def gearing_type(self) -> '_226.GearingTypes':
        '''GearingTypes: 'GearingType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.GearingType)
        return constructor.new(_226.GearingTypes)(value) if value is not None else None

    @gearing_type.setter
    def gearing_type(self, value: '_226.GearingTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    def agma_over_load_factor(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.AGMAOverLoadFactor) if self.wrapped.AGMAOverLoadFactor is not None else None
    ...
    @property
    def vehicle_dynamics(self) -> '_258.VehicleDynamicsProperties':
        ...
        return constructor.new(_258.VehicleDynamicsProperties)(self.wrapped.VehicleDynamics) if self.wrapped.VehicleDynamics is not None else None

    @property
    def air_properties(self) -> '_216.AirProperties':
        ...
        return constructor.new(_216.AirProperties)(self.wrapped.AirProperties) if self.wrapped.AirProperties is not None else None
