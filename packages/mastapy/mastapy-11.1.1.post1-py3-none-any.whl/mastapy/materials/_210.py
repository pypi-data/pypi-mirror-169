...
from mastapy.materials import _211
...
class AcousticRadiationEfficiency(_0.APIBase):
    ...
    @property
    def radiation_efficiency_curve(self) -> '_1336.Vector2DListAccessor':
        '''Vector2DListAccessor: 'RadiationEfficiencyCurve' is the original name of this property.'''

        return constructor.new(_1336.Vector2DListAccessor)(self.wrapped.RadiationEfficiencyCurve) if self.wrapped.RadiationEfficiencyCurve is not None else None

    @radiation_efficiency_curve.setter
    def radiation_efficiency_curve(self, value: '_1336.Vector2DListAccessor'):
        value = value.wrapped if value else None
        self.wrapped.RadiationEfficiencyCurve = value

    @property
    def input_type(self) -> '_211.AcousticRadiationEfficiencyInputType':
        ...
        return constructor.new(_211.AcousticRadiationEfficiencyInputType)(value) if value is not None else None

    @input_type.setter
    def input_type(self, value: '_211.AcousticRadiationEfficiencyInputType'):
