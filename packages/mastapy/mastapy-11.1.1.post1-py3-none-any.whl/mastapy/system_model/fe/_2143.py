...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _191
...
class MaterialPropertiesWithSelection(_0.APIBase):
    ...
    @property
    def material_properties(self) -> '_191.MaterialPropertiesReporting':
        ...
        return constructor.new(_191.MaterialPropertiesReporting)(self.wrapped.MaterialProperties) if self.wrapped.MaterialProperties is not None else None
