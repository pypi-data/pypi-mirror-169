...
from mastapy.nodal_analysis.dev_tools_analyses import _164, _155
from mastapy.nodal_analysis import _61
from mastapy.system_model.fe import _2131, _2134
...
class FESubstructureWithSelectionForModalAnalysis(_2134.FESubstructureWithSelection):
    '''FESubstructureWithSelectionForModalAnalysis
    ...
    @property
    def modal_draw_style(self) -> '_164.FEModelModalAnalysisDrawStyle':
        ...
        return constructor.new(_164.FEModelModalAnalysisDrawStyle)(self.wrapped.ModalDrawStyle) if self.wrapped.ModalDrawStyle is not None else None

    @property
    def eigenvalue_options(self) -> '_155.EigenvalueOptions':
        ...
        return constructor.new(_155.EigenvalueOptions)(self.wrapped.EigenvalueOptions) if self.wrapped.EigenvalueOptions is not None else None
    ...
    def fe_modal_frequencies(self) -> 'List[_61.FEModalFrequencyComparison]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FEModalFrequencies, constructor.new(_61.FEModalFrequencyComparison))
        return value

    @property
    def full_fe_mode_shapes_at_condensation_nodes(self) -> 'List[_2131.FESubstructureNodeModeShapes]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FullFEModeShapesAtCondensationNodes, constructor.new(_2131.FESubstructureNodeModeShapes))
        return value
