...
from mastapy.system_model.fe import _2102, _2109
...
class RaceBearingFE(_0.APIBase):
    ...
    @property
    def alignment_method(self) -> '_2102.AlignmentMethodForRaceBearing':
        ...
        return constructor.new(_2102.AlignmentMethodForRaceBearing)(value) if value is not None else None

    @alignment_method.setter
    def alignment_method(self, value: '_2102.AlignmentMethodForRaceBearing'):
    ...
    @property
    def links(self) -> 'List[_2109.BearingRaceNodeLink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_2109.BearingRaceNodeLink))
        return value
