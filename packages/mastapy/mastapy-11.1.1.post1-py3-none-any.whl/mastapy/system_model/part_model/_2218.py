...
from mastapy.system_model import _1950
from mastapy._internal import constructor, conversion
from mastapy.geometry import _278
from mastapy.system_model.part_model.projections import _2229
from mastapy.system_model.part_model.part_groups import _2234
...
class RootAssembly(_2179.Assembly):
    '''RootAssembly
    ...
    def model(self) -> '_1950.Design':
        ...
        return constructor.new(_1950.Design)(self.wrapped.Model) if self.wrapped.Model is not None else None

    @property
    def packaging_limits(self) -> '_278.PackagingLimits':
        ...
        return constructor.new(_278.PackagingLimits)(self.wrapped.PackagingLimits) if self.wrapped.PackagingLimits is not None else None

    @property
    def parallel_part_groups_drawing_order(self) -> 'List[_2229.SpecifiedParallelPartGroupDrawingOrder]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelPartGroupsDrawingOrder, constructor.new(_2229.SpecifiedParallelPartGroupDrawingOrder))
        return value

    @property
    def parallel_part_groups(self) -> 'List[_2234.ParallelPartGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelPartGroups, constructor.new(_2234.ParallelPartGroup))
        return value
