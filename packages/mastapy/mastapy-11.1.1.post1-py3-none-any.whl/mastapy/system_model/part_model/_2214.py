...
class PlanetCarrierSettings(_1390.PerMachineSettings):
    '''PlanetCarrierSettings
    ...
    @property
    def planet_pin_manufacturing_errors_coordinate_system(self) -> '_1963.PlanetPinManufacturingErrorsCoordinateSystem':
        ...
        return constructor.new(_1963.PlanetPinManufacturingErrorsCoordinateSystem)(value) if value is not None else None

    @planet_pin_manufacturing_errors_coordinate_system.setter
    def planet_pin_manufacturing_errors_coordinate_system(self, value: '_1963.PlanetPinManufacturingErrorsCoordinateSystem'):
