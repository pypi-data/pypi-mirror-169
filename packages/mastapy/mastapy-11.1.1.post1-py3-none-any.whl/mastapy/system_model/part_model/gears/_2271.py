...
class FaceGear(_2273.Gear):
    ...
    @property
    def active_gear_design(self) -> '_947.FaceGearDesign':
    ...
    @property
    def face_gear_design(self) -> '_947.FaceGearDesign':
        ...
        if _947.FaceGearDesign.TYPE not in self.wrapped.FaceGearDesign.__class__.__mro__:
