...
from mastapy.system_model.part_model.gears.supercharger_rotor_set import _2306
from mastapy.system_model.part_model.gears import _2268, _2275
...
class CylindricalGearSet(_2275.GearSet):
    '''CylindricalGearSet
    ...
    @property
    def active_gear_set_design(self) -> '_985.CylindricalGearSetDesign':
    ...
    @property
    def supercharger_rotor_set(self) -> '_2306.SuperchargerRotorSet':
        ...
        return constructor.new(_2306.SuperchargerRotorSet)(self.wrapped.SuperchargerRotorSet) if self.wrapped.SuperchargerRotorSet is not None else None
    ...
    @property
    def cylindrical_meshes(self) -> 'List[_2054.CylindricalGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshes, constructor.new(_2054.CylindricalGearMesh))
        return value

    @property
    def gear_set_designs(self) -> 'List[_985.CylindricalGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetDesigns, constructor.new(_985.CylindricalGearSetDesign))
        return value
