...
class CylindricalGear(_2273.Gear):
    '''CylindricalGear
    ...
    @property
    def active_gear_design(self) -> '_970.CylindricalGearDesign':
    ...
    @property
    def cylindrical_gear_design(self) -> '_970.CylindricalGearDesign':
        ...
        if _970.CylindricalGearDesign.TYPE not in self.wrapped.CylindricalGearDesign.__class__.__mro__:
