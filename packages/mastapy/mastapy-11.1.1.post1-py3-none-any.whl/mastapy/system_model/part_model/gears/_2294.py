...
class WormGear(_2273.Gear):
    ...
    @property
    def active_gear_design(self) -> '_915.WormGearDesign':
    ...
    @property
    def worm_gear_design(self) -> '_915.WormGearDesign':
        ...
        if _915.WormGearDesign.TYPE not in self.wrapped.WormGearDesign.__class__.__mro__:
