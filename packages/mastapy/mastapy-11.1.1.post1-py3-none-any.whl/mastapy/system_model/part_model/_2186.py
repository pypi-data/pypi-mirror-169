...
from mastapy.bearings.bearing_results import _1721, _1720
...
class BearingRaceMountingOptions(_0.APIBase):
    ...
    @property
    def mounting_sleeve_material(self) -> '_218.BearingMaterial':
        ...
        return constructor.new(_218.BearingMaterial)(self.wrapped.MountingSleeveMaterial) if self.wrapped.MountingSleeveMaterial is not None else None
