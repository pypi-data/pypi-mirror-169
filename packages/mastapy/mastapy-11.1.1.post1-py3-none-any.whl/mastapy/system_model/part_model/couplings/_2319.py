...
from mastapy.system_model.part_model.couplings import _2320, _2333
...
class BeltDrive(_2220.SpecialisedAssembly):
    '''BeltDrive
    ...
    @property
    def type_of_belt(self) -> '_2320.BeltDriveType':
        '''BeltDriveType: 'TypeOfBelt' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.TypeOfBelt)
        return constructor.new(_2320.BeltDriveType)(value) if value is not None else None

    @type_of_belt.setter
    def type_of_belt(self, value: '_2320.BeltDriveType'):
    ...
    @property
    def pulleys(self) -> 'List[_2333.Pulley]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_2333.Pulley))
        return value

    @property
    def belt_connections(self) -> 'List[_2013.BeltConnection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BeltConnections, constructor.new(_2013.BeltConnection))
        return value
