...
class ShaftHubConnection(_2192.Connector):
    '''ShaftHubConnection
    ...
    @property
    def tilt_stiffness_type(self) -> '_2335.RigidConnectorTiltStiffnessTypes':
        ...
        return constructor.new(_2335.RigidConnectorTiltStiffnessTypes)(value) if value is not None else None

    @tilt_stiffness_type.setter
    def tilt_stiffness_type(self, value: '_2335.RigidConnectorTiltStiffnessTypes'):
    ...
    @property
    def spline_type(self) -> '_1213.SplineDesignTypes':
        '''SplineDesignTypes: 'SplineType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.SplineType)
        return constructor.new(_1213.SplineDesignTypes)(value) if value is not None else None

    @spline_type.setter
    def spline_type(self, value: '_1213.SplineDesignTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def spline_joint_design(self) -> '_1218.SplineJointDesign':
        ...
        if _1218.SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_custom_spline_joint_design(self) -> '_1193.CustomSplineJointDesign':
        ...
        if _1193.CustomSplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_din5480_spline_joint_design(self) -> '_1196.DIN5480SplineJointDesign':
        ...
        if _1196.DIN5480SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_gbt3478_spline_joint_design(self) -> '_1200.GBT3478SplineJointDesign':
        ...
        if _1200.GBT3478SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_iso4156_spline_joint_design(self) -> '_1203.ISO4156SplineJointDesign':
        ...
        if _1203.ISO4156SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_jisb1603_spline_joint_design(self) -> '_1204.JISB1603SplineJointDesign':
        ...
        if _1204.JISB1603SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_sae_spline_joint_design(self) -> '_1211.SAESplineJointDesign':
        ...
        if _1211.SAESplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_standard_spline_joint_design(self) -> '_1223.StandardSplineJointDesign':
        ...
        if _1223.StandardSplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def interference_fit_design(self) -> '_1248.InterferenceFitDesign':
        ...
        if _1248.InterferenceFitDesign.TYPE not in self.wrapped.InterferenceFitDesign.__class__.__mro__:
    ...
    @property
    def left_flank_lead_relief(self) -> '_2342.SplineLeadRelief':
        ...
        return constructor.new(_2342.SplineLeadRelief)(self.wrapped.LeftFlankLeadRelief) if self.wrapped.LeftFlankLeadRelief is not None else None

    @property
    def right_flank_lead_relief(self) -> '_2342.SplineLeadRelief':
        ...
        return constructor.new(_2342.SplineLeadRelief)(self.wrapped.RightFlankLeadRelief) if self.wrapped.RightFlankLeadRelief is not None else None

    @property
    def tooth_locations_external_spline_half(self) -> 'List[_2336.RigidConnectorToothLocation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ToothLocationsExternalSplineHalf, constructor.new(_2336.RigidConnectorToothLocation))
        return value

    @property
    def lead_reliefs(self) -> 'List[_2342.SplineLeadRelief]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LeadReliefs, constructor.new(_2342.SplineLeadRelief))
        return value
