...
from mastapy.system_model.drawing import _2000, _1996
...
class ContourDrawStyle(_277.DrawStyleBase):
    '''ContourDrawStyle
    ...
    @property
    def contour(self) -> '_1593.ThreeDViewContourOption':
        '''ThreeDViewContourOption: 'Contour' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Contour)
        return constructor.new(_1593.ThreeDViewContourOption)(value) if value is not None else None

    @contour.setter
    def contour(self, value: '_1593.ThreeDViewContourOption'):
    ...
    @property
    def deflection_scaling(self) -> '_2000.ScalingDrawStyle':
        ...
        return constructor.new(_2000.ScalingDrawStyle)(self.wrapped.DeflectionScaling) if self.wrapped.DeflectionScaling is not None else None

    @property
    def model_view_options(self) -> '_1996.ModelViewOptionsDrawStyle':
        ...
        return constructor.new(_1996.ModelViewOptionsDrawStyle)(self.wrapped.ModelViewOptions) if self.wrapped.ModelViewOptions is not None else None
