...
class ConceptGearMesh(_2058.GearMesh):
    '''ConceptGearMesh
    ...
    @property
    def active_gear_mesh_design(self) -> '_1126.ConceptGearMeshDesign':
        ...
        return constructor.new(_1126.ConceptGearMeshDesign)(self.wrapped.ActiveGearMeshDesign) if self.wrapped.ActiveGearMeshDesign is not None else None

    @property
    def concept_gear_mesh_design(self) -> '_1126.ConceptGearMeshDesign':
        ...
        return constructor.new(_1126.ConceptGearMeshDesign)(self.wrapped.ConceptGearMeshDesign) if self.wrapped.ConceptGearMeshDesign is not None else None
