...
class FaceGearMesh(_2058.GearMesh):
    '''FaceGearMesh
    ...
    @property
    def active_gear_mesh_design(self) -> '_949.FaceGearMeshDesign':
        ...
        return constructor.new(_949.FaceGearMeshDesign)(self.wrapped.ActiveGearMeshDesign) if self.wrapped.ActiveGearMeshDesign is not None else None

    @property
    def face_gear_mesh_design(self) -> '_949.FaceGearMeshDesign':
        ...
        return constructor.new(_949.FaceGearMeshDesign)(self.wrapped.FaceGearMeshDesign) if self.wrapped.FaceGearMeshDesign is not None else None
