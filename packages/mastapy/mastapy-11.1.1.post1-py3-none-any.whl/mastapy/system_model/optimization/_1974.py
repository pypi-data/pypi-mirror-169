...
from mastapy.system_model.optimization import _1983, _1975
...
class ConicalGearOptimisationStrategy(_1983.OptimizationStrategy['_1975.ConicalGearOptimizationStep']):
    '''ConicalGearOptimisationStrategy
