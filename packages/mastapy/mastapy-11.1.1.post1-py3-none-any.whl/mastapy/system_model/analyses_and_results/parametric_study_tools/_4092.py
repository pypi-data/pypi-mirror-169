...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4091, _4090, _4097
...
class FaceGearSetParametricStudyTool(_4097.GearSetParametricStudyTool):
    '''FaceGearSetParametricStudyTool
    ...
    @property
    def face_gears_parametric_study_tool(self) -> 'List[_4091.FaceGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsParametricStudyTool, constructor.new(_4091.FaceGearParametricStudyTool))
        return value

    @property
    def face_meshes_parametric_study_tool(self) -> 'List[_4090.FaceGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesParametricStudyTool, constructor.new(_4090.FaceGearMeshParametricStudyTool))
        return value
