...
class PartCompoundParametricStudyTool(_7266.PartCompoundAnalysis):
    '''PartCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4127.PartParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4127.PartParametricStudyTool))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4127.PartParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4127.PartParametricStudyTool))
        return value
