...
class MeasurementComponentSystemDeflection(_2573.VirtualComponentSystemDeflection):
    '''MeasurementComponentSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3845.MeasurementComponentPowerFlow':
        ...
        return constructor.new(_3845.MeasurementComponentPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
