...
from mastapy.system_model.analyses_and_results.power_flows import _3792, _3812
...
class CoaxialConnectionSystemDeflection(_2543.ShaftToMountableComponentConnectionSystemDeflection):
    '''CoaxialConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3792.CoaxialConnectionPowerFlow':
