...
from mastapy.system_model.analyses_and_results.power_flows import _3770, _3814, _3867
...
class AbstractShaftSystemDeflection(_2429.AbstractShaftOrHousingSystemDeflection):
    '''AbstractShaftSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3770.AbstractShaftPowerFlow':
