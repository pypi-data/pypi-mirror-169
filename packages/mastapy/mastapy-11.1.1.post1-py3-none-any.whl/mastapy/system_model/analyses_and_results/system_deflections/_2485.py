...
class CylindricalGearSystemDeflectionWithLTCAResults(_2483.CylindricalGearSystemDeflection):
    '''CylindricalGearSystemDeflectionWithLTCAResults
    ...
    @property
    def cylindrical_gear_ltca_results(self) -> '_817.CylindricalGearLoadDistributionAnalysis':
        ...
        return constructor.new(_817.CylindricalGearLoadDistributionAnalysis)(self.wrapped.CylindricalGearLTCAResults) if self.wrapped.CylindricalGearLTCAResults is not None else None
