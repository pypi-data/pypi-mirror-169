...
class TorqueConverterPumpSystemDeflection(_2468.CouplingHalfSystemDeflection):
    '''TorqueConverterPumpSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3891.TorqueConverterPumpPowerFlow':
        ...
        return constructor.new(_3891.TorqueConverterPumpPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
