...
class BoltSystemDeflection(_2453.ComponentSystemDeflection):
    '''BoltSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3788.BoltPowerFlow':
        ...
        return constructor.new(_3788.BoltPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
