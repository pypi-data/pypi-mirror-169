...
class BevelGearSetSystemDeflection(_2433.AGMAGleasonConicalGearSetSystemDeflection):
    '''BevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3786.BevelGearSetPowerFlow':
