...
class AbstractShaftOrHousingSystemDeflection(_2453.ComponentSystemDeflection):
    '''AbstractShaftOrHousingSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3769.AbstractShaftOrHousingPowerFlow':
