...
class AGMAGleasonConicalGearMeshSystemDeflection(_2462.ConicalGearMeshSystemDeflection):
    '''AGMAGleasonConicalGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3772.AGMAGleasonConicalGearMeshPowerFlow':
