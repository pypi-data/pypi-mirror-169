...
class SynchroniserSleeveSystemDeflection(_2560.SynchroniserPartSystemDeflection):
    '''SynchroniserSleeveSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3887.SynchroniserSleevePowerFlow':
        ...
        return constructor.new(_3887.SynchroniserSleevePowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
