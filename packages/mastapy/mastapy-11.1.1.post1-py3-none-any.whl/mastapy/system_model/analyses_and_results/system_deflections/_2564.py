...
from mastapy.system_model.drawing import _2000, _1990
...
class SystemDeflectionDrawStyle(_1990.ContourDrawStyle):
    '''SystemDeflectionDrawStyle
    ...
    @property
    def force_arrow_scaling(self) -> '_2000.ScalingDrawStyle':
        ...
        return constructor.new(_2000.ScalingDrawStyle)(self.wrapped.ForceArrowScaling) if self.wrapped.ForceArrowScaling is not None else None
