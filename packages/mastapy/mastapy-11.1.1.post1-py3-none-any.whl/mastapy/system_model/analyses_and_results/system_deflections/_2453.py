...
from mastapy.math_utility.measured_vectors import _1364, _1363
from mastapy.system_model.analyses_and_results.power_flows import (
    _3793, _3769, _3770, _3773,
    _3776, _3780, _3782, _3783,
    _3785, _3788, _3790, _3795,
    _3798, _3801, _3804, _3806,
    _3810, _3814, _3817, _3819,
    _3820, _3821, _3823, _3825,
    _3828, _3830, _3832, _3836,
    _3839, _3842, _3844, _3845,
    _3846, _3847, _3850, _3854,
    _3855, _3858, _3859, _3860,
    _3864, _3866, _3867, _3871,
    _3874, _3877, _3880, _3882,
    _3883, _3884, _3885, _3887,
...
class ComponentSystemDeflection(_2523.PartSystemDeflection):
    '''ComponentSystemDeflection
    ...
    @property
    def power_loss(self) -> '_271.PowerLoss':
        ...
        if _271.PowerLoss.TYPE not in self.wrapped.PowerLoss.__class__.__mro__:
    ...
    @property
    def power_loss_of_type_independent_power_loss(self) -> '_264.IndependentPowerLoss':
        ...
        if _264.IndependentPowerLoss.TYPE not in self.wrapped.PowerLoss.__class__.__mro__:
    ...
    @property
    def power_loss_of_type_load_and_speed_combined_power_loss(self) -> '_266.LoadAndSpeedCombinedPowerLoss':
        ...
        if _266.LoadAndSpeedCombinedPowerLoss.TYPE not in self.wrapped.PowerLoss.__class__.__mro__:
    ...
    @property
    def resistive_torque(self) -> '_272.ResistiveTorque':
        ...
        if _272.ResistiveTorque.TYPE not in self.wrapped.ResistiveTorque.__class__.__mro__:
    ...
    @property
    def resistive_torque_of_type_combined_resistive_torque(self) -> '_262.CombinedResistiveTorque':
        ...
        if _262.CombinedResistiveTorque.TYPE not in self.wrapped.ResistiveTorque.__class__.__mro__:
    ...
    @property
    def resistive_torque_of_type_independent_resistive_torque(self) -> '_265.IndependentResistiveTorque':
        ...
        if _265.IndependentResistiveTorque.TYPE not in self.wrapped.ResistiveTorque.__class__.__mro__:
    ...
    @property
    def rigidly_connected_components(self) -> '_2586.RigidlyConnectedComponentGroupSystemDeflection':
        ...
        return constructor.new(_2586.RigidlyConnectedComponentGroupSystemDeflection)(self.wrapped.RigidlyConnectedComponents) if self.wrapped.RigidlyConnectedComponents is not None else None

    @property
    def mass_properties_in_local_coordinate_system_from_node_model(self) -> '_1320.MassProperties':
        ...
        return constructor.new(_1320.MassProperties)(self.wrapped.MassPropertiesInLocalCoordinateSystemFromNodeModel) if self.wrapped.MassPropertiesInLocalCoordinateSystemFromNodeModel is not None else None

    @property
    def node_results(self) -> 'List[_1364.NodeResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeResults, constructor.new(_1364.NodeResults))
        return value

    @property
    def connected_components_forces_in_lcs(self) -> 'List[_1363.ForceResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectedComponentsForcesInLCS, constructor.new(_1363.ForceResults))
        return value

    @property
    def connected_components_forces_in_wcs(self) -> 'List[_1363.ForceResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectedComponentsForcesInWCS, constructor.new(_1363.ForceResults))
        return value

    @property
    def power_flow_results(self) -> '_3793.ComponentPowerFlow':
