...
class ShaftSectionEndResultsSystemDeflection(_0.APIBase):
    ...
    @property
    def displacements(self) -> '_1366.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1366.VectorWithLinearAndAngularComponents)(self.wrapped.Displacements) if self.wrapped.Displacements is not None else None

    @property
    def forces(self) -> '_1366.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1366.VectorWithLinearAndAngularComponents)(self.wrapped.Forces) if self.wrapped.Forces is not None else None
