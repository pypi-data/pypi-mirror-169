...
class OilSealSystemDeflection(_2466.ConnectorSystemDeflection):
    '''OilSealSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3847.OilSealPowerFlow':
        ...
        return constructor.new(_3847.OilSealPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
