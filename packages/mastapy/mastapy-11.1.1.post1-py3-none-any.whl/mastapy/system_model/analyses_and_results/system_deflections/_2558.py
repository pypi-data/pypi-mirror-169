...
class StraightBevelSunGearSystemDeflection(_2553.StraightBevelDiffGearSystemDeflection):
    '''StraightBevelSunGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3883.StraightBevelSunGearPowerFlow':
        ...
        return constructor.new(_3883.StraightBevelSunGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
