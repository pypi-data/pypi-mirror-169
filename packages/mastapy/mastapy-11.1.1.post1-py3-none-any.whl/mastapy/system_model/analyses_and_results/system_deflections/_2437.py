...
from mastapy.system_model.analyses_and_results.power_flows import _3777, _3808
...
class BeltConnectionSystemDeflection(_2505.InterMountableComponentConnectionSystemDeflection):
    '''BeltConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3777.BeltConnectionPowerFlow':
        ...
        if _3777.BeltConnectionPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
