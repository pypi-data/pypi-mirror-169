...
class CylindricalGearSetSystemDeflectionWithLTCAResults(_2480.CylindricalGearSetSystemDeflection):
    '''CylindricalGearSetSystemDeflectionWithLTCAResults
    ...
    @property
    def basic_ltca_results(self) -> '_821.CylindricalGearSetLoadDistributionAnalysis':
        ...
        if _821.CylindricalGearSetLoadDistributionAnalysis.TYPE not in self.wrapped.BasicLTCAResults.__class__.__mro__:
    ...
    @property
    def basic_ltca_results_only_first_planetary_mesh(self) -> '_821.CylindricalGearSetLoadDistributionAnalysis':
        ...
        if _821.CylindricalGearSetLoadDistributionAnalysis.TYPE not in self.wrapped.BasicLTCAResultsOnlyFirstPlanetaryMesh.__class__.__mro__:
    ...
    @property
    def advanced_ltca_results(self) -> '_821.CylindricalGearSetLoadDistributionAnalysis':
        ...
        if _821.CylindricalGearSetLoadDistributionAnalysis.TYPE not in self.wrapped.AdvancedLTCAResults.__class__.__mro__:
    ...
    @property
    def advanced_ltca_results_only_first_planetary_mesh(self) -> '_821.CylindricalGearSetLoadDistributionAnalysis':
        ...
        if _821.CylindricalGearSetLoadDistributionAnalysis.TYPE not in self.wrapped.AdvancedLTCAResultsOnlyFirstPlanetaryMesh.__class__.__mro__:
