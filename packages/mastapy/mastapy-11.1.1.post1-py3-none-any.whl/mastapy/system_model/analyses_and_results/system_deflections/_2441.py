...
from mastapy.system_model.analyses_and_results.power_flows import _3780, _3782, _3783
...
class BevelDifferentialGearSystemDeflection(_2446.BevelGearSystemDeflection):
    '''BevelDifferentialGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3780.BevelDifferentialGearPowerFlow':
