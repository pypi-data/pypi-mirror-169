...
class ConceptGearMeshSystemDeflection(_2497.GearMeshSystemDeflection):
    '''ConceptGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3797.ConceptGearMeshPowerFlow':
        ...
        return constructor.new(_3797.ConceptGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None

    @property
    def rating(self) -> '_511.ConceptGearMeshRating':
        ...
        return constructor.new(_511.ConceptGearMeshRating)(self.wrapped.Rating) if self.wrapped.Rating is not None else None
