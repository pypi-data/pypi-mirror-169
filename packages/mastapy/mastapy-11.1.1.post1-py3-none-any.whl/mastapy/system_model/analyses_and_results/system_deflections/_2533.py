...
from mastapy.system_model.analyses_and_results.system_deflections import _2534, _2505
...
class RingPinsToDiscConnectionSystemDeflection(_2505.InterMountableComponentConnectionSystemDeflection):
    '''RingPinsToDiscConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3861.RingPinsToDiscConnectionPowerFlow':
        ...
        return constructor.new(_3861.RingPinsToDiscConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None

    @property
    def ring_pin_to_disc_contacts(self) -> 'List[_2534.RingPinToDiscContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RingPinToDiscContacts, constructor.new(_2534.RingPinToDiscContactReporting))
        return value
