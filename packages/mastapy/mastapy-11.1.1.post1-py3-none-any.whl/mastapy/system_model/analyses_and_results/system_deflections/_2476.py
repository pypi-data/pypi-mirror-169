...
class CycloidalDiscSystemDeflection(_2430.AbstractShaftSystemDeflection):
    '''CycloidalDiscSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3814.CycloidalDiscPowerFlow':
        ...
        return constructor.new(_3814.CycloidalDiscPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
