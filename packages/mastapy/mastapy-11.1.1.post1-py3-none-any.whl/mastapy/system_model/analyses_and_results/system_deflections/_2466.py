...
class ConnectorSystemDeflection(_2520.MountableComponentSystemDeflection):
    '''ConnectorSystemDeflection
    ...
    @property
    def outer_fe_part(self) -> '_2495.FEPartSystemDeflection':
        ...
        return constructor.new(_2495.FEPartSystemDeflection)(self.wrapped.OuterFEPart) if self.wrapped.OuterFEPart is not None else None

    @property
    def force_on_outer_support_in_wcs(self) -> '_1366.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1366.VectorWithLinearAndAngularComponents)(self.wrapped.ForceOnOuterSupportInWCS) if self.wrapped.ForceOnOuterSupportInWCS is not None else None

    @property
    def force_on_outer_support_in_lcs(self) -> '_1366.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1366.VectorWithLinearAndAngularComponents)(self.wrapped.ForceOnOuterSupportInLCS) if self.wrapped.ForceOnOuterSupportInLCS is not None else None

    @property
    def outer_fe_substructure_nodes(self) -> 'List[_2129.FESubstructureNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.OuterFESubstructureNodes, constructor.new(_2129.FESubstructureNode))
        return value

    @property
    def power_flow_results(self) -> '_3804.ConnectorPowerFlow':
