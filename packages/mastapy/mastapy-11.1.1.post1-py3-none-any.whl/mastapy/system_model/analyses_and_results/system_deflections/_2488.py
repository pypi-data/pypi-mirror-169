...
class CylindricalPlanetGearSystemDeflection(_2485.CylindricalGearSystemDeflectionWithLTCAResults):
    '''CylindricalPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3819.CylindricalPlanetGearPowerFlow':
        ...
        return constructor.new(_3819.CylindricalPlanetGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
