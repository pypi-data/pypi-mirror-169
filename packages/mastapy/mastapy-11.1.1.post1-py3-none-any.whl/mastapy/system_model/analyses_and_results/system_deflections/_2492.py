...
class FaceGearMeshSystemDeflection(_2497.GearMeshSystemDeflection):
    '''FaceGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3822.FaceGearMeshPowerFlow':
        ...
        return constructor.new(_3822.FaceGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None

    @property
    def rating(self) -> '_414.FaceGearMeshRating':
        ...
        return constructor.new(_414.FaceGearMeshRating)(self.wrapped.Rating) if self.wrapped.Rating is not None else None
