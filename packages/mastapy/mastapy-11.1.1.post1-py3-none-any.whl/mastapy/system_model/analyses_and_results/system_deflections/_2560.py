...
from mastapy.system_model.analyses_and_results.power_flows import _3885, _3884, _3887
...
class SynchroniserPartSystemDeflection(_2468.CouplingHalfSystemDeflection):
    '''SynchroniserPartSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3885.SynchroniserPartPowerFlow':
