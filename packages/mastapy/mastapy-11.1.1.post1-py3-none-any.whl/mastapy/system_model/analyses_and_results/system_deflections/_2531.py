...
from mastapy.system_model.analyses_and_results.power_flows import _3859, _3810
...
class PulleySystemDeflection(_2468.CouplingHalfSystemDeflection):
    '''PulleySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3859.PulleyPowerFlow':
