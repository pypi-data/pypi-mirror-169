...
class SynchroniserCompoundSystemDeflection(_2689.SpecialisedAssemblyCompoundSystemDeflection):
    '''SynchroniserCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2562.SynchroniserSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2562.SynchroniserSystemDeflection))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_2562.SynchroniserSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2562.SynchroniserSystemDeflection))
        return value
