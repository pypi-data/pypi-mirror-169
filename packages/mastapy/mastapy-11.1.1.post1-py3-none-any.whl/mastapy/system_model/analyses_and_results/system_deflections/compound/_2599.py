...
class BeltDriveCompoundSystemDeflection(_2689.SpecialisedAssemblyCompoundSystemDeflection):
    '''BeltDriveCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2438.BeltDriveSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2438.BeltDriveSystemDeflection))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_2438.BeltDriveSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2438.BeltDriveSystemDeflection))
        return value
