...
class BevelGearMeshCompoundSystemDeflection(_2594.AGMAGleasonConicalGearMeshCompoundSystemDeflection):
    '''BevelGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2444.BevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_2444.BevelGearMeshSystemDeflection))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_2444.BevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_2444.BevelGearMeshSystemDeflection))
        return value
