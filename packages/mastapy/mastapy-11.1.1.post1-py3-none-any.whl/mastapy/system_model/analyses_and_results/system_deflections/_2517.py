...
class MassDiscSystemDeflection(_2573.VirtualComponentSystemDeflection):
    '''MassDiscSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3844.MassDiscPowerFlow':
        ...
        return constructor.new(_3844.MassDiscPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
