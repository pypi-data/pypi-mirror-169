...
class SingleAnalysis:
    ...
    def perform_analysis_with_progress(self, task_progress: '_7278.TaskProgress'):
        ''' 'PerformAnalysis' is the original name of this method.
    ...
    def results_for(self, design_entity: '_1954.DesignEntity') -> '_2394.DesignEntityAnalysis':
    ...
    def results_for_design_entity_analysis(self, design_entity_analysis: '_2394.DesignEntityAnalysis') -> '_2394.DesignEntityAnalysis':
        ''' 'ResultsFor' is the original name of this method.
