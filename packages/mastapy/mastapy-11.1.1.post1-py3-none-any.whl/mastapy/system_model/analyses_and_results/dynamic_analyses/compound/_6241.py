...
class SynchroniserPartCompoundDynamicAnalysis(_6165.CouplingHalfCompoundDynamicAnalysis):
    '''SynchroniserPartCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6112.SynchroniserPartDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6112.SynchroniserPartDynamicAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_6112.SynchroniserPartDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6112.SynchroniserPartDynamicAnalysis))
        return value
