...
class ShaftHubConnectionCompoundDynamicAnalysis(_6162.ConnectorCompoundDynamicAnalysis):
    '''ShaftHubConnectionCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6093.ShaftHubConnectionDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6093.ShaftHubConnectionDynamicAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6093.ShaftHubConnectionDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6093.ShaftHubConnectionDynamicAnalysis))
        return value
