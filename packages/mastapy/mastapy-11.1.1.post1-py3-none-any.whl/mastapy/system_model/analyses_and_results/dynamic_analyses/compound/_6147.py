...
class ClutchCompoundDynamicAnalysis(_6163.CouplingCompoundDynamicAnalysis):
    '''ClutchCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6018.ClutchDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6018.ClutchDynamicAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_6018.ClutchDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6018.ClutchDynamicAnalysis))
        return value
