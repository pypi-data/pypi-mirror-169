...
class ClutchHalfCompoundDynamicAnalysis(_6165.CouplingHalfCompoundDynamicAnalysis):
    '''ClutchHalfCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6019.ClutchHalfDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6019.ClutchHalfDynamicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6019.ClutchHalfDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6019.ClutchHalfDynamicAnalysis))
        return value
