...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6994, _7000
...
class RootAssemblyAdvancedSystemDeflection(_7000.AssemblyAdvancedSystemDeflection):
    '''RootAssemblyAdvancedSystemDeflection
    ...
    @property
    def advanced_system_deflection_inputs(self) -> '_6994.AdvancedSystemDeflection':
        ...
        return constructor.new(_6994.AdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflectionInputs) if self.wrapped.AdvancedSystemDeflectionInputs is not None else None
