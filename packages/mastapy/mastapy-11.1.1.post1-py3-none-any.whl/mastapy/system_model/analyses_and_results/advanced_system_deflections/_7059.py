...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7057, _7058, _6999
...
class HypoidGearSetAdvancedSystemDeflection(_6999.AGMAGleasonConicalGearSetAdvancedSystemDeflection):
    '''HypoidGearSetAdvancedSystemDeflection
    ...
    @property
    def hypoid_gears_advanced_system_deflection(self) -> 'List[_7057.HypoidGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsAdvancedSystemDeflection, constructor.new(_7057.HypoidGearAdvancedSystemDeflection))
        return value

    @property
    def hypoid_meshes_advanced_system_deflection(self) -> 'List[_7058.HypoidGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesAdvancedSystemDeflection, constructor.new(_7058.HypoidGearMeshAdvancedSystemDeflection))
        return value
