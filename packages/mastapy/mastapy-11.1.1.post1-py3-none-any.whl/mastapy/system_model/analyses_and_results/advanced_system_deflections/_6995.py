...
class AdvancedSystemDeflectionOptions(_0.APIBase):
    ...
    @property
    def use_advanced_ltca(self) -> '_811.UseAdvancedLTCAOptions':
        ...
        return constructor.new(_811.UseAdvancedLTCAOptions)(value) if value is not None else None

    @use_advanced_ltca.setter
    def use_advanced_ltca(self, value: '_811.UseAdvancedLTCAOptions'):
