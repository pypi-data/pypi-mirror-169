...
class PartCompoundPowerFlow(_7266.PartCompoundAnalysis):
    '''PartCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3848.PartPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3848.PartPowerFlow))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3848.PartPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3848.PartPowerFlow))
        return value
