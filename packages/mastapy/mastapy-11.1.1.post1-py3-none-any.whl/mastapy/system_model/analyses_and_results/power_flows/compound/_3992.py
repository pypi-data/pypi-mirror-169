...
class RollingRingAssemblyCompoundPowerFlow(_3999.SpecialisedAssemblyCompoundPowerFlow):
    '''RollingRingAssemblyCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3862.RollingRingAssemblyPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3862.RollingRingAssemblyPowerFlow))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3862.RollingRingAssemblyPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3862.RollingRingAssemblyPowerFlow))
        return value
