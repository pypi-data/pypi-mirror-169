...
class PowerFlow(_7270.StaticLoadAnalysisCase):
    '''PowerFlow
    ...
    @property
    def torsional_system_deflection(self) -> '_2570.TorsionalSystemDeflection':
        ...
        return constructor.new(_2570.TorsionalSystemDeflection)(self.wrapped.TorsionalSystemDeflection) if self.wrapped.TorsionalSystemDeflection is not None else None
