...
class AbstractShaftOrHousingCompoundMultibodyDynamicsAnalysis(_5282.ComponentCompoundMultibodyDynamicsAnalysis):
    '''AbstractShaftOrHousingCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5107.AbstractShaftOrHousingMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5107.AbstractShaftOrHousingMultibodyDynamicsAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5107.AbstractShaftOrHousingMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5107.AbstractShaftOrHousingMultibodyDynamicsAnalysis))
        return value
