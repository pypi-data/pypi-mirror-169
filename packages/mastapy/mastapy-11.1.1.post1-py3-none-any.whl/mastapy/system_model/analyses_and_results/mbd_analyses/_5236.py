...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5240, _5145
...
class TorqueConverterConnectionMultibodyDynamicsAnalysis(_5145.CouplingConnectionMultibodyDynamicsAnalysis):
    '''TorqueConverterConnectionMultibodyDynamicsAnalysis
    ...
    @property
    def locking_status(self) -> '_5240.TorqueConverterStatus':
        ...
        return constructor.new(_5240.TorqueConverterStatus)(value) if value is not None else None
