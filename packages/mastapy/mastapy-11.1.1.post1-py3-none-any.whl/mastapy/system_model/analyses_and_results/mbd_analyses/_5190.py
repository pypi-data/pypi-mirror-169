...
from mastapy.system_model.analyses_and_results.mbd_analyses.external_interfaces import _5256
...
class MBDAnalysisOptions(_0.APIBase):
    ...
    @property
    def analysis_type(self) -> '_5112.AnalysisTypes':
        '''AnalysisTypes: 'AnalysisType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.AnalysisType)
        return constructor.new(_5112.AnalysisTypes)(value) if value is not None else None

    @analysis_type.setter
    def analysis_type(self, value: '_5112.AnalysisTypes'):
    ...
    @property
    def method_to_define_period(self) -> '_5174.InertiaAdjustedLoadCasePeriodMethod':
        ...
        return constructor.new(_5174.InertiaAdjustedLoadCasePeriodMethod)(value) if value is not None else None

    @method_to_define_period.setter
    def method_to_define_period(self, value: '_5174.InertiaAdjustedLoadCasePeriodMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def static_load_cases_to_create(self) -> '_5175.InertiaAdjustedLoadCaseResultsToCreate':
        ...
        return constructor.new(_5175.InertiaAdjustedLoadCaseResultsToCreate)(value) if value is not None else None

    @static_load_cases_to_create.setter
    def static_load_cases_to_create(self, value: '_5175.InertiaAdjustedLoadCaseResultsToCreate'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    def transient_solver_options(self) -> '_84.TransientSolverOptions':
        ...
        return constructor.new(_84.TransientSolverOptions)(self.wrapped.TransientSolverOptions) if self.wrapped.TransientSolverOptions is not None else None

    @property
    def external_interface_options(self) -> '_5256.DynamicExternalInterfaceOptions':
        ...
        return constructor.new(_5256.DynamicExternalInterfaceOptions)(self.wrapped.ExternalInterfaceOptions) if self.wrapped.ExternalInterfaceOptions is not None else None

    @property
    def run_up_analysis_options(self) -> '_5191.MBDRunUpAnalysisOptions':
        ...
        return constructor.new(_5191.MBDRunUpAnalysisOptions)(self.wrapped.RunUpAnalysisOptions) if self.wrapped.RunUpAnalysisOptions is not None else None

    @property
    def frequency_response_options(self) -> '_4365.FrequencyResponseAnalysisOptions':
        ...
        return constructor.new(_4365.FrequencyResponseAnalysisOptions)(self.wrapped.FrequencyResponseOptions) if self.wrapped.FrequencyResponseOptions is not None else None
