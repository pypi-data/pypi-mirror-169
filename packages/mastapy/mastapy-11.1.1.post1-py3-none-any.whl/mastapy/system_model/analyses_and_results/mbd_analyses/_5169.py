...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5168, _5166, _5217
...
class GearSetMultibodyDynamicsAnalysis(_5217.SpecialisedAssemblyMultibodyDynamicsAnalysis):
    '''GearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5168.GearMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_5168.GearMultibodyDynamicsAnalysis))
        return value

    @property
    def meshes(self) -> 'List[_5166.GearMeshMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_5166.GearMeshMultibodyDynamicsAnalysis))
        return value
