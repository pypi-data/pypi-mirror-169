...
from mastapy.system_model.analyses_and_results.mbd_analyses import _2382, _5113
...
class RootAssemblyMultibodyDynamicsAnalysis(_5113.AssemblyMultibodyDynamicsAnalysis):
    '''RootAssemblyMultibodyDynamicsAnalysis
    ...
    @property
    def multibody_dynamics_analysis_inputs(self) -> '_2382.MultibodyDynamicsAnalysis':
        ...
        return constructor.new(_2382.MultibodyDynamicsAnalysis)(self.wrapped.MultibodyDynamicsAnalysisInputs) if self.wrapped.MultibodyDynamicsAnalysisInputs is not None else None
