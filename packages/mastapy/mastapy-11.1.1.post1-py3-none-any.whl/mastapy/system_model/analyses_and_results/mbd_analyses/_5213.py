...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5253, _5255
...
class ShaftHubConnectionMultibodyDynamicsAnalysis(_5144.ConnectorMultibodyDynamicsAnalysis):
    '''ShaftHubConnectionMultibodyDynamicsAnalysis
    ...
    @property
    def peak_dynamic_force(self) -> '_5253.DynamicForceVector3DResult':
        ...
        return constructor.new(_5253.DynamicForceVector3DResult)(self.wrapped.PeakDynamicForce) if self.wrapped.PeakDynamicForce is not None else None

    @property
    def peak_dynamic_force_angular(self) -> '_5255.DynamicTorqueVector3DResult':
        ...
        return constructor.new(_5255.DynamicTorqueVector3DResult)(self.wrapped.PeakDynamicForceAngular) if self.wrapped.PeakDynamicForceAngular is not None else None
