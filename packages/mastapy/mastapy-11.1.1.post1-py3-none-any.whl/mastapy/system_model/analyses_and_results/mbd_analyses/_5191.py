...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5177, _5216, _5211
...
class MBDRunUpAnalysisOptions(_7256.AbstractAnalysisOptions['_6523.TimeSeriesLoadCase']):
    '''MBDRunUpAnalysisOptions
    ...
    @property
    def input_velocity_processing_type(self) -> '_5177.InputVelocityForRunUpProcessingType':
        ...
        return constructor.new(_5177.InputVelocityForRunUpProcessingType)(value) if value is not None else None

    @input_velocity_processing_type.setter
    def input_velocity_processing_type(self, value: '_5177.InputVelocityForRunUpProcessingType'):
    ...
    @property
    def shape_of_initial_acceleration_period(self) -> '_5216.ShapeOfInitialAccelerationPeriodForRunUp':
        ...
        return constructor.new(_5216.ShapeOfInitialAccelerationPeriodForRunUp)(value) if value is not None else None

    @shape_of_initial_acceleration_period.setter
    def shape_of_initial_acceleration_period(self, value: '_5216.ShapeOfInitialAccelerationPeriodForRunUp'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ShapeOfInitialAccelerationPeriod = value

    @property
    def run_up_driving_mode(self) -> '_5211.RunUpDrivingMode':
        ...
        return constructor.new(_5211.RunUpDrivingMode)(value) if value is not None else None

    @run_up_driving_mode.setter
    def run_up_driving_mode(self, value: '_5211.RunUpDrivingMode'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
