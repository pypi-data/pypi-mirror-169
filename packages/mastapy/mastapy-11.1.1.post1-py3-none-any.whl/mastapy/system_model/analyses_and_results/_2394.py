...
from mastapy.system_model.part_model import (
    ...
    _2185, _2187, _2188, _2189,
    _2192, _2193, _2196, _2197,
...
from mastapy.utility.model_validation import _1567, _1568
...
class DesignEntityAnalysis(_0.APIBase):
    ...
    @property
    def active_report_as_text(self) -> '_1528.CustomReport':
        ...
        return constructor.new(_1528.CustomReport)(self.wrapped.ActiveReportAsText) if self.wrapped.ActiveReportAsText is not None else None

    @property
    def safety_factors(self) -> '_248.SafetyFactorGroup':
        ...
        return constructor.new(_248.SafetyFactorGroup)(self.wrapped.SafetyFactors) if self.wrapped.SafetyFactors is not None else None

    @property
    def component_design(self) -> '_1954.DesignEntity':
        ...
        if _1954.DesignEntity.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_connection(self) -> '_2017.Connection':
    ...
    @property
    def component_design_of_type_part(self) -> '_2212.Part':
    ...
    @property
    def local_coordinate_system(self) -> '_1300.CoordinateSystem3D':
        ...
        return constructor.new(_1300.CoordinateSystem3D)(self.wrapped.LocalCoordinateSystem) if self.wrapped.LocalCoordinateSystem is not None else None
    ...
    @property
    def all_status_errors(self) -> 'List[_1568.StatusItem]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllStatusErrors, constructor.new(_1568.StatusItem))
        return value
