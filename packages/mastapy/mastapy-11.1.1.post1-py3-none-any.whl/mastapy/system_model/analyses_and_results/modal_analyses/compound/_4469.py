...
class BeltDriveCompoundModalAnalysis(_4557.SpecialisedAssemblyCompoundModalAnalysis):
    '''BeltDriveCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4316.BeltDriveModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4316.BeltDriveModalAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4316.BeltDriveModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4316.BeltDriveModalAnalysis))
        return value
