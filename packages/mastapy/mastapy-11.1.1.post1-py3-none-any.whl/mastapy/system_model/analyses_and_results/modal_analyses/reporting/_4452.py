...
class PerModeResultsReport(_1530.CustomReportChart):
    '''PerModeResultsReport
    ...
    @property
    def display_option(self) -> '_1592.TableAndChartOptions':
    ...
    def display_option(self, value: '_1592.TableAndChartOptions'):
