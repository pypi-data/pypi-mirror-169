...
class PlanetaryConnectionAdvancedTimeSteppingAnalysisForModulation(_6829.ShaftToMountableComponentConnectionAdvancedTimeSteppingAnalysisForModulation):
    '''PlanetaryConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2527.PlanetaryConnectionSystemDeflection':
        ...
        return constructor.new(_2527.PlanetaryConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
