...
class FaceGearCompoundAdvancedTimeSteppingAnalysisForModulation(_6919.GearCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''FaceGearCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6784.FaceGearAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6784.FaceGearAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6784.FaceGearAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6784.FaceGearAdvancedTimeSteppingAnalysisForModulation))
        return value
