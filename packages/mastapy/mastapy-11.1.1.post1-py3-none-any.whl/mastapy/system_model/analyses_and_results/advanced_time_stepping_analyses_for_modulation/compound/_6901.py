...
class CVTBeltConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_6870.BeltConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''CVTBeltConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6772.CVTBeltConnectionAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6772.CVTBeltConnectionAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_6772.CVTBeltConnectionAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6772.CVTBeltConnectionAdvancedTimeSteppingAnalysisForModulation))
        return value
