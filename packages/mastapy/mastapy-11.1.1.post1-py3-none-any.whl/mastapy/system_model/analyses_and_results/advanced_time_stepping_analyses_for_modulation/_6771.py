...
class CVTAdvancedTimeSteppingAnalysisForModulation(_6741.BeltDriveAdvancedTimeSteppingAnalysisForModulation):
    '''CVTAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2472.CVTSystemDeflection':
        ...
        return constructor.new(_2472.CVTSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
