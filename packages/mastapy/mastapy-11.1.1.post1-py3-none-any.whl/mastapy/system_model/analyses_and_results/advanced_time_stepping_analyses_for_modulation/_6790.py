...
class GearMeshAdvancedTimeSteppingAnalysisForModulation(_6797.InterMountableComponentConnectionAdvancedTimeSteppingAnalysisForModulation):
    '''GearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2497.GearMeshSystemDeflection':
