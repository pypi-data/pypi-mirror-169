...
class BoltedJointAdvancedTimeSteppingAnalysisForModulation(_6830.SpecialisedAssemblyAdvancedTimeSteppingAnalysisForModulation):
    '''BoltedJointAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2447.BoltedJointSystemDeflection':
        ...
        return constructor.new(_2447.BoltedJointSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
