...
class BevelDifferentialPlanetGearAdvancedTimeSteppingAnalysisForModulation(_6742.BevelDifferentialGearAdvancedTimeSteppingAnalysisForModulation):
    '''BevelDifferentialPlanetGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2260.BevelDifferentialPlanetGear':
        ...
        return constructor.new(_2260.BevelDifferentialPlanetGear)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign is not None else None

    @property
    def system_deflection_results(self) -> '_2442.BevelDifferentialPlanetGearSystemDeflection':
        ...
        return constructor.new(_2442.BevelDifferentialPlanetGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
