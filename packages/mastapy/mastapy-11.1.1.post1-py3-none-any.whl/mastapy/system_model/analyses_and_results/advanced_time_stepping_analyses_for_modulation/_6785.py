...
class FaceGearMeshAdvancedTimeSteppingAnalysisForModulation(_6790.GearMeshAdvancedTimeSteppingAnalysisForModulation):
    '''FaceGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2492.FaceGearMeshSystemDeflection':
        ...
        return constructor.new(_2492.FaceGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
