...
class MassDiscAdvancedTimeSteppingAnalysisForModulation(_6854.VirtualComponentAdvancedTimeSteppingAnalysisForModulation):
    '''MassDiscAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2517.MassDiscSystemDeflection':
        ...
        return constructor.new(_2517.MassDiscSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
