...
class SpringDamperConnectionAdvancedTimeSteppingAnalysisForModulation(_6769.CouplingConnectionAdvancedTimeSteppingAnalysisForModulation):
    '''SpringDamperConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2548.SpringDamperConnectionSystemDeflection':
        ...
        return constructor.new(_2548.SpringDamperConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
