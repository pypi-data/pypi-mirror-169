...
class StraightBevelDiffGearMeshAdvancedTimeSteppingAnalysisForModulation(_6748.BevelGearMeshAdvancedTimeSteppingAnalysisForModulation):
    '''StraightBevelDiffGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2551.StraightBevelDiffGearMeshSystemDeflection':
        ...
        return constructor.new(_2551.StraightBevelDiffGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
