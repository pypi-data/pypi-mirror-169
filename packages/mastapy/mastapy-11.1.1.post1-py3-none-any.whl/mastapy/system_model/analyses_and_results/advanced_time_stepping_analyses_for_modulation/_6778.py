...
class CylindricalGearAdvancedTimeSteppingAnalysisForModulation(_6789.GearAdvancedTimeSteppingAnalysisForModulation):
    '''CylindricalGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2483.CylindricalGearSystemDeflection':
