...
class MeasurementComponentAdvancedTimeSteppingAnalysisForModulation(_6854.VirtualComponentAdvancedTimeSteppingAnalysisForModulation):
    '''MeasurementComponentAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2518.MeasurementComponentSystemDeflection':
        ...
        return constructor.new(_2518.MeasurementComponentSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
