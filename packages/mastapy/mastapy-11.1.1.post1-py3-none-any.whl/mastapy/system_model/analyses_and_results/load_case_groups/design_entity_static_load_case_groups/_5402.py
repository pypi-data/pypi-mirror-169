...
TConnection = TypeVar('TConnection', bound='_2017.Connection')
TConnectionStaticLoad = TypeVar('TConnectionStaticLoad', bound='_6566.ConnectionLoadCase')


class ConnectionStaticLoadCaseGroup(_5403.DesignEntityStaticLoadCaseGroup, Generic[TConnection, TConnectionStaticLoad]):
    '''ConnectionStaticLoadCaseGroup
