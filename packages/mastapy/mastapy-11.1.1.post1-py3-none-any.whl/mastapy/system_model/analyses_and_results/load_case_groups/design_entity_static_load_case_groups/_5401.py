...
TReal = TypeVar('TReal', bound='_2189.Component')
TComponentStaticLoad = TypeVar('TComponentStaticLoad', bound='_6554.ComponentLoadCase')


class ComponentStaticLoadCaseGroup(_5405.PartStaticLoadCaseGroup, Generic[TReal, TComponentStaticLoad]):
    '''ComponentStaticLoadCaseGroup
