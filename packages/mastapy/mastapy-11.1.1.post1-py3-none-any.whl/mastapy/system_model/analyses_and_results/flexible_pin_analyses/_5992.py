...
class FlexiblePinAnalysisManufactureLevel(_5988.FlexiblePinAnalysis):
    '''FlexiblePinAnalysisManufactureLevel
    ...
    @property
    def planetary_mesh_analysis(self) -> '_4077.CylindricalGearMeshParametricStudyTool':
        ...
        return constructor.new(_4077.CylindricalGearMeshParametricStudyTool)(self.wrapped.PlanetaryMeshAnalysis) if self.wrapped.PlanetaryMeshAnalysis is not None else None
