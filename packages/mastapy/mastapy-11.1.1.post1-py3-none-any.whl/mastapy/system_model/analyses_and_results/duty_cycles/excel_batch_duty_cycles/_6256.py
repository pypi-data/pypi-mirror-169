...
class ExcelBatchDutyCycleSpectraCreatorDetails(_0.APIBase):
    ...
    def masta_file_details(self) -> '_6260.MASTAFileDetails':
        ...
        return constructor.new(_6260.MASTAFileDetails)(self.wrapped.MASTAFileDetails) if self.wrapped.MASTAFileDetails is not None else None
    ...
    def excel_file_details(self) -> '_6257.ExcelFileDetails':
        ...
        return constructor.new(_6257.ExcelFileDetails)(self.wrapped.ExcelFileDetails) if self.wrapped.ExcelFileDetails is not None else None

    @property
    def working_folder(self) -> '_1395.SelectableFolder':
        ...
        return constructor.new(_1395.SelectableFolder)(self.wrapped.WorkingFolder) if self.wrapped.WorkingFolder is not None else None
