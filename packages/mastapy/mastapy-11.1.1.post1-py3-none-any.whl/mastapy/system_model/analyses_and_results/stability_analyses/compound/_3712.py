...
class PartCompoundStabilityAnalysis(_7266.PartCompoundAnalysis):
    '''PartCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3581.PartStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3581.PartStabilityAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3581.PartStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3581.PartStabilityAnalysis))
        return value
