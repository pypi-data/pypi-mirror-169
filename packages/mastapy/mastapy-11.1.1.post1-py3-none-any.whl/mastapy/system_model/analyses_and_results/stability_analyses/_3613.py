...
from mastapy.system_model.analyses_and_results.stability_analyses import _3614, _3612, _3518
...
class StraightBevelGearSetStabilityAnalysis(_3518.BevelGearSetStabilityAnalysis):
    '''StraightBevelGearSetStabilityAnalysis
    ...
    @property
    def straight_bevel_gears_stability_analysis(self) -> 'List[_3614.StraightBevelGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsStabilityAnalysis, constructor.new(_3614.StraightBevelGearStabilityAnalysis))
        return value

    @property
    def straight_bevel_meshes_stability_analysis(self) -> 'List[_3612.StraightBevelGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesStabilityAnalysis, constructor.new(_3612.StraightBevelGearMeshStabilityAnalysis))
        return value
