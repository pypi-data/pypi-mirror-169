...
from mastapy.system_model.analyses_and_results.static_loads import _6590, _6598
...
class ElectricMachineHarmonicLoadDataFromMotorPackages(_6590.ElectricMachineHarmonicLoadData, Generic[T]):
    '''ElectricMachineHarmonicLoadDataFromMotorPackages
