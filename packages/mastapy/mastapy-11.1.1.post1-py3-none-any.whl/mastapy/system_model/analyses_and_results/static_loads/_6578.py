...
from mastapy.system_model.analyses_and_results.static_loads import _6579, _6608
...
class CylindricalGearLoadCase(_6608.GearLoadCase):
    '''CylindricalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6579.CylindricalGearManufactureError':
        ...
        return constructor.new(_6579.CylindricalGearManufactureError)(self.wrapped.GearManufactureErrors) if self.wrapped.GearManufactureErrors is not None else None

    @property
    def overridden_micro_geometry(self) -> '_1054.CylindricalGearMicroGeometry':
        ...
        return constructor.new(_1054.CylindricalGearMicroGeometry)(self.wrapped.OverriddenMicroGeometry) if self.wrapped.OverriddenMicroGeometry is not None else None
