...
from mastapy.system_model.fe import _2104, _2127
...
class FEPartLoadCase(_6526.AbstractShaftOrHousingLoadCase):
    '''FEPartLoadCase
    ...
    @property
    def angle_source(self) -> '_2104.AngleSource':
        ...
        return constructor.new(_2104.AngleSource)(value) if value is not None else None
