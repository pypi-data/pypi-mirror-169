...
class ConicalGearSetHarmonicLoadData(_6612.GearSetHarmonicLoadData):
    '''ConicalGearSetHarmonicLoadData
    ...
    @property
    def te_specification_type(self) -> '_316.TESpecificationType':
        ...
        return constructor.new(_316.TESpecificationType)(value) if value is not None else None

    @te_specification_type.setter
    def te_specification_type(self, value: '_316.TESpecificationType'):
