...
from mastapy.system_model.analyses_and_results.static_loads import _6624, _6620, _6598
...
class HarmonicLoadDataImportFromMotorPackages(_6620.HarmonicLoadDataImportBase['T'], Generic[T]):
    '''HarmonicLoadDataImportFromMotorPackages
