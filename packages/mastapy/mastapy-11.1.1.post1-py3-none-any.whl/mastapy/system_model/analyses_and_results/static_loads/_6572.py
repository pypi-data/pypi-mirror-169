...
from mastapy.system_model.analyses_and_results.static_loads import _6573, _6539
...
class CVTLoadCase(_6539.BeltDriveLoadCase):
    '''CVTLoadCase
    ...
    @property
    def pulleys(self) -> 'List[_6573.CVTPulleyLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_6573.CVTPulleyLoadCase))
        return value
