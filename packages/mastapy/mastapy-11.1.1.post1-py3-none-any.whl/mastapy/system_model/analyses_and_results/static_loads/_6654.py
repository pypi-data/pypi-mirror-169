...
class PlanetaryGearSetLoadCase(_6582.CylindricalGearSetLoadCase):
    '''PlanetaryGearSetLoadCase
    ...
    @property
    def include_gear_blank_elastic_distortion(self) -> '_1388.LoadCaseOverrideOption':
    ...
    def include_gear_blank_elastic_distortion(self, value: '_1388.LoadCaseOverrideOption'):
    ...
    @property
    def assembly_design(self) -> '_2285.PlanetaryGearSet':
        ...
        return constructor.new(_2285.PlanetaryGearSet)(self.wrapped.AssemblyDesign) if self.wrapped.AssemblyDesign is not None else None
