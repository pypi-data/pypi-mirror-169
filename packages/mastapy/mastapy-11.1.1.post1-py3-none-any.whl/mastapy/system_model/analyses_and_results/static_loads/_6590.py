...
from mastapy.system_model.analyses_and_results.static_loads import _6698, _6624, _6674
...
class ElectricMachineHarmonicLoadData(_6674.SpeedDependentHarmonicLoadData):
    '''ElectricMachineHarmonicLoadData
    ...
    @property
    def force_distribution_3d(self) -> '_1628.ThreeDVectorChartDefinition':
        ...
        return constructor.new(_1628.ThreeDVectorChartDefinition)(self.wrapped.ForceDistribution3D) if self.wrapped.ForceDistribution3D is not None else None
