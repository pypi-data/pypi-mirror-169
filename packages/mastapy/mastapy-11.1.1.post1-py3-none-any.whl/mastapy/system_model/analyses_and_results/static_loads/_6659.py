...
from mastapy.system_model.analyses_and_results.static_loads import _6658, _6703
...
class PointLoadLoadCase(_6703.VirtualComponentLoadCase):
    '''PointLoadLoadCase
    ...
    def force_x(self) -> '_91.ForceInputComponent':
        ...
        return constructor.new(_91.ForceInputComponent)(self.wrapped.ForceX) if self.wrapped.ForceX is not None else None
    ...
    def force_y(self) -> '_91.ForceInputComponent':
        ...
        return constructor.new(_91.ForceInputComponent)(self.wrapped.ForceY) if self.wrapped.ForceY is not None else None
    ...
    def axial_load(self) -> '_91.ForceInputComponent':
        ...
        return constructor.new(_91.ForceInputComponent)(self.wrapped.AxialLoad) if self.wrapped.AxialLoad is not None else None
    ...
    def moment_x(self) -> '_92.MomentInputComponent':
        ...
        return constructor.new(_92.MomentInputComponent)(self.wrapped.MomentX) if self.wrapped.MomentX is not None else None
    ...
    def moment_y(self) -> '_92.MomentInputComponent':
        ...
        return constructor.new(_92.MomentInputComponent)(self.wrapped.MomentY) if self.wrapped.MomentY is not None else None
    ...
    def moment_z(self) -> '_92.MomentInputComponent':
        ...
        return constructor.new(_92.MomentInputComponent)(self.wrapped.MomentZ) if self.wrapped.MomentZ is not None else None

    def get_harmonic_load_data_for_import(self) -> '_6658.PointLoadHarmonicLoadData':
