...
from mastapy.system_model.analyses_and_results.static_loads import _6655, _6645
...
class PlanetCarrierLoadCase(_6645.MountableComponentLoadCase):
    '''PlanetCarrierLoadCase
    ...
    @property
    def planet_manufacture_errors(self) -> 'List[_6655.PlanetarySocketManufactureError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetManufactureErrors, constructor.new(_6655.PlanetarySocketManufactureError))
        return value
