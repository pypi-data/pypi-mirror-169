...
from mastapy.system_model import _1964, _1965, _1966
from mastapy.system_model.analyses_and_results.mbd_analyses import _5244
from mastapy.system_model.analyses_and_results.static_loads import _6699, _6590, _6703
...
class PowerLoadLoadCase(_6703.VirtualComponentLoadCase):
    '''PowerLoadLoadCase
    ...
    @property
    def torque_vs_time(self) -> '_1336.Vector2DListAccessor':
        '''Vector2DListAccessor: 'TorqueVsTime' is the original name of this property.'''

        return constructor.new(_1336.Vector2DListAccessor)(self.wrapped.TorqueVsTime) if self.wrapped.TorqueVsTime is not None else None

    @torque_vs_time.setter
    def torque_vs_time(self, value: '_1336.Vector2DListAccessor'):
        value = value.wrapped if value else None
        self.wrapped.TorqueVsTime = value

    @property
    def torque_vs_angle(self) -> '_1336.Vector2DListAccessor':
        '''Vector2DListAccessor: 'TorqueVsAngle' is the original name of this property.'''

        return constructor.new(_1336.Vector2DListAccessor)(self.wrapped.TorqueVsAngle) if self.wrapped.TorqueVsAngle is not None else None

    @torque_vs_angle.setter
    def torque_vs_angle(self, value: '_1336.Vector2DListAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def torque_vs_angle_and_speed(self) -> '_1368.GriddedSurfaceAccessor':
        '''GriddedSurfaceAccessor: 'TorqueVsAngleAndSpeed' is the original name of this property.'''

        return constructor.new(_1368.GriddedSurfaceAccessor)(self.wrapped.TorqueVsAngleAndSpeed) if self.wrapped.TorqueVsAngleAndSpeed is not None else None

    @torque_vs_angle_and_speed.setter
    def torque_vs_angle_and_speed(self, value: '_1368.GriddedSurfaceAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def engine_throttle_time_profile(self) -> '_1336.Vector2DListAccessor':
        '''Vector2DListAccessor: 'EngineThrottleTimeProfile' is the original name of this property.'''

        return constructor.new(_1336.Vector2DListAccessor)(self.wrapped.EngineThrottleTimeProfile) if self.wrapped.EngineThrottleTimeProfile is not None else None

    @engine_throttle_time_profile.setter
    def engine_throttle_time_profile(self, value: '_1336.Vector2DListAccessor'):
        value = value.wrapped if value else None
        self.wrapped.EngineThrottleTimeProfile = value

    @property
    def quadratic_resistance_coefficient_time_profile(self) -> '_1336.Vector2DListAccessor':
        '''Vector2DListAccessor: 'QuadraticResistanceCoefficientTimeProfile' is the original name of this property.'''

        return constructor.new(_1336.Vector2DListAccessor)(self.wrapped.QuadraticResistanceCoefficientTimeProfile) if self.wrapped.QuadraticResistanceCoefficientTimeProfile is not None else None

    @quadratic_resistance_coefficient_time_profile.setter
    def quadratic_resistance_coefficient_time_profile(self, value: '_1336.Vector2DListAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def linear_resistance_coefficient_time_profile(self) -> '_1336.Vector2DListAccessor':
        '''Vector2DListAccessor: 'LinearResistanceCoefficientTimeProfile' is the original name of this property.'''

        return constructor.new(_1336.Vector2DListAccessor)(self.wrapped.LinearResistanceCoefficientTimeProfile) if self.wrapped.LinearResistanceCoefficientTimeProfile is not None else None

    @linear_resistance_coefficient_time_profile.setter
    def linear_resistance_coefficient_time_profile(self, value: '_1336.Vector2DListAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def constant_resistance_coefficient_time_profile(self) -> '_1336.Vector2DListAccessor':
        '''Vector2DListAccessor: 'ConstantResistanceCoefficientTimeProfile' is the original name of this property.'''

        return constructor.new(_1336.Vector2DListAccessor)(self.wrapped.ConstantResistanceCoefficientTimeProfile) if self.wrapped.ConstantResistanceCoefficientTimeProfile is not None else None

    @constant_resistance_coefficient_time_profile.setter
    def constant_resistance_coefficient_time_profile(self, value: '_1336.Vector2DListAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def drag_torque_vs_speed_and_time(self) -> '_1368.GriddedSurfaceAccessor':
        '''GriddedSurfaceAccessor: 'DragTorqueVsSpeedAndTime' is the original name of this property.'''

        return constructor.new(_1368.GriddedSurfaceAccessor)(self.wrapped.DragTorqueVsSpeedAndTime) if self.wrapped.DragTorqueVsSpeedAndTime is not None else None

    @drag_torque_vs_speed_and_time.setter
    def drag_torque_vs_speed_and_time(self, value: '_1368.GriddedSurfaceAccessor'):
        value = value.wrapped if value else None
        self.wrapped.DragTorqueVsSpeedAndTime = value

    @property
    def drag_torque_specification_method(self) -> '_1964.PowerLoadDragTorqueSpecificationMethod':
        ...
        return constructor.new(_1964.PowerLoadDragTorqueSpecificationMethod)(value) if value is not None else None

    @drag_torque_specification_method.setter
    def drag_torque_specification_method(self, value: '_1964.PowerLoadDragTorqueSpecificationMethod'):
    ...
    @property
    def wheel_slip_model(self) -> '_5244.WheelSlipType':
        ...
        return constructor.new(_5244.WheelSlipType)(value) if value is not None else None

    @wheel_slip_model.setter
    def wheel_slip_model(self, value: '_5244.WheelSlipType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def speed_vs_time(self) -> '_1336.Vector2DListAccessor':
        '''Vector2DListAccessor: 'SpeedVsTime' is the original name of this property.'''

        return constructor.new(_1336.Vector2DListAccessor)(self.wrapped.SpeedVsTime) if self.wrapped.SpeedVsTime is not None else None

    @speed_vs_time.setter
    def speed_vs_time(self, value: '_1336.Vector2DListAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def target_speed_input_type(self) -> '_1966.PowerLoadPIDControlSpeedInputType':
        ...
        return constructor.new(_1966.PowerLoadPIDControlSpeedInputType)(value) if value is not None else None

    @target_speed_input_type.setter
    def target_speed_input_type(self, value: '_1966.PowerLoadPIDControlSpeedInputType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def target_speed_vs_time(self) -> '_1336.Vector2DListAccessor':
        '''Vector2DListAccessor: 'TargetSpeedVsTime' is the original name of this property.'''

        return constructor.new(_1336.Vector2DListAccessor)(self.wrapped.TargetSpeedVsTime) if self.wrapped.TargetSpeedVsTime is not None else None

    @target_speed_vs_time.setter
    def target_speed_vs_time(self, value: '_1336.Vector2DListAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def engine_idle_speed_control_pid_settings(self) -> '_1376.PIDControlSettings':
        ...
        return constructor.new(_1376.PIDControlSettings)(self.wrapped.EngineIdleSpeedControlPIDSettings) if self.wrapped.EngineIdleSpeedControlPIDSettings is not None else None
    ...
    def coefficient_of_friction_with_ground(self) -> '_93.NonDimensionalInputComponent':
        ...
        return constructor.new(_93.NonDimensionalInputComponent)(self.wrapped.CoefficientOfFrictionWithGround) if self.wrapped.CoefficientOfFrictionWithGround is not None else None

    @property
    def pid_control_settings(self) -> '_1376.PIDControlSettings':
        ...
        return constructor.new(_1376.PIDControlSettings)(self.wrapped.PIDControlSettings) if self.wrapped.PIDControlSettings is not None else None

    def get_harmonic_load_data_for_import(self) -> '_6590.ElectricMachineHarmonicLoadData':
