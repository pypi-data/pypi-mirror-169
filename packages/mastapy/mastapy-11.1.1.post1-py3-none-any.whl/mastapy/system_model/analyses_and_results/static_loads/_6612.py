...
from mastapy.system_model.analyses_and_results.static_loads import _6611, _6616
...
class GearSetHarmonicLoadData(_6616.HarmonicLoadDataBase):
    '''GearSetHarmonicLoadData
    ...
    @property
    def gear_mesh_te_order_type(self) -> '_6611.GearMeshTEOrderType':
        ...
        return constructor.new(_6611.GearMeshTEOrderType)(value) if value is not None else None

    @gear_mesh_te_order_type.setter
    def gear_mesh_te_order_type(self, value: '_6611.GearMeshTEOrderType'):
