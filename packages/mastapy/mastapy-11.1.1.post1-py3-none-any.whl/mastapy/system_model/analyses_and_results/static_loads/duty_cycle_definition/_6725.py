...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import _6726, _6720
...
class TorqueInputOptions(_6720.PowerLoadInputOptions):
    '''TorqueInputOptions
    ...
    @property
    def conversion_to_load_case(self) -> '_6726.TorqueValuesObtainedFrom':
        ...
        return constructor.new(_6726.TorqueValuesObtainedFrom)(value) if value is not None else None

    @conversion_to_load_case.setter
    def conversion_to_load_case(self, value: '_6726.TorqueValuesObtainedFrom'):
