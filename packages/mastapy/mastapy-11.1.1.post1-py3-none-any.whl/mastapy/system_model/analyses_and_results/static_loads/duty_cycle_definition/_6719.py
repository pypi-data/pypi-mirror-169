...
from mastapy.utility_gui import _1617
...
class PointLoadInputOptions(_1617.ColumnInputOptions):
    '''PointLoadInputOptions
    ...
    @axis.setter
    def axis(self, value: '_1293.Axis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.Axis = value

    @property
    def conversion_to_load_case(self) -> '_6710.AdditionalForcesObtainedFrom':
        ...
        return constructor.new(_6710.AdditionalForcesObtainedFrom)(value) if value is not None else None

    @conversion_to_load_case.setter
    def conversion_to_load_case(self, value: '_6710.AdditionalForcesObtainedFrom'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
