...
from mastapy.math_utility import _1305, _1315
...
class PointLoadHarmonicLoadData(_6674.SpeedDependentHarmonicLoadData):
    '''PointLoadHarmonicLoadData
    ...
    @property
    def degree_of_freedom(self) -> '_1305.DegreesOfFreedom':
        ...
        return constructor.new(_1305.DegreesOfFreedom)(value) if value is not None else None

    @degree_of_freedom.setter
    def degree_of_freedom(self, value: '_1305.DegreesOfFreedom'):
