...
from mastapy.system_model.analyses_and_results.static_loads import _6704, _6705, _6613
...
class WormGearSetLoadCase(_6613.GearSetLoadCase):
    '''WormGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6704.WormGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6704.WormGearLoadCase))
        return value

    @property
    def worm_gears_load_case(self) -> 'List[_6704.WormGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsLoadCase, constructor.new(_6704.WormGearLoadCase))
        return value

    @property
    def worm_meshes_load_case(self) -> 'List[_6705.WormGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesLoadCase, constructor.new(_6705.WormGearMeshLoadCase))
        return value
