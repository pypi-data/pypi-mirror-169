...
from mastapy.bolts import _1286, _1267
...
class BoltMaterial(_1267.BoltedJointMaterial):
    '''BoltMaterial
    ...
    @property
    def strength_grade(self) -> '_1286.StrengthGrades':
        ...
        return constructor.new(_1286.StrengthGrades)(value) if value is not None else None

    @strength_grade.setter
    def strength_grade(self, value: '_1286.StrengthGrades'):
