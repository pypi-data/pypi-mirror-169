...
from mastapy.math_utility.optimisation import _1357, _1355
...
class ParetoOptimistaionVariable(_1355.ParetoOptimisationVariableBase):
    '''ParetoOptimistaionVariable
    ...
    @property
    def property_target_for_dominant_candidate_search(self) -> '_1357.PropertyTargetForDominantCandidateSearch':
        ...
        return constructor.new(_1357.PropertyTargetForDominantCandidateSearch)(value) if value is not None else None

    @property_target_for_dominant_candidate_search.setter
    def property_target_for_dominant_candidate_search(self, value: '_1357.PropertyTargetForDominantCandidateSearch'):
