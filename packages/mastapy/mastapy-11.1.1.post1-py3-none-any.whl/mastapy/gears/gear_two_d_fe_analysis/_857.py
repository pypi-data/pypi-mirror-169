...
class CylindricalGearSetTIFFAnalysis(_1173.GearSetDesignAnalysis):
    '''CylindricalGearSetTIFFAnalysis
    ...
    @property
    def gears(self) -> 'List[_859.CylindricalGearTIFFAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_859.CylindricalGearTIFFAnalysis))
        return value
