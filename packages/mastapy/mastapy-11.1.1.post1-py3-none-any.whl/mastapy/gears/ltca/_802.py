...
from mastapy.gears.ltca import _803, _801
...
class GearMeshLoadDistributionAnalysis(_1170.GearMeshImplementationAnalysis):
    '''GearMeshLoadDistributionAnalysis
    ...
    @property
    def transmission_error_fourier_series(self) -> '_1315.FourierSeries':
        ...
        return constructor.new(_1315.FourierSeries)(self.wrapped.TransmissionErrorFourierSeries) if self.wrapped.TransmissionErrorFourierSeries is not None else None

    @property
    def moment_about_centre_fourier_series(self) -> '_1315.FourierSeries':
        ...
        return constructor.new(_1315.FourierSeries)(self.wrapped.MomentAboutCentreFourierSeries) if self.wrapped.MomentAboutCentreFourierSeries is not None else None

    @property
    def load_distribution_analyses_at_single_rotation(self) -> 'List[_803.GearMeshLoadDistributionAtRotation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadDistributionAnalysesAtSingleRotation, constructor.new(_803.GearMeshLoadDistributionAtRotation))
        return value

    def maximum_root_stress_with_flanks(self, gear: '_801.GearLoadDistributionAnalysis', flank: '_293.GearFlanks', stress_type: '_83.StressResultsType') -> 'float':
    ...
    def maximum_root_stress(self, gear: '_801.GearLoadDistributionAnalysis', stress_type: '_83.StressResultsType') -> 'float':
        ''' 'MaximumRootStress' is the original name of this method.
