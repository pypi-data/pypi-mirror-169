...
from mastapy.gears.ltca.conical import _830
...
class ConicalMeshLoadDistributionAnalysis(_802.GearMeshLoadDistributionAnalysis):
    '''ConicalMeshLoadDistributionAnalysis
    ...
    @property
    def conical_mesh_load_case(self) -> '_848.ConicalMeshLoadCase':
        ...
        if _848.ConicalMeshLoadCase.TYPE not in self.wrapped.ConicalMeshLoadCase.__class__.__mro__:
    ...
    @property
    def conical_mesh_manufacturing_analysis(self) -> '_745.ConicalMeshManufacturingAnalysis':
        ...
        return constructor.new(_745.ConicalMeshManufacturingAnalysis)(self.wrapped.ConicalMeshManufacturingAnalysis) if self.wrapped.ConicalMeshManufacturingAnalysis is not None else None

    @property
    def meshed_gears(self) -> 'List[_830.ConicalMeshedGearLoadDistributionAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_830.ConicalMeshedGearLoadDistributionAnalysis))
        return value
