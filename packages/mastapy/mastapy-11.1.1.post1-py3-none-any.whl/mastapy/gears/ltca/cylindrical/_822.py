...
class CylindricalMeshLoadDistributionAtRotation(_803.GearMeshLoadDistributionAtRotation):
    '''CylindricalMeshLoadDistributionAtRotation
    ...
    @property
    def mesh_alignment(self) -> '_1070.MeshAlignment':
        ...
        return constructor.new(_1070.MeshAlignment)(self.wrapped.MeshAlignment) if self.wrapped.MeshAlignment is not None else None

    @property
    def loaded_contact_lines(self) -> 'List[_819.CylindricalGearMeshLoadedContactLine]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadedContactLines, constructor.new(_819.CylindricalGearMeshLoadedContactLine))
        return value
