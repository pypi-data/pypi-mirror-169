...
from mastapy.gears.rating.cylindrical.iso6336 import _488
...
class CylindricalGearMeshLoadedContactPoint(_805.GearMeshLoadedContactPoint):
    '''CylindricalGearMeshLoadedContactPoint
    ...
    def is_tip_contact_point(self) -> 'bool':
        ...
        return self.wrapped.IsTipContactPoint
    ...
    def is_gear_a_tip_contact_point(self) -> 'bool':
        ...
        return self.wrapped.IsGearATipContactPoint
    ...
    def is_gear_b_tip_contact_point(self) -> 'bool':
        ...
        return self.wrapped.IsGearBTipContactPoint
    ...
    @property
    def gear_a_profile_measurement(self) -> '_982.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_982.CylindricalGearProfileMeasurement)(self.wrapped.GearAProfileMeasurement) if self.wrapped.GearAProfileMeasurement is not None else None

    @property
    def gear_b_profile_measurement(self) -> '_982.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_982.CylindricalGearProfileMeasurement)(self.wrapped.GearBProfileMeasurement) if self.wrapped.GearBProfileMeasurement is not None else None

    @property
    def tooth_flank_fracture_analysis_gear_a(self) -> '_488.ToothFlankFractureAnalysisContactPointMethodA':
        ...
        return constructor.new(_488.ToothFlankFractureAnalysisContactPointMethodA)(self.wrapped.ToothFlankFractureAnalysisGearA) if self.wrapped.ToothFlankFractureAnalysisGearA is not None else None

    @property
    def tooth_flank_fracture_analysis_gear_b(self) -> '_488.ToothFlankFractureAnalysisContactPointMethodA':
        ...
        return constructor.new(_488.ToothFlankFractureAnalysisContactPointMethodA)(self.wrapped.ToothFlankFractureAnalysisGearB) if self.wrapped.ToothFlankFractureAnalysisGearB is not None else None
