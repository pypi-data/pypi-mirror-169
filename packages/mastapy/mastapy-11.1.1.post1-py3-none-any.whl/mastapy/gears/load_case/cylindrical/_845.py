...
from mastapy.gears import _291, _290
...
class CylindricalMeshLoadCase(_836.MeshLoadCase):
    '''CylindricalMeshLoadCase
    ...
    @property
    def misalignment_source(self) -> '_291.CylindricalMisalignmentDataSource':
        ...
        return constructor.new(_291.CylindricalMisalignmentDataSource)(value) if value is not None else None

    @misalignment_source.setter
    def misalignment_source(self, value: '_291.CylindricalMisalignmentDataSource'):
    ...
    @property
    def load_case_modifiable_settings(self) -> '_1015.LTCALoadCaseModifiableSettings':
        ...
        return constructor.new(_1015.LTCALoadCaseModifiableSettings)(self.wrapped.LoadCaseModifiableSettings) if self.wrapped.LoadCaseModifiableSettings is not None else None
