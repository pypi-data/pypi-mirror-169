...
from mastapy.math_utility.optimisation import _1351, _1342, _1348
...
class DesignSpaceSearchBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    @property
    def remove_candidates_with(self) -> '_876.LargerOrSmaller':
        ...
        return constructor.new(_876.LargerOrSmaller)(value) if value is not None else None

    @remove_candidates_with.setter
    def remove_candidates_with(self, value: '_876.LargerOrSmaller'):
    ...
    @property
    def selected_design_space_search_strategy(self) -> '_1351.ParetoOptimisationStrategy':
        ...
        return constructor.new(_1351.ParetoOptimisationStrategy)(self.wrapped.SelectedDesignSpaceSearchStrategy) if self.wrapped.SelectedDesignSpaceSearchStrategy is not None else None

    @property
    def optimisation_targets(self) -> 'List[_883.OptimisationTarget[TAnalysis]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.OptimisationTargets, constructor.new(_883.OptimisationTarget)[TAnalysis])
        return value

    @property
    def input_setters(self) -> 'List[_1342.InputSetter[TAnalysis]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InputSetters, constructor.new(_1342.InputSetter)[TAnalysis])
        return value

    @property
    def table_filters(self) -> 'List[_901.TableFilter[TAnalysis, TCandidate]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TableFilters, constructor.new(_901.TableFilter)[TAnalysis, TCandidate])
        return value
    ...
    @property
    def chart_details(self) -> 'List[_865.ChartInfoBase[TAnalysis, TCandidate]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ChartDetails, constructor.new(_865.ChartInfoBase)[TAnalysis, TCandidate])
        return value
    ...
    @property
    def reasons_for_invalid_candidates(self) -> 'List[_898.ReasonsForInvalidDesigns]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ReasonsForInvalidCandidates, constructor.new(_898.ReasonsForInvalidDesigns))
        return value

    @property
    def filters(self) -> 'List[_1348.ParetoOptimisationFilter]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Filters, constructor.new(_1348.ParetoOptimisationFilter))
        return value
