...
from mastapy.gears.gear_set_pareto_optimiser import _867, _878
...
class MicroGeometryDesignSpaceSearch(_867.DesignSpaceSearchBase['_821.CylindricalGearSetLoadDistributionAnalysis', '_878.MicroGeometryDesignSpaceSearchCandidate']):
    '''MicroGeometryDesignSpaceSearch
    ...
    @property
    def load_case_duty_cycle(self) -> '_821.CylindricalGearSetLoadDistributionAnalysis':
        ...
        if _821.CylindricalGearSetLoadDistributionAnalysis.TYPE not in self.wrapped.LoadCaseDutyCycle.__class__.__mro__:
    ...
    @property
    def selected_candidate_micro_geometry(self) -> '_1059.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_1059.CylindricalGearSetMicroGeometry)(self.wrapped.SelectedCandidateMicroGeometry) if self.wrapped.SelectedCandidateMicroGeometry is not None else None

    @property
    def candidate_gear_sets(self) -> 'List[_1059.CylindricalGearSetMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateGearSets, constructor.new(_1059.CylindricalGearSetMicroGeometry))
        return value

    @property
    def all_candidate_gear_sets(self) -> 'List[_1059.CylindricalGearSetMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateGearSets, constructor.new(_1059.CylindricalGearSetMicroGeometry))
        return value
