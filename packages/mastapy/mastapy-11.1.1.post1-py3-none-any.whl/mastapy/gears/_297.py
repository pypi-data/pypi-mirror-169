...
class GearSetOptimisationResult(_0.APIBase):
    ...
    @property
    def gear_set(self) -> '_908.GearSetDesign':
        ...
        if _908.GearSetDesign.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_worm_gear_set_design(self) -> '_917.WormGearSetDesign':
        ...
        if _917.WormGearSetDesign.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_face_gear_set_design(self) -> '_953.FaceGearSetDesign':
        ...
        if _953.FaceGearSetDesign.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_cylindrical_gear_set_design(self) -> '_985.CylindricalGearSetDesign':
        ...
        if _985.CylindricalGearSetDesign.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_cylindrical_planetary_gear_set_design(self) -> '_996.CylindricalPlanetaryGearSetDesign':
        ...
        if _996.CylindricalPlanetaryGearSetDesign.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_conical_gear_set_design(self) -> '_1105.ConicalGearSetDesign':
    ...
    @property
    def gear_set_of_type_concept_gear_set_design(self) -> '_1127.ConceptGearSetDesign':
        ...
        if _1127.ConceptGearSetDesign.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def rating(self) -> '_322.AbstractGearSetRating':
        ...
        if _322.AbstractGearSetRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def rating_of_type_gear_set_duty_cycle_rating(self) -> '_329.GearSetDutyCycleRating':
        ...
        if _329.GearSetDutyCycleRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def rating_of_type_gear_set_rating(self) -> '_330.GearSetRating':
    ...
    @property
    def rating_of_type_worm_gear_set_duty_cycle_rating(self) -> '_342.WormGearSetDutyCycleRating':
        ...
        if _342.WormGearSetDutyCycleRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def rating_of_type_face_gear_set_duty_cycle_rating(self) -> '_416.FaceGearSetDutyCycleRating':
        ...
        if _416.FaceGearSetDutyCycleRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def rating_of_type_cylindrical_gear_set_duty_cycle_rating(self) -> '_428.CylindricalGearSetDutyCycleRating':
        ...
        if _428.CylindricalGearSetDutyCycleRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def rating_of_type_conical_gear_set_duty_cycle_rating(self) -> '_502.ConicalGearSetDutyCycleRating':
        ...
        if _502.ConicalGearSetDutyCycleRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def rating_of_type_concept_gear_set_duty_cycle_rating(self) -> '_513.ConceptGearSetDutyCycleRating':
        ...
        if _513.ConceptGearSetDutyCycleRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def optimisation_history(self) -> '_1345.OptimisationHistory':
        '''OptimisationHistory: 'OptimisationHistory' is the original name of this property.'''

        return constructor.new(_1345.OptimisationHistory)(self.wrapped.OptimisationHistory) if self.wrapped.OptimisationHistory is not None else None

    @optimisation_history.setter
    def optimisation_history(self, value: '_1345.OptimisationHistory'):
