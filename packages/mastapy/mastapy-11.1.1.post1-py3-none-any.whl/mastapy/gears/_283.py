...
class BevelHypoidGearDesignSettings(_1390.PerMachineSettings):
    '''BevelHypoidGearDesignSettings
    ...
    @property
    def quality_grade_type(self) -> '_311.QualityGradeTypes':
    ...
    def quality_grade_type(self, value: '_311.QualityGradeTypes'):
