...
class PlungeShaverCalculationInputs(_0.APIBase):
    ...
    @property
    def shaver_hand(self) -> '_300.Hand':
    ...
    @shaver_hand.setter
    def shaver_hand(self, value: '_300.Hand'):
    ...
    @property
    def input_gear_geometry(self) -> '_693.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_693.CylindricalCutterSimulatableGear)(self.wrapped.InputGearGeometry) if self.wrapped.InputGearGeometry is not None else None
