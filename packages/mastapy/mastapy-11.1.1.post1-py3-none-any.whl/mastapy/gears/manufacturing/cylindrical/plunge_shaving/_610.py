...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _617, _603
...
class PlungeShaverGeneration(_0.APIBase):
    ...
    @property
    def calculated_conjugate_face_width(self) -> '_1290.Range':
        ...
        if _1290.Range.TYPE not in self.wrapped.CalculatedConjugateFaceWidth.__class__.__mro__:
    ...
    @property
    def crossed_axis_calculation_details(self) -> '_962.CrossedAxisCylindricalGearPairLineContact':
        ...
        return constructor.new(_962.CrossedAxisCylindricalGearPairLineContact)(self.wrapped.CrossedAxisCalculationDetails) if self.wrapped.CrossedAxisCalculationDetails is not None else None

    @property
    def points_of_interest_on_the_shaver(self) -> 'List[_617.ShaverPointOfInterest]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PointsOfInterestOnTheShaver, constructor.new(_617.ShaverPointOfInterest))
        return value

    @property
    def calculation_errors(self) -> 'List[_603.CalculationError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CalculationErrors, constructor.new(_603.CalculationError))
        return value
