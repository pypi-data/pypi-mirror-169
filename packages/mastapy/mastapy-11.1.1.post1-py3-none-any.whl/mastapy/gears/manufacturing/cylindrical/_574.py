...
from mastapy.gears.manufacturing.cylindrical import _595, _596
...
class CylindricalGearSpecifiedMicroGeometry(_0.APIBase):
    ...
    @property
    def lead_micro_geometry(self) -> '_595.MicroGeometryInputsLead':
        ...
        return constructor.new(_595.MicroGeometryInputsLead)(self.wrapped.LeadMicroGeometry) if self.wrapped.LeadMicroGeometry is not None else None

    @property
    def profile_micro_geometry(self) -> 'List[_596.MicroGeometryInputsProfile]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ProfileMicroGeometry, constructor.new(_596.MicroGeometryInputsProfile))
        return value
