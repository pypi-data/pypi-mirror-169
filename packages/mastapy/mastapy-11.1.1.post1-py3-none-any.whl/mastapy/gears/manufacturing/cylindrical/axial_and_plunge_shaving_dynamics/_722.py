...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _726
...
class RedressingSettings(_0.APIBase, Generic[T]):
    ...
    @property
    def redressed_shaver(self) -> '_676.CylindricalGearShaver':
        ...
        if _676.CylindricalGearShaver.TYPE not in self.wrapped.RedressedShaver.__class__.__mro__:
