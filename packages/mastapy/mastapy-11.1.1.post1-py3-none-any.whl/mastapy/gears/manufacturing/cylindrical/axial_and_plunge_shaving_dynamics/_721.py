...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _717, _731, _716
...
class PlungeShavingDynamicsViewModel(_731.ShavingDynamicsViewModel['_716.PlungeShaverDynamics']):
    '''PlungeShavingDynamicsViewModel
    ...
    @property
    def settings(self) -> '_717.PlungeShaverDynamicSettings':
        ...
        return constructor.new(_717.PlungeShaverDynamicSettings)(self.wrapped.Settings) if self.wrapped.Settings is not None else None
