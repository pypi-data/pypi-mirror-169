...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _623, _655
...
class WormGrindingProcessProfileCalculation(_655.WormGrindingProcessCalculation):
    '''WormGrindingProcessProfileCalculation
