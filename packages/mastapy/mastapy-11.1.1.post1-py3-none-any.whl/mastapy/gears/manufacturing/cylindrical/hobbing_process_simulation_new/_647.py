...
T = TypeVar('T', bound='_646.ProcessSimulationInput')
...
class ProcessSimulationNew(_0.APIBase, Generic[T]):
    ...
    @property
    def lead_calculation(self) -> '_643.ProcessLeadCalculation':
        ...
        return constructor.new(_643.ProcessLeadCalculation)(self.wrapped.LeadCalculation) if self.wrapped.LeadCalculation is not None else None

    @property
    def profile_calculation(self) -> '_645.ProcessProfileCalculation':
        ...
        return constructor.new(_645.ProcessProfileCalculation)(self.wrapped.ProfileCalculation) if self.wrapped.ProfileCalculation is not None else None

    @property
    def pitch_calculation(self) -> '_644.ProcessPitchCalculation':
        ...
        return constructor.new(_644.ProcessPitchCalculation)(self.wrapped.PitchCalculation) if self.wrapped.PitchCalculation is not None else None

    @property
    def gear_tooth_shape_calculation(self) -> '_642.ProcessGearShape':
        ...
        return constructor.new(_642.ProcessGearShape)(self.wrapped.GearToothShapeCalculation) if self.wrapped.GearToothShapeCalculation is not None else None

    @property
    def total_modification_calculation(self) -> '_649.ProcessTotalModificationCalculation':
        ...
        return constructor.new(_649.ProcessTotalModificationCalculation)(self.wrapped.TotalModificationCalculation) if self.wrapped.TotalModificationCalculation is not None else None
