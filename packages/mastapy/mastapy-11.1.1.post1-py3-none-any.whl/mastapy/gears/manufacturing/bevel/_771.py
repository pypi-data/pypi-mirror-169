...
from mastapy.gears.manufacturing.bevel import _749
...
class PinionRoughMachineSetting(_0.APIBase):
    ...
    @property
    def pinion_config(self) -> '_749.ConicalPinionManufacturingConfig':
        ...
        return constructor.new(_749.ConicalPinionManufacturingConfig)(self.wrapped.PinionConfig) if self.wrapped.PinionConfig is not None else None

    @property
    def gear_set(self) -> '_1105.ConicalGearSetDesign':
        ...
        if _1105.ConicalGearSetDesign.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_zerol_bevel_gear_set_design(self) -> '_912.ZerolBevelGearSetDesign':
        ...
        if _912.ZerolBevelGearSetDesign.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_straight_bevel_gear_set_design(self) -> '_921.StraightBevelGearSetDesign':
        ...
        if _921.StraightBevelGearSetDesign.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_straight_bevel_diff_gear_set_design(self) -> '_925.StraightBevelDiffGearSetDesign':
        ...
        if _925.StraightBevelDiffGearSetDesign.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_spiral_bevel_gear_set_design(self) -> '_929.SpiralBevelGearSetDesign':
        ...
        if _929.SpiralBevelGearSetDesign.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_set_design(self) -> '_933.KlingelnbergCycloPalloidSpiralBevelGearSetDesign':
        ...
        if _933.KlingelnbergCycloPalloidSpiralBevelGearSetDesign.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_klingelnberg_cyclo_palloid_hypoid_gear_set_design(self) -> '_937.KlingelnbergCycloPalloidHypoidGearSetDesign':
        ...
        if _937.KlingelnbergCycloPalloidHypoidGearSetDesign.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_klingelnberg_conical_gear_set_design(self) -> '_941.KlingelnbergConicalGearSetDesign':
        ...
        if _941.KlingelnbergConicalGearSetDesign.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_hypoid_gear_set_design(self) -> '_945.HypoidGearSetDesign':
        ...
        if _945.HypoidGearSetDesign.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_bevel_gear_set_design(self) -> '_1131.BevelGearSetDesign':
        ...
        if _1131.BevelGearSetDesign.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_agma_gleason_conical_gear_set_design(self) -> '_1144.AGMAGleasonConicalGearSetDesign':
        ...
        if _1144.AGMAGleasonConicalGearSetDesign.TYPE not in self.wrapped.GearSet.__class__.__mro__:
