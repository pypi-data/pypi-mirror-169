...
from mastapy.gears.manufacturing.bevel.basic_machine_settings import _782
...
class BasicConicalGearMachineSettingsGenerated(_782.BasicConicalGearMachineSettings):
    '''BasicConicalGearMachineSettingsGenerated
