...
class ConicalSetMicroGeometryConfigBase(_1178.GearSetImplementationDetail):
    '''ConicalSetMicroGeometryConfigBase
    ...
    @property
    def deflection_from_bending_option(self) -> '_292.DeflectionFromBendingOption':
        ...
        return constructor.new(_292.DeflectionFromBendingOption)(value) if value is not None else None

    @deflection_from_bending_option.setter
    def deflection_from_bending_option(self, value: '_292.DeflectionFromBendingOption'):
