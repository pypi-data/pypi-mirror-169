...
from mastapy.gears.gear_designs.conical import _1107, _1106
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy._internal import enum_with_selected_value_runtime, conversion, constructor
from mastapy.gears.manufacturing.bevel import _737, _746, _754
...
class ConicalSetManufacturingConfig(_754.ConicalSetMicroGeometryConfigBase):
    '''ConicalSetManufacturingConfig
    ...
    @property
    def gear_manufacturing_configurations(self) -> 'List[_737.ConicalGearManufacturingConfig]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearManufacturingConfigurations, constructor.new(_737.ConicalGearManufacturingConfig))
        return value

    @property
    def meshes(self) -> 'List[_746.ConicalMeshManufacturingConfig]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_746.ConicalMeshManufacturingConfig))
        return value
