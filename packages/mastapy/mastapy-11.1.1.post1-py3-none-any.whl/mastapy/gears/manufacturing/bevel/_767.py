...
from mastapy.gears.gear_designs.conical import _1120
...
class PinionFinishMachineSettings(_287.ConicalGearToothSurface):
    '''PinionFinishMachineSettings
    ...
    @property
    def toprem_letter(self) -> '_1120.TopremLetter':
