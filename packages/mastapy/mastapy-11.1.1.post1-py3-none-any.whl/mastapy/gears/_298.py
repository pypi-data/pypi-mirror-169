...
class GearSetOptimisationResults(_0.APIBase):
    ...
    @property
    def results(self) -> 'List[_297.GearSetOptimisationResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Results, constructor.new(_297.GearSetOptimisationResult))
        return value
