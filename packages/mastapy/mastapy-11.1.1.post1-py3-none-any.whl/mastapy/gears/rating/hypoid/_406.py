...
class HypoidGearRating(_527.AGMAGleasonConicalGearRating):
    '''HypoidGearRating
    ...
    @property
    def hypoid_gear(self) -> '_943.HypoidGearDesign':
        ...
        return constructor.new(_943.HypoidGearDesign)(self.wrapped.HypoidGear) if self.wrapped.HypoidGear is not None else None
