...
class KlingelnbergCycloPalloidHypoidGearRating(_379.KlingelnbergCycloPalloidConicalGearRating):
    '''KlingelnbergCycloPalloidHypoidGearRating
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear(self) -> '_935.KlingelnbergCycloPalloidHypoidGearDesign':
        ...
        return constructor.new(_935.KlingelnbergCycloPalloidHypoidGearDesign)(self.wrapped.KlingelnbergCycloPalloidHypoidGear) if self.wrapped.KlingelnbergCycloPalloidHypoidGear is not None else None
