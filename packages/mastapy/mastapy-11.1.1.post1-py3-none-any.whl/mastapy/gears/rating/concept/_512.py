...
class ConceptGearRating(_328.GearRating):
    '''ConceptGearRating
    ...
    @property
    def concept_gear(self) -> '_1125.ConceptGearDesign':
        ...
        return constructor.new(_1125.ConceptGearDesign)(self.wrapped.ConceptGear) if self.wrapped.ConceptGear is not None else None
