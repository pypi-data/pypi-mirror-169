...
class WormGearSetRating(_330.GearSetRating):
    '''WormGearSetRating
    ...
    @property
    def worm_mesh_ratings(self) -> 'List[_340.WormGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshRatings, constructor.new(_340.WormGearMeshRating))
        return value
