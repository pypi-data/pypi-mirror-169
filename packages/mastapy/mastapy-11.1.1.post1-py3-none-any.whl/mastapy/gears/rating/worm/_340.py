...
class WormGearMeshRating(_327.GearMeshRating):
    '''WormGearMeshRating
    ...
    @property
    def worm_gear_mesh(self) -> '_916.WormGearMeshDesign':
        ...
        return constructor.new(_916.WormGearMeshDesign)(self.wrapped.WormGearMesh) if self.wrapped.WormGearMesh is not None else None
