...
class CylindricalGearSingleFlankRating(_331.GearSingleFlankRating):
    '''CylindricalGearSingleFlankRating
    ...
    @property
    def metal_plastic(self) -> '_244.MetalPlasticType':
        ...
        return constructor.new(_244.MetalPlasticType)(value) if value is not None else None
    ...
    @property
    def geometry_data_source_for_rating(self) -> '_425.CylindricalGearRatingGeometryDataSource':
        ...
        return constructor.new(_425.CylindricalGearRatingGeometryDataSource)(value) if value is not None else None
