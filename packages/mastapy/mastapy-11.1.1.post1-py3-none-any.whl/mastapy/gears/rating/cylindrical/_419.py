...
class CylindricalGearDutyCycleRating(_325.GearDutyCycleRating):
    '''CylindricalGearDutyCycleRating
    ...
    @property
    def gear_set_design_duty_cycle(self) -> '_428.CylindricalGearSetDutyCycleRating':
        ...
        return constructor.new(_428.CylindricalGearSetDutyCycleRating)(self.wrapped.GearSetDesignDutyCycle) if self.wrapped.GearSetDesignDutyCycle is not None else None

    @property
    def cylindrical_gear_set_design_duty_cycle(self) -> '_428.CylindricalGearSetDutyCycleRating':
        ...
        return constructor.new(_428.CylindricalGearSetDutyCycleRating)(self.wrapped.CylindricalGearSetDesignDutyCycle) if self.wrapped.CylindricalGearSetDesignDutyCycle is not None else None
    ...
    @property
    def cylindrical_gear_mesh_ratings(self) -> 'List[_438.MeshRatingForReports]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearMeshRatings, constructor.new(_438.MeshRatingForReports))
        return value
