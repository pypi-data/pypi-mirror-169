...
from mastapy.gears.gear_designs.cylindrical import _984, _1028
...
class AGMA2101MeshSingleFlankRating(_432.CylindricalMeshSingleFlankRating):
    '''AGMA2101MeshSingleFlankRating
    ...
    @property
    def scuffing_temperature_method(self) -> '_1028.ScuffingTemperatureMethodsAGMA':
        ...
        return constructor.new(_1028.ScuffingTemperatureMethodsAGMA)(value) if value is not None else None
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_496.AGMA2101GearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_496.AGMA2101GearSingleFlankRating))
        return value

    @property
    def agma_cylindrical_gear_single_flank_ratings(self) -> 'List[_496.AGMA2101GearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AGMACylindricalGearSingleFlankRatings, constructor.new(_496.AGMA2101GearSingleFlankRating))
        return value
