...
from mastapy.gears.gear_designs.cylindrical import _1027, _1026
from mastapy.materials import _238
from mastapy.gears.rating.cylindrical import _427, _426, _430
...
class CylindricalMeshSingleFlankRating(_333.MeshSingleFlankRating):
    '''CylindricalMeshSingleFlankRating
    ...
    @property
    def contact_ratio_source(self) -> '_288.ContactRatioDataSource':
        ...
        return constructor.new(_288.ContactRatioDataSource)(value) if value is not None else None
    ...
    @property
    def coefficient_of_friction_method_flash_temperature_method(self) -> '_1027.ScuffingCoefficientOfFrictionMethods':
        ...
        return constructor.new(_1027.ScuffingCoefficientOfFrictionMethods)(value) if value is not None else None
    ...
    @property
    def lubrication_detail(self) -> '_238.LubricationDetail':
        ...
        return constructor.new(_238.LubricationDetail)(self.wrapped.LubricationDetail) if self.wrapped.LubricationDetail is not None else None

    @property
    def sorted_scuffing_results(self) -> '_427.CylindricalGearScuffingResults':
        ...
        return constructor.new(_427.CylindricalGearScuffingResults)(self.wrapped.SortedScuffingResults) if self.wrapped.SortedScuffingResults is not None else None

    @property
    def sorted_scuffing_results_without_special_values(self) -> '_427.CylindricalGearScuffingResults':
        ...
        return constructor.new(_427.CylindricalGearScuffingResults)(self.wrapped.SortedScuffingResultsWithoutSpecialValues) if self.wrapped.SortedScuffingResultsWithoutSpecialValues is not None else None

    @property
    def rating_settings(self) -> '_426.CylindricalGearRatingSettings':
        ...
        return constructor.new(_426.CylindricalGearRatingSettings)(self.wrapped.RatingSettings) if self.wrapped.RatingSettings is not None else None
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_430.CylindricalGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_430.CylindricalGearSingleFlankRating))
        return value
