...
class CylindricalGearRatingSettings(_1390.PerMachineSettings):
    '''CylindricalGearRatingSettings
    ...
    @property
    def tip_relief_in_scuffing_calculation(self) -> '_448.TipReliefScuffingOptions':
        ...
        return constructor.new(_448.TipReliefScuffingOptions)(value) if value is not None else None

    @tip_relief_in_scuffing_calculation.setter
    def tip_relief_in_scuffing_calculation(self, value: '_448.TipReliefScuffingOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TipReliefInScuffingCalculation = value

    @property
    def dynamic_factor_method(self) -> '_435.DynamicFactorMethods':
        ...
        return constructor.new(_435.DynamicFactorMethods)(value) if value is not None else None

    @dynamic_factor_method.setter
    def dynamic_factor_method(self, value: '_435.DynamicFactorMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def gear_blank_factor_calculation_option(self) -> '_436.GearBlankFactorCalculationOptions':
        ...
        return constructor.new(_436.GearBlankFactorCalculationOptions)(value) if value is not None else None

    @gear_blank_factor_calculation_option.setter
    def gear_blank_factor_calculation_option(self, value: '_436.GearBlankFactorCalculationOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def film_thickness_equation_for_scuffing(self) -> '_445.ScuffingMethods':
        ...
        return constructor.new(_445.ScuffingMethods)(value) if value is not None else None

    @film_thickness_equation_for_scuffing.setter
    def film_thickness_equation_for_scuffing(self, value: '_445.ScuffingMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FilmThicknessEquationForScuffing = value

    @property
    def micropitting_rating_method(self) -> '_439.MicropittingRatingMethod':
        ...
        return constructor.new(_439.MicropittingRatingMethod)(value) if value is not None else None

    @micropitting_rating_method.setter
    def micropitting_rating_method(self, value: '_439.MicropittingRatingMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def permissible_bending_stress_method(self) -> '_442.RatingMethod':
        ...
        return constructor.new(_442.RatingMethod)(value) if value is not None else None

    @permissible_bending_stress_method.setter
    def permissible_bending_stress_method(self, value: '_442.RatingMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def chosen_tooth_thickness_for_bending_strength(self) -> '_449.ToothThicknesses':
        ...
        return constructor.new(_449.ToothThicknesses)(value) if value is not None else None

    @chosen_tooth_thickness_for_bending_strength.setter
    def chosen_tooth_thickness_for_bending_strength(self, value: '_449.ToothThicknesses'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
