...
from mastapy.gears.rating.cylindrical import _426, _422, _424
from mastapy.gears.rating.cylindrical.optimisation import _463
...
class CylindricalGearSetRating(_330.GearSetRating):
    '''CylindricalGearSetRating
    ...
    @property
    def optimisations(self) -> '_463.CylindricalGearSetRatingOptimisationHelper':
        ...
        return constructor.new(_463.CylindricalGearSetRatingOptimisationHelper)(self.wrapped.Optimisations) if self.wrapped.Optimisations is not None else None
    ...
    @property
    def vdi_cylindrical_gear_single_flank_ratings(self) -> 'List[_451.VDI2737InternalGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.VDICylindricalGearSingleFlankRatings, constructor.new(_451.VDI2737InternalGearSingleFlankRating))
        return value

    @property
    def cylindrical_mesh_ratings(self) -> 'List[_422.CylindricalGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshRatings, constructor.new(_422.CylindricalGearMeshRating))
        return value

    @property
    def gear_ratings(self) -> 'List[_424.CylindricalGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_424.CylindricalGearRating))
        return value
