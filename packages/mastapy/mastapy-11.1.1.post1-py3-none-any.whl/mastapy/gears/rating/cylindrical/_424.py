...
from mastapy.gears.rating.cylindrical import _420, _421, _450
...
class CylindricalGearRating(_328.GearRating):
    '''CylindricalGearRating
    ...
    @property
    def vdi2737_safety_factor(self) -> '_450.VDI2737SafetyFactorReportingObject':
        ...
        return constructor.new(_450.VDI2737SafetyFactorReportingObject)(self.wrapped.VDI2737SafetyFactor) if self.wrapped.VDI2737SafetyFactor is not None else None
