...
class ISO6336AbstractMetalMeshSingleFlankRating(_480.ISO6336AbstractMeshSingleFlankRating):
    '''ISO6336AbstractMetalMeshSingleFlankRating
    ...
    @property
    def scuffing_rating_method_flash_temperature_method(self) -> '_443.ScuffingFlashTemperatureRatingMethod':
        ...
        return constructor.new(_443.ScuffingFlashTemperatureRatingMethod)(value) if value is not None else None

    @property
    def scuffing_rating_method_integral_temperature_method(self) -> '_444.ScuffingIntegralTemperatureRatingMethod':
        ...
        return constructor.new(_444.ScuffingIntegralTemperatureRatingMethod)(value) if value is not None else None
    ...
    @property
    def scuffing_temperature_method(self) -> '_1029.ScuffingTemperatureMethodsISO':
        ...
        return constructor.new(_1029.ScuffingTemperatureMethodsISO)(value) if value is not None else None
    ...
    @property
    def sorted_micro_pitting_results(self) -> '_423.CylindricalGearMicroPittingResults':
        ...
        return constructor.new(_423.CylindricalGearMicroPittingResults)(self.wrapped.SortedMicroPittingResults) if self.wrapped.SortedMicroPittingResults is not None else None

    @property
    def single_flank_rating_of_test_gears_for_micropitting(self) -> '_476.ISO63362006MeshSingleFlankRating':
        ...
        if _476.ISO63362006MeshSingleFlankRating.TYPE not in self.wrapped.SingleFlankRatingOfTestGearsForMicropitting.__class__.__mro__:
    ...
    @property
    def isodin_cylindrical_gear_single_flank_ratings(self) -> 'List[_481.ISO6336AbstractMetalGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ISODINCylindricalGearSingleFlankRatings, constructor.new(_481.ISO6336AbstractMetalGearSingleFlankRating))
        return value
