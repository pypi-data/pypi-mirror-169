...
class ToothFlankFractureAnalysisPointN1457(_0.APIBase):
    ...
    @property
    def stress_analysis_with_maximum_equivalent_stress(self) -> '_493.ToothFlankFractureStressStepAtAnalysisPointN1457':
        ...
        return constructor.new(_493.ToothFlankFractureStressStepAtAnalysisPointN1457)(self.wrapped.StressAnalysisWithMaximumEquivalentStress) if self.wrapped.StressAnalysisWithMaximumEquivalentStress is not None else None

    @property
    def stress_history(self) -> 'List[_493.ToothFlankFractureStressStepAtAnalysisPointN1457]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StressHistory, constructor.new(_493.ToothFlankFractureStressStepAtAnalysisPointN1457))
        return value
