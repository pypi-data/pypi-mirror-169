...
class BevelGearDesign(_1142.AGMAGleasonConicalGearDesign):
    '''BevelGearDesign
    ...
    @property
    def finishing_method(self) -> '_1135.FinishingMethods':
        ...
        return constructor.new(_1135.FinishingMethods)(value) if value is not None else None

    @finishing_method.setter
    def finishing_method(self, value: '_1135.FinishingMethods'):
