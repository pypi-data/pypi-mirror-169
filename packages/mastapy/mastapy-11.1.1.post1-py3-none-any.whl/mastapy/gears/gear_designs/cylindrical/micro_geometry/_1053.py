...
class CylindricalGearMeshMicroGeometryDutyCycle(_1169.GearMeshDesignAnalysis):
    '''CylindricalGearMeshMicroGeometryDutyCycle
    ...
    @property
    def meshes_analysis(self) -> 'List[_818.CylindricalGearMeshLoadDistributionAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesAnalysis, constructor.new(_818.CylindricalGearMeshLoadDistributionAnalysis))
        return value
