...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1080, _1068, _1075
...
class CylindricalGearTriangularEndModificationAtOrientation(_0.APIBase):
    ...
    @property
    def linear(self) -> '_1080.SingleCylindricalGearTriangularEndModification':
        ...
        if _1080.SingleCylindricalGearTriangularEndModification.TYPE not in self.wrapped.Linear.__class__.__mro__:
    ...
    @property
    def linear_of_type_linear_cylindrical_gear_triangular_end_modification(self) -> '_1068.LinearCylindricalGearTriangularEndModification':
        ...
        if _1068.LinearCylindricalGearTriangularEndModification.TYPE not in self.wrapped.Linear.__class__.__mro__:
    ...
    @property
    def linear_of_type_parabolic_cylindrical_gear_triangular_end_modification(self) -> '_1075.ParabolicCylindricalGearTriangularEndModification':
        ...
        if _1075.ParabolicCylindricalGearTriangularEndModification.TYPE not in self.wrapped.Linear.__class__.__mro__:
    ...
    @property
    def parabolic(self) -> '_1080.SingleCylindricalGearTriangularEndModification':
        ...
        if _1080.SingleCylindricalGearTriangularEndModification.TYPE not in self.wrapped.Parabolic.__class__.__mro__:
    ...
    @property
    def parabolic_of_type_linear_cylindrical_gear_triangular_end_modification(self) -> '_1068.LinearCylindricalGearTriangularEndModification':
        ...
        if _1068.LinearCylindricalGearTriangularEndModification.TYPE not in self.wrapped.Parabolic.__class__.__mro__:
    ...
    @property
    def parabolic_of_type_parabolic_cylindrical_gear_triangular_end_modification(self) -> '_1075.ParabolicCylindricalGearTriangularEndModification':
        ...
        if _1075.ParabolicCylindricalGearTriangularEndModification.TYPE not in self.wrapped.Parabolic.__class__.__mro__:
