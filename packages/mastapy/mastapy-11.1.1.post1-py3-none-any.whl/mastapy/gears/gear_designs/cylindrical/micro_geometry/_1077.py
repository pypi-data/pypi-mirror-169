...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1079
...
class ProfileReliefWithDeviation(_1079.ReliefWithDeviation):
    '''ProfileReliefWithDeviation
    ...
    @property
    def position_on_profile(self) -> '_982.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_982.CylindricalGearProfileMeasurement)(self.wrapped.PositionOnProfile) if self.wrapped.PositionOnProfile is not None else None
