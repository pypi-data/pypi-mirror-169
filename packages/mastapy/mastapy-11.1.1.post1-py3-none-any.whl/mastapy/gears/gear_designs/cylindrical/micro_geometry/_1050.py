...
class CylindricalGearLeadModification(_533.LeadModification):
    '''CylindricalGearLeadModification
    ...
    @property
    def lead_modification_chart(self) -> '_1629.TwoDChartDefinition':
        ...
        if _1629.TwoDChartDefinition.TYPE not in self.wrapped.LeadModificationChart.__class__.__mro__:
