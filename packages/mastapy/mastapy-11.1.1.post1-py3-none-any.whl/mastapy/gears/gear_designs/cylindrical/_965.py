...
class CylindricalGearAbstractRackFlank(_0.APIBase):
    ...
    @property
    def cutter(self) -> '_964.CylindricalGearAbstractRack':
        ...
        if _964.CylindricalGearAbstractRack.TYPE not in self.wrapped.Cutter.__class__.__mro__:
    ...
    @property
    def cutter_of_type_cylindrical_gear_basic_rack(self) -> '_966.CylindricalGearBasicRack':
        ...
        if _966.CylindricalGearBasicRack.TYPE not in self.wrapped.Cutter.__class__.__mro__:
    ...
    @property
    def cutter_of_type_cylindrical_gear_pinion_type_cutter(self) -> '_980.CylindricalGearPinionTypeCutter':
        ...
        if _980.CylindricalGearPinionTypeCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
    ...
    @property
    def cutter_of_type_standard_rack(self) -> '_1032.StandardRack':
        ...
        if _1032.StandardRack.TYPE not in self.wrapped.Cutter.__class__.__mro__:
