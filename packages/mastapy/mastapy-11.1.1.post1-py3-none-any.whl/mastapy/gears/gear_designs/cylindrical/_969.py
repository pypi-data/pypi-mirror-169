...
class CylindricalGearDefaults(_1390.PerMachineSettings):
    '''CylindricalGearDefaults
    ...
    @property
    def finish_stock_type(self) -> '_1045.FinishStockType':
    ...
    def finish_stock_type(self, value: '_1045.FinishStockType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FinishStockType = value

    @property
    def system_of_fits_defaults(self) -> '_1090.DIN3967SystemOfGearFits':
        ...
        return constructor.new(_1090.DIN3967SystemOfGearFits)(self.wrapped.SystemOfFitsDefaults) if self.wrapped.SystemOfFitsDefaults is not None else None

    @property
    def rough_cutter_creation_settings(self) -> '_683.RoughCutterCreationSettings':
        ...
        return constructor.new(_683.RoughCutterCreationSettings)(self.wrapped.RoughCutterCreationSettings) if self.wrapped.RoughCutterCreationSettings is not None else None
