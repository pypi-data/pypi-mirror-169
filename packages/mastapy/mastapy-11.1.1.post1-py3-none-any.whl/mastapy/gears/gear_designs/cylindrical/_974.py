...
class CylindricalGearDesignConstraintSettings(_1390.PerMachineSettings):
    '''CylindricalGearDesignConstraintSettings
    ...
    @property
    def cylindrical_gear_design_constraints(self) -> '_972.CylindricalGearDesignConstraints':
        ...
        return constructor.new(_972.CylindricalGearDesignConstraints)(self.wrapped.CylindricalGearDesignConstraints) if self.wrapped.CylindricalGearDesignConstraints is not None else None
