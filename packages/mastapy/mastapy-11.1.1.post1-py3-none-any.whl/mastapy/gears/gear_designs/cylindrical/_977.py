...
from mastapy.gears.gear_designs.cylindrical import (
    _984, _1043, _985, _996,
    _978, _957, _970, _993,
    _997
)
from mastapy._internal.implicit import enum_with_selected_value, overridable
from mastapy.gears import _302, _285
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy._internal.cast_exception import CastException
from mastapy.math_utility.measured_ranges import _1367
...
class CylindricalGearMeshDesign(_907.GearMeshDesign):
    '''CylindricalGearMeshDesign
    ...
    @property
    def profile_modification(self) -> '_984.CylindricalGearProfileModifications':
        ...
        return constructor.new(_984.CylindricalGearProfileModifications)(value) if value is not None else None

    @profile_modification.setter
    def profile_modification(self, value: '_984.CylindricalGearProfileModifications'):
    ...
    @property
    def type_of_mechanism_housing(self) -> '_1043.TypeOfMechanismHousing':
        ...
        return constructor.new(_1043.TypeOfMechanismHousing)(value) if value is not None else None

    @type_of_mechanism_housing.setter
    def type_of_mechanism_housing(self, value: '_1043.TypeOfMechanismHousing'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    def gear_mesh_drawing(self) -> 'Image':
        ...
        value = conversion.pn_to_mp_smt_bitmap(self.wrapped.GearMeshDrawing)
        return value

    @property
    def centre_distance_change_method(self) -> '_285.CentreDistanceChangeMethod':
        ...
        return constructor.new(_285.CentreDistanceChangeMethod)(value) if value is not None else None

    @centre_distance_change_method.setter
    def centre_distance_change_method(self, value: '_285.CentreDistanceChangeMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def left_flank(self) -> '_978.CylindricalGearMeshFlankDesign':
        ...
        return constructor.new(_978.CylindricalGearMeshFlankDesign)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank is not None else None

    @property
    def right_flank(self) -> '_978.CylindricalGearMeshFlankDesign':
        ...
        return constructor.new(_978.CylindricalGearMeshFlankDesign)(self.wrapped.RightFlank) if self.wrapped.RightFlank is not None else None

    @property
    def backlash_specification(self) -> '_957.BacklashSpecification':
        ...
        return constructor.new(_957.BacklashSpecification)(self.wrapped.BacklashSpecification) if self.wrapped.BacklashSpecification is not None else None

    @property
    def valid_normal_module_range(self) -> '_1367.ShortLengthRange':
        ...
        return constructor.new(_1367.ShortLengthRange)(self.wrapped.ValidNormalModuleRange) if self.wrapped.ValidNormalModuleRange is not None else None
    ...
    @property
    def cylindrical_meshed_gear(self) -> 'List[_993.CylindricalMeshedGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshedGear, constructor.new(_993.CylindricalMeshedGear))
        return value

    @property
    def flanks(self) -> 'List[_978.CylindricalGearMeshFlankDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Flanks, constructor.new(_978.CylindricalGearMeshFlankDesign))
        return value

    @property
    def gear_a(self) -> '_970.CylindricalGearDesign':
    ...
    @property
    def gear_b(self) -> '_970.CylindricalGearDesign':
    ...
    @property
    def both_flanks(self) -> '_978.CylindricalGearMeshFlankDesign':
        ...
        return constructor.new(_978.CylindricalGearMeshFlankDesign)(self.wrapped.BothFlanks) if self.wrapped.BothFlanks is not None else None
