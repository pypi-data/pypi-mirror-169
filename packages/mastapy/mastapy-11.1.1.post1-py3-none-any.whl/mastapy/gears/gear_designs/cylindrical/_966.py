...
class CylindricalGearBasicRack(_964.CylindricalGearAbstractRack):
    '''CylindricalGearBasicRack
    ...
    @property
    def basic_rack_profile(self) -> '_958.BasicRackProfiles':
        ...
        return constructor.new(_958.BasicRackProfiles)(value) if value is not None else None

    @basic_rack_profile.setter
    def basic_rack_profile(self, value: '_958.BasicRackProfiles'):
    ...
    @property
    def proportional_method_for_tip_clearance(self) -> '_1037.TipAlterationCoefficientMethod':
        ...
        return constructor.new(_1037.TipAlterationCoefficientMethod)(value) if value is not None else None

    @proportional_method_for_tip_clearance.setter
    def proportional_method_for_tip_clearance(self, value: '_1037.TipAlterationCoefficientMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def pinion_type_cutter_for_rating(self) -> '_980.CylindricalGearPinionTypeCutter':
        ...
        return constructor.new(_980.CylindricalGearPinionTypeCutter)(self.wrapped.PinionTypeCutterForRating) if self.wrapped.PinionTypeCutterForRating is not None else None
