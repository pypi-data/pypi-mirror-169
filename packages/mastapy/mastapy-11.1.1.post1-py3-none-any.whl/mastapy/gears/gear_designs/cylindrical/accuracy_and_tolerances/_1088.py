...
from mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances import _1087
...
class CylindricalAccuracyGraderWithProfileFormAndSlope(_1087.CylindricalAccuracyGrader):
    '''CylindricalAccuracyGraderWithProfileFormAndSlope
