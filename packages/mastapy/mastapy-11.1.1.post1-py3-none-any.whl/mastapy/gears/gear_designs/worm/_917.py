...
from mastapy.gears.gear_designs.worm import _915, _916
...
class WormGearSetDesign(_908.GearSetDesign):
    '''WormGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_915.WormGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_915.WormGearDesign))
        return value

    @property
    def worm_gears(self) -> 'List[_915.WormGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGears, constructor.new(_915.WormGearDesign))
        return value

    @property
    def worm_meshes(self) -> 'List[_916.WormGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshes, constructor.new(_916.WormGearMeshDesign))
        return value
