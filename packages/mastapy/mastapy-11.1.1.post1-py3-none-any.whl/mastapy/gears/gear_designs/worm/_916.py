...
class WormGearMeshDesign(_907.GearMeshDesign):
    '''WormGearMeshDesign
    ...
    @property
    def worm_gear_set(self) -> '_917.WormGearSetDesign':
        ...
        return constructor.new(_917.WormGearSetDesign)(self.wrapped.WormGearSet) if self.wrapped.WormGearSet is not None else None

    @property
    def worm(self) -> '_914.WormDesign':
        ...
        return constructor.new(_914.WormDesign)(self.wrapped.Worm) if self.wrapped.Worm is not None else None

    @property
    def wheel(self) -> '_918.WormWheelDesign':
        ...
        return constructor.new(_918.WormWheelDesign)(self.wrapped.Wheel) if self.wrapped.Wheel is not None else None
