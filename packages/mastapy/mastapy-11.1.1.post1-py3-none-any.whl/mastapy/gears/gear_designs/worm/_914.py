...
class WormDesign(_915.WormGearDesign):
    '''WormDesign
    ...
    @property
    def addendum_factor(self) -> '_317.WormAddendumFactor':
        ...
        return constructor.new(_317.WormAddendumFactor)(value) if value is not None else None

    @addendum_factor.setter
    def addendum_factor(self, value: '_317.WormAddendumFactor'):
