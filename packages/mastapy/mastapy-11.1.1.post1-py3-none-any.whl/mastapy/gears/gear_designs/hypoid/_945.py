...
from mastapy.gears.gear_designs.hypoid import _943, _944
...
class HypoidGearSetDesign(_1144.AGMAGleasonConicalGearSetDesign):
    '''HypoidGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_943.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_943.HypoidGearDesign))
        return value

    @property
    def hypoid_gears(self) -> 'List[_943.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGears, constructor.new(_943.HypoidGearDesign))
        return value

    @property
    def meshes(self) -> 'List[_944.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_944.HypoidGearMeshDesign))
        return value

    @property
    def hypoid_meshes(self) -> 'List[_944.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshes, constructor.new(_944.HypoidGearMeshDesign))
        return value
