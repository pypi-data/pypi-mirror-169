...
from mastapy.gears.materials import _562
...
class KlingelnbergConicalGearDesign(_1103.ConicalGearDesign):
    '''KlingelnbergConicalGearDesign
    ...
    @property
    def klingelnberg_cyclo_palloid_gear_material(self) -> '_562.KlingelnbergCycloPalloidConicalGearMaterial':
        ...
        return constructor.new(_562.KlingelnbergCycloPalloidConicalGearMaterial)(self.wrapped.KlingelnbergCycloPalloidGearMaterial) if self.wrapped.KlingelnbergCycloPalloidGearMaterial is not None else None
