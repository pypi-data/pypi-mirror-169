...
class FaceGearSetDesign(_908.GearSetDesign):
    '''FaceGearSetDesign
    ...
    @property
    def pinion(self) -> '_952.FaceGearPinionDesign':
        ...
        return constructor.new(_952.FaceGearPinionDesign)(self.wrapped.Pinion) if self.wrapped.Pinion is not None else None

    @property
    def face_gear(self) -> '_955.FaceGearWheelDesign':
        ...
        return constructor.new(_955.FaceGearWheelDesign)(self.wrapped.FaceGear) if self.wrapped.FaceGear is not None else None

    @property
    def cylindrical_gear_set_micro_geometry(self) -> '_954.FaceGearSetMicroGeometry':
        ...
        return constructor.new(_954.FaceGearSetMicroGeometry)(self.wrapped.CylindricalGearSetMicroGeometry) if self.wrapped.CylindricalGearSetMicroGeometry is not None else None

    @property
    def gears(self) -> 'List[_947.FaceGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_947.FaceGearDesign))
        return value

    @property
    def face_gears(self) -> 'List[_947.FaceGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGears, constructor.new(_947.FaceGearDesign))
        return value

    @property
    def face_meshes(self) -> 'List[_949.FaceGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshes, constructor.new(_949.FaceGearMeshDesign))
        return value
