...
from mastapy.utility.modal_analysis.gears import _1572, _1576
...
class GearMeshForTE(_1576.OrderForTE):
    '''GearMeshForTE
    ...
    @property
    def attached_gears(self) -> 'List[_1572.GearOrderForTE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AttachedGears, constructor.new(_1572.GearOrderForTE))
        return value
