...
from mastapy.utility.report import _1544, _1547
...
TItem = TypeVar('TItem', bound='_1547.CustomReportPropertyItem')


class CustomReportMultiPropertyItem(_1544.CustomReportMultiPropertyItemBase, Generic[TItem]):
    '''CustomReportMultiPropertyItem
