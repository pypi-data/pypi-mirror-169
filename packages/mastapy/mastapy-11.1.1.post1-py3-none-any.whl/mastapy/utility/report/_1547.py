...
from mastapy.utility.report import _1558, _1557
from mastapy._internal import enum_with_selected_value_runtime, constructor, conversion
from mastapy.utility.reporting_property_framework import _1562
...
class CustomReportPropertyItem(_0.APIBase):
    ...
    @property
    def font_weight(self) -> '_1558.FontWeight':
        '''FontWeight: 'FontWeight' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.FontWeight)
        return constructor.new(_1558.FontWeight)(value) if value is not None else None

    @font_weight.setter
    def font_weight(self, value: '_1558.FontWeight'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FontWeight = value

    @property
    def font_style(self) -> '_1557.FontStyle':
        '''FontStyle: 'FontStyle' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.FontStyle)
        return constructor.new(_1557.FontStyle)(value) if value is not None else None

    @font_style.setter
    def font_style(self, value: '_1557.FontStyle'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FontStyle = value

    @property
    def horizontal_position(self) -> '_1562.CellValuePosition':
        ...
        return constructor.new(_1562.CellValuePosition)(value) if value is not None else None

    @horizontal_position.setter
    def horizontal_position(self, value: '_1562.CellValuePosition'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
