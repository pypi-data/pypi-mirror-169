...
from mastapy.utility.databases import _1600, _1597, _1596
...
TKey = TypeVar('TKey', bound='_1597.DatabaseKey')
TValue = TypeVar('TValue', bound='_0.APIBase')


class SQLDatabase(_1596.Database['TKey', 'TValue'], Generic[TKey, TValue]):
    '''SQLDatabase
    ...
    def save(self, item: '_1600.NamedDatabaseItem'):
    ...
    def delete(self, key: '_1597.DatabaseKey'):
