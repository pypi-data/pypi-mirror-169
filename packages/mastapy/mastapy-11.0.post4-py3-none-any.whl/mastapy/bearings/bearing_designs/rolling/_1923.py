...
class ThrustBallBearing(_1892.BallBearing):
    '''ThrustBallBearing
    ...
    @property
    def outer_ring_mounting(self) -> '_1649.OuterRingMounting':
        ...
        return constructor.new(_1649.OuterRingMounting)(value) if value is not None else None

    @outer_ring_mounting.setter
    def outer_ring_mounting(self, value: '_1649.OuterRingMounting'):
