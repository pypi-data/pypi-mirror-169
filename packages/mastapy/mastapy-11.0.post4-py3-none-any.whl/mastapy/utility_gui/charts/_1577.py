...
class CustomTableAndChart(_1515.CustomTable):
    '''CustomTableAndChart
    ...
    @property
    def primary_axis_range(self) -> '_1252.Range':
        ...
        if _1252.Range.TYPE not in self.wrapped.PrimaryAxisRange.__class__.__mro__:
