...
from mastapy.gears.gear_designs.concept import _1088, _1089
...
class ConceptGearSetDesign(_880.GearSetDesign):
    ...
    @property
    def gears(self) -> 'List[_1088.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_1088.ConceptGearDesign))
        return value

    @property
    def concept_gears(self) -> 'List[_1088.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGears, constructor.new(_1088.ConceptGearDesign))
        return value

    @property
    def concept_meshes(self) -> 'List[_1089.ConceptGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshes, constructor.new(_1089.ConceptGearMeshDesign))
        return value
