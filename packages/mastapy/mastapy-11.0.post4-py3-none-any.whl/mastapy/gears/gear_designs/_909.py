...
class SelectedDesignConstraintsCollection(_1390.PerMachineSettings):
    '''SelectedDesignConstraintsCollection
    ...
    @property
    def design_constraints(self) -> '_904.DesignConstraintsCollection':
        ...
        return constructor.new(_904.DesignConstraintsCollection)(self.wrapped.DesignConstraints) if self.wrapped.DesignConstraints is not None else None
