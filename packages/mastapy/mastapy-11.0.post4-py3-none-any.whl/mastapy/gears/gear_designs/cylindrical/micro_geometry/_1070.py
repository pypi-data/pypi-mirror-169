...
class MeshedCylindricalGearMicroGeometry(_0.APIBase):
    ...
    @property
    def flanks(self) -> 'List[_1069.MeshedCylindricalGearFlankMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Flanks, constructor.new(_1069.MeshedCylindricalGearFlankMicroGeometry))
        return value
