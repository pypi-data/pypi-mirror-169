...
class CylindricalGearShaperTangible(_684.CutterShapeDefinition):
    '''CylindricalGearShaperTangible
    ...
    @property
    def design(self) -> '_675.CylindricalGearShaper':
        ...
        return constructor.new(_675.CylindricalGearShaper)(self.wrapped.Design) if self.wrapped.Design is not None else None
