...
class FlexiblePinAnalysisManufactureLevel(_5917.FlexiblePinAnalysis):
    '''FlexiblePinAnalysisManufactureLevel
    ...
    @property
    def planetary_mesh_analysis(self) -> '_4006.CylindricalGearMeshParametricStudyTool':
        ...
        return constructor.new(_4006.CylindricalGearMeshParametricStudyTool)(self.wrapped.PlanetaryMeshAnalysis) if self.wrapped.PlanetaryMeshAnalysis else None
