...
class PointLoadInputOptions(_1573.ColumnInputOptions):
    '''PointLoadInputOptions
    ...
    @property
    def conversion_to_load_case(self) -> '_6638.AdditionalForcesObtainedFrom':
        ...
        return constructor.new(_6638.AdditionalForcesObtainedFrom)(value) if value else None

    @conversion_to_load_case.setter
    def conversion_to_load_case(self, value: '_6638.AdditionalForcesObtainedFrom'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
