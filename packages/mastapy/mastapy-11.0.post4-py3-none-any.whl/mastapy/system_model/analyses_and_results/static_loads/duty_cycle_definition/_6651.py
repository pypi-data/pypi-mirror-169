...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import (
    _6641, _6652, _6643, _6640,
    _6644, _6646, _6653, _6650,
    _6642, _6645, _6639
)
...
class TimeSeriesImporter(_0.APIBase):
    ...
    @property
    def import_type(self) -> '_6555.ImportType':
        '''ImportType: 'ImportType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ImportType)
        return constructor.new(_6555.ImportType)(value) if value else None

    @import_type.setter
    def import_type(self, value: '_6555.ImportType'):
    ...
    @property
    def time_step_input(self) -> '_6652.TimeStepInputOptions':
        ...
        return constructor.new(_6652.TimeStepInputOptions)(self.wrapped.TimeStepInput) if self.wrapped.TimeStepInput else None

    @property
    def gear_ratio_options(self) -> '_6643.GearRatioInputOptions':
        ...
        return constructor.new(_6643.GearRatioInputOptions)(self.wrapped.GearRatioOptions) if self.wrapped.GearRatioOptions else None

    @property
    def design_state_options(self) -> '_6640.DesignStateOptions':
        ...
        return constructor.new(_6640.DesignStateOptions)(self.wrapped.DesignStateOptions) if self.wrapped.DesignStateOptions else None

    @property
    def load_case_name_inputs(self) -> '_6644.LoadCaseNameOptions':
        ...
        return constructor.new(_6644.LoadCaseNameOptions)(self.wrapped.LoadCaseNameInputs) if self.wrapped.LoadCaseNameInputs else None

    @property
    def file_inputs(self) -> 'List[_6646.MultiTimeSeriesDataInputFileOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FileInputs, constructor.new(_6646.MultiTimeSeriesDataInputFileOptions))
        return value

    @property
    def torque_inputs(self) -> 'List[_6653.TorqueInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TorqueInputs, constructor.new(_6653.TorqueInputOptions))
        return value

    @property
    def speed_inputs(self) -> 'List[_6650.SpeedInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpeedInputs, constructor.new(_6650.SpeedInputOptions))
        return value

    @property
    def force_inputs(self) -> 'List[_6642.ForceInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceInputs, constructor.new(_6642.ForceInputOptions))
        return value

    @property
    def moment_inputs(self) -> 'List[_6645.MomentInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MomentInputs, constructor.new(_6645.MomentInputOptions))
        return value

    @property
    def boost_pressure_inputs(self) -> 'List[_6639.BoostPressureLoadCaseInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoostPressureInputs, constructor.new(_6639.BoostPressureLoadCaseInputOptions))
        return value

    @property
    def columns(self) -> 'List[_1547.ColumnTitle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Columns, constructor.new(_1547.ColumnTitle))
        return value
