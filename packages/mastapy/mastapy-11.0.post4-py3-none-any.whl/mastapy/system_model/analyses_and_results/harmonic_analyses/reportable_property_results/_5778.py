...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5772, _5777
...
class ResultsForOrderIncludingGroups(_5777.ResultsForOrder):
    '''ResultsForOrderIncludingGroups
    ...
    @property
    def groups(self) -> 'List[_5772.HarmonicAnalysisResultsBrokenDownByGroupsWithinAHarmonic]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Groups, constructor.new(_5772.HarmonicAnalysisResultsBrokenDownByGroupsWithinAHarmonic))
        return value
