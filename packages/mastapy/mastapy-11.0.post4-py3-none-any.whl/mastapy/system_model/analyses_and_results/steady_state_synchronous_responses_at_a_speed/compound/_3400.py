...
class ConceptCouplingHalfCompoundSteadyStateSynchronousResponseAtASpeed(_3411.CouplingHalfCompoundSteadyStateSynchronousResponseAtASpeed):
    '''ConceptCouplingHalfCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3269.ConceptCouplingHalfSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3269.ConceptCouplingHalfSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3269.ConceptCouplingHalfSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3269.ConceptCouplingHalfSteadyStateSynchronousResponseAtASpeed))
        return value
