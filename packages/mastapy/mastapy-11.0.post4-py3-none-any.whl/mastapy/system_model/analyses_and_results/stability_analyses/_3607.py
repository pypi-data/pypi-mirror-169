...
from mastapy.system_model.analyses_and_results.stability_analyses import _3608, _3606, _3515
...
class StraightBevelDiffGearSetStabilityAnalysis(_3515.BevelGearSetStabilityAnalysis):
    '''StraightBevelDiffGearSetStabilityAnalysis
    ...
    @property
    def straight_bevel_diff_gears_stability_analysis(self) -> 'List[_3608.StraightBevelDiffGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsStabilityAnalysis, constructor.new(_3608.StraightBevelDiffGearStabilityAnalysis))
        return value

    @property
    def straight_bevel_diff_meshes_stability_analysis(self) -> 'List[_3606.StraightBevelDiffGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesStabilityAnalysis, constructor.new(_3606.StraightBevelDiffGearMeshStabilityAnalysis))
        return value
