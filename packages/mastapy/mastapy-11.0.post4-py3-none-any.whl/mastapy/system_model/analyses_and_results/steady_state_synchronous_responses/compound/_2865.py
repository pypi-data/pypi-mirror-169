...
class BevelDifferentialGearCompoundSteadyStateSynchronousResponse(_2870.BevelGearCompoundSteadyStateSynchronousResponse):
    '''BevelDifferentialGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2734.BevelDifferentialGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2734.BevelDifferentialGearSteadyStateSynchronousResponse))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2734.BevelDifferentialGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2734.BevelDifferentialGearSteadyStateSynchronousResponse))
        return value
