...
class RollingRingConnectionSystemDeflection(_2502.InterMountableComponentConnectionSystemDeflection):
    '''RollingRingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3860.RollingRingConnectionPowerFlow':
        ...
        return constructor.new(_3860.RollingRingConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
