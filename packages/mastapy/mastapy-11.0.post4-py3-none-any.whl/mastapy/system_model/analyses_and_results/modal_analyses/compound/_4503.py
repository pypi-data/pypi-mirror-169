...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4483
...
class CycloidalDiscCentralBearingConnectionCompoundModalAnalysis(_4483.CoaxialConnectionCompoundModalAnalysis):
    '''CycloidalDiscCentralBearingConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4351.CycloidalDiscCentralBearingConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4351.CycloidalDiscCentralBearingConnectionModalAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4351.CycloidalDiscCentralBearingConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4351.CycloidalDiscCentralBearingConnectionModalAnalysis))
        return value
