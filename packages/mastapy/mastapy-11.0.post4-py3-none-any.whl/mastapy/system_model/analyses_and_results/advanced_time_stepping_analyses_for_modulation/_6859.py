...
class ZerolBevelGearMeshAdvancedTimeSteppingAnalysisForModulation(_6748.BevelGearMeshAdvancedTimeSteppingAnalysisForModulation):
    '''ZerolBevelGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2577.ZerolBevelGearMeshSystemDeflection':
        ...
        return constructor.new(_2577.ZerolBevelGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
