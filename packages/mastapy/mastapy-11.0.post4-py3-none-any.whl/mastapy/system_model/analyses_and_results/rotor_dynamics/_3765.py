...
from mastapy.utility.units_and_measurements.measurements import _1471
...
class ShaftModalComplexShape(_3763.ShaftComplexShape['_1471.Number', 'SMT.MastaAPI.Utility.UnitsAndMeasurements.Measurements.Number']):
    '''ShaftModalComplexShape
