...
class FlexiblePinAssemblyCompoundHarmonicAnalysisOfSingleExcitation(_5564.SpecialisedAssemblyCompoundHarmonicAnalysisOfSingleExcitation):
    '''FlexiblePinAssemblyCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5393.FlexiblePinAssemblyHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5393.FlexiblePinAssemblyHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_5393.FlexiblePinAssemblyHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5393.FlexiblePinAssemblyHarmonicAnalysisOfSingleExcitation))
        return value
