...
class PartToPartShearCouplingCompoundModalAnalysisAtASpeed(_4661.CouplingCompoundModalAnalysisAtASpeed):
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4577.PartToPartShearCouplingModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4577.PartToPartShearCouplingModalAnalysisAtASpeed))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4577.PartToPartShearCouplingModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4577.PartToPartShearCouplingModalAnalysisAtASpeed))
        return value
