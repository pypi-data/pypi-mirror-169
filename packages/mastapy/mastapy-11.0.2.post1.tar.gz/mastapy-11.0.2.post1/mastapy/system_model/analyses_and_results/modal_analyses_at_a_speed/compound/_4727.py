...
class SpringDamperConnectionCompoundModalAnalysisAtASpeed(_4662.CouplingConnectionCompoundModalAnalysisAtASpeed):
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4597.SpringDamperConnectionModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4597.SpringDamperConnectionModalAnalysisAtASpeed))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4597.SpringDamperConnectionModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4597.SpringDamperConnectionModalAnalysisAtASpeed))
        return value
