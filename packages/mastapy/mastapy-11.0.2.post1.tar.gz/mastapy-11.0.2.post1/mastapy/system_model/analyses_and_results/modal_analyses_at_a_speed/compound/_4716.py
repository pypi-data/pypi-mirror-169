...
class RollingRingCompoundModalAnalysisAtASpeed(_4663.CouplingHalfCompoundModalAnalysisAtASpeed):
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4588.RollingRingModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4588.RollingRingModalAnalysisAtASpeed))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4588.RollingRingModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4588.RollingRingModalAnalysisAtASpeed))
        return value
