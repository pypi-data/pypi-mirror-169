...
class CouplingCompoundModalAnalysisAtASpeed(_4722.SpecialisedAssemblyCompoundModalAnalysisAtASpeed):
    '''CouplingCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4534.CouplingModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4534.CouplingModalAnalysisAtASpeed))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4534.CouplingModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4534.CouplingModalAnalysisAtASpeed))
        return value
