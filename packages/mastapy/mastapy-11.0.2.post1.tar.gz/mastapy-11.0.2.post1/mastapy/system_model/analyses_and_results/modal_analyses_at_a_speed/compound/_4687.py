...
class HypoidGearMeshCompoundModalAnalysisAtASpeed(_4629.AGMAGleasonConicalGearMeshCompoundModalAnalysisAtASpeed):
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4557.HypoidGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4557.HypoidGearMeshModalAnalysisAtASpeed))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4557.HypoidGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4557.HypoidGearMeshModalAnalysisAtASpeed))
        return value
