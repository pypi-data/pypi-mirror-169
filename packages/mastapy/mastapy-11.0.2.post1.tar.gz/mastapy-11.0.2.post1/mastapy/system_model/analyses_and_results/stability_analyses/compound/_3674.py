...
class StraightBevelPlanetGearCompoundStabilityAnalysis(_3668.StraightBevelDiffGearCompoundStabilityAnalysis):
    '''StraightBevelPlanetGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3545.StraightBevelPlanetGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3545.StraightBevelPlanetGearStabilityAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3545.StraightBevelPlanetGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3545.StraightBevelPlanetGearStabilityAnalysis))
        return value
