...
from mastapy.system_model.analyses_and_results.stability_analyses import _2318, _3438
...
class RootAssemblyStabilityAnalysis(_3438.AssemblyStabilityAnalysis):
    '''RootAssemblyStabilityAnalysis
    ...
    @property
    def stability_analysis_inputs(self) -> '_2318.StabilityAnalysis':
        ...
        return constructor.new(_2318.StabilityAnalysis)(self.wrapped.StabilityAnalysisInputs) if self.wrapped.StabilityAnalysisInputs else None
