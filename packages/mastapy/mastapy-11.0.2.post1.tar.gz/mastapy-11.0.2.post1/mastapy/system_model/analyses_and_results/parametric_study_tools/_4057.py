...
class PartParametricStudyTool(_7190.PartAnalysisCase):
    '''PartParametricStudyTool
    ...
    @property
    def data_logger(self) -> '_1576.DataLoggerWithCharts':
        ...
        return constructor.new(_1576.DataLoggerWithCharts)(self.wrapped.DataLogger) if self.wrapped.DataLogger else None
