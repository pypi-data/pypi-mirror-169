...
from mastapy.system_model.analyses_and_results.static_loads import _6459, _6571
from mastapy.system_model import _1897
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4055, _4056
...
class ParametricStudyToolOptions(_0.APIBase):
    ...
    @property
    def parametric_study_type(self) -> '_6571.ParametricStudyType':
        ...
        return constructor.new(_6571.ParametricStudyType)(value) if value else None

    @parametric_study_type.setter
    def parametric_study_type(self, value: '_6571.ParametricStudyType'):
    ...
    @property
    def external_full_fe_loader(self) -> '_1897.ExternalFullFELoader':
        ...
        return constructor.new(_1897.ExternalFullFELoader)(self.wrapped.ExternalFullFELoader) if self.wrapped.ExternalFullFELoader else None

    @property
    def step_results(self) -> 'List[_4055.ParametricStudyToolStepResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StepResults, constructor.new(_4055.ParametricStudyToolStepResult))
        return value

    @property
    def study_variables(self) -> 'List[_4056.ParametricStudyVariable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StudyVariables, constructor.new(_4056.ParametricStudyVariable))
        return value
