...
from mastapy.system_model.analyses_and_results.static_loads import _6535, _6540
...
class GearSetHarmonicLoadData(_6540.HarmonicLoadDataBase):
    '''GearSetHarmonicLoadData
    ...
    @property
    def gear_mesh_te_order_type(self) -> '_6535.GearMeshTEOrderType':
        ...
        return constructor.new(_6535.GearMeshTEOrderType)(value) if value else None

    @gear_mesh_te_order_type.setter
    def gear_mesh_te_order_type(self, value: '_6535.GearMeshTEOrderType'):
