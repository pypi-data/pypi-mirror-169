...
from mastapy.system_model.fe import _2041, _2064
...
class FEPartLoadCase(_6450.AbstractShaftOrHousingLoadCase):
    '''FEPartLoadCase
    ...
    @property
    def angle_source(self) -> '_2041.AngleSource':
        ...
        return constructor.new(_2041.AngleSource)(value) if value else None
