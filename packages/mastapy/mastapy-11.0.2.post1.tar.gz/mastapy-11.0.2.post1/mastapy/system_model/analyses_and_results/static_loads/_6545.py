...
from mastapy.system_model.analyses_and_results.static_loads import _6548, _6544, _6522
...
class HarmonicLoadDataImportFromMotorPackages(_6544.HarmonicLoadDataImportBase['T'], Generic[T]):
    '''HarmonicLoadDataImportFromMotorPackages
