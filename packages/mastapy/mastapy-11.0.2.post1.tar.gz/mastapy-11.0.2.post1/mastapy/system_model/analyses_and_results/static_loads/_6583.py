...
from mastapy.system_model import _1902, _1903, _1904
from mastapy.system_model.analyses_and_results.mbd_analyses import _5174
from mastapy.system_model.analyses_and_results.static_loads import _6624, _6514, _6628
...
class PowerLoadLoadCase(_6628.VirtualComponentLoadCase):
    '''PowerLoadLoadCase
    ...
    @property
    def drag_torque_specification_method(self) -> '_1902.PowerLoadDragTorqueSpecificationMethod':
        ...
        return constructor.new(_1902.PowerLoadDragTorqueSpecificationMethod)(value) if value else None

    @drag_torque_specification_method.setter
    def drag_torque_specification_method(self, value: '_1902.PowerLoadDragTorqueSpecificationMethod'):
    ...
    @property
    def wheel_slip_model(self) -> '_5174.WheelSlipType':
        ...
        return constructor.new(_5174.WheelSlipType)(value) if value else None

    @wheel_slip_model.setter
    def wheel_slip_model(self, value: '_5174.WheelSlipType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def target_speed_input_type(self) -> '_1904.PowerLoadPIDControlSpeedInputType':
        ...
        return constructor.new(_1904.PowerLoadPIDControlSpeedInputType)(value) if value else None

    @target_speed_input_type.setter
    def target_speed_input_type(self, value: '_1904.PowerLoadPIDControlSpeedInputType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def engine_idle_speed_control_pid_settings(self) -> '_1337.PIDControlSettings':
        ...
        return constructor.new(_1337.PIDControlSettings)(self.wrapped.EngineIdleSpeedControlPIDSettings) if self.wrapped.EngineIdleSpeedControlPIDSettings else None

    @property
    def coefficient_of_friction_with_ground(self) -> '_90.NonDimensionalInputComponent':
        ...
        return constructor.new(_90.NonDimensionalInputComponent)(self.wrapped.CoefficientOfFrictionWithGround) if self.wrapped.CoefficientOfFrictionWithGround else None

    @property
    def pid_control_settings(self) -> '_1337.PIDControlSettings':
        ...
        return constructor.new(_1337.PIDControlSettings)(self.wrapped.PIDControlSettings) if self.wrapped.PIDControlSettings else None

    def get_harmonic_load_data_for_import(self) -> '_6514.ElectricMachineHarmonicLoadData':
