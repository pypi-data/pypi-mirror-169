...
from mastapy.system_model.analyses_and_results.load_case_groups import _5319, _5320, _5321
...
class StaticLoadCase(_6447.LoadCase):
    '''StaticLoadCase
    ...
    @property
    def planetary_rating_load_sharing_method(self) -> '_303.PlanetaryRatingLoadSharingOption':
    ...
    def planetary_rating_load_sharing_method(self, value: '_303.PlanetaryRatingLoadSharingOption'):
    ...
    @property
    def te_set_up_for_dynamic_analyses_options(self) -> '_2358.TESetUpForDynamicAnalysisOptions':
        ...
        return constructor.new(_2358.TESetUpForDynamicAnalysisOptions)(self.wrapped.TESetUpForDynamicAnalysesOptions) if self.wrapped.TESetUpForDynamicAnalysesOptions else None
    ...
    @property
    def harmonic_analysis_options_for_atsam(self) -> '_5679.HarmonicAnalysisOptions':
        ...
        if _5679.HarmonicAnalysisOptions.TYPE not in self.wrapped.HarmonicAnalysisOptionsForATSAM.__class__.__mro__:
    ...
    @property
    def clutch_engagements(self) -> 'List[_5319.ClutchEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ClutchEngagements, constructor.new(_5319.ClutchEngagementStatus))
        return value

    @property
    def concept_clutch_engagements(self) -> 'List[_5320.ConceptSynchroGearEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptClutchEngagements, constructor.new(_5320.ConceptSynchroGearEngagementStatus))
        return value
    ...
    def duplicate(self, new_design_state_group: '_5321.DesignState', name: Optional['str'] = 'None') -> 'StaticLoadCase':
