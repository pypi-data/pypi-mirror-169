...
from mastapy.system_model.analyses_and_results.static_loads import _6608, _6609, _6471
...
class StraightBevelGearSetLoadCase(_6471.BevelGearSetLoadCase):
    '''StraightBevelGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6608.StraightBevelGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6608.StraightBevelGearLoadCase))
        return value

    @property
    def straight_bevel_gears_load_case(self) -> 'List[_6608.StraightBevelGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsLoadCase, constructor.new(_6608.StraightBevelGearLoadCase))
        return value

    @property
    def straight_bevel_meshes_load_case(self) -> 'List[_6609.StraightBevelGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesLoadCase, constructor.new(_6609.StraightBevelGearMeshLoadCase))
        return value
