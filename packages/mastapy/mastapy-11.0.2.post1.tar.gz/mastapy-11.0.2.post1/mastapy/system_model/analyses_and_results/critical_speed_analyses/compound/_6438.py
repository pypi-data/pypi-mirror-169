...
class TorqueConverterTurbineCompoundCriticalSpeedAnalysis(_6357.CouplingHalfCompoundCriticalSpeedAnalysis):
    '''TorqueConverterTurbineCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6309.TorqueConverterTurbineCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6309.TorqueConverterTurbineCriticalSpeedAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6309.TorqueConverterTurbineCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6309.TorqueConverterTurbineCriticalSpeedAnalysis))
        return value
