...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6297, _6298, _6205
...
class StraightBevelGearSetCriticalSpeedAnalysis(_6205.BevelGearSetCriticalSpeedAnalysis):
    '''StraightBevelGearSetCriticalSpeedAnalysis
    ...
    @property
    def straight_bevel_gears_critical_speed_analysis(self) -> 'List[_6297.StraightBevelGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsCriticalSpeedAnalysis, constructor.new(_6297.StraightBevelGearCriticalSpeedAnalysis))
        return value

    @property
    def straight_bevel_meshes_critical_speed_analysis(self) -> 'List[_6298.StraightBevelGearMeshCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesCriticalSpeedAnalysis, constructor.new(_6298.StraightBevelGearMeshCriticalSpeedAnalysis))
        return value
