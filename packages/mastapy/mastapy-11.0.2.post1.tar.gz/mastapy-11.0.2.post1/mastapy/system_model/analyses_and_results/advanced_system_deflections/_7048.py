...
class ZerolBevelGearAdvancedSystemDeflection(_6934.BevelGearAdvancedSystemDeflection):
    '''ZerolBevelGearAdvancedSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_332.ZerolBevelGearRating':
        ...
        return constructor.new(_332.ZerolBevelGearRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def component_system_deflection_results(self) -> 'List[_2509.ZerolBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2509.ZerolBevelGearSystemDeflection))
        return value
