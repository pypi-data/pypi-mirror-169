...
class PulleyCompoundSteadyStateSynchronousResponse(_3341.CouplingHalfCompoundSteadyStateSynchronousResponse):
    '''PulleyCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3258.PulleySteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3258.PulleySteadyStateSynchronousResponse))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3258.PulleySteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3258.PulleySteadyStateSynchronousResponse))
        return value
