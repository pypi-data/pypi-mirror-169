...
class SpringDamperHalfSystemDeflection(_2400.CouplingHalfSystemDeflection):
    '''SpringDamperHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3804.SpringDamperHalfPowerFlow':
        ...
        return constructor.new(_3804.SpringDamperHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
