...
class MeasurementComponentSystemDeflection(_2503.VirtualComponentSystemDeflection):
    '''MeasurementComponentSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3775.MeasurementComponentPowerFlow':
        ...
        return constructor.new(_3775.MeasurementComponentPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
