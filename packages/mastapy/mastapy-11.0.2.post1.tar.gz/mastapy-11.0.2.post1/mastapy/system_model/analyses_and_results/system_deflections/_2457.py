...
class PlanetaryConnectionSystemDeflection(_2473.ShaftToMountableComponentConnectionSystemDeflection):
    '''PlanetaryConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3782.PlanetaryConnectionPowerFlow':
        ...
        return constructor.new(_3782.PlanetaryConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
