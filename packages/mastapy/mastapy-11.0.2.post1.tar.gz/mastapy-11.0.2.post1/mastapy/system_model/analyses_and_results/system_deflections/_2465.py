...
class RollingRingAssemblySystemDeflection(_2474.SpecialisedAssemblySystemDeflection):
    '''RollingRingAssemblySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3792.RollingRingAssemblyPowerFlow':
        ...
        return constructor.new(_3792.RollingRingAssemblyPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
