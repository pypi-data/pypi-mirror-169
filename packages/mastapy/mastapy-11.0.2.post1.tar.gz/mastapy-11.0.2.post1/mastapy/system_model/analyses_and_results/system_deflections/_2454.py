...
class PartToPartShearCouplingConnectionSystemDeflection(_2399.CouplingConnectionSystemDeflection):
    '''PartToPartShearCouplingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3779.PartToPartShearCouplingConnectionPowerFlow':
        ...
        return constructor.new(_3779.PartToPartShearCouplingConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
