...
class TorqueConverterPumpSystemDeflection(_2400.CouplingHalfSystemDeflection):
    '''TorqueConverterPumpSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3821.TorqueConverterPumpPowerFlow':
        ...
        return constructor.new(_3821.TorqueConverterPumpPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
