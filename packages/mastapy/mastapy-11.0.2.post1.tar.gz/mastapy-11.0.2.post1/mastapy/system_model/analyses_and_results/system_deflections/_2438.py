...
class KlingelnbergCycloPalloidConicalGearSystemDeflection(_2396.ConicalGearSystemDeflection):
    '''KlingelnbergCycloPalloidConicalGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3766.KlingelnbergCycloPalloidConicalGearPowerFlow':
