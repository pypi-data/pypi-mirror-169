...
class PartToPartShearCouplingHalfSystemDeflection(_2400.CouplingHalfSystemDeflection):
    '''PartToPartShearCouplingHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3780.PartToPartShearCouplingHalfPowerFlow':
        ...
        return constructor.new(_3780.PartToPartShearCouplingHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
