...
from mastapy.system_model.analyses_and_results.power_flows import _3807, _3812, _3813
...
class StraightBevelDiffGearSystemDeflection(_2378.BevelGearSystemDeflection):
    '''StraightBevelDiffGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3807.StraightBevelDiffGearPowerFlow':
    ...
    @property
    def component_detailed_analysis(self) -> '_358.StraightBevelDiffGearRating':
        ...
        return constructor.new(_358.StraightBevelDiffGearRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None
