...
class MassDiscSystemDeflection(_2503.VirtualComponentSystemDeflection):
    '''MassDiscSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3774.MassDiscPowerFlow':
        ...
        return constructor.new(_3774.MassDiscPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
