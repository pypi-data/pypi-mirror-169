...
class WormGearSystemDeflection(_2429.GearSystemDeflection):
    '''WormGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3826.WormGearPowerFlow':
        ...
        return constructor.new(_3826.WormGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
