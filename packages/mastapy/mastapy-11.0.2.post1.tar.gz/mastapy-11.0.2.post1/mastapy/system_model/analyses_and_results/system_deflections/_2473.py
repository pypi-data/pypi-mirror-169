...
class ShaftToMountableComponentConnectionSystemDeflection(_2363.AbstractShaftToMountableComponentConnectionSystemDeflection):
    '''ShaftToMountableComponentConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3798.ShaftToMountableComponentConnectionPowerFlow':
