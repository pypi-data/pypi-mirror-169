...
class RollingRingSystemDeflection(_2400.CouplingHalfSystemDeflection):
    '''RollingRingSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3794.RollingRingPowerFlow':
        ...
        return constructor.new(_3794.RollingRingPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
