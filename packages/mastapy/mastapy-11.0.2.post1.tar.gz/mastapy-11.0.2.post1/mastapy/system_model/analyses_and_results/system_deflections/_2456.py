...
from mastapy.system_model.analyses_and_results.system_deflections import _2454, _2401
...
class PartToPartShearCouplingSystemDeflection(_2401.CouplingSystemDeflection):
    '''PartToPartShearCouplingSystemDeflection
    ...
    @property
    def part_to_part_shear_coupling_connection(self) -> '_2454.PartToPartShearCouplingConnectionSystemDeflection':
        ...
        return constructor.new(_2454.PartToPartShearCouplingConnectionSystemDeflection)(self.wrapped.PartToPartShearCouplingConnection) if self.wrapped.PartToPartShearCouplingConnection else None
    ...
    @property
    def power_flow_results(self) -> '_3781.PartToPartShearCouplingPowerFlow':
        ...
        return constructor.new(_3781.PartToPartShearCouplingPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
