...
from mastapy.system_model.analyses_and_results.system_deflections import _2445, _2495
...
class SystemDeflection(_7189.FEAnalysis):
    '''SystemDeflection
    ...
    @property
    def overall_efficiency_results(self) -> '_2445.LoadCaseOverallEfficiencyResult':
        ...
        return constructor.new(_2445.LoadCaseOverallEfficiencyResult)(self.wrapped.OverallEfficiencyResults) if self.wrapped.OverallEfficiencyResults else None

    @property
    def analysis_options(self) -> '_2495.SystemDeflectionOptions':
        ...
        return constructor.new(_2495.SystemDeflectionOptions)(self.wrapped.AnalysisOptions) if self.wrapped.AnalysisOptions else None
