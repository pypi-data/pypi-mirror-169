...
from mastapy.system_model.analyses_and_results.system_deflections import _2477, _2475, _2377
...
class SpiralBevelGearSetSystemDeflection(_2377.BevelGearSetSystemDeflection):
    '''SpiralBevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3802.SpiralBevelGearSetPowerFlow':
        ...
        return constructor.new(_3802.SpiralBevelGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def spiral_bevel_gears_system_deflection(self) -> 'List[_2477.SpiralBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsSystemDeflection, constructor.new(_2477.SpiralBevelGearSystemDeflection))
        return value

    @property
    def spiral_bevel_meshes_system_deflection(self) -> 'List[_2475.SpiralBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesSystemDeflection, constructor.new(_2475.SpiralBevelGearMeshSystemDeflection))
        return value
