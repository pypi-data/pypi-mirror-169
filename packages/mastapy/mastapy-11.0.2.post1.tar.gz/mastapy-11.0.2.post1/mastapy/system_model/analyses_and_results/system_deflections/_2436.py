...
class KlingelnbergCycloPalloidConicalGearMeshSystemDeflection(_2394.ConicalGearMeshSystemDeflection):
    '''KlingelnbergCycloPalloidConicalGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3765.KlingelnbergCycloPalloidConicalGearMeshPowerFlow':
