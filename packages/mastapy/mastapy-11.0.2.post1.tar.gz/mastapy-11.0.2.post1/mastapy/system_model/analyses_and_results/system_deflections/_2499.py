...
class TorqueConverterTurbineSystemDeflection(_2400.CouplingHalfSystemDeflection):
    '''TorqueConverterTurbineSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3822.TorqueConverterTurbinePowerFlow':
        ...
        return constructor.new(_3822.TorqueConverterTurbinePowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
