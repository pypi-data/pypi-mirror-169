...
class StraightBevelSunGearSystemDeflection(_2483.StraightBevelDiffGearSystemDeflection):
    '''StraightBevelSunGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3813.StraightBevelSunGearPowerFlow':
        ...
        return constructor.new(_3813.StraightBevelSunGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
