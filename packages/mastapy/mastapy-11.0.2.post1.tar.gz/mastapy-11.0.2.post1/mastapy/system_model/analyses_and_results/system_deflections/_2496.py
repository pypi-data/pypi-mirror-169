...
class TorqueConverterConnectionSystemDeflection(_2399.CouplingConnectionSystemDeflection):
    '''TorqueConverterConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3819.TorqueConverterConnectionPowerFlow':
        ...
        return constructor.new(_3819.TorqueConverterConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
