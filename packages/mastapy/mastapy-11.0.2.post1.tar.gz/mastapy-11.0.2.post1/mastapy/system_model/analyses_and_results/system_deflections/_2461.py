...
from mastapy.system_model.analyses_and_results.power_flows import _3789, _3740
...
class PulleySystemDeflection(_2400.CouplingHalfSystemDeflection):
    '''PulleySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3789.PulleyPowerFlow':
