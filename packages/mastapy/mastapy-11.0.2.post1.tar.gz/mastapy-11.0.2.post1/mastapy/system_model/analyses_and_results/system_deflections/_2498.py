...
class TorqueConverterSystemDeflection(_2401.CouplingSystemDeflection):
    '''TorqueConverterSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3820.TorqueConverterPowerFlow':
        ...
        return constructor.new(_3820.TorqueConverterPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
