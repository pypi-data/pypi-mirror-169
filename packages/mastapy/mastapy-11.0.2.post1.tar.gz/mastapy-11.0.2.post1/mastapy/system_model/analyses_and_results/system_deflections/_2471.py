...
class ShaftSectionSystemDeflection(_124.Bar):
    '''ShaftSectionSystemDeflection
    ...
    @property
    def left_end(self) -> '_2470.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2470.ShaftSectionEndResultsSystemDeflection)(self.wrapped.LeftEnd) if self.wrapped.LeftEnd else None

    @property
    def right_end(self) -> '_2470.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2470.ShaftSectionEndResultsSystemDeflection)(self.wrapped.RightEnd) if self.wrapped.RightEnd else None
