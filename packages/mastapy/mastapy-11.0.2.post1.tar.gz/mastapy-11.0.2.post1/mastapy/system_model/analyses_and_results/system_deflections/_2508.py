...
from mastapy.system_model.analyses_and_results.system_deflections import _2509, _2507, _2377
...
class ZerolBevelGearSetSystemDeflection(_2377.BevelGearSetSystemDeflection):
    '''ZerolBevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3830.ZerolBevelGearSetPowerFlow':
        ...
        return constructor.new(_3830.ZerolBevelGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def zerol_bevel_gears_system_deflection(self) -> 'List[_2509.ZerolBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsSystemDeflection, constructor.new(_2509.ZerolBevelGearSystemDeflection))
        return value

    @property
    def zerol_bevel_meshes_system_deflection(self) -> 'List[_2507.ZerolBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesSystemDeflection, constructor.new(_2507.ZerolBevelGearMeshSystemDeflection))
        return value
