...
class SynchroniserCompoundPowerFlow(_3929.SpecialisedAssemblyCompoundPowerFlow):
    '''SynchroniserCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3816.SynchroniserPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3816.SynchroniserPowerFlow))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3816.SynchroniserPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3816.SynchroniserPowerFlow))
        return value
