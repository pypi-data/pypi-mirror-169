...
from mastapy.system_model.analyses_and_results.power_flows import _3810, _3809, _3716
...
class StraightBevelGearSetPowerFlow(_3716.BevelGearSetPowerFlow):
    '''StraightBevelGearSetPowerFlow
    ...
    @property
    def rating(self) -> '_363.StraightBevelGearSetRating':
        ...
        return constructor.new(_363.StraightBevelGearSetRating)(self.wrapped.Rating) if self.wrapped.Rating else None

    @property
    def component_detailed_analysis(self) -> '_363.StraightBevelGearSetRating':
        ...
        return constructor.new(_363.StraightBevelGearSetRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def gears_power_flow(self) -> 'List[_3810.StraightBevelGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsPowerFlow, constructor.new(_3810.StraightBevelGearPowerFlow))
        return value

    @property
    def straight_bevel_gears_power_flow(self) -> 'List[_3810.StraightBevelGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsPowerFlow, constructor.new(_3810.StraightBevelGearPowerFlow))
        return value

    @property
    def meshes_power_flow(self) -> 'List[_3809.StraightBevelGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesPowerFlow, constructor.new(_3809.StraightBevelGearMeshPowerFlow))
        return value

    @property
    def straight_bevel_meshes_power_flow(self) -> 'List[_3809.StraightBevelGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesPowerFlow, constructor.new(_3809.StraightBevelGearMeshPowerFlow))
        return value
