...
class TorqueConverterPumpCompoundPowerFlow(_3870.CouplingHalfCompoundPowerFlow):
    '''TorqueConverterPumpCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3821.TorqueConverterPumpPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3821.TorqueConverterPumpPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3821.TorqueConverterPumpPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3821.TorqueConverterPumpPowerFlow))
        return value
