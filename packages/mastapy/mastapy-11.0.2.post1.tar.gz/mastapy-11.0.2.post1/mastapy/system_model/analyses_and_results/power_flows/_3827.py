...
from mastapy.system_model.analyses_and_results.power_flows import _3826, _3825, _3759
...
class WormGearSetPowerFlow(_3759.GearSetPowerFlow):
    '''WormGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_3826.WormGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsPowerFlow, constructor.new(_3826.WormGearPowerFlow))
        return value

    @property
    def worm_gears_power_flow(self) -> 'List[_3826.WormGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsPowerFlow, constructor.new(_3826.WormGearPowerFlow))
        return value

    @property
    def meshes_power_flow(self) -> 'List[_3825.WormGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesPowerFlow, constructor.new(_3825.WormGearMeshPowerFlow))
        return value

    @property
    def worm_meshes_power_flow(self) -> 'List[_3825.WormGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesPowerFlow, constructor.new(_3825.WormGearMeshPowerFlow))
        return value
