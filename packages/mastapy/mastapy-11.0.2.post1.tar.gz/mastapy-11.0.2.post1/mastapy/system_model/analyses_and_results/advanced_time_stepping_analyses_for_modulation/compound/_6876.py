...
class RingPinsToDiscConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_6851.InterMountableComponentConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''RingPinsToDiscConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6747.RingPinsToDiscConnectionAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6747.RingPinsToDiscConnectionAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_6747.RingPinsToDiscConnectionAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6747.RingPinsToDiscConnectionAdvancedTimeSteppingAnalysisForModulation))
        return value
