...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5107, _5146, _5141
...
class MBDRunUpAnalysisOptions(_7181.AbstractAnalysisOptions['_6618.TimeSeriesLoadCase']):
    '''MBDRunUpAnalysisOptions
    ...
    @property
    def input_velocity_processing_type(self) -> '_5107.InputVelocityForRunUpProcessingType':
        ...
        return constructor.new(_5107.InputVelocityForRunUpProcessingType)(value) if value else None

    @input_velocity_processing_type.setter
    def input_velocity_processing_type(self, value: '_5107.InputVelocityForRunUpProcessingType'):
    ...
    @property
    def shape_of_initial_acceleration_period(self) -> '_5146.ShapeOfInitialAccelerationPeriodForRunUp':
        ...
        return constructor.new(_5146.ShapeOfInitialAccelerationPeriodForRunUp)(value) if value else None

    @shape_of_initial_acceleration_period.setter
    def shape_of_initial_acceleration_period(self, value: '_5146.ShapeOfInitialAccelerationPeriodForRunUp'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ShapeOfInitialAccelerationPeriod = value

    @property
    def run_up_driving_mode(self) -> '_5141.RunUpDrivingMode':
        ...
        return constructor.new(_5141.RunUpDrivingMode)(value) if value else None

    @run_up_driving_mode.setter
    def run_up_driving_mode(self, value: '_5141.RunUpDrivingMode'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
