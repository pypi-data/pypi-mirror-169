...
from mastapy.bearings.bearing_results.rolling import _1738, _1728
...
class LoadedSphericalRollerRadialBearingRow(_1728.LoadedRollerBearingRow):
    '''LoadedSphericalRollerRadialBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1738.LoadedSphericalRollerRadialBearingResults':
        ...
        return constructor.new(_1738.LoadedSphericalRollerRadialBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
