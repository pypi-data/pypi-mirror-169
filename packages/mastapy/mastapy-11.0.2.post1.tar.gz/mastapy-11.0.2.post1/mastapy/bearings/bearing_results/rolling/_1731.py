...
from mastapy.bearings.bearing_results.rolling.fitting import _1809, _1807, _1810
from mastapy.bearings.bearing_results.rolling import (
    _1675, _1772, _1672, _1759,
    _1732
)
from mastapy._internal.cast_exception import CastException
from mastapy.bearings.bearing_results.rolling.abma import _1813, _1811, _1812
from mastapy.bearings.bearing_results.rolling.iso_rating_results import (
    _1800, _1798, _1804, _1803,
    _1799, _1805, _1801
)
from mastapy.bearings.bearing_results.rolling.skf_module import _1795
...
class LoadedRollingBearingResults(_1658.LoadedDetailedBearingResults):
    '''LoadedRollingBearingResults
    ...
    @property
    def fluid_film_temperature_source(self) -> '_1593.FluidFilmTemperatureOptions':
        ...
        return constructor.new(_1593.FluidFilmTemperatureOptions)(value) if value else None
    ...
    @property
    def outer_ring_fitting_at_assembly(self) -> '_1809.OuterRingFittingThermalResults':
        ...
        return constructor.new(_1809.OuterRingFittingThermalResults)(self.wrapped.OuterRingFittingAtAssembly) if self.wrapped.OuterRingFittingAtAssembly else None

    @property
    def outer_ring_fitting_at_operating_conditions(self) -> '_1809.OuterRingFittingThermalResults':
        ...
        return constructor.new(_1809.OuterRingFittingThermalResults)(self.wrapped.OuterRingFittingAtOperatingConditions) if self.wrapped.OuterRingFittingAtOperatingConditions else None

    @property
    def inner_ring_fitting_at_assembly(self) -> '_1807.InnerRingFittingThermalResults':
        ...
        return constructor.new(_1807.InnerRingFittingThermalResults)(self.wrapped.InnerRingFittingAtAssembly) if self.wrapped.InnerRingFittingAtAssembly else None

    @property
    def inner_ring_fitting_at_operating_conditions(self) -> '_1807.InnerRingFittingThermalResults':
        ...
        return constructor.new(_1807.InnerRingFittingThermalResults)(self.wrapped.InnerRingFittingAtOperatingConditions) if self.wrapped.InnerRingFittingAtOperatingConditions else None

    @property
    def maximum_operating_internal_clearance(self) -> '_1675.InternalClearance':
        ...
        if _1675.InternalClearance.TYPE not in self.wrapped.MaximumOperatingInternalClearance.__class__.__mro__:
    ...
    @property
    def minimum_operating_internal_clearance(self) -> '_1675.InternalClearance':
        ...
        if _1675.InternalClearance.TYPE not in self.wrapped.MinimumOperatingInternalClearance.__class__.__mro__:
    ...
    @property
    def din732(self) -> '_1672.DIN732Results':
        ...
        return constructor.new(_1672.DIN732Results)(self.wrapped.DIN732) if self.wrapped.DIN732 else None

    @property
    def ansiabma(self) -> '_1813.ANSIABMAResults':
        ...
        if _1813.ANSIABMAResults.TYPE not in self.wrapped.ANSIABMA.__class__.__mro__:
    ...
    @property
    def ansiabma_of_type_ansiabma112014_results(self) -> '_1811.ANSIABMA112014Results':
        ...
        if _1811.ANSIABMA112014Results.TYPE not in self.wrapped.ANSIABMA.__class__.__mro__:
    ...
    @property
    def ansiabma_of_type_ansiabma92015_results(self) -> '_1812.ANSIABMA92015Results':
        ...
        if _1812.ANSIABMA92015Results.TYPE not in self.wrapped.ANSIABMA.__class__.__mro__:
    ...
    @property
    def iso2812007(self) -> '_1800.ISO2812007Results':
        ...
        if _1800.ISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
    ...
    @property
    def iso2812007_of_type_ball_iso2812007_results(self) -> '_1798.BallISO2812007Results':
        ...
        if _1798.BallISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
    ...
    @property
    def iso2812007_of_type_roller_iso2812007_results(self) -> '_1804.RollerISO2812007Results':
        ...
        if _1804.RollerISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
    ...
    @property
    def isots162812008(self) -> '_1803.ISOTS162812008Results':
        ...
        if _1803.ISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
    ...
    @property
    def isots162812008_of_type_ball_isots162812008_results(self) -> '_1799.BallISOTS162812008Results':
        ...
        if _1799.BallISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
    ...
    @property
    def isots162812008_of_type_roller_isots162812008_results(self) -> '_1805.RollerISOTS162812008Results':
        ...
        if _1805.RollerISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
    ...
    @property
    def iso762006(self) -> '_1801.ISO762006Results':
        ...
        return constructor.new(_1801.ISO762006Results)(self.wrapped.ISO762006) if self.wrapped.ISO762006 else None

    @property
    def maximum_static_contact_stress(self) -> '_1759.MaximumStaticContactStress':
        ...
        return constructor.new(_1759.MaximumStaticContactStress)(self.wrapped.MaximumStaticContactStress) if self.wrapped.MaximumStaticContactStress else None

    @property
    def skf_module_results(self) -> '_1795.SKFModuleResults':
        ...
        return constructor.new(_1795.SKFModuleResults)(self.wrapped.SKFModuleResults) if self.wrapped.SKFModuleResults else None

    @property
    def rows(self) -> 'List[_1732.LoadedRollingBearingRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Rows, constructor.new(_1732.LoadedRollingBearingRow))
        return value

    @property
    def all_mounting_results(self) -> 'List[_1810.RingFittingThermalResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllMountingResults, constructor.new(_1810.RingFittingThermalResults))
        return value
