...
class RollingBearingFrictionCoefficients(_1346.IndependentReportablePropertiesBase['RollingBearingFrictionCoefficients']):
    '''RollingBearingFrictionCoefficients
    ...
    @property
    def iso14179_static_equivalent_load_factors(self) -> '_1649.EquivalentLoadFactors':
        ...
        return constructor.new(_1649.EquivalentLoadFactors)(self.wrapped.ISO14179StaticEquivalentLoadFactors) if self.wrapped.ISO14179StaticEquivalentLoadFactors else None

    @property
    def iso14179_dynamic_equivalent_load_factors(self) -> '_1649.EquivalentLoadFactors':
        ...
        return constructor.new(_1649.EquivalentLoadFactors)(self.wrapped.ISO14179DynamicEquivalentLoadFactors) if self.wrapped.ISO14179DynamicEquivalentLoadFactors else None
