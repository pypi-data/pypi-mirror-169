...
from mastapy.bearings.bearing_results.rolling import _1747, _1723
...
class LoadedTaperRollerBearingRow(_1723.LoadedNonBarrelRollerBearingRow):
    '''LoadedTaperRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1747.LoadedTaperRollerBearingResults':
        ...
        return constructor.new(_1747.LoadedTaperRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
