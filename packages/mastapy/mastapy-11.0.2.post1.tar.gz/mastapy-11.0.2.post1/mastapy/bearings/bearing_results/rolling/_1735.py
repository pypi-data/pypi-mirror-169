...
from mastapy.bearings.bearing_results.rolling import _1734, _1701
...
class LoadedSelfAligningBallBearingRow(_1701.LoadedBallBearingRow):
    '''LoadedSelfAligningBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1734.LoadedSelfAligningBallBearingResults':
        ...
        return constructor.new(_1734.LoadedSelfAligningBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
