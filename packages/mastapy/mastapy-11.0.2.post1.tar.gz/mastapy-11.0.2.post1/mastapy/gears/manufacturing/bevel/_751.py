...
from mastapy.gears.manufacturing.bevel.basic_machine_settings import _771
...
class PinionConcave(_0.APIBase):
    ...
    @property
    def pinion_concave_ob_configuration(self) -> '_771.BasicConicalGearMachineSettingsGenerated':
        ...
        return constructor.new(_771.BasicConicalGearMachineSettingsGenerated)(self.wrapped.PinionConcaveOBConfiguration) if self.wrapped.PinionConcaveOBConfiguration else None
