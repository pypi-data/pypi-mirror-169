...
from mastapy.gears.manufacturing.bevel.cutters import _764, _763
...
class ConicalWheelManufacturingConfig(_724.ConicalGearManufacturingConfig):
    '''ConicalWheelManufacturingConfig
    ...
    @property
    def wheel_rough_cutter(self) -> '_764.WheelRoughCutter':
        ...
        return constructor.new(_764.WheelRoughCutter)(self.wrapped.WheelRoughCutter) if self.wrapped.WheelRoughCutter else None

    @property
    def wheel_finish_cutter(self) -> '_763.WheelFinishCutter':
        ...
        return constructor.new(_763.WheelFinishCutter)(self.wrapped.WheelFinishCutter) if self.wrapped.WheelFinishCutter else None
    ...
    @property
    def specified_machine_settings(self) -> '_769.BasicConicalGearMachineSettings':
        ...
        if _769.BasicConicalGearMachineSettings.TYPE not in self.wrapped.SpecifiedMachineSettings.__class__.__mro__:
    ...
    @property
    def specified_machine_settings_of_type_basic_conical_gear_machine_settings_formate(self) -> '_770.BasicConicalGearMachineSettingsFormate':
        ...
        if _770.BasicConicalGearMachineSettingsFormate.TYPE not in self.wrapped.SpecifiedMachineSettings.__class__.__mro__:
    ...
    @property
    def specified_machine_settings_of_type_basic_conical_gear_machine_settings_generated(self) -> '_771.BasicConicalGearMachineSettingsGenerated':
        ...
        if _771.BasicConicalGearMachineSettingsGenerated.TYPE not in self.wrapped.SpecifiedMachineSettings.__class__.__mro__:
