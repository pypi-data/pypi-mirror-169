...
class PinionConvex(_0.APIBase):
    ...
    @property
    def pinion_convex_ib_configuration(self) -> '_771.BasicConicalGearMachineSettingsGenerated':
        ...
        return constructor.new(_771.BasicConicalGearMachineSettingsGenerated)(self.wrapped.PinionConvexIBConfiguration) if self.wrapped.PinionConvexIBConfiguration else None
