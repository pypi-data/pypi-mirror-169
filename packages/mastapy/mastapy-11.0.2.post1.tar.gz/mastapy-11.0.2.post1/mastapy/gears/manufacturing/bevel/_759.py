...
from mastapy.gears.manufacturing.bevel.cutters import _763
from mastapy._internal import constructor
from mastapy.gears.manufacturing.bevel.basic_machine_settings import _769, _770, _771
...
class Wheel(_0.APIBase):
    ...
    @property
    def basic_conical_gear_machine_settings(self) -> '_769.BasicConicalGearMachineSettings':
        ...
        if _769.BasicConicalGearMachineSettings.TYPE not in self.wrapped.BasicConicalGearMachineSettings.__class__.__mro__:
    ...
    @property
    def basic_conical_gear_machine_settings_of_type_basic_conical_gear_machine_settings_formate(self) -> '_770.BasicConicalGearMachineSettingsFormate':
        ...
        if _770.BasicConicalGearMachineSettingsFormate.TYPE not in self.wrapped.BasicConicalGearMachineSettings.__class__.__mro__:
    ...
    @property
    def basic_conical_gear_machine_settings_of_type_basic_conical_gear_machine_settings_generated(self) -> '_771.BasicConicalGearMachineSettingsGenerated':
        ...
        if _771.BasicConicalGearMachineSettingsGenerated.TYPE not in self.wrapped.BasicConicalGearMachineSettings.__class__.__mro__:
