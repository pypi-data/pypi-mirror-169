...
from mastapy.gears.manufacturing.bevel import _746, _760
...
class ManufacturingMachine(_1558.NamedDatabaseItem):
    '''ManufacturingMachine
    ...
    @property
    def machine_type(self) -> '_746.MachineTypes':
        '''MachineTypes: 'MachineType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.MachineType)
        return constructor.new(_746.MachineTypes)(value) if value else None

    @machine_type.setter
    def machine_type(self, value: '_746.MachineTypes'):
    ...
    @property
    def wheel_formate_machine_type(self) -> '_760.WheelFormatMachineTypes':
        ...
        return constructor.new(_760.WheelFormatMachineTypes)(value) if value else None

    @wheel_formate_machine_type.setter
    def wheel_formate_machine_type(self, value: '_760.WheelFormatMachineTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
