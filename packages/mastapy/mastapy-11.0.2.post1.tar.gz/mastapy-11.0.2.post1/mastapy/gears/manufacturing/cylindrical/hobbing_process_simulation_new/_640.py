...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _642
...
class WormGrindingCutterCalculation(_642.WormGrindingProcessCalculation):
    '''WormGrindingCutterCalculation
    ...
    @property
    def input_gear_point_of_interest(self) -> '_601.PointOfInterest':
        ...
        return constructor.new(_601.PointOfInterest)(self.wrapped.InputGearPointOfInterest) if self.wrapped.InputGearPointOfInterest else None
