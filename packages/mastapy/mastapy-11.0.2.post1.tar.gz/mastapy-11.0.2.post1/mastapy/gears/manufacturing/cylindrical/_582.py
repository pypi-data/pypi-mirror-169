...
from mastapy.gears.manufacturing.cylindrical import _581, _580
...
class MicroGeometryInputsLead(_581.MicroGeometryInputs['_580.LeadModificationSegment']):
    '''MicroGeometryInputsLead
    ...
    @property
    def lead_micro_geometry_range(self) -> '_1253.Range':
        ...
        if _1253.Range.TYPE not in self.wrapped.LeadMicroGeometryRange.__class__.__mro__:
