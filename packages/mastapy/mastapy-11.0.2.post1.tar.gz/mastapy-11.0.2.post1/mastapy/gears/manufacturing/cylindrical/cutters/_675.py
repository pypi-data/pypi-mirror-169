...
class CylindricalGearHobDesign(_678.CylindricalGearRackDesign):
    ...
    @property
    def hob_edge_type(self) -> '_579.HobEdgeTypes':
        '''HobEdgeTypes: 'HobEdgeType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HobEdgeType)
        return constructor.new(_579.HobEdgeTypes)(value) if value else None

    @hob_edge_type.setter
    def hob_edge_type(self, value: '_579.HobEdgeTypes'):
    ...
    def nominal_hob_shape(self) -> '_691.CylindricalGearHobShape':
        ...
        return constructor.new(_691.CylindricalGearHobShape)(self.wrapped.NominalHobShape) if self.wrapped.NominalHobShape else None
    ...
    def nominal_rack_shape(self) -> '_696.RackShape':
        ...
        if _696.RackShape.TYPE not in self.wrapped.NominalRackShape.__class__.__mro__:
    ...
    def nominal_rack_shape_of_type_cylindrical_gear_hob_shape(self) -> '_691.CylindricalGearHobShape':
        ...
        if _691.CylindricalGearHobShape.TYPE not in self.wrapped.NominalRackShape.__class__.__mro__:
    ...
    def nominal_rack_shape_of_type_cylindrical_gear_worm_grinder_shape(self) -> '_694.CylindricalGearWormGrinderShape':
        ...
        if _694.CylindricalGearWormGrinderShape.TYPE not in self.wrapped.NominalRackShape.__class__.__mro__:
    ...
    def maximum_hob_material_shape(self) -> '_691.CylindricalGearHobShape':
        ...
        return constructor.new(_691.CylindricalGearHobShape)(self.wrapped.MaximumHobMaterialShape) if self.wrapped.MaximumHobMaterialShape else None
    ...
    def minimum_hob_material_shape(self) -> '_691.CylindricalGearHobShape':
        ...
        return constructor.new(_691.CylindricalGearHobShape)(self.wrapped.MinimumHobMaterialShape) if self.wrapped.MinimumHobMaterialShape else None
