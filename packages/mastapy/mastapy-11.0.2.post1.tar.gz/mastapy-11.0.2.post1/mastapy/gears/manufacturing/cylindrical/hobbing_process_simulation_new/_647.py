...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _639, _633
...
class WormGrindingProcessSimulationInput(_633.ProcessSimulationInput):
    '''WormGrindingProcessSimulationInput
    ...
    @property
    def worm_grinder_manufacture_error(self) -> '_639.WormGrinderManufactureError':
        ...
        return constructor.new(_639.WormGrinderManufactureError)(self.wrapped.WormGrinderManufactureError) if self.wrapped.WormGrinderManufactureError else None
