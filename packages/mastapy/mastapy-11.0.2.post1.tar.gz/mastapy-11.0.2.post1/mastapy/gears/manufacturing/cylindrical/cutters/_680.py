...
class CylindricalGearShaper(_684.InvoluteCutterDesign):
    ...
    @property
    def shaper_edge_type(self) -> '_1001.ShaperEdgeTypes':
        ...
        return constructor.new(_1001.ShaperEdgeTypes)(value) if value else None

    @shaper_edge_type.setter
    def shaper_edge_type(self, value: '_1001.ShaperEdgeTypes'):
