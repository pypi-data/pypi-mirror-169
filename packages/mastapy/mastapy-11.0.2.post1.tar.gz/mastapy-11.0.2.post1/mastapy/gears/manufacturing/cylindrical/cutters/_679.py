...
class CylindricalGearRealCutterDesign(_672.CylindricalGearAbstractCutterDesign):
    ...
    def nominal_cutter_shape(self) -> '_689.CutterShapeDefinition':
        ...
        if _689.CutterShapeDefinition.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
    ...
    def nominal_cutter_shape_of_type_cylindrical_gear_formed_wheel_grinder_tangible(self) -> '_690.CylindricalGearFormedWheelGrinderTangible':
        ...
        if _690.CylindricalGearFormedWheelGrinderTangible.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
    ...
    def nominal_cutter_shape_of_type_cylindrical_gear_hob_shape(self) -> '_691.CylindricalGearHobShape':
        ...
        if _691.CylindricalGearHobShape.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
    ...
    def nominal_cutter_shape_of_type_cylindrical_gear_shaper_tangible(self) -> '_692.CylindricalGearShaperTangible':
        ...
        if _692.CylindricalGearShaperTangible.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
    ...
    def nominal_cutter_shape_of_type_cylindrical_gear_shaver_tangible(self) -> '_693.CylindricalGearShaverTangible':
        ...
        if _693.CylindricalGearShaverTangible.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
    ...
    def nominal_cutter_shape_of_type_cylindrical_gear_worm_grinder_shape(self) -> '_694.CylindricalGearWormGrinderShape':
        ...
        if _694.CylindricalGearWormGrinderShape.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
    ...
    def nominal_cutter_shape_of_type_rack_shape(self) -> '_696.RackShape':
        ...
        if _696.RackShape.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
    ...
    def customised_cutting_edge_profile(self) -> '_670.CustomisableEdgeProfile':
        ...
        return constructor.new(_670.CustomisableEdgeProfile)(self.wrapped.CustomisedCuttingEdgeProfile) if self.wrapped.CustomisedCuttingEdgeProfile else None
