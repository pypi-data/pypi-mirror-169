...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _710, _709, _713
...
class ShavingDynamicsCalculation(_0.APIBase, Generic[T]):
    ...
    @property
    def accuracy_level_iso6(self) -> '_710.RollAngleRangeRelativeToAccuracy':
        ...
        return constructor.new(_710.RollAngleRangeRelativeToAccuracy)(self.wrapped.AccuracyLevelISO6) if self.wrapped.AccuracyLevelISO6 else None

    @property
    def accuracy_level_iso7(self) -> '_710.RollAngleRangeRelativeToAccuracy':
        ...
        return constructor.new(_710.RollAngleRangeRelativeToAccuracy)(self.wrapped.AccuracyLevelISO7) if self.wrapped.AccuracyLevelISO7 else None

    @property
    def designed_gear(self) -> '_652.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_652.CylindricalCutterSimulatableGear)(self.wrapped.DesignedGear) if self.wrapped.DesignedGear else None
    ...
    def life_shaver(self) -> '_681.CylindricalGearShaver':
        ...
        if _681.CylindricalGearShaver.TYPE not in self.wrapped.LifeShaver.__class__.__mro__:
    ...
    @property
    def new_cutter_start_of_shaving(self) -> '_954.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_954.CylindricalGearProfileMeasurement)(self.wrapped.NewCutterStartOfShaving) if self.wrapped.NewCutterStartOfShaving else None

    @property
    def life_cutter_start_of_shaving(self) -> '_954.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_954.CylindricalGearProfileMeasurement)(self.wrapped.LifeCutterStartOfShaving) if self.wrapped.LifeCutterStartOfShaving else None
