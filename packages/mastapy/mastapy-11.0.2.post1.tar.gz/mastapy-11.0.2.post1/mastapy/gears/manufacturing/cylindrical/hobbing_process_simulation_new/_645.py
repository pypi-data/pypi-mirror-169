...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _609, _642
...
class WormGrindingProcessPitchCalculation(_642.WormGrindingProcessCalculation):
    '''WormGrindingProcessPitchCalculation
