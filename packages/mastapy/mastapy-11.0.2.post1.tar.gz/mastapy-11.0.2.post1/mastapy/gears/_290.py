...
from mastapy.gears.rating.cylindrical import _436, _421
from mastapy.gears.gear_designs.cylindrical import _1009, _947
from mastapy.materials import _234, _223
...
class GearSetDesignGroup(_0.APIBase):
    ...
    @property
    def misalignment_contact_pattern_enhancement(self) -> '_436.MisalignmentContactPatternEnhancements':
        ...
        return constructor.new(_436.MisalignmentContactPatternEnhancements)(value) if value else None

    @misalignment_contact_pattern_enhancement.setter
    def misalignment_contact_pattern_enhancement(self, value: '_436.MisalignmentContactPatternEnhancements'):
    ...
    @property
    def default_rough_toleranced_metal_measurement(self) -> '_1009.TolerancedMetalMeasurements':
        ...
        return constructor.new(_1009.TolerancedMetalMeasurements)(value) if value else None

    @default_rough_toleranced_metal_measurement.setter
    def default_rough_toleranced_metal_measurement(self, value: '_1009.TolerancedMetalMeasurements'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def general_transmission_properties(self) -> '_223.GeneralTransmissionProperties':
        ...
        return constructor.new(_223.GeneralTransmissionProperties)(self.wrapped.GeneralTransmissionProperties) if self.wrapped.GeneralTransmissionProperties else None

    @property
    def settings(self) -> '_421.CylindricalGearRatingSettings':
        ...
        return constructor.new(_421.CylindricalGearRatingSettings)(self.wrapped.Settings) if self.wrapped.Settings else None
