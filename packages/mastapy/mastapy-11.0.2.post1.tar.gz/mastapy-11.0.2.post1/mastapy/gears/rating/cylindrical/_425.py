...
class CylindricalGearSingleFlankRating(_326.GearSingleFlankRating):
    '''CylindricalGearSingleFlankRating
    ...
    @property
    def metal_plastic(self) -> '_240.MetalPlasticType':
        ...
        return constructor.new(_240.MetalPlasticType)(value) if value else None
    ...
    @property
    def geometry_data_source_for_rating(self) -> '_420.CylindricalGearRatingGeometryDataSource':
        ...
        return constructor.new(_420.CylindricalGearRatingGeometryDataSource)(value) if value else None
