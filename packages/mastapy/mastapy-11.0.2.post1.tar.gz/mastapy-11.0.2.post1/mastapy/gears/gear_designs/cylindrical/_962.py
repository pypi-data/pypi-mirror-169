...
class CylindricalGearTableWithMGCharts(_1516.CustomTable):
    '''CylindricalGearTableWithMGCharts
    ...
    @property
    def item_detail(self) -> '_961.CylindricalGearTableMGItemDetail':
        ...
        return constructor.new(_961.CylindricalGearTableMGItemDetail)(value) if value else None

    @item_detail.setter
    def item_detail(self, value: '_961.CylindricalGearTableMGItemDetail'):
