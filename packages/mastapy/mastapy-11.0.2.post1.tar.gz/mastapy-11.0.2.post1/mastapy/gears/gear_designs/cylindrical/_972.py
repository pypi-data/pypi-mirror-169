...
class FinishStockSpecification(_996.RelativeValuesSpecification['FinishStockSpecification']):
    '''FinishStockSpecification
    ...
    @property
    def normal(self) -> '_1010.TolerancedValueSpecification[FinishStockSpecification]':
        ...
        if _1010.TolerancedValueSpecification[FinishStockSpecification].TYPE not in self.wrapped.Normal.__class__.__mro__:
    ...
    @property
    def tangent_to_reference_circle(self) -> '_1010.TolerancedValueSpecification[FinishStockSpecification]':
        ...
        if _1010.TolerancedValueSpecification[FinishStockSpecification].TYPE not in self.wrapped.TangentToReferenceCircle.__class__.__mro__:
