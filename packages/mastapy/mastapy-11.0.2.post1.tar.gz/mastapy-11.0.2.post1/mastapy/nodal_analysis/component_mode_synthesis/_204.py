...
from mastapy.nodal_analysis.states import _117, _116
...
class StaticCMSResults(_203.RealCMSResults):
    '''StaticCMSResults
    ...
    @property
    def node_stress_tensors(self) -> '_117.NodeVectorState':
        ...
        if _117.NodeVectorState.TYPE not in self.wrapped.NodeStressTensors.__class__.__mro__:
