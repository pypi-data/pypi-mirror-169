...
class RealCMSResults(_200.CMSResults):
    '''RealCMSResults
    ...
    @property
    def node_displacements(self) -> '_117.NodeVectorState':
        ...
        if _117.NodeVectorState.TYPE not in self.wrapped.NodeDisplacements.__class__.__mro__:
