...
class ElementPropertiesMass(_179.ElementPropertiesBase):
    '''ElementPropertiesMass
    ...
    @property
    def inertia(self) -> '_1282.InertiaTensor':
        ...
        return constructor.new(_1282.InertiaTensor)(self.wrapped.Inertia) if self.wrapped.Inertia else None
