...
class TransientSolverOptions(_0.APIBase):
    ...
    @property
    def solver_tolerance_input_method(self) -> '_83.TransientSolverToleranceInputMethod':
        ...
        return constructor.new(_83.TransientSolverToleranceInputMethod)(value) if value else None

    @solver_tolerance_input_method.setter
    def solver_tolerance_input_method(self, value: '_83.TransientSolverToleranceInputMethod'):
