...
class TransientSolver(_96.DynamicSolver):
    '''TransientSolver
    ...
    @property
    def solver_status(self) -> '_82.TransientSolverStatus':
        ...
        return constructor.new(_82.TransientSolverStatus)(value) if value else None

    @solver_status.setter
    def solver_status(self, value: '_82.TransientSolverStatus'):
