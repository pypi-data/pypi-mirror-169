...
from mastapy.nodal_analysis import _53, _85, _56
...
class FEMeshingOptions(_0.APIBase):
    ...
    @property
    def element_shape(self) -> '_85.VolumeElementShape':
        ...
        return constructor.new(_85.VolumeElementShape)(value) if value else None

    @element_shape.setter
    def element_shape(self, value: '_85.VolumeElementShape'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
