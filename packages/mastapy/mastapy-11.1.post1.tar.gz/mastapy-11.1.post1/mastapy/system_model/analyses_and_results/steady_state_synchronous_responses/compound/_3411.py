...
class CVTPulleyCompoundSteadyStateSynchronousResponse(_3457.PulleyCompoundSteadyStateSynchronousResponse):
    '''CVTPulleyCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3277.CVTPulleySteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3277.CVTPulleySteadyStateSynchronousResponse))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3277.CVTPulleySteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3277.CVTPulleySteadyStateSynchronousResponse))
        return value
