...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _5020, _5021, _5033
...
class CylindricalGearSetCompoundModalAnalysis(_5033.GearSetCompoundModalAnalysis):
    '''CylindricalGearSetCompoundModalAnalysis
    ...
    @property
    def cylindrical_gears_compound_modal_analysis(self) -> 'List[_5020.CylindricalGearCompoundModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsCompoundModalAnalysis, constructor.new(_5020.CylindricalGearCompoundModalAnalysis))
        return value

    @property
    def cylindrical_meshes_compound_modal_analysis(self) -> 'List[_5021.CylindricalGearMeshCompoundModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesCompoundModalAnalysis, constructor.new(_5021.CylindricalGearMeshCompoundModalAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4870.CylindricalGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4870.CylindricalGearSetModalAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4870.CylindricalGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4870.CylindricalGearSetModalAnalysis))
        return value
