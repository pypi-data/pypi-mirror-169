...
from mastapy.system_model.analyses_and_results.modal_analyses import _4845, _4880, _4905
...
class AbstractAssemblyModalAnalysis(_4905.PartModalAnalysis):
    '''AbstractAssemblyModalAnalysis
    ...
    @property
    def rigidly_connected_groups(self) -> 'List[_4845.ComponentModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RigidlyConnectedGroups, constructor.new(_4845.ComponentModalAnalysis))
        return value

    @property
    def gear_meshes(self) -> 'List[_4880.GearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshes, constructor.new(_4880.GearMeshModalAnalysis))
        return value
