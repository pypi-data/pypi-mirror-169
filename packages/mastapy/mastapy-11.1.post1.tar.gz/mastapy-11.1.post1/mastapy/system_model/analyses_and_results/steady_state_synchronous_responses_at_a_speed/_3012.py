...
class ConnectionSteadyStateSynchronousResponseAtASpeed(_7258.ConnectionStaticLoadAnalysisCase):
    '''ConnectionSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def steady_state_synchronous_response_at_a_speed(self) -> '_3082.SteadyStateSynchronousResponseAtASpeed':
        ...
        return constructor.new(_3082.SteadyStateSynchronousResponseAtASpeed)(self.wrapped.SteadyStateSynchronousResponseAtASpeed) if self.wrapped.SteadyStateSynchronousResponseAtASpeed is not None else None
