...
class BevelDifferentialGearMeshAdvancedSystemDeflection(_7007.BevelGearMeshAdvancedSystemDeflection):
    '''BevelDifferentialGearMeshAdvancedSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_514.BevelGearMeshRating':
        ...
        if _514.BevelGearMeshRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2436.BevelDifferentialGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2436.BevelDifferentialGearMeshSystemDeflection))
        return value
