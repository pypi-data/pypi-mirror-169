...
from mastapy.system_model.analyses_and_results.static_loads import _6537, _6540, _6541
...
class BevelDifferentialGearAdvancedSystemDeflection(_7006.BevelGearAdvancedSystemDeflection):
    '''BevelDifferentialGearAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6537.BevelDifferentialGearLoadCase':
        ...
        if _6537.BevelDifferentialGearLoadCase.TYPE not in self.wrapped.ComponentLoadCase.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis(self) -> '_515.BevelGearRating':
        ...
        if _515.BevelGearRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2438.BevelDifferentialGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2438.BevelDifferentialGearSystemDeflection))
        return value
