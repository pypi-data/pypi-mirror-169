...
class AGMAGleasonConicalGearMeshSystemDeflection(_2459.ConicalGearMeshSystemDeflection):
    '''AGMAGleasonConicalGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3769.AGMAGleasonConicalGearMeshPowerFlow':
