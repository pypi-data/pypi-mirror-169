...
class BoltedJointSystemDeflection(_2541.SpecialisedAssemblySystemDeflection):
    '''BoltedJointSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3784.BoltedJointPowerFlow':
        ...
        return constructor.new(_3784.BoltedJointPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
