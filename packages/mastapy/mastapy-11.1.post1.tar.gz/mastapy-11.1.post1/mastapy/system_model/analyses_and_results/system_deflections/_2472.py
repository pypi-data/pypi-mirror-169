...
class CycloidalDiscPlanetaryBearingConnectionSystemDeflection(_2428.AbstractShaftToMountableComponentConnectionSystemDeflection):
    '''CycloidalDiscPlanetaryBearingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3810.CycloidalDiscPlanetaryBearingConnectionPowerFlow':
        ...
        return constructor.new(_3810.CycloidalDiscPlanetaryBearingConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
