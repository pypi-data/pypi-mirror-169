...
class ConceptCouplingHalfSystemDeflection(_2465.CouplingHalfSystemDeflection):
    '''ConceptCouplingHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3792.ConceptCouplingHalfPowerFlow':
        ...
        return constructor.new(_3792.ConceptCouplingHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
