...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4075, _4074, _4094
...
class CylindricalGearSetParametricStudyTool(_4094.GearSetParametricStudyTool):
    '''CylindricalGearSetParametricStudyTool
    ...
    @property
    def cylindrical_gears_parametric_study_tool(self) -> 'List[_4075.CylindricalGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsParametricStudyTool, constructor.new(_4075.CylindricalGearParametricStudyTool))
        return value

    @property
    def cylindrical_meshes_parametric_study_tool(self) -> 'List[_4074.CylindricalGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesParametricStudyTool, constructor.new(_4074.CylindricalGearMeshParametricStudyTool))
        return value

    @property
    def assembly_system_deflection_results(self) -> 'List[_2477.CylindricalGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2477.CylindricalGearSetSystemDeflection))
        return value
