...
from mastapy.system_model.analyses_and_results.static_loads import _6519, _6526, _6520
...
class ConnectionLoadCase(_2389.ConnectionAnalysis):
    '''ConnectionLoadCase
    ...
    @property
    def static_load_case(self) -> '_6519.StaticLoadCase':
        ...
        if _6519.StaticLoadCase.TYPE not in self.wrapped.StaticLoadCase.__class__.__mro__:
