...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _2377, _4310
...
class RootAssemblyModalAnalysisAtAStiffness(_4310.AssemblyModalAnalysisAtAStiffness):
    '''RootAssemblyModalAnalysisAtAStiffness
    ...
    @property
    def modal_analysis_at_a_stiffness_inputs(self) -> '_2377.ModalAnalysisAtAStiffness':
        ...
        return constructor.new(_2377.ModalAnalysisAtAStiffness)(self.wrapped.ModalAnalysisAtAStiffnessInputs) if self.wrapped.ModalAnalysisAtAStiffnessInputs is not None else None
