...
class AGMAGleasonConicalGearMeshAdvancedTimeSteppingAnalysisForModulation(_6761.ConicalGearMeshAdvancedTimeSteppingAnalysisForModulation):
    '''AGMAGleasonConicalGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2429.AGMAGleasonConicalGearMeshSystemDeflection':
