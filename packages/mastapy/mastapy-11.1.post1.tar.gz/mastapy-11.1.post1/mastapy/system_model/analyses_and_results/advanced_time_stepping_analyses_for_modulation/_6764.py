...
class ConnectorAdvancedTimeSteppingAnalysisForModulation(_6806.MountableComponentAdvancedTimeSteppingAnalysisForModulation):
    '''ConnectorAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2463.ConnectorSystemDeflection':
