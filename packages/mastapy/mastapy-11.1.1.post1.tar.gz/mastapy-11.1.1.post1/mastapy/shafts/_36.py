...
class ShaftSectionEndDamageResults(_0.APIBase):
    ...
    def section_end(self) -> '_80.SectionEnd':
        ...
        return constructor.new(_80.SectionEnd)(value) if value is not None else None
    ...
    @property
    def sn_curve(self) -> '_250.SNCurve':
        ...
        return constructor.new(_250.SNCurve)(self.wrapped.SNCurve) if self.wrapped.SNCurve is not None else None
    ...
    @property
    def sn_curve_axial(self) -> '_250.SNCurve':
        ...
        return constructor.new(_250.SNCurve)(self.wrapped.SNCurveAxial) if self.wrapped.SNCurveAxial is not None else None

    @property
    def sn_curve_bending_x(self) -> '_250.SNCurve':
        ...
        return constructor.new(_250.SNCurve)(self.wrapped.SNCurveBendingX) if self.wrapped.SNCurveBendingX is not None else None

    @property
    def sn_curve_bending_y(self) -> '_250.SNCurve':
        ...
        return constructor.new(_250.SNCurve)(self.wrapped.SNCurveBendingY) if self.wrapped.SNCurveBendingY is not None else None

    @property
    def sn_curve_torsional(self) -> '_250.SNCurve':
        ...
        return constructor.new(_250.SNCurve)(self.wrapped.SNCurveTorsional) if self.wrapped.SNCurveTorsional is not None else None
