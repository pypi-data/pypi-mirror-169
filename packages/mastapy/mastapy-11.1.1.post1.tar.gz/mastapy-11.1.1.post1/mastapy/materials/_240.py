...
from mastapy.materials import _243, _229
...
class Material(_1600.NamedDatabaseItem):
    '''Material
    ...
    @property
    def standard(self) -> '_243.MaterialStandards':
        ...
        return constructor.new(_243.MaterialStandards)(value) if value is not None else None

    @property
    def hardness_type(self) -> '_229.HardnessType':
        '''HardnessType: 'HardnessType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HardnessType)
        return constructor.new(_229.HardnessType)(value) if value is not None else None

    @hardness_type.setter
    def hardness_type(self, value: '_229.HardnessType'):
