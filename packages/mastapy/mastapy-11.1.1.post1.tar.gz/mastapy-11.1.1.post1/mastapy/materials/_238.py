...
from mastapy.utility.databases import _1600
...
class LubricationDetail(_1600.NamedDatabaseItem):
    '''LubricationDetail
    ...
    @property
    def density_specification_method(self) -> '_223.DensitySpecificationMethod':
        ...
        return constructor.new(_223.DensitySpecificationMethod)(value) if value is not None else None

    @density_specification_method.setter
    def density_specification_method(self, value: '_223.DensitySpecificationMethod'):
    ...
    @property
    def density_vs_temperature(self) -> '_1336.Vector2DListAccessor':
        '''Vector2DListAccessor: 'DensityVsTemperature' is the original name of this property.'''

        return constructor.new(_1336.Vector2DListAccessor)(self.wrapped.DensityVsTemperature) if self.wrapped.DensityVsTemperature is not None else None

    @density_vs_temperature.setter
    def density_vs_temperature(self, value: '_1336.Vector2DListAccessor'):
    ...
    @property
    def pressure_viscosity_coefficient_method(self) -> '_246.PressureViscosityCoefficientMethod':
        ...
        return constructor.new(_246.PressureViscosityCoefficientMethod)(value) if value is not None else None

    @pressure_viscosity_coefficient_method.setter
    def pressure_viscosity_coefficient_method(self, value: '_246.PressureViscosityCoefficientMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def oil_filtration_and_contamination(self) -> '_245.OilFiltrationOptions':
        ...
        return constructor.new(_245.OilFiltrationOptions)(value) if value is not None else None

    @oil_filtration_and_contamination.setter
    def oil_filtration_and_contamination(self, value: '_245.OilFiltrationOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.OilFiltrationAndContamination = value

    @property
    def grease_contamination_level(self) -> '_228.GreaseContaminationOptions':
        ...
        return constructor.new(_228.GreaseContaminationOptions)(value) if value is not None else None

    @grease_contamination_level.setter
    def grease_contamination_level(self, value: '_228.GreaseContaminationOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def lubricant_type_supply(self) -> '_217.BearingLubricationCondition':
        ...
        return constructor.new(_217.BearingLubricationCondition)(value) if value is not None else None

    @lubricant_type_supply.setter
    def lubricant_type_supply(self, value: '_217.BearingLubricationCondition'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def lubricant_viscosity_classification(self) -> '_235.LubricantViscosityClassification':
        ...
        return constructor.new(_235.LubricantViscosityClassification)(value) if value is not None else None

    @lubricant_viscosity_classification.setter
    def lubricant_viscosity_classification(self, value: '_235.LubricantViscosityClassification'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def lubricant_grade_agma(self) -> '_234.LubricantViscosityClassAGMA':
        ...
        return constructor.new(_234.LubricantViscosityClassAGMA)(value) if value is not None else None

    @lubricant_grade_agma.setter
    def lubricant_grade_agma(self, value: '_234.LubricantViscosityClassAGMA'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.LubricantGradeAGMA = value

    @property
    def lubricant_grade_sae(self) -> '_237.LubricantViscosityClassSAE':
        ...
        return constructor.new(_237.LubricantViscosityClassSAE)(value) if value is not None else None

    @lubricant_grade_sae.setter
    def lubricant_grade_sae(self, value: '_237.LubricantViscosityClassSAE'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def delivery(self) -> '_233.LubricantDelivery':
        ...
        return constructor.new(_233.LubricantDelivery)(value) if value is not None else None

    @property
    def agma925a03_lubricant_type(self) -> '_212.AGMALubricantType':
        ...
        return constructor.new(_212.AGMALubricantType)(value) if value is not None else None

    @agma925a03_lubricant_type.setter
    def agma925a03_lubricant_type(self, value: '_212.AGMALubricantType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.AGMA925A03LubricantType = value

    @property
    def iso_lubricant_type(self) -> '_231.ISOLubricantType':
        ...
        return constructor.new(_231.ISOLubricantType)(value) if value is not None else None

    @iso_lubricant_type.setter
    def iso_lubricant_type(self, value: '_231.ISOLubricantType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
