...
from mastapy.gears.fe_model import _1148
...
class GearFEModel(_1168.GearImplementationDetail):
    '''GearFEModel
    ...
    @property
    def element_settings(self) -> '_1148.GearMeshingElementOptions':
        ...
        return constructor.new(_1148.GearMeshingElementOptions)(self.wrapped.ElementSettings) if self.wrapped.ElementSettings is not None else None

    def get_stress_influence_coefficients_from_fe(self, flank: '_293.GearFlanks'):
    ...
    def get_stress_influence_coefficients_from_fe_with_progress(self, flank: '_293.GearFlanks', progress: '_7278.TaskProgress'):
        ''' 'GetStressInfluenceCoefficientsFromFE' is the original name of this method.
    ...
    def calculate_stiffness_from_fe_with_progress(self, progress: '_7278.TaskProgress'):
        ''' 'CalculateStiffnessFromFE' is the original name of this method.
