...
class PocketingPowerLossCoefficients(_1600.NamedDatabaseItem):
    '''PocketingPowerLossCoefficients
    ...
    @property
    def raw_pocketing_power_loss_lookup_table(self) -> '_1368.GriddedSurfaceAccessor':
        '''GriddedSurfaceAccessor: 'RawPocketingPowerLossLookupTable' is the original name of this property.'''

        return constructor.new(_1368.GriddedSurfaceAccessor)(self.wrapped.RawPocketingPowerLossLookupTable) if self.wrapped.RawPocketingPowerLossLookupTable is not None else None

    @raw_pocketing_power_loss_lookup_table.setter
    def raw_pocketing_power_loss_lookup_table(self, value: '_1368.GriddedSurfaceAccessor'):
    ...
    @property
    def specifications_for_the_effect_of_oil_kinematic_viscosity(self) -> 'List[_313.SpecificationForTheEffectOfOilKinematicViscosity]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpecificationsForTheEffectOfOilKinematicViscosity, constructor.new(_313.SpecificationForTheEffectOfOilKinematicViscosity))
        return value
