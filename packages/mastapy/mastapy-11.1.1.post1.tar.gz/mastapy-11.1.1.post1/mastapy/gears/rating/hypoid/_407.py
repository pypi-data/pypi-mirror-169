...
from mastapy.gears.rating.hypoid import _405, _406
...
class HypoidGearSetRating(_528.AGMAGleasonConicalGearSetRating):
    '''HypoidGearSetRating
    ...
    @property
    def hypoid_mesh_ratings(self) -> 'List[_405.HypoidGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshRatings, constructor.new(_405.HypoidGearMeshRating))
        return value
