...
from mastapy.gears.gear_designs.conical import _1118
...
class AGMAGleasonConicalGearMeshRating(_500.ConicalGearMeshRating):
    '''AGMAGleasonConicalGearMeshRating
    ...
    @property
    def load_distribution_factor_method(self) -> '_1118.LoadDistributionFactorMethods':
        ...
        return constructor.new(_1118.LoadDistributionFactorMethods)(value) if value is not None else None
