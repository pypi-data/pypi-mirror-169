...
class VDI2737InternalGearSingleFlankRating(_0.APIBase):
    ...
    @property
    def iso_gear_rating(self) -> '_481.ISO6336AbstractMetalGearSingleFlankRating':
        ...
        if _481.ISO6336AbstractMetalGearSingleFlankRating.TYPE not in self.wrapped.ISOGearRating.__class__.__mro__:
    ...
    @property
    def iso_gear_rating_of_type_iso63361996_gear_single_flank_rating(self) -> '_473.ISO63361996GearSingleFlankRating':
        ...
        if _473.ISO63361996GearSingleFlankRating.TYPE not in self.wrapped.ISOGearRating.__class__.__mro__:
    ...
    @property
    def iso_gear_rating_of_type_iso63362006_gear_single_flank_rating(self) -> '_475.ISO63362006GearSingleFlankRating':
        ...
        if _475.ISO63362006GearSingleFlankRating.TYPE not in self.wrapped.ISOGearRating.__class__.__mro__:
    ...
    @property
    def iso_gear_rating_of_type_iso63362019_gear_single_flank_rating(self) -> '_477.ISO63362019GearSingleFlankRating':
        ...
        if _477.ISO63362019GearSingleFlankRating.TYPE not in self.wrapped.ISOGearRating.__class__.__mro__:
    ...
    @property
    def iso_gear_rating_of_type_din3990_gear_single_flank_rating(self) -> '_494.DIN3990GearSingleFlankRating':
        ...
        if _494.DIN3990GearSingleFlankRating.TYPE not in self.wrapped.ISOGearRating.__class__.__mro__:
