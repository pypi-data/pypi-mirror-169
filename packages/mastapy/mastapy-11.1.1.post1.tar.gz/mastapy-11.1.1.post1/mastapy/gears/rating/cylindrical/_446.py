...
class ScuffingResultsRow(_0.APIBase):
    ...
    @property
    def pinion(self) -> '_447.ScuffingResultsRowGear':
        ...
        return constructor.new(_447.ScuffingResultsRowGear)(self.wrapped.Pinion) if self.wrapped.Pinion is not None else None
