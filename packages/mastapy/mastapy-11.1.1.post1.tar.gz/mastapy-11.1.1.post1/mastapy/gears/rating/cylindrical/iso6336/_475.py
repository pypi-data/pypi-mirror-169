...
from mastapy.gears.rating.cylindrical.iso6336 import _470, _481
...
class ISO63362006GearSingleFlankRating(_481.ISO6336AbstractMetalGearSingleFlankRating):
    '''ISO63362006GearSingleFlankRating
    ...
    @property
    def tooth_fatigue_fracture_results(self) -> '_470.CylindricalGearToothFatigueFractureResults':
        ...
        return constructor.new(_470.CylindricalGearToothFatigueFractureResults)(self.wrapped.ToothFatigueFractureResults) if self.wrapped.ToothFatigueFractureResults is not None else None
