...
class SafetyFactorOptimisationStepResult(_0.APIBase):
    ...
    @property
    def safety_factors(self) -> '_335.SafetyFactorResults':
        ...
        return constructor.new(_335.SafetyFactorResults)(self.wrapped.SafetyFactors) if self.wrapped.SafetyFactors is not None else None

    @property
    def normalised_safety_factors(self) -> '_335.SafetyFactorResults':
        ...
        return constructor.new(_335.SafetyFactorResults)(self.wrapped.NormalisedSafetyFactors) if self.wrapped.NormalisedSafetyFactors is not None else None
