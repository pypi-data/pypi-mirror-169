...
class ToothFlankFractureAnalysisContactPointCommon(_0.APIBase):
    ...
    @property
    def analysis_point_with_maximum_local_material_exposure(self) -> '_490.ToothFlankFractureAnalysisPoint':
        ...
        return constructor.new(_490.ToothFlankFractureAnalysisPoint)(self.wrapped.AnalysisPointWithMaximumLocalMaterialExposure) if self.wrapped.AnalysisPointWithMaximumLocalMaterialExposure is not None else None

    @property
    def watch_points(self) -> 'List[_490.ToothFlankFractureAnalysisPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WatchPoints, constructor.new(_490.ToothFlankFractureAnalysisPoint))
        return value
