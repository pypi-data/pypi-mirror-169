...
class CylindricalMeshDutyCycleRating(_332.MeshDutyCycleRating):
    '''CylindricalMeshDutyCycleRating
    ...
    @property
    def highest_torque_load_case(self) -> '_422.CylindricalGearMeshRating':
        ...
        return constructor.new(_422.CylindricalGearMeshRating)(self.wrapped.HighestTorqueLoadCase) if self.wrapped.HighestTorqueLoadCase is not None else None
