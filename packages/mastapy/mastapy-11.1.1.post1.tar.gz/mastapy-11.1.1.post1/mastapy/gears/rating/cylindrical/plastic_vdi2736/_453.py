...
from mastapy.gears.rating.cylindrical.plastic_vdi2736 import _457
from mastapy.materials import _254, _255
...
class PlasticGearVDI2736AbstractGearSingleFlankRating(_479.ISO6336AbstractGearSingleFlankRating):
    '''PlasticGearVDI2736AbstractGearSingleFlankRating
    ...
    @property
    def is_gear_driving_or_driven(self) -> '_324.FlankLoadingState':
        ...
        return constructor.new(_324.FlankLoadingState)(value) if value is not None else None
    ...
    @property
    def standard_plastic_sn_curve_for_the_specified_operating_conditions(self) -> '_457.PlasticSNCurveForTheSpecifiedOperatingConditions':
        ...
        return constructor.new(_457.PlasticSNCurveForTheSpecifiedOperatingConditions)(self.wrapped.StandardPlasticSNCurveForTheSpecifiedOperatingConditions) if self.wrapped.StandardPlasticSNCurveForTheSpecifiedOperatingConditions is not None else None
