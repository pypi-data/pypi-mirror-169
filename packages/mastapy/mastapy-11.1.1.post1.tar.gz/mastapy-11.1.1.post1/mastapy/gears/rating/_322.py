...
class AbstractGearSetRating(_1164.AbstractGearSetAnalysis):
    '''AbstractGearSetRating
    ...
    @property
    def gear_ratings(self) -> 'List[_321.AbstractGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_321.AbstractGearRating))
        return value

    @property
    def gear_mesh_ratings(self) -> 'List[_320.AbstractGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshRatings, constructor.new(_320.AbstractGearMeshRating))
        return value
