...
class KlingelnbergConicalMeshSingleFlankRating(_333.MeshSingleFlankRating):
    '''KlingelnbergConicalMeshSingleFlankRating
    ...
    @property
    def virtual_cylindrical_gear_set(self) -> '_354.KlingelnbergVirtualCylindricalGearSet':
        ...
        return constructor.new(_354.KlingelnbergVirtualCylindricalGearSet)(self.wrapped.VirtualCylindricalGearSet) if self.wrapped.VirtualCylindricalGearSet is not None else None
