...
class SpiralBevelGearRating(_516.BevelGearRating):
    '''SpiralBevelGearRating
    ...
    @property
    def spiral_bevel_gear(self) -> '_927.SpiralBevelGearDesign':
        ...
        return constructor.new(_927.SpiralBevelGearDesign)(self.wrapped.SpiralBevelGear) if self.wrapped.SpiralBevelGear is not None else None
