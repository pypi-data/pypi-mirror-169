...
class ZerolBevelGearMeshRating(_515.BevelGearMeshRating):
    '''ZerolBevelGearMeshRating
    ...
    @property
    def zerol_bevel_gear_mesh(self) -> '_911.ZerolBevelGearMeshDesign':
        ...
        return constructor.new(_911.ZerolBevelGearMeshDesign)(self.wrapped.ZerolBevelGearMesh) if self.wrapped.ZerolBevelGearMesh is not None else None
