...
class ZerolBevelGearRating(_516.BevelGearRating):
    '''ZerolBevelGearRating
    ...
    @property
    def zerol_bevel_gear(self) -> '_910.ZerolBevelGearDesign':
        ...
        return constructor.new(_910.ZerolBevelGearDesign)(self.wrapped.ZerolBevelGear) if self.wrapped.ZerolBevelGear is not None else None
