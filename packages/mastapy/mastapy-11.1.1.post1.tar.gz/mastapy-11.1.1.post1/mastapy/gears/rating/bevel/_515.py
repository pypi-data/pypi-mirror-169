...
from mastapy.gears.rating.bevel.standards import _521, _519
from mastapy.gears.rating.iso_10300 import _392, _390
...
class BevelGearMeshRating(_526.AGMAGleasonConicalGearMeshRating):
    '''BevelGearMeshRating
    ...
    @property
    def gleason_bevel_mesh_single_flank_rating(self) -> '_521.GleasonSpiralBevelMeshSingleFlankRating':
        ...
        return constructor.new(_521.GleasonSpiralBevelMeshSingleFlankRating)(self.wrapped.GleasonBevelMeshSingleFlankRating) if self.wrapped.GleasonBevelMeshSingleFlankRating is not None else None

    @property
    def agma_bevel_mesh_single_flank_rating(self) -> '_519.AGMASpiralBevelMeshSingleFlankRating':
        ...
        return constructor.new(_519.AGMASpiralBevelMeshSingleFlankRating)(self.wrapped.AGMABevelMeshSingleFlankRating) if self.wrapped.AGMABevelMeshSingleFlankRating is not None else None

    @property
    def iso10300_bevel_mesh_single_flank_rating_method_b1(self) -> '_392.ISO10300MeshSingleFlankRatingMethodB1':
        ...
        return constructor.new(_392.ISO10300MeshSingleFlankRatingMethodB1)(self.wrapped.ISO10300BevelMeshSingleFlankRatingMethodB1) if self.wrapped.ISO10300BevelMeshSingleFlankRatingMethodB1 is not None else None

    @property
    def iso10300_bevel_mesh_single_flank_rating_method_b2(self) -> '_390.Iso10300MeshSingleFlankRatingBevelMethodB2':
        ...
        return constructor.new(_390.Iso10300MeshSingleFlankRatingBevelMethodB2)(self.wrapped.ISO10300BevelMeshSingleFlankRatingMethodB2) if self.wrapped.ISO10300BevelMeshSingleFlankRatingMethodB2 is not None else None
