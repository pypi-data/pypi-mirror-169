...
from mastapy.gears.rating.conical import _502, _501
...
class ConicalGearDutyCycleRating(_325.GearDutyCycleRating):
    '''ConicalGearDutyCycleRating
    ...
    @property
    def gear_set_design_duty_cycle(self) -> '_502.ConicalGearSetDutyCycleRating':
        ...
        return constructor.new(_502.ConicalGearSetDutyCycleRating)(self.wrapped.GearSetDesignDutyCycle) if self.wrapped.GearSetDesignDutyCycle is not None else None

    @property
    def conical_gear_set_design_duty_cycle(self) -> '_502.ConicalGearSetDutyCycleRating':
        ...
        return constructor.new(_502.ConicalGearSetDutyCycleRating)(self.wrapped.ConicalGearSetDesignDutyCycle) if self.wrapped.ConicalGearSetDesignDutyCycle is not None else None
    ...
    @property
    def concave_flank_rating(self) -> '_326.GearFlankRating':
        ...
        if _326.GearFlankRating.TYPE not in self.wrapped.ConcaveFlankRating.__class__.__mro__:
    ...
    @property
    def convex_flank_rating(self) -> '_326.GearFlankRating':
        ...
        if _326.GearFlankRating.TYPE not in self.wrapped.ConvexFlankRating.__class__.__mro__:
    ...
    @property
    def gear_ratings(self) -> 'List[_501.ConicalGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_501.ConicalGearRating))
        return value

    @property
    def conical_gear_ratings(self) -> 'List[_501.ConicalGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalGearRatings, constructor.new(_501.ConicalGearRating))
        return value
