...
class ConicalGearMicroGeometryConfigBase(_1168.GearImplementationDetail):
    '''ConicalGearMicroGeometryConfigBase
    ...
    @property
    def flank_measurement_border(self) -> '_757.FlankMeasurementBorder':
        ...
        return constructor.new(_757.FlankMeasurementBorder)(self.wrapped.FlankMeasurementBorder) if self.wrapped.FlankMeasurementBorder is not None else None
