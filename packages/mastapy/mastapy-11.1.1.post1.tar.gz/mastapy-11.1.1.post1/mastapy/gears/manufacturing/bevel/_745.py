...
from mastapy.gears.manufacturing.bevel import _756, _740
...
class ConicalMeshManufacturingAnalysis(_1170.GearMeshImplementationAnalysis):
    '''ConicalMeshManufacturingAnalysis
    ...
    @property
    def tca(self) -> '_756.EaseOffBasedTCA':
        ...
        return constructor.new(_756.EaseOffBasedTCA)(self.wrapped.TCA) if self.wrapped.TCA is not None else None

    @property
    def meshed_gears(self) -> 'List[_740.ConicalMeshedGearManufacturingAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_740.ConicalMeshedGearManufacturingAnalysis))
        return value
