...
from mastapy.gears.manufacturing.bevel.cutters import _776
from mastapy._internal import constructor
from mastapy.gears.manufacturing.bevel.basic_machine_settings import _782, _783, _784
...
class Wheel(_0.APIBase):
    ...
    @property
    def basic_conical_gear_machine_settings(self) -> '_782.BasicConicalGearMachineSettings':
        ...
        if _782.BasicConicalGearMachineSettings.TYPE not in self.wrapped.BasicConicalGearMachineSettings.__class__.__mro__:
    ...
    @property
    def basic_conical_gear_machine_settings_of_type_basic_conical_gear_machine_settings_formate(self) -> '_783.BasicConicalGearMachineSettingsFormate':
        ...
        if _783.BasicConicalGearMachineSettingsFormate.TYPE not in self.wrapped.BasicConicalGearMachineSettings.__class__.__mro__:
    ...
    @property
    def basic_conical_gear_machine_settings_of_type_basic_conical_gear_machine_settings_generated(self) -> '_784.BasicConicalGearMachineSettingsGenerated':
        ...
        if _784.BasicConicalGearMachineSettingsGenerated.TYPE not in self.wrapped.BasicConicalGearMachineSettings.__class__.__mro__:
