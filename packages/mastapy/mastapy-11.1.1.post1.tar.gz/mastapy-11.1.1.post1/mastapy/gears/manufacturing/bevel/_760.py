...
from mastapy.gears.manufacturing.bevel import _759, _773
...
class ManufacturingMachine(_1600.NamedDatabaseItem):
    '''ManufacturingMachine
    ...
    @property
    def machine_type(self) -> '_759.MachineTypes':
        '''MachineTypes: 'MachineType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.MachineType)
        return constructor.new(_759.MachineTypes)(value) if value is not None else None

    @machine_type.setter
    def machine_type(self, value: '_759.MachineTypes'):
    ...
    @property
    def wheel_formate_machine_type(self) -> '_773.WheelFormatMachineTypes':
        ...
        return constructor.new(_773.WheelFormatMachineTypes)(value) if value is not None else None

    @wheel_formate_machine_type.setter
    def wheel_formate_machine_type(self, value: '_773.WheelFormatMachineTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
