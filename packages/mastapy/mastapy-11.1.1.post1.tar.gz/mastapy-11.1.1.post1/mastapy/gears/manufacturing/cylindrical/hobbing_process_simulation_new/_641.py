...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _646, _633, _660
...
class ProcessCalculation(_0.APIBase):
    ...
    @property
    def inputs(self) -> '_646.ProcessSimulationInput':
        ...
        if _646.ProcessSimulationInput.TYPE not in self.wrapped.Inputs.__class__.__mro__:
    ...
    @property
    def inputs_of_type_hobbing_process_simulation_input(self) -> '_633.HobbingProcessSimulationInput':
        ...
        if _633.HobbingProcessSimulationInput.TYPE not in self.wrapped.Inputs.__class__.__mro__:
    ...
    @property
    def inputs_of_type_worm_grinding_process_simulation_input(self) -> '_660.WormGrindingProcessSimulationInput':
        ...
        if _660.WormGrindingProcessSimulationInput.TYPE not in self.wrapped.Inputs.__class__.__mro__:
