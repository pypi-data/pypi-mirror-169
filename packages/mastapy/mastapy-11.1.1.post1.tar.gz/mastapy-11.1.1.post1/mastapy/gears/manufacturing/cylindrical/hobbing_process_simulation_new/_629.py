...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _621, _627
...
class HobbingProcessLeadCalculation(_627.HobbingProcessCalculation):
    '''HobbingProcessLeadCalculation
