...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _614
...
class WormGrindingCutterCalculation(_655.WormGrindingProcessCalculation):
    '''WormGrindingCutterCalculation
    ...
    @property
    def grinder_tooth_shape_chart(self) -> '_1629.TwoDChartDefinition':
        ...
        if _1629.TwoDChartDefinition.TYPE not in self.wrapped.GrinderToothShapeChart.__class__.__mro__:
    ...
    @property
    def input_gear_point_of_interest(self) -> '_614.PointOfInterest':
        ...
        return constructor.new(_614.PointOfInterest)(self.wrapped.InputGearPointOfInterest) if self.wrapped.InputGearPointOfInterest is not None else None
