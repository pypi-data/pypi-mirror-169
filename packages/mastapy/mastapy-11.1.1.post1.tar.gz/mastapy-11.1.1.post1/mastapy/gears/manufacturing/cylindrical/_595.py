...
from mastapy.gears.manufacturing.cylindrical import _594, _593
...
class MicroGeometryInputsLead(_594.MicroGeometryInputs['_593.LeadModificationSegment']):
    '''MicroGeometryInputsLead
    ...
    @property
    def lead_micro_geometry_range(self) -> '_1290.Range':
        ...
        if _1290.Range.TYPE not in self.wrapped.LeadMicroGeometryRange.__class__.__mro__:
