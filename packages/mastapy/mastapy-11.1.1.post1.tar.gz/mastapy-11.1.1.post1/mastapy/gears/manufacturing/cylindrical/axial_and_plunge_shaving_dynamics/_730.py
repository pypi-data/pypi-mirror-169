...
class ShavingDynamicsConfiguration(_0.APIBase):
    ...
    @property
    def conventional_shaving_dynamics(self) -> '_727.ShavingDynamicsCalculation[_712.ConventionalShavingDynamics]':
        ...
        if _727.ShavingDynamicsCalculation[_712.ConventionalShavingDynamics].TYPE not in self.wrapped.ConventionalShavingDynamics.__class__.__mro__:
    ...
    @property
    def conventional_shaving_dynamics_of_type_conventional_shaving_dynamics_calculation_for_designed_gears(self) -> '_713.ConventionalShavingDynamicsCalculationForDesignedGears':
        ...
        if _713.ConventionalShavingDynamicsCalculationForDesignedGears.TYPE not in self.wrapped.ConventionalShavingDynamics.__class__.__mro__:
    ...
    @property
    def conventional_shaving_dynamics_of_type_conventional_shaving_dynamics_calculation_for_hobbed_gears(self) -> '_714.ConventionalShavingDynamicsCalculationForHobbedGears':
        ...
        if _714.ConventionalShavingDynamicsCalculationForHobbedGears.TYPE not in self.wrapped.ConventionalShavingDynamics.__class__.__mro__:
    ...
    @property
    def conventional_shaving_dynamics_of_type_plunge_shaving_dynamics_calculation_for_designed_gears(self) -> '_719.PlungeShavingDynamicsCalculationForDesignedGears':
        ...
        if _719.PlungeShavingDynamicsCalculationForDesignedGears.TYPE not in self.wrapped.ConventionalShavingDynamics.__class__.__mro__:
    ...
    @property
    def conventional_shaving_dynamics_of_type_plunge_shaving_dynamics_calculation_for_hobbed_gears(self) -> '_720.PlungeShavingDynamicsCalculationForHobbedGears':
        ...
        if _720.PlungeShavingDynamicsCalculationForHobbedGears.TYPE not in self.wrapped.ConventionalShavingDynamics.__class__.__mro__:
    ...
    @property
    def plunge_shaving_dynamics(self) -> '_727.ShavingDynamicsCalculation[_716.PlungeShaverDynamics]':
        ...
        if _727.ShavingDynamicsCalculation[_716.PlungeShaverDynamics].TYPE not in self.wrapped.PlungeShavingDynamics.__class__.__mro__:
    ...
    @property
    def plunge_shaving_dynamics_of_type_conventional_shaving_dynamics_calculation_for_designed_gears(self) -> '_713.ConventionalShavingDynamicsCalculationForDesignedGears':
        ...
        if _713.ConventionalShavingDynamicsCalculationForDesignedGears.TYPE not in self.wrapped.PlungeShavingDynamics.__class__.__mro__:
    ...
    @property
    def plunge_shaving_dynamics_of_type_conventional_shaving_dynamics_calculation_for_hobbed_gears(self) -> '_714.ConventionalShavingDynamicsCalculationForHobbedGears':
        ...
        if _714.ConventionalShavingDynamicsCalculationForHobbedGears.TYPE not in self.wrapped.PlungeShavingDynamics.__class__.__mro__:
    ...
    @property
    def plunge_shaving_dynamics_of_type_plunge_shaving_dynamics_calculation_for_designed_gears(self) -> '_719.PlungeShavingDynamicsCalculationForDesignedGears':
        ...
        if _719.PlungeShavingDynamicsCalculationForDesignedGears.TYPE not in self.wrapped.PlungeShavingDynamics.__class__.__mro__:
    ...
    @property
    def plunge_shaving_dynamics_of_type_plunge_shaving_dynamics_calculation_for_hobbed_gears(self) -> '_720.PlungeShavingDynamicsCalculationForHobbedGears':
        ...
        if _720.PlungeShavingDynamicsCalculationForHobbedGears.TYPE not in self.wrapped.PlungeShavingDynamics.__class__.__mro__:
