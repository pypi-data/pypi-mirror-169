...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _604, _610
...
class PlungeShaverOutputs(_0.APIBase):
    ...
    @property
    def calculation_details(self) -> '_610.PlungeShaverGeneration':
        ...
        return constructor.new(_610.PlungeShaverGeneration)(self.wrapped.CalculationDetails) if self.wrapped.CalculationDetails is not None else None
