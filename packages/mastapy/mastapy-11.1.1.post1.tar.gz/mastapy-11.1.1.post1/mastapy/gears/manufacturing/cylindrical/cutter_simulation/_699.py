...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _685
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _692
...
class FormWheelGrindingSimulationCalculator(_692.CutterSimulationCalc):
    '''FormWheelGrindingSimulationCalculator
    ...
    @property
    def profiled_grinding_wheel(self) -> '_685.CylindricalGearFormedWheelGrinderTangible':
        ...
        return constructor.new(_685.CylindricalGearFormedWheelGrinderTangible)(self.wrapped.ProfiledGrindingWheel) if self.wrapped.ProfiledGrindingWheel is not None else None
