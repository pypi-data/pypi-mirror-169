...
class HobbingProcessSimulationInput(_646.ProcessSimulationInput):
    '''HobbingProcessSimulationInput
    ...
    @property
    def hob_manufacture_error(self) -> '_637.HobManufactureError':
        ...
        return constructor.new(_637.HobManufactureError)(self.wrapped.HobManufactureError) if self.wrapped.HobManufactureError is not None else None

    @property
    def hob_resharpening_error(self) -> '_638.HobResharpeningError':
        ...
        return constructor.new(_638.HobResharpeningError)(self.wrapped.HobResharpeningError) if self.wrapped.HobResharpeningError is not None else None
