...
class CylindricalGearShaper(_679.InvoluteCutterDesign):
    '''CylindricalGearShaper
    ...
    @property
    def shaper_edge_type(self) -> '_1030.ShaperEdgeTypes':
        ...
        return constructor.new(_1030.ShaperEdgeTypes)(value) if value is not None else None

    @shaper_edge_type.setter
    def shaper_edge_type(self, value: '_1030.ShaperEdgeTypes'):
