...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _652, _646
...
class WormGrindingProcessSimulationInput(_646.ProcessSimulationInput):
    '''WormGrindingProcessSimulationInput
    ...
    @property
    def worm_grinder_manufacture_error(self) -> '_652.WormGrinderManufactureError':
        ...
        return constructor.new(_652.WormGrinderManufactureError)(self.wrapped.WormGrinderManufactureError) if self.wrapped.WormGrinderManufactureError is not None else None
