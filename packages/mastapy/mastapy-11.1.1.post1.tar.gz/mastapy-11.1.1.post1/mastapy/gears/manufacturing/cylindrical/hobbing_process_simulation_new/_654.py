...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _621, _655
...
class WormGrindingLeadCalculation(_655.WormGrindingProcessCalculation):
    '''WormGrindingLeadCalculation
    ...
    @property
    def right_flank(self) -> '_621.CalculateLeadDeviationAccuracy':
        ...
        return constructor.new(_621.CalculateLeadDeviationAccuracy)(self.wrapped.RightFlank) if self.wrapped.RightFlank is not None else None

    @property
    def left_flank(self) -> '_621.CalculateLeadDeviationAccuracy':
        ...
        return constructor.new(_621.CalculateLeadDeviationAccuracy)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank is not None else None
