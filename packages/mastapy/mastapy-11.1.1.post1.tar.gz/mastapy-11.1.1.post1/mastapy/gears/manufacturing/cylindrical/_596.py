...
from mastapy.gears.manufacturing.cylindrical import _594, _598
...
class MicroGeometryInputsProfile(_594.MicroGeometryInputs['_598.ProfileModificationSegment']):
    '''MicroGeometryInputsProfile
    ...
    @property
    def profile_micro_geometry_range(self) -> '_1290.Range':
        ...
        if _1290.Range.TYPE not in self.wrapped.ProfileMicroGeometryRange.__class__.__mro__:
