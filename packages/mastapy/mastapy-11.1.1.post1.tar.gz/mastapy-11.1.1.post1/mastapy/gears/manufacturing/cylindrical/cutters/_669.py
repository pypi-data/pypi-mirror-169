...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _689, _691, _686
...
class CylindricalGearGrindingWorm(_673.CylindricalGearRackDesign):
    '''CylindricalGearGrindingWorm
    ...
    @property
    def nominal_worm_grinder_shape(self) -> '_689.CylindricalGearWormGrinderShape':
        ...
        return constructor.new(_689.CylindricalGearWormGrinderShape)(self.wrapped.NominalWormGrinderShape) if self.wrapped.NominalWormGrinderShape is not None else None
