...
from mastapy.gears.ltca import _810, _804
...
class GearMeshLoadDistributionAtRotation(_0.APIBase):
    ...
    @property
    def gear_a_in_mesh(self) -> '_810.MeshedGearLoadDistributionAnalysisAtRotation':
        ...
        return constructor.new(_810.MeshedGearLoadDistributionAnalysisAtRotation)(self.wrapped.GearAInMesh) if self.wrapped.GearAInMesh is not None else None

    @property
    def gear_b_in_mesh(self) -> '_810.MeshedGearLoadDistributionAnalysisAtRotation':
        ...
        return constructor.new(_810.MeshedGearLoadDistributionAnalysisAtRotation)(self.wrapped.GearBInMesh) if self.wrapped.GearBInMesh is not None else None

    @property
    def loaded_contact_lines(self) -> 'List[_804.GearMeshLoadedContactLine]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadedContactLines, constructor.new(_804.GearMeshLoadedContactLine))
        return value

    @property
    def meshed_gears(self) -> 'List[_810.MeshedGearLoadDistributionAnalysisAtRotation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_810.MeshedGearLoadDistributionAnalysisAtRotation))
        return value
