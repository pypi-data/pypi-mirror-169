...
from mastapy.gears.rating.cylindrical import _441, _426
from mastapy.gears.gear_designs.cylindrical import _1038, _974
from mastapy.materials import _238, _227
...
class GearSetDesignGroup(_0.APIBase):
    ...
    @property
    def misalignment_contact_pattern_enhancement(self) -> '_441.MisalignmentContactPatternEnhancements':
        ...
        return constructor.new(_441.MisalignmentContactPatternEnhancements)(value) if value is not None else None

    @misalignment_contact_pattern_enhancement.setter
    def misalignment_contact_pattern_enhancement(self, value: '_441.MisalignmentContactPatternEnhancements'):
    ...
    @property
    def default_rough_toleranced_metal_measurement(self) -> '_1038.TolerancedMetalMeasurements':
        ...
        return constructor.new(_1038.TolerancedMetalMeasurements)(value) if value is not None else None

    @default_rough_toleranced_metal_measurement.setter
    def default_rough_toleranced_metal_measurement(self, value: '_1038.TolerancedMetalMeasurements'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def general_transmission_properties(self) -> '_227.GeneralTransmissionProperties':
        ...
        return constructor.new(_227.GeneralTransmissionProperties)(self.wrapped.GeneralTransmissionProperties) if self.wrapped.GeneralTransmissionProperties is not None else None

    @property
    def settings(self) -> '_426.CylindricalGearRatingSettings':
        ...
        return constructor.new(_426.CylindricalGearRatingSettings)(self.wrapped.Settings) if self.wrapped.Settings is not None else None
