...
from mastapy.gears.rating.hypoid import _408
from mastapy.gears.rating.iso_10300 import _395, _387, _402
...
class BevelHypoidGearRatingSettings(_1390.PerMachineSettings):
    '''BevelHypoidGearRatingSettings
    ...
    @property
    def bevel_gear_rating_method(self) -> '_566.RatingMethods':
        ...
        return constructor.new(_566.RatingMethods)(value) if value is not None else None

    @bevel_gear_rating_method.setter
    def bevel_gear_rating_method(self, value: '_566.RatingMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.BevelGearRatingMethod = value

    @property
    def hypoid_gear_rating_method(self) -> '_408.HypoidRatingMethod':
        ...
        return constructor.new(_408.HypoidRatingMethod)(value) if value is not None else None

    @hypoid_gear_rating_method.setter
    def hypoid_gear_rating_method(self, value: '_408.HypoidRatingMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def iso_rating_method_for_bevel_gears(self) -> '_395.ISO10300RatingMethod':
        ...
        return constructor.new(_395.ISO10300RatingMethod)(value) if value is not None else None

    @iso_rating_method_for_bevel_gears.setter
    def iso_rating_method_for_bevel_gears(self, value: '_395.ISO10300RatingMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ISORatingMethodForBevelGears = value

    @property
    def iso_rating_method_for_hypoid_gears(self) -> '_395.ISO10300RatingMethod':
    ...
    def iso_rating_method_for_hypoid_gears(self, value: '_395.ISO10300RatingMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ISORatingMethodForHypoidGears = value

    @property
    def bevel_general_load_factors_k_method(self) -> '_387.GeneralLoadFactorCalculationMethod':
        ...
        return constructor.new(_387.GeneralLoadFactorCalculationMethod)(value) if value is not None else None

    @bevel_general_load_factors_k_method.setter
    def bevel_general_load_factors_k_method(self, value: '_387.GeneralLoadFactorCalculationMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.BevelGeneralLoadFactorsKMethod = value

    @property
    def hypoid_general_load_factors_k_method(self) -> '_387.GeneralLoadFactorCalculationMethod':
    ...
    def hypoid_general_load_factors_k_method(self, value: '_387.GeneralLoadFactorCalculationMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HypoidGeneralLoadFactorsKMethod = value

    @property
    def bevel_pitting_factor_calculation_method(self) -> '_402.PittingFactorCalculationMethod':
        ...
        return constructor.new(_402.PittingFactorCalculationMethod)(value) if value is not None else None

    @bevel_pitting_factor_calculation_method.setter
    def bevel_pitting_factor_calculation_method(self, value: '_402.PittingFactorCalculationMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.BevelPittingFactorCalculationMethod = value

    @property
    def hypoid_pitting_factor_calculation_method(self) -> '_402.PittingFactorCalculationMethod':
    ...
    def hypoid_pitting_factor_calculation_method(self, value: '_402.PittingFactorCalculationMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
