...
class ConicalGearCutter(_0.APIBase):
    ...
    @property
    def cutter_gauge_length(self) -> '_1111.CutterGaugeLengths':
        ...
        return constructor.new(_1111.CutterGaugeLengths)(value) if value is not None else None

    @cutter_gauge_length.setter
    def cutter_gauge_length(self, value: '_1111.CutterGaugeLengths'):
    ...
    @property
    def cutter_blade_type(self) -> '_1110.CutterBladeType':
        ...
        return constructor.new(_1110.CutterBladeType)(value) if value is not None else None

    @cutter_blade_type.setter
    def cutter_blade_type(self, value: '_1110.CutterBladeType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.CutterBladeType = value

    @property
    def input_toprem_as(self) -> '_1119.TopremEntryType':
        ...
        return constructor.new(_1119.TopremEntryType)(value) if value is not None else None

    @input_toprem_as.setter
    def input_toprem_as(self, value: '_1119.TopremEntryType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.InputTopremAs = value

    @property
    def outer_toprem_letter_concave(self) -> '_1120.TopremLetter':
        ...
        return constructor.new(_1120.TopremLetter)(value) if value is not None else None

    @outer_toprem_letter_concave.setter
    def outer_toprem_letter_concave(self, value: '_1120.TopremLetter'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.OuterTopremLetterConcave = value

    @property
    def inner_toprem_letter_convex(self) -> '_1120.TopremLetter':
    ...
    def inner_toprem_letter_convex(self, value: '_1120.TopremLetter'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
