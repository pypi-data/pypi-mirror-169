...
from mastapy.gears import _315, _312
from mastapy.gears.gear_designs.conical import _1114, _1105
from mastapy.gleason_smt_link import _274
...
class AGMAGleasonConicalGearSetDesign(_1105.ConicalGearSetDesign):
    '''AGMAGleasonConicalGearSetDesign
    ...
    @property
    def tooth_taper(self) -> '_315.SpiralBevelToothTaper':
        ...
        return constructor.new(_315.SpiralBevelToothTaper)(value) if value is not None else None

    @tooth_taper.setter
    def tooth_taper(self, value: '_315.SpiralBevelToothTaper'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ToothTaper = value

    @property
    def reliability_requirement_gleason(self) -> '_1114.GleasonSafetyRequirements':
        ...
        return constructor.new(_1114.GleasonSafetyRequirements)(value) if value is not None else None

    @reliability_requirement_gleason.setter
    def reliability_requirement_gleason(self, value: '_1114.GleasonSafetyRequirements'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ReliabilityRequirementGleason = value

    @property
    def reliability_requirement_agma(self) -> '_312.SafetyRequirementsAGMA':
        ...
        return constructor.new(_312.SafetyRequirementsAGMA)(value) if value is not None else None

    @reliability_requirement_agma.setter
    def reliability_requirement_agma(self, value: '_312.SafetyRequirementsAGMA'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def manufacturing_method(self) -> '_274.CutterMethod':
        ...
        return constructor.new(_274.CutterMethod)(value) if value is not None else None

    @manufacturing_method.setter
    def manufacturing_method(self, value: '_274.CutterMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def conical_meshes(self) -> 'List[_1143.AGMAGleasonConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshes, constructor.new(_1143.AGMAGleasonConicalGearMeshDesign))
        return value

    @property
    def meshes(self) -> 'List[_1143.AGMAGleasonConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_1143.AGMAGleasonConicalGearMeshDesign))
        return value
