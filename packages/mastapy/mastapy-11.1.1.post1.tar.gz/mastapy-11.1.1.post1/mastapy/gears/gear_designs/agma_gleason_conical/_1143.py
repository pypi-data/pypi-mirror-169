...
from mastapy.gears.gear_designs.conical import _1118, _1104
...
class AGMAGleasonConicalGearMeshDesign(_1104.ConicalGearMeshDesign):
    '''AGMAGleasonConicalGearMeshDesign
    ...
    @property
    def profile_crowning_setting(self) -> '_403.ProfileCrowningSetting':
        ...
        return constructor.new(_403.ProfileCrowningSetting)(value) if value is not None else None

    @profile_crowning_setting.setter
    def profile_crowning_setting(self, value: '_403.ProfileCrowningSetting'):
    ...
    @property
    def mounting_conditions_of_pinion_and_wheel(self) -> '_401.MountingConditionsOfPinionAndWheel':
        ...
        return constructor.new(_401.MountingConditionsOfPinionAndWheel)(value) if value is not None else None

    @mounting_conditions_of_pinion_and_wheel.setter
    def mounting_conditions_of_pinion_and_wheel(self, value: '_401.MountingConditionsOfPinionAndWheel'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.MountingConditionsOfPinionAndWheel = value

    @property
    def verification_of_contact_pattern(self) -> '_404.VerificationOfContactPattern':
        ...
        return constructor.new(_404.VerificationOfContactPattern)(value) if value is not None else None

    @verification_of_contact_pattern.setter
    def verification_of_contact_pattern(self, value: '_404.VerificationOfContactPattern'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.VerificationOfContactPattern = value

    @property
    def iso10300_gear_set_finishing_methods(self) -> '_388.Iso10300FinishingMethods':
        ...
        return constructor.new(_388.Iso10300FinishingMethods)(value) if value is not None else None

    @iso10300_gear_set_finishing_methods.setter
    def iso10300_gear_set_finishing_methods(self, value: '_388.Iso10300FinishingMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
