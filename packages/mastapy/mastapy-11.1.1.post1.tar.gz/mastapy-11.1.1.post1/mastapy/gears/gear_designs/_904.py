...
class DesignConstraintsCollection(_1600.NamedDatabaseItem):
    '''DesignConstraintsCollection
    ...
    @property
    def design_constraints(self) -> 'List[_1607.DeletableCollectionMember[_902.DesignConstraint]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignConstraints, constructor.new(_1607.DeletableCollectionMember)[_902.DesignConstraint])
        return value
