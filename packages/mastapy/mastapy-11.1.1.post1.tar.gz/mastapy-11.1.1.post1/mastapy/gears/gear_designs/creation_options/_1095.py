...
from mastapy.gears.gear_designs.creation_options import _1096
...
class CylindricalGearPairCreationOptions(_1096.GearSetCreationOptions['_985.CylindricalGearSetDesign']):
    '''CylindricalGearPairCreationOptions
