...
from mastapy.gears.fe_model.cylindrical import _1152
from mastapy._internal.cast_exception import CastException
from mastapy.gears.fe_model.conical import _1155
...
class GearSetDesign(_906.GearDesignComponent):
    '''GearSetDesign
    ...
    @property
    def transmission_properties_gears(self) -> '_295.GearSetDesignGroup':
        ...
        return constructor.new(_295.GearSetDesignGroup)(self.wrapped.TransmissionPropertiesGears) if self.wrapped.TransmissionPropertiesGears is not None else None

    @property
    def active_ltcafe_model(self) -> '_1149.GearSetFEModel':
        ...
        if _1149.GearSetFEModel.TYPE not in self.wrapped.ActiveLTCAFEModel.__class__.__mro__:
    ...
    @property
    def active_ltcafe_model_of_type_cylindrical_gear_set_fe_model(self) -> '_1152.CylindricalGearSetFEModel':
        ...
        if _1152.CylindricalGearSetFEModel.TYPE not in self.wrapped.ActiveLTCAFEModel.__class__.__mro__:
    ...
    @property
    def active_ltcafe_model_of_type_conical_set_fe_model(self) -> '_1155.ConicalSetFEModel':
        ...
        if _1155.ConicalSetFEModel.TYPE not in self.wrapped.ActiveLTCAFEModel.__class__.__mro__:
    ...
    @property
    def tifffe_model(self) -> '_1149.GearSetFEModel':
        ...
        if _1149.GearSetFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
    ...
    @property
    def tifffe_model_of_type_cylindrical_gear_set_fe_model(self) -> '_1152.CylindricalGearSetFEModel':
        ...
        if _1152.CylindricalGearSetFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
    ...
    @property
    def tifffe_model_of_type_conical_set_fe_model(self) -> '_1155.ConicalSetFEModel':
        ...
        if _1155.ConicalSetFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
    ...
    @property
    def gears(self) -> 'List[_905.GearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_905.GearDesign))
        return value

    @property
    def ltcafe_models(self) -> 'List[_1149.GearSetFEModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LTCAFEModels, constructor.new(_1149.GearSetFEModel))
        return value
