...
from mastapy.gears.fe_model import _1146
...
class GearDesign(_906.GearDesignComponent):
    '''GearDesign
    ...
    @property
    def tifffe_model(self) -> '_1146.GearFEModel':
        ...
        if _1146.GearFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
    ...
    @property
    def tifffe_model_of_type_cylindrical_gear_fe_model(self) -> '_1150.CylindricalGearFEModel':
        ...
        if _1150.CylindricalGearFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
    ...
    @property
    def tifffe_model_of_type_conical_gear_fe_model(self) -> '_1153.ConicalGearFEModel':
        ...
        if _1153.ConicalGearFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
