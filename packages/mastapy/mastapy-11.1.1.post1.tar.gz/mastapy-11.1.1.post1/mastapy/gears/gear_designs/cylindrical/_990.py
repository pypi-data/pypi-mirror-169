...
class CylindricalGearTableWithMGCharts(_1554.CustomTable):
    '''CylindricalGearTableWithMGCharts
    ...
    @property
    def item_detail(self) -> '_989.CylindricalGearTableMGItemDetail':
        ...
        return constructor.new(_989.CylindricalGearTableMGItemDetail)(value) if value is not None else None

    @item_detail.setter
    def item_detail(self, value: '_989.CylindricalGearTableMGItemDetail'):
