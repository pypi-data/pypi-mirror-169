...
class CrossedAxisCylindricalGearPair(_0.APIBase):
    ...
    @property
    def shaver(self) -> '_693.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_693.CylindricalCutterSimulatableGear)(self.wrapped.Shaver) if self.wrapped.Shaver is not None else None
