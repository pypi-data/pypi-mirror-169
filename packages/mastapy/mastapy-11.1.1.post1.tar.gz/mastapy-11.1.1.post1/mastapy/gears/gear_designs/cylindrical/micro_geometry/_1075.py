...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1080
...
class ParabolicCylindricalGearTriangularEndModification(_1080.SingleCylindricalGearTriangularEndModification):
    '''ParabolicCylindricalGearTriangularEndModification
