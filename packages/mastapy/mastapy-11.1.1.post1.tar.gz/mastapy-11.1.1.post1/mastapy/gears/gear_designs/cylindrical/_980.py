...
from mastapy.gears.gear_designs.cylindrical import _981, _964
...
class CylindricalGearPinionTypeCutter(_964.CylindricalGearAbstractRack):
    '''CylindricalGearPinionTypeCutter
    ...
    @property
    def left_flank(self) -> '_981.CylindricalGearPinionTypeCutterFlank':
        ...
        return constructor.new(_981.CylindricalGearPinionTypeCutterFlank)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank is not None else None

    @property
    def right_flank(self) -> '_981.CylindricalGearPinionTypeCutterFlank':
        ...
        return constructor.new(_981.CylindricalGearPinionTypeCutterFlank)(self.wrapped.RightFlank) if self.wrapped.RightFlank is not None else None
