...
from mastapy.gears.gear_designs.cylindrical import _1021, _1020, _970
...
class CylindricalPlanetGearDesign(_970.CylindricalGearDesign):
    '''CylindricalPlanetGearDesign
    ...
    @property
    def planetary_details(self) -> '_307.PlanetaryDetail':
        ...
        return constructor.new(_307.PlanetaryDetail)(self.wrapped.PlanetaryDetails) if self.wrapped.PlanetaryDetails is not None else None

    @property
    def planetary_sidebands_amplitude_factors(self) -> 'List[_1021.NamedPlanetSideBandAmplitudeFactor]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetarySidebandsAmplitudeFactors, constructor.new(_1021.NamedPlanetSideBandAmplitudeFactor))
        return value

    @property
    def planet_assembly_indices(self) -> 'List[_1020.NamedPlanetAssemblyIndex]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetAssemblyIndices, constructor.new(_1020.NamedPlanetAssemblyIndex))
        return value
