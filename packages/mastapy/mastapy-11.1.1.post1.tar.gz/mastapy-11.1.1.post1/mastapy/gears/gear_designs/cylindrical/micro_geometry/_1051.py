...
class CylindricalGearLeadModificationAtProfilePosition(_1050.CylindricalGearLeadModification):
    '''CylindricalGearLeadModificationAtProfilePosition
    ...
    @property
    def profile_measurement(self) -> '_982.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_982.CylindricalGearProfileMeasurement)(self.wrapped.ProfileMeasurement) if self.wrapped.ProfileMeasurement is not None else None
