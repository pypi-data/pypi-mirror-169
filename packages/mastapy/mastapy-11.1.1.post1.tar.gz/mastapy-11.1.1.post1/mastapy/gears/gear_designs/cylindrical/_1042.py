...
from mastapy.gears.gear_designs.cylindrical import _991
from mastapy.utility.units_and_measurements.measurements import _1455, _1471
...
class ToothThicknessSpecificationBase(_0.APIBase):
    ...
    @property
    def normal_thickness(self) -> '_991.CylindricalGearToothThicknessSpecification[_1455.LengthShort]':
        ...
        return constructor.new(_991.CylindricalGearToothThicknessSpecification)[_1455.LengthShort](self.wrapped.NormalThickness) if self.wrapped.NormalThickness is not None else None

    @property
    def normal_thickness_at_specified_diameter(self) -> '_991.CylindricalGearToothThicknessSpecification[_1455.LengthShort]':
        ...
        return constructor.new(_991.CylindricalGearToothThicknessSpecification)[_1455.LengthShort](self.wrapped.NormalThicknessAtSpecifiedDiameter) if self.wrapped.NormalThicknessAtSpecifiedDiameter is not None else None

    @property
    def chordal_span(self) -> '_991.CylindricalGearToothThicknessSpecification[_1455.LengthShort]':
        ...
        return constructor.new(_991.CylindricalGearToothThicknessSpecification)[_1455.LengthShort](self.wrapped.ChordalSpan) if self.wrapped.ChordalSpan is not None else None

    @property
    def over_balls(self) -> '_991.CylindricalGearToothThicknessSpecification[_1455.LengthShort]':
        ...
        return constructor.new(_991.CylindricalGearToothThicknessSpecification)[_1455.LengthShort](self.wrapped.OverBalls) if self.wrapped.OverBalls is not None else None

    @property
    def transverse_thickness(self) -> '_991.CylindricalGearToothThicknessSpecification[_1455.LengthShort]':
        ...
        return constructor.new(_991.CylindricalGearToothThicknessSpecification)[_1455.LengthShort](self.wrapped.TransverseThickness) if self.wrapped.TransverseThickness is not None else None

    @property
    def transverse_thickness_at_specified_diameter(self) -> '_991.CylindricalGearToothThicknessSpecification[_1455.LengthShort]':
        ...
        return constructor.new(_991.CylindricalGearToothThicknessSpecification)[_1455.LengthShort](self.wrapped.TransverseThicknessAtSpecifiedDiameter) if self.wrapped.TransverseThicknessAtSpecifiedDiameter is not None else None

    @property
    def profile_shift_coefficient(self) -> '_991.CylindricalGearToothThicknessSpecification[_1471.Number]':
        ...
        return constructor.new(_991.CylindricalGearToothThicknessSpecification)[_1471.Number](self.wrapped.ProfileShiftCoefficient) if self.wrapped.ProfileShiftCoefficient is not None else None

    @property
    def profile_shift(self) -> '_991.CylindricalGearToothThicknessSpecification[_1455.LengthShort]':
        ...
        return constructor.new(_991.CylindricalGearToothThicknessSpecification)[_1455.LengthShort](self.wrapped.ProfileShift) if self.wrapped.ProfileShift is not None else None

    @property
    def tooth_thickness(self) -> 'List[_991.CylindricalGearToothThicknessSpecification[_1455.LengthShort]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ToothThickness, constructor.new(_991.CylindricalGearToothThicknessSpecification)[_1455.LengthShort])
        return value
