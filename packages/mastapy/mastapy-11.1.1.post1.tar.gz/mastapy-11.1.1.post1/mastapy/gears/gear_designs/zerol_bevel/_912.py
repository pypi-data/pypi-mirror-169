...
from mastapy.gears.gear_designs.zerol_bevel import _910, _911
...
class ZerolBevelGearSetDesign(_1131.BevelGearSetDesign):
    '''ZerolBevelGearSetDesign
    ...
    @property
    def tooth_taper_zerol(self) -> '_319.ZerolBevelGleasonToothTaperOption':
        ...
        return constructor.new(_319.ZerolBevelGleasonToothTaperOption)(value) if value is not None else None

    @tooth_taper_zerol.setter
    def tooth_taper_zerol(self, value: '_319.ZerolBevelGleasonToothTaperOption'):
    ...
    @property
    def gears(self) -> 'List[_910.ZerolBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_910.ZerolBevelGearDesign))
        return value
    ...
    @property
    def zerol_bevel_meshes(self) -> 'List[_911.ZerolBevelGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshes, constructor.new(_911.ZerolBevelGearMeshDesign))
        return value
