...
from mastapy.gears.gear_designs.conical import _1117, _1105
...
class KlingelnbergConicalGearSetDesign(_1105.ConicalGearSetDesign):
    '''KlingelnbergConicalGearSetDesign
    ...
    @property
    def gear_finish(self) -> '_1117.KlingelnbergFinishingMethods':
        ...
        return constructor.new(_1117.KlingelnbergFinishingMethods)(value) if value is not None else None

    @gear_finish.setter
    def gear_finish(self, value: '_1117.KlingelnbergFinishingMethods'):
    ...
    @property
    def conical_meshes(self) -> 'List[_940.KlingelnbergConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshes, constructor.new(_940.KlingelnbergConicalGearMeshDesign))
        return value

    @property
    def klingelnberg_conical_meshes(self) -> 'List[_940.KlingelnbergConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergConicalMeshes, constructor.new(_940.KlingelnbergConicalGearMeshDesign))
        return value
