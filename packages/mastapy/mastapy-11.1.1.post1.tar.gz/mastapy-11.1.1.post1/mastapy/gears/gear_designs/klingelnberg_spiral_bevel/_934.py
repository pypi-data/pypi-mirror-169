...
from mastapy.gears.gear_designs.klingelnberg_conical import _942
...
class KlingelnbergCycloPalloidSpiralBevelMeshedGearDesign(_942.KlingelnbergConicalMeshedGearDesign):
    '''KlingelnbergCycloPalloidSpiralBevelMeshedGearDesign
