...
from mastapy.gears.gear_designs.klingelnberg_spiral_bevel import _933, _931, _934
...
class KlingelnbergCycloPalloidSpiralBevelGearMeshDesign(_940.KlingelnbergConicalGearMeshDesign):
    '''KlingelnbergCycloPalloidSpiralBevelGearMeshDesign
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshed_gears(self) -> 'List[_934.KlingelnbergCycloPalloidSpiralBevelMeshedGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidSpiralBevelMeshedGears, constructor.new(_934.KlingelnbergCycloPalloidSpiralBevelMeshedGearDesign))
        return value
