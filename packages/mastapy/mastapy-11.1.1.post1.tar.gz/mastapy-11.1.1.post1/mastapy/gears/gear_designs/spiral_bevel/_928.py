...
from mastapy.gears.gear_designs.spiral_bevel import _929, _927, _930
...
class SpiralBevelGearMeshDesign(_1130.BevelGearMeshDesign):
    '''SpiralBevelGearMeshDesign
    ...
    @property
    def spiral_bevel_meshed_gears(self) -> 'List[_930.SpiralBevelMeshedGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshedGears, constructor.new(_930.SpiralBevelMeshedGearDesign))
        return value
