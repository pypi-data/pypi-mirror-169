...
from mastapy.materials import _257, _254, _255
...
class PlasticSNCurve(_0.APIBase):
    ...
    @property
    def lubricant(self) -> '_257.VDI2736LubricantType':
        ...
        return constructor.new(_257.VDI2736LubricantType)(value) if value is not None else None

    @lubricant.setter
    def lubricant(self, value: '_257.VDI2736LubricantType'):
    ...
    @property
    def material(self) -> '_564.PlasticCylindricalGearMaterial':
        ...
        return constructor.new(_564.PlasticCylindricalGearMaterial)(self.wrapped.Material) if self.wrapped.Material is not None else None

    @property
    def bending_stress_cycle_data(self) -> 'List[_254.StressCyclesDataForTheBendingSNCurveOfAPlasticMaterial]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BendingStressCycleData, constructor.new(_254.StressCyclesDataForTheBendingSNCurveOfAPlasticMaterial))
        return value

    @property
    def contact_stress_cycle_data(self) -> 'List[_255.StressCyclesDataForTheContactSNCurveOfAPlasticMaterial]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ContactStressCycleData, constructor.new(_255.StressCyclesDataForTheContactSNCurveOfAPlasticMaterial))
        return value

    @property
    def bending_stress_cycle_data_for_damage_tables(self) -> 'List[_254.StressCyclesDataForTheBendingSNCurveOfAPlasticMaterial]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BendingStressCycleDataForDamageTables, constructor.new(_254.StressCyclesDataForTheBendingSNCurveOfAPlasticMaterial))
        return value

    @property
    def contact_stress_cycle_data_for_damage_tables(self) -> 'List[_255.StressCyclesDataForTheContactSNCurveOfAPlasticMaterial]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ContactStressCycleDataForDamageTables, constructor.new(_255.StressCyclesDataForTheContactSNCurveOfAPlasticMaterial))
        return value
