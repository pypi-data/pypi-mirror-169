...
from mastapy.gears.materials import _569, _555
...
class BevelGearMaterial(_555.GearMaterial):
    '''BevelGearMaterial
    ...
    @property
    def sn_curve_definition(self) -> '_569.SNCurveDefinition':
        ...
        return constructor.new(_569.SNCurveDefinition)(value) if value is not None else None

    @sn_curve_definition.setter
    def sn_curve_definition(self, value: '_569.SNCurveDefinition'):
