...
class ISOCylindricalGearMaterial(_552.CylindricalGearMaterial):
    '''ISOCylindricalGearMaterial
    ...
    @property
    def quality_grade(self) -> '_247.QualityGrade':
        '''QualityGrade: 'QualityGrade' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.QualityGrade)
        return constructor.new(_247.QualityGrade)(value) if value is not None else None

    @quality_grade.setter
    def quality_grade(self, value: '_247.QualityGrade'):
