...
from mastapy.materials import _213, _214, _215
...
class AGMACylindricalGearMaterial(_552.CylindricalGearMaterial):
    '''AGMACylindricalGearMaterial
    ...
    @property
    def material_application(self) -> '_213.AGMAMaterialApplications':
        ...
        return constructor.new(_213.AGMAMaterialApplications)(value) if value is not None else None

    @material_application.setter
    def material_application(self, value: '_213.AGMAMaterialApplications'):
    ...
    @property
    def material_class(self) -> '_214.AGMAMaterialClasses':
        ...
        return constructor.new(_214.AGMAMaterialClasses)(value) if value is not None else None

    @material_class.setter
    def material_class(self, value: '_214.AGMAMaterialClasses'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.MaterialClass = value

    @property
    def grade(self) -> '_215.AGMAMaterialGrade':
        '''AGMAMaterialGrade: 'Grade' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Grade)
        return constructor.new(_215.AGMAMaterialGrade)(value) if value is not None else None

    @grade.setter
    def grade(self, value: '_215.AGMAMaterialGrade'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
