...
from mastapy.gears.materials import _563, _555
...
class CylindricalGearMaterial(_555.GearMaterial):
    '''CylindricalGearMaterial
    ...
    @property
    def heat_treatment_process_development(self) -> '_563.ManufactureRating':
        ...
        return constructor.new(_563.ManufactureRating)(value) if value is not None else None

    @heat_treatment_process_development.setter
    def heat_treatment_process_development(self, value: '_563.ManufactureRating'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HeatTreatmentProcessDevelopment = value

    @property
    def heat_treatment_distortion_control(self) -> '_563.ManufactureRating':
    ...
    def heat_treatment_distortion_control(self, value: '_563.ManufactureRating'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HeatTreatmentDistortionControl = value

    @property
    def machine_process_development(self) -> '_563.ManufactureRating':
    ...
    def machine_process_development(self, value: '_563.ManufactureRating'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.MachineProcessDevelopment = value

    @property
    def manufacturability(self) -> '_563.ManufactureRating':
    ...
    def manufacturability(self, value: '_563.ManufactureRating'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
