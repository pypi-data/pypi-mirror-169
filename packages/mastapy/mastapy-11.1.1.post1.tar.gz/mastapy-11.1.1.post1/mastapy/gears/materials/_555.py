...
from mastapy.materials import _250, _240
...
class GearMaterial(_240.Material):
    '''GearMaterial
    ...
    @property
    def sn_curve_contact(self) -> '_250.SNCurve':
        ...
        return constructor.new(_250.SNCurve)(self.wrapped.SNCurveContact) if self.wrapped.SNCurveContact is not None else None

    @property
    def sn_curve_bending(self) -> '_250.SNCurve':
        ...
        return constructor.new(_250.SNCurve)(self.wrapped.SNCurveBending) if self.wrapped.SNCurveBending is not None else None
