...
from mastapy.gears.gear_two_d_fe_analysis import _861
...
class CylindricalGearTIFFAnalysisDutyCycle(_1165.GearDesignAnalysis):
    '''CylindricalGearTIFFAnalysisDutyCycle
    ...
    @property
    def analysis(self) -> '_861.CylindricalGearTwoDimensionalFEAnalysis':
        ...
        return constructor.new(_861.CylindricalGearTwoDimensionalFEAnalysis)(self.wrapped.Analysis) if self.wrapped.Analysis is not None else None
