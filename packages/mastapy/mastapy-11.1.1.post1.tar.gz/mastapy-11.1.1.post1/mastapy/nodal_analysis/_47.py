...
class AnalysisSettingsObjects(_1600.NamedDatabaseItem):
    '''AnalysisSettingsObjects
    ...
    def rating_type_for_bearing_reliability(self) -> '_77.RatingTypeForBearingReliability':
        ...
        return constructor.new(_77.RatingTypeForBearingReliability)(value) if value is not None else None
    ...
    def rating_type_for_shaft_reliability(self) -> '_78.RatingTypeForShaftReliability':
        ...
        return constructor.new(_78.RatingTypeForShaftReliability)(value) if value is not None else None
