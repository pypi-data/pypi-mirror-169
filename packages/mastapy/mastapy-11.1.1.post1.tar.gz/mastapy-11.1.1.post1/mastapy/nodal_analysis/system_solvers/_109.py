...
class SingularValuesAnalysis(_0.APIBase):
    ...
    def smallest_singular_vectors(self) -> 'List[_110.SingularVectorAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SmallestSingularVectors, constructor.new(_110.SingularVectorAnalysis))
        return value
    ...
    def largest_singular_vectors(self) -> 'List[_110.SingularVectorAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LargestSingularVectors, constructor.new(_110.SingularVectorAnalysis))
        return value
