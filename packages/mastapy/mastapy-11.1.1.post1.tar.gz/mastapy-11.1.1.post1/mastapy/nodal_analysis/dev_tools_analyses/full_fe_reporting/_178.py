...
from mastapy.fe_tools.vis_tools_visualisation.enums import _1179
...
class CoordinateSystemReporting(_0.APIBase):
    ...
    @property
    def type_(self) -> '_1179.CoordinateSystemType':
        ...
        return constructor.new(_1179.CoordinateSystemType)(value) if value is not None else None
