...
class FEStiffness(_0.APIBase):
    ...
    def stiffness_in_fe_coordinate_system_mn_rad(self) -> '_75.NodalMatrix':
        ...
        return constructor.new(_75.NodalMatrix)(self.wrapped.StiffnessInFECoordinateSystemMNRad) if self.wrapped.StiffnessInFECoordinateSystemMNRad is not None else None
    ...
    def mass_matrix_mn_rad_s_kg(self) -> '_75.NodalMatrix':
        ...
        return constructor.new(_75.NodalMatrix)(self.wrapped.MassMatrixMNRadSKg) if self.wrapped.MassMatrixMNRadSKg is not None else None
    ...
    def stiffness_matrix(self) -> '_75.NodalMatrix':
        ...
        return constructor.new(_75.NodalMatrix)(self.wrapped.StiffnessMatrix) if self.wrapped.StiffnessMatrix is not None else None
