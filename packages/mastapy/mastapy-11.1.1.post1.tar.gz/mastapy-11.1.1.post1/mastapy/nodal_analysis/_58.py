...
class FEMeshingOptions(_0.APIBase):
    ...
    def element_shape(self) -> '_88.VolumeElementShape':
        ...
        return constructor.new(_88.VolumeElementShape)(value) if value is not None else None
    ...
    def meshing_problems(self) -> 'List[_59.FEMeshingProblem]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshingProblems, constructor.new(_59.FEMeshingProblem))
        return value
