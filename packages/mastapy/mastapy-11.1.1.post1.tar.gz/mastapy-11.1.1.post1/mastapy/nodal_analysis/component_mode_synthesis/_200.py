...
from mastapy.nodal_analysis.component_mode_synthesis import _207, _202, _198
...
class CMSModel(_0.APIBase):
    ...
    @property
    def software_used_for_reduction(self) -> '_207.SoftwareUsedForReductionType':
        ...
        return constructor.new(_207.SoftwareUsedForReductionType)(value) if value is not None else None
    ...
    @property
    def fe_model(self) -> '_160.FEModel':
        ...
        return constructor.new(_160.FEModel)(self.wrapped.FEModel) if self.wrapped.FEModel is not None else None

    @property
    def reduction_options(self) -> '_202.CMSOptions':
        ...
        return constructor.new(_202.CMSOptions)(self.wrapped.ReductionOptions) if self.wrapped.ReductionOptions is not None else None

    @property
    def element_face_groups(self) -> 'List[_198.CMSElementFaceGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElementFaceGroups, constructor.new(_198.CMSElementFaceGroup))
        return value
