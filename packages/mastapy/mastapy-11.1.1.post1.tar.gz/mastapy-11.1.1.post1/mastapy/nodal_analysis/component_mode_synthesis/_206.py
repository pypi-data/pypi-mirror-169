...
class RealCMSResults(_203.CMSResults):
    '''RealCMSResults
    ...
    def node_displacements(self) -> '_120.NodeVectorState':
        ...
        if _120.NodeVectorState.TYPE not in self.wrapped.NodeDisplacements.__class__.__mro__:
        ...
        return constructor.new_override(self.wrapped.NodeDisplacements.__class__)(self.wrapped.NodeDisplacements) if self.wrapped.NodeDisplacements is not None else None
