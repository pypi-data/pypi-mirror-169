...
class TransientSolverOptions(_0.APIBase):
    ...
    def solver_tolerance_input_method(self) -> '_86.TransientSolverToleranceInputMethod':
        ...
        return constructor.new(_86.TransientSolverToleranceInputMethod)(value) if value is not None else None
    ...
    def result_logging_frequency(self) -> '_79.ResultLoggingFrequency':
        ...
        return constructor.new(_79.ResultLoggingFrequency)(value) if value is not None else None
