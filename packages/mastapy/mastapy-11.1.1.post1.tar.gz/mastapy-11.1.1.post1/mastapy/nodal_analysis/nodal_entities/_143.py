...
from mastapy.math_utility.stiffness_calculators import _1339
...
class SurfaceToSurfaceContactStiffnessEntity(_121.ArbitraryNodalComponent):
    ...
    @property
    def contact(self) -> '_1339.SurfaceToSurfaceContact':
        ...
        return constructor.new(_1339.SurfaceToSurfaceContact)(self.wrapped.Contact) if self.wrapped.Contact is not None else None
