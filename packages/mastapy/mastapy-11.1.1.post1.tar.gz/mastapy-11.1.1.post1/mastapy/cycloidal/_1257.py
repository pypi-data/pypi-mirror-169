...
from mastapy.cycloidal import _1260
...
class CycloidalDiscDesign(_0.APIBase):
    ...
    @property
    def estimated_modifications_from_spline_fit(self) -> '_1629.TwoDChartDefinition':
        ...
        if _1629.TwoDChartDefinition.TYPE not in self.wrapped.EstimatedModificationsFromSplineFit.__class__.__mro__:
    ...
    @property
    def crowning_chart(self) -> '_1629.TwoDChartDefinition':
        ...
        if _1629.TwoDChartDefinition.TYPE not in self.wrapped.CrowningChart.__class__.__mro__:
    ...
    @property
    def modifications_specification(self) -> '_1260.CycloidalDiscModificationsSpecification':
        ...
        return constructor.new(_1260.CycloidalDiscModificationsSpecification)(self.wrapped.ModificationsSpecification) if self.wrapped.ModificationsSpecification is not None else None
