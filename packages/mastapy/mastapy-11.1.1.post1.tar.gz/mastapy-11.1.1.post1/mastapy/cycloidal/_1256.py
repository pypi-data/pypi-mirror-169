...
from mastapy.cycloidal import _1263, _1257, _1262
...
class CycloidalAssemblyDesign(_0.APIBase):
    ...
    @property
    def ring_pins(self) -> '_1263.RingPinsDesign':
        ...
        return constructor.new(_1263.RingPinsDesign)(self.wrapped.RingPins) if self.wrapped.RingPins is not None else None

    @property
    def discs(self) -> 'List[_1257.CycloidalDiscDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Discs, constructor.new(_1257.CycloidalDiscDesign))
        return value

    @property
    def disc_phases(self) -> 'List[_1262.NamedDiscPhase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DiscPhases, constructor.new(_1262.NamedDiscPhase))
        return value
