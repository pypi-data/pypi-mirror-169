...
class CustomTableAndChart(_1554.CustomTable):
    '''CustomTableAndChart
    ...
    @property
    def primary_axis_range(self) -> '_1290.Range':
        ...
        if _1290.Range.TYPE not in self.wrapped.PrimaryAxisRange.__class__.__mro__:
