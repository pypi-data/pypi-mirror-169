...
from mastapy.bearings.tolerances import _1663, _1660
...
class InterferenceTolerance(_1660.BearingConnectionComponent):
    '''InterferenceTolerance
    ...
    @property
    def definition_option(self) -> '_1663.BearingToleranceDefinitionOptions':
    ...
    def definition_option(self, value: '_1663.BearingToleranceDefinitionOptions'):
    ...
    @property
    def mounting_point_surface_finish(self) -> '_1648.MountingPointSurfaceFinishes':
        ...
        return constructor.new(_1648.MountingPointSurfaceFinishes)(value) if value is not None else None

    @mounting_point_surface_finish.setter
    def mounting_point_surface_finish(self, value: '_1648.MountingPointSurfaceFinishes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
