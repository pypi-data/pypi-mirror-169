...
from mastapy.bearings.bearing_results.rolling import _1820, _1766
...
class LoadedRollerBearingElement(_1766.LoadedElement):
    '''LoadedRollerBearingElement
    ...
    @property
    def results_at_roller_offsets(self) -> 'List[_1820.ResultsAtRollerOffset]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResultsAtRollerOffsets, constructor.new(_1820.ResultsAtRollerOffset))
        return value
