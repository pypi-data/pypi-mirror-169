...
from mastapy.bearings.bearing_results.rolling import _1801, _1777
...
class LoadedTaperRollerBearingRow(_1777.LoadedNonBarrelRollerBearingRow):
    '''LoadedTaperRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1801.LoadedTaperRollerBearingResults':
        ...
        return constructor.new(_1801.LoadedTaperRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
