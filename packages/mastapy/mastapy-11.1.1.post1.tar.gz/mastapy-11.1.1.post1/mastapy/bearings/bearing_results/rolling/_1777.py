...
class LoadedNonBarrelRollerBearingRow(_1782.LoadedRollerBearingRow):
    '''LoadedNonBarrelRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1776.LoadedNonBarrelRollerBearingResults':
