...
from mastapy.bearings.bearing_results.rolling.skf_module import _1846, _1849
...
class DynamicAxialLoadCarryingCapacity(_1849.SKFCalculationResult):
    '''DynamicAxialLoadCarryingCapacity
    ...
    @property
    def permissible_axial_load(self) -> '_1846.PermissibleAxialLoad':
        ...
        return constructor.new(_1846.PermissibleAxialLoad)(self.wrapped.PermissibleAxialLoad) if self.wrapped.PermissibleAxialLoad is not None else None
