...
from mastapy.bearings.bearing_results.rolling import _1810, _1782
...
class LoadedToroidalRollerBearingRow(_1782.LoadedRollerBearingRow):
    '''LoadedToroidalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1810.LoadedToroidalRollerBearingResults':
        ...
        return constructor.new(_1810.LoadedToroidalRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
