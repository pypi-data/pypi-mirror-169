...
from mastapy.bearings.bearing_results.rolling import _1735, _1738, _1755
...
class LoadedAngularContactBallBearingRow(_1755.LoadedBallBearingRow):
    '''LoadedAngularContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1735.LoadedAngularContactBallBearingResults':
