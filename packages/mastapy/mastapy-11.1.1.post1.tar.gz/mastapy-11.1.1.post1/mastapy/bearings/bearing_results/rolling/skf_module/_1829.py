...
from mastapy.bearings.bearing_results.rolling.skf_module import _1830, _1849
...
class AdjustedSpeed(_1849.SKFCalculationResult):
    '''AdjustedSpeed
    ...
    @property
    def adjustment_factors(self) -> '_1830.AdjustmentFactors':
        ...
        return constructor.new(_1830.AdjustmentFactors)(self.wrapped.AdjustmentFactors) if self.wrapped.AdjustmentFactors is not None else None
