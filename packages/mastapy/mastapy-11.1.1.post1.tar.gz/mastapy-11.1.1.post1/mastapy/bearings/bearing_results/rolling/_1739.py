...
from mastapy.bearings.bearing_results.rolling import _1738, _1736
...
class LoadedAngularContactThrustBallBearingRow(_1736.LoadedAngularContactBallBearingRow):
    '''LoadedAngularContactThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1738.LoadedAngularContactThrustBallBearingResults':
        ...
        return constructor.new(_1738.LoadedAngularContactThrustBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
