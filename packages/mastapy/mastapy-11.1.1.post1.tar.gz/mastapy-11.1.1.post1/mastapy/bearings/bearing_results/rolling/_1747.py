...
from mastapy.bearings.bearing_results.rolling import _1746, _1749, _1777
...
class LoadedAxialThrustCylindricalRollerBearingRow(_1777.LoadedNonBarrelRollerBearingRow):
    '''LoadedAxialThrustCylindricalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1746.LoadedAxialThrustCylindricalRollerBearingResults':
