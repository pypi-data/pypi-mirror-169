...
from mastapy.bearings.bearing_results.rolling import _1749, _1747
...
class LoadedAxialThrustNeedleRollerBearingRow(_1747.LoadedAxialThrustCylindricalRollerBearingRow):
    '''LoadedAxialThrustNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1749.LoadedAxialThrustNeedleRollerBearingResults':
        ...
        return constructor.new(_1749.LoadedAxialThrustNeedleRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
