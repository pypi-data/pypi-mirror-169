...
from mastapy.bearings.bearing_results.rolling.skf_module import _1843, _1849
...
class BearingRatingLife(_1849.SKFCalculationResult):
    '''BearingRatingLife
    ...
    @property
    def life_model(self) -> '_1843.LifeModel':
        ...
        return constructor.new(_1843.LifeModel)(self.wrapped.LifeModel) if self.wrapped.LifeModel is not None else None
