...
from mastapy.bearings.bearing_results.rolling import _1817, _1776
...
class LoadedCylindricalRollerBearingResults(_1776.LoadedNonBarrelRollerBearingResults):
    '''LoadedCylindricalRollerBearingResults
    ...
    @property
    def permissible_continuous_axial_load(self) -> '_1817.PermissibleContinuousAxialLoadResults':
        ...
        return constructor.new(_1817.PermissibleContinuousAxialLoadResults)(self.wrapped.PermissibleContinuousAxialLoad) if self.wrapped.PermissibleContinuousAxialLoad is not None else None
