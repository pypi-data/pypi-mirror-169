...
from mastapy.bearings.bearing_results.rolling import _1795, _1782
...
class LoadedSphericalRollerThrustBearingRow(_1782.LoadedRollerBearingRow):
    '''LoadedSphericalRollerThrustBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1795.LoadedSphericalRollerThrustBearingResults':
        ...
        return constructor.new(_1795.LoadedSphericalRollerThrustBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
