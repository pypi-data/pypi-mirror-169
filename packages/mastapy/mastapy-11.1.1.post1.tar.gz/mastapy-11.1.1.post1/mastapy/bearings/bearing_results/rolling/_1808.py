...
from mastapy.bearings.bearing_results.rolling import _1807, _1755
...
class LoadedThrustBallBearingRow(_1755.LoadedBallBearingRow):
    '''LoadedThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1807.LoadedThrustBallBearingResults':
        ...
        return constructor.new(_1807.LoadedThrustBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
