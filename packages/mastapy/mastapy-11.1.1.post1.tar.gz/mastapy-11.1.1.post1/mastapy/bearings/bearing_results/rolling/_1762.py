...
from mastapy.bearings.bearing_results.rolling import _1761, _1773, _1777
...
class LoadedCylindricalRollerBearingRow(_1777.LoadedNonBarrelRollerBearingRow):
    '''LoadedCylindricalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1761.LoadedCylindricalRollerBearingResults':
