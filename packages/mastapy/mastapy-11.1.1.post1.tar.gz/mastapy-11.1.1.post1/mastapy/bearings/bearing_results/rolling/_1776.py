...
from mastapy.bearings.bearing_results.rolling import _1825, _1781
...
class LoadedNonBarrelRollerBearingResults(_1781.LoadedRollerBearingResults):
    '''LoadedNonBarrelRollerBearingResults
    ...
    @property
    def smt_rib_stress(self) -> '_1825.SMTRibStressResults':
        ...
        return constructor.new(_1825.SMTRibStressResults)(self.wrapped.SMTRibStress) if self.wrapped.SMTRibStress is not None else None
