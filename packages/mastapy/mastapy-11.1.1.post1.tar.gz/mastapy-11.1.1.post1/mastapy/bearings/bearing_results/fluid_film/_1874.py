...
from mastapy.bearings.bearing_results.fluid_film import _1875, _1871
...
class LoadedPlainJournalBearingResults(_1871.LoadedFluidFilmBearingResults):
    '''LoadedPlainJournalBearingResults
    ...
    @property
    def journal_bearing_rows(self) -> 'List[_1875.LoadedPlainJournalBearingRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.JournalBearingRows, constructor.new(_1875.LoadedPlainJournalBearingRow))
        return value
