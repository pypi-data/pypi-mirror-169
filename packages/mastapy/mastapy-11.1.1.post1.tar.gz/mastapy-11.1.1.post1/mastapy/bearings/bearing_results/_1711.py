...
class LoadedDetailedBearingResults(_1714.LoadedNonLinearBearingResults):
    '''LoadedDetailedBearingResults
    ...
    @property
    def lubrication(self) -> '_238.LubricationDetail':
        ...
        return constructor.new(_238.LubricationDetail)(self.wrapped.Lubrication) if self.wrapped.Lubrication is not None else None
