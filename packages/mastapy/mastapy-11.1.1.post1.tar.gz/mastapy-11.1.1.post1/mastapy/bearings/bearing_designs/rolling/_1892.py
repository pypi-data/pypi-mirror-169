...
from mastapy.bearings.bearing_designs.rolling import _1893, _1915
...
class BallBearing(_1915.RollingBearing):
    '''BallBearing
    ...
    @property
    def shoulders(self) -> 'List[_1893.BallBearingShoulderDefinition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Shoulders, constructor.new(_1893.BallBearingShoulderDefinition))
        return value
