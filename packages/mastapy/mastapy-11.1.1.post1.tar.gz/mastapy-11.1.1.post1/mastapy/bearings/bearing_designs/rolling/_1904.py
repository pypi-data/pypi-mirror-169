...
from mastapy.bearings.bearing_designs.rolling import _1903, _1909
...
class FourPointContactBallBearing(_1909.MultiPointContactBallBearing):
    '''FourPointContactBallBearing
    ...
    @property
    def contact_angle_and_internal_clearance_definition(self) -> '_1903.FourPointContactAngleDefinition':
        ...
        return constructor.new(_1903.FourPointContactAngleDefinition)(value) if value is not None else None

    @contact_angle_and_internal_clearance_definition.setter
    def contact_angle_and_internal_clearance_definition(self, value: '_1903.FourPointContactAngleDefinition'):
