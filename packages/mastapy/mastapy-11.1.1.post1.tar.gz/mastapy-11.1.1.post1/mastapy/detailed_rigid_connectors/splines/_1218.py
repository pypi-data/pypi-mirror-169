...
from mastapy.detailed_rigid_connectors.splines import (
    _1197, _1208, _1220, _1212,
    _1209, _1216, _1217, _1192,
    _1195, _1199, _1202, _1210,
    _1222
)
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy._internal.cast_exception import CastException
from mastapy.detailed_rigid_connectors import _1190
...
class SplineJointDesign(_1190.DetailedRigidConnectorDesign):
    '''SplineJointDesign
    ...
    @property
    def root_type(self) -> '_1208.RootTypes':
        '''RootTypes: 'RootType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.RootType)
        return constructor.new(_1208.RootTypes)(value) if value is not None else None

    @root_type.setter
    def root_type(self, value: '_1208.RootTypes'):
    ...
    @property
    def torque_cycles(self) -> '_1212.SAETorqueCycles':
        ...
        return constructor.new(_1212.SAETorqueCycles)(value) if value is not None else None

    @torque_cycles.setter
    def torque_cycles(self, value: '_1212.SAETorqueCycles'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TorqueCycles = value

    @property
    def fatigue_life_factor_type(self) -> '_1209.SAEFatigueLifeFactorTypes':
        ...
        return constructor.new(_1209.SAEFatigueLifeFactorTypes)(value) if value is not None else None

    @fatigue_life_factor_type.setter
    def fatigue_life_factor_type(self, value: '_1209.SAEFatigueLifeFactorTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FatigueLifeFactorType = value

    @property
    def spline_fixture_type(self) -> '_1216.SplineFixtureTypes':
        ...
        return constructor.new(_1216.SplineFixtureTypes)(value) if value is not None else None

    @spline_fixture_type.setter
    def spline_fixture_type(self, value: '_1216.SplineFixtureTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def external_half(self) -> '_1217.SplineHalfDesign':
        ...
        if _1217.SplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
    ...
    @property
    def external_half_of_type_custom_spline_half_design(self) -> '_1192.CustomSplineHalfDesign':
        ...
        if _1192.CustomSplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
    ...
    @property
    def external_half_of_type_din5480_spline_half_design(self) -> '_1195.DIN5480SplineHalfDesign':
        ...
        if _1195.DIN5480SplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
    ...
    @property
    def external_half_of_type_gbt3478_spline_half_design(self) -> '_1199.GBT3478SplineHalfDesign':
        ...
        if _1199.GBT3478SplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
    ...
    @property
    def external_half_of_type_iso4156_spline_half_design(self) -> '_1202.ISO4156SplineHalfDesign':
        ...
        if _1202.ISO4156SplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
    ...
    @property
    def external_half_of_type_sae_spline_half_design(self) -> '_1210.SAESplineHalfDesign':
        ...
        if _1210.SAESplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
    ...
    @property
    def external_half_of_type_standard_spline_half_design(self) -> '_1222.StandardSplineHalfDesign':
        ...
        if _1222.StandardSplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
    ...
    @property
    def internal_half(self) -> '_1217.SplineHalfDesign':
        ...
        if _1217.SplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
    ...
    @property
    def internal_half_of_type_custom_spline_half_design(self) -> '_1192.CustomSplineHalfDesign':
        ...
        if _1192.CustomSplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
    ...
    @property
    def internal_half_of_type_din5480_spline_half_design(self) -> '_1195.DIN5480SplineHalfDesign':
        ...
        if _1195.DIN5480SplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
    ...
    @property
    def internal_half_of_type_gbt3478_spline_half_design(self) -> '_1199.GBT3478SplineHalfDesign':
        ...
        if _1199.GBT3478SplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
    ...
    @property
    def internal_half_of_type_iso4156_spline_half_design(self) -> '_1202.ISO4156SplineHalfDesign':
        ...
        if _1202.ISO4156SplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
    ...
    @property
    def internal_half_of_type_sae_spline_half_design(self) -> '_1210.SAESplineHalfDesign':
        ...
        if _1210.SAESplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
    ...
    @property
    def internal_half_of_type_standard_spline_half_design(self) -> '_1222.StandardSplineHalfDesign':
        ...
        if _1222.StandardSplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
