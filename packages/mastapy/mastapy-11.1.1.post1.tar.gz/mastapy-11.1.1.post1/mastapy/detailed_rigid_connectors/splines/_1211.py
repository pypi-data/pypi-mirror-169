...
from mastapy.detailed_rigid_connectors.splines import _1198, _1223
...
class SAESplineJointDesign(_1223.StandardSplineJointDesign):
    '''SAESplineJointDesign
    ...
    @property
    def fit_type(self) -> '_1198.FitTypes':
        '''FitTypes: 'FitType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.FitType)
        return constructor.new(_1198.FitTypes)(value) if value is not None else None

    @fit_type.setter
    def fit_type(self, value: '_1198.FitTypes'):
