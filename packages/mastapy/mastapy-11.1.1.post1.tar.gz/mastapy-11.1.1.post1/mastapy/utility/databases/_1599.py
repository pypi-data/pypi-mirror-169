...
from mastapy.utility.databases import _1600, _1602, _1601
...
TValue = TypeVar('TValue', bound='_1600.NamedDatabaseItem')


class NamedDatabase(_1602.SQLDatabase['_1601.NamedKey', 'TValue'], Generic[TValue]):
    '''NamedDatabase
    ...
    def rename(self, item: '_1600.NamedDatabaseItem', new_name: 'str') -> 'bool':
    ...
    def duplicate(self, new_name: 'str', item: '_1600.NamedDatabaseItem') -> '_1600.NamedDatabaseItem':
