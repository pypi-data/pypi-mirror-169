...
from mastapy.utility.units_and_measurements.measurements import _1494
...
class DutyCyclePropertySummaryStress(_1608.DutyCyclePropertySummary['_1494.Stress', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryStress
