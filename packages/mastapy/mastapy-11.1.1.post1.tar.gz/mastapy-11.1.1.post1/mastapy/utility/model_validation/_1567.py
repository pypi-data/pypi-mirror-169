...
from mastapy.utility.model_validation import _1568
...
class Status(_0.APIBase):
    ...
    @property
    def errors(self) -> 'List[_1568.StatusItem]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Errors, constructor.new(_1568.StatusItem))
        return value

    @property
    def warnings(self) -> 'List[_1568.StatusItem]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Warnings, constructor.new(_1568.StatusItem))
        return value
