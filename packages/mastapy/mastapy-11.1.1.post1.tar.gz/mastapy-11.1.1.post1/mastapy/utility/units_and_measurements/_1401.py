...
from mastapy.utility import _1394
...
class MeasurementBase(_0.APIBase):
    ...
    @property
    def rounding_method(self) -> '_1394.RoundingMethods':
        ...
        return constructor.new(_1394.RoundingMethods)(value) if value is not None else None

    @rounding_method.setter
    def rounding_method(self, value: '_1394.RoundingMethods'):
    ...
    @property
    def current_unit(self) -> '_1406.Unit':
        ...
        if _1406.Unit.TYPE not in self.wrapped.CurrentUnit.__class__.__mro__:
    ...
    @property
    def available_units(self) -> 'List[_1406.Unit]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AvailableUnits, constructor.new(_1406.Unit))
        return value
