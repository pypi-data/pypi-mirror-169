...
from mastapy.utility.modal_analysis.gears import _1573, _1576, _1578
...
class GearOrderForTE(_1578.OrderWithRadius):
    '''GearOrderForTE
    ...
    @property
    def position(self) -> '_1573.GearPositions':
        ...
        return constructor.new(_1573.GearPositions)(value) if value is not None else None

    @property
    def additional_orders_and_harmonics(self) -> 'List[_1576.OrderForTE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AdditionalOrdersAndHarmonics, constructor.new(_1576.OrderForTE))
        return value
