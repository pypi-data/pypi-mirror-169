...
class FourierSeries(_0.APIBase):
    ...
    @property
    def harmonics(self) -> 'List[_1318.HarmonicValue]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Harmonics, constructor.new(_1318.HarmonicValue))
        return value

    @property
    def harmonics_with_zeros_truncated(self) -> 'List[_1318.HarmonicValue]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HarmonicsWithZerosTruncated, constructor.new(_1318.HarmonicValue))
        return value
    ...
    def harmonic(self, index: 'int') -> '_1318.HarmonicValue':
