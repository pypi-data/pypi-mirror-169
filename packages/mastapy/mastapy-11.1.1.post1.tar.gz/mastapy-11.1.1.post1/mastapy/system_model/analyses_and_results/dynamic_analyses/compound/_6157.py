...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6155, _6156, _6186
...
class ConceptGearSetCompoundDynamicAnalysis(_6186.GearSetCompoundDynamicAnalysis):
    '''ConceptGearSetCompoundDynamicAnalysis
    ...
    @property
    def concept_gears_compound_dynamic_analysis(self) -> 'List[_6155.ConceptGearCompoundDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsCompoundDynamicAnalysis, constructor.new(_6155.ConceptGearCompoundDynamicAnalysis))
        return value

    @property
    def concept_meshes_compound_dynamic_analysis(self) -> 'List[_6156.ConceptGearMeshCompoundDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesCompoundDynamicAnalysis, constructor.new(_6156.ConceptGearMeshCompoundDynamicAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6027.ConceptGearSetDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6027.ConceptGearSetDynamicAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_6027.ConceptGearSetDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6027.ConceptGearSetDynamicAnalysis))
        return value
