...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _2369, _6003
...
class RootAssemblyDynamicAnalysis(_6003.AssemblyDynamicAnalysis):
    '''RootAssemblyDynamicAnalysis
    ...
    @property
    def dynamic_analysis_inputs(self) -> '_2369.DynamicAnalysis':
        ...
        if _2369.DynamicAnalysis.TYPE not in self.wrapped.DynamicAnalysisInputs.__class__.__mro__:
