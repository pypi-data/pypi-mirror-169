...
class GuideDxfModelSystemDeflection(_2453.ComponentSystemDeflection):
    '''GuideDxfModelSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3830.GuideDxfModelPowerFlow':
        ...
        return constructor.new(_3830.GuideDxfModelPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
