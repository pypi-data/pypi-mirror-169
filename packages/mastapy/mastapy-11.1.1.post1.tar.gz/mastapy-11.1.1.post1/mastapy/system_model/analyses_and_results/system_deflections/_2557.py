...
class StraightBevelPlanetGearSystemDeflection(_2553.StraightBevelDiffGearSystemDeflection):
    '''StraightBevelPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3882.StraightBevelPlanetGearPowerFlow':
        ...
        return constructor.new(_3882.StraightBevelPlanetGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
