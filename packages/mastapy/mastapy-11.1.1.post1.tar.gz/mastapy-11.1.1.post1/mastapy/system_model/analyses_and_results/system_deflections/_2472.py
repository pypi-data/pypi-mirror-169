...
class CVTSystemDeflection(_2438.BeltDriveSystemDeflection):
    '''CVTSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3809.CVTPowerFlow':
        ...
        return constructor.new(_3809.CVTPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
