...
from mastapy.system_model.analyses_and_results import _2395
...
class RigidlyConnectedComponentGroupSystemDeflection(_2395.DesignEntityGroupAnalysis):
    '''RigidlyConnectedComponentGroupSystemDeflection
    ...
    @property
    def mass_properties(self) -> '_1320.MassProperties':
        ...
        return constructor.new(_1320.MassProperties)(self.wrapped.MassProperties) if self.wrapped.MassProperties is not None else None

    @property
    def components(self) -> 'List[_2453.ComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Components, constructor.new(_2453.ComponentSystemDeflection))
        return value
