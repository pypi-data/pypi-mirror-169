...
from mastapy.system_model.analyses_and_results.system_deflections.reporting import _2586
from mastapy.system_model.analyses_and_results.system_deflections import _2453, _2523
from mastapy.system_model.analyses_and_results.power_flows import (
    _3768, _3774, _3775, _3778,
    _3781, _3786, _3787, _3791,
    _3796, _3799, _3802, _3807,
    _3809, _3811, _3818, _3824,
    _3826, _3829, _3833, _3837,
    _3840, _3843, _3851, _3853,
    _3862, _3865, _3869, _3872,
    _3875, _3878, _3881, _3886,
    _3890, _3897, _3900
)
...
class AbstractAssemblySystemDeflection(_2523.PartSystemDeflection):
    '''AbstractAssemblySystemDeflection
    ...
    @property
    def rigidly_connected_groups(self) -> 'List[_2586.RigidlyConnectedComponentGroupSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RigidlyConnectedGroups, constructor.new(_2586.RigidlyConnectedComponentGroupSystemDeflection))
        return value

    @property
    def components_with_unknown_mass_properties(self) -> 'List[_2453.ComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentsWithUnknownMassProperties, constructor.new(_2453.ComponentSystemDeflection))
        return value

    @property
    def components_with_zero_mass_properties(self) -> 'List[_2453.ComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentsWithZeroMassProperties, constructor.new(_2453.ComponentSystemDeflection))
        return value

    @property
    def power_flow_results(self) -> '_3768.AbstractAssemblyPowerFlow':
