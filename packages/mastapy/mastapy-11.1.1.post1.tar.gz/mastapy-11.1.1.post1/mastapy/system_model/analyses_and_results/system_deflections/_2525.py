...
class PartToPartShearCouplingHalfSystemDeflection(_2468.CouplingHalfSystemDeflection):
    '''PartToPartShearCouplingHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3850.PartToPartShearCouplingHalfPowerFlow':
        ...
        return constructor.new(_3850.PartToPartShearCouplingHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
