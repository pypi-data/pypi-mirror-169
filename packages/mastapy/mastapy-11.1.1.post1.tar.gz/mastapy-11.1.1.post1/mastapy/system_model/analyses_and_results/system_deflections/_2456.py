...
class ConceptCouplingHalfSystemDeflection(_2468.CouplingHalfSystemDeflection):
    '''ConceptCouplingHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3795.ConceptCouplingHalfPowerFlow':
        ...
        return constructor.new(_3795.ConceptCouplingHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
