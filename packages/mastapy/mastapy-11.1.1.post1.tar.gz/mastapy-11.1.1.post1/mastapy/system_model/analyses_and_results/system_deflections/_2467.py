...
class CouplingConnectionSystemDeflection(_2505.InterMountableComponentConnectionSystemDeflection):
    '''CouplingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3805.CouplingConnectionPowerFlow':
        ...
        if _3805.CouplingConnectionPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_clutch_connection_power_flow(self) -> '_3789.ClutchConnectionPowerFlow':
        ...
        if _3789.ClutchConnectionPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_concept_coupling_connection_power_flow(self) -> '_3794.ConceptCouplingConnectionPowerFlow':
        ...
        if _3794.ConceptCouplingConnectionPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_part_to_part_shear_coupling_connection_power_flow(self) -> '_3849.PartToPartShearCouplingConnectionPowerFlow':
        ...
        if _3849.PartToPartShearCouplingConnectionPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_spring_damper_connection_power_flow(self) -> '_3873.SpringDamperConnectionPowerFlow':
        ...
        if _3873.SpringDamperConnectionPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_torque_converter_connection_power_flow(self) -> '_3889.TorqueConverterConnectionPowerFlow':
        ...
        if _3889.TorqueConverterConnectionPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
