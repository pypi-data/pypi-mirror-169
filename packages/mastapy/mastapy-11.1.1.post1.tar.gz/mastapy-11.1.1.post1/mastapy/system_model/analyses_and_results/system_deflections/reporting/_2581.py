...
from mastapy.utility_gui.charts import _1623
...
class FlexibleGearChart(_0.APIBase):
    ...
    @property
    def chart(self) -> '_1623.LegacyChartMathChartDefinition':
        ...
        return constructor.new(_1623.LegacyChartMathChartDefinition)(self.wrapped.Chart) if self.wrapped.Chart is not None else None
