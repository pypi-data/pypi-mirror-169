...
from mastapy.system_model.analyses_and_results.system_deflections import _2547, _2545, _2445
...
class SpiralBevelGearSetSystemDeflection(_2445.BevelGearSetSystemDeflection):
    '''SpiralBevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3872.SpiralBevelGearSetPowerFlow':
        ...
        return constructor.new(_3872.SpiralBevelGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
    ...
    @property
    def spiral_bevel_gears_system_deflection(self) -> 'List[_2547.SpiralBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsSystemDeflection, constructor.new(_2547.SpiralBevelGearSystemDeflection))
        return value

    @property
    def spiral_bevel_meshes_system_deflection(self) -> 'List[_2545.SpiralBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesSystemDeflection, constructor.new(_2545.SpiralBevelGearMeshSystemDeflection))
        return value
