...
class VirtualComponentSystemDeflection(_2520.MountableComponentSystemDeflection):
    '''VirtualComponentSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3894.VirtualComponentPowerFlow':
