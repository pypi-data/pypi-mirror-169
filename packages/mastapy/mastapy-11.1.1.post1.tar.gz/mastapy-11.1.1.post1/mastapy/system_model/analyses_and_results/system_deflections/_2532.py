...
class RingPinsSystemDeflection(_2520.MountableComponentSystemDeflection):
    '''RingPinsSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3860.RingPinsPowerFlow':
        ...
        return constructor.new(_3860.RingPinsPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
