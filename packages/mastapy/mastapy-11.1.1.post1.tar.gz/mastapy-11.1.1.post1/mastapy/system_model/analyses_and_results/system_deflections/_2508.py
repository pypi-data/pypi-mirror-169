...
from mastapy.system_model.analyses_and_results.power_flows import _3836, _3839, _3842
...
class KlingelnbergCycloPalloidConicalGearSystemDeflection(_2464.ConicalGearSystemDeflection):
    '''KlingelnbergCycloPalloidConicalGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3836.KlingelnbergCycloPalloidConicalGearPowerFlow':
