...
from mastapy.system_model.analyses_and_results.system_deflections import _2515, _2565
...
class SystemDeflection(_7264.FEAnalysis):
    '''SystemDeflection
    ...
    @property
    def overall_efficiency_results(self) -> '_2515.LoadCaseOverallEfficiencyResult':
        ...
        return constructor.new(_2515.LoadCaseOverallEfficiencyResult)(self.wrapped.OverallEfficiencyResults) if self.wrapped.OverallEfficiencyResults is not None else None

    @property
    def analysis_options(self) -> '_2565.SystemDeflectionOptions':
        ...
        return constructor.new(_2565.SystemDeflectionOptions)(self.wrapped.AnalysisOptions) if self.wrapped.AnalysisOptions is not None else None
