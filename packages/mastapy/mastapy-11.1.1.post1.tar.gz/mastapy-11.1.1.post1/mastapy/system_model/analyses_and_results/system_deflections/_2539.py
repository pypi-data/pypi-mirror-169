...
from mastapy.detailed_rigid_connectors.rating import _1239
from mastapy.detailed_rigid_connectors.splines.ratings import (
    _1227, _1229, _1231, _1233,
    _1235
)
from mastapy._internal.cast_exception import CastException
from mastapy.detailed_rigid_connectors.keyed_joints.rating import _1245
from mastapy.detailed_rigid_connectors.interference_fits.rating import _1252
from mastapy.bearings.bearing_results import _1699
...
class ShaftHubConnectionSystemDeflection(_2466.ConnectorSystemDeflection):
    '''ShaftHubConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3866.ShaftHubConnectionPowerFlow':
        ...
        return constructor.new(_3866.ShaftHubConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None

    @property
    def component_detailed_analysis(self) -> '_1239.ShaftHubConnectionRating':
        ...
        if _1239.ShaftHubConnectionRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_agma6123_spline_joint_rating(self) -> '_1227.AGMA6123SplineJointRating':
        ...
        if _1227.AGMA6123SplineJointRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_din5466_spline_rating(self) -> '_1229.DIN5466SplineRating':
        ...
        if _1229.DIN5466SplineRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_gbt17855_spline_joint_rating(self) -> '_1231.GBT17855SplineJointRating':
        ...
        if _1231.GBT17855SplineJointRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_sae_spline_joint_rating(self) -> '_1233.SAESplineJointRating':
        ...
        if _1233.SAESplineJointRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_spline_joint_rating(self) -> '_1235.SplineJointRating':
        ...
        if _1235.SplineJointRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_keyway_rating(self) -> '_1245.KeywayRating':
        ...
        if _1245.KeywayRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_interference_fit_rating(self) -> '_1252.InterferenceFitRating':
        ...
        if _1252.InterferenceFitRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def stiffness_matrix_in_local_coordinate_system(self) -> '_1699.BearingStiffnessMatrixReporter':
        ...
        return constructor.new(_1699.BearingStiffnessMatrixReporter)(self.wrapped.StiffnessMatrixInLocalCoordinateSystem) if self.wrapped.StiffnessMatrixInLocalCoordinateSystem is not None else None

    @property
    def stiffness_matrix_in_unrotated_coordinate_system(self) -> '_1699.BearingStiffnessMatrixReporter':
        ...
        return constructor.new(_1699.BearingStiffnessMatrixReporter)(self.wrapped.StiffnessMatrixInUnrotatedCoordinateSystem) if self.wrapped.StiffnessMatrixInUnrotatedCoordinateSystem is not None else None
    ...
    @property
    def left_flank_contacts(self) -> 'List[_2588.SplineFlankContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LeftFlankContacts, constructor.new(_2588.SplineFlankContactReporting))
        return value

    @property
    def right_flank_contacts(self) -> 'List[_2588.SplineFlankContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RightFlankContacts, constructor.new(_2588.SplineFlankContactReporting))
        return value

    @property
    def tip_contacts(self) -> 'List[_2588.SplineFlankContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TipContacts, constructor.new(_2588.SplineFlankContactReporting))
        return value
