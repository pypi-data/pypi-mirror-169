...
from mastapy.system_model.analyses_and_results.system_deflections import _2559, _2544
...
class SynchroniserSystemDeflection(_2544.SpecialisedAssemblySystemDeflection):
    '''SynchroniserSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3886.SynchroniserPowerFlow':
        ...
        return constructor.new(_3886.SynchroniserPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None

    @property
    def cones(self) -> 'List[_2559.SynchroniserHalfSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_2559.SynchroniserHalfSystemDeflection))
        return value
