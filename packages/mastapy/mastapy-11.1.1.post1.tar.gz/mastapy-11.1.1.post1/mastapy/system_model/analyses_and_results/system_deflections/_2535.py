...
class RollingRingAssemblySystemDeflection(_2544.SpecialisedAssemblySystemDeflection):
    '''RollingRingAssemblySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3862.RollingRingAssemblyPowerFlow':
        ...
        return constructor.new(_3862.RollingRingAssemblyPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
