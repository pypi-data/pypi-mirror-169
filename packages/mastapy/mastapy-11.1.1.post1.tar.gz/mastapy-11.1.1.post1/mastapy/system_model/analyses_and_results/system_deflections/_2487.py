...
from mastapy.system_model.analyses_and_results.system_deflections import (
    _2486, _2483, _2484, _2485,
    _2488, _2477, _2478, _2479
)
...
class CylindricalMeshedGearSystemDeflection(_0.APIBase):
    ...
    @property
    def left_flank(self) -> '_2486.CylindricalMeshedGearFlankSystemDeflection':
        ...
        return constructor.new(_2486.CylindricalMeshedGearFlankSystemDeflection)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank is not None else None

    @property
    def right_flank(self) -> '_2486.CylindricalMeshedGearFlankSystemDeflection':
        ...
        return constructor.new(_2486.CylindricalMeshedGearFlankSystemDeflection)(self.wrapped.RightFlank) if self.wrapped.RightFlank is not None else None

    @property
    def flanks(self) -> 'List[_2486.CylindricalMeshedGearFlankSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Flanks, constructor.new(_2486.CylindricalMeshedGearFlankSystemDeflection))
        return value

    @property
    def tension_side_fillet_results(self) -> 'List[_806.GearRootFilletStressResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TensionSideFilletResults, constructor.new(_806.GearRootFilletStressResults))
        return value

    @property
    def compression_side_fillet_results(self) -> 'List[_806.GearRootFilletStressResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CompressionSideFilletResults, constructor.new(_806.GearRootFilletStressResults))
        return value

    @property
    def cylindrical_gear_system_deflection(self) -> '_2483.CylindricalGearSystemDeflection':
        ...
        if _2483.CylindricalGearSystemDeflection.TYPE not in self.wrapped.CylindricalGearSystemDeflection.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_system_deflection_of_type_cylindrical_gear_system_deflection_timestep(self) -> '_2484.CylindricalGearSystemDeflectionTimestep':
        ...
        if _2484.CylindricalGearSystemDeflectionTimestep.TYPE not in self.wrapped.CylindricalGearSystemDeflection.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_system_deflection_of_type_cylindrical_gear_system_deflection_with_ltca_results(self) -> '_2485.CylindricalGearSystemDeflectionWithLTCAResults':
        ...
        if _2485.CylindricalGearSystemDeflectionWithLTCAResults.TYPE not in self.wrapped.CylindricalGearSystemDeflection.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_system_deflection_of_type_cylindrical_planet_gear_system_deflection(self) -> '_2488.CylindricalPlanetGearSystemDeflection':
        ...
        if _2488.CylindricalPlanetGearSystemDeflection.TYPE not in self.wrapped.CylindricalGearSystemDeflection.__class__.__mro__:
    ...
    @property
    def other_cylindrical_gear_system_deflection(self) -> '_2483.CylindricalGearSystemDeflection':
        ...
        if _2483.CylindricalGearSystemDeflection.TYPE not in self.wrapped.OtherCylindricalGearSystemDeflection.__class__.__mro__:
    ...
    @property
    def other_cylindrical_gear_system_deflection_of_type_cylindrical_gear_system_deflection_timestep(self) -> '_2484.CylindricalGearSystemDeflectionTimestep':
        ...
        if _2484.CylindricalGearSystemDeflectionTimestep.TYPE not in self.wrapped.OtherCylindricalGearSystemDeflection.__class__.__mro__:
    ...
    @property
    def other_cylindrical_gear_system_deflection_of_type_cylindrical_gear_system_deflection_with_ltca_results(self) -> '_2485.CylindricalGearSystemDeflectionWithLTCAResults':
        ...
        if _2485.CylindricalGearSystemDeflectionWithLTCAResults.TYPE not in self.wrapped.OtherCylindricalGearSystemDeflection.__class__.__mro__:
    ...
    @property
    def other_cylindrical_gear_system_deflection_of_type_cylindrical_planet_gear_system_deflection(self) -> '_2488.CylindricalPlanetGearSystemDeflection':
        ...
        if _2488.CylindricalPlanetGearSystemDeflection.TYPE not in self.wrapped.OtherCylindricalGearSystemDeflection.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_mesh_system_deflection(self) -> '_2477.CylindricalGearMeshSystemDeflection':
        ...
        if _2477.CylindricalGearMeshSystemDeflection.TYPE not in self.wrapped.CylindricalGearMeshSystemDeflection.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_mesh_system_deflection_of_type_cylindrical_gear_mesh_system_deflection_timestep(self) -> '_2478.CylindricalGearMeshSystemDeflectionTimestep':
        ...
        if _2478.CylindricalGearMeshSystemDeflectionTimestep.TYPE not in self.wrapped.CylindricalGearMeshSystemDeflection.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_mesh_system_deflection_of_type_cylindrical_gear_mesh_system_deflection_with_ltca_results(self) -> '_2479.CylindricalGearMeshSystemDeflectionWithLTCAResults':
        ...
        if _2479.CylindricalGearMeshSystemDeflectionWithLTCAResults.TYPE not in self.wrapped.CylindricalGearMeshSystemDeflection.__class__.__mro__:
    ...
    @property
    def both_flanks(self) -> '_2486.CylindricalMeshedGearFlankSystemDeflection':
        ...
        return constructor.new(_2486.CylindricalMeshedGearFlankSystemDeflection)(self.wrapped.BothFlanks) if self.wrapped.BothFlanks is not None else None
