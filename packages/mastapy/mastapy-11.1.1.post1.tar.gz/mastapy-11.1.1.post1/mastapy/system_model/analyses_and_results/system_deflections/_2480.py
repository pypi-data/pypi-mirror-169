...
from mastapy.system_model.analyses_and_results.power_flows import _3818, _3853
from mastapy.gears.rating.cylindrical import _429
from mastapy.gears.manufacturing.cylindrical import _582
from mastapy.system_model.analyses_and_results.system_deflections import _2483, _2477, _2498
...
class CylindricalGearSetSystemDeflection(_2498.GearSetSystemDeflection):
    '''CylindricalGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3818.CylindricalGearSetPowerFlow':
    ...
    @property
    def manufacturing_analysis(self) -> '_582.CylindricalManufacturedGearSetLoadCase':
        ...
        return constructor.new(_582.CylindricalManufacturedGearSetLoadCase)(self.wrapped.ManufacturingAnalysis) if self.wrapped.ManufacturingAnalysis is not None else None

    @property
    def cylindrical_gears_system_deflection(self) -> 'List[_2483.CylindricalGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsSystemDeflection, constructor.new(_2483.CylindricalGearSystemDeflection))
        return value

    @property
    def cylindrical_meshes_system_deflection(self) -> 'List[_2477.CylindricalGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesSystemDeflection, constructor.new(_2477.CylindricalGearMeshSystemDeflection))
        return value
