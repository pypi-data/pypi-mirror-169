...
class TorqueConverterTurbineSystemDeflection(_2468.CouplingHalfSystemDeflection):
    '''TorqueConverterTurbineSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3892.TorqueConverterTurbinePowerFlow':
        ...
        return constructor.new(_3892.TorqueConverterTurbinePowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
