...
class PartToPartShearCouplingConnectionSystemDeflection(_2467.CouplingConnectionSystemDeflection):
    '''PartToPartShearCouplingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3849.PartToPartShearCouplingConnectionPowerFlow':
        ...
        return constructor.new(_3849.PartToPartShearCouplingConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
