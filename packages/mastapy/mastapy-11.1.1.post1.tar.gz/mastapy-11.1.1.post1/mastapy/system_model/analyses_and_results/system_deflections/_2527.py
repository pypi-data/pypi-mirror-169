...
class PlanetaryConnectionSystemDeflection(_2543.ShaftToMountableComponentConnectionSystemDeflection):
    '''PlanetaryConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3852.PlanetaryConnectionPowerFlow':
        ...
        return constructor.new(_3852.PlanetaryConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
