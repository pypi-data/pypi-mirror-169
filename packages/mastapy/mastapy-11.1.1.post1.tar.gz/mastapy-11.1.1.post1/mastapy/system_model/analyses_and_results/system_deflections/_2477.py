...
from mastapy.system_model.analyses_and_results.system_deflections.reporting import _2583
...
class CylindricalGearMeshSystemDeflection(_2497.GearMeshSystemDeflection):
    '''CylindricalGearMeshSystemDeflection
    ...
    @property
    def chart_of_misalignment_in_transverse_line_of_action(self) -> '_1560.LegacyChartDefinition':
        ...
        return constructor.new(_1560.LegacyChartDefinition)(self.wrapped.ChartOfMisalignmentInTransverseLineOfAction) if self.wrapped.ChartOfMisalignmentInTransverseLineOfAction is not None else None
    ...
    @property
    def power_flow_results(self) -> '_3816.CylindricalGearMeshPowerFlow':
        ...
        return constructor.new(_3816.CylindricalGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
    ...
    @property
    def gear_a(self) -> '_2483.CylindricalGearSystemDeflection':
    ...
    @property
    def gear_b(self) -> '_2483.CylindricalGearSystemDeflection':
    ...
    @property
    def cylindrical_gears(self) -> 'List[_2483.CylindricalGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_2483.CylindricalGearSystemDeflection))
        return value
    ...
    @property
    def mesh_deflections_left_flank(self) -> 'List[_2583.MeshDeflectionResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshDeflectionsLeftFlank, constructor.new(_2583.MeshDeflectionResults))
        return value

    @property
    def mesh_deflections_right_flank(self) -> 'List[_2583.MeshDeflectionResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshDeflectionsRightFlank, constructor.new(_2583.MeshDeflectionResults))
        return value
