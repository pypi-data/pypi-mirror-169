...
class ParametricStudyDOEResultVariable(_1355.ParetoOptimisationVariableBase):
    '''ParametricStudyDOEResultVariable
    ...
    @property
    def target(self) -> '_1357.PropertyTargetForDominantCandidateSearch':
    ...
    @target.setter
    def target(self, value: '_1357.PropertyTargetForDominantCandidateSearch'):
