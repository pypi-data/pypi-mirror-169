...
class ConnectionParametricStudyTool(_7258.ConnectionAnalysisCase):
    '''ConnectionParametricStudyTool
    ...
    @property
    def parametric_study_tool(self) -> '_4122.ParametricStudyTool':
        ...
        return constructor.new(_4122.ParametricStudyTool)(self.wrapped.ParametricStudyTool) if self.wrapped.ParametricStudyTool is not None else None
