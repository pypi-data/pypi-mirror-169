...
class BearingCompoundParametricStudyTool(_4213.ConnectorCompoundParametricStudyTool):
    '''BearingCompoundParametricStudyTool
    ...
    @property
    def bearing_duty_cycle_results(self) -> '_1705.LoadedBearingDutyCycle':
        ...
        if _1705.LoadedBearingDutyCycle.TYPE not in self.wrapped.BearingDutyCycleResults.__class__.__mro__:
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4038.BearingParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4038.BearingParametricStudyTool))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4038.BearingParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4038.BearingParametricStudyTool))
        return value
