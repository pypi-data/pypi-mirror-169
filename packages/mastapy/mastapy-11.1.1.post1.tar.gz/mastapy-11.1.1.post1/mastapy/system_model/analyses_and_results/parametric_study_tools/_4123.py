...
from mastapy.system_model.analyses_and_results.static_loads import _6535, _6648
from mastapy.system_model import _1958, _1954
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4125, _4126
from mastapy.system_model.analyses_and_results import _2391
from mastapy.math_utility.convergence import _1375
...
class ParametricStudyToolOptions(_0.APIBase):
    ...
    @property
    def parametric_study_type(self) -> '_6648.ParametricStudyType':
        ...
        return constructor.new(_6648.ParametricStudyType)(value) if value is not None else None

    @parametric_study_type.setter
    def parametric_study_type(self, value: '_6648.ParametricStudyType'):
    ...
    @property
    def external_full_fe_loader(self) -> '_1958.ExternalFullFELoader':
        ...
        return constructor.new(_1958.ExternalFullFELoader)(self.wrapped.ExternalFullFELoader) if self.wrapped.ExternalFullFELoader is not None else None

    @property
    def step_results(self) -> 'List[_4125.ParametricStudyToolStepResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StepResults, constructor.new(_4125.ParametricStudyToolStepResult))
        return value

    @property
    def study_variables(self) -> 'List[_4126.ParametricStudyVariable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StudyVariables, constructor.new(_4126.ParametricStudyVariable))
        return value

    @property
    def parametric_study_logging_variables(self) -> 'List[_2391.AnalysisCaseVariable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParametricStudyLoggingVariables, constructor.new(_2391.AnalysisCaseVariable))
        return value
    ...
    def data_logger_for(self, design_entity: '_1954.DesignEntity') -> '_1375.DataLogger':
    ...
    def add_study_variable(self, design_entity: '_1954.DesignEntity', path: 'List[str]') -> '_4126.ParametricStudyVariable':
    ...
    def remove_study_variable(self, study_variable: '_4126.ParametricStudyVariable'):
    ...
    def move_study_variable_up(self, study_variable: '_4126.ParametricStudyVariable'):
    ...
    def move_study_variable_down(self, study_variable: '_4126.ParametricStudyVariable'):
    ...
    def add_logging_variable(self, design_entity: '_1954.DesignEntity', path: 'List[str]') -> '_2391.AnalysisCaseVariable':
    ...
    def remove_logging_variable(self, analysis_variable: '_2391.AnalysisCaseVariable'):
