...
class ConceptCouplingAdvancedSystemDeflection(_7031.CouplingAdvancedSystemDeflection):
    '''ConceptCouplingAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2457.ConceptCouplingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2457.ConceptCouplingSystemDeflection))
        return value
