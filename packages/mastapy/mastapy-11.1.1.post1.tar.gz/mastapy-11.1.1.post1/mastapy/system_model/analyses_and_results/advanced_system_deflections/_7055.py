...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7070, _7094
...
class GearSetAdvancedSystemDeflection(_7094.SpecialisedAssemblyAdvancedSystemDeflection):
    '''GearSetAdvancedSystemDeflection
    ...
    @property
    def use_ltca_in_advanced_system_deflection(self) -> '_7070.UseLtcaInAsdOption':
        ...
        return constructor.new(_7070.UseLtcaInAsdOption)(value) if value is not None else None

    @use_ltca_in_advanced_system_deflection.setter
    def use_ltca_in_advanced_system_deflection(self, value: '_7070.UseLtcaInAsdOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.UseLTCAInAdvancedSystemDeflection = value

    @property
    def rating(self) -> '_330.GearSetRating':
        ...
        if _330.GearSetRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def rating_of_type_worm_gear_set_rating(self) -> '_343.WormGearSetRating':
        ...
        if _343.WormGearSetRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def rating_of_type_straight_bevel_diff_gear_set_rating(self) -> '_367.StraightBevelDiffGearSetRating':
        ...
        if _367.StraightBevelDiffGearSetRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def rating_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_set_rating(self) -> '_374.KlingelnbergCycloPalloidSpiralBevelGearSetRating':
        ...
        if _374.KlingelnbergCycloPalloidSpiralBevelGearSetRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    def rating_of_type_klingelnberg_cyclo_palloid_hypoid_gear_set_rating(self) -> '_377.KlingelnbergCycloPalloidHypoidGearSetRating':
        ...
        if _377.KlingelnbergCycloPalloidHypoidGearSetRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def rating_of_type_klingelnberg_cyclo_palloid_conical_gear_set_rating(self) -> '_380.KlingelnbergCycloPalloidConicalGearSetRating':
        ...
        if _380.KlingelnbergCycloPalloidConicalGearSetRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def rating_of_type_hypoid_gear_set_rating(self) -> '_407.HypoidGearSetRating':
        ...
        if _407.HypoidGearSetRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def rating_of_type_face_gear_set_rating(self) -> '_417.FaceGearSetRating':
        ...
        if _417.FaceGearSetRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def rating_of_type_cylindrical_gear_set_rating(self) -> '_429.CylindricalGearSetRating':
        ...
        if _429.CylindricalGearSetRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def rating_of_type_conical_gear_set_rating(self) -> '_503.ConicalGearSetRating':
        ...
        if _503.ConicalGearSetRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def rating_of_type_concept_gear_set_rating(self) -> '_514.ConceptGearSetRating':
        ...
        if _514.ConceptGearSetRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def rating_of_type_bevel_gear_set_rating(self) -> '_517.BevelGearSetRating':
    ...
    @property
    def rating_of_type_agma_gleason_conical_gear_set_rating(self) -> '_528.AGMAGleasonConicalGearSetRating':
        ...
        if _528.AGMAGleasonConicalGearSetRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
