...
from mastapy.math_utility.convergence import _1375, _1374
from mastapy.utility_gui import _1619
...
class ConnectionAdvancedSystemDeflection(_7261.ConnectionStaticLoadAnalysisCase):
    '''ConnectionAdvancedSystemDeflection
    ...
    @property
    def advanced_system_deflection(self) -> '_6994.AdvancedSystemDeflection':
        ...
        return constructor.new(_6994.AdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflection) if self.wrapped.AdvancedSystemDeflection is not None else None

    @property
    def data_logger(self) -> '_1375.DataLogger':
        ...
        if _1375.DataLogger.TYPE not in self.wrapped.DataLogger.__class__.__mro__:
