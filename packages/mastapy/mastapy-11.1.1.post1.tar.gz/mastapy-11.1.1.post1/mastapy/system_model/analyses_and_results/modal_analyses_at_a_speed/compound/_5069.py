...
class RollingRingConnectionCompoundModalAnalysisAtASpeed(_5041.InterMountableComponentConnectionCompoundModalAnalysisAtASpeed):
    '''RollingRingConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4939.RollingRingConnectionModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4939.RollingRingConnectionModalAnalysisAtASpeed))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4939.RollingRingConnectionModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4939.RollingRingConnectionModalAnalysisAtASpeed))
        return value
