...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4461
...
class AbstractShaftCompoundModalAnalysis(_4461.AbstractShaftOrHousingCompoundModalAnalysis):
    '''AbstractShaftCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4307.AbstractShaftModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4307.AbstractShaftModalAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4307.AbstractShaftModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4307.AbstractShaftModalAnalysis))
        return value
