...
class BevelDifferentialPlanetGearCompoundMultibodyDynamicsAnalysis(_5268.BevelDifferentialGearCompoundMultibodyDynamicsAnalysis):
    '''BevelDifferentialPlanetGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5121.BevelDifferentialPlanetGearMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5121.BevelDifferentialPlanetGearMultibodyDynamicsAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5121.BevelDifferentialPlanetGearMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5121.BevelDifferentialPlanetGearMultibodyDynamicsAnalysis))
        return value
