...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5204, _5217
...
class BeltDriveMultibodyDynamicsAnalysis(_5217.SpecialisedAssemblyMultibodyDynamicsAnalysis):
    '''BeltDriveMultibodyDynamicsAnalysis
    ...
    @property
    def pulleys(self) -> 'List[_5204.PulleyMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_5204.PulleyMultibodyDynamicsAnalysis))
        return value
