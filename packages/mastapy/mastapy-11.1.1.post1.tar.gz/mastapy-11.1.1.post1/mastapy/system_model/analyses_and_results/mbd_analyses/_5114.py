...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5253
...
class BearingMultibodyDynamicsAnalysis(_5144.ConnectorMultibodyDynamicsAnalysis):
    '''BearingMultibodyDynamicsAnalysis
