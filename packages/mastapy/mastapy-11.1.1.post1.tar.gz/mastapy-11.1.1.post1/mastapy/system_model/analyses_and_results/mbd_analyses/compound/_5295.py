...
class CouplingConnectionCompoundMultibodyDynamicsAnalysis(_5322.InterMountableComponentConnectionCompoundMultibodyDynamicsAnalysis):
    '''CouplingConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5145.CouplingConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5145.CouplingConnectionMultibodyDynamicsAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_5145.CouplingConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5145.CouplingConnectionMultibodyDynamicsAnalysis))
        return value
