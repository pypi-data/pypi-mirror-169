...
class MultibodyDynamicsAnalysis(_7271.TimeSeriesLoadAnalysisCase):
    '''MultibodyDynamicsAnalysis
    ...
    @property
    def mbd_options(self) -> '_5190.MBDAnalysisOptions':
        ...
        return constructor.new(_5190.MBDAnalysisOptions)(self.wrapped.MBDOptions) if self.wrapped.MBDOptions is not None else None
    ...
    def transient_solver(self) -> '_114.TransientSolver':
        ...
        if _114.TransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    def transient_solver_of_type_backward_euler_acceleration_step_halving_transient_solver(self) -> '_96.BackwardEulerAccelerationStepHalvingTransientSolver':
        ...
        if _96.BackwardEulerAccelerationStepHalvingTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    def transient_solver_of_type_backward_euler_transient_solver(self) -> '_97.BackwardEulerTransientSolver':
        ...
        if _97.BackwardEulerTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    def transient_solver_of_type_internal_transient_solver(self) -> '_100.InternalTransientSolver':
        ...
        if _100.InternalTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    def transient_solver_of_type_lobatto_iiia_transient_solver(self) -> '_101.LobattoIIIATransientSolver':
        ...
        if _101.LobattoIIIATransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    def transient_solver_of_type_lobatto_iiic_transient_solver(self) -> '_102.LobattoIIICTransientSolver':
        ...
        if _102.LobattoIIICTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    def transient_solver_of_type_newmark_acceleration_transient_solver(self) -> '_103.NewmarkAccelerationTransientSolver':
        ...
        if _103.NewmarkAccelerationTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    def transient_solver_of_type_newmark_transient_solver(self) -> '_104.NewmarkTransientSolver':
        ...
        if _104.NewmarkTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    def transient_solver_of_type_semi_implicit_transient_solver(self) -> '_105.SemiImplicitTransientSolver':
        ...
        if _105.SemiImplicitTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    def transient_solver_of_type_simple_acceleration_based_step_halving_transient_solver(self) -> '_106.SimpleAccelerationBasedStepHalvingTransientSolver':
        ...
        if _106.SimpleAccelerationBasedStepHalvingTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    def transient_solver_of_type_simple_velocity_based_step_halving_transient_solver(self) -> '_107.SimpleVelocityBasedStepHalvingTransientSolver':
        ...
        if _107.SimpleVelocityBasedStepHalvingTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    def transient_solver_of_type_step_halving_transient_solver(self) -> '_112.StepHalvingTransientSolver':
        ...
        if _112.StepHalvingTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    def transient_solver_of_type_wilson_theta_transient_solver(self) -> '_115.WilsonThetaTransientSolver':
        ...
        if _115.WilsonThetaTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
