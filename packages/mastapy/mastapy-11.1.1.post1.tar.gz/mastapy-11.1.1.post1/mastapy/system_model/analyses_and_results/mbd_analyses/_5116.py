...
class BeltConnectionMultibodyDynamicsAnalysis(_5178.InterMountableComponentConnectionMultibodyDynamicsAnalysis):
    '''BeltConnectionMultibodyDynamicsAnalysis
    ...
    def loading_status(self) -> '_71.LoadingStatus':
        ...
        return constructor.new(_71.LoadingStatus)(value) if value is not None else None
