...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3989
...
class CVTPulleyCompoundPowerFlow(_3989.PulleyCompoundPowerFlow):
    '''CVTPulleyCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3810.CVTPulleyPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3810.CVTPulleyPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3810.CVTPulleyPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3810.CVTPulleyPowerFlow))
        return value
