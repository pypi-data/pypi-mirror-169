...
from mastapy.system_model.analyses_and_results.power_flows import _3827, _3828, _3869
...
class GearSetPowerFlow(_3869.SpecialisedAssemblyPowerFlow):
    '''GearSetPowerFlow
    ...
    @property
    def meshes_power_flow(self) -> 'List[_3827.GearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesPowerFlow, constructor.new(_3827.GearMeshPowerFlow))
        return value

    @property
    def gears_power_flow(self) -> 'List[_3828.GearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsPowerFlow, constructor.new(_3828.GearPowerFlow))
        return value
