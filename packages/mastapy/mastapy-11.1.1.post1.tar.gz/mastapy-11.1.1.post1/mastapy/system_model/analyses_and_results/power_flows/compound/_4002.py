...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4000, _4001, _3919
...
class SpiralBevelGearSetCompoundPowerFlow(_3919.BevelGearSetCompoundPowerFlow):
    '''SpiralBevelGearSetCompoundPowerFlow
    ...
    @property
    def spiral_bevel_gears_compound_power_flow(self) -> 'List[_4000.SpiralBevelGearCompoundPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsCompoundPowerFlow, constructor.new(_4000.SpiralBevelGearCompoundPowerFlow))
        return value

    @property
    def spiral_bevel_meshes_compound_power_flow(self) -> 'List[_4001.SpiralBevelGearMeshCompoundPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesCompoundPowerFlow, constructor.new(_4001.SpiralBevelGearMeshCompoundPowerFlow))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3872.SpiralBevelGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3872.SpiralBevelGearSetPowerFlow))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3872.SpiralBevelGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3872.SpiralBevelGearSetPowerFlow))
        return value
