...
class RootAssemblyCompoundPowerFlow(_3908.AssemblyCompoundPowerFlow):
    '''RootAssemblyCompoundPowerFlow
    ...
    @property
    def compound_static_load(self) -> '_5388.AbstractStaticLoadCaseGroup':
        ...
        if _5388.AbstractStaticLoadCaseGroup.TYPE not in self.wrapped.CompoundStaticLoad.__class__.__mro__:
    ...
    @property
    def compound_static_load_of_type_abstract_design_state_load_case_group(self) -> '_5386.AbstractDesignStateLoadCaseGroup':
        ...
        if _5386.AbstractDesignStateLoadCaseGroup.TYPE not in self.wrapped.CompoundStaticLoad.__class__.__mro__:
    ...
    @property
    def compound_static_load_of_type_design_state(self) -> '_5391.DesignState':
        ...
        if _5391.DesignState.TYPE not in self.wrapped.CompoundStaticLoad.__class__.__mro__:
    ...
    @property
    def compound_static_load_of_type_duty_cycle(self) -> '_5392.DutyCycle':
        ...
        if _5392.DutyCycle.TYPE not in self.wrapped.CompoundStaticLoad.__class__.__mro__:
    ...
    @property
    def compound_static_load_of_type_sub_group_in_single_design_state(self) -> '_5395.SubGroupInSingleDesignState':
        ...
        if _5395.SubGroupInSingleDesignState.TYPE not in self.wrapped.CompoundStaticLoad.__class__.__mro__:
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3865.RootAssemblyPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3865.RootAssemblyPowerFlow))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3865.RootAssemblyPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3865.RootAssemblyPowerFlow))
        return value
