...
class AGMAGleasonConicalGearSetAdvancedTimeSteppingAnalysisForModulation(_6765.ConicalGearSetAdvancedTimeSteppingAnalysisForModulation):
    '''AGMAGleasonConicalGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2433.AGMAGleasonConicalGearSetSystemDeflection':
