...
class AGMAGleasonConicalGearMeshAdvancedTimeSteppingAnalysisForModulation(_6764.ConicalGearMeshAdvancedTimeSteppingAnalysisForModulation):
    '''AGMAGleasonConicalGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_design(self) -> '_2044.AGMAGleasonConicalGearMesh':
    ...
    @property
    def system_deflection_results(self) -> '_2432.AGMAGleasonConicalGearMeshSystemDeflection':
