...
class GearAdvancedTimeSteppingAnalysisForModulation(_6809.MountableComponentAdvancedTimeSteppingAnalysisForModulation):
    '''GearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2499.GearSystemDeflection':
