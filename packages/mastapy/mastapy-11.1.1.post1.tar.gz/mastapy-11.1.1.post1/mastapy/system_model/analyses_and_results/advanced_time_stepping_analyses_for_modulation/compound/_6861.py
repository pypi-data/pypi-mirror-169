...
class AbstractAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation(_6940.PartCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''AbstractAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6727.AbstractAssemblyAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6727.AbstractAssemblyAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6727.AbstractAssemblyAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6727.AbstractAssemblyAdvancedTimeSteppingAnalysisForModulation))
        return value
