...
class BeltConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_6926.InterMountableComponentConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''BeltConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2013.BeltConnection':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6740.BeltConnectionAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6740.BeltConnectionAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_6740.BeltConnectionAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6740.BeltConnectionAdvancedTimeSteppingAnalysisForModulation))
        return value
