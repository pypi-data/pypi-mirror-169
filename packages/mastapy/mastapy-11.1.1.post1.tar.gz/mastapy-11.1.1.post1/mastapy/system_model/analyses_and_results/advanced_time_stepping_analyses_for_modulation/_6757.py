...
class ConceptCouplingAdvancedTimeSteppingAnalysisForModulation(_6768.CouplingAdvancedTimeSteppingAnalysisForModulation):
    '''ConceptCouplingAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2457.ConceptCouplingSystemDeflection':
        ...
        return constructor.new(_2457.ConceptCouplingSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
