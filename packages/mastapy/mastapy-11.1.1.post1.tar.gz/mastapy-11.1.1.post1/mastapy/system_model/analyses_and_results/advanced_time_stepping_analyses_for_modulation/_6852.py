...
class TorqueConverterTurbineAdvancedTimeSteppingAnalysisForModulation(_6770.CouplingHalfAdvancedTimeSteppingAnalysisForModulation):
    '''TorqueConverterTurbineAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2569.TorqueConverterTurbineSystemDeflection':
        ...
        return constructor.new(_2569.TorqueConverterTurbineSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
