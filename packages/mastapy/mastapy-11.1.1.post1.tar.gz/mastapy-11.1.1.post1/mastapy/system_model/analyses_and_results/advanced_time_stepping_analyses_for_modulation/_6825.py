...
class RollingRingConnectionAdvancedTimeSteppingAnalysisForModulation(_6797.InterMountableComponentConnectionAdvancedTimeSteppingAnalysisForModulation):
    '''RollingRingConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2536.RollingRingConnectionSystemDeflection':
        ...
        return constructor.new(_2536.RollingRingConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
