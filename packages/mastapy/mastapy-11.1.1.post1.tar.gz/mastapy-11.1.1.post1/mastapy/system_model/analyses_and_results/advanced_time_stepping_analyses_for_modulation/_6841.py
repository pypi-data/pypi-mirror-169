...
class StraightBevelGearMeshAdvancedTimeSteppingAnalysisForModulation(_6748.BevelGearMeshAdvancedTimeSteppingAnalysisForModulation):
    '''StraightBevelGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2554.StraightBevelGearMeshSystemDeflection':
        ...
        return constructor.new(_2554.StraightBevelGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
