...
class TorqueConverterPumpAdvancedTimeSteppingAnalysisForModulation(_6770.CouplingHalfAdvancedTimeSteppingAnalysisForModulation):
    '''TorqueConverterPumpAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2567.TorqueConverterPumpSystemDeflection':
        ...
        return constructor.new(_2567.TorqueConverterPumpSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
