...
class StraightBevelSunGearAdvancedTimeSteppingAnalysisForModulation(_6837.StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation):
    '''StraightBevelSunGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2293.StraightBevelSunGear':
        ...
        return constructor.new(_2293.StraightBevelSunGear)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign is not None else None

    @property
    def system_deflection_results(self) -> '_2558.StraightBevelSunGearSystemDeflection':
        ...
        return constructor.new(_2558.StraightBevelSunGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
