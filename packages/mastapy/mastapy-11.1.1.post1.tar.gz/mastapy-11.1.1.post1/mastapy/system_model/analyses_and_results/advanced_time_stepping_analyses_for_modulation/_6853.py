...
class UnbalancedMassAdvancedTimeSteppingAnalysisForModulation(_6854.VirtualComponentAdvancedTimeSteppingAnalysisForModulation):
    '''UnbalancedMassAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2572.UnbalancedMassSystemDeflection':
        ...
        return constructor.new(_2572.UnbalancedMassSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
