...
class CouplingAdvancedTimeSteppingAnalysisForModulation(_6830.SpecialisedAssemblyAdvancedTimeSteppingAnalysisForModulation):
    '''CouplingAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2469.CouplingSystemDeflection':
