...
class BeltDriveCompoundAdvancedTimeSteppingAnalysisForModulation(_6959.SpecialisedAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''BeltDriveCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6741.BeltDriveAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6741.BeltDriveAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_6741.BeltDriveAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6741.BeltDriveAdvancedTimeSteppingAnalysisForModulation))
        return value
