...
class ClutchAdvancedTimeSteppingAnalysisForModulation(_6768.CouplingAdvancedTimeSteppingAnalysisForModulation):
    '''ClutchAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2451.ClutchSystemDeflection':
        ...
        return constructor.new(_2451.ClutchSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
