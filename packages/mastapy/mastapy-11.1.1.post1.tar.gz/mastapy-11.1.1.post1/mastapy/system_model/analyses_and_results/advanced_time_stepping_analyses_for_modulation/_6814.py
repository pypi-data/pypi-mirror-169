...
class PartToPartShearCouplingHalfAdvancedTimeSteppingAnalysisForModulation(_6770.CouplingHalfAdvancedTimeSteppingAnalysisForModulation):
    '''PartToPartShearCouplingHalfAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2525.PartToPartShearCouplingHalfSystemDeflection':
        ...
        return constructor.new(_2525.PartToPartShearCouplingHalfSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
