...
from mastapy.system_model.analyses_and_results.static_loads import _6562, _6608
...
class ConicalGearLoadCase(_6608.GearLoadCase):
    '''ConicalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6562.ConicalGearManufactureError':
        ...
        return constructor.new(_6562.ConicalGearManufactureError)(self.wrapped.GearManufactureErrors) if self.wrapped.GearManufactureErrors is not None else None
    ...
    def planetaries(self) -> 'List[ConicalGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Planetaries, constructor.new(ConicalGearLoadCase))
        return value
