...
class CylindricalGearSetLoadCase(_6613.GearSetLoadCase):
    '''CylindricalGearSetLoadCase
    ...
    @property
    def coefficient_of_friction_calculation_method(self) -> '_286.CoefficientOfFrictionCalculationMethod':
        ...
        return constructor.new(_286.CoefficientOfFrictionCalculationMethod)(value) if value is not None else None

    @coefficient_of_friction_calculation_method.setter
    def coefficient_of_friction_calculation_method(self, value: '_286.CoefficientOfFrictionCalculationMethod'):
    ...
    @property
    def reset_micro_geometry(self) -> '_6662.ResetMicroGeometryOptions':
        ...
        return constructor.new(_6662.ResetMicroGeometryOptions)(value) if value is not None else None

    @reset_micro_geometry.setter
    def reset_micro_geometry(self, value: '_6662.ResetMicroGeometryOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def overridden_micro_geometry(self) -> '_1059.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_1059.CylindricalGearSetMicroGeometry)(self.wrapped.OverriddenMicroGeometry) if self.wrapped.OverriddenMicroGeometry is not None else None

    @property
    def ltca(self) -> '_1015.LTCALoadCaseModifiableSettings':
        ...
        return constructor.new(_1015.LTCALoadCaseModifiableSettings)(self.wrapped.LTCA) if self.wrapped.LTCA is not None else None

    @property
    def gears(self) -> 'List[_6578.CylindricalGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6578.CylindricalGearLoadCase))
        return value

    @property
    def cylindrical_gears_load_case(self) -> 'List[_6578.CylindricalGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsLoadCase, constructor.new(_6578.CylindricalGearLoadCase))
        return value

    @property
    def cylindrical_meshes_load_case(self) -> 'List[_6580.CylindricalGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesLoadCase, constructor.new(_6580.CylindricalGearMeshLoadCase))
        return value

    def get_harmonic_load_data_for_import(self) -> '_6581.CylindricalGearSetHarmonicLoadData':
