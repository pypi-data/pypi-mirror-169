...
from mastapy.system_model.analyses_and_results.static_loads import _6522, _6529, _6523
...
class ConnectionLoadCase(_2392.ConnectionAnalysis):
    '''ConnectionLoadCase
    ...
    @property
    def static_load_case(self) -> '_6522.StaticLoadCase':
        ...
        if _6522.StaticLoadCase.TYPE not in self.wrapped.StaticLoadCase.__class__.__mro__:
    ...
    @property
    def time_series_load_case(self) -> '_6523.TimeSeriesLoadCase':
        ...
        return constructor.new(_6523.TimeSeriesLoadCase)(self.wrapped.TimeSeriesLoadCase) if self.wrapped.TimeSeriesLoadCase is not None else None
