...
from mastapy.system_model.analyses_and_results.static_loads import _6581, _6610
...
class CylindricalGearMeshLoadCase(_6610.GearMeshLoadCase):
    '''CylindricalGearMeshLoadCase
    ...
    @property
    def iso14179_coefficient_of_friction_constants_and_exponents(self) -> '_559.ISOTR1417912001CoefficientOfFrictionConstants':
        ...
        return constructor.new(_559.ISOTR1417912001CoefficientOfFrictionConstants)(self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponents) if self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponents is not None else None
