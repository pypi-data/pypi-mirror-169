...
from mastapy.utility.file_access_helpers import _1590
from mastapy.utility_gui import _1618
...
class MultiTimeSeriesDataInputFileOptions(_1618.DataInputFileOptions):
    '''MultiTimeSeriesDataInputFileOptions
    ...
    @property
    def delimiter_options(self) -> '_1590.TextFileDelimiterOptions':
        ...
        return constructor.new(_1590.TextFileDelimiterOptions)(self.wrapped.DelimiterOptions) if self.wrapped.DelimiterOptions is not None else None
