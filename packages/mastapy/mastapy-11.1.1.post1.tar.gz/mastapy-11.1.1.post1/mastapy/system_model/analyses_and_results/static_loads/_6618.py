...
from mastapy.system_model.analyses_and_results.static_loads import _6646, _6620, _6596
...
class HarmonicLoadDataExcelImport(_6620.HarmonicLoadDataImportBase['_6596.ElectricMachineHarmonicLoadExcelImportOptions']):
    '''HarmonicLoadDataExcelImport
    ...
    @property
    def speeds(self) -> 'List[_6646.NamedSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Speeds, constructor.new(_6646.NamedSpeed))
        return value
