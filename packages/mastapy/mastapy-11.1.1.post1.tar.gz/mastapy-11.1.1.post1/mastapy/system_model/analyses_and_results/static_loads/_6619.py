...
from mastapy.system_model.analyses_and_results.static_loads import _6630, _6617, _6597
...
class HarmonicLoadDataFluxImport(_6617.HarmonicLoadDataCSVImport['_6597.ElectricMachineHarmonicLoadFluxImportOptions']):
    '''HarmonicLoadDataFluxImport
    ...
    @property
    def inner_diameter_reference(self) -> '_6630.InnerDiameterReference':
        ...
        return constructor.new(_6630.InnerDiameterReference)(value) if value is not None else None

    @inner_diameter_reference.setter
    def inner_diameter_reference(self, value: '_6630.InnerDiameterReference'):
