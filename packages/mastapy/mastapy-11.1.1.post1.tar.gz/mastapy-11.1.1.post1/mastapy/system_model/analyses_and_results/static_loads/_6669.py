...
class RootAssemblyLoadCase(_6536.AssemblyLoadCase):
    '''RootAssemblyLoadCase
    ...
    def brake_force_input_values(self) -> '_91.ForceInputComponent':
        ...
        return constructor.new(_91.ForceInputComponent)(self.wrapped.BrakeForceInputValues) if self.wrapped.BrakeForceInputValues is not None else None
    ...
    def road_incline_input_values(self) -> '_90.AngleInputComponent':
        ...
        return constructor.new(_90.AngleInputComponent)(self.wrapped.RoadInclineInputValues) if self.wrapped.RoadInclineInputValues is not None else None

    @property
    def drive_cycle_pid_control_settings(self) -> '_1376.PIDControlSettings':
        ...
        return constructor.new(_1376.PIDControlSettings)(self.wrapped.DriveCyclePIDControlSettings) if self.wrapped.DriveCyclePIDControlSettings is not None else None
    ...
    def target_vehicle_speed(self) -> '_95.VelocityInputComponent':
        ...
        return constructor.new(_95.VelocityInputComponent)(self.wrapped.TargetVehicleSpeed) if self.wrapped.TargetVehicleSpeed is not None else None

    @property
    def load_case(self) -> '_6522.StaticLoadCase':
        ...
        if _6522.StaticLoadCase.TYPE not in self.wrapped.LoadCase.__class__.__mro__:
    ...
    @property
    def supercharger_rotor_sets(self) -> 'List[_6582.CylindricalGearSetLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SuperchargerRotorSets, constructor.new(_6582.CylindricalGearSetLoadCase))
        return value
