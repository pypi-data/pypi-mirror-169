...
from mastapy.system_model.analyses_and_results.static_loads import _6707, _6708, _6547
...
class ZerolBevelGearSetLoadCase(_6547.BevelGearSetLoadCase):
    '''ZerolBevelGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6707.ZerolBevelGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6707.ZerolBevelGearLoadCase))
        return value

    @property
    def zerol_bevel_gears_load_case(self) -> 'List[_6707.ZerolBevelGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsLoadCase, constructor.new(_6707.ZerolBevelGearLoadCase))
        return value

    @property
    def zerol_bevel_meshes_load_case(self) -> 'List[_6708.ZerolBevelGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesLoadCase, constructor.new(_6708.ZerolBevelGearMeshLoadCase))
        return value
