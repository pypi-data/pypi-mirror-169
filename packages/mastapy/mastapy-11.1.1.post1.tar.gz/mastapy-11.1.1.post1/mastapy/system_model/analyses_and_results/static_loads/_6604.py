...
from mastapy.system_model.analyses_and_results.static_loads import _6602, _6603, _6613
...
class FaceGearSetLoadCase(_6613.GearSetLoadCase):
    '''FaceGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6602.FaceGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6602.FaceGearLoadCase))
        return value

    @property
    def face_gears_load_case(self) -> 'List[_6602.FaceGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsLoadCase, constructor.new(_6602.FaceGearLoadCase))
        return value

    @property
    def face_meshes_load_case(self) -> 'List[_6603.FaceGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesLoadCase, constructor.new(_6603.FaceGearMeshLoadCase))
        return value
