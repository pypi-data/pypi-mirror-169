...
from mastapy.gears.gear_designs.conical import _1115, _1109
from mastapy.system_model.analyses_and_results.static_loads import _6564, _6610
...
class ConicalGearMeshLoadCase(_6610.GearMeshLoadCase):
    '''ConicalGearMeshLoadCase
    ...
    @property
    def results_from_imported_xml(self) -> '_1115.KimosBevelHypoidSingleLoadCaseResultsData':
        ...
        return constructor.new(_1115.KimosBevelHypoidSingleLoadCaseResultsData)(self.wrapped.ResultsFromImportedXML) if self.wrapped.ResultsFromImportedXML is not None else None

    @property
    def user_specified_misalignments(self) -> '_1109.ConicalMeshMisalignments':
        ...
        return constructor.new(_1109.ConicalMeshMisalignments)(self.wrapped.UserSpecifiedMisalignments) if self.wrapped.UserSpecifiedMisalignments is not None else None
    ...
    def get_harmonic_load_data_for_import(self) -> '_6564.ConicalGearSetHarmonicLoadData':
