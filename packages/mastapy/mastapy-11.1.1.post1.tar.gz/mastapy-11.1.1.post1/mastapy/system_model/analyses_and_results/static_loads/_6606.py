...
class FlexiblePinAssemblyLoadCase(_6673.SpecialisedAssemblyLoadCase):
    '''FlexiblePinAssemblyLoadCase
    ...
    @property
    def include_inner_race_distortion_for_flexible_pin_spindle(self) -> '_1388.LoadCaseOverrideOption':
    ...
    def include_inner_race_distortion_for_flexible_pin_spindle(self, value: '_1388.LoadCaseOverrideOption'):
