...
from mastapy.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import _5405
...
TAssembly = TypeVar('TAssembly', bound='_2180.AbstractAssembly')
TAssemblyStaticLoad = TypeVar('TAssemblyStaticLoad', bound='_6524.AbstractAssemblyLoadCase')


class AbstractAssemblyStaticLoadCaseGroup(_5405.PartStaticLoadCaseGroup, Generic[TAssembly, TAssemblyStaticLoad]):
    '''AbstractAssemblyStaticLoadCaseGroup
