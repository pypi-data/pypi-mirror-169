...
class CouplingCompoundCriticalSpeedAnalysis(_6490.SpecialisedAssemblyCompoundCriticalSpeedAnalysis):
    '''CouplingCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6299.CouplingCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6299.CouplingCriticalSpeedAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6299.CouplingCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6299.CouplingCriticalSpeedAnalysis))
        return value
