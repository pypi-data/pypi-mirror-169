...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6425
...
class KlingelnbergCycloPalloidConicalGearMeshCompoundCriticalSpeedAnalysis(_6425.ConicalGearMeshCompoundCriticalSpeedAnalysis):
    '''KlingelnbergCycloPalloidConicalGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6330.KlingelnbergCycloPalloidConicalGearMeshCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6330.KlingelnbergCycloPalloidConicalGearMeshCriticalSpeedAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_6330.KlingelnbergCycloPalloidConicalGearMeshCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6330.KlingelnbergCycloPalloidConicalGearMeshCriticalSpeedAnalysis))
        return value
