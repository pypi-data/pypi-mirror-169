...
class CVTCompoundStabilityAnalysis(_3643.BeltDriveCompoundStabilityAnalysis):
    '''CVTCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3544.CVTStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3544.CVTStabilityAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3544.CVTStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3544.CVTStabilityAnalysis))
        return value
