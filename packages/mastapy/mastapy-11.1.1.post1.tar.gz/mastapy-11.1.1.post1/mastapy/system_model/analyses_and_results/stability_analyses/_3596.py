...
from mastapy.system_model.analyses_and_results.stability_analyses import _2385, _3508
...
class RootAssemblyStabilityAnalysis(_3508.AssemblyStabilityAnalysis):
    '''RootAssemblyStabilityAnalysis
    ...
    @property
    def stability_analysis_inputs(self) -> '_2385.StabilityAnalysis':
        ...
        return constructor.new(_2385.StabilityAnalysis)(self.wrapped.StabilityAnalysisInputs) if self.wrapped.StabilityAnalysisInputs is not None else None
