...
from mastapy.system_model.analyses_and_results.stability_analyses import _2385
...
class ConnectionStabilityAnalysis(_7261.ConnectionStaticLoadAnalysisCase):
    '''ConnectionStabilityAnalysis
