...
from mastapy.system_model.analyses_and_results.stability_analyses import _3541, _3503
...
class ShaftStabilityAnalysis(_3503.AbstractShaftStabilityAnalysis):
    '''ShaftStabilityAnalysis
    ...
    @property
    def critical_speeds(self) -> 'List[_3541.CriticalSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CriticalSpeeds, constructor.new(_3541.CriticalSpeed))
        return value
