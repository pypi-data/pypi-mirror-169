...
from mastapy.system_model.part_model.gears import _2269, _2285, _2268
...
class CylindricalGearMesh(_2058.GearMesh):
    '''CylindricalGearMesh
    ...
    @property
    def cylindrical_gear_set(self) -> '_2269.CylindricalGearSet':
        ...
        if _2269.CylindricalGearSet.TYPE not in self.wrapped.CylindricalGearSet.__class__.__mro__:
    ...
    @property
    def centre_distance_range(self) -> '_1367.ShortLengthRange':
        ...
        return constructor.new(_1367.ShortLengthRange)(self.wrapped.CentreDistanceRange) if self.wrapped.CentreDistanceRange is not None else None

    @property
    def active_gear_mesh_design(self) -> '_977.CylindricalGearMeshDesign':
        ...
        return constructor.new(_977.CylindricalGearMeshDesign)(self.wrapped.ActiveGearMeshDesign) if self.wrapped.ActiveGearMeshDesign is not None else None

    @property
    def cylindrical_gear_mesh_design(self) -> '_977.CylindricalGearMeshDesign':
        ...
        return constructor.new(_977.CylindricalGearMeshDesign)(self.wrapped.CylindricalGearMeshDesign) if self.wrapped.CylindricalGearMeshDesign is not None else None

    @property
    def cylindrical_gears(self) -> 'List[_2268.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_2268.CylindricalGear))
        return value
