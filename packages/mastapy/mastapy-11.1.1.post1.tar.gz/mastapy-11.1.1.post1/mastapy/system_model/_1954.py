...
class DesignEntity(_0.APIBase):
    ...
    @property
    def design_properties(self) -> '_1950.Design':
        ...
        return constructor.new(_1950.Design)(self.wrapped.DesignProperties) if self.wrapped.DesignProperties is not None else None
