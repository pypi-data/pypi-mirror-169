...
from mastapy.utility.enums import _1593
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.nodal_analysis.component_mode_synthesis import _208
from mastapy.nodal_analysis.dev_tools_analyses import _166
from mastapy.system_model.fe import _2144, _2134
...
class FESubstructureWithSelectionForStaticAnalysis(_2134.FESubstructureWithSelection):
    '''FESubstructureWithSelectionForStaticAnalysis
    ...
    @property
    def static_draw_style(self) -> '_166.FEModelStaticAnalysisDrawStyle':
        ...
        return constructor.new(_166.FEModelStaticAnalysisDrawStyle)(self.wrapped.StaticDrawStyle) if self.wrapped.StaticDrawStyle is not None else None

    @property
    def boundary_conditions_selected_nodes(self) -> 'List[_2144.NodeBoundaryConditionStaticAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoundaryConditionsSelectedNodes, constructor.new(_2144.NodeBoundaryConditionStaticAnalysis))
        return value

    @property
    def boundary_conditions_all_nodes(self) -> 'List[_2144.NodeBoundaryConditionStaticAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoundaryConditionsAllNodes, constructor.new(_2144.NodeBoundaryConditionStaticAnalysis))
        return value

    @property
    def force_results(self) -> 'List[_1366.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceResults, constructor.new(_1366.VectorWithLinearAndAngularComponents))
        return value

    @property
    def displacement_results(self) -> 'List[_1366.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DisplacementResults, constructor.new(_1366.VectorWithLinearAndAngularComponents))
        return value
