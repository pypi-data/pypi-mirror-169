...
class FESubstructureWithSelectionForHarmonicAnalysis(_2134.FESubstructureWithSelection):
    '''FESubstructureWithSelectionForHarmonicAnalysis
    ...
    @property
    def harmonic_draw_style(self) -> '_162.FEModelHarmonicAnalysisDrawStyle':
        ...
        return constructor.new(_162.FEModelHarmonicAnalysisDrawStyle)(self.wrapped.HarmonicDrawStyle) if self.wrapped.HarmonicDrawStyle is not None else None
