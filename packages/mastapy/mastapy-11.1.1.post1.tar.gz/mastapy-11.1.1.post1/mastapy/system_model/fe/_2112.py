...
class ContactPairWithSelection(_0.APIBase):
    ...
    @property
    def contact_pair(self) -> '_177.ContactPairReporting':
        ...
        return constructor.new(_177.ContactPairReporting)(self.wrapped.ContactPair) if self.wrapped.ContactPair is not None else None
