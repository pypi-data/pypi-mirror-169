...
class BaseFEWithSelection(_0.APIBase):
    ...
    @property
    def node_selection(self) -> '_169.FENodeSelectionDrawStyle':
        ...
        return constructor.new(_169.FENodeSelectionDrawStyle)(self.wrapped.NodeSelection) if self.wrapped.NodeSelection is not None else None

    @property
    def draw_style(self) -> '_154.DrawStyleForFE':
        ...
        return constructor.new(_154.DrawStyleForFE)(self.wrapped.DrawStyle) if self.wrapped.DrawStyle is not None else None

    @property
    def transparency_draw_style(self) -> '_168.FEModelTransparencyDrawStyle':
        ...
        return constructor.new(_168.FEModelTransparencyDrawStyle)(self.wrapped.TransparencyDrawStyle) if self.wrapped.TransparencyDrawStyle is not None else None

    @property
    def component_draw_style(self) -> '_161.FEModelComponentDrawStyle':
        ...
        return constructor.new(_161.FEModelComponentDrawStyle)(self.wrapped.ComponentDrawStyle) if self.wrapped.ComponentDrawStyle is not None else None
    ...
    def select_component(self, component: '_2189.Component'):
