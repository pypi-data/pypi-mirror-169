...
class IndependentMastaCreatedCondensationNode(_0.APIBase):
    ...
    @property
    def rigid_coupling_type(self) -> '_176.RigidCouplingType':
        ...
        return constructor.new(_176.RigidCouplingType)(value) if value is not None else None

    @rigid_coupling_type.setter
    def rigid_coupling_type(self, value: '_176.RigidCouplingType'):
    ...
    @property
    def fe_substructure_node(self) -> '_2129.FESubstructureNode':
        ...
        return constructor.new(_2129.FESubstructureNode)(self.wrapped.FESubstructureNode) if self.wrapped.FESubstructureNode is not None else None
