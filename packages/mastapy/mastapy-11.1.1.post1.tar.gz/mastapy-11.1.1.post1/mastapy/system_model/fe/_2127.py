...
from mastapy.system_model.fe import (
    _2107, _2132, _2155, _2101,
    _2103, _2128, _2153, _2129,
    _2125, _2139, _2140, _2138,
    _2135, _2136, _2137
)
from mastapy._internal.python_net import python_net_import
from mastapy.system_model.part_model import _2193, _2189, _2197
...
from mastapy.system_model import _1968
from mastapy.math_utility import _1300
from mastapy.materials import _210, _252
from mastapy.system_model.part_model.shaft_model import _2226
from mastapy.system_model.fe.links import _2162
from mastapy.math_utility.measured_vectors import _1366
from mastapy.nodal_analysis.fe_export_utility import _153
...
class FESubstructure(_63.FEStiffness):
    ...
    @property
    def bearing_node_alignment(self) -> '_2107.BearingNodeAlignmentOption':
        ...
        return constructor.new(_2107.BearingNodeAlignmentOption)(value) if value is not None else None

    @bearing_node_alignment.setter
    def bearing_node_alignment(self, value: '_2107.BearingNodeAlignmentOption'):
    ...
    @property
    def alignment_method(self) -> '_2101.AlignmentMethod':
        ...
        return constructor.new(_2101.AlignmentMethod)(value) if value is not None else None

    @alignment_method.setter
    def alignment_method(self, value: '_2101.AlignmentMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    def gravity_force_source(self) -> '_67.GravityForceSource':
        ...
        return constructor.new(_67.GravityForceSource)(value) if value is not None else None
    ...
    def fe_meshing_options(self) -> '_81.ShaftFEMeshingOptions':
        ...
        return constructor.new(_81.ShaftFEMeshingOptions)(self.wrapped.FEMeshingOptions) if self.wrapped.FEMeshingOptions is not None else None

    @property
    def cms_model(self) -> '_200.CMSModel':
        ...
        return constructor.new(_200.CMSModel)(self.wrapped.CMSModel) if self.wrapped.CMSModel is not None else None

    @property
    def geometry_modeller_dimensions(self) -> '_147.GeometryModellerDimensions':
        ...
        return constructor.new(_147.GeometryModellerDimensions)(self.wrapped.GeometryModellerDimensions) if self.wrapped.GeometryModellerDimensions is not None else None

    @property
    def alignment_to_component(self) -> '_1968.RelativeComponentAlignment[_2189.Component]':
        ...
        return constructor.new(_1968.RelativeComponentAlignment)[_2189.Component](self.wrapped.AlignmentToComponent) if self.wrapped.AlignmentToComponent is not None else None

    @property
    def alignment_using_axial_node_positions(self) -> '_2103.AlignmentUsingAxialNodePositions':
        ...
        return constructor.new(_2103.AlignmentUsingAxialNodePositions)(self.wrapped.AlignmentUsingAxialNodePositions) if self.wrapped.AlignmentUsingAxialNodePositions is not None else None

    @property
    def coordinate_system(self) -> '_1300.CoordinateSystem3D':
        ...
        return constructor.new(_1300.CoordinateSystem3D)(self.wrapped.CoordinateSystem) if self.wrapped.CoordinateSystem is not None else None

    @property
    def export(self) -> '_2128.FESubstructureExportOptions':
        ...
        return constructor.new(_2128.FESubstructureExportOptions)(self.wrapped.Export) if self.wrapped.Export is not None else None

    @property
    def acoustic_radiation_efficiency(self) -> '_210.AcousticRadiationEfficiency':
        ...
        return constructor.new(_210.AcousticRadiationEfficiency)(self.wrapped.AcousticRadiationEfficiency) if self.wrapped.AcousticRadiationEfficiency is not None else None

    @property
    def sound_pressure_enclosure(self) -> '_252.SoundPressureEnclosure':
        ...
        return constructor.new(_252.SoundPressureEnclosure)(self.wrapped.SoundPressureEnclosure) if self.wrapped.SoundPressureEnclosure is not None else None

    @property
    def shafts_that_can_be_replaced(self) -> 'List[_2153.ReplacedShaftSelectionHelper]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftsThatCanBeReplaced, constructor.new(_2153.ReplacedShaftSelectionHelper))
        return value
    ...
    @property
    def replaced_shafts(self) -> 'List[_2226.Shaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ReplacedShafts, constructor.new(_2226.Shaft))
        return value

    @property
    def links(self) -> 'List[_2162.FELink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_2162.FELink))
        return value

    @property
    def thermal_expansion_forces(self) -> 'List[_1366.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionForces, constructor.new(_1366.VectorWithLinearAndAngularComponents))
        return value

    @property
    def thermal_expansion_displacements(self) -> 'List[_1366.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionDisplacements, constructor.new(_1366.VectorWithLinearAndAngularComponents))
        return value

    @property
    def geometries(self) -> 'List[_2125.FEStiffnessGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Geometries, constructor.new(_2125.FEStiffnessGeometry))
        return value

    @property
    def gear_meshing_options(self) -> 'List[_2139.GearMeshingOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshingOptions, constructor.new(_2139.GearMeshingOptions))
        return value

    @property
    def independent_masta_created_condensation_nodes(self) -> 'List[_2140.IndependentMastaCreatedCondensationNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.IndependentMastaCreatedCondensationNodes, constructor.new(_2140.IndependentMastaCreatedCondensationNode))
        return value

    @property
    def fe_part(self) -> '_2197.FEPart':
        ...
        return constructor.new(_2197.FEPart)(self.wrapped.FEPart) if self.wrapped.FEPart is not None else None
    ...
    def import_fe_mesh(self, file_path: 'str', format_: '_153.FEExportFormat', length_scale: Optional['float'] = 1.0, force_scale: Optional['float'] = 1.0, progress: Optional['_7278.TaskProgress'] = None):
    ...
    def load_stl_geometry(self, length_unit: '_1406.Unit', file_name: 'str'):
    ...
    def import_node_positions(self, file_name: 'str', distance_unit: '_1406.Unit'):
    ...
    def import_reduced_stiffness(self, file_name: 'str', distance_unit: '_1406.Unit', force_unit: '_1406.Unit'):
    ...
    def load_existing_masta_fe_file_with_progress(self, file_name: 'str', progress: '_7278.TaskProgress'):
        ''' 'LoadExistingMastaFEFile' is the original name of this method.
    ...
    def create_fe_substructure_with_selection_for_static_analysis(self) -> '_2138.FESubstructureWithSelectionForStaticAnalysis':
    ...
    def create_fe_substructure_with_selection_components(self) -> '_2135.FESubstructureWithSelectionComponents':
    ...
    def create_fe_substructure_with_selection_for_harmonic_analysis(self) -> '_2136.FESubstructureWithSelectionForHarmonicAnalysis':
    ...
    def create_fe_substructure_with_selection_for_modal_analysis(self) -> '_2137.FESubstructureWithSelectionForModalAnalysis':
    ...
    def links_for(self, node: '_2129.FESubstructureNode') -> 'List[_2162.FELink]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.LinksFor(node.wrapped if node else None), constructor.new(_2162.FELink))
