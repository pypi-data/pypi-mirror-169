...
from mastapy.system_model.fe.links import _2169
...
class ElectricMachineStatorFELink(_2169.MultiNodeFELink):
    '''ElectricMachineStatorFELink
    ...
    @property
    def electric_machine_dynamic_load_data(self) -> '_2119.ElectricMachineDynamicLoadData':
        ...
        return constructor.new(_2119.ElectricMachineDynamicLoadData)(self.wrapped.ElectricMachineDynamicLoadData) if self.wrapped.ElectricMachineDynamicLoadData is not None else None
