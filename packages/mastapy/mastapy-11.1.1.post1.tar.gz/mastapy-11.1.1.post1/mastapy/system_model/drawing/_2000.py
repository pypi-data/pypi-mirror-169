...
from mastapy.utility.enums import _1591
...
class ScalingDrawStyle(_0.APIBase):
    ...
    @property
    def bearing_force_arrows(self) -> '_1591.BearingForceArrowOption':
        ...
        return constructor.new(_1591.BearingForceArrowOption)(value) if value is not None else None

    @bearing_force_arrows.setter
    def bearing_force_arrows(self, value: '_1591.BearingForceArrowOption'):
