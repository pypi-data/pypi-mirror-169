...
from mastapy.system_model.drawing import _1990, _1997
...
from mastapy.system_model.analyses_and_results.rotor_dynamics import _3762
...
class AbstractSystemDeflectionViewable(_1997.PartAnalysisCaseWithContourViewable):
    '''AbstractSystemDeflectionViewable
    ...
    @property
    def contour_draw_style(self) -> '_1990.ContourDrawStyle':
        ...
        if _1990.ContourDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_system_deflection_draw_style(self) -> '_2564.SystemDeflectionDrawStyle':
        ...
        if _2564.SystemDeflectionDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_steady_state_synchronous_response_draw_style(self) -> '_2828.SteadyStateSynchronousResponseDrawStyle':
        ...
        if _2828.SteadyStateSynchronousResponseDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_stability_analysis_draw_style(self) -> '_3607.StabilityAnalysisDrawStyle':
        ...
        if _3607.StabilityAnalysisDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_rotor_dynamics_draw_style(self) -> '_3762.RotorDynamicsDrawStyle':
        ...
        if _3762.RotorDynamicsDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_modal_analysis_draw_style(self) -> '_4386.ModalAnalysisDrawStyle':
        ...
        if _4386.ModalAnalysisDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_mbd_analysis_draw_style(self) -> '_5189.MBDAnalysisDrawStyle':
        ...
        if _5189.MBDAnalysisDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_harmonic_analysis_draw_style(self) -> '_5487.HarmonicAnalysisDrawStyle':
        ...
        if _5487.HarmonicAnalysisDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_dynamic_analysis_draw_style(self) -> '_6048.DynamicAnalysisDrawStyle':
        ...
        if _6048.DynamicAnalysisDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_critical_speed_analysis_draw_style(self) -> '_6301.CriticalSpeedAnalysisDrawStyle':
        ...
        if _6301.CriticalSpeedAnalysisDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
