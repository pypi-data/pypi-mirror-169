...
class FlexiblePinAssembly(_2220.SpecialisedAssembly):
    '''FlexiblePinAssembly
    ...
    @property
    def planet_gear(self) -> '_2268.CylindricalGear':
        ...
        if _2268.CylindricalGear.TYPE not in self.wrapped.PlanetGear.__class__.__mro__:
