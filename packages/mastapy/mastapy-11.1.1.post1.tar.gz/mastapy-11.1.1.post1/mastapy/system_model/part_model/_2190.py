...
class ComponentsConnectedResult(_0.APIBase):
    ...
    @property
    def created_socket_connection(self) -> '_2191.ConnectedSockets':
        ...
        return constructor.new(_2191.ConnectedSockets)(self.wrapped.CreatedSocketConnection) if self.wrapped.CreatedSocketConnection is not None else None
