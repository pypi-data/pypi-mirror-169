...
from mastapy.system_model.part_model import _2205, _2208
...
class PlanetCarrier(_2208.MountableComponent):
    '''PlanetCarrier
    ...
    @property
    def planetary_sockets(self) -> 'List[_2033.PlanetarySocket]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetarySockets, constructor.new(_2033.PlanetarySocket))
        return value

    def attach_carrier_shaft(self, shaft: '_2226.Shaft', offset: Optional['float'] = float('nan')):
    ...
    def attach_pin_shaft(self, shaft: '_2226.Shaft', offset: Optional['float'] = float('nan')):
