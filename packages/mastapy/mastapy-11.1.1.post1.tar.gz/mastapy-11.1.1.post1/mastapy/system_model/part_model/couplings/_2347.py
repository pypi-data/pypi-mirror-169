...
from mastapy.system_model.part_model.couplings import _2346, _2348
...
class SynchroniserHalf(_2348.SynchroniserPart):
    '''SynchroniserHalf
    ...
    @property
    def cones(self) -> 'List[_2346.SynchroniserCone]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_2346.SynchroniserCone))
        return value
