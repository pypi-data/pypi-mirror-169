...
class SpringDamper(_2326.Coupling):
    '''SpringDamper
    ...
    @property
    def connection(self) -> '_2095.SpringDamperConnection':
        ...
        return constructor.new(_2095.SpringDamperConnection)(self.wrapped.Connection) if self.wrapped.Connection is not None else None
