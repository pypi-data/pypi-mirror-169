...
from mastapy.system_model.part_model.couplings import (
    _2327, _2322, _2325, _2330,
    _2332, _2333, _2339, _2344,
    _2347, _2348, _2349, _2351,
    _2353
)
...
class Coupling(_2220.SpecialisedAssembly):
    '''Coupling
    ...
    @property
    def halves(self) -> 'List[_2327.CouplingHalf]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Halves, constructor.new(_2327.CouplingHalf))
        return value

    @property
    def half_a(self) -> '_2327.CouplingHalf':
        ...
        if _2327.CouplingHalf.TYPE not in self.wrapped.HalfA.__class__.__mro__:
    ...
    @property
    def half_a_of_type_clutch_half(self) -> '_2322.ClutchHalf':
        ...
        if _2322.ClutchHalf.TYPE not in self.wrapped.HalfA.__class__.__mro__:
            raise CastException('Failed to cast half_a to ClutchHalf. Expected: {}.'.format(self.wrapped.HalfA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfA.__class__)(self.wrapped.HalfA) if self.wrapped.HalfA is not None else None

    @property
    def half_a_of_type_concept_coupling_half(self) -> '_2325.ConceptCouplingHalf':
        ...
        if _2325.ConceptCouplingHalf.TYPE not in self.wrapped.HalfA.__class__.__mro__:
    ...
    @property
    def half_a_of_type_cvt_pulley(self) -> '_2330.CVTPulley':
        ...
        if _2330.CVTPulley.TYPE not in self.wrapped.HalfA.__class__.__mro__:
            raise CastException('Failed to cast half_a to CVTPulley. Expected: {}.'.format(self.wrapped.HalfA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfA.__class__)(self.wrapped.HalfA) if self.wrapped.HalfA is not None else None

    @property
    def half_a_of_type_part_to_part_shear_coupling_half(self) -> '_2332.PartToPartShearCouplingHalf':
        ...
        if _2332.PartToPartShearCouplingHalf.TYPE not in self.wrapped.HalfA.__class__.__mro__:
    ...
    @property
    def half_a_of_type_pulley(self) -> '_2333.Pulley':
        ...
        if _2333.Pulley.TYPE not in self.wrapped.HalfA.__class__.__mro__:
            raise CastException('Failed to cast half_a to Pulley. Expected: {}.'.format(self.wrapped.HalfA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfA.__class__)(self.wrapped.HalfA) if self.wrapped.HalfA is not None else None

    @property
    def half_a_of_type_rolling_ring(self) -> '_2339.RollingRing':
        ...
        if _2339.RollingRing.TYPE not in self.wrapped.HalfA.__class__.__mro__:
            raise CastException('Failed to cast half_a to RollingRing. Expected: {}.'.format(self.wrapped.HalfA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfA.__class__)(self.wrapped.HalfA) if self.wrapped.HalfA is not None else None

    @property
    def half_a_of_type_spring_damper_half(self) -> '_2344.SpringDamperHalf':
        ...
        if _2344.SpringDamperHalf.TYPE not in self.wrapped.HalfA.__class__.__mro__:
            raise CastException('Failed to cast half_a to SpringDamperHalf. Expected: {}.'.format(self.wrapped.HalfA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfA.__class__)(self.wrapped.HalfA) if self.wrapped.HalfA is not None else None

    @property
    def half_a_of_type_synchroniser_half(self) -> '_2347.SynchroniserHalf':
        ...
        if _2347.SynchroniserHalf.TYPE not in self.wrapped.HalfA.__class__.__mro__:
            raise CastException('Failed to cast half_a to SynchroniserHalf. Expected: {}.'.format(self.wrapped.HalfA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfA.__class__)(self.wrapped.HalfA) if self.wrapped.HalfA is not None else None

    @property
    def half_a_of_type_synchroniser_part(self) -> '_2348.SynchroniserPart':
        ...
        if _2348.SynchroniserPart.TYPE not in self.wrapped.HalfA.__class__.__mro__:
            raise CastException('Failed to cast half_a to SynchroniserPart. Expected: {}.'.format(self.wrapped.HalfA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfA.__class__)(self.wrapped.HalfA) if self.wrapped.HalfA is not None else None

    @property
    def half_a_of_type_synchroniser_sleeve(self) -> '_2349.SynchroniserSleeve':
        ...
        if _2349.SynchroniserSleeve.TYPE not in self.wrapped.HalfA.__class__.__mro__:
    ...
    @property
    def half_a_of_type_torque_converter_pump(self) -> '_2351.TorqueConverterPump':
        ...
        if _2351.TorqueConverterPump.TYPE not in self.wrapped.HalfA.__class__.__mro__:
    ...
    @property
    def half_a_of_type_torque_converter_turbine(self) -> '_2353.TorqueConverterTurbine':
        ...
        if _2353.TorqueConverterTurbine.TYPE not in self.wrapped.HalfA.__class__.__mro__:
    ...
    @property
    def half_b(self) -> '_2327.CouplingHalf':
        ...
        if _2327.CouplingHalf.TYPE not in self.wrapped.HalfB.__class__.__mro__:
    ...
    @property
    def half_b_of_type_clutch_half(self) -> '_2322.ClutchHalf':
        ...
        if _2322.ClutchHalf.TYPE not in self.wrapped.HalfB.__class__.__mro__:
            raise CastException('Failed to cast half_b to ClutchHalf. Expected: {}.'.format(self.wrapped.HalfB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfB.__class__)(self.wrapped.HalfB) if self.wrapped.HalfB is not None else None

    @property
    def half_b_of_type_concept_coupling_half(self) -> '_2325.ConceptCouplingHalf':
        ...
        if _2325.ConceptCouplingHalf.TYPE not in self.wrapped.HalfB.__class__.__mro__:
    ...
    @property
    def half_b_of_type_cvt_pulley(self) -> '_2330.CVTPulley':
        ...
        if _2330.CVTPulley.TYPE not in self.wrapped.HalfB.__class__.__mro__:
            raise CastException('Failed to cast half_b to CVTPulley. Expected: {}.'.format(self.wrapped.HalfB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfB.__class__)(self.wrapped.HalfB) if self.wrapped.HalfB is not None else None

    @property
    def half_b_of_type_part_to_part_shear_coupling_half(self) -> '_2332.PartToPartShearCouplingHalf':
        ...
        if _2332.PartToPartShearCouplingHalf.TYPE not in self.wrapped.HalfB.__class__.__mro__:
    ...
    @property
    def half_b_of_type_pulley(self) -> '_2333.Pulley':
        ...
        if _2333.Pulley.TYPE not in self.wrapped.HalfB.__class__.__mro__:
            raise CastException('Failed to cast half_b to Pulley. Expected: {}.'.format(self.wrapped.HalfB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfB.__class__)(self.wrapped.HalfB) if self.wrapped.HalfB is not None else None

    @property
    def half_b_of_type_rolling_ring(self) -> '_2339.RollingRing':
        ...
        if _2339.RollingRing.TYPE not in self.wrapped.HalfB.__class__.__mro__:
            raise CastException('Failed to cast half_b to RollingRing. Expected: {}.'.format(self.wrapped.HalfB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfB.__class__)(self.wrapped.HalfB) if self.wrapped.HalfB is not None else None

    @property
    def half_b_of_type_spring_damper_half(self) -> '_2344.SpringDamperHalf':
        ...
        if _2344.SpringDamperHalf.TYPE not in self.wrapped.HalfB.__class__.__mro__:
            raise CastException('Failed to cast half_b to SpringDamperHalf. Expected: {}.'.format(self.wrapped.HalfB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfB.__class__)(self.wrapped.HalfB) if self.wrapped.HalfB is not None else None

    @property
    def half_b_of_type_synchroniser_half(self) -> '_2347.SynchroniserHalf':
        ...
        if _2347.SynchroniserHalf.TYPE not in self.wrapped.HalfB.__class__.__mro__:
            raise CastException('Failed to cast half_b to SynchroniserHalf. Expected: {}.'.format(self.wrapped.HalfB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfB.__class__)(self.wrapped.HalfB) if self.wrapped.HalfB is not None else None

    @property
    def half_b_of_type_synchroniser_part(self) -> '_2348.SynchroniserPart':
        ...
        if _2348.SynchroniserPart.TYPE not in self.wrapped.HalfB.__class__.__mro__:
            raise CastException('Failed to cast half_b to SynchroniserPart. Expected: {}.'.format(self.wrapped.HalfB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfB.__class__)(self.wrapped.HalfB) if self.wrapped.HalfB is not None else None

    @property
    def half_b_of_type_synchroniser_sleeve(self) -> '_2349.SynchroniserSleeve':
        ...
        if _2349.SynchroniserSleeve.TYPE not in self.wrapped.HalfB.__class__.__mro__:
    ...
    @property
    def half_b_of_type_torque_converter_pump(self) -> '_2351.TorqueConverterPump':
        ...
        if _2351.TorqueConverterPump.TYPE not in self.wrapped.HalfB.__class__.__mro__:
    ...
    @property
    def half_b_of_type_torque_converter_turbine(self) -> '_2353.TorqueConverterTurbine':
        ...
        if _2353.TorqueConverterTurbine.TYPE not in self.wrapped.HalfB.__class__.__mro__:
