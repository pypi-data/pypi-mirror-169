...
from mastapy.math_utility.stiffness_calculators import _1338
...
class SplineLeadRelief(_0.APIBase):
    ...
    @property
    def contact_position(self) -> '_1338.IndividualContactPosition':
        ...
        return constructor.new(_1338.IndividualContactPosition)(value) if value is not None else None
    ...
    @property
    def microgeometry_clearance_chart(self) -> '_1629.TwoDChartDefinition':
        ...
        if _1629.TwoDChartDefinition.TYPE not in self.wrapped.MicrogeometryClearanceChart.__class__.__mro__:
    ...
    @property
    def crowning(self) -> '_2328.CrowningSpecification':
        ...
        return constructor.new(_2328.CrowningSpecification)(self.wrapped.Crowning) if self.wrapped.Crowning is not None else None
