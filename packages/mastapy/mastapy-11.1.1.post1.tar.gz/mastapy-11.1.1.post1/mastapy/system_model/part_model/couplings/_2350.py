...
from mastapy.system_model.part_model.couplings import _2351, _2353, _2326
...
class TorqueConverter(_2326.Coupling):
    '''TorqueConverter
    ...
    @property
    def pump(self) -> '_2351.TorqueConverterPump':
        ...
        return constructor.new(_2351.TorqueConverterPump)(self.wrapped.Pump) if self.wrapped.Pump is not None else None

    @property
    def turbine(self) -> '_2353.TorqueConverterTurbine':
        ...
        return constructor.new(_2353.TorqueConverterTurbine)(self.wrapped.Turbine) if self.wrapped.Turbine is not None else None
