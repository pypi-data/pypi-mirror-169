...
from mastapy.system_model.part_model.gears import _2268, _2270, _2269
...
class PlanetaryGearSet(_2269.CylindricalGearSet):
    '''PlanetaryGearSet
    ...
    @property
    def suns(self) -> 'List[_2268.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Suns, constructor.new(_2268.CylindricalGear))
        return value

    @property
    def planets(self) -> 'List[_2270.CylindricalPlanetGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Planets, constructor.new(_2270.CylindricalPlanetGear))
        return value

    @property
    def annuluses(self) -> 'List[_2268.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Annuluses, constructor.new(_2268.CylindricalGear))
        return value

    def add_sun(self) -> '_2268.CylindricalGear':
    ...
    def add_planet(self) -> '_2268.CylindricalGear':
    ...
    def add_annulus(self) -> '_2268.CylindricalGear':
