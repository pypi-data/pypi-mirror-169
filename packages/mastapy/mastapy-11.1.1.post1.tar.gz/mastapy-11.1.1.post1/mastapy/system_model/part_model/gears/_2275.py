...
class GearSet(_2220.SpecialisedAssembly):
    '''GearSet
    ...
    @property
    def active_gear_set_design(self) -> '_908.GearSetDesign':
        ...
        if _908.GearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_worm_gear_set_design(self) -> '_917.WormGearSetDesign':
        ...
        if _917.WormGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_face_gear_set_design(self) -> '_953.FaceGearSetDesign':
        ...
        if _953.FaceGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_cylindrical_gear_set_design(self) -> '_985.CylindricalGearSetDesign':
        ...
        if _985.CylindricalGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_cylindrical_planetary_gear_set_design(self) -> '_996.CylindricalPlanetaryGearSetDesign':
        ...
        if _996.CylindricalPlanetaryGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_conical_gear_set_design(self) -> '_1105.ConicalGearSetDesign':
    ...
    @property
    def active_gear_set_design_of_type_concept_gear_set_design(self) -> '_1127.ConceptGearSetDesign':
        ...
        if _1127.ConceptGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def gear_set_designs(self) -> 'List[_908.GearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetDesigns, constructor.new(_908.GearSetDesign))
        return value

    def set_active_gear_set_design(self, gear_set_design: '_908.GearSetDesign'):
    ...
    def add_gear_set_design(self, design: '_908.GearSetDesign'):
