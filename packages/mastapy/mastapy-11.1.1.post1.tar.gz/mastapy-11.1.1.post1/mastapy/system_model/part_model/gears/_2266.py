...
from mastapy.system_model.part_model.gears import _2274, _2273
...
class ConicalGear(_2273.Gear):
    ...
    @property
    def orientation(self) -> '_2274.GearOrientations':
        ...
        return constructor.new(_2274.GearOrientations)(value) if value is not None else None

    @orientation.setter
    def orientation(self, value: '_2274.GearOrientations'):
    ...
    @property
    def active_gear_design(self) -> '_1103.ConicalGearDesign':
    ...
    @property
    def conical_gear_design(self) -> '_1103.ConicalGearDesign':
        ...
        if _1103.ConicalGearDesign.TYPE not in self.wrapped.ConicalGearDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_design_of_type_zerol_bevel_gear_design(self) -> '_910.ZerolBevelGearDesign':
        ...
        if _910.ZerolBevelGearDesign.TYPE not in self.wrapped.ConicalGearDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_design_of_type_straight_bevel_gear_design(self) -> '_919.StraightBevelGearDesign':
        ...
        if _919.StraightBevelGearDesign.TYPE not in self.wrapped.ConicalGearDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_design_of_type_spiral_bevel_gear_design(self) -> '_927.SpiralBevelGearDesign':
        ...
        if _927.SpiralBevelGearDesign.TYPE not in self.wrapped.ConicalGearDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_design_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_design(self) -> '_931.KlingelnbergCycloPalloidSpiralBevelGearDesign':
        ...
        if _931.KlingelnbergCycloPalloidSpiralBevelGearDesign.TYPE not in self.wrapped.ConicalGearDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_design_of_type_klingelnberg_cyclo_palloid_hypoid_gear_design(self) -> '_935.KlingelnbergCycloPalloidHypoidGearDesign':
        ...
        if _935.KlingelnbergCycloPalloidHypoidGearDesign.TYPE not in self.wrapped.ConicalGearDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_design_of_type_klingelnberg_conical_gear_design(self) -> '_939.KlingelnbergConicalGearDesign':
        ...
        if _939.KlingelnbergConicalGearDesign.TYPE not in self.wrapped.ConicalGearDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_design_of_type_hypoid_gear_design(self) -> '_943.HypoidGearDesign':
        ...
        if _943.HypoidGearDesign.TYPE not in self.wrapped.ConicalGearDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_design_of_type_bevel_gear_design(self) -> '_1129.BevelGearDesign':
        ...
        if _1129.BevelGearDesign.TYPE not in self.wrapped.ConicalGearDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_design_of_type_agma_gleason_conical_gear_design(self) -> '_1142.AGMAGleasonConicalGearDesign':
        ...
        if _1142.AGMAGleasonConicalGearDesign.TYPE not in self.wrapped.ConicalGearDesign.__class__.__mro__:
