...
class BevelGear(_2256.AGMAGleasonConicalGear):
    '''BevelGear
    ...
    @property
    def conical_gear_design(self) -> '_1129.BevelGearDesign':
    ...
    @property
    def bevel_gear_design(self) -> '_1129.BevelGearDesign':
        ...
        if _1129.BevelGearDesign.TYPE not in self.wrapped.BevelGearDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_design_of_type_zerol_bevel_gear_design(self) -> '_910.ZerolBevelGearDesign':
        ...
        if _910.ZerolBevelGearDesign.TYPE not in self.wrapped.BevelGearDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_design_of_type_straight_bevel_gear_design(self) -> '_919.StraightBevelGearDesign':
        ...
        if _919.StraightBevelGearDesign.TYPE not in self.wrapped.BevelGearDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_design_of_type_spiral_bevel_gear_design(self) -> '_927.SpiralBevelGearDesign':
        ...
        if _927.SpiralBevelGearDesign.TYPE not in self.wrapped.BevelGearDesign.__class__.__mro__:
