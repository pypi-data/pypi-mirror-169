...
from mastapy.system_model.part_model.part_groups import _2232, _2230
...
class ConcentricPartGroup(_2230.ConcentricOrParallelPartGroup):
    '''ConcentricPartGroup
    ...
    @property
    def parallel_groups(self) -> 'List[_2232.ConcentricPartGroupParallelToThis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelGroups, constructor.new(_2232.ConcentricPartGroupParallelToThis))
        return value
