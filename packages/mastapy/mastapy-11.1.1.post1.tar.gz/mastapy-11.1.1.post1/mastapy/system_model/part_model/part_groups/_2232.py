...
from mastapy.system_model.part_model.part_groups import _2230, _2231, _2234
...
class ConcentricPartGroupParallelToThis(_0.APIBase):
    ...
    @property
    def parallel_group(self) -> '_2230.ConcentricOrParallelPartGroup':
        ...
        if _2230.ConcentricOrParallelPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
    ...
    @property
    def parallel_group_of_type_concentric_part_group(self) -> '_2231.ConcentricPartGroup':
        ...
        if _2231.ConcentricPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
    ...
    @property
    def parallel_group_of_type_parallel_part_group(self) -> '_2234.ParallelPartGroup':
        ...
        if _2234.ParallelPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
