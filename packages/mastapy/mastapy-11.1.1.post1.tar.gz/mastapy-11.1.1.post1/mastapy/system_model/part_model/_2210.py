...
from mastapy.materials.efficiency import _270, _269
...
class OilSeal(_2192.Connector):
    ...
    @property
    def oil_seal_material(self) -> '_270.OilSealMaterialType':
        ...
        return constructor.new(_270.OilSealMaterialType)(value) if value is not None else None

    @oil_seal_material.setter
    def oil_seal_material(self, value: '_270.OilSealMaterialType'):
    ...
    @property
    def drag_torque_vs_rotational_speed(self) -> '_1336.Vector2DListAccessor':
        '''Vector2DListAccessor: 'DragTorqueVsRotationalSpeed' is the original name of this property.'''

        return constructor.new(_1336.Vector2DListAccessor)(self.wrapped.DragTorqueVsRotationalSpeed) if self.wrapped.DragTorqueVsRotationalSpeed is not None else None

    @drag_torque_vs_rotational_speed.setter
    def drag_torque_vs_rotational_speed(self, value: '_1336.Vector2DListAccessor'):
    ...
    @property
    def oil_seal_orientation(self) -> '_1717.Orientations':
    ...
    def oil_seal_orientation(self, value: '_1717.Orientations'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
