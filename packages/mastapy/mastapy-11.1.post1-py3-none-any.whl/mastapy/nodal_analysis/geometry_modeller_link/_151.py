...
class SpaceClaimDimension(_0.APIBase):
    ...
    @property
    def type_(self) -> '_148.GeometryModellerDimensionType':
        '''GeometryModellerDimensionType: 'Type' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Type)
        return constructor.new(_148.GeometryModellerDimensionType)(value) if value is not None else None

    @type_.setter
    def type_(self, value: '_148.GeometryModellerDimensionType'):
