...
from mastapy.fe_tools.enums import _1185
...
class ElementPropertiesBase(_0.APIBase):
    ...
    @property
    def class_(self) -> '_1185.ElementPropertyClass':
        ...
        return constructor.new(_1185.ElementPropertyClass)(value) if value is not None else None
