...
class BevelHypoidGearRatingSettings(_1387.PerMachineSettings):
    '''BevelHypoidGearRatingSettings
    ...
    @property
    def bevel_gear_rating_method(self) -> '_565.RatingMethods':
        ...
        return constructor.new(_565.RatingMethods)(value) if value is not None else None

    @bevel_gear_rating_method.setter
    def bevel_gear_rating_method(self, value: '_565.RatingMethods'):
