...
class ConicalSetFEModel(_1149.GearSetFEModel):
    '''ConicalSetFEModel
    ...
    @property
    def flank_data_source(self) -> '_1156.FlankDataSource':
        ...
        return constructor.new(_1156.FlankDataSource)(value) if value is not None else None

    @flank_data_source.setter
    def flank_data_source(self, value: '_1156.FlankDataSource'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
