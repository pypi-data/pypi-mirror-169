...
from mastapy.gears.fe_model import _1147, _1146
...
class GearSetFEModel(_1178.GearSetImplementationDetail):
    '''GearSetFEModel
    ...
    @property
    def mesh_fe_models(self) -> 'List[_1147.GearMeshFEModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshFEModels, constructor.new(_1147.GearMeshFEModel))
        return value

    @property
    def gear_fe_models(self) -> 'List[_1146.GearFEModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearFEModels, constructor.new(_1146.GearFEModel))
        return value
