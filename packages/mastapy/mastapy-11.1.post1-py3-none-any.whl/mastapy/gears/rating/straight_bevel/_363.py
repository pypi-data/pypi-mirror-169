...
class StraightBevelGearRating(_516.BevelGearRating):
    '''StraightBevelGearRating
    ...
    @property
    def straight_bevel_gear(self) -> '_919.StraightBevelGearDesign':
        ...
        return constructor.new(_919.StraightBevelGearDesign)(self.wrapped.StraightBevelGear) if self.wrapped.StraightBevelGear is not None else None
