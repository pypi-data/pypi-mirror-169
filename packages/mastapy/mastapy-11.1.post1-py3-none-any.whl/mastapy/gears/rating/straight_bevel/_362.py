...
class StraightBevelGearMeshRating(_515.BevelGearMeshRating):
    '''StraightBevelGearMeshRating
    ...
    @property
    def straight_bevel_gear_mesh(self) -> '_920.StraightBevelGearMeshDesign':
        ...
        return constructor.new(_920.StraightBevelGearMeshDesign)(self.wrapped.StraightBevelGearMesh) if self.wrapped.StraightBevelGearMesh is not None else None
