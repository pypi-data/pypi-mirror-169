...
from mastapy.gears.manufacturing.cylindrical import _592
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _686, _691, _689
...
class CylindricalGearHobDesign(_673.CylindricalGearRackDesign):
    '''CylindricalGearHobDesign
    ...
    @property
    def hob_edge_type(self) -> '_592.HobEdgeTypes':
        '''HobEdgeTypes: 'HobEdgeType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HobEdgeType)
        return constructor.new(_592.HobEdgeTypes)(value) if value is not None else None

    @hob_edge_type.setter
    def hob_edge_type(self, value: '_592.HobEdgeTypes'):
    ...
    @property
    def nominal_hob_shape(self) -> '_686.CylindricalGearHobShape':
        ...
        return constructor.new(_686.CylindricalGearHobShape)(self.wrapped.NominalHobShape) if self.wrapped.NominalHobShape is not None else None

    @property
    def nominal_rack_shape(self) -> '_691.RackShape':
        ...
        if _691.RackShape.TYPE not in self.wrapped.NominalRackShape.__class__.__mro__:
    ...
    @property
    def nominal_rack_shape_of_type_cylindrical_gear_hob_shape(self) -> '_686.CylindricalGearHobShape':
        ...
        if _686.CylindricalGearHobShape.TYPE not in self.wrapped.NominalRackShape.__class__.__mro__:
    ...
    @property
    def nominal_rack_shape_of_type_cylindrical_gear_worm_grinder_shape(self) -> '_689.CylindricalGearWormGrinderShape':
        ...
        if _689.CylindricalGearWormGrinderShape.TYPE not in self.wrapped.NominalRackShape.__class__.__mro__:
    ...
    @property
    def maximum_hob_material_shape(self) -> '_686.CylindricalGearHobShape':
        ...
        return constructor.new(_686.CylindricalGearHobShape)(self.wrapped.MaximumHobMaterialShape) if self.wrapped.MaximumHobMaterialShape is not None else None

    @property
    def minimum_hob_material_shape(self) -> '_686.CylindricalGearHobShape':
        ...
        return constructor.new(_686.CylindricalGearHobShape)(self.wrapped.MinimumHobMaterialShape) if self.wrapped.MinimumHobMaterialShape is not None else None
