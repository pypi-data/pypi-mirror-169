...
from mastapy.gears import _300, _318
from mastapy._internal.implicit import overridable
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _691, _686, _689
...
class CylindricalGearRackDesign(_674.CylindricalGearRealCutterDesign):
    '''CylindricalGearRackDesign
    ...
    @property
    def worm_type(self) -> '_318.WormType':
        '''WormType: 'WormType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.WormType)
        return constructor.new(_318.WormType)(value) if value is not None else None

    @worm_type.setter
    def worm_type(self, value: '_318.WormType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
