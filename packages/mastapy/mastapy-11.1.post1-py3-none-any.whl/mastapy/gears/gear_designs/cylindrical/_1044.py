...
class Usage(_1385.IndependentReportablePropertiesBase['Usage']):
    '''Usage
    ...
    @property
    def safety_requirement(self) -> '_312.SafetyRequirementsAGMA':
    ...
    def safety_requirement(self, value: '_312.SafetyRequirementsAGMA'):
    ...
    @property
    def spur_gear_load_sharing_code(self) -> '_1031.SpurGearLoadSharingCodes':
        ...
        return constructor.new(_1031.SpurGearLoadSharingCodes)(value) if value is not None else None

    @spur_gear_load_sharing_code.setter
    def spur_gear_load_sharing_code(self, value: '_1031.SpurGearLoadSharingCodes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
