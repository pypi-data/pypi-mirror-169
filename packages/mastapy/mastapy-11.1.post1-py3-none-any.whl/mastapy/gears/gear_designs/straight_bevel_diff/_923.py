...
from mastapy.gears.gear_designs.bevel import _1134, _1129
...
class StraightBevelDiffGearDesign(_1129.BevelGearDesign):
    '''StraightBevelDiffGearDesign
    ...
    @property
    def edge_radius_from(self) -> '_1134.EdgeRadiusType':
        ...
        return constructor.new(_1134.EdgeRadiusType)(value) if value is not None else None

    @edge_radius_from.setter
    def edge_radius_from(self, value: '_1134.EdgeRadiusType'):
