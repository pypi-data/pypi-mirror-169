...
from mastapy.bearings import _1659
...
class TiltingPadThrustBearing(_1937.PadFluidFilmBearing):
    '''TiltingPadThrustBearing
    ...
    @property
    def tilting_pad_type(self) -> '_1659.TiltingPadTypes':
        ...
        return constructor.new(_1659.TiltingPadTypes)(value) if value is not None else None

    @tilting_pad_type.setter
    def tilting_pad_type(self, value: '_1659.TiltingPadTypes'):
