...
from mastapy.cycloidal import _1263, _1264
...
class RingPins(_2208.MountableComponent):
    '''RingPins
    ...
    @property
    def ring_pins_design(self) -> '_1263.RingPinsDesign':
        ...
        return constructor.new(_1263.RingPinsDesign)(self.wrapped.RingPinsDesign) if self.wrapped.RingPinsDesign is not None else None

    @property
    def ring_pins_material(self) -> '_1264.RingPinsMaterial':
        ...
        return constructor.new(_1264.RingPinsMaterial)(self.wrapped.RingPinsMaterial) if self.wrapped.RingPinsMaterial is not None else None
