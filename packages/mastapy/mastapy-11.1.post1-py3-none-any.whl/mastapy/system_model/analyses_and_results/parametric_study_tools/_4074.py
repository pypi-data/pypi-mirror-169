...
class CylindricalGearMeshParametricStudyTool(_4092.GearMeshParametricStudyTool):
    '''CylindricalGearMeshParametricStudyTool
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2474.CylindricalGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2474.CylindricalGearMeshSystemDeflection))
        return value
