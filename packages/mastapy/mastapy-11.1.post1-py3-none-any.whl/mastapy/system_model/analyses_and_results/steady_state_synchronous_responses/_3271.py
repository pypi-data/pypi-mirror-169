...
class ConnectionSteadyStateSynchronousResponse(_7258.ConnectionStaticLoadAnalysisCase):
    '''ConnectionSteadyStateSynchronousResponse
    ...
    @property
    def steady_state_synchronous_response(self) -> '_3342.SteadyStateSynchronousResponse':
        ...
        return constructor.new(_3342.SteadyStateSynchronousResponse)(self.wrapped.SteadyStateSynchronousResponse) if self.wrapped.SteadyStateSynchronousResponse is not None else None
