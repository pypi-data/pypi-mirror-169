...
class HarmonicAnalysisFEExportOptions(_5488.HarmonicAnalysisExportOptions['_2397.IHaveFEPartHarmonicAnalysisResults', '_2197.FEPart']):
    '''HarmonicAnalysisFEExportOptions
    ...
    def element_face_group_to_export(self) -> 'list_with_selected_item.ListWithSelectedItem_CMSElementFaceGroup':
        ...
        return constructor.new(list_with_selected_item.ListWithSelectedItem_CMSElementFaceGroup)(self.wrapped.ElementFaceGroupToExport) if self.wrapped.ElementFaceGroupToExport is not None else None
    ...
    @property
    def analysis_options(self) -> '_5490.HarmonicAnalysisOptions':
        ...
        if _5490.HarmonicAnalysisOptions.TYPE not in self.wrapped.AnalysisOptions.__class__.__mro__:
