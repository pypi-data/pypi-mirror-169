...
class CouplingConnectionHarmonicAnalysis(_5752.InterMountableComponentConnectionHarmonicAnalysis):
    '''CouplingConnectionHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2464.CouplingConnectionSystemDeflection':
