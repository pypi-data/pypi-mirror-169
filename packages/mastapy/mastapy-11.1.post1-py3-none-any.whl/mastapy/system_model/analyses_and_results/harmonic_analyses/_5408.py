...
from mastapy.system_model.analyses_and_results.system_deflections import _2430, _2476, _2542
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5409
...
class AbstractShaftHarmonicAnalysis(_5409.AbstractShaftOrHousingHarmonicAnalysis):
    '''AbstractShaftHarmonicAnalysis
    ...
    @property
    def component_design(self) -> '_2181.AbstractShaft':
    ...
    @property
    def system_deflection_results(self) -> '_2430.AbstractShaftSystemDeflection':
