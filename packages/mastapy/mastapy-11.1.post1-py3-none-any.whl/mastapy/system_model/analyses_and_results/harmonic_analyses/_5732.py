...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5745, _5665
...
class FEPartHarmonicAnalysis(_5665.AbstractShaftOrHousingHarmonicAnalysis):
    '''FEPartHarmonicAnalysis
    ...
    @property
    def coupled_modal_analysis(self) -> '_4877.FEPartModalAnalysis':
        ...
        return constructor.new(_4877.FEPartModalAnalysis)(self.wrapped.CoupledModalAnalysis) if self.wrapped.CoupledModalAnalysis is not None else None
