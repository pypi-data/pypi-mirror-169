...
from mastapy.system_model.analyses_and_results.static_loads import (
    _6613, _6561, _6578, _6587,
    _6588, _6589, _6590, _6591,
    _6609, _6655, _6671, _6698
)
...
class AbstractPeriodicExcitationDetail(_0.APIBase):
    ...
    @property
    def harmonic_load_data(self) -> '_6613.HarmonicLoadDataBase':
        ...
        if _6613.HarmonicLoadDataBase.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_conical_gear_set_harmonic_load_data(self) -> '_6561.ConicalGearSetHarmonicLoadData':
        ...
        if _6561.ConicalGearSetHarmonicLoadData.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_cylindrical_gear_set_harmonic_load_data(self) -> '_6578.CylindricalGearSetHarmonicLoadData':
        ...
        if _6578.CylindricalGearSetHarmonicLoadData.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_electric_machine_harmonic_load_data(self) -> '_6587.ElectricMachineHarmonicLoadData':
        ...
        if _6587.ElectricMachineHarmonicLoadData.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_electric_machine_harmonic_load_data_from_excel(self) -> '_6588.ElectricMachineHarmonicLoadDataFromExcel':
        ...
        if _6588.ElectricMachineHarmonicLoadDataFromExcel.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_electric_machine_harmonic_load_data_from_flux(self) -> '_6589.ElectricMachineHarmonicLoadDataFromFlux':
        ...
        if _6589.ElectricMachineHarmonicLoadDataFromFlux.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_electric_machine_harmonic_load_data_from_jmag(self) -> '_6590.ElectricMachineHarmonicLoadDataFromJMAG':
        ...
        if _6590.ElectricMachineHarmonicLoadDataFromJMAG.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_electric_machine_harmonic_load_data_from_motor_cad(self) -> '_6591.ElectricMachineHarmonicLoadDataFromMotorCAD':
        ...
        if _6591.ElectricMachineHarmonicLoadDataFromMotorCAD.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_gear_set_harmonic_load_data(self) -> '_6609.GearSetHarmonicLoadData':
        ...
        if _6609.GearSetHarmonicLoadData.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_point_load_harmonic_load_data(self) -> '_6655.PointLoadHarmonicLoadData':
        ...
        if _6655.PointLoadHarmonicLoadData.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_speed_dependent_harmonic_load_data(self) -> '_6671.SpeedDependentHarmonicLoadData':
        ...
        if _6671.SpeedDependentHarmonicLoadData.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_unbalanced_mass_harmonic_load_data(self) -> '_6698.UnbalancedMassHarmonicLoadData':
        ...
        if _6698.UnbalancedMassHarmonicLoadData.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
