...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _2376
...
class ConnectionModalAnalysisAtASpeed(_7258.ConnectionStaticLoadAnalysisCase):
    '''ConnectionModalAnalysisAtASpeed
    ...
    @property
    def modal_analysis_at_a_speed(self) -> '_2376.ModalAnalysisAtASpeed':
        ...
        return constructor.new(_2376.ModalAnalysisAtASpeed)(self.wrapped.ModalAnalysisAtASpeed) if self.wrapped.ModalAnalysisAtASpeed is not None else None
