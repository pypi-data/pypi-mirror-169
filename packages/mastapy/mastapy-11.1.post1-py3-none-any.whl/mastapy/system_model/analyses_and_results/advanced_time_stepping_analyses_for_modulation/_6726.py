...
class AbstractShaftOrHousingAdvancedTimeSteppingAnalysisForModulation(_6753.ComponentAdvancedTimeSteppingAnalysisForModulation):
    '''AbstractShaftOrHousingAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2426.AbstractShaftOrHousingSystemDeflection':
