...
class CylindricalGearAdvancedTimeSteppingAnalysisForModulation(_6786.GearAdvancedTimeSteppingAnalysisForModulation):
    '''CylindricalGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2480.CylindricalGearSystemDeflection':
