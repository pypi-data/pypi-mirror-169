...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5165, _5163, _5214
...
class GearSetMultibodyDynamicsAnalysis(_5214.SpecialisedAssemblyMultibodyDynamicsAnalysis):
    '''GearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5165.GearMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_5165.GearMultibodyDynamicsAnalysis))
        return value

    @property
    def meshes(self) -> 'List[_5163.GearMeshMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_5163.GearMeshMultibodyDynamicsAnalysis))
        return value
