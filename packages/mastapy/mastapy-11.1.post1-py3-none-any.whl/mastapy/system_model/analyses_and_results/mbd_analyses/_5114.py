...
from mastapy.system_model.analyses_and_results.static_loads import _6536, _6569
from mastapy.system_model.analyses_and_results.mbd_analyses import _5201, _5214
...
class BeltDriveMultibodyDynamicsAnalysis(_5214.SpecialisedAssemblyMultibodyDynamicsAnalysis):
    '''BeltDriveMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_load_case(self) -> '_6536.BeltDriveLoadCase':
        ...
        if _6536.BeltDriveLoadCase.TYPE not in self.wrapped.AssemblyLoadCase.__class__.__mro__:
    ...
    @property
    def pulleys(self) -> 'List[_5201.PulleyMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_5201.PulleyMultibodyDynamicsAnalysis))
        return value
