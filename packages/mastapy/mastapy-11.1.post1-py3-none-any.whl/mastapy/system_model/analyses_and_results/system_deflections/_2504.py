...
from mastapy.system_model.analyses_and_results.power_flows import _3834, _3837, _3840
...
class KlingelnbergCycloPalloidConicalGearSetSystemDeflection(_2460.ConicalGearSetSystemDeflection):
    '''KlingelnbergCycloPalloidConicalGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3834.KlingelnbergCycloPalloidConicalGearSetPowerFlow':
