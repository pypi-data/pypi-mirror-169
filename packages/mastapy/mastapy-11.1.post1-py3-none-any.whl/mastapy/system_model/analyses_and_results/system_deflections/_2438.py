...
from mastapy.system_model.analyses_and_results.power_flows import _3777, _3779, _3780
...
class BevelDifferentialGearSystemDeflection(_2443.BevelGearSystemDeflection):
    '''BevelDifferentialGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3777.BevelDifferentialGearPowerFlow':
