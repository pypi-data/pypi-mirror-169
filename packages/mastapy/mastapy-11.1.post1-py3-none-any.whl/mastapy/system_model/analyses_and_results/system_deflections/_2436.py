...
class BevelDifferentialGearMeshSystemDeflection(_2441.BevelGearMeshSystemDeflection):
    '''BevelDifferentialGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3776.BevelDifferentialGearMeshPowerFlow':
        ...
        return constructor.new(_3776.BevelDifferentialGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None

    @property
    def rating(self) -> '_514.BevelGearMeshRating':
