...
from mastapy.system_model.analyses_and_results.power_flows import _3815, _3850
from mastapy.gears.rating.cylindrical import _428
from mastapy.gears.manufacturing.cylindrical import _581
from mastapy.system_model.analyses_and_results.system_deflections import _2480, _2474, _2495
...
class CylindricalGearSetSystemDeflection(_2495.GearSetSystemDeflection):
    '''CylindricalGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3815.CylindricalGearSetPowerFlow':
        ...
        if _3815.CylindricalGearSetPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def manufacturing_analysis(self) -> '_581.CylindricalManufacturedGearSetLoadCase':
        ...
        return constructor.new(_581.CylindricalManufacturedGearSetLoadCase)(self.wrapped.ManufacturingAnalysis) if self.wrapped.ManufacturingAnalysis is not None else None

    @property
    def cylindrical_gears_system_deflection(self) -> 'List[_2480.CylindricalGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsSystemDeflection, constructor.new(_2480.CylindricalGearSystemDeflection))
        return value

    @property
    def cylindrical_meshes_system_deflection(self) -> 'List[_2474.CylindricalGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesSystemDeflection, constructor.new(_2474.CylindricalGearMeshSystemDeflection))
        return value
