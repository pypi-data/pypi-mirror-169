...
from mastapy.system_model.analyses_and_results.power_flows import _3874, _3879, _3880
...
class StraightBevelDiffGearSystemDeflection(_2443.BevelGearSystemDeflection):
    '''StraightBevelDiffGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3874.StraightBevelDiffGearPowerFlow':
