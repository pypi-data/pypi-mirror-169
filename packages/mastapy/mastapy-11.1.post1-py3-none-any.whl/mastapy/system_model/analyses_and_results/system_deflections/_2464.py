...
class CouplingConnectionSystemDeflection(_2502.InterMountableComponentConnectionSystemDeflection):
    '''CouplingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3802.CouplingConnectionPowerFlow':
