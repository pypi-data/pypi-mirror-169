...
class AbstractShaftToMountableComponentConnectionSystemDeflection(_2462.ConnectionSystemDeflection):
    '''AbstractShaftToMountableComponentConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3768.AbstractShaftToMountableComponentConnectionPowerFlow':
