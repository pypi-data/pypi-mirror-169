...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4460
...
class CycloidalDiscCompoundModalAnalysis(_4460.AbstractShaftCompoundModalAnalysis):
    '''CycloidalDiscCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4352.CycloidalDiscModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4352.CycloidalDiscModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4352.CycloidalDiscModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4352.CycloidalDiscModalAnalysis))
        return value
