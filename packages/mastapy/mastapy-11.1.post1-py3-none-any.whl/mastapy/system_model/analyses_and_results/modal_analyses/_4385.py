...
class ModalAnalysisBarModelFEExportOptions(_0.APIBase):
    ...
    @property
    def mode_options(self) -> '_155.EigenvalueOptions':
        ...
        return constructor.new(_155.EigenvalueOptions)(self.wrapped.ModeOptions) if self.wrapped.ModeOptions is not None else None
    ...
    def set_fe_file_to_include(self, file_path: 'str', format_: '_153.FEExportFormat', length_scale: Optional['float'] = 1.0, force_scale: Optional['float'] = 1.0):
