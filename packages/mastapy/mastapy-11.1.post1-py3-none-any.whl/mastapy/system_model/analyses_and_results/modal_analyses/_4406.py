...
from mastapy.system_model.analyses_and_results.modal_analyses import _2378, _4313
...
class RootAssemblyModalAnalysis(_4313.AssemblyModalAnalysis):
    '''RootAssemblyModalAnalysis
    ...
    @property
    def modal_analysis_inputs(self) -> '_2378.ModalAnalysis':
        ...
        if _2378.ModalAnalysis.TYPE not in self.wrapped.ModalAnalysisInputs.__class__.__mro__:
