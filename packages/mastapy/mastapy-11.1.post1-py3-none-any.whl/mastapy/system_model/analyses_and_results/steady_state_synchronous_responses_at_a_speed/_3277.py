...
class ConnectionSteadyStateSynchronousResponseAtASpeed(_7261.ConnectionStaticLoadAnalysisCase):
    '''ConnectionSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def steady_state_synchronous_response_at_a_speed(self) -> '_3347.SteadyStateSynchronousResponseAtASpeed':
        ...
        return constructor.new(_3347.SteadyStateSynchronousResponseAtASpeed)(self.wrapped.SteadyStateSynchronousResponseAtASpeed) if self.wrapped.SteadyStateSynchronousResponseAtASpeed is not None else None
