...
from mastapy.system_model.optimization import _1980, _1972
...
class ConicalGearOptimisationStrategy(_1980.OptimizationStrategy['_1972.ConicalGearOptimizationStep']):
    '''ConicalGearOptimisationStrategy
