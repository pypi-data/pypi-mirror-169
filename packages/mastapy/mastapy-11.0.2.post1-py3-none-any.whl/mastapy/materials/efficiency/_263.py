...
class OilPumpDetail(_1346.IndependentReportablePropertiesBase['OilPumpDetail']):
    '''OilPumpDetail
    ...
    @property
    def oil_pump_drive_type(self) -> '_264.OilPumpDriveType':
        ...
        return constructor.new(_264.OilPumpDriveType)(value) if value else None

    @oil_pump_drive_type.setter
    def oil_pump_drive_type(self, value: '_264.OilPumpDriveType'):
