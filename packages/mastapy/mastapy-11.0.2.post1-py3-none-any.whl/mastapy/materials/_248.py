...
class SoundPressureEnclosure(_0.APIBase):
    ...
    @property
    def enclosure_type(self) -> '_249.SoundPressureEnclosureType':
        ...
        return constructor.new(_249.SoundPressureEnclosureType)(value) if value else None

    @enclosure_type.setter
    def enclosure_type(self, value: '_249.SoundPressureEnclosureType'):
