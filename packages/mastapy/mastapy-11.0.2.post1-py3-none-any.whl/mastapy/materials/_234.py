...
class LubricationDetail(_1558.NamedDatabaseItem):
    '''LubricationDetail
    ...
    @property
    def density_specification_method(self) -> '_219.DensitySpecificationMethod':
        ...
        return constructor.new(_219.DensitySpecificationMethod)(value) if value else None

    @density_specification_method.setter
    def density_specification_method(self, value: '_219.DensitySpecificationMethod'):
    ...
    @property
    def pressure_viscosity_coefficient_method(self) -> '_242.PressureViscosityCoefficientMethod':
        ...
        return constructor.new(_242.PressureViscosityCoefficientMethod)(value) if value else None

    @pressure_viscosity_coefficient_method.setter
    def pressure_viscosity_coefficient_method(self, value: '_242.PressureViscosityCoefficientMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def oil_filtration_and_contamination(self) -> '_241.OilFiltrationOptions':
        ...
        return constructor.new(_241.OilFiltrationOptions)(value) if value else None

    @oil_filtration_and_contamination.setter
    def oil_filtration_and_contamination(self, value: '_241.OilFiltrationOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.OilFiltrationAndContamination = value

    @property
    def grease_contamination_level(self) -> '_224.GreaseContaminationOptions':
        ...
        return constructor.new(_224.GreaseContaminationOptions)(value) if value else None

    @grease_contamination_level.setter
    def grease_contamination_level(self, value: '_224.GreaseContaminationOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def lubricant_type_supply(self) -> '_213.BearingLubricationCondition':
        ...
        return constructor.new(_213.BearingLubricationCondition)(value) if value else None

    @lubricant_type_supply.setter
    def lubricant_type_supply(self, value: '_213.BearingLubricationCondition'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def lubricant_viscosity_classification(self) -> '_231.LubricantViscosityClassification':
        ...
        return constructor.new(_231.LubricantViscosityClassification)(value) if value else None

    @lubricant_viscosity_classification.setter
    def lubricant_viscosity_classification(self, value: '_231.LubricantViscosityClassification'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def lubricant_grade_agma(self) -> '_230.LubricantViscosityClassAGMA':
        ...
        return constructor.new(_230.LubricantViscosityClassAGMA)(value) if value else None

    @lubricant_grade_agma.setter
    def lubricant_grade_agma(self, value: '_230.LubricantViscosityClassAGMA'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.LubricantGradeAGMA = value

    @property
    def lubricant_grade_sae(self) -> '_233.LubricantViscosityClassSAE':
        ...
        return constructor.new(_233.LubricantViscosityClassSAE)(value) if value else None

    @lubricant_grade_sae.setter
    def lubricant_grade_sae(self, value: '_233.LubricantViscosityClassSAE'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def delivery(self) -> '_229.LubricantDelivery':
        ...
        return constructor.new(_229.LubricantDelivery)(value) if value else None

    @property
    def agma925a03_lubricant_type(self) -> '_208.AGMALubricantType':
        ...
        return constructor.new(_208.AGMALubricantType)(value) if value else None

    @agma925a03_lubricant_type.setter
    def agma925a03_lubricant_type(self, value: '_208.AGMALubricantType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.AGMA925A03LubricantType = value

    @property
    def iso_lubricant_type(self) -> '_227.ISOLubricantType':
        ...
        return constructor.new(_227.ISOLubricantType)(value) if value else None

    @iso_lubricant_type.setter
    def iso_lubricant_type(self, value: '_227.ISOLubricantType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
