...
from mastapy.materials import _239, _225
...
class Material(_1558.NamedDatabaseItem):
    '''Material
    ...
    @property
    def standard(self) -> '_239.MaterialStandards':
        '''MaterialStandards: 'Standard' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Standard)
        return constructor.new(_239.MaterialStandards)(value) if value else None

    @standard.setter
    def standard(self, value: '_239.MaterialStandards'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.Standard = value

    @property
    def hardness_type(self) -> '_225.HardnessType':
        '''HardnessType: 'HardnessType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HardnessType)
        return constructor.new(_225.HardnessType)(value) if value else None

    @hardness_type.setter
    def hardness_type(self, value: '_225.HardnessType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
