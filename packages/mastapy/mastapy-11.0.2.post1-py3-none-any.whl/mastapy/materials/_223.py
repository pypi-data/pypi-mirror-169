...
class GeneralTransmissionProperties(_0.APIBase):
    ...
    @property
    def transmission_application(self) -> '_252.TransmissionApplications':
        ...
        return constructor.new(_252.TransmissionApplications)(value) if value else None

    @transmission_application.setter
    def transmission_application(self, value: '_252.TransmissionApplications'):
    ...
    @property
    def bearing_iso762006_static_safety_factor_limit(self) -> '_226.ISO76StaticSafetyFactorLimits':
        ...
        return constructor.new(_226.ISO76StaticSafetyFactorLimits)(value) if value else None

    @bearing_iso762006_static_safety_factor_limit.setter
    def bearing_iso762006_static_safety_factor_limit(self, value: '_226.ISO76StaticSafetyFactorLimits'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def wind_turbine_standard(self) -> '_255.WindTurbineStandards':
        ...
        return constructor.new(_255.WindTurbineStandards)(value) if value else None

    @wind_turbine_standard.setter
    def wind_turbine_standard(self, value: '_255.WindTurbineStandards'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def driving_machine_characteristics(self) -> '_256.WorkingCharacteristics':
        ...
        return constructor.new(_256.WorkingCharacteristics)(value) if value else None

    @driving_machine_characteristics.setter
    def driving_machine_characteristics(self, value: '_256.WorkingCharacteristics'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.DrivingMachineCharacteristics = value

    @property
    def driven_machine_characteristics(self) -> '_256.WorkingCharacteristics':
    ...
    def driven_machine_characteristics(self, value: '_256.WorkingCharacteristics'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @gearing_type.setter
    def gearing_type(self, value: '_222.GearingTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def vehicle_dynamics(self) -> '_254.VehicleDynamicsProperties':
        ...
        return constructor.new(_254.VehicleDynamicsProperties)(self.wrapped.VehicleDynamics) if self.wrapped.VehicleDynamics else None

    @property
    def air_properties(self) -> '_212.AirProperties':
        ...
        return constructor.new(_212.AirProperties)(self.wrapped.AirProperties) if self.wrapped.AirProperties else None
