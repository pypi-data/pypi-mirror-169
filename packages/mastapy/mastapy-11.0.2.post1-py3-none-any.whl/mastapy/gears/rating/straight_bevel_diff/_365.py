...
from mastapy.gears.rating.straight_bevel_diff import _368, _366
...
class StraightBevelDiffGearMeshRating(_500.ConicalGearMeshRating):
    '''StraightBevelDiffGearMeshRating
    ...
    @property
    def meshed_gears(self) -> 'List[_368.StraightBevelDiffMeshedGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_368.StraightBevelDiffMeshedGearRating))
        return value

    @property
    def gears_in_mesh(self) -> 'List[_368.StraightBevelDiffMeshedGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsInMesh, constructor.new(_368.StraightBevelDiffMeshedGearRating))
        return value

    @property
    def straight_bevel_diff_gear_ratings(self) -> 'List[_366.StraightBevelDiffGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearRatings, constructor.new(_366.StraightBevelDiffGearRating))
        return value
