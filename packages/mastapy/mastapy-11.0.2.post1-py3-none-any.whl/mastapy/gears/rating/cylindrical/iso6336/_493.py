...
class ToothFlankFractureStressStepAtAnalysisPointN1457(_0.APIBase):
    ...
    @property
    def stress(self) -> '_1366.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1366.VectorWithLinearAndAngularComponents)(self.wrapped.Stress) if self.wrapped.Stress is not None else None

    @property
    def contact_position_on_profile(self) -> '_982.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_982.CylindricalGearProfileMeasurement)(self.wrapped.ContactPositionOnProfile) if self.wrapped.ContactPositionOnProfile is not None else None
