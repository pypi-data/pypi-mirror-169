...
from mastapy.gears.gear_designs.cylindrical import _998, _997
from mastapy.materials import _234
from mastapy.gears.rating.cylindrical import _422, _421, _425
...
class CylindricalMeshSingleFlankRating(_328.MeshSingleFlankRating):
    '''CylindricalMeshSingleFlankRating
    ...
    @property
    def contact_ratio_source(self) -> '_283.ContactRatioDataSource':
        ...
        return constructor.new(_283.ContactRatioDataSource)(value) if value else None
    ...
    @property
    def coefficient_of_friction_method_flash_temperature_method(self) -> '_998.ScuffingCoefficientOfFrictionMethods':
        ...
        return constructor.new(_998.ScuffingCoefficientOfFrictionMethods)(value) if value else None
    ...
    @property
    def lubrication_detail(self) -> '_234.LubricationDetail':
        ...
        return constructor.new(_234.LubricationDetail)(self.wrapped.LubricationDetail) if self.wrapped.LubricationDetail else None

    @property
    def sorted_scuffing_results(self) -> '_422.CylindricalGearScuffingResults':
        ...
        return constructor.new(_422.CylindricalGearScuffingResults)(self.wrapped.SortedScuffingResults) if self.wrapped.SortedScuffingResults else None

    @property
    def sorted_scuffing_results_without_special_values(self) -> '_422.CylindricalGearScuffingResults':
        ...
        return constructor.new(_422.CylindricalGearScuffingResults)(self.wrapped.SortedScuffingResultsWithoutSpecialValues) if self.wrapped.SortedScuffingResultsWithoutSpecialValues else None

    @property
    def rating_settings(self) -> '_421.CylindricalGearRatingSettings':
        ...
        return constructor.new(_421.CylindricalGearRatingSettings)(self.wrapped.RatingSettings) if self.wrapped.RatingSettings else None
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_425.CylindricalGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_425.CylindricalGearSingleFlankRating))
        return value
