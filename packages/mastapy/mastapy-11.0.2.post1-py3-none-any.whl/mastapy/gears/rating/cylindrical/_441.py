...
from mastapy.gears.rating.cylindrical import _442
...
class ScuffingResultsRow(_0.APIBase):
    ...
    @property
    def pinion(self) -> '_442.ScuffingResultsRowGear':
        ...
        return constructor.new(_442.ScuffingResultsRowGear)(self.wrapped.Pinion) if self.wrapped.Pinion else None
