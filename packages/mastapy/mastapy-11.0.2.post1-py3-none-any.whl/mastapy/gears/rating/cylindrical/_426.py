...
class CylindricalMeshDutyCycleRating(_327.MeshDutyCycleRating):
    '''CylindricalMeshDutyCycleRating
    ...
    @property
    def highest_torque_load_case(self) -> '_417.CylindricalGearMeshRating':
        ...
        return constructor.new(_417.CylindricalGearMeshRating)(self.wrapped.HighestTorqueLoadCase) if self.wrapped.HighestTorqueLoadCase else None
