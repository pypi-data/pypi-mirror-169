...
from mastapy.gears.rating.zerol_bevel import _336, _337
...
class ZerolBevelGearSetRating(_517.BevelGearSetRating):
    '''ZerolBevelGearSetRating
    ...
    @property
    def zerol_bevel_mesh_ratings(self) -> 'List[_336.ZerolBevelGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshRatings, constructor.new(_336.ZerolBevelGearMeshRating))
        return value

    @property
    def zerol_bevel_gear_ratings(self) -> 'List[_337.ZerolBevelGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearRatings, constructor.new(_337.ZerolBevelGearRating))
        return value
