...
class FaceGearSetRating(_330.GearSetRating):
    '''FaceGearSetRating
    ...
    @property
    def face_gear_set(self) -> '_953.FaceGearSetDesign':
        ...
        return constructor.new(_953.FaceGearSetDesign)(self.wrapped.FaceGearSet) if self.wrapped.FaceGearSet is not None else None

    @property
    def face_mesh_ratings(self) -> 'List[_414.FaceGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshRatings, constructor.new(_414.FaceGearMeshRating))
        return value

    @property
    def gear_ratings(self) -> 'List[_415.FaceGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_415.FaceGearRating))
        return value
