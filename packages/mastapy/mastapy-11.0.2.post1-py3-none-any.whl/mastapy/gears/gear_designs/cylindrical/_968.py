...
class CylindricalPlanetaryGearSetDesign(_957.CylindricalGearSetDesign):
    '''CylindricalPlanetaryGearSetDesign
    ...
    @property
    def planetary_sideband_fourier_series_for_rotating_planet_carrier(self) -> '_1278.FourierSeries':
        ...
        return constructor.new(_1278.FourierSeries)(self.wrapped.PlanetarySidebandFourierSeriesForRotatingPlanetCarrier) if self.wrapped.PlanetarySidebandFourierSeriesForRotatingPlanetCarrier else None
