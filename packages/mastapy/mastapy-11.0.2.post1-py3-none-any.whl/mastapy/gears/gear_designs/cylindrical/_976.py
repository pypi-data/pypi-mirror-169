...
class GearSetFCAImportSetup(_0.APIBase):
    ...
    @property
    def meshes(self) -> 'List[_950.CylindricalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_950.CylindricalGearMeshDesign))
        return value
