...
class TiffAnalysisSettings(_1346.IndependentReportablePropertiesBase['TiffAnalysisSettings']):
    '''TiffAnalysisSettings
    ...
    @property
    def surface_material_properties(self) -> '_979.HardenedMaterialProperties':
        ...
        return constructor.new(_979.HardenedMaterialProperties)(self.wrapped.SurfaceMaterialProperties) if self.wrapped.SurfaceMaterialProperties else None

    @property
    def core_material_properties(self) -> '_979.HardenedMaterialProperties':
        ...
        return constructor.new(_979.HardenedMaterialProperties)(self.wrapped.CoreMaterialProperties) if self.wrapped.CoreMaterialProperties else None
