...
from mastapy.utility.units_and_measurements.measurements import _1416, _1432
...
class ToothThicknessSpecificationBase(_0.APIBase):
    ...
    @property
    def normal_thickness(self) -> '_963.CylindricalGearToothThicknessSpecification[_1416.LengthShort]':
        ...
        return constructor.new(_963.CylindricalGearToothThicknessSpecification)[_1416.LengthShort](self.wrapped.NormalThickness) if self.wrapped.NormalThickness else None

    @property
    def normal_thickness_at_specified_diameter(self) -> '_963.CylindricalGearToothThicknessSpecification[_1416.LengthShort]':
        ...
        return constructor.new(_963.CylindricalGearToothThicknessSpecification)[_1416.LengthShort](self.wrapped.NormalThicknessAtSpecifiedDiameter) if self.wrapped.NormalThicknessAtSpecifiedDiameter else None

    @property
    def chordal_span(self) -> '_963.CylindricalGearToothThicknessSpecification[_1416.LengthShort]':
        ...
        return constructor.new(_963.CylindricalGearToothThicknessSpecification)[_1416.LengthShort](self.wrapped.ChordalSpan) if self.wrapped.ChordalSpan else None

    @property
    def over_balls(self) -> '_963.CylindricalGearToothThicknessSpecification[_1416.LengthShort]':
        ...
        return constructor.new(_963.CylindricalGearToothThicknessSpecification)[_1416.LengthShort](self.wrapped.OverBalls) if self.wrapped.OverBalls else None

    @property
    def transverse_thickness(self) -> '_963.CylindricalGearToothThicknessSpecification[_1416.LengthShort]':
        ...
        return constructor.new(_963.CylindricalGearToothThicknessSpecification)[_1416.LengthShort](self.wrapped.TransverseThickness) if self.wrapped.TransverseThickness else None

    @property
    def transverse_thickness_at_specified_diameter(self) -> '_963.CylindricalGearToothThicknessSpecification[_1416.LengthShort]':
        ...
        return constructor.new(_963.CylindricalGearToothThicknessSpecification)[_1416.LengthShort](self.wrapped.TransverseThicknessAtSpecifiedDiameter) if self.wrapped.TransverseThicknessAtSpecifiedDiameter else None

    @property
    def profile_shift_coefficient(self) -> '_963.CylindricalGearToothThicknessSpecification[_1432.Number]':
        ...
        return constructor.new(_963.CylindricalGearToothThicknessSpecification)[_1432.Number](self.wrapped.ProfileShiftCoefficient) if self.wrapped.ProfileShiftCoefficient else None

    @property
    def profile_shift(self) -> '_963.CylindricalGearToothThicknessSpecification[_1416.LengthShort]':
        ...
        return constructor.new(_963.CylindricalGearToothThicknessSpecification)[_1416.LengthShort](self.wrapped.ProfileShift) if self.wrapped.ProfileShift else None

    @property
    def tooth_thickness(self) -> 'List[_963.CylindricalGearToothThicknessSpecification[_1416.LengthShort]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ToothThickness, constructor.new(_963.CylindricalGearToothThicknessSpecification)[_1416.LengthShort])
        return value
