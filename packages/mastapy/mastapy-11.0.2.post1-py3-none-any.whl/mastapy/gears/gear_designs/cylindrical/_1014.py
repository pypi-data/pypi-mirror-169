...
class Usage(_1346.IndependentReportablePropertiesBase['Usage']):
    '''Usage
    ...
    @property
    def safety_requirement(self) -> '_307.SafetyRequirementsAGMA':
    ...
    def safety_requirement(self, value: '_307.SafetyRequirementsAGMA'):
    ...
    @property
    def spur_gear_load_sharing_code(self) -> '_1002.SpurGearLoadSharingCodes':
        ...
        return constructor.new(_1002.SpurGearLoadSharingCodes)(value) if value else None

    @spur_gear_load_sharing_code.setter
    def spur_gear_load_sharing_code(self, value: '_1002.SpurGearLoadSharingCodes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
