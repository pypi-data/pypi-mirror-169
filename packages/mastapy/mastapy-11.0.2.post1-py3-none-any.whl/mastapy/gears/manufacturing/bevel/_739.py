...
from mastapy.gears.gear_designs.conical import _1071, _1070
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy._internal import enum_with_selected_value_runtime, conversion, constructor
from mastapy.gears.manufacturing.bevel import _724, _733, _741
...
class ConicalSetManufacturingConfig(_741.ConicalSetMicroGeometryConfigBase):
    '''ConicalSetManufacturingConfig
    ...
    @property
    def gear_manufacturing_configurations(self) -> 'List[_724.ConicalGearManufacturingConfig]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearManufacturingConfigurations, constructor.new(_724.ConicalGearManufacturingConfig))
        return value

    @property
    def meshes(self) -> 'List[_733.ConicalMeshManufacturingConfig]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_733.ConicalMeshManufacturingConfig))
        return value
