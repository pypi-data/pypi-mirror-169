...
class ConicalSetMicroGeometryConfigBase(_1141.GearSetImplementationDetail):
    '''ConicalSetMicroGeometryConfigBase
    ...
    @property
    def deflection_from_bending_option(self) -> '_287.DeflectionFromBendingOption':
        ...
        return constructor.new(_287.DeflectionFromBendingOption)(value) if value else None

    @deflection_from_bending_option.setter
    def deflection_from_bending_option(self, value: '_287.DeflectionFromBendingOption'):
