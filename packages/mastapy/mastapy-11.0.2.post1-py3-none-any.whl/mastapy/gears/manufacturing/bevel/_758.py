...
class PinionRoughMachineSetting(_0.APIBase):
    ...
    @property
    def pinion_config(self) -> '_736.ConicalPinionManufacturingConfig':
        ...
        return constructor.new(_736.ConicalPinionManufacturingConfig)(self.wrapped.PinionConfig) if self.wrapped.PinionConfig else None

    @property
    def gear_set(self) -> '_1069.ConicalGearSetDesign':
