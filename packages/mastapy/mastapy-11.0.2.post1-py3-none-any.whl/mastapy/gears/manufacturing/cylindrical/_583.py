...
from mastapy.gears.manufacturing.cylindrical import _581, _585
...
class MicroGeometryInputsProfile(_581.MicroGeometryInputs['_585.ProfileModificationSegment']):
    '''MicroGeometryInputsProfile
    ...
    @property
    def profile_micro_geometry_range(self) -> '_1253.Range':
        ...
        if _1253.Range.TYPE not in self.wrapped.ProfileMicroGeometryRange.__class__.__mro__:
