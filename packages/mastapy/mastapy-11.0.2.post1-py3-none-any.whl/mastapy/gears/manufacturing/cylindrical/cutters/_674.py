...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _694, _696, _691
...
class CylindricalGearGrindingWorm(_678.CylindricalGearRackDesign):
    ...
    def nominal_worm_grinder_shape(self) -> '_694.CylindricalGearWormGrinderShape':
        ...
        return constructor.new(_694.CylindricalGearWormGrinderShape)(self.wrapped.NominalWormGrinderShape) if self.wrapped.NominalWormGrinderShape else None
