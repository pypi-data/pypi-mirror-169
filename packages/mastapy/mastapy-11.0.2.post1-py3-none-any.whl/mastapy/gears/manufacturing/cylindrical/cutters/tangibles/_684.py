...
class CutterShapeDefinition(_0.APIBase):
    ...
    @property
    def design(self) -> '_674.CylindricalGearRealCutterDesign':
        ...
        if _674.CylindricalGearRealCutterDesign.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_cylindrical_gear_form_grinding_wheel(self) -> '_668.CylindricalGearFormGrindingWheel':
        ...
        if _668.CylindricalGearFormGrindingWheel.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_cylindrical_gear_grinding_worm(self) -> '_669.CylindricalGearGrindingWorm':
        ...
        if _669.CylindricalGearGrindingWorm.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_cylindrical_gear_hob_design(self) -> '_670.CylindricalGearHobDesign':
        ...
        if _670.CylindricalGearHobDesign.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_cylindrical_gear_plunge_shaver(self) -> '_671.CylindricalGearPlungeShaver':
        ...
        if _671.CylindricalGearPlungeShaver.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_cylindrical_gear_rack_design(self) -> '_673.CylindricalGearRackDesign':
        ...
        if _673.CylindricalGearRackDesign.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_cylindrical_gear_shaper(self) -> '_675.CylindricalGearShaper':
        ...
        if _675.CylindricalGearShaper.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_cylindrical_gear_shaver(self) -> '_676.CylindricalGearShaver':
        ...
        if _676.CylindricalGearShaver.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_involute_cutter_design(self) -> '_679.InvoluteCutterDesign':
        ...
        if _679.InvoluteCutterDesign.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def fillet_points(self) -> 'List[_690.NamedPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FilletPoints, constructor.new(_690.NamedPoint))
        return value

    @property
    def main_blade_points(self) -> 'List[_690.NamedPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MainBladePoints, constructor.new(_690.NamedPoint))
        return value
