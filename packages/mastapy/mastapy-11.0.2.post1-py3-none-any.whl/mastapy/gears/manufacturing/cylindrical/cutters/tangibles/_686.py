...
from mastapy.gears.manufacturing.cylindrical.cutters import _670
...
class CylindricalGearHobShape(_691.RackShape):
    '''CylindricalGearHobShape
    ...
    @property
    def design(self) -> '_670.CylindricalGearHobDesign':
        ...
        return constructor.new(_670.CylindricalGearHobDesign)(self.wrapped.Design) if self.wrapped.Design is not None else None
