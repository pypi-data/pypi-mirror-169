...
from mastapy.gears.gear_designs.cylindrical import _1006, _955
...
class ShavingDynamicsViewModel(_719.ShavingDynamicsViewModelBase, Generic[T]):
    '''ShavingDynamicsViewModel
    ...
    @property
    def active_profile_range_calculation_source(self) -> '_697.ActiveProfileRangeCalculationSource':
        ...
        return constructor.new(_697.ActiveProfileRangeCalculationSource)(value) if value else None

    @active_profile_range_calculation_source.setter
    def active_profile_range_calculation_source(self, value: '_697.ActiveProfileRangeCalculationSource'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def calculation(self) -> '_714.ShavingDynamicsCalculation[T]':
        ...
        if _714.ShavingDynamicsCalculation[T].TYPE not in self.wrapped.Calculation.__class__.__mro__:
    ...
    @property
    def calculation_of_type_conventional_shaving_dynamics_calculation_for_designed_gears(self) -> '_700.ConventionalShavingDynamicsCalculationForDesignedGears':
        ...
        if _700.ConventionalShavingDynamicsCalculationForDesignedGears.TYPE not in self.wrapped.Calculation.__class__.__mro__:
    ...
    @property
    def calculation_of_type_conventional_shaving_dynamics_calculation_for_hobbed_gears(self) -> '_701.ConventionalShavingDynamicsCalculationForHobbedGears':
        ...
        if _701.ConventionalShavingDynamicsCalculationForHobbedGears.TYPE not in self.wrapped.Calculation.__class__.__mro__:
    ...
    @property
    def calculation_of_type_plunge_shaving_dynamics_calculation_for_designed_gears(self) -> '_706.PlungeShavingDynamicsCalculationForDesignedGears':
        ...
        if _706.PlungeShavingDynamicsCalculationForDesignedGears.TYPE not in self.wrapped.Calculation.__class__.__mro__:
    ...
    @property
    def calculation_of_type_plunge_shaving_dynamics_calculation_for_hobbed_gears(self) -> '_707.PlungeShavingDynamicsCalculationForHobbedGears':
        ...
        if _707.PlungeShavingDynamicsCalculationForHobbedGears.TYPE not in self.wrapped.Calculation.__class__.__mro__:
