...
class ShavingDynamicsConfiguration(_0.APIBase):
    ...
    @property
    def conventional_shaving_dynamics(self) -> '_714.ShavingDynamicsCalculation[_699.ConventionalShavingDynamics]':
        ...
        if _714.ShavingDynamicsCalculation[_699.ConventionalShavingDynamics].TYPE not in self.wrapped.ConventionalShavingDynamics.__class__.__mro__:
    ...
    @property
    def conventional_shaving_dynamics_of_type_conventional_shaving_dynamics_calculation_for_designed_gears(self) -> '_700.ConventionalShavingDynamicsCalculationForDesignedGears':
        ...
        if _700.ConventionalShavingDynamicsCalculationForDesignedGears.TYPE not in self.wrapped.ConventionalShavingDynamics.__class__.__mro__:
    ...
    @property
    def conventional_shaving_dynamics_of_type_conventional_shaving_dynamics_calculation_for_hobbed_gears(self) -> '_701.ConventionalShavingDynamicsCalculationForHobbedGears':
        ...
        if _701.ConventionalShavingDynamicsCalculationForHobbedGears.TYPE not in self.wrapped.ConventionalShavingDynamics.__class__.__mro__:
    ...
    @property
    def conventional_shaving_dynamics_of_type_plunge_shaving_dynamics_calculation_for_designed_gears(self) -> '_706.PlungeShavingDynamicsCalculationForDesignedGears':
        ...
        if _706.PlungeShavingDynamicsCalculationForDesignedGears.TYPE not in self.wrapped.ConventionalShavingDynamics.__class__.__mro__:
    ...
    @property
    def conventional_shaving_dynamics_of_type_plunge_shaving_dynamics_calculation_for_hobbed_gears(self) -> '_707.PlungeShavingDynamicsCalculationForHobbedGears':
        ...
        if _707.PlungeShavingDynamicsCalculationForHobbedGears.TYPE not in self.wrapped.ConventionalShavingDynamics.__class__.__mro__:
    ...
    @property
    def plunge_shaving_dynamics(self) -> '_714.ShavingDynamicsCalculation[_703.PlungeShaverDynamics]':
        ...
        if _714.ShavingDynamicsCalculation[_703.PlungeShaverDynamics].TYPE not in self.wrapped.PlungeShavingDynamics.__class__.__mro__:
    ...
    @property
    def plunge_shaving_dynamics_of_type_conventional_shaving_dynamics_calculation_for_designed_gears(self) -> '_700.ConventionalShavingDynamicsCalculationForDesignedGears':
        ...
        if _700.ConventionalShavingDynamicsCalculationForDesignedGears.TYPE not in self.wrapped.PlungeShavingDynamics.__class__.__mro__:
    ...
    @property
    def plunge_shaving_dynamics_of_type_conventional_shaving_dynamics_calculation_for_hobbed_gears(self) -> '_701.ConventionalShavingDynamicsCalculationForHobbedGears':
        ...
        if _701.ConventionalShavingDynamicsCalculationForHobbedGears.TYPE not in self.wrapped.PlungeShavingDynamics.__class__.__mro__:
    ...
    @property
    def plunge_shaving_dynamics_of_type_plunge_shaving_dynamics_calculation_for_designed_gears(self) -> '_706.PlungeShavingDynamicsCalculationForDesignedGears':
        ...
        if _706.PlungeShavingDynamicsCalculationForDesignedGears.TYPE not in self.wrapped.PlungeShavingDynamics.__class__.__mro__:
    ...
    @property
    def plunge_shaving_dynamics_of_type_plunge_shaving_dynamics_calculation_for_hobbed_gears(self) -> '_707.PlungeShavingDynamicsCalculationForHobbedGears':
        ...
        if _707.PlungeShavingDynamicsCalculationForHobbedGears.TYPE not in self.wrapped.PlungeShavingDynamics.__class__.__mro__:
