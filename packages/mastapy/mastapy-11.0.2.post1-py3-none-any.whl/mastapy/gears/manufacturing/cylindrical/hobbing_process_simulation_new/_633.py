...
class ProcessSimulationInput(_0.APIBase):
    ...
    @property
    def centre_distance_offset_specification_method(self) -> '_611.CentreDistanceOffsetMethod':
        ...
        return constructor.new(_611.CentreDistanceOffsetMethod)(value) if value else None

    @centre_distance_offset_specification_method.setter
    def centre_distance_offset_specification_method(self, value: '_611.CentreDistanceOffsetMethod'):
    ...
    @property
    def analysis_setting(self) -> '_607.AnalysisMethod':
        ...
        return constructor.new(_607.AnalysisMethod)(value) if value else None

    @analysis_setting.setter
    def analysis_setting(self, value: '_607.AnalysisMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def cutter_mounting_error(self) -> '_638.RackMountingError':
        ...
        return constructor.new(_638.RackMountingError)(self.wrapped.CutterMountingError) if self.wrapped.CutterMountingError else None

    @property
    def gear_mounting_error(self) -> '_613.GearMountingError':
        ...
        return constructor.new(_613.GearMountingError)(self.wrapped.GearMountingError) if self.wrapped.GearMountingError else None

    @property
    def cutter_head_slide_error(self) -> '_612.CutterHeadSlideError':
        ...
        return constructor.new(_612.CutterHeadSlideError)(self.wrapped.CutterHeadSlideError) if self.wrapped.CutterHeadSlideError else None
