...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _633, _620, _647
...
class ProcessCalculation(_0.APIBase):
    ...
    @property
    def inputs(self) -> '_633.ProcessSimulationInput':
        ...
        if _633.ProcessSimulationInput.TYPE not in self.wrapped.Inputs.__class__.__mro__:
    ...
    @property
    def inputs_of_type_hobbing_process_simulation_input(self) -> '_620.HobbingProcessSimulationInput':
        ...
        if _620.HobbingProcessSimulationInput.TYPE not in self.wrapped.Inputs.__class__.__mro__:
    ...
    @property
    def inputs_of_type_worm_grinding_process_simulation_input(self) -> '_647.WormGrindingProcessSimulationInput':
        ...
        if _647.WormGrindingProcessSimulationInput.TYPE not in self.wrapped.Inputs.__class__.__mro__:
