...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _608, _642
...
class WormGrindingLeadCalculation(_642.WormGrindingProcessCalculation):
    '''WormGrindingLeadCalculation
