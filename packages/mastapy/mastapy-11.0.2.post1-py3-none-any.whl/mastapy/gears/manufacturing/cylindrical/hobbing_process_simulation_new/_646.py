...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _610, _642
...
class WormGrindingProcessProfileCalculation(_642.WormGrindingProcessCalculation):
    '''WormGrindingProcessProfileCalculation
