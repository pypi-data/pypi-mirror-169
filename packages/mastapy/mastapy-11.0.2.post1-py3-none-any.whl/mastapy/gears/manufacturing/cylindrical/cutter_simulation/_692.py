...
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _693, _698
...
class CutterSimulationCalc(_0.APIBase):
    ...
    @property
    def gear(self) -> '_693.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_693.CylindricalCutterSimulatableGear)(self.wrapped.Gear) if self.wrapped.Gear is not None else None

    @property
    def stock_removed_at_reference_diameter(self) -> '_698.FinishStockPoint':
        ...
        return constructor.new(_698.FinishStockPoint)(self.wrapped.StockRemovedAtReferenceDiameter) if self.wrapped.StockRemovedAtReferenceDiameter is not None else None

    @property
    def stock_removed_at_designed_sap(self) -> '_698.FinishStockPoint':
        ...
        return constructor.new(_698.FinishStockPoint)(self.wrapped.StockRemovedAtDesignedSAP) if self.wrapped.StockRemovedAtDesignedSAP is not None else None

    @property
    def stock_removed_at_rough_tip_form(self) -> '_698.FinishStockPoint':
        ...
        return constructor.new(_698.FinishStockPoint)(self.wrapped.StockRemovedAtRoughTipForm) if self.wrapped.StockRemovedAtRoughTipForm is not None else None

    @property
    def gear_fillet_points(self) -> 'List[_690.NamedPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearFilletPoints, constructor.new(_690.NamedPoint))
        return value

    @property
    def finish_stock_indexed_arcs(self) -> 'List[_698.FinishStockPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FinishStockIndexedArcs, constructor.new(_698.FinishStockPoint))
        return value

    @property
    def main_profile_finish_stock(self) -> 'List[_698.FinishStockPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MainProfileFinishStock, constructor.new(_698.FinishStockPoint))
        return value
