...
class WormGrinderSimulationCalculator(_663.RackSimulationCalculator):
    '''WormGrinderSimulationCalculator
    ...
    def worm_grinder(self) -> '_694.CylindricalGearWormGrinderShape':
        ...
        return constructor.new(_694.CylindricalGearWormGrinderShape)(self.wrapped.WormGrinder) if self.wrapped.WormGrinder else None
