...
class WormGrinderSimulationCalculator(_704.RackSimulationCalculator):
    '''WormGrinderSimulationCalculator
    ...
    @property
    def worm_grinder(self) -> '_689.CylindricalGearWormGrinderShape':
        ...
        return constructor.new(_689.CylindricalGearWormGrinderShape)(self.wrapped.WormGrinder) if self.wrapped.WormGrinder is not None else None
