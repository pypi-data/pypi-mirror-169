...
from mastapy.materials import _253, _250, _251
...
class PlasticSNCurve(_0.APIBase):
    ...
    @property
    def material(self) -> '_551.PlasticCylindricalGearMaterial':
        ...
        return constructor.new(_551.PlasticCylindricalGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None

    @property
    def bending_stress_cycle_data(self) -> 'List[_250.StressCyclesDataForTheBendingSNCurveOfAPlasticMaterial]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BendingStressCycleData, constructor.new(_250.StressCyclesDataForTheBendingSNCurveOfAPlasticMaterial))
        return value

    @property
    def contact_stress_cycle_data(self) -> 'List[_251.StressCyclesDataForTheContactSNCurveOfAPlasticMaterial]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ContactStressCycleData, constructor.new(_251.StressCyclesDataForTheContactSNCurveOfAPlasticMaterial))
        return value
