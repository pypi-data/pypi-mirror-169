...
from mastapy.detailed_rigid_connectors.interference_fits import _1250
from mastapy.bearings.tolerances import _1680, _1666, _1672
...
class InterferenceFitHalfDesign(_1191.DetailedRigidConnectorHalfDesign):
    '''InterferenceFitHalfDesign
    ...
    @property
    def stress_region(self) -> '_1250.StressRegions':
        ...
        return constructor.new(_1250.StressRegions)(value) if value is not None else None
    ...
    @property
    def tolerance(self) -> '_1680.SupportTolerance':
        ...
        if _1680.SupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
    ...
    @property
    def tolerance_of_type_inner_support_tolerance(self) -> '_1666.InnerSupportTolerance':
        ...
        if _1666.InnerSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
    ...
    @property
    def tolerance_of_type_outer_support_tolerance(self) -> '_1672.OuterSupportTolerance':
        ...
        if _1672.OuterSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
