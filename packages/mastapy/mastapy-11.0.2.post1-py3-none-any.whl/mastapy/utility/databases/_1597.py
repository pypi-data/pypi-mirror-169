...
class NamedDatabaseItem(_0.APIBase):
    ...
    @property
    def database_key(self) -> '_1598.NamedKey':
        '''NamedKey: 'DatabaseKey' is the original name of this property.'''

        return constructor.new(_1598.NamedKey)(self.wrapped.DatabaseKey) if self.wrapped.DatabaseKey is not None else None

    @database_key.setter
    def database_key(self, value: '_1598.NamedKey'):
