...
with _DummyBaseClassImport():
    ...
    from ._78 import ShaftFEMeshingOptions
    from ._79 import SparseNodalMatrix
    from ._80 import StressResultsType
    from ._81 import TransientSolverOptions
    from ._82 import TransientSolverStatus
    from ._83 import TransientSolverToleranceInputMethod
    from ._84 import ValueInputOption
    from ._85 import VolumeElementShape
