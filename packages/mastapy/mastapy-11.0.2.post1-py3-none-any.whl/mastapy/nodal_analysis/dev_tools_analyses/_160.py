...
class FEModelInstanceDrawStyle(_0.APIBase):
    ...
    @property
    def model_draw_style(self) -> '_151.DrawStyleForFE':
        ...
        return constructor.new(_151.DrawStyleForFE)(self.wrapped.ModelDrawStyle) if self.wrapped.ModelDrawStyle else None
