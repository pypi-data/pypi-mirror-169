...
class ElementPropertiesBeam(_187.ElementPropertiesWithMaterial):
    '''ElementPropertiesBeam
    ...
    @property
    def section_type(self) -> '_1144.BeamSectionType':
        ...
        return constructor.new(_1144.BeamSectionType)(value) if value else None
