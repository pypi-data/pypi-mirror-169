...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _1147
...
class ElementPropertiesShell(_187.ElementPropertiesWithMaterial):
    '''ElementPropertiesShell
    ...
    @property
    def wall_type(self) -> '_1147.ElementPropertiesShellWallType':
        ...
        return constructor.new(_1147.ElementPropertiesShellWallType)(value) if value else None
