...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _191, _179
...
class ElementPropertiesRigid(_179.ElementPropertiesBase):
    '''ElementPropertiesRigid
    ...
    @property
    def degrees_of_freedom_list(self) -> 'List[_191.RigidElementNodeDegreesOfFreedom]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DegreesOfFreedomList, constructor.new(_191.RigidElementNodeDegreesOfFreedom))
        return value
