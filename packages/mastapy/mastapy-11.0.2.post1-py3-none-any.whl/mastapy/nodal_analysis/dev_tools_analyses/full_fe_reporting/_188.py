...
class MaterialPropertiesReporting(_0.APIBase):
    ...
    @property
    def elastic_modulus_components(self) -> '_177.ElasticModulusOrthotropicComponents':
        ...
        return constructor.new(_177.ElasticModulusOrthotropicComponents)(self.wrapped.ElasticModulusComponents) if self.wrapped.ElasticModulusComponents else None

    @property
    def shear_modulus_components(self) -> '_192.ShearModulusOrthotropicComponents':
        ...
        return constructor.new(_192.ShearModulusOrthotropicComponents)(self.wrapped.ShearModulusComponents) if self.wrapped.ShearModulusComponents else None

    @property
    def poissons_ratio_components(self) -> '_190.PoissonRatioOrthotropicComponents':
        ...
        return constructor.new(_190.PoissonRatioOrthotropicComponents)(self.wrapped.PoissonsRatioComponents) if self.wrapped.PoissonsRatioComponents else None

    @property
    def thermal_expansion_coefficient_components(self) -> '_193.ThermalExpansionOrthotropicComponents':
        ...
        return constructor.new(_193.ThermalExpansionOrthotropicComponents)(self.wrapped.ThermalExpansionCoefficientComponents) if self.wrapped.ThermalExpansionCoefficientComponents else None
