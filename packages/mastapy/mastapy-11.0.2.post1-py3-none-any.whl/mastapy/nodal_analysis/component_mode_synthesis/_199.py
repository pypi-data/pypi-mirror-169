...
from mastapy.fe_tools.vfx_tools import _1148
...
class CMSOptions(_0.APIBase):
    ...
    @property
    def precision_when_saving_expansion_vectors(self) -> '_1267.DataPrecision':
        ...
        return constructor.new(_1267.DataPrecision)(value) if value else None

    @precision_when_saving_expansion_vectors.setter
    def precision_when_saving_expansion_vectors(self, value: '_1267.DataPrecision'):
    ...
    @property
    def internal_mode_options(self) -> '_152.EigenvalueOptions':
        ...
        return constructor.new(_152.EigenvalueOptions)(self.wrapped.InternalModeOptions) if self.wrapped.InternalModeOptions else None

    @property
    def solver_options(self) -> '_1148.ProSolveOptions':
        ...
        return constructor.new(_1148.ProSolveOptions)(self.wrapped.SolverOptions) if self.wrapped.SolverOptions else None
