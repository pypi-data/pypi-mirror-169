...
from mastapy.math_utility.measured_vectors import _1364, _1366
...
class NodeComparisonResult(_0.APIBase):
    ...
    @property
    def original_result(self) -> '_1364.NodeResults':
        ...
        return constructor.new(_1364.NodeResults)(self.wrapped.OriginalResult) if self.wrapped.OriginalResult is not None else None

    @property
    def new_result(self) -> '_1364.NodeResults':
        ...
        return constructor.new(_1364.NodeResults)(self.wrapped.NewResult) if self.wrapped.NewResult is not None else None

    @property
    def displacement_change(self) -> '_1366.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1366.VectorWithLinearAndAngularComponents)(self.wrapped.DisplacementChange) if self.wrapped.DisplacementChange is not None else None
