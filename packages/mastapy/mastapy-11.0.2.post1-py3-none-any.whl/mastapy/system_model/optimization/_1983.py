...
from mastapy.system_model.optimization import _1984, _1982
...
TStep = TypeVar('TStep', bound='_1982.OptimizationStep')


class OptimizationStrategy(_1984.OptimizationStrategyBase, Generic[TStep]):
    '''OptimizationStrategy
