...
from mastapy.system_model.part_model.couplings import _2347, _2349
...
class SynchroniserShift(_0.APIBase):
    ...
    @property
    def cone(self) -> '_2347.SynchroniserHalf':
        ...
        return constructor.new(_2347.SynchroniserHalf)(self.wrapped.Cone) if self.wrapped.Cone is not None else None

    @property
    def sleeve(self) -> '_2349.SynchroniserSleeve':
        ...
        return constructor.new(_2349.SynchroniserSleeve)(self.wrapped.Sleeve) if self.wrapped.Sleeve is not None else None
