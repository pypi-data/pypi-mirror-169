...
class TimeSeriesLoadCase(_6447.LoadCase):
    '''TimeSeriesLoadCase
    ...
    @property
    def driva_analysis_options(self) -> '_5120.MBDAnalysisOptions':
        ...
        return constructor.new(_5120.MBDAnalysisOptions)(self.wrapped.DRIVAAnalysisOptions) if self.wrapped.DRIVAAnalysisOptions else None
