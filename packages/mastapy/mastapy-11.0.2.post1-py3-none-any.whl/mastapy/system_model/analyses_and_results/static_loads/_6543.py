...
from mastapy.system_model.analyses_and_results.static_loads import _6554, _6541, _6521
...
class HarmonicLoadDataFluxImport(_6541.HarmonicLoadDataCSVImport['_6521.ElectricMachineHarmonicLoadFluxImportOptions']):
    '''HarmonicLoadDataFluxImport
    ...
    @property
    def inner_diameter_reference(self) -> '_6554.InnerDiameterReference':
        ...
        return constructor.new(_6554.InnerDiameterReference)(value) if value else None

    @inner_diameter_reference.setter
    def inner_diameter_reference(self, value: '_6554.InnerDiameterReference'):
