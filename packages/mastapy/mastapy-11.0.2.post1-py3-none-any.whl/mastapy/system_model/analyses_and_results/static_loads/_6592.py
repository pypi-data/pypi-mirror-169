...
from mastapy.nodal_analysis.varying_input_components import _88, _87, _92
from mastapy.math_utility.control import _1337
from mastapy.system_model.analyses_and_results.static_loads import (
    _6604, _6453, _6506, _6460
)
...
class RootAssemblyLoadCase(_6460.AssemblyLoadCase):
    '''RootAssemblyLoadCase
    ...
    @property
    def brake_force_input_values(self) -> '_88.ForceInputComponent':
        ...
        return constructor.new(_88.ForceInputComponent)(self.wrapped.BrakeForceInputValues) if self.wrapped.BrakeForceInputValues else None

    @property
    def road_incline_input_values(self) -> '_87.AngleInputComponent':
        ...
        return constructor.new(_87.AngleInputComponent)(self.wrapped.RoadInclineInputValues) if self.wrapped.RoadInclineInputValues else None

    @property
    def drive_cycle_pid_control_settings(self) -> '_1337.PIDControlSettings':
        ...
        return constructor.new(_1337.PIDControlSettings)(self.wrapped.DriveCyclePIDControlSettings) if self.wrapped.DriveCyclePIDControlSettings else None

    @property
    def target_vehicle_speed(self) -> '_92.VelocityInputComponent':
        ...
        return constructor.new(_92.VelocityInputComponent)(self.wrapped.TargetVehicleSpeed) if self.wrapped.TargetVehicleSpeed else None
    ...
    @property
    def supercharger_rotor_sets(self) -> 'List[_6506.CylindricalGearSetLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SuperchargerRotorSets, constructor.new(_6506.CylindricalGearSetLoadCase))
        return value
