...
from mastapy.system_model.analyses_and_results.static_loads import _6569, _6544, _6520
...
class HarmonicLoadDataExcelImport(_6544.HarmonicLoadDataImportBase['_6520.ElectricMachineHarmonicLoadExcelImportOptions']):
    '''HarmonicLoadDataExcelImport
    ...
    @property
    def speeds(self) -> 'List[_6569.NamedSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Speeds, constructor.new(_6569.NamedSpeed))
        return value
