...
from mastapy.math_utility import _1268, _1278
...
class PointLoadHarmonicLoadData(_6597.SpeedDependentHarmonicLoadData):
    '''PointLoadHarmonicLoadData
    ...
    @property
    def degree_of_freedom(self) -> '_1268.DegreesOfFreedom':
        ...
        return constructor.new(_1268.DegreesOfFreedom)(value) if value else None

    @degree_of_freedom.setter
    def degree_of_freedom(self, value: '_1268.DegreesOfFreedom'):
