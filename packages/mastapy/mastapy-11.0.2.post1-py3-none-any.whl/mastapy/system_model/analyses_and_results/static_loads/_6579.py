...
from mastapy.system_model.analyses_and_results.static_loads import _6578, _6568
...
class PlanetCarrierLoadCase(_6568.MountableComponentLoadCase):
    '''PlanetCarrierLoadCase
    ...
    @property
    def planet_manufacture_errors(self) -> 'List[_6578.PlanetarySocketManufactureError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetManufactureErrors, constructor.new(_6578.PlanetarySocketManufactureError))
        return value
