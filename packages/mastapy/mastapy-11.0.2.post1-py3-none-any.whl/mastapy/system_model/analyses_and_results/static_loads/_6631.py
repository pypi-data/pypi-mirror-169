...
from mastapy.system_model.analyses_and_results.static_loads import _6629, _6630, _6537
...
class WormGearSetLoadCase(_6537.GearSetLoadCase):
    '''WormGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6629.WormGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6629.WormGearLoadCase))
        return value

    @property
    def worm_gears_load_case(self) -> 'List[_6629.WormGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsLoadCase, constructor.new(_6629.WormGearLoadCase))
        return value

    @property
    def worm_meshes_load_case(self) -> 'List[_6630.WormGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesLoadCase, constructor.new(_6630.WormGearMeshLoadCase))
        return value
