...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4102, _4101, _4027
...
class WormGearSetParametricStudyTool(_4027.GearSetParametricStudyTool):
    '''WormGearSetParametricStudyTool
    ...
    @property
    def worm_gears_parametric_study_tool(self) -> 'List[_4102.WormGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsParametricStudyTool, constructor.new(_4102.WormGearParametricStudyTool))
        return value

    @property
    def worm_meshes_parametric_study_tool(self) -> 'List[_4101.WormGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesParametricStudyTool, constructor.new(_4101.WormGearMeshParametricStudyTool))
        return value
