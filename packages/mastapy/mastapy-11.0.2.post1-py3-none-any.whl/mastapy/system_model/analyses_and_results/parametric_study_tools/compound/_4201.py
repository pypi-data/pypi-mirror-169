...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4054, _4053, _4072
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.load_case_groups import (
    _5317, _5316, _5318, _5321,
    _5322, _5324, _5326
)
...
class RootAssemblyCompoundParametricStudyTool(_4114.AssemblyCompoundParametricStudyTool):
    '''RootAssemblyCompoundParametricStudyTool
    ...
    @property
    def results_for_reporting(self) -> '_4054.ParametricStudyToolResultsForReporting':
        ...
        return constructor.new(_4054.ParametricStudyToolResultsForReporting)(self.wrapped.ResultsForReporting) if self.wrapped.ResultsForReporting else None
    ...
    @property
    def compound_load_case(self) -> '_5317.AbstractLoadCaseGroup':
        ...
        if _5317.AbstractLoadCaseGroup.TYPE not in self.wrapped.CompoundLoadCase.__class__.__mro__:
    ...
    @property
    def compound_load_case_of_type_abstract_design_state_load_case_group(self) -> '_5316.AbstractDesignStateLoadCaseGroup':
        ...
        if _5316.AbstractDesignStateLoadCaseGroup.TYPE not in self.wrapped.CompoundLoadCase.__class__.__mro__:
    ...
    @property
    def compound_load_case_of_type_abstract_static_load_case_group(self) -> '_5318.AbstractStaticLoadCaseGroup':
        ...
        if _5318.AbstractStaticLoadCaseGroup.TYPE not in self.wrapped.CompoundLoadCase.__class__.__mro__:
    ...
    @property
    def compound_load_case_of_type_design_state(self) -> '_5321.DesignState':
        ...
        if _5321.DesignState.TYPE not in self.wrapped.CompoundLoadCase.__class__.__mro__:
    ...
    @property
    def compound_load_case_of_type_duty_cycle(self) -> '_5322.DutyCycle':
        ...
        if _5322.DutyCycle.TYPE not in self.wrapped.CompoundLoadCase.__class__.__mro__:
    ...
    @property
    def compound_load_case_of_type_group_of_time_series_load_cases(self) -> '_5324.GroupOfTimeSeriesLoadCases':
        ...
        if _5324.GroupOfTimeSeriesLoadCases.TYPE not in self.wrapped.CompoundLoadCase.__class__.__mro__:
    ...
    @property
    def compound_load_case_of_type_sub_group_in_single_design_state(self) -> '_5326.SubGroupInSingleDesignState':
        ...
        if _5326.SubGroupInSingleDesignState.TYPE not in self.wrapped.CompoundLoadCase.__class__.__mro__:
    ...
    @property
    def root_assembly_duty_cycle_results(self) -> '_2571.DutyCycleEfficiencyResults':
        ...
        return constructor.new(_2571.DutyCycleEfficiencyResults)(self.wrapped.RootAssemblyDutyCycleResults) if self.wrapped.RootAssemblyDutyCycleResults else None

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4072.RootAssemblyParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4072.RootAssemblyParametricStudyTool))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4072.RootAssemblyParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4072.RootAssemblyParametricStudyTool))
        return value
