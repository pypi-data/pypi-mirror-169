...
class OilSealCompoundParametricStudyTool(_4143.ConnectorCompoundParametricStudyTool):
    '''OilSealCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4046.OilSealParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4046.OilSealParametricStudyTool))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4046.OilSealParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4046.OilSealParametricStudyTool))
        return value
