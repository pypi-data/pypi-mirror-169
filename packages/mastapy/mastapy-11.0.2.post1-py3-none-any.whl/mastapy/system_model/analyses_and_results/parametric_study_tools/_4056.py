...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4047, _4044
...
class ParametricStudyVariable(_2324.AnalysisCaseVariable):
    '''ParametricStudyVariable
    ...
    @property
    def dimension(self) -> '_4047.ParametricStudyDimension':
        ...
        return constructor.new(_4047.ParametricStudyDimension)(value) if value else None

    @dimension.setter
    def dimension(self, value: '_4047.ParametricStudyDimension'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.Dimension = value

    @property
    def distribution(self) -> '_4044.MonteCarloDistribution':
        ...
        return constructor.new(_4044.MonteCarloDistribution)(value) if value else None

    @distribution.setter
    def distribution(self, value: '_4044.MonteCarloDistribution'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
