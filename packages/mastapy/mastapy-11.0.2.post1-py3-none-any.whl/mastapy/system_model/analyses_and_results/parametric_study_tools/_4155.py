...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4154, _4153, _4045
...
class StraightBevelGearSetParametricStudyTool(_4045.BevelGearSetParametricStudyTool):
    '''StraightBevelGearSetParametricStudyTool
    ...
    @property
    def straight_bevel_gears_parametric_study_tool(self) -> 'List[_4154.StraightBevelGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsParametricStudyTool, constructor.new(_4154.StraightBevelGearParametricStudyTool))
        return value

    @property
    def straight_bevel_meshes_parametric_study_tool(self) -> 'List[_4153.StraightBevelGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesParametricStudyTool, constructor.new(_4153.StraightBevelGearMeshParametricStudyTool))
        return value
