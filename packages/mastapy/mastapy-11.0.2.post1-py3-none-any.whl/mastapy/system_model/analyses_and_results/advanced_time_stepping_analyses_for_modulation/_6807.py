...
class OilSealAdvancedTimeSteppingAnalysisForModulation(_6764.ConnectorAdvancedTimeSteppingAnalysisForModulation):
    '''OilSealAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2519.OilSealSystemDeflection':
        ...
        return constructor.new(_2519.OilSealSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
