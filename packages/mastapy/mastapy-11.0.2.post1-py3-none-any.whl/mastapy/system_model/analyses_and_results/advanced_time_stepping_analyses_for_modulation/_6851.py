...
class VirtualComponentAdvancedTimeSteppingAnalysisForModulation(_6806.MountableComponentAdvancedTimeSteppingAnalysisForModulation):
    '''VirtualComponentAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2570.VirtualComponentSystemDeflection':
