...
class SteadyStateSynchronousResponseOnAShaft(_7195.StaticLoadAnalysisCase):
    '''SteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def options(self) -> '_3277.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_3277.SteadyStateSynchronousResponseOptions)(self.wrapped.Options) if self.wrapped.Options else None
