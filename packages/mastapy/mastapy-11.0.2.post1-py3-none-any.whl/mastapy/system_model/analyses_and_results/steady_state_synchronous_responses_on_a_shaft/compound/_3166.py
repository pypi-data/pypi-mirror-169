...
class FaceGearCompoundSteadyStateSynchronousResponseOnAShaft(_3171.GearCompoundSteadyStateSynchronousResponseOnAShaft):
    '''FaceGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3038.FaceGearSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3038.FaceGearSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3038.FaceGearSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3038.FaceGearSteadyStateSynchronousResponseOnAShaft))
        return value
