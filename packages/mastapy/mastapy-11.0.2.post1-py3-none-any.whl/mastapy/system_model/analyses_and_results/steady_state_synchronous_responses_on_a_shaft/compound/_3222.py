...
class StraightBevelGearMeshCompoundSteadyStateSynchronousResponseOnAShaft(_3130.BevelGearMeshCompoundSteadyStateSynchronousResponseOnAShaft):
    '''StraightBevelGearMeshCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3092.StraightBevelGearMeshSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3092.StraightBevelGearMeshSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_3092.StraightBevelGearMeshSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3092.StraightBevelGearMeshSteadyStateSynchronousResponseOnAShaft))
        return value
