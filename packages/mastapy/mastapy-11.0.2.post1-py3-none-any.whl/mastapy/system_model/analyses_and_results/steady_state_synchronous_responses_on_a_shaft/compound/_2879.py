...
class SpecialisedAssemblyCompoundSteadyStateSynchronousResponseOnAShaft(_2781.AbstractAssemblyCompoundSteadyStateSynchronousResponseOnAShaft):
    '''SpecialisedAssemblyCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2749.SpecialisedAssemblySteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2749.SpecialisedAssemblySteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2749.SpecialisedAssemblySteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2749.SpecialisedAssemblySteadyStateSynchronousResponseOnAShaft))
        return value
