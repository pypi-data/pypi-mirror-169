...
class PartSteadyStateSynchronousResponseOnAShaft(_7265.PartStaticLoadAnalysisCase):
    '''PartSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def steady_state_synchronous_response_on_a_shaft(self) -> '_2823.SteadyStateSynchronousResponseOnAShaft':
        ...
        return constructor.new(_2823.SteadyStateSynchronousResponseOnAShaft)(self.wrapped.SteadyStateSynchronousResponseOnAShaft) if self.wrapped.SteadyStateSynchronousResponseOnAShaft is not None else None

    def create_viewable(self) -> '_2000.SteadyStateSynchronousResponseViewable':
