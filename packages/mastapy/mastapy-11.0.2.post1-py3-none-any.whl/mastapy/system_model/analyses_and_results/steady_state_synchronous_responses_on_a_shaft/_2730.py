...
class PartSteadyStateSynchronousResponseOnAShaft(_7193.PartStaticLoadAnalysisCase):
    '''PartSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def steady_state_synchronous_response_on_a_shaft(self) -> '_2756.SteadyStateSynchronousResponseOnAShaft':
        ...
        return constructor.new(_2756.SteadyStateSynchronousResponseOnAShaft)(self.wrapped.SteadyStateSynchronousResponseOnAShaft) if self.wrapped.SteadyStateSynchronousResponseOnAShaft else None

    def create_viewable(self) -> '_1940.SteadyStateSynchronousResponseViewable':
