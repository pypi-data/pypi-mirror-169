...
class SteadyStateSynchronousResponseOnAShaft(_7270.StaticLoadAnalysisCase):
    '''SteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def options(self) -> '_2829.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_2829.SteadyStateSynchronousResponseOptions)(self.wrapped.Options) if self.wrapped.Options is not None else None
