...
class ConnectionSteadyStateSynchronousResponseOnAShaft(_7261.ConnectionStaticLoadAnalysisCase):
    '''ConnectionSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def steady_state_synchronous_response_on_a_shaft(self) -> '_3088.SteadyStateSynchronousResponseOnAShaft':
        ...
        return constructor.new(_3088.SteadyStateSynchronousResponseOnAShaft)(self.wrapped.SteadyStateSynchronousResponseOnAShaft) if self.wrapped.SteadyStateSynchronousResponseOnAShaft is not None else None
