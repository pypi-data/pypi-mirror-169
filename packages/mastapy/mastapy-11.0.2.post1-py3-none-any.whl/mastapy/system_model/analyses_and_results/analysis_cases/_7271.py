...
class TimeSeriesLoadAnalysisCase(_7255.AnalysisCase):
    '''TimeSeriesLoadAnalysisCase
    ...
    @property
    def load_case(self) -> '_6523.TimeSeriesLoadCase':
        ...
        return constructor.new(_6523.TimeSeriesLoadCase)(self.wrapped.LoadCase) if self.wrapped.LoadCase is not None else None
