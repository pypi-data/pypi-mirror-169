...
class WormGearMeshAdvancedSystemDeflection(_6979.GearMeshAdvancedSystemDeflection):
    '''WormGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2504.WormGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2504.WormGearMeshSystemDeflection))
        return value
