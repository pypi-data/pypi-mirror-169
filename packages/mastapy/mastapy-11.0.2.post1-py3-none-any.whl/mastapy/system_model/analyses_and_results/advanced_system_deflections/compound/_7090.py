...
class CouplingHalfCompoundAdvancedSystemDeflection(_7128.MountableComponentCompoundAdvancedSystemDeflection):
    '''CouplingHalfCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6958.CouplingHalfAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6958.CouplingHalfAdvancedSystemDeflection))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_6958.CouplingHalfAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6958.CouplingHalfAdvancedSystemDeflection))
        return value
