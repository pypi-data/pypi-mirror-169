...
class PartAdvancedSystemDeflection(_7265.PartStaticLoadAnalysisCase):
    '''PartAdvancedSystemDeflection
    ...
    @property
    def advanced_system_deflection(self) -> '_6991.AdvancedSystemDeflection':
        ...
        return constructor.new(_6991.AdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflection) if self.wrapped.AdvancedSystemDeflection is not None else None
    ...
    def create_viewable(self) -> '_1985.AdvancedSystemDeflectionViewable':
