...
class PlanetCarrierAdvancedSystemDeflection(_6998.MountableComponentAdvancedSystemDeflection):
    '''PlanetCarrierAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2458.PlanetCarrierSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2458.PlanetCarrierSystemDeflection))
        return value
