...
class SpiralBevelGearMeshAdvancedSystemDeflection(_6935.BevelGearMeshAdvancedSystemDeflection):
    '''SpiralBevelGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2475.SpiralBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2475.SpiralBevelGearMeshSystemDeflection))
        return value
