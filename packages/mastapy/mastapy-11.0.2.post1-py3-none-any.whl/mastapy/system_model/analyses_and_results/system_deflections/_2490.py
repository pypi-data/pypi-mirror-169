...
from mastapy.system_model.analyses_and_results.power_flows import _3815, _3814, _3817
...
class SynchroniserPartSystemDeflection(_2400.CouplingHalfSystemDeflection):
    '''SynchroniserPartSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3815.SynchroniserPartPowerFlow':
