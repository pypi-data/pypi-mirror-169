...
from mastapy.system_model.analyses_and_results.system_deflections import _2556, _2541
...
class SynchroniserSystemDeflection(_2541.SpecialisedAssemblySystemDeflection):
    '''SynchroniserSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3883.SynchroniserPowerFlow':
        ...
        return constructor.new(_3883.SynchroniserPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None

    @property
    def cones(self) -> 'List[_2556.SynchroniserHalfSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_2556.SynchroniserHalfSystemDeflection))
        return value
