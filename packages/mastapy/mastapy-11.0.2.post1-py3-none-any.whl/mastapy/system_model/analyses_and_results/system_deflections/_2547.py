...
class SpringDamperSystemDeflection(_2466.CouplingSystemDeflection):
    '''SpringDamperSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3872.SpringDamperPowerFlow':
        ...
        return constructor.new(_3872.SpringDamperPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
