...
class StraightBevelGearSystemDeflection(_2378.BevelGearSystemDeflection):
    '''StraightBevelGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3810.StraightBevelGearPowerFlow':
        ...
        return constructor.new(_3810.StraightBevelGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def component_detailed_analysis(self) -> '_362.StraightBevelGearRating':
        ...
        return constructor.new(_362.StraightBevelGearRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None
