...
class RollingRingConnectionSystemDeflection(_2435.InterMountableComponentConnectionSystemDeflection):
    '''RollingRingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3793.RollingRingConnectionPowerFlow':
        ...
        return constructor.new(_3793.RollingRingConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
