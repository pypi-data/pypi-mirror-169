...
class PointLoadSystemDeflection(_2503.VirtualComponentSystemDeflection):
    '''PointLoadSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3785.PointLoadPowerFlow':
        ...
        return constructor.new(_3785.PointLoadPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
