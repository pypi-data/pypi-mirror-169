...
from mastapy.system_model.analyses_and_results.power_flows import _3882, _3881, _3884
...
class SynchroniserPartSystemDeflection(_2465.CouplingHalfSystemDeflection):
    '''SynchroniserPartSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3882.SynchroniserPartPowerFlow':
