...
from mastapy.system_model.analyses_and_results.system_deflections import _2381, _2490
...
class SynchroniserHalfSystemDeflection(_2490.SynchroniserPartSystemDeflection):
    '''SynchroniserHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3814.SynchroniserHalfPowerFlow':
        ...
        return constructor.new(_3814.SynchroniserHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
