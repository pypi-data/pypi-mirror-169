...
class TorqueConverterPumpSystemDeflection(_2465.CouplingHalfSystemDeflection):
    '''TorqueConverterPumpSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3888.TorqueConverterPumpPowerFlow':
        ...
        return constructor.new(_3888.TorqueConverterPumpPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
