...
class SynchroniserSleeveSystemDeflection(_2490.SynchroniserPartSystemDeflection):
    '''SynchroniserSleeveSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3817.SynchroniserSleevePowerFlow':
        ...
        return constructor.new(_3817.SynchroniserSleevePowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
