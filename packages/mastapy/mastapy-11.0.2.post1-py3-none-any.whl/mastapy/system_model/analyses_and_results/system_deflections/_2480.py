...
class SpringDamperSystemDeflection(_2401.CouplingSystemDeflection):
    '''SpringDamperSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3805.SpringDamperPowerFlow':
        ...
        return constructor.new(_3805.SpringDamperPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
