...
class KlingelnbergCycloPalloidHypoidGearSystemDeflection(_2438.KlingelnbergCycloPalloidConicalGearSystemDeflection):
    '''KlingelnbergCycloPalloidHypoidGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3769.KlingelnbergCycloPalloidHypoidGearPowerFlow':
        ...
        return constructor.new(_3769.KlingelnbergCycloPalloidHypoidGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
