...
class VirtualComponentSystemDeflection(_2450.MountableComponentSystemDeflection):
    '''VirtualComponentSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3824.VirtualComponentPowerFlow':
