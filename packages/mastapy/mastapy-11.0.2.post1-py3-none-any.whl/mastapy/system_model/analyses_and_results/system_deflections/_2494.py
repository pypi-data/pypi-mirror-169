...
from mastapy.system_model.drawing import _1937, _1927
...
class SystemDeflectionDrawStyle(_1927.ContourDrawStyle):
    '''SystemDeflectionDrawStyle
    ...
    @property
    def force_arrow_scaling(self) -> '_1937.ScalingDrawStyle':
        ...
        return constructor.new(_1937.ScalingDrawStyle)(self.wrapped.ForceArrowScaling) if self.wrapped.ForceArrowScaling else None
