...
class SpringDamperConnectionSystemDeflection(_2399.CouplingConnectionSystemDeflection):
    '''SpringDamperConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3803.SpringDamperConnectionPowerFlow':
        ...
        return constructor.new(_3803.SpringDamperConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
