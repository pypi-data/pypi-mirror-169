...
from mastapy.detailed_rigid_connectors.splines.ratings import (
    _1190, _1192, _1194, _1196,
    _1198
)
from mastapy._internal.cast_exception import CastException
from mastapy.detailed_rigid_connectors.keyed_joints.rating import _1208
...
class ShaftHubConnectionSystemDeflection(_2398.ConnectorSystemDeflection):
    '''ShaftHubConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3796.ShaftHubConnectionPowerFlow':
        ...
        return constructor.new(_3796.ShaftHubConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def component_detailed_analysis(self) -> '_1202.ShaftHubConnectionRating':
        ...
        if _1202.ShaftHubConnectionRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_agma6123_spline_joint_rating(self) -> '_1190.AGMA6123SplineJointRating':
        ...
        if _1190.AGMA6123SplineJointRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_din5466_spline_rating(self) -> '_1192.DIN5466SplineRating':
        ...
        if _1192.DIN5466SplineRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_gbt17855_spline_joint_rating(self) -> '_1194.GBT17855SplineJointRating':
        ...
        if _1194.GBT17855SplineJointRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_sae_spline_joint_rating(self) -> '_1196.SAESplineJointRating':
        ...
        if _1196.SAESplineJointRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_spline_joint_rating(self) -> '_1198.SplineJointRating':
        ...
        if _1198.SplineJointRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_keyway_rating(self) -> '_1208.KeywayRating':
        ...
        if _1208.KeywayRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_interference_fit_rating(self) -> '_1215.InterferenceFitRating':
        ...
        if _1215.InterferenceFitRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def stiffness_matrix_in_local_coordinate_system(self) -> '_1647.BearingStiffnessMatrixReporter':
        ...
        return constructor.new(_1647.BearingStiffnessMatrixReporter)(self.wrapped.StiffnessMatrixInLocalCoordinateSystem) if self.wrapped.StiffnessMatrixInLocalCoordinateSystem else None

    @property
    def stiffness_matrix_in_unrotated_coordinate_system(self) -> '_1647.BearingStiffnessMatrixReporter':
        ...
        return constructor.new(_1647.BearingStiffnessMatrixReporter)(self.wrapped.StiffnessMatrixInUnrotatedCoordinateSystem) if self.wrapped.StiffnessMatrixInUnrotatedCoordinateSystem else None
    ...
    @property
    def left_flank_contacts(self) -> 'List[_2518.SplineFlankContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LeftFlankContacts, constructor.new(_2518.SplineFlankContactReporting))
        return value

    @property
    def right_flank_contacts(self) -> 'List[_2518.SplineFlankContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RightFlankContacts, constructor.new(_2518.SplineFlankContactReporting))
        return value

    @property
    def tip_contacts(self) -> 'List[_2518.SplineFlankContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TipContacts, constructor.new(_2518.SplineFlankContactReporting))
        return value
