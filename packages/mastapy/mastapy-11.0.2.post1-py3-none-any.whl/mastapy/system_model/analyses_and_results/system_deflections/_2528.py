...
from mastapy.system_model.analyses_and_results.power_flows import _3856, _3807
...
class PulleySystemDeflection(_2465.CouplingHalfSystemDeflection):
    '''PulleySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3856.PulleyPowerFlow':
