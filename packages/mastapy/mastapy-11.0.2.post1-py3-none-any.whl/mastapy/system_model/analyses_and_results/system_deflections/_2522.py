...
class PartToPartShearCouplingHalfSystemDeflection(_2465.CouplingHalfSystemDeflection):
    '''PartToPartShearCouplingHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3847.PartToPartShearCouplingHalfPowerFlow':
        ...
        return constructor.new(_3847.PartToPartShearCouplingHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
