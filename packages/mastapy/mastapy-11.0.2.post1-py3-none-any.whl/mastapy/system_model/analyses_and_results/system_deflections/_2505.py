...
from mastapy.system_model.analyses_and_results.system_deflections import _2506, _2504, _2428
...
class WormGearSetSystemDeflection(_2428.GearSetSystemDeflection):
    '''WormGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3827.WormGearSetPowerFlow':
        ...
        return constructor.new(_3827.WormGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def worm_gears_system_deflection(self) -> 'List[_2506.WormGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsSystemDeflection, constructor.new(_2506.WormGearSystemDeflection))
        return value

    @property
    def worm_meshes_system_deflection(self) -> 'List[_2504.WormGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesSystemDeflection, constructor.new(_2504.WormGearMeshSystemDeflection))
        return value
