...
class StraightBevelPlanetGearSystemDeflection(_2483.StraightBevelDiffGearSystemDeflection):
    '''StraightBevelPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3812.StraightBevelPlanetGearPowerFlow':
        ...
        return constructor.new(_3812.StraightBevelPlanetGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
