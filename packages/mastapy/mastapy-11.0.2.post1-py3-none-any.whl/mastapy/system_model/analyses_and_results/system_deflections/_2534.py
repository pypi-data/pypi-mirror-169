...
class RollingRingSystemDeflection(_2465.CouplingHalfSystemDeflection):
    '''RollingRingSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3861.RollingRingPowerFlow':
        ...
        return constructor.new(_3861.RollingRingPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
