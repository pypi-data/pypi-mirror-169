...
from mastapy.system_model.analyses_and_results.system_deflections import _2489, _2474
...
class SynchroniserSystemDeflection(_2474.SpecialisedAssemblySystemDeflection):
    '''SynchroniserSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3816.SynchroniserPowerFlow':
        ...
        return constructor.new(_3816.SynchroniserPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def cones(self) -> 'List[_2489.SynchroniserHalfSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_2489.SynchroniserHalfSystemDeflection))
        return value
