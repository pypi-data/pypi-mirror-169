...
class MassDiscSystemDeflection(_2570.VirtualComponentSystemDeflection):
    '''MassDiscSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3841.MassDiscPowerFlow':
        ...
        return constructor.new(_3841.MassDiscPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
