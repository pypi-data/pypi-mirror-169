...
class StraightBevelDiffGearMeshSystemDeflection(_2376.BevelGearMeshSystemDeflection):
    '''StraightBevelDiffGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3806.StraightBevelDiffGearMeshPowerFlow':
        ...
        return constructor.new(_3806.StraightBevelDiffGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def rating(self) -> '_357.StraightBevelDiffGearMeshRating':
        ...
        return constructor.new(_357.StraightBevelDiffGearMeshRating)(self.wrapped.Rating) if self.wrapped.Rating else None

    @property
    def component_detailed_analysis(self) -> '_357.StraightBevelDiffGearMeshRating':
        ...
        return constructor.new(_357.StraightBevelDiffGearMeshRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None
