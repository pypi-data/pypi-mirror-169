...
class MeasurementComponentSystemDeflection(_2570.VirtualComponentSystemDeflection):
    '''MeasurementComponentSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3842.MeasurementComponentPowerFlow':
        ...
        return constructor.new(_3842.MeasurementComponentPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
