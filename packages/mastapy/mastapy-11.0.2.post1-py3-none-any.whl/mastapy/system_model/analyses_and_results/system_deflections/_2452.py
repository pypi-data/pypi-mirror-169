...
class OilSealSystemDeflection(_2398.ConnectorSystemDeflection):
    '''OilSealSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3777.OilSealPowerFlow':
        ...
        return constructor.new(_3777.OilSealPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
