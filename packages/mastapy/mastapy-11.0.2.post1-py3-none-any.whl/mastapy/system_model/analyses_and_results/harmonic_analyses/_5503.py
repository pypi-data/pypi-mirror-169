...
class KlingelnbergCycloPalloidSpiralBevelGearHarmonicAnalysis(_5497.KlingelnbergCycloPalloidConicalGearHarmonicAnalysis):
    '''KlingelnbergCycloPalloidSpiralBevelGearHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2514.KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection':
        ...
        return constructor.new(_2514.KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
