...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5538
...
class SpringDamperCompoundHarmonicAnalysis(_5636.CouplingCompoundHarmonicAnalysis):
    '''SpringDamperCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5538.SpringDamperHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5538.SpringDamperHarmonicAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_5538.SpringDamperHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5538.SpringDamperHarmonicAnalysis))
        return value
