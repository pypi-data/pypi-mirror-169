...
class TorqueConverterConnectionCompoundHarmonicAnalysis(_5893.CouplingConnectionCompoundHarmonicAnalysis):
    '''TorqueConverterConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5807.TorqueConverterConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5807.TorqueConverterConnectionHarmonicAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5807.TorqueConverterConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5807.TorqueConverterConnectionHarmonicAnalysis))
        return value
