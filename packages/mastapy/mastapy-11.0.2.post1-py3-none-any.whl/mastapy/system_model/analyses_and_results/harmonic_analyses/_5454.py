...
class CycloidalDiscPlanetaryBearingConnectionHarmonicAnalysis(_5410.AbstractShaftToMountableComponentConnectionHarmonicAnalysis):
    '''CycloidalDiscPlanetaryBearingConnectionHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2475.CycloidalDiscPlanetaryBearingConnectionSystemDeflection':
        ...
        return constructor.new(_2475.CycloidalDiscPlanetaryBearingConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
