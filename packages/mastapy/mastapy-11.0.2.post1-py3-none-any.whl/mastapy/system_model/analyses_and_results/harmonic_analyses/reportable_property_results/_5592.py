...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5584, _5591
...
class ResultsForOrderIncludingSurfaces(_5591.ResultsForOrderIncludingNodes):
    '''ResultsForOrderIncludingSurfaces
    ...
    @property
    def fe_surfaces(self) -> 'List[_5584.HarmonicAnalysisResultsBrokenDownBySurfaceWithinAHarmonic]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FESurfaces, constructor.new(_5584.HarmonicAnalysisResultsBrokenDownBySurfaceWithinAHarmonic))
        return value
