...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5581, _5586
...
class ResultsForMultipleOrdersForGroups(_5586.ResultsForMultipleOrders):
    '''ResultsForMultipleOrdersForGroups
    ...
    @property
    def groups(self) -> 'List[_5581.HarmonicAnalysisResultsBrokenDownByGroupsWithinAHarmonic]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Groups, constructor.new(_5581.HarmonicAnalysisResultsBrokenDownByGroupsWithinAHarmonic))
        return value
