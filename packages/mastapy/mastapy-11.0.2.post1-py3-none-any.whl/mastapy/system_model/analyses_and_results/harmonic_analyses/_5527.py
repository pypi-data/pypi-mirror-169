...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5492, _5408
...
class ShaftHarmonicAnalysis(_5408.AbstractShaftHarmonicAnalysis):
    '''ShaftHarmonicAnalysis
    ...
    @property
    def coupled_modal_analysis(self) -> '_4408.ShaftModalAnalysis':
        ...
        return constructor.new(_4408.ShaftModalAnalysis)(self.wrapped.CoupledModalAnalysis) if self.wrapped.CoupledModalAnalysis is not None else None

    @property
    def export(self) -> '_5492.HarmonicAnalysisShaftExportOptions':
        ...
        return constructor.new(_5492.HarmonicAnalysisShaftExportOptions)(self.wrapped.Export) if self.wrapped.Export is not None else None
