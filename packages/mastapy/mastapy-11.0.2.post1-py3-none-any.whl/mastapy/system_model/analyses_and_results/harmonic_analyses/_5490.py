...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5567
from mastapy.system_model.analyses_and_results.modal_analyses import _4387
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5532, _5478
...
class HarmonicAnalysisOptions(_0.APIBase):
    ...
    @property
    def excitation_selection(self) -> '_5567.ExcitationSourceSelectionGroup':
        ...
        return constructor.new(_5567.ExcitationSourceSelectionGroup)(self.wrapped.ExcitationSelection) if self.wrapped.ExcitationSelection is not None else None

    @property
    def modal_analysis_options(self) -> '_4387.ModalAnalysisOptions':
        ...
        return constructor.new(_4387.ModalAnalysisOptions)(self.wrapped.ModalAnalysisOptions) if self.wrapped.ModalAnalysisOptions is not None else None
