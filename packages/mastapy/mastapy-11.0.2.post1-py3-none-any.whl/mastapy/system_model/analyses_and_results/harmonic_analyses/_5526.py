...
class RootAssemblyHarmonicAnalysis(_5414.AssemblyHarmonicAnalysis):
    '''RootAssemblyHarmonicAnalysis
    ...
    @property
    def export(self) -> '_5491.HarmonicAnalysisRootAssemblyExportOptions':
        ...
        return constructor.new(_5491.HarmonicAnalysisRootAssemblyExportOptions)(self.wrapped.Export) if self.wrapped.Export is not None else None
    ...
    @property
    def harmonic_analysis_inputs(self) -> '_2375.HarmonicAnalysis':
        ...
        if _2375.HarmonicAnalysis.TYPE not in self.wrapped.HarmonicAnalysisInputs.__class__.__mro__:
