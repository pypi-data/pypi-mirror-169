...
class FaceGearMeshCompoundSteadyStateSynchronousResponseAtASpeed(_3099.GearMeshCompoundSteadyStateSynchronousResponseAtASpeed):
    '''FaceGearMeshCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2963.FaceGearMeshSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_2963.FaceGearMeshSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_2963.FaceGearMeshSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_2963.FaceGearMeshSteadyStateSynchronousResponseAtASpeed))
        return value
