...
class PartToPartShearCouplingCompoundSteadyStateSynchronousResponseAtASpeed(_3077.CouplingCompoundSteadyStateSynchronousResponseAtASpeed):
    '''PartToPartShearCouplingCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2992.PartToPartShearCouplingSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2992.PartToPartShearCouplingSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_2992.PartToPartShearCouplingSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2992.PartToPartShearCouplingSteadyStateSynchronousResponseAtASpeed))
        return value
