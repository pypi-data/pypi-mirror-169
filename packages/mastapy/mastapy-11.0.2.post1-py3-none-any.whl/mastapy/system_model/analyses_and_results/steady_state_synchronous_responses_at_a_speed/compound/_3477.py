...
class StraightBevelDiffGearCompoundSteadyStateSynchronousResponseAtASpeed(_3388.BevelGearCompoundSteadyStateSynchronousResponseAtASpeed):
    '''StraightBevelDiffGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3350.StraightBevelDiffGearSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3350.StraightBevelDiffGearSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3350.StraightBevelDiffGearSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3350.StraightBevelDiffGearSteadyStateSynchronousResponseAtASpeed))
        return value
