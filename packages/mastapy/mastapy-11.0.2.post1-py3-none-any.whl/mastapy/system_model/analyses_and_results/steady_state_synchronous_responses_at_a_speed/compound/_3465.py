...
class RollingRingConnectionCompoundSteadyStateSynchronousResponseAtASpeed(_3437.InterMountableComponentConnectionCompoundSteadyStateSynchronousResponseAtASpeed):
    '''RollingRingConnectionCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3334.RollingRingConnectionSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3334.RollingRingConnectionSteadyStateSynchronousResponseAtASpeed))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3334.RollingRingConnectionSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3334.RollingRingConnectionSteadyStateSynchronousResponseAtASpeed))
        return value
