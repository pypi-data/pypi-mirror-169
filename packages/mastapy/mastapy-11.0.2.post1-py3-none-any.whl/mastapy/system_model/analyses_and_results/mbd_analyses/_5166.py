...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5170, _5075
...
class TorqueConverterConnectionMultibodyDynamicsAnalysis(_5075.CouplingConnectionMultibodyDynamicsAnalysis):
    '''TorqueConverterConnectionMultibodyDynamicsAnalysis
    ...
    @property
    def locking_status(self) -> '_5170.TorqueConverterStatus':
        ...
        return constructor.new(_5170.TorqueConverterStatus)(value) if value else None
