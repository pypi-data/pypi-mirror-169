...
from mastapy.system_model.analyses_and_results.mbd_analyses import _2315, _5043
...
class RootAssemblyMultibodyDynamicsAnalysis(_5043.AssemblyMultibodyDynamicsAnalysis):
    '''RootAssemblyMultibodyDynamicsAnalysis
    ...
    @property
    def multibody_dynamics_analysis_inputs(self) -> '_2315.MultibodyDynamicsAnalysis':
        ...
        return constructor.new(_2315.MultibodyDynamicsAnalysis)(self.wrapped.MultibodyDynamicsAnalysisInputs) if self.wrapped.MultibodyDynamicsAnalysisInputs else None
