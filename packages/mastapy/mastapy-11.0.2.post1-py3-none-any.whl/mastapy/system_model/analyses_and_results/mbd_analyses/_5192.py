...
from mastapy.system_model.analyses_and_results.mbd_analyses import _2379
from mastapy.math_utility.convergence import _1372, _1371
...
class PartMultibodyDynamicsAnalysis(_7266.PartTimeSeriesLoadAnalysisCase):
    '''PartMultibodyDynamicsAnalysis
    ...
    @property
    def data_logger(self) -> '_1372.DataLogger':
        ...
        if _1372.DataLogger.TYPE not in self.wrapped.DataLogger.__class__.__mro__:
    ...
    def create_viewable(self) -> '_1991.MBDAnalysisViewable':
