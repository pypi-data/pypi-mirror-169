...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5781, _5782, _5788
...
class FaceGearSetHarmonicAnalysisOfSingleExcitation(_5788.GearSetHarmonicAnalysisOfSingleExcitation):
    '''FaceGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def face_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_5781.FaceGearHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsHarmonicAnalysisOfSingleExcitation, constructor.new(_5781.FaceGearHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def face_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_5782.FaceGearMeshHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesHarmonicAnalysisOfSingleExcitation, constructor.new(_5782.FaceGearMeshHarmonicAnalysisOfSingleExcitation))
        return value
