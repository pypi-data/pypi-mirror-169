...
class ModalAnalysisForHarmonicAnalysis(_2378.ModalAnalysis):
    '''ModalAnalysisForHarmonicAnalysis
    ...
    @property
    def harmonic_analysis_settings(self) -> '_5490.HarmonicAnalysisOptions':
        ...
        if _5490.HarmonicAnalysisOptions.TYPE not in self.wrapped.HarmonicAnalysisSettings.__class__.__mro__:
