...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5790, _5735
...
class RootAssemblyHarmonicAnalysisOfSingleExcitation(_5735.AssemblyHarmonicAnalysisOfSingleExcitation):
    '''RootAssemblyHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def harmonic_analysis_of_single_excitation_inputs(self) -> '_5790.HarmonicAnalysisOfSingleExcitation':
        ...
        return constructor.new(_5790.HarmonicAnalysisOfSingleExcitation)(self.wrapped.HarmonicAnalysisOfSingleExcitationInputs) if self.wrapped.HarmonicAnalysisOfSingleExcitationInputs is not None else None
