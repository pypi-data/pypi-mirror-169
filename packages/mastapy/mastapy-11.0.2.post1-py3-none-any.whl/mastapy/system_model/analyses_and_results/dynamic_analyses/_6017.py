...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _2303, _5929
...
class RootAssemblyDynamicAnalysis(_5929.AssemblyDynamicAnalysis):
    '''RootAssemblyDynamicAnalysis
    ...
    @property
    def dynamic_analysis_inputs(self) -> '_2303.DynamicAnalysis':
        ...
        if _2303.DynamicAnalysis.TYPE not in self.wrapped.DynamicAnalysisInputs.__class__.__mro__:
