...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6022, _6023, _5940
...
class SpiralBevelGearSetDynamicAnalysis(_5940.BevelGearSetDynamicAnalysis):
    '''SpiralBevelGearSetDynamicAnalysis
    ...
    @property
    def spiral_bevel_gears_dynamic_analysis(self) -> 'List[_6022.SpiralBevelGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsDynamicAnalysis, constructor.new(_6022.SpiralBevelGearDynamicAnalysis))
        return value

    @property
    def spiral_bevel_meshes_dynamic_analysis(self) -> 'List[_6023.SpiralBevelGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesDynamicAnalysis, constructor.new(_6023.SpiralBevelGearMeshDynamicAnalysis))
        return value
