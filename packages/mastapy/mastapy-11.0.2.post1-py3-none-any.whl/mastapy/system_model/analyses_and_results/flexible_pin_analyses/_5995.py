...
from mastapy.system_model.analyses_and_results.flexible_pin_analyses import _5987
...
class WindTurbineCertificationReport(_5987.CombinationAnalysis):
    '''WindTurbineCertificationReport
    ...
    @property
    def design(self) -> '_2218.RootAssembly':
        ...
        return constructor.new(_2218.RootAssembly)(self.wrapped.Design) if self.wrapped.Design is not None else None

    @property
    def ldd_static_analysis(self) -> '_2684.RootAssemblyCompoundSystemDeflection':
        ...
        return constructor.new(_2684.RootAssemblyCompoundSystemDeflection)(self.wrapped.LDDStaticAnalysis) if self.wrapped.LDDStaticAnalysis is not None else None

    @property
    def nominal_load_case_static_analysis(self) -> '_2538.RootAssemblySystemDeflection':
        ...
        return constructor.new(_2538.RootAssemblySystemDeflection)(self.wrapped.NominalLoadCaseStaticAnalysis) if self.wrapped.NominalLoadCaseStaticAnalysis is not None else None

    @property
    def extreme_load_case_static_analysis(self) -> '_2538.RootAssemblySystemDeflection':
        ...
        return constructor.new(_2538.RootAssemblySystemDeflection)(self.wrapped.ExtremeLoadCaseStaticAnalysis) if self.wrapped.ExtremeLoadCaseStaticAnalysis is not None else None
