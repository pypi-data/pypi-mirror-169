...
class SteadyStateSynchronousResponse(_7182.CompoundAnalysisCase):
    '''SteadyStateSynchronousResponse
    ...
    @property
    def steady_state_analysis_options(self) -> '_3277.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_3277.SteadyStateSynchronousResponseOptions)(self.wrapped.SteadyStateAnalysisOptions) if self.wrapped.SteadyStateAnalysisOptions else None
