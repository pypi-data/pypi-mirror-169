...
class ConnectionSteadyStateSynchronousResponse(_7186.ConnectionStaticLoadAnalysisCase):
    '''ConnectionSteadyStateSynchronousResponse
    ...
    @property
    def steady_state_synchronous_response(self) -> '_3275.SteadyStateSynchronousResponse':
        ...
        return constructor.new(_3275.SteadyStateSynchronousResponse)(self.wrapped.SteadyStateSynchronousResponse) if self.wrapped.SteadyStateSynchronousResponse else None
