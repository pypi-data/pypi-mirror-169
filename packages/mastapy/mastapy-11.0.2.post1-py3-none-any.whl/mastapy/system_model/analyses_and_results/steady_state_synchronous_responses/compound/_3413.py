...
class StraightBevelPlanetGearCompoundSteadyStateSynchronousResponse(_3407.StraightBevelDiffGearCompoundSteadyStateSynchronousResponse):
    '''StraightBevelPlanetGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3284.StraightBevelPlanetGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3284.StraightBevelPlanetGearSteadyStateSynchronousResponse))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3284.StraightBevelPlanetGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3284.StraightBevelPlanetGearSteadyStateSynchronousResponse))
        return value
