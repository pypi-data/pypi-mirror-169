...
class CriticalSpeedAnalysis(_7270.StaticLoadAnalysisCase):
    '''CriticalSpeedAnalysis
    ...
    @property
    def critical_speed_analysis_options(self) -> '_6302.CriticalSpeedAnalysisOptions':
        ...
        return constructor.new(_6302.CriticalSpeedAnalysisOptions)(self.wrapped.CriticalSpeedAnalysisOptions) if self.wrapped.CriticalSpeedAnalysisOptions is not None else None
