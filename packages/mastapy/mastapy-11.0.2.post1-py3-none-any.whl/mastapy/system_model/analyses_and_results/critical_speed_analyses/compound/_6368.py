...
class CylindricalPlanetGearCompoundCriticalSpeedAnalysis(_6365.CylindricalGearCompoundCriticalSpeedAnalysis):
    '''CylindricalPlanetGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6239.CylindricalPlanetGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6239.CylindricalPlanetGearCriticalSpeedAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6239.CylindricalPlanetGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6239.CylindricalPlanetGearCriticalSpeedAnalysis))
        return value
