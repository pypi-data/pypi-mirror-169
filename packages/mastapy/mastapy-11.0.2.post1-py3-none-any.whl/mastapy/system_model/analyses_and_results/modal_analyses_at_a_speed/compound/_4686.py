...
class HypoidGearCompoundModalAnalysisAtASpeed(_4628.AGMAGleasonConicalGearCompoundModalAnalysisAtASpeed):
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4558.HypoidGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4558.HypoidGearModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4558.HypoidGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4558.HypoidGearModalAnalysisAtASpeed))
        return value
