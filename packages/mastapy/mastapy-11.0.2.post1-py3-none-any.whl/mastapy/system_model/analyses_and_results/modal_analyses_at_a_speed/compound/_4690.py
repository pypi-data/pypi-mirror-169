...
class KlingelnbergCycloPalloidConicalGearCompoundModalAnalysisAtASpeed(_4656.ConicalGearCompoundModalAnalysisAtASpeed):
    '''KlingelnbergCycloPalloidConicalGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4562.KlingelnbergCycloPalloidConicalGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4562.KlingelnbergCycloPalloidConicalGearModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4562.KlingelnbergCycloPalloidConicalGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4562.KlingelnbergCycloPalloidConicalGearModalAnalysisAtASpeed))
        return value
