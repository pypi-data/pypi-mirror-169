...
from mastapy.system_model.analyses_and_results.power_flows import _3814, _3799
...
class SynchroniserPowerFlow(_3799.SpecialisedAssemblyPowerFlow):
    '''SynchroniserPowerFlow
    ...
    @property
    def cones(self) -> 'List[_3814.SynchroniserHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_3814.SynchroniserHalfPowerFlow))
        return value
