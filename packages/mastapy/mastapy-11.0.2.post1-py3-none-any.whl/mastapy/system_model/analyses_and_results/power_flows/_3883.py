...
from mastapy.system_model.analyses_and_results.power_flows import _3881, _3866
...
class SynchroniserPowerFlow(_3866.SpecialisedAssemblyPowerFlow):
    '''SynchroniserPowerFlow
    ...
    @property
    def cones(self) -> 'List[_3881.SynchroniserHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_3881.SynchroniserHalfPowerFlow))
        return value
