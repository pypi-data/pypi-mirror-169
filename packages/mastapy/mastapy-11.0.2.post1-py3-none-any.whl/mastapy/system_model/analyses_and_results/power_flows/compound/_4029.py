...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4027, _4028, _3919
...
class ZerolBevelGearSetCompoundPowerFlow(_3919.BevelGearSetCompoundPowerFlow):
    '''ZerolBevelGearSetCompoundPowerFlow
    ...
    @property
    def zerol_bevel_gears_compound_power_flow(self) -> 'List[_4027.ZerolBevelGearCompoundPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsCompoundPowerFlow, constructor.new(_4027.ZerolBevelGearCompoundPowerFlow))
        return value

    @property
    def zerol_bevel_meshes_compound_power_flow(self) -> 'List[_4028.ZerolBevelGearMeshCompoundPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesCompoundPowerFlow, constructor.new(_4028.ZerolBevelGearMeshCompoundPowerFlow))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3900.ZerolBevelGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3900.ZerolBevelGearSetPowerFlow))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3900.ZerolBevelGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3900.ZerolBevelGearSetPowerFlow))
        return value
