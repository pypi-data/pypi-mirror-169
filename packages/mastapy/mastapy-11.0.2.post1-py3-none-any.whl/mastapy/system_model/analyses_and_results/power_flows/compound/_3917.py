...
class PointLoadCompoundPowerFlow(_3953.VirtualComponentCompoundPowerFlow):
    '''PointLoadCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3785.PointLoadPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3785.PointLoadPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3785.PointLoadPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3785.PointLoadPowerFlow))
        return value
