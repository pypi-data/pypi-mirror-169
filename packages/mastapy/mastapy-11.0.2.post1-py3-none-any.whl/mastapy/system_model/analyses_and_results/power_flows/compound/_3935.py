...
class SpringDamperHalfCompoundPowerFlow(_3870.CouplingHalfCompoundPowerFlow):
    '''SpringDamperHalfCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3804.SpringDamperHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3804.SpringDamperHalfPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3804.SpringDamperHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3804.SpringDamperHalfPowerFlow))
        return value
