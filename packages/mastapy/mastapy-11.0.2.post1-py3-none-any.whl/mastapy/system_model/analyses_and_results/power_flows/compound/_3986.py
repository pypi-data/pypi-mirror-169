...
class PulleyCompoundPowerFlow(_3937.CouplingHalfCompoundPowerFlow):
    '''PulleyCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3856.PulleyPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3856.PulleyPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3856.PulleyPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3856.PulleyPowerFlow))
        return value
