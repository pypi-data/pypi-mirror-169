...
class PlanetaryGearSetCompoundModalAnalysisAtAStiffness(_4415.CylindricalGearSetCompoundModalAnalysisAtAStiffness):
    '''PlanetaryGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4321.PlanetaryGearSetModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4321.PlanetaryGearSetModalAnalysisAtAStiffness))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4321.PlanetaryGearSetModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4321.PlanetaryGearSetModalAnalysisAtAStiffness))
        return value
