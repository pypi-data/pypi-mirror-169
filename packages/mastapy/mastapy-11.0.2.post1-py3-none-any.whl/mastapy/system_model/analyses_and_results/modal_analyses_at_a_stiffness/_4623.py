...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _2380
...
class ConnectionModalAnalysisAtAStiffness(_7261.ConnectionStaticLoadAnalysisCase):
    '''ConnectionModalAnalysisAtAStiffness
    ...
    @property
    def modal_analysis_at_a_stiffness(self) -> '_2380.ModalAnalysisAtAStiffness':
        ...
        return constructor.new(_2380.ModalAnalysisAtAStiffness)(self.wrapped.ModalAnalysisAtAStiffness) if self.wrapped.ModalAnalysisAtAStiffness is not None else None
