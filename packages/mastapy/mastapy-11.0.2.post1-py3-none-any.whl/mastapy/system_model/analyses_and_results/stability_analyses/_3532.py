...
from mastapy.system_model.analyses_and_results.stability_analyses import _3533, _3531, _3448
...
class SpiralBevelGearSetStabilityAnalysis(_3448.BevelGearSetStabilityAnalysis):
    '''SpiralBevelGearSetStabilityAnalysis
    ...
    @property
    def spiral_bevel_gears_stability_analysis(self) -> 'List[_3533.SpiralBevelGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsStabilityAnalysis, constructor.new(_3533.SpiralBevelGearStabilityAnalysis))
        return value

    @property
    def spiral_bevel_meshes_stability_analysis(self) -> 'List[_3531.SpiralBevelGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesStabilityAnalysis, constructor.new(_3531.SpiralBevelGearMeshStabilityAnalysis))
        return value
