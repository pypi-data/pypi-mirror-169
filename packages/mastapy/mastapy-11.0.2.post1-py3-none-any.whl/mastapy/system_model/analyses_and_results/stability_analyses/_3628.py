...
from mastapy.system_model.analyses_and_results.stability_analyses import _3629, _3627, _3515
...
class ZerolBevelGearSetStabilityAnalysis(_3515.BevelGearSetStabilityAnalysis):
    '''ZerolBevelGearSetStabilityAnalysis
    ...
    @property
    def zerol_bevel_gears_stability_analysis(self) -> 'List[_3629.ZerolBevelGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsStabilityAnalysis, constructor.new(_3629.ZerolBevelGearStabilityAnalysis))
        return value

    @property
    def zerol_bevel_meshes_stability_analysis(self) -> 'List[_3627.ZerolBevelGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesStabilityAnalysis, constructor.new(_3627.ZerolBevelGearMeshStabilityAnalysis))
        return value
