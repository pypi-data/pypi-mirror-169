...
from mastapy.system_model.analyses_and_results.stability_analyses import _3471, _3433
...
class ShaftStabilityAnalysis(_3433.AbstractShaftStabilityAnalysis):
    '''ShaftStabilityAnalysis
    ...
    @property
    def critical_speeds(self) -> 'List[_3471.CriticalSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CriticalSpeeds, constructor.new(_3471.CriticalSpeed))
        return value
