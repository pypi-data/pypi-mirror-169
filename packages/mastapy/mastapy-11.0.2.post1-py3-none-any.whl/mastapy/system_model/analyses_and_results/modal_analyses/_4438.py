...
TMeasurement = TypeVar('TMeasurement', bound='_1401.MeasurementBase')


class WhineWaterfallReferenceValues(_4439.WhineWaterfallReferenceValuesBase, Generic[TMeasurement]):
    '''WhineWaterfallReferenceValues
