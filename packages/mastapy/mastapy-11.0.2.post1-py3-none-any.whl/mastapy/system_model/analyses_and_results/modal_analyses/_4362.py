...
from mastapy.system_model.analyses_and_results.modal_analyses import _4361, _4360, _4368
...
class FaceGearSetModalAnalysis(_4368.GearSetModalAnalysis):
    '''FaceGearSetModalAnalysis
    ...
    @property
    def face_gears_modal_analysis(self) -> 'List[_4361.FaceGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsModalAnalysis, constructor.new(_4361.FaceGearModalAnalysis))
        return value

    @property
    def face_meshes_modal_analysis(self) -> 'List[_4360.FaceGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesModalAnalysis, constructor.new(_4360.FaceGearMeshModalAnalysis))
        return value
