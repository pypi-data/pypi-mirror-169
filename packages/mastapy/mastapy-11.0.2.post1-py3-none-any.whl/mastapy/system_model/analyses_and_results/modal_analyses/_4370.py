...
class HypoidGearMeshModalAnalysis(_4310.AGMAGleasonConicalGearMeshModalAnalysis):
    '''HypoidGearMeshModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2501.HypoidGearMeshSystemDeflection':
        ...
        return constructor.new(_2501.HypoidGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
