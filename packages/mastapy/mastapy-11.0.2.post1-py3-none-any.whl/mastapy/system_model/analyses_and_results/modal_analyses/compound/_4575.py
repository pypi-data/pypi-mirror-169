...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4574
...
class SynchroniserSleeveCompoundModalAnalysis(_4574.SynchroniserPartCompoundModalAnalysis):
    '''SynchroniserSleeveCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4429.SynchroniserSleeveModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4429.SynchroniserSleeveModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4429.SynchroniserSleeveModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4429.SynchroniserSleeveModalAnalysis))
        return value
