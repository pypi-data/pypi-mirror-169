...
from mastapy.system_model.analyses_and_results.modal_analyses import _4442
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4517
...
class WormGearCompoundModalAnalysis(_4517.GearCompoundModalAnalysis):
    '''WormGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4442.WormGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4442.WormGearModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4442.WormGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4442.WormGearModalAnalysis))
        return value
