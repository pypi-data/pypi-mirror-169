...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4582, _4583, _4519
from mastapy.system_model.analyses_and_results.modal_analyses import _4443
...
class WormGearSetCompoundModalAnalysis(_4519.GearSetCompoundModalAnalysis):
    '''WormGearSetCompoundModalAnalysis
    ...
    @property
    def worm_gears_compound_modal_analysis(self) -> 'List[_4582.WormGearCompoundModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsCompoundModalAnalysis, constructor.new(_4582.WormGearCompoundModalAnalysis))
        return value

    @property
    def worm_meshes_compound_modal_analysis(self) -> 'List[_4583.WormGearMeshCompoundModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesCompoundModalAnalysis, constructor.new(_4583.WormGearMeshCompoundModalAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4443.WormGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4443.WormGearSetModalAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4443.WormGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4443.WormGearSetModalAnalysis))
        return value
