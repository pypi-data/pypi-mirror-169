...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4463
...
class HypoidGearCompoundModalAnalysis(_4463.AGMAGleasonConicalGearCompoundModalAnalysis):
    '''HypoidGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4371.HypoidGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4371.HypoidGearModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4371.HypoidGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4371.HypoidGearModalAnalysis))
        return value
