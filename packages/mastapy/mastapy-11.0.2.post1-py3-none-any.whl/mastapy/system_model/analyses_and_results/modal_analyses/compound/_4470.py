...
class BevelDifferentialGearCompoundModalAnalysis(_4475.BevelGearCompoundModalAnalysis):
    '''BevelDifferentialGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4318.BevelDifferentialGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4318.BevelDifferentialGearModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4318.BevelDifferentialGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4318.BevelDifferentialGearModalAnalysis))
        return value
