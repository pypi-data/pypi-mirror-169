...
class CouplingHalfCompoundModalAnalysis(_4536.MountableComponentCompoundModalAnalysis):
    '''CouplingHalfCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4345.CouplingHalfModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4345.CouplingHalfModalAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4345.CouplingHalfModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4345.CouplingHalfModalAnalysis))
        return value
