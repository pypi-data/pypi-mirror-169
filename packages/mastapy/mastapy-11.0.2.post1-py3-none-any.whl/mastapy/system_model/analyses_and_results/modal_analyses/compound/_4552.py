...
class RollingRingConnectionCompoundModalAnalysis(_4524.InterMountableComponentConnectionCompoundModalAnalysis):
    '''RollingRingConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4404.RollingRingConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4404.RollingRingConnectionModalAnalysis))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4404.RollingRingConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4404.RollingRingConnectionModalAnalysis))
        return value
