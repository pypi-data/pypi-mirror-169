...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4972, _4969, _4971
...
class PartModalAnalysis(_7265.PartStaticLoadAnalysisCase):
    '''PartModalAnalysis
    ...
    @property
    def results_for_modes(self) -> 'List[_4972.SingleModeResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResultsForModes, constructor.new(_4972.SingleModeResults))
        return value

    @property
    def shaft_excitation_details(self) -> 'List[_4969.RigidlyConnectedDesignEntityGroupModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftExcitationDetails, constructor.new(_4969.RigidlyConnectedDesignEntityGroupModalAnalysis))
        return value

    @property
    def gear_mesh_excitation_details(self) -> 'List[_4969.RigidlyConnectedDesignEntityGroupModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshExcitationDetails, constructor.new(_4969.RigidlyConnectedDesignEntityGroupModalAnalysis))
        return value
    ...
    def create_viewable(self) -> '_1992.ModalAnalysisViewable':
