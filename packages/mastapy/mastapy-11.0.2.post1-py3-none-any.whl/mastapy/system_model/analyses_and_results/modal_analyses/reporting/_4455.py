...
from mastapy.utility.modal_analysis import _1570
...
class RigidlyConnectedDesignEntityGroupModalAnalysis(_2395.DesignEntityGroupAnalysis):
    '''RigidlyConnectedDesignEntityGroupModalAnalysis
    ...
    @property
    def excitation_frequencies_at_reference_speed(self) -> 'List[_1570.DesignEntityExcitationDescription]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcitationFrequenciesAtReferenceSpeed, constructor.new(_1570.DesignEntityExcitationDescription))
        return value
