...
class FaceGearMesh(_2055.GearMesh):
    '''FaceGearMesh
    ...
    @property
    def face_gear_mesh_design(self) -> '_948.FaceGearMeshDesign':
        ...
        return constructor.new(_948.FaceGearMeshDesign)(self.wrapped.FaceGearMeshDesign) if self.wrapped.FaceGearMeshDesign is not None else None
