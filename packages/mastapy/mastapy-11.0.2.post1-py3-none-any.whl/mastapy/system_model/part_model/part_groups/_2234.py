...
from mastapy.system_model.part_model.part_groups import _2231, _2233, _2230
...
class ParallelPartGroup(_2230.ConcentricOrParallelPartGroup):
    '''ParallelPartGroup
    ...
    @property
    def concentric_part_groups(self) -> 'List[_2231.ConcentricPartGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConcentricPartGroups, constructor.new(_2231.ConcentricPartGroup))
        return value

    @property
    def design_measurements(self) -> 'List[_2233.DesignMeasurements]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignMeasurements, constructor.new(_2233.DesignMeasurements))
        return value
