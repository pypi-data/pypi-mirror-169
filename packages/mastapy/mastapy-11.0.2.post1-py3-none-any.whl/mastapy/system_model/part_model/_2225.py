...
class WindTurbineSingleBladeDetails(_0.APIBase):
    ...
    @property
    def edgewise_modes(self) -> '_2224.WindTurbineBladeModeDetails':
        ...
        return constructor.new(_2224.WindTurbineBladeModeDetails)(self.wrapped.EdgewiseModes) if self.wrapped.EdgewiseModes is not None else None

    @property
    def flapwise_modes(self) -> '_2224.WindTurbineBladeModeDetails':
        ...
        return constructor.new(_2224.WindTurbineBladeModeDetails)(self.wrapped.FlapwiseModes) if self.wrapped.FlapwiseModes is not None else None
