...
class Shaft(_2181.AbstractShaft):
    '''Shaft
    ...
    @property
    def guide_image(self) -> '_2200.GuideImage':
        ...
        return constructor.new(_2200.GuideImage)(self.wrapped.GuideImage) if self.wrapped.GuideImage is not None else None
    ...
    @property
    def fe_substructure_replacing_this(self) -> '_2127.FESubstructure':
        ...
        return constructor.new(_2127.FESubstructure)(self.wrapped.FESubstructureReplacingThis) if self.wrapped.FESubstructureReplacingThis is not None else None
    ...
    def mount_component(self, component: '_2208.MountableComponent', offset: 'float'):
