...
from mastapy.cycloidal import _1257, _1258, _1264
from mastapy.system_model.part_model import _2205, _2181
from mastapy.materials import _240, _218
...
from mastapy.detailed_rigid_connectors.splines import _1219
from mastapy.bolts import _1267, _1271
from mastapy.system_model.connections_and_sockets.cycloidal import _2084
...
class CycloidalDisc(_2181.AbstractShaft):
    '''CycloidalDisc
    ...
    @property
    def cycloidal_disc_design(self) -> '_1257.CycloidalDiscDesign':
        ...
        return constructor.new(_1257.CycloidalDiscDesign)(self.wrapped.CycloidalDiscDesign) if self.wrapped.CycloidalDiscDesign is not None else None

    @property
    def load_sharing_settings(self) -> '_2205.LoadSharingSettings':
        ...
        return constructor.new(_2205.LoadSharingSettings)(self.wrapped.LoadSharingSettings) if self.wrapped.LoadSharingSettings is not None else None

    @property
    def disc_material(self) -> '_240.Material':
        ...
        if _240.Material.TYPE not in self.wrapped.DiscMaterial.__class__.__mro__:
    ...
    @property
    def planetary_bearing_sockets(self) -> 'List[_2084.CycloidalDiscPlanetaryBearingSocket]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetaryBearingSockets, constructor.new(_2084.CycloidalDiscPlanetaryBearingSocket))
        return value
