...
class BevelGear(_2253.AGMAGleasonConicalGear):
    '''BevelGear
    ...
    @property
    def conical_gear_design(self) -> '_1127.BevelGearDesign':
        ...
        if _1127.BevelGearDesign.TYPE not in self.wrapped.ConicalGearDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_design_of_type_zerol_bevel_gear_design(self) -> '_909.ZerolBevelGearDesign':
        ...
        if _909.ZerolBevelGearDesign.TYPE not in self.wrapped.ConicalGearDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_design_of_type_straight_bevel_diff_gear_design(self) -> '_918.StraightBevelDiffGearDesign':
        ...
        if _918.StraightBevelDiffGearDesign.TYPE not in self.wrapped.ConicalGearDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_design_of_type_straight_bevel_gear_design(self) -> '_922.StraightBevelGearDesign':
        ...
        if _922.StraightBevelGearDesign.TYPE not in self.wrapped.ConicalGearDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_design_of_type_spiral_bevel_gear_design(self) -> '_926.SpiralBevelGearDesign':
        ...
        if _926.SpiralBevelGearDesign.TYPE not in self.wrapped.ConicalGearDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_design(self) -> '_1127.BevelGearDesign':
        ...
        if _1127.BevelGearDesign.TYPE not in self.wrapped.BevelGearDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_design_of_type_zerol_bevel_gear_design(self) -> '_909.ZerolBevelGearDesign':
        ...
        if _909.ZerolBevelGearDesign.TYPE not in self.wrapped.BevelGearDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_design_of_type_straight_bevel_diff_gear_design(self) -> '_918.StraightBevelDiffGearDesign':
        ...
        if _918.StraightBevelDiffGearDesign.TYPE not in self.wrapped.BevelGearDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_design_of_type_straight_bevel_gear_design(self) -> '_922.StraightBevelGearDesign':
        ...
        if _922.StraightBevelGearDesign.TYPE not in self.wrapped.BevelGearDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_design_of_type_spiral_bevel_gear_design(self) -> '_926.SpiralBevelGearDesign':
        ...
        if _926.SpiralBevelGearDesign.TYPE not in self.wrapped.BevelGearDesign.__class__.__mro__:
