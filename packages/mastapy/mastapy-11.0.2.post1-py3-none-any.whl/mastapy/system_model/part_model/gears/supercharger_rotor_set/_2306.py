...
class SuperchargerRotorSet(_1600.NamedDatabaseItem):
    '''SuperchargerRotorSet
    ...
    @property
    def y_variable_for_imported_data(self) -> '_2308.YVariableForImportedData':
        ...
        return constructor.new(_2308.YVariableForImportedData)(value) if value is not None else None

    @y_variable_for_imported_data.setter
    def y_variable_for_imported_data(self, value: '_2308.YVariableForImportedData'):
    ...
    @property
    def supercharger_map_chart(self) -> '_1627.ThreeDChartDefinition':
        ...
        return constructor.new(_1627.ThreeDChartDefinition)(self.wrapped.SuperchargerMapChart) if self.wrapped.SuperchargerMapChart is not None else None

    @property
    def file(self) -> '_2301.RotorSetDataInputFileOptions':
        ...
        return constructor.new(_2301.RotorSetDataInputFileOptions)(self.wrapped.File) if self.wrapped.File is not None else None

    @property
    def rotor_speed(self) -> '_2303.RotorSpeedInputOptions':
        ...
        return constructor.new(_2303.RotorSpeedInputOptions)(self.wrapped.RotorSpeed) if self.wrapped.RotorSpeed is not None else None

    @property
    def boost_pressure(self) -> '_2298.BoostPressureInputOptions':
        ...
        return constructor.new(_2298.BoostPressureInputOptions)(self.wrapped.BoostPressure) if self.wrapped.BoostPressure is not None else None

    @property
    def pressure_ratio(self) -> '_2300.PressureRatioInputOptions':
        ...
        return constructor.new(_2300.PressureRatioInputOptions)(self.wrapped.PressureRatio) if self.wrapped.PressureRatio is not None else None

    @property
    def input_power(self) -> '_2299.InputPowerInputOptions':
        ...
        return constructor.new(_2299.InputPowerInputOptions)(self.wrapped.InputPower) if self.wrapped.InputPower is not None else None

    @property
    def measured_points(self) -> 'List[_2302.RotorSetMeasuredPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeasuredPoints, constructor.new(_2302.RotorSetMeasuredPoint))
        return value
