...
from mastapy.bearings.bearing_designs.concept import _1946, _1948
...
class ConceptAxialClearanceBearing(_1948.ConceptClearanceBearing):
    '''ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self) -> '_1946.BearingNodePosition':
        ...
        return constructor.new(_1946.BearingNodePosition)(value) if value is not None else None

    @node_position.setter
    def node_position(self, value: '_1946.BearingNodePosition'):
