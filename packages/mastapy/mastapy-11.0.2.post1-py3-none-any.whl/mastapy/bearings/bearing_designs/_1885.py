...
class LinearBearing(_1882.BearingDesign):
    '''LinearBearing
    ...
    @property
    def stiffness_options(self) -> '_1642.BearingStiffnessMatrixOption':
        ...
        return constructor.new(_1642.BearingStiffnessMatrixOption)(value) if value is not None else None

    @stiffness_options.setter
    def stiffness_options(self, value: '_1642.BearingStiffnessMatrixOption'):
