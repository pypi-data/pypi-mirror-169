...
class LoadedNonBarrelRollerBearingRow(_1779.LoadedRollerBearingRow):
    '''LoadedNonBarrelRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1773.LoadedNonBarrelRollerBearingResults':
