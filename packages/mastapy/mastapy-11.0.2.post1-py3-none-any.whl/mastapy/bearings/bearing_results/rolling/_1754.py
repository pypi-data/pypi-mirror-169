...
from mastapy.bearings.bearing_results.rolling import _1753, _1701
...
class LoadedThrustBallBearingRow(_1701.LoadedBallBearingRow):
    '''LoadedThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1753.LoadedThrustBallBearingResults':
        ...
        return constructor.new(_1753.LoadedThrustBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
