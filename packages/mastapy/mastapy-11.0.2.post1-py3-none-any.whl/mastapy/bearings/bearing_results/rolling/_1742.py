...
from mastapy.bearings.bearing_results.rolling import _1741, _1728
...
class LoadedSphericalRollerThrustBearingRow(_1728.LoadedRollerBearingRow):
    '''LoadedSphericalRollerThrustBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1741.LoadedSphericalRollerThrustBearingResults':
        ...
        return constructor.new(_1741.LoadedSphericalRollerThrustBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
