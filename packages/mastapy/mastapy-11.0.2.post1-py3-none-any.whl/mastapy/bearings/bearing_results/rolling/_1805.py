...
from mastapy.bearings.bearing_results.rolling import _1804, _1752
...
class LoadedThrustBallBearingRow(_1752.LoadedBallBearingRow):
    '''LoadedThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1804.LoadedThrustBallBearingResults':
        ...
        return constructor.new(_1804.LoadedThrustBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
