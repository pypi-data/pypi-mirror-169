...
from mastapy.bearings.bearing_results.rolling import _1750, _1701
...
class LoadedThreePointContactBallBearingRow(_1701.LoadedBallBearingRow):
    '''LoadedThreePointContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1750.LoadedThreePointContactBallBearingResults':
        ...
        return constructor.new(_1750.LoadedThreePointContactBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
