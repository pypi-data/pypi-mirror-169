...
from mastapy.bearings.bearing_results.rolling import _1756, _1728
...
class LoadedToroidalRollerBearingRow(_1728.LoadedRollerBearingRow):
    '''LoadedToroidalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1756.LoadedToroidalRollerBearingResults':
        ...
        return constructor.new(_1756.LoadedToroidalRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
