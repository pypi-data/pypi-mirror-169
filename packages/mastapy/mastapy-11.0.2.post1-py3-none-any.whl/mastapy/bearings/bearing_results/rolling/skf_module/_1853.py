...
from mastapy.bearings.bearing_results.rolling.skf_module import _1845, _1849
...
class Viscosities(_1849.SKFCalculationResult):
    '''Viscosities
    ...
    @property
    def operating_viscosity(self) -> '_1845.OperatingViscosity':
        ...
        return constructor.new(_1845.OperatingViscosity)(self.wrapped.OperatingViscosity) if self.wrapped.OperatingViscosity is not None else None
