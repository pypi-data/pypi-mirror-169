...
from roomdata_window import Ui_MainWindow
from add_rule_window_main import AddRuleMainWindow
...
class RoomdataMainWindow(QMainWindow):
    ...
    def init_vars(self):
        ...
        self.ui.time_combo_box.addItems([f'{i}月' for i in range(1, 13)])
        self.ui.time_combo_box.setCurrentIndex(0)
    ...
    def generate_csv(self):
        ...
        for index, sheet in enumerate(sheets):
            ...
            for row in range(2, num_row + 1):
                ...
                selected_month = self.ui.time_combo_box.currentIndex() + 1
                if submit_date.month != selected_month:
