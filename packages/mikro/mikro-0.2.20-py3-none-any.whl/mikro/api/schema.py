from typing import Optional, Dict, Iterator, List, AsyncIterator, Literal
...
class From_xarrayMutation(BaseModel):
    ...
    class Meta:
        document = "fragment Representation on Representation {\n  sample {\n    id\n    name\n  }\n  type\n  id\n  store\n  variety\n  name\n  omero {\n    scale\n    physicalSize {\n      x\n      y\n      z\n      t\n      c\n    }\n  }\n  origins {\n    id\n    store\n    variety\n  }\n}\n\nmutation from_xarray($xarray: XArray!, $name: String, $variety: RepresentationVarietyInput, $origins: [ID], $fileOrigins: [ID], $roiOrigins: [ID], $tags: [String], $sample: ID, $omero: OmeroRepresentationInput) {\n  fromXArray(\n    xarray: $xarray\n    name: $name\n    origins: $origins\n    tags: $tags\n    sample: $sample\n    omero: $omero\n    fileOrigins: $fileOrigins\n    roiOrigins: $roiOrigins\n    variety: $variety\n  ) {\n    ...Representation\n  }\n}"
...
async def afrom_xarray(
    ...
    Arguments:
        ...
        file_origins (Optional[List[Optional[ID]]], optional): fileOrigins.
        roi_origins (Optional[List[Optional[ID]]], optional): roiOrigins.
