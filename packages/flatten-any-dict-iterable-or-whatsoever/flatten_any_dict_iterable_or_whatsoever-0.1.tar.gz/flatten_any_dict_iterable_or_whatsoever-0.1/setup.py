...
with codecs.open(r"C:\Users\Gamer\anaconda3\envs\dfdir\_tmp_PyGitUpload_000015\README.md", encoding="utf-8") as fh:
    long_description = "\n" + fh.read()
...
setup(
    ...
    #packages=[],
    keywords=['iter', 'nested', 'iterable', 'flatten', 'lists of lists', 'flatten json'],
