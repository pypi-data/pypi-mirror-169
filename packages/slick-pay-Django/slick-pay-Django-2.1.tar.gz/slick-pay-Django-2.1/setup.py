...
setup(
    name="slick-pay-Django",  # Required
    version="2.1",  # Required
    description="slick-pay Gateway (Django Library)",  # Optional
    long_description=long_description,  # Optional
    long_description_content_type="text/markdown",  # Optional (see note above)
    #url="https://github.com/Chargily/chargily-epay-django",  # Optional
    author="Slickpay",  # Optional
    ...
    keywords="e-pay, slickpay, edahabia, cib, django",  # Optional
    package_dir={"": "src"},  # Optional
    packages=find_packages(where="src"),  # Required
    python_requires=">=3.7",
    #install_requires=["slick-pay-python"],  # Optional
