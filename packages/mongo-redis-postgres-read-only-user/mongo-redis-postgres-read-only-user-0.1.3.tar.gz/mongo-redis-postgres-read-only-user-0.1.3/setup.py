...
packages = \
['mongo_redis_postgres_read_only_user']

package_data = \
{'': ['*']}

install_requires = \
['psycopg2==2.9.3', 'pymongo==4.2.0', 'redis==4.3.4', 'typer==0.6.1']

entry_points = \
{'console_scripts': ['create-read-user = '
                     'mongo_redis_postgres_read_only_user.main:app']}

setup_kwargs = {
    'name': 'mongo-redis-postgres-read-only-user',
    'version': '0.1.3',
    'description': '',
