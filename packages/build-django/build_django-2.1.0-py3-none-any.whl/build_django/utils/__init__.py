...
async def install_package(pip_path: str, package: str, *args: Iterable[str]) -> Process:
...
async def install_packages(pip_path: str, packages: Iterable[str], *args: Iterable[str]) -> list[Process]:
    added = set()
