...
import xarray as xr
import sys
from soda.utils.othertime import DaysSince
...
def load_LISST_info(workDir):
    ...
    lisst_device_file = os.path.join(workDir,'instrumentation','device_files',\
                                     'LISST','LISST_OutputInfo.csv')
    lisst_sizebins = os.path.join(workDir, 'instrumentation','device_files',\
                                  'LISST','LISST_Sediment_SizeBins.csv')
