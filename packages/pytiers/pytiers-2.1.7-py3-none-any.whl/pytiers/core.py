...
class Tier(object):
    ...
    def interpolate_points(self, by_target, by, step=.01, strict=True):
        ...
        interpolated_points = [Point(time, value, superior_Tier=self) for time, value in zip(interpolated_point_times, [point1.time, point2.time], [point1.value, point2.value])]
        
        self.add_points(interpolated_points, _by.POINT)
