...
from web3_eth._utils.request import (
...
from web3_eth._utils.utility_methods import (
    any_in_dict,
)
from web3_eth.constants import (
...
if TYPE_CHECKING:
    ...
    from web3_eth.eth import AsyncEth  # noqa: F401
