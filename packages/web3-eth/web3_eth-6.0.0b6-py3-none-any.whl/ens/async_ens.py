...
if TYPE_CHECKING:
    ...
    from web3_eth.contract import (  # noqa: F401
        AsyncContract,
    )
...
class AsyncENS(BaseENS):
    ...
    def __init__(
        ...
        :type provider: instance of `web3_eth.providers.base.BaseProvider`
    ...
    def fromWeb3(cls, w3: "Web3", addr: ChecksumAddress = None) -> "AsyncENS":
        """
        Generate an AsyncENS instance with web3_eth
    ...
    async def setup_address(
        ...
        :param dict transact: the transaction configuration, like in
            :meth:`~web3_eth.eth.Eth.send_transaction`
        :raises InvalidName: if ``name`` has invalid syntax
    ...
    async def setup_name(
        ...
        :param dict transact: the transaction configuration, like in
            :meth:`~web3_eth.eth.send_transaction`
