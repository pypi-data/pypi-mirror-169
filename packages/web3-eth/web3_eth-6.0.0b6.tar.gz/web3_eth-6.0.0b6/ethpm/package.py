...
from web3_eth._utils.validation import (
    validate_address,
)
...
class Package(object):
    ...
    def update_w3(self, w3: "Web3") -> "Package":
        ...
        but connected to a different web3_eth instance.
    ...
    def get_contract_factory(self, name: ContractName) -> LinkableContract:
        ...
        ``web3_eth.contract.Contract``, ``ethpm.contract.LinkableContract`` with a few extra
