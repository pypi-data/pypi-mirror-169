...
from web3_eth.middleware.buffered_gas_estimate import (
    async_buffered_gas_estimate_middleware,
)
from web3_eth.providers import (
    BaseProvider,
)
from web3_eth.providers.async_base import (
    AsyncBaseProvider,
)
...
class AsyncEthereumTesterProvider(AsyncBaseProvider):
    ...
    def __init__(self) -> None:
        ...
        from web3_eth.providers.eth_tester.defaults import API_ENDPOINTS
