...
from web3_eth._utils.method_formatters import (
    to_hex_if_integer,
)
from web3_eth._utils.module_testing.module_testing_utils import (
    assert_contains_log,
    async_mock_offchain_lookup_request_response,
    mine_pending_block,
    mock_offchain_lookup_request_response,
)
from web3_eth._utils.type_conversion import (
    to_hex_if_bytes,
)
...
from web3_eth.middleware.fixture import (
...
if TYPE_CHECKING:
    ...
    from web3_eth.contract import Contract  # noqa: F401
