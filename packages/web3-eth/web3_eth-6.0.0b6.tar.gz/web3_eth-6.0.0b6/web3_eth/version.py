...
class Version(Module):
    ...
    def api(self) -> NoReturn:
        raise DeprecationWarning(
            "This method has been deprecated ... Please use web3_eth.api instead."
        )

    @property
    def node(self) -> NoReturn:
        raise DeprecationWarning(
            "This method has been deprecated ... Please use web3_eth.clientVersion instead."
        )
    ...
    def ethereum(self) -> NoReturn:
        raise DeprecationWarning(
            ...
            "Please use web3_eth.eth.protocol_version instead."
        )
