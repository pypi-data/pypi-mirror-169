...
from web3_eth._utils.module import (
    attach_modules as _attach_modules,
)
from web3_eth._utils.normalizers import (
    abi_ens_resolver,
)
from web3_eth.eth import (
    Eth,
)
from web3_eth.geth import (
    Geth,
    GethAdmin,
    GethMiner,
    GethPersonal,
...
from web3_eth.manager import (
    RequestManager as DefaultRequestManager,
)
from web3_eth.module import (
    Module,
)
from web3_eth.net import (
    AsyncNet,
    Net,
)
from web3_eth.parity import (
    Parity,
    ParityPersonal,
)
from web3_eth.providers import (
    AsyncBaseProvider,
    BaseProvider,
)
from web3_eth.providers.eth_tester import (
    EthereumTesterProvider,
)
from web3_eth.providers.ipc import (
    IPCProvider,
)
from web3_eth.providers.async_rpc import (
    AsyncHTTPProvider,
)
from web3_eth.providers.rpc import (
    HTTPProvider,
)
from web3_eth.providers.websocket import (
    WebsocketProvider,
)
from web3_eth.testing import (
    Testing,
)
...
from web3_eth.version import (
    Version,
)

if TYPE_CHECKING:
    from web3_eth.pm import PM  # noqa: F401
    from web3_eth._utils.empty import Empty  # noqa: F401
...
class Web3:
    ...
    @property
    def api(self) -> str:
        from web3_eth import __version__
    ...
    def enable_unstable_package_management_api(self) -> None:
        from web3_eth.pm import PM  # noqa: F811
