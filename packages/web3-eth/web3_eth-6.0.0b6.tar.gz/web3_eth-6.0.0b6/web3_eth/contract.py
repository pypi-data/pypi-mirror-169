...
from web3_eth._utils.abi import (
    abi_to_signature,
...
from web3_eth._utils.async_transactions import (
    fill_transaction_defaults as async_fill_transaction_defaults,
)
from web3_eth._utils.blocks import (
    is_hex_encoded_block_hash,
)
from web3_eth._utils.contracts import (
    encode_abi,
...
from web3_eth._utils.datatypes import (
    PropertyCheckingFactory,
)
from web3_eth._utils.empty import (
    empty,
)
from web3_eth._utils.encoding import (
    to_4byte_hex,
    to_hex,
)
from web3_eth._utils.events import (
    EventFilterBuilder,
    get_event_data,
    is_dynamic_sized_type,
)
from web3_eth._utils.filters import (
    LogFilter,
    construct_event_filter_params,
)
from web3_eth._utils.function_identifiers import (
    FallbackFn,
    ReceiveFn,
)
from web3_eth._utils.normalizers import (
...
from web3_eth._utils.transactions import (
    fill_transaction_defaults,
)
from web3_eth.datastructures import (
    AttributeDict,
...
from web3_eth.types import (  # noqa: F401
    ABI,
    ABIEvent,
    ABIFunction,
    BlockIdentifier,
...
from web3_eth.utils import (
    get_abi_input_names,
)

if TYPE_CHECKING:
    from ens import ENS  # noqa: F401
    from web3_eth import Web3  # noqa: F401
...
class BaseContractEvents:
    ...
    .. code-block:: python
        ...
        >>> mycontract.events
        <web3_eth.contract.ContractEvents object at 0x108afde10>
    ...
    .. code-block:: python
        ...
        <class 'web3_eth._utils.datatypes.LogAnonymous'>
        ...
...
class BaseContract:
    ...
    :meth:`web3_eth.eth.Eth.contract` that takes compiled Solidity contract
    ...
    def __init__(self, address: Optional[ChecksumAddress] = None) -> None:
        ...
        if _w3 is None:
            raise AttributeError(
                ...
                "`web3_eth.contract` interface to create your contract class."
            )
...
class ContractFunction(BaseContractFunction):
    ...
    def call(
        ...
        :param transaction: Dictionary of transaction info for web3_eth interface
...
class ContractEvent(BaseContractEvent):
    ...
    def getLogs(
        ...
        .. code-block:: python
            ...
            from = max(mycontract.web3_eth.eth.block_number - 10, 1)
            to = mycontract.web3_eth.eth.block_number
        ...
        See also: :func:`web3_eth.middleware.filter.local_filter_middleware`.
