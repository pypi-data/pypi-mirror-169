...
setup(
    ...
    install_requires=[
        ...
        # remove typing_extensions after python_requires>=3.8, see web3_eth._utils.compat
        "typing-extensions>=3.7.4.1,<5;python_version<'3.8'",
        "websockets>=10.0.0,<11",
    ],
    python_requires=">=3.7.2",
    extras_require=extras_require,
    py_modules=["web3_eth", "ens", "ethpm"],
    entry_points={"pytest11": ["pytest_ethereum = web3_eth.tools.pytest_ethereum.plugins"]},
    license="MIT",
    zip_safe=False,
    keywords="ethereum",
    packages=find_packages(exclude=["tests", "tests.*"]),
    package_data={"web3_eth": ["py.typed"]},
    classifiers=[
