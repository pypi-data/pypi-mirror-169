...
if TYPE_CHECKING:
    from web3_eth import Web3 as _Web3  # noqa: F401
    from web3_eth.providers import (  # noqa: F401
        AsyncBaseProvider,
        BaseProvider,
    )
...
def Web3() -> Type["_Web3"]:
    from web3_eth import Web3 as Web3Main
...
def init_web3(
    ...
    from web3_eth import Web3 as Web3Main
    from web3_eth.eth import Eth as EthMain
...
def customize_web3(w3: "_Web3") -> "_Web3":
    from web3_eth.middleware import make_stalecheck_middleware
...
# borrowed from similar method at `web3_eth._utils.abi` due to circular dependency
...
def init_async_web3(
    ...
    from web3_eth import Web3 as Web3Main
    from web3_eth.eth import AsyncEth as AsyncEthMain
...
async def _async_ens_stalecheck_middleware(
    ...
    from web3_eth.middleware import async_make_stalecheck_middleware
