...
class Wif(_Spectral.Wif):
    ...
    def removeNaN(self) :
        """Return Wif object with NaN components


        Returns
        -------
        sp.Wif
            Wif object with NaN components.
    ...
    @classmethod
    def FromTS(cls, se, b = 0.0, method = "FFT", window = None , **kwargs):
    ...
    def FromTS_FFT(cls, se, b = 0.0, depth = -1., windows = None, wmax = None):
        ...
        from droppy.TimeDomain import fftDf
    ...
    def FromTS_LLSQ(cls, se, freq, b = 0.0, depth = -1):
        ...
        Comment : The match between original and reconstructed wave elevation increase with n.
        ...
        print ("Solving linear LSQ", matA.shape)
    ...
    def optimize(self, energyRatio):
        ...
        Args:
            energyRatio (float): Amount of energy to keep (1.0, conserve 100% of the energy)

        Returns:
            Wif: Wif with "optimized" frequencies
