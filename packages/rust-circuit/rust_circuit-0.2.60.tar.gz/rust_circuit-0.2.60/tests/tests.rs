...
use rust_circuit::circuit::{ArrayConstant, CircuitNode, GeneralFunction};
...
#[test]
fn test_circuit_rrfs() {
    pyo3::prepare_freethreaded_python();
    let z = {
        ArrayConstant::from_hash(
            None,
            "7d7e6f95cef66624b7aaa27a2d4415547043592e6cd0ddcb40aa6bb5ebd28760",
        )
        .unwrap()
        .rc()
    };
