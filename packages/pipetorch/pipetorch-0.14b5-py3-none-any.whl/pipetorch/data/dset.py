...
class _DSet:
    ...
    def _copy_meta(self, r):
        r._df = self._df
        r._dfindices = np.array(self._dfindices)
    ...
    def replace_y(self, new_y):
        ...
        r.loc[r._dfindices[indices], r._columny] = np.NaN
    ...
    def fill_column(self, values, *columns, inplace=False, offset=0):
        ...
        if inplace:
            ...
            self._df.loc[ self._dfindices[indices], columns ] = values
            ...
            r.loc[ self._dfindices[indices], columns] = values
            return r
