...
class Workflow_Processor:
    ...
    def execute(self, labeler, batch_size = 3, return_results = True):
        self.raw_predictions, self.numeric_class, self.classification = labeler.get_labels(self.img_obj, batch_size = batch_size)
