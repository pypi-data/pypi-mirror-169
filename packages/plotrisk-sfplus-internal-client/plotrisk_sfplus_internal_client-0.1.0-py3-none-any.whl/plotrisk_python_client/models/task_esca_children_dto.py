...
class TaskESCAChildrenDto(object):
    ...
    def __init__(self, croppable_area_id=None, croppable_area_name=None, cu_count=None, task_count=None):  # noqa: E501
        """TaskESCAChildrenDto - a model defined in Swagger"""  # noqa: E501
