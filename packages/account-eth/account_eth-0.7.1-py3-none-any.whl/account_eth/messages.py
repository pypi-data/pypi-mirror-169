...
from account_eth._utils.structured_data.hashing import (
    hash_domain,
    hash_message as hash_eip712_message,
    load_and_validate_structured_message,
)
from account_eth._utils.structured_data.validation import (
    validate_structured_data,
)
from account_eth._utils.validation import (
    is_valid_address,
)
...
def encode_defunct(
    ...
    .. doctest:: python
        ...
        >>> from utils_eth.curried import to_hex, to_bytes
...
def defunct_hash_message(
    ...
    .. CAUTION:: Intented for use with the deprecated
        :meth:`account_eth.account.Account.signHash`.
