...
from account_eth._utils.legacy_transactions import (
    Transaction,
    vrs_from,
)
from account_eth._utils.signing import (
...
from account_eth._utils.typed_transactions import (
    TypedTransaction,
)
from account_eth.datastructures import (
    SignedMessage,
    SignedTransaction,
)
from account_eth.hdaccount import (
...
class Account:
    ...
    _default_kdf = os.getenv("account_eth_KDF", "scrypt")
    ...
    def create(self, extra_entropy=""):
        ...
        :class:`~account_eth.local.LocalAccount`.
    ...
    def encrypt(cls, private_key, password, kdf=None, iterations=None):
        ...
        environment variable :envvar:`account_eth_KDF`. If that is not set, then
    ...
    def create_with_mnemonic(
        ...
        Creates a new private key, and returns it as a
        :class:`~account_eth.local.LocalAccount`, alongside the mnemonic that can
    ...
    def sign_message(
        ...
        you can use :meth:`~account_eth.messages.encode_defunct`.
        ...
        :returns: Various details about the signature - most importantly the
            fields: v, r, and s
        :rtype: ~account_eth.datastructures.SignedMessage
    ...
    def signHash(self, message_hash, private_key):
        ...
        .. WARNING:: *Never* sign a hash that you didn't generate,
            ...
            Instead, prefer :meth:`~account_eth.account.Account.sign_message`,
            which cannot accidentally sign a transaction.

        .. CAUTION:: Deprecated for :meth:`~account_eth.account.Account.sign_message`.
