...
from account_eth.signers.base import (
    BaseAccount,
)
...
class LocalAccount(BaseAccount):
    ...
    def __init__(self, key, account):
        ...
        :param ~account_eth.account.Account account: the key-unaware management API
        """
    ...
    def encrypt(self, password, kdf=None, iterations=None):
        ...
        :meth:`~account_eth.account.Account.encrypt`, but without a
    ...
    def sign_message(self, signable_message):
        ...
        This uses the same structure as in
        :meth:`~account_eth.account.Account.sign_message`, but without a
        private key argument.
        """
