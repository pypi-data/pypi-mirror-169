...
class NucleotideAlignmentsService(BaseService):
    ...
    @api_method
    def get_by_id(self, nucleotide_alignment_id: str) -> NucleotideAlignment:
        """
        Get a Nucleotide Alignment.

        See https://benchling.com/api/reference#/Nucleotide%20Alignments/getNucleotideAlignment
        """
        response = get_nucleotide_alignment.sync_detailed(
            client=self.client, alignment_id=nucleotide_alignment_id
        )
