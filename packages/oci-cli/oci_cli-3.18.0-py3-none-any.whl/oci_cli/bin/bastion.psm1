...
function GetOciSubcommands_bastion() {
    $ociSubcommands = @{
        ...
        'bastion session' = 'create create-managed-ssh create-port-forwarding delete get list update'
...
function GetOciCommandsToLongParams_bastion() {
    $ociCommandsToLongParams = @{
        ...
        'bastion bastion create' = 'bastion-type client-cidr-list compartment-id defined-tags freeform-tags from-json help jump-host-ips max-session-ttl max-wait-seconds name phone-book-entry target-subnet-id wait-for-state wait-interval-seconds'
        ...
        'bastion session create-port-forwarding' = 'bastion-id display-name from-json help key-type max-wait-seconds session-ttl ssh-public-key-file target-port target-private-ip target-resource-id wait-for-state wait-interval-seconds'
