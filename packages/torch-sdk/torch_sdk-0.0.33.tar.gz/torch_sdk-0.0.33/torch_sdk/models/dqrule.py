...
from torch_sdk.models.rule import ShortSegment, Label, BackingAsset, RuleThresholdLevel, RuleTag, PolicyGroup, RuleResource, RuleExecution

from torch_sdk.models.ruleExecutionResult import ExecutorConfig
...
class DataQualityRule:
    def __init__(self, name=None, description=None, type=None, enabled=None, schedule=None, scheduled=None,
                 ...
                 policyGroups=None, id=None, **kwargs):
        self.id = id
        self.name = name
