...
class _msview:
    ...
    def __call__( self, infile='', displaytype='raster', channel=int(0), zoom=int(1), outfile='', outscale=float(1.0), outdpi=int(300), outformat='jpg', outlandscape=False, gui=True ):
        ...
        return _end_log( _logging_state_, 'msview', _msview_t( _pc.document['infile'], _pc.document['displaytype'], _pc.document['channel'], _pc.document['zoom'], _pc.document['outfile'], _pc.document['outscale'], _pc.document['outdpi'], _pc.document['outformat'], _pc.document['outlandscape'], _pc.document['gui'] ) )
