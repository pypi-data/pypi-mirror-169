...
class _imview:
    ...
    def __raster_inp(self):
        ...
        (pre,post) = ('','') if self.__validate_({'raster': value},{'raster': self.__schema['raster']}) else ('\x1B[91m','\x1B[0m')
    ...
    def __contour_inp(self):
        ...
        (pre,post) = ('','') if self.__validate_({'contour': value},{'contour': self.__schema['contour']}) else ('\x1B[91m','\x1B[0m')
    ...
    def __out_inp(self):
        ...
        (pre,post) = ('','') if self.__validate_({'out': value},{'out': self.__schema['out']}) else ('\x1B[91m','\x1B[0m')
    ...
    def tget(self,file=None):
        ...
        filename = None
        if file is None:
            if os.path.isfile("imview.last"):
                filename = "imview.last"
