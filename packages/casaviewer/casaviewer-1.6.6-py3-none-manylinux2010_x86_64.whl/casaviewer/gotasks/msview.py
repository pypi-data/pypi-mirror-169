...
class _msview:
    ...
    def __displaytype_inp(self):
        ...
        (pre,post) = ('','') if self.__validate_({'displaytype': value},{'displaytype': self.__schema['displaytype']}) else ('\x1B[91m','\x1B[0m')
    ...
    def __channel_inp(self):
        ...
        (pre,post) = ('','') if self.__validate_({'channel': value},{'channel': self.__schema['channel']}) else ('\x1B[91m','\x1B[0m')
    ...
    def __outscale_inp(self):
        ...
        (pre,post) = ('','') if self.__validate_({'outscale': value},{'outscale': self.__schema['outscale']}) else ('\x1B[91m','\x1B[0m')
    ...
    def __outdpi_inp(self):
        ...
        (pre,post) = ('','') if self.__validate_({'outdpi': value},{'outdpi': self.__schema['outdpi']}) else ('\x1B[91m','\x1B[0m')
    ...
    def __outformat_inp(self):
        ...
        (pre,post) = ('','') if self.__validate_({'outformat': value},{'outformat': self.__schema['outformat']}) else ('\x1B[91m','\x1B[0m')
    ...
    def __outlandscape_inp(self):
        ...
        (pre,post) = ('','') if self.__validate_({'outlandscape': value},{'outlandscape': self.__schema['outlandscape']}) else ('\x1B[91m','\x1B[0m')
    ...
    def __gui_inp(self):
        ...
        (pre,post) = ('','') if self.__validate_({'gui': value},{'gui': self.__schema['gui']}) else ('\x1B[91m','\x1B[0m')
    ...
    def tget(self,file=None):
        ...
        filename = None
        if file is None:
            if os.path.isfile("msview.last"):
                filename = "msview.last"
