...
def get_template_LEDET_options_sheet():
    ...
    template_LEDET_options_sheet = [
        ...
        ['flag_calculateMagneticField', None, 'If set to 1, the 2D magnetic-field maps will be calculated (not imported). The calculation will rely on the Biot-Savart law and use the strand positions imported from the map2d file.'],
        [None, None, None],
