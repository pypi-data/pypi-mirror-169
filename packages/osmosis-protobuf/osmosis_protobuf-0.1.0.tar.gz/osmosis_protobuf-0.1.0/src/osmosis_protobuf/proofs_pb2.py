...
ExistenceProof = _reflection.GeneratedProtocolMessageType('ExistenceProof', (_message.Message,), {'DESCRIPTOR': _EXISTENCEPROOF, '__module__': 'proofs_pb2'})
_sym_db.RegisterMessage(ExistenceProof)
NonExistenceProof = _reflection.GeneratedProtocolMessageType('NonExistenceProof', (_message.Message,), {'DESCRIPTOR': _NONEXISTENCEPROOF, '__module__': 'proofs_pb2'})
_sym_db.RegisterMessage(NonExistenceProof)
CommitmentProof = _reflection.GeneratedProtocolMessageType('CommitmentProof', (_message.Message,), {'DESCRIPTOR': _COMMITMENTPROOF, '__module__': 'proofs_pb2'})
_sym_db.RegisterMessage(CommitmentProof)
LeafOp = _reflection.GeneratedProtocolMessageType('LeafOp', (_message.Message,), {'DESCRIPTOR': _LEAFOP, '__module__': 'proofs_pb2'})
_sym_db.RegisterMessage(LeafOp)
InnerOp = _reflection.GeneratedProtocolMessageType('InnerOp', (_message.Message,), {'DESCRIPTOR': _INNEROP, '__module__': 'proofs_pb2'})
_sym_db.RegisterMessage(InnerOp)
ProofSpec = _reflection.GeneratedProtocolMessageType('ProofSpec', (_message.Message,), {'DESCRIPTOR': _PROOFSPEC, '__module__': 'proofs_pb2'})
_sym_db.RegisterMessage(ProofSpec)
InnerSpec = _reflection.GeneratedProtocolMessageType('InnerSpec', (_message.Message,), {'DESCRIPTOR': _INNERSPEC, '__module__': 'proofs_pb2'})
_sym_db.RegisterMessage(InnerSpec)
BatchProof = _reflection.GeneratedProtocolMessageType('BatchProof', (_message.Message,), {'DESCRIPTOR': _BATCHPROOF, '__module__': 'proofs_pb2'})
_sym_db.RegisterMessage(BatchProof)
BatchEntry = _reflection.GeneratedProtocolMessageType('BatchEntry', (_message.Message,), {'DESCRIPTOR': _BATCHENTRY, '__module__': 'proofs_pb2'})
_sym_db.RegisterMessage(BatchEntry)
CompressedBatchProof = _reflection.GeneratedProtocolMessageType('CompressedBatchProof', (_message.Message,), {'DESCRIPTOR': _COMPRESSEDBATCHPROOF, '__module__': 'proofs_pb2'})
_sym_db.RegisterMessage(CompressedBatchProof)
CompressedBatchEntry = _reflection.GeneratedProtocolMessageType('CompressedBatchEntry', (_message.Message,), {'DESCRIPTOR': _COMPRESSEDBATCHENTRY, '__module__': 'proofs_pb2'})
_sym_db.RegisterMessage(CompressedBatchEntry)
CompressedExistenceProof = _reflection.GeneratedProtocolMessageType('CompressedExistenceProof', (_message.Message,), {'DESCRIPTOR': _COMPRESSEDEXISTENCEPROOF, '__module__': 'proofs_pb2'})
_sym_db.RegisterMessage(CompressedExistenceProof)
CompressedNonExistenceProof = _reflection.GeneratedProtocolMessageType('CompressedNonExistenceProof', (_message.Message,), {'DESCRIPTOR': _COMPRESSEDNONEXISTENCEPROOF, '__module__': 'proofs_pb2'})
