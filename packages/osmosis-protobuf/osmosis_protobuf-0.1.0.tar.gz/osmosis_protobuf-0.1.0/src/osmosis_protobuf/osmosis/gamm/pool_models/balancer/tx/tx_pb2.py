...
MsgCreateBalancerPool = _reflection.GeneratedProtocolMessageType('MsgCreateBalancerPool', (_message.Message,), {'DESCRIPTOR': _MSGCREATEBALANCERPOOL, '__module__': 'osmosis.gamm.pool_models.balancer.tx.tx_pb2'})
_sym_db.RegisterMessage(MsgCreateBalancerPool)
MsgCreateBalancerPoolResponse = _reflection.GeneratedProtocolMessageType('MsgCreateBalancerPoolResponse', (_message.Message,), {'DESCRIPTOR': _MSGCREATEBALANCERPOOLRESPONSE, '__module__': 'osmosis.gamm.pool_models.balancer.tx.tx_pb2'})
_sym_db.RegisterMessage(MsgCreateBalancerPoolResponse)
_MSG = DESCRIPTOR.services_by_name['Msg']
if _descriptor._USE_C_DESCRIPTORS == False:
    DESCRIPTOR._options = None
    DESCRIPTOR._serialized_options = b'Z?github.com/osmosis-labs/osmosis/v12/x/gamm/pool-models/balancer'
