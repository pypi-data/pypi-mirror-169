...
MsgIBCSend = _reflection.GeneratedProtocolMessageType('MsgIBCSend', (_message.Message,), {'DESCRIPTOR': _MSGIBCSEND, '__module__': 'cosmwasm.wasm.v1.ibc_pb2'})
_sym_db.RegisterMessage(MsgIBCSend)
MsgIBCCloseChannel = _reflection.GeneratedProtocolMessageType('MsgIBCCloseChannel', (_message.Message,), {'DESCRIPTOR': _MSGIBCCLOSECHANNEL, '__module__': 'cosmwasm.wasm.v1.ibc_pb2'})
