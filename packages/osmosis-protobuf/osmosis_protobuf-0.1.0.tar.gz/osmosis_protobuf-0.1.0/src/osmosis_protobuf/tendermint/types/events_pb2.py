...
EventDataRoundState = _reflection.GeneratedProtocolMessageType('EventDataRoundState', (_message.Message,), {'DESCRIPTOR': _EVENTDATAROUNDSTATE, '__module__': 'tendermint.types.events_pb2'})
