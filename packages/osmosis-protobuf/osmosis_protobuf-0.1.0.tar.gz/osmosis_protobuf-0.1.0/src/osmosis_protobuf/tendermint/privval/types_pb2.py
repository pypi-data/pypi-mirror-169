...
RemoteSignerError = _reflection.GeneratedProtocolMessageType('RemoteSignerError', (_message.Message,), {'DESCRIPTOR': _REMOTESIGNERERROR, '__module__': 'tendermint.privval.types_pb2'})
_sym_db.RegisterMessage(RemoteSignerError)
PubKeyRequest = _reflection.GeneratedProtocolMessageType('PubKeyRequest', (_message.Message,), {'DESCRIPTOR': _PUBKEYREQUEST, '__module__': 'tendermint.privval.types_pb2'})
_sym_db.RegisterMessage(PubKeyRequest)
PubKeyResponse = _reflection.GeneratedProtocolMessageType('PubKeyResponse', (_message.Message,), {'DESCRIPTOR': _PUBKEYRESPONSE, '__module__': 'tendermint.privval.types_pb2'})
_sym_db.RegisterMessage(PubKeyResponse)
SignVoteRequest = _reflection.GeneratedProtocolMessageType('SignVoteRequest', (_message.Message,), {'DESCRIPTOR': _SIGNVOTEREQUEST, '__module__': 'tendermint.privval.types_pb2'})
_sym_db.RegisterMessage(SignVoteRequest)
SignedVoteResponse = _reflection.GeneratedProtocolMessageType('SignedVoteResponse', (_message.Message,), {'DESCRIPTOR': _SIGNEDVOTERESPONSE, '__module__': 'tendermint.privval.types_pb2'})
_sym_db.RegisterMessage(SignedVoteResponse)
SignProposalRequest = _reflection.GeneratedProtocolMessageType('SignProposalRequest', (_message.Message,), {'DESCRIPTOR': _SIGNPROPOSALREQUEST, '__module__': 'tendermint.privval.types_pb2'})
_sym_db.RegisterMessage(SignProposalRequest)
SignedProposalResponse = _reflection.GeneratedProtocolMessageType('SignedProposalResponse', (_message.Message,), {'DESCRIPTOR': _SIGNEDPROPOSALRESPONSE, '__module__': 'tendermint.privval.types_pb2'})
_sym_db.RegisterMessage(SignedProposalResponse)
PingRequest = _reflection.GeneratedProtocolMessageType('PingRequest', (_message.Message,), {'DESCRIPTOR': _PINGREQUEST, '__module__': 'tendermint.privval.types_pb2'})
_sym_db.RegisterMessage(PingRequest)
PingResponse = _reflection.GeneratedProtocolMessageType('PingResponse', (_message.Message,), {'DESCRIPTOR': _PINGRESPONSE, '__module__': 'tendermint.privval.types_pb2'})
_sym_db.RegisterMessage(PingResponse)
Message = _reflection.GeneratedProtocolMessageType('Message', (_message.Message,), {'DESCRIPTOR': _MESSAGE, '__module__': 'tendermint.privval.types_pb2'})
