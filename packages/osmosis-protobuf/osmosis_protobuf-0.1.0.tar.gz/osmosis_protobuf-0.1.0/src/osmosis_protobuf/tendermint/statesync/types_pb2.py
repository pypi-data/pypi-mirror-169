...
Message = _reflection.GeneratedProtocolMessageType('Message', (_message.Message,), {'DESCRIPTOR': _MESSAGE, '__module__': 'tendermint.statesync.types_pb2'})
_sym_db.RegisterMessage(Message)
SnapshotsRequest = _reflection.GeneratedProtocolMessageType('SnapshotsRequest', (_message.Message,), {'DESCRIPTOR': _SNAPSHOTSREQUEST, '__module__': 'tendermint.statesync.types_pb2'})
_sym_db.RegisterMessage(SnapshotsRequest)
SnapshotsResponse = _reflection.GeneratedProtocolMessageType('SnapshotsResponse', (_message.Message,), {'DESCRIPTOR': _SNAPSHOTSRESPONSE, '__module__': 'tendermint.statesync.types_pb2'})
_sym_db.RegisterMessage(SnapshotsResponse)
ChunkRequest = _reflection.GeneratedProtocolMessageType('ChunkRequest', (_message.Message,), {'DESCRIPTOR': _CHUNKREQUEST, '__module__': 'tendermint.statesync.types_pb2'})
_sym_db.RegisterMessage(ChunkRequest)
ChunkResponse = _reflection.GeneratedProtocolMessageType('ChunkResponse', (_message.Message,), {'DESCRIPTOR': _CHUNKRESPONSE, '__module__': 'tendermint.statesync.types_pb2'})
