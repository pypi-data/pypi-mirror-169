...
NewRoundStep = _reflection.GeneratedProtocolMessageType('NewRoundStep', (_message.Message,), {'DESCRIPTOR': _NEWROUNDSTEP, '__module__': 'tendermint.consensus.types_pb2'})
_sym_db.RegisterMessage(NewRoundStep)
NewValidBlock = _reflection.GeneratedProtocolMessageType('NewValidBlock', (_message.Message,), {'DESCRIPTOR': _NEWVALIDBLOCK, '__module__': 'tendermint.consensus.types_pb2'})
_sym_db.RegisterMessage(NewValidBlock)
Proposal = _reflection.GeneratedProtocolMessageType('Proposal', (_message.Message,), {'DESCRIPTOR': _PROPOSAL, '__module__': 'tendermint.consensus.types_pb2'})
_sym_db.RegisterMessage(Proposal)
ProposalPOL = _reflection.GeneratedProtocolMessageType('ProposalPOL', (_message.Message,), {'DESCRIPTOR': _PROPOSALPOL, '__module__': 'tendermint.consensus.types_pb2'})
_sym_db.RegisterMessage(ProposalPOL)
BlockPart = _reflection.GeneratedProtocolMessageType('BlockPart', (_message.Message,), {'DESCRIPTOR': _BLOCKPART, '__module__': 'tendermint.consensus.types_pb2'})
_sym_db.RegisterMessage(BlockPart)
Vote = _reflection.GeneratedProtocolMessageType('Vote', (_message.Message,), {'DESCRIPTOR': _VOTE, '__module__': 'tendermint.consensus.types_pb2'})
_sym_db.RegisterMessage(Vote)
HasVote = _reflection.GeneratedProtocolMessageType('HasVote', (_message.Message,), {'DESCRIPTOR': _HASVOTE, '__module__': 'tendermint.consensus.types_pb2'})
_sym_db.RegisterMessage(HasVote)
VoteSetMaj23 = _reflection.GeneratedProtocolMessageType('VoteSetMaj23', (_message.Message,), {'DESCRIPTOR': _VOTESETMAJ23, '__module__': 'tendermint.consensus.types_pb2'})
_sym_db.RegisterMessage(VoteSetMaj23)
VoteSetBits = _reflection.GeneratedProtocolMessageType('VoteSetBits', (_message.Message,), {'DESCRIPTOR': _VOTESETBITS, '__module__': 'tendermint.consensus.types_pb2'})
_sym_db.RegisterMessage(VoteSetBits)
Message = _reflection.GeneratedProtocolMessageType('Message', (_message.Message,), {'DESCRIPTOR': _MESSAGE, '__module__': 'tendermint.consensus.types_pb2'})
