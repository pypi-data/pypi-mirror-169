...
PexRequest = _reflection.GeneratedProtocolMessageType('PexRequest', (_message.Message,), {'DESCRIPTOR': _PEXREQUEST, '__module__': 'tendermint.p2p.pex_pb2'})
_sym_db.RegisterMessage(PexRequest)
PexAddrs = _reflection.GeneratedProtocolMessageType('PexAddrs', (_message.Message,), {'DESCRIPTOR': _PEXADDRS, '__module__': 'tendermint.p2p.pex_pb2'})
_sym_db.RegisterMessage(PexAddrs)
Message = _reflection.GeneratedProtocolMessageType('Message', (_message.Message,), {'DESCRIPTOR': _MESSAGE, '__module__': 'tendermint.p2p.pex_pb2'})
