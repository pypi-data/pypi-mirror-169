...
NetAddress = _reflection.GeneratedProtocolMessageType('NetAddress', (_message.Message,), {'DESCRIPTOR': _NETADDRESS, '__module__': 'tendermint.p2p.types_pb2'})
...
DefaultNodeInfo = _reflection.GeneratedProtocolMessageType('DefaultNodeInfo', (_message.Message,), {'DESCRIPTOR': _DEFAULTNODEINFO, '__module__': 'tendermint.p2p.types_pb2'})
_sym_db.RegisterMessage(DefaultNodeInfo)
DefaultNodeInfoOther = _reflection.GeneratedProtocolMessageType('DefaultNodeInfoOther', (_message.Message,), {'DESCRIPTOR': _DEFAULTNODEINFOOTHER, '__module__': 'tendermint.p2p.types_pb2'})
