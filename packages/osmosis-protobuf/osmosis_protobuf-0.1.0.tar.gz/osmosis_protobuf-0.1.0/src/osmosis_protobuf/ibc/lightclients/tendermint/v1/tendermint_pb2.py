...
ClientState = _reflection.GeneratedProtocolMessageType('ClientState', (_message.Message,), {'DESCRIPTOR': _CLIENTSTATE, '__module__': 'ibc.lightclients.tendermint.v1.tendermint_pb2'})
_sym_db.RegisterMessage(ClientState)
ConsensusState = _reflection.GeneratedProtocolMessageType('ConsensusState', (_message.Message,), {'DESCRIPTOR': _CONSENSUSSTATE, '__module__': 'ibc.lightclients.tendermint.v1.tendermint_pb2'})
_sym_db.RegisterMessage(ConsensusState)
Misbehaviour = _reflection.GeneratedProtocolMessageType('Misbehaviour', (_message.Message,), {'DESCRIPTOR': _MISBEHAVIOUR, '__module__': 'ibc.lightclients.tendermint.v1.tendermint_pb2'})
_sym_db.RegisterMessage(Misbehaviour)
Header = _reflection.GeneratedProtocolMessageType('Header', (_message.Message,), {'DESCRIPTOR': _HEADER, '__module__': 'ibc.lightclients.tendermint.v1.tendermint_pb2'})
_sym_db.RegisterMessage(Header)
Fraction = _reflection.GeneratedProtocolMessageType('Fraction', (_message.Message,), {'DESCRIPTOR': _FRACTION, '__module__': 'ibc.lightclients.tendermint.v1.tendermint_pb2'})
