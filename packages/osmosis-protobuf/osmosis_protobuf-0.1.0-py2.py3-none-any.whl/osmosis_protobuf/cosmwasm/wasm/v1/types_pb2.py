...
AccessTypeParam = _reflection.GeneratedProtocolMessageType('AccessTypeParam', (_message.Message,), {'DESCRIPTOR': _ACCESSTYPEPARAM, '__module__': 'cosmwasm.wasm.v1.types_pb2'})
_sym_db.RegisterMessage(AccessTypeParam)
AccessConfig = _reflection.GeneratedProtocolMessageType('AccessConfig', (_message.Message,), {'DESCRIPTOR': _ACCESSCONFIG, '__module__': 'cosmwasm.wasm.v1.types_pb2'})
_sym_db.RegisterMessage(AccessConfig)
Params = _reflection.GeneratedProtocolMessageType('Params', (_message.Message,), {'DESCRIPTOR': _PARAMS, '__module__': 'cosmwasm.wasm.v1.types_pb2'})
_sym_db.RegisterMessage(Params)
CodeInfo = _reflection.GeneratedProtocolMessageType('CodeInfo', (_message.Message,), {'DESCRIPTOR': _CODEINFO, '__module__': 'cosmwasm.wasm.v1.types_pb2'})
_sym_db.RegisterMessage(CodeInfo)
ContractInfo = _reflection.GeneratedProtocolMessageType('ContractInfo', (_message.Message,), {'DESCRIPTOR': _CONTRACTINFO, '__module__': 'cosmwasm.wasm.v1.types_pb2'})
_sym_db.RegisterMessage(ContractInfo)
ContractCodeHistoryEntry = _reflection.GeneratedProtocolMessageType('ContractCodeHistoryEntry', (_message.Message,), {'DESCRIPTOR': _CONTRACTCODEHISTORYENTRY, '__module__': 'cosmwasm.wasm.v1.types_pb2'})
_sym_db.RegisterMessage(ContractCodeHistoryEntry)
AbsoluteTxPosition = _reflection.GeneratedProtocolMessageType('AbsoluteTxPosition', (_message.Message,), {'DESCRIPTOR': _ABSOLUTETXPOSITION, '__module__': 'cosmwasm.wasm.v1.types_pb2'})
_sym_db.RegisterMessage(AbsoluteTxPosition)
Model = _reflection.GeneratedProtocolMessageType('Model', (_message.Message,), {'DESCRIPTOR': _MODEL, '__module__': 'cosmwasm.wasm.v1.types_pb2'})
