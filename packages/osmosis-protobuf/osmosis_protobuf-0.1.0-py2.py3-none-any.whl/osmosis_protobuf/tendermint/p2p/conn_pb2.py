...
PacketPing = _reflection.GeneratedProtocolMessageType('PacketPing', (_message.Message,), {'DESCRIPTOR': _PACKETPING, '__module__': 'tendermint.p2p.conn_pb2'})
_sym_db.RegisterMessage(PacketPing)
PacketPong = _reflection.GeneratedProtocolMessageType('PacketPong', (_message.Message,), {'DESCRIPTOR': _PACKETPONG, '__module__': 'tendermint.p2p.conn_pb2'})
_sym_db.RegisterMessage(PacketPong)
PacketMsg = _reflection.GeneratedProtocolMessageType('PacketMsg', (_message.Message,), {'DESCRIPTOR': _PACKETMSG, '__module__': 'tendermint.p2p.conn_pb2'})
_sym_db.RegisterMessage(PacketMsg)
Packet = _reflection.GeneratedProtocolMessageType('Packet', (_message.Message,), {'DESCRIPTOR': _PACKET, '__module__': 'tendermint.p2p.conn_pb2'})
_sym_db.RegisterMessage(Packet)
AuthSigMessage = _reflection.GeneratedProtocolMessageType('AuthSigMessage', (_message.Message,), {'DESCRIPTOR': _AUTHSIGMESSAGE, '__module__': 'tendermint.p2p.conn_pb2'})
