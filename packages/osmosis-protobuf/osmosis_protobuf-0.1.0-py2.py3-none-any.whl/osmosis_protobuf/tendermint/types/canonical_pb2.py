...
CanonicalBlockID = _reflection.GeneratedProtocolMessageType('CanonicalBlockID', (_message.Message,), {'DESCRIPTOR': _CANONICALBLOCKID, '__module__': 'tendermint.types.canonical_pb2'})
_sym_db.RegisterMessage(CanonicalBlockID)
CanonicalPartSetHeader = _reflection.GeneratedProtocolMessageType('CanonicalPartSetHeader', (_message.Message,), {'DESCRIPTOR': _CANONICALPARTSETHEADER, '__module__': 'tendermint.types.canonical_pb2'})
_sym_db.RegisterMessage(CanonicalPartSetHeader)
CanonicalProposal = _reflection.GeneratedProtocolMessageType('CanonicalProposal', (_message.Message,), {'DESCRIPTOR': _CANONICALPROPOSAL, '__module__': 'tendermint.types.canonical_pb2'})
_sym_db.RegisterMessage(CanonicalProposal)
CanonicalVote = _reflection.GeneratedProtocolMessageType('CanonicalVote', (_message.Message,), {'DESCRIPTOR': _CANONICALVOTE, '__module__': 'tendermint.types.canonical_pb2'})
