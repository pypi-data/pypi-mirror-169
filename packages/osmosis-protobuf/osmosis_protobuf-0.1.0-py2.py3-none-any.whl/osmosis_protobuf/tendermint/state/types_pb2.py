...
ABCIResponsesInfo = _reflection.GeneratedProtocolMessageType('ABCIResponsesInfo', (_message.Message,), {'DESCRIPTOR': _ABCIRESPONSESINFO, '__module__': 'tendermint.state.types_pb2'})
