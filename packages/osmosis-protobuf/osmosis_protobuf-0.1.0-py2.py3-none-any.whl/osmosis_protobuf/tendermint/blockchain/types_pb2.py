...
BlockRequest = _reflection.GeneratedProtocolMessageType('BlockRequest', (_message.Message,), {'DESCRIPTOR': _BLOCKREQUEST, '__module__': 'tendermint.blockchain.types_pb2'})
_sym_db.RegisterMessage(BlockRequest)
NoBlockResponse = _reflection.GeneratedProtocolMessageType('NoBlockResponse', (_message.Message,), {'DESCRIPTOR': _NOBLOCKRESPONSE, '__module__': 'tendermint.blockchain.types_pb2'})
_sym_db.RegisterMessage(NoBlockResponse)
BlockResponse = _reflection.GeneratedProtocolMessageType('BlockResponse', (_message.Message,), {'DESCRIPTOR': _BLOCKRESPONSE, '__module__': 'tendermint.blockchain.types_pb2'})
_sym_db.RegisterMessage(BlockResponse)
StatusRequest = _reflection.GeneratedProtocolMessageType('StatusRequest', (_message.Message,), {'DESCRIPTOR': _STATUSREQUEST, '__module__': 'tendermint.blockchain.types_pb2'})
_sym_db.RegisterMessage(StatusRequest)
StatusResponse = _reflection.GeneratedProtocolMessageType('StatusResponse', (_message.Message,), {'DESCRIPTOR': _STATUSRESPONSE, '__module__': 'tendermint.blockchain.types_pb2'})
_sym_db.RegisterMessage(StatusResponse)
Message = _reflection.GeneratedProtocolMessageType('Message', (_message.Message,), {'DESCRIPTOR': _MESSAGE, '__module__': 'tendermint.blockchain.types_pb2'})
