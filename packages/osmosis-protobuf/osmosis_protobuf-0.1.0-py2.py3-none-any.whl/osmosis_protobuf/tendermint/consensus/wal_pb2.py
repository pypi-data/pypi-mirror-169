...
MsgInfo = _reflection.GeneratedProtocolMessageType('MsgInfo', (_message.Message,), {'DESCRIPTOR': _MSGINFO, '__module__': 'tendermint.consensus.wal_pb2'})
_sym_db.RegisterMessage(MsgInfo)
TimeoutInfo = _reflection.GeneratedProtocolMessageType('TimeoutInfo', (_message.Message,), {'DESCRIPTOR': _TIMEOUTINFO, '__module__': 'tendermint.consensus.wal_pb2'})
_sym_db.RegisterMessage(TimeoutInfo)
EndHeight = _reflection.GeneratedProtocolMessageType('EndHeight', (_message.Message,), {'DESCRIPTOR': _ENDHEIGHT, '__module__': 'tendermint.consensus.wal_pb2'})
_sym_db.RegisterMessage(EndHeight)
WALMessage = _reflection.GeneratedProtocolMessageType('WALMessage', (_message.Message,), {'DESCRIPTOR': _WALMESSAGE, '__module__': 'tendermint.consensus.wal_pb2'})
_sym_db.RegisterMessage(WALMessage)
TimedWALMessage = _reflection.GeneratedProtocolMessageType('TimedWALMessage', (_message.Message,), {'DESCRIPTOR': _TIMEDWALMESSAGE, '__module__': 'tendermint.consensus.wal_pb2'})
