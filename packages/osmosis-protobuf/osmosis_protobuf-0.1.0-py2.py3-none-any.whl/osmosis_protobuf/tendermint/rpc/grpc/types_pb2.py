...
RequestPing = _reflection.GeneratedProtocolMessageType('RequestPing', (_message.Message,), {'DESCRIPTOR': _REQUESTPING, '__module__': 'tendermint.rpc.grpc.types_pb2'})
_sym_db.RegisterMessage(RequestPing)
RequestBroadcastTx = _reflection.GeneratedProtocolMessageType('RequestBroadcastTx', (_message.Message,), {'DESCRIPTOR': _REQUESTBROADCASTTX, '__module__': 'tendermint.rpc.grpc.types_pb2'})
_sym_db.RegisterMessage(RequestBroadcastTx)
ResponsePing = _reflection.GeneratedProtocolMessageType('ResponsePing', (_message.Message,), {'DESCRIPTOR': _RESPONSEPING, '__module__': 'tendermint.rpc.grpc.types_pb2'})
_sym_db.RegisterMessage(ResponsePing)
ResponseBroadcastTx = _reflection.GeneratedProtocolMessageType('ResponseBroadcastTx', (_message.Message,), {'DESCRIPTOR': _RESPONSEBROADCASTTX, '__module__': 'tendermint.rpc.grpc.types_pb2'})
