...
_MSGSETDENOMMETADATA = DESCRIPTOR.message_types_by_name['MsgSetDenomMetadata']
_MSGSETDENOMMETADATARESPONSE = DESCRIPTOR.message_types_by_name['MsgSetDenomMetadataResponse']
...
MsgSetDenomMetadata = _reflection.GeneratedProtocolMessageType('MsgSetDenomMetadata', (_message.Message,), {'DESCRIPTOR': _MSGSETDENOMMETADATA, '__module__': 'osmosis.tokenfactory.v1beta1.tx_pb2'})
_sym_db.RegisterMessage(MsgSetDenomMetadata)
MsgSetDenomMetadataResponse = _reflection.GeneratedProtocolMessageType('MsgSetDenomMetadataResponse', (_message.Message,), {'DESCRIPTOR': _MSGSETDENOMMETADATARESPONSE, '__module__': 'osmosis.tokenfactory.v1beta1.tx_pb2'})
_sym_db.RegisterMessage(MsgSetDenomMetadataResponse)
_MSG = DESCRIPTOR.services_by_name['Msg']
if _descriptor._USE_C_DESCRIPTORS == False:
    DESCRIPTOR._options = None
    DESCRIPTOR._serialized_options = b'Z8github.com/osmosis-labs/osmosis/v12/x/tokenfactory/types'
