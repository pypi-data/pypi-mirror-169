...
SetSuperfluidAssetsProposal = _reflection.GeneratedProtocolMessageType('SetSuperfluidAssetsProposal', (_message.Message,), {'DESCRIPTOR': _SETSUPERFLUIDASSETSPROPOSAL, '__module__': 'osmosis.superfluid.v1beta1.gov_pb2'})
_sym_db.RegisterMessage(SetSuperfluidAssetsProposal)
RemoveSuperfluidAssetsProposal = _reflection.GeneratedProtocolMessageType('RemoveSuperfluidAssetsProposal', (_message.Message,), {'DESCRIPTOR': _REMOVESUPERFLUIDASSETSPROPOSAL, '__module__': 'osmosis.superfluid.v1beta1.gov_pb2'})
