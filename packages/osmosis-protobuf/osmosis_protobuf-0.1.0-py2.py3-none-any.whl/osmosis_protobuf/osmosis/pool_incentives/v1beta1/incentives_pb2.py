...
_POOLTOGAUGE = DESCRIPTOR.message_types_by_name['PoolToGauge']
_POOLTOGAUGES = DESCRIPTOR.message_types_by_name['PoolToGauges']
...
PoolToGauge = _reflection.GeneratedProtocolMessageType('PoolToGauge', (_message.Message,), {'DESCRIPTOR': _POOLTOGAUGE, '__module__': 'osmosis.pool_incentives.v1beta1.incentives_pb2'})
_sym_db.RegisterMessage(PoolToGauge)
PoolToGauges = _reflection.GeneratedProtocolMessageType('PoolToGauges', (_message.Message,), {'DESCRIPTOR': _POOLTOGAUGES, '__module__': 'osmosis.pool_incentives.v1beta1.incentives_pb2'})
_sym_db.RegisterMessage(PoolToGauges)
if _descriptor._USE_C_DESCRIPTORS == False:
    DESCRIPTOR._options = None
    DESCRIPTOR._serialized_options = b'Z;github.com/osmosis-labs/osmosis/v12/x/pool-incentives/types'
