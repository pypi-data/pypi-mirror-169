...
ClientState = _reflection.GeneratedProtocolMessageType('ClientState', (_message.Message,), {'DESCRIPTOR': _CLIENTSTATE, '__module__': 'ibc.lightclients.solomachine.v2.solomachine_pb2'})
_sym_db.RegisterMessage(ClientState)
ConsensusState = _reflection.GeneratedProtocolMessageType('ConsensusState', (_message.Message,), {'DESCRIPTOR': _CONSENSUSSTATE, '__module__': 'ibc.lightclients.solomachine.v2.solomachine_pb2'})
_sym_db.RegisterMessage(ConsensusState)
Header = _reflection.GeneratedProtocolMessageType('Header', (_message.Message,), {'DESCRIPTOR': _HEADER, '__module__': 'ibc.lightclients.solomachine.v2.solomachine_pb2'})
_sym_db.RegisterMessage(Header)
Misbehaviour = _reflection.GeneratedProtocolMessageType('Misbehaviour', (_message.Message,), {'DESCRIPTOR': _MISBEHAVIOUR, '__module__': 'ibc.lightclients.solomachine.v2.solomachine_pb2'})
_sym_db.RegisterMessage(Misbehaviour)
SignatureAndData = _reflection.GeneratedProtocolMessageType('SignatureAndData', (_message.Message,), {'DESCRIPTOR': _SIGNATUREANDDATA, '__module__': 'ibc.lightclients.solomachine.v2.solomachine_pb2'})
_sym_db.RegisterMessage(SignatureAndData)
TimestampedSignatureData = _reflection.GeneratedProtocolMessageType('TimestampedSignatureData', (_message.Message,), {'DESCRIPTOR': _TIMESTAMPEDSIGNATUREDATA, '__module__': 'ibc.lightclients.solomachine.v2.solomachine_pb2'})
_sym_db.RegisterMessage(TimestampedSignatureData)
SignBytes = _reflection.GeneratedProtocolMessageType('SignBytes', (_message.Message,), {'DESCRIPTOR': _SIGNBYTES, '__module__': 'ibc.lightclients.solomachine.v2.solomachine_pb2'})
_sym_db.RegisterMessage(SignBytes)
HeaderData = _reflection.GeneratedProtocolMessageType('HeaderData', (_message.Message,), {'DESCRIPTOR': _HEADERDATA, '__module__': 'ibc.lightclients.solomachine.v2.solomachine_pb2'})
_sym_db.RegisterMessage(HeaderData)
ClientStateData = _reflection.GeneratedProtocolMessageType('ClientStateData', (_message.Message,), {'DESCRIPTOR': _CLIENTSTATEDATA, '__module__': 'ibc.lightclients.solomachine.v2.solomachine_pb2'})
_sym_db.RegisterMessage(ClientStateData)
ConsensusStateData = _reflection.GeneratedProtocolMessageType('ConsensusStateData', (_message.Message,), {'DESCRIPTOR': _CONSENSUSSTATEDATA, '__module__': 'ibc.lightclients.solomachine.v2.solomachine_pb2'})
_sym_db.RegisterMessage(ConsensusStateData)
ConnectionStateData = _reflection.GeneratedProtocolMessageType('ConnectionStateData', (_message.Message,), {'DESCRIPTOR': _CONNECTIONSTATEDATA, '__module__': 'ibc.lightclients.solomachine.v2.solomachine_pb2'})
_sym_db.RegisterMessage(ConnectionStateData)
ChannelStateData = _reflection.GeneratedProtocolMessageType('ChannelStateData', (_message.Message,), {'DESCRIPTOR': _CHANNELSTATEDATA, '__module__': 'ibc.lightclients.solomachine.v2.solomachine_pb2'})
_sym_db.RegisterMessage(ChannelStateData)
PacketCommitmentData = _reflection.GeneratedProtocolMessageType('PacketCommitmentData', (_message.Message,), {'DESCRIPTOR': _PACKETCOMMITMENTDATA, '__module__': 'ibc.lightclients.solomachine.v2.solomachine_pb2'})
_sym_db.RegisterMessage(PacketCommitmentData)
PacketAcknowledgementData = _reflection.GeneratedProtocolMessageType('PacketAcknowledgementData', (_message.Message,), {'DESCRIPTOR': _PACKETACKNOWLEDGEMENTDATA, '__module__': 'ibc.lightclients.solomachine.v2.solomachine_pb2'})
_sym_db.RegisterMessage(PacketAcknowledgementData)
PacketReceiptAbsenceData = _reflection.GeneratedProtocolMessageType('PacketReceiptAbsenceData', (_message.Message,), {'DESCRIPTOR': _PACKETRECEIPTABSENCEDATA, '__module__': 'ibc.lightclients.solomachine.v2.solomachine_pb2'})
_sym_db.RegisterMessage(PacketReceiptAbsenceData)
NextSequenceRecvData = _reflection.GeneratedProtocolMessageType('NextSequenceRecvData', (_message.Message,), {'DESCRIPTOR': _NEXTSEQUENCERECVDATA, '__module__': 'ibc.lightclients.solomachine.v2.solomachine_pb2'})
