...
QueryAccountAddressByIDRequest = _reflection.GeneratedProtocolMessageType('QueryAccountAddressByIDRequest', (_message.Message,), {'DESCRIPTOR': _QUERYACCOUNTADDRESSBYIDREQUEST, '__module__': 'cosmos.auth.v1beta1.query_pb2'})
_sym_db.RegisterMessage(QueryAccountAddressByIDRequest)
QueryAccountAddressByIDResponse = _reflection.GeneratedProtocolMessageType('QueryAccountAddressByIDResponse', (_message.Message,), {'DESCRIPTOR': _QUERYACCOUNTADDRESSBYIDRESPONSE, '__module__': 'cosmos.auth.v1beta1.query_pb2'})
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _QUERYACCOUNTADDRESSBYIDREQUEST._serialized_start = 1123
    _QUERYACCOUNTADDRESSBYIDREQUEST._serialized_end = 1167
    _QUERYACCOUNTADDRESSBYIDRESPONSE._serialized_start = 1169
    _QUERYACCOUNTADDRESSBYIDRESPONSE._serialized_end = 1253
    _QUERY._serialized_start = 1256
    _QUERY._serialized_end = 2520