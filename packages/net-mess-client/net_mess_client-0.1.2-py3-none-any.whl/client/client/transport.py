...
class ClientTransport(threading.Thread, QObject):
    ...
    def connection_init(self, port, ip):
        ...
        LOG.debug('Запуск диалогового окна авторизации.')
        ...
        LOG.debug(f'Хэш пароля готов: {passwd_hash_string}')
        ...
        with socket_lock:
            ...
            LOG.debug(f'Сообщение о присутствии = {presense}')
        try:
            ...
            LOG.debug(f'Ошибка соединения.', exc_info=err)
