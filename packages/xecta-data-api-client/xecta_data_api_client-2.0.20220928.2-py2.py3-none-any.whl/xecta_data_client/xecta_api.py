...
from openapi_client.api.formation_property_api import WellboreFormationApi
from openapi_client.api.deviation_survey_api import DeviationSurveyApi
from openapi_client.api.tubing_api import WellboreTubingApi
from openapi_client.api.casing_api import WellboreCasingApi
...
class XectaApi:
    ...
    class XectaApiClient:
        ...
        def wellbore_formation_api(self) -> WellboreFormationApi:
            with ApiClient(self._configuration) as api_client:
                return WellboreFormationApi(api_client)

        def deviation_survey_api(self) -> DeviationSurveyApi:
            with ApiClient(self._configuration) as api_client:
                return DeviationSurveyApi(api_client)

        def wellbore_tubing_api(self) -> WellboreTubingApi:
            with ApiClient(self._configuration) as api_client:
                return WellboreTubingApi(api_client)

        def wellbore_casing_api(self) -> WellboreCasingApi:
            with ApiClient(self._configuration) as api_client:
                return WellboreCasingApi(api_client)
