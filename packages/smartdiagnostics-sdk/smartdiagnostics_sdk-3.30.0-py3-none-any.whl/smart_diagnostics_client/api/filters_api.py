...
class FiltersApi(object):
    ...
    def get_indicator_filters(self, **kwargs):  # noqa: E501
        ...
        :param str order_by: Allows sorting response items by multiple fields. Sortable properties: | Field name | Type | | ---------- | ---- | | `LocationName` | String | | `Name` | String | | `SortOrder` | Int32 | | `SystemName` | String |
