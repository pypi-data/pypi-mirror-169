...
class AssetsApi(object):
    ...
    def get_asset_classification_categories(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str filter: Filter statements to narrow results by properties. Filterable properties:  | Field name | Type | Operators | | ---------- | ---- | --------- | | `Active` | Boolean | `eq, neq` | | `TypeCode` | String | `eq, neq, in, like, isnull, isnotnull` | | `TypeId` | Int32 | `eq, neq, in, lt, gt, leq, geq` | | `TypeName` | String | `eq, neq, in, like, isnull, isnotnull` | | `Code` | String | `eq, neq, in, like, isnull, isnotnull` | | `Id` | Int32 | `eq, neq, in, lt, gt, leq, geq` | | `Name` | String | `eq, neq, in, like, isnull, isnotnull` | | `ParentCategory` | AssetCategoryParentChild | `isnull, isnotnull` | | `AssetCategoryParentCode` | String | `eq, neq, in, like, isnull, isnotnull` | | `AssetCategoryParentId` | Int32 | `eq, neq, in, lt, gt, leq, geq` | | `AssetCategoryParentName` | String | `eq, neq, in, like, isnull, isnotnull` | | `AssetCategoryParentShortName` | String | `eq, neq, in, like, isnull, isnotnull` |
    ...
    def get_assets(self, **kwargs):  # noqa: E501
        ...
        :param bool include_analytics_models: Determines whether to include the Analytics Model with the asset
        :param str filter: Filter statements to narrow results by properties. Filterable properties:  | Field name | Type | Operators | | ---------- | ---- | --------- | | `Abbreviation` | String | `eq, neq, in, like, isnull, isnotnull` | | `Active` | Boolean | `eq, neq` | | `AnalyticsModelCount` | Int32 | `eq, neq, in, lt, gt, leq, geq` | | `AnalyticsModelId` | Guid | `eq, neq, in` | | `AnalyticsModelName` | String | `eq, neq, in, like, isnull, isnotnull` | | `Category` | AssetCategoryChild | `isnull, isnotnull` | | `CategoryCode` | String | `eq, neq, in, like, isnull, isnotnull` | | `CategoryId` | Int32 | `eq, neq, in, lt, gt, leq, geq` | | `CategoryName` | String | `eq, neq, in, like, isnull, isnotnull` | | `CategoryShortName` | String | `eq, neq, in, like, isnull, isnotnull` | | `CorporationAbbreviation` | String | `eq, neq, in, like, isnull, isnotnull` | | `CorporationId` | Guid | `eq, neq, in` | | `CorporationName` | String | `eq, neq, in, like, isnull, isnotnull` | | `Created` | DateTime | `eq, neq, in, lt, gt, leq, geq` | | `Criticality` | AssetCriticalityChild | `isnull, isnotnull` | | `CriticalityId` | Int32 | `eq, neq, in, lt, gt, leq, geq` | | `CriticalityName` | String | `eq, neq, in, like, isnull, isnotnull` | | `HasWatchlistTicket` | Boolean | `eq, neq` | | `IsOperatorView` | Boolean | `eq, neq` | | `IsPaused` | Boolean | `eq, neq` | | `LocationAbbreviation` | String | `eq, neq, in, like, isnull, isnotnull` | | `LocationId` | Guid | `eq, neq, in` | | `LocationName` | String | `eq, neq, in, like, isnull, isnotnull` | | `Manufacturer` | String | `eq, neq, in, like, isnull, isnotnull` | | `ModelName` | String | `eq, neq, in, like, isnull, isnotnull` | | `Name` | String | `eq, neq, in, like, isnull, isnotnull` | | `NodeId` | Int32 | `eq, neq, in, lt, gt, leq, geq` | | `NodeSerialNumber` | String | `eq, neq, in, like, isnull, isnotnull` | | `Size` | AssetSizeChild | `isnull, isnotnull` | | `SizeCode` | String | `eq, neq, in, like, isnull, isnotnull` | | `SizeId` | Int32 | `eq, neq, in, lt, gt, leq, geq` | | `SizeName` | String | `eq, neq, in, like, isnull, isnotnull` | | `Supplier` | String | `eq, neq, in, like, isnull, isnotnull` | | `TagId` | Guid | `eq, neq, in` | | `TagName` | String | `eq, neq, in, like, isnull, isnotnull` | | `Type` | AssetTypeChild | `isnull, isnotnull` | | `TypeCode` | String | `eq, neq, in, like, isnull, isnotnull` | | `TypeId` | Int32 | `eq, neq, in, lt, gt, leq, geq` | | `TypeName` | String | `eq, neq, in, like, isnull, isnotnull` |
        :param int page: Results page. 1-based (1 returns the first page, 0 is invalid).
        :param int page_limit: Number of items to return per page.
