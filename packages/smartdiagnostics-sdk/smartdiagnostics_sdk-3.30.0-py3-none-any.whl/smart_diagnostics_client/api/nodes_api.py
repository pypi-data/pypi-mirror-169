...
class NodesApi(object):
    ...
    def export_nodes(self, **kwargs):  # noqa: E501
        ...
        :param str filter: Filter statements to narrow results by properties. Filterable properties:  | Field name | Type | Operators | | ---------- | ---- | --------- | | `Active` | Boolean | `eq, neq` | | `BaseStation` | BaseStationNodeChild | `isnull, isnotnull` | | `BaseStationReceiverSerialNumber` | String | `eq, neq, in, like, isnull, isnotnull` | | `CurrentCollector` | CollectorNodeChild | `isnull, isnotnull` | | `BaseStationId` | Int64 | `eq, neq, in, lt, gt, leq, geq` | | `BaseStationName` | String | `eq, neq, in, like, isnull, isnotnull` | | `BaseStationSerialNumber` | String | `eq, neq, in, like, isnull, isnotnull` | | `CorporationAbbreviation` | String | `eq, neq, in, like, isnull, isnotnull` | | `CorporationId` | Guid | `eq, neq, in` | | `CorporationName` | String | `eq, neq, in, like, isnull, isnotnull` | | `FirmwareVersion` | String | `eq, neq, in, like, isnull, isnotnull` | | `LocationAbbreviation` | String | `eq, neq, in, like, isnull, isnotnull` | | `LocationId` | Guid | `eq, neq, in` | | `LocationName` | String | `eq, neq, in, like, isnull, isnotnull` | | `Nickname` | String | `eq, neq, in, like, isnull, isnotnull` | | `NodeTypeCode` | NodeTypeCodes | `eq, neq, in` | | `Repeater` | RepeaterNodeChild | `isnull, isnotnull` | | `RepeaterId` | Int64 | `eq, neq, in, lt, gt, leq, geq` | | `RepeaterName` | String | `eq, neq, in, like, isnull, isnotnull` | | `RepeaterSerialNumber` | String | `eq, neq, in, like, isnull, isnotnull` | | `SerialNumber` | String | `eq, neq, in, like, isnull, isnotnull` |
