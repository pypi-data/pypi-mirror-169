import{e as t,c as e,I as o,W as i,E as s,r as a,b as r,d as n,p as l,n as c,s as d,y as p}from"./index-0718df31.js";import{g as h}from"./c.8f86cda9.js";import"./c.644c7642.js";import{E as m,c as u,o as w}from"./c.f4500ca6.js";import{W as _,s as g,a as v}from"./c.1b7fdd9b.js";import{o as b}from"./c.c1f0f00b.js";import{g as f,a as $,e as y}from"./c.dd6ca16a.js";class k{constructor(t){this.Y=t}disconnect(){this.Y=void 0}reconnect(t){this.Y=t}deref(){return this.Y}}class C{constructor(){this.Z=void 0,this.q=void 0}get(){return this.Z}pause(){var t;null!==(t=this.Z)&&void 0!==t||(this.Z=new Promise((t=>this.q=t)))}resume(){var t;null===(t=this.q)||void 0===t||t.call(this),this.Z=this.q=void 0}}const S=t=>!i(t)&&"function"==typeof t.then;const P=t(class extends e{constructor(){super(...arguments),this._$Cwt=1073741823,this._$Cyt=[],this._$CK=new k(this),this._$CX=new C}render(...t){var e;return null!==(e=t.find((t=>!S(t))))&&void 0!==e?e:o}update(t,e){const i=this._$Cyt;let s=i.length;this._$Cyt=e;const a=this._$CK,r=this._$CX;this.isConnected||this.disconnected();for(let t=0;t<e.length&&!(t>this._$Cwt);t++){const o=e[t];if(!S(o))return this._$Cwt=t,o;t<s&&o===i[t]||(this._$Cwt=1073741823,s=0,Promise.resolve(o).then((async t=>{for(;r.get();)await r.get();const e=a.deref();if(void 0!==e){const i=e._$Cyt.indexOf(o);i>-1&&i<e._$Cwt&&(e._$Cwt=i,e.setValue(t))}})))}return o}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}}),x=(t,e)=>{import("./c.6846b8bb.js");const o=document.createElement("esphome-compile-dialog");o.configuration=t,o.downloadFactoryFirmware=e,document.body.append(o)},W=async(t,e)=>{let o;if(import("./c.0b7cdde8.js"),t.port)o=new m(t.port,console);else try{o=await u(console)}catch(o){return void("NotFoundError"===o.name?w((()=>W(t,e))):alert(`Unable to connect: ${o.message}`))}e&&e();const i=document.createElement("esphome-install-web-dialog");i.params=t,i.esploader=o,document.body.append(i)};let E=class extends d{constructor(){super(...arguments),this._ethernet=!1,this._state="pick_option"}render(){let t,e;return"pick_option"===this._state?(t=`How do you want to install ${this.configuration} on your device?`,e=p`
        <mwc-list-item
          twoline
          hasMeta
          .port=${"OTA"}
