...
from novaquery.version import VERSION
...
if __name__ == "__main__":
  ...
  parser = argparse.ArgumentParser(description='novaquery setup', allow_abbrev=False)
  ...
  setup(
    ...
    description = 'A tool to query OpenStack nova for servers, using a json-friendly syntax',
    long_description = README,
    long_description_content_type = 'text/markdown',
    author = 'Carlos A.',             
    author_email = 'caralla@upv.es',  
    url = 'https://github.com/dealfonso/novaquery',
