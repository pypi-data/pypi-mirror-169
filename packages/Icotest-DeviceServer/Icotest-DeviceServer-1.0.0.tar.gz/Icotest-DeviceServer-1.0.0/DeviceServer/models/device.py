...
class Device(object):
    ...
    def __init__(self, device_id=None, device_index=None, description=None, type=None, port_count=None, local_vars_configuration=None):  # noqa: E501
    ...
    def port_count(self, port_count):
        ...
        :type: int
        """
        if self.local_vars_configuration.client_side_validation and port_count is None:  # noqa: E501
            raise ValueError("Invalid value for `port_count`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
        ...
        if (self.local_vars_configuration.client_side_validation and
                port_count is not None and port_count < 1):  # noqa: E501
            raise ValueError("Invalid value for `port_count`, must be a value greater than or equal to `1`")  # noqa: E501
