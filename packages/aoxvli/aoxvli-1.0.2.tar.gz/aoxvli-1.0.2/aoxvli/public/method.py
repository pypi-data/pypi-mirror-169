...
class PubMeth:
    ...
    @staticmethod
    def plot_energies(energies_list_in, fig_size=(7, 5), y_range=[-2000, 2000], line_type='k-', figuretitle='title', x_label_pos=[], x_labs=[], save_or_not=True, show=False, save_title='band', lw=2, hold_on=False, y_label="E(meV)", test_mode=False, selected_bds_indices=[], fig_format='.svg'):
