...
class tablerow:
    ...
    def __init__(self, table=None, columnnames=[  ], exclude=False, *args, **kwargs):
        ...
        if self._swigobj is None:
            self._swigobj = _tablerow(_pc.document['table']._swigobj if hasattr(_pc.document['table'],'_swigobj') else _pc.document['table'], _str_ec(_pc.document['columnnames']), _pc.document['exclude'])
    ...
    def _get(self, rownr):
        ...
        """
        return _dict_dc(self._swigobj._get(rownr))

    def get(self, rownr):
        """get a single row specified by rownr
        
        """
        return _dict_dc(self._swigobj.get(rownr))

    def _put(self, rownr, value, matchingfields=True):
        """put a single row specified by rownr
        
        """
        return self._swigobj._put(rownr, _dict_ec(value), matchingfields)

    def put(self, rownr, value, matchingfields=True):
        """put a single row specified by rownr
        
        """
        return self._swigobj.put(rownr, _dict_ec(value), matchingfields)
    ...
    def __getitem__(self, rownr=None):
        ...
        """
        return _any_dc(self._swigobj.__getitem__(_any_ec(rownr)))
