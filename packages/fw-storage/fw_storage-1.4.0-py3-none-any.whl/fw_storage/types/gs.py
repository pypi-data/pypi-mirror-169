...
# TODO enable passing **envdict and move to utils
@contextlib.contextmanager
def TemporaryEnv():
    """Context to set process environment variables temporarily."""
