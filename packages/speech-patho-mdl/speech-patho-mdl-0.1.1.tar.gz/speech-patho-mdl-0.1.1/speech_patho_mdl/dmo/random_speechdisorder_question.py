...
# -*- coding: UTF-8 -*-
# type: ignore
""" Handle a Request for a Random Speech Disorder Question """
...
from speech_patho_mdl.dto import random_speech_disorder_question
...
class RandomSpeechDisorderQuestion(BaseObject):
    ...
    def process(self) -> ServiceEvent:
        ...
        random_question = random_speech_disorder_question()
        if self.isEnabledForDebug:
            Enforcer.is_str(random_question)

        output_text = f"answer a speech disorder question: {random_question}"
