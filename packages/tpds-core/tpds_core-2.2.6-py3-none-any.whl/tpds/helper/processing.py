...
import enum
import subprocess
from typing import Sequence, Literal, Tuple, Union, Any, List
...
class ProcessingUtils():
    ...
    def start(self, cmd: Sequence[str], err_handling: __allowed_handling = ErrorHandling.DISCARD,
                log_args: bool = True, **kwargs: Any) -> subprocess.Popen[Any]:
        """
    ...
    def wait(self, process: subprocess.Popen[Any], timeout: Union[int, None] = None) -> Tuple[str, int]:
        """
