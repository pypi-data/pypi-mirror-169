...
from typing import MutableSequence, MutableMapping, Any, Callable, Iterable, Sequence, Union, T, KT, VT, VT_co, T_co, Iterator
...
class TpdsSettings(TpdsSettingsDict[str, Any]):
    ...
    def __new__(cls, home_path: Union[str, 'os.PathLike[str]', None] = None,
                config: Union[str, 'os.PathLike[str]', None] = None,
                validator: Union[SettingsValidator, None] = None, **kwargs: str) -> Any:
        """
    ...
    def __init__(self, home_path: Union[str, 'os.PathLike[str]', None] = None,
                config: Union[str, 'os.PathLike[str]', None] = None, **kwargs: str) -> None:
        """
...
class TrustPlatformSettings():
    ...
    def __init__(self, file_name: Union[str, 'os.PathLike[str]', None] = None,
                values: Union[dict[str, Any], None] = None,
                log_enable: bool = True) -> None:
        if not log_enable:
