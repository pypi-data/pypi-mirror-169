...
class SettingsValidator():
    ...
    def validated(self, config: Union[str, dict[str, Any], 'os.PathLike[str]'],
                  debug: bool = False) -> Union[dict[str, Any], None]:
        """
    ...
    def validate(self, config: Union[str, dict[str, Any], 'os.PathLike[str]'],
