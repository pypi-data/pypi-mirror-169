...
class Thread(models.Model):
    ...
    has_enroll = models.IntegerField(verbose_name='有报名', default=False, help_text='', choices=((1, "是"), (0, "否")))
    has_fee = models.IntegerField(verbose_name='有小费', default=False, help_text='', choices=((1, "是"), (0, "否")))
    has_comment = models.IntegerField(verbose_name='有评论', default=True, help_text='', choices=((1, "是"), (0, "否")))
