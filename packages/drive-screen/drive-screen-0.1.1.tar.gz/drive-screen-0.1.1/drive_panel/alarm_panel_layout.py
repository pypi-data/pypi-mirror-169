                ...
                [
                    ...
                    dbc.ModalBody(
                        [
                           ...
                           html.P("请输入每隔多少秒刷新一次" ,style={'padding': '20px 0px 0px 0px'}),
...
def alarm_panel_layout_fun(Api_Host, width = 5, height = 800):
    '''
    ...
    if width>=4:
        ...
        card = dbc.Col(
                    dbc.Container([
                        ...
                        dbc.Button(id = 'tips_button',href=Api_Host+'/alert/list/', outline=True, color="success", className="me-1",style={"margin-left": "5px"}),
                        html.Br(),
                        dbc.Toast(
                            dbc.Container([
         ...
         card = dbc.Col(
                    dbc.Container([
                        ...
                        dbc.Row(
                            dbc.Col(
                                dbc.Button(id = 'tips_button',href=Api_Host+'/alert/list/', outline=True, color="success", className="me-1"),
                            ),
