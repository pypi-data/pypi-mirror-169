...
from drive_panel.alarm_api import *
from drive_panel.style import button_style_full,modal_info_style
import datetime
...
class  DriveAlarmPanel(object):
    ...
    def screen_msgiv1(self,data,create_time, feedback_key):
        ...
        #             dbc.Button(
        #                 button_cn_map[name],
        #                 href=SERVER_HOST + additional_functions_mapping.get(name) + feedback_key,
        #                 outline=True, color="secondary", className="me-1"
        #             )
        #         )
        #     ans_button.append(
        #         html.P(buttons, className="lead")
        #     )
            
        # if data.get("status"):
        #     status_button = []
        #     for name in data.get("status"):
            ...
            card = [dbc.Toast(
                        dbc.Row([
                            dbc.Col(
                                ...
                                #     style={"overflow-x": "scroll",'margin-right': '0px', 'margin-left': '0px'}   
                                # ),
                                ans_table,
                                width=9,
