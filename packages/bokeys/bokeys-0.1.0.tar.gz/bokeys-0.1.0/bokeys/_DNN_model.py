...
import numpy as np
import pandas as pd
from _dnn_torch_utils import Meter, MyDataset, EarlyStopping, MyDNN, collate_fn, set_random_seed
...
from _splitdater import split_dataset
from _feature_create  import create_des
warnings.filterwarnings('ignore')
torch.backends.cudnn.enabled = True
torch.backends.cudnn.benchmark = True
set_random_seed(seed=43)
torch.set_num_threads(48)
def get_split_index(X, Y,split_type='random',random =20):
