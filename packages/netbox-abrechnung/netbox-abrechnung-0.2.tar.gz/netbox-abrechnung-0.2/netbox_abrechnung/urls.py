...
# LeistungsscheinDevice    
 ...
 #   path('sladevice/edit/', views.DeviceBulkEditView.as_view(), name='sladevice/bulk_edit'),
 #   path('sladevice/delete/', views.DeviceBulkDeleteView.as_view(), name='sladevice/bulk_delete'),
 #   path("sladevice/import/", views.DeviceBulkImportView.as_view(), name="sladevice/import"),
