...
[**post_device_pair**](DevicesApi.md#post_device_pair) | **POST** /devices/{device_id}/pair | POST device pair
...
# **get_devices**
> list[Device] get_devices(controller_id=controller_id, device_id=device_id, device_type=device_type, status=status, serial_no=serial_no, management_status=management_status)
...
with icotest_voice.ApiClient() as api_client:
    ...
    try:
        # GET devices
        api_response = api_instance.get_devices(controller_id=controller_id, device_id=device_id, device_type=device_type, status=status, serial_no=serial_no, management_status=management_status)
        pprint(api_response)
    except ApiException as e:
...
with icotest_voice.ApiClient() as api_client:
    # Create an instance of the API class
    api_instance = icotest_voice.DevicesApi(api_client)
    device_id = "5ad25725-8be0-489d-9b26-c0299a76e136"  # (str): the unique id of the device
...
> str post_device_make_call(device_id, call_type, phone_number, call_duration=call_duration, outgoing_recording_file=outgoing_recording_file, playback_file=playback_file)
...
with icotest_voice.ApiClient() as api_client:
    ...
    playback_file = "AudioPlayback.wav"  # (str): the filename of the playback file (optional)

    try:
        # POST make call
        api_response = api_instance.post_device_make_call(device_id, call_type, phone_number, call_duration=call_duration, outgoing_recording_file=outgoing_recording_file, playback_file=playback_file)
        pprint(api_response)
    except ApiException as e:
...
# **post_device_pair**
> str post_device_pair(device_id, channel_number=channel_number)

POST device pair

Post request to perform pairing with a channel number
...
with icotest_voice.ApiClient() as api_client:
    ...
    api_instance = icotest_voice.DevicesApi(api_client)
    device_id = "bc331ccb-5841-44ec-9d32-4f4fe0c3c16c"  # (str): the unique id of the device
channel_number = 3.4  # (float): the number of the channel (0-9) (optional)

    try:
        # POST device pair
        api_response = api_instance.post_device_pair(device_id, channel_number=channel_number)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DevicesApi->post_device_pair: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **device_id** | [**str**](.md)| the unique id of the device | 
 **channel_number** | **float**| the number of the channel (0-9) | [optional] 
...
with icotest_voice.ApiClient() as api_client:
    ...
    api_instance = icotest_voice.DevicesApi(api_client)
    device_id = "bc331ccb-5841-44ec-9d32-4f4fe0c3c16c"  # (str): the unique id of the device
channel_number = 3.4  # (float): the number of the channel (optional)
pin_code = 1234  # (float): the pin code (optional)
...
------------- | ------------- | ------------- | -------------
 **device_id** | [**str**](.md)| the unique id of the device | 
 **channel_number** | **float**| the number of the channel | [optional] 
 **pin_code** | **float**| the pin code | [optional] 
...
> str post_devices_receive_call(device_id, ring_count=ring_count, call_duration=call_duration, incoming_recording_file=incoming_recording_file, playback_file=playback_file)
...
with icotest_voice.ApiClient() as api_client:
    ...
    try:
        # POST receive call
        api_response = api_instance.post_devices_receive_call(device_id, ring_count=ring_count, call_duration=call_duration, incoming_recording_file=incoming_recording_file, playback_file=playback_file)
        pprint(api_response)
    except ApiException as e:
...
with icotest_voice.ApiClient() as api_client:
    ...
    api_instance = icotest_voice.DevicesApi(api_client)
    device = {
        "device_id": "bc331ccb-5841-44ec-9d32-4f4fe0c3c16c",
        ...
        "controller_id": "cc331ccb-5841-44ec-9d32-4f4fe0c3c16c",
        "device_status": {},
        "callback_port": 0,
        "management_status":true
    }  # (Device): the model of a device (optional)
...
with icotest_voice.ApiClient() as api_client:
    ...
    body = {
        "battery_level": 4,
        "date_generated": "2021-02-18T11:21:33.839384",
        "handset_number": 4,
        "registration_status": 1,
        "rfpi": "030B469EC8",
        "signal_level": "98",
        "software_version": "SW:4.0.19.1,EEP:2.0,ATE:2.0.0"
    }  # (object): The model of a device (optional)
