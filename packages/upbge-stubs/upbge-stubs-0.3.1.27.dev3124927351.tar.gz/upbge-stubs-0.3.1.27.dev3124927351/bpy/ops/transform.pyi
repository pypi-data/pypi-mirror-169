...
def edge_bevelweight(value: float = 0.0, snap: bool = False, snap_elements: typing.Set[str] = {'INCREMENT'}, use_snap_project: bool = False, snap_target: str = 'CLOSEST', use_snap_self: bool = True, use_snap_edit: bool = True, use_snap_nonedit: bool = True, use_snap_selectable_only: bool = False, use_snap_to_same_target: bool = False, snap_face_nearest_steps: int = 1, snap_point: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), snap_align: bool = False, snap_normal: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), release_confirm: bool = False, use_accurate: bool = False) -> None:
...
def seq_slide(value: typing.Tuple[float, float] = (0.0, 0.0), orient_axis_ortho: str = 'X', snap: bool = False, snap_elements: typing.Set[str] = {'INCREMENT'}, use_snap_project: bool = False, snap_target: str = 'CLOSEST', use_snap_self: bool = True, use_snap_edit: bool = True, use_snap_nonedit: bool = True, use_snap_selectable_only: bool = False, use_snap_to_same_target: bool = False, snap_face_nearest_steps: int = 1, snap_point: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), snap_align: bool = False, snap_normal: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), view2d_edge_pan: bool = False, release_confirm: bool = False, use_accurate: bool = False) -> None:
...
def vert_crease(value: float = 0.0, snap: bool = False, snap_elements: typing.Set[str] = {'INCREMENT'}, use_snap_project: bool = False, snap_target: str = 'CLOSEST', use_snap_self: bool = True, use_snap_edit: bool = True, use_snap_nonedit: bool = True, use_snap_selectable_only: bool = False, use_snap_to_same_target: bool = False, snap_face_nearest_steps: int = 1, snap_point: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), snap_align: bool = False, snap_normal: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), release_confirm: bool = False, use_accurate: bool = False) -> None:
