...
class TestEnv(BaseModel):
    ...
    # slice_expire_*: optional during init and if not slice based
    slice_expire_assumed: Optional[datetime]  # assumed = known indirectly
    slice_expire_confirmed: Optional[datetime]  # confirmed = known directly from wall
