...
class ProcessCodeTask:
    ...
    def execute(self, evalFunction):
        ...
        context = ProcessCodeContext(lambda message, cause: allErrors.append(
            ...
            try:
                for line in codeGenRequest:
                    ...
                    if not headerSeen:
                        ...
                        ProcessCodeTask._prepareContextForHookCall(context, True, None, None, -1)
                ...
                if headerSeen:
                    ProcessCodeTask._prepareContextForHookCall(context, False, None, None, -1)
    ...
    def _processFileOfAugCodes(context, evalFunction,
        ...
        try:
            ...
            try:
                ProcessCodeTask._prepareContextForHookCall(context, False, srcFile, fileAugCodes, -1)
