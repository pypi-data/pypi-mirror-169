...
echo $dev_mounts >> /etc/ecs/dev_mount_file.out
echo -e "o\\ny" | mdadm --create --verbose --force --auto=yes /dev/md0 --level=0 --raid-devices=2 $dev_mounts >> /etc/ecs/dev_mount.out
mkfs.ext4 /dev/md0
mkdir /ssd
echo /dev/md0 /ssd ext4 defaults 0 0 >> /etc/fstab
mount /dev/md0 /ssd
                '''
