...
from typing import Protocol, Union, AsyncIterable, List, Awaitable, AsyncGenerator, Any, Tuple, Callable, Iterable
...
class JPTest:
    ...
    def __init__(self, name: str = None, max_score: Union[float, int] = None, timeout: int = 120,
        ...
        self.name: str = name
        self.max_score: float = float(max_score) if max_score is not None else None
