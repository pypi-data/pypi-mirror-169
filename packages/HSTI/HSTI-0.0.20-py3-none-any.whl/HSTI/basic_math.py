...
#Subtracts the mean from the data, either the mean of each spectrum (axis = 's')
...
def array2rgb(three_layer_cube):
    three_layer_cube[:,:,0] = three_layer_cube[:,:,0] - np.min(three_layer_cube[:,:,0])
    three_layer_cube[:,:,0] = three_layer_cube[:,:,0]/np.max(three_layer_cube[:,:,0])
    three_layer_cube[:,:,1] = three_layer_cube[:,:,1] - np.min(three_layer_cube[:,:,1])
    three_layer_cube[:,:,1] = three_layer_cube[:,:,1]/np.max(three_layer_cube[:,:,1])
    three_layer_cube[:,:,2] = three_layer_cube[:,:,2] - np.min(three_layer_cube[:,:,2])
