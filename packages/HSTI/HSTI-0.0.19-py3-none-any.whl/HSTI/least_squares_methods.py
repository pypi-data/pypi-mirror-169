...
### hypertools closure:     # self.spectra[j,:] = fnnls(self.contributions.T@self.contributions, self.contributions.T@self.X[:,j])[0] #Taken from hypertools
    def calculate_ALS_from_spectrum(self, matrix, spectra, closure = False, nonnegativity_c = False, nonnegativity_s = False, unimodality_s = False, thresh = 1e-8, max_it = 50):
