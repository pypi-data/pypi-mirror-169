...
from textractor.utils.geometry_util import flatten, get_indices
...
from textractor.utils.search_utils import get_word_similarity, get_metadata_attr_name
...
class Table(DocumentEntity):
    ...
    def get_table_range(self):
        ...
        return max(list(self._get_table_cells().keys())), max(
            list(self._get_table_cells(row_wise=False, column_wise=True).keys())
        )
    ...
    def export_as_excel(self, filepath=None, workbook=None, save_workbook=True):
        """
