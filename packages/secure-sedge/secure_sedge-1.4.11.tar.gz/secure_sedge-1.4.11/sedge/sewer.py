...
@task
def install_cert_on_windows(ctx, bucket, key, profile, pfx_password=None):
    """
    ...
    e = {}
    if pfx_password:
        password = f"-password (ConvertTo-SecureString -f -a $env:SEDGE_PASSWORD)"
