...
#                     return pd.DataFrame(columns=results)
    ...
    async def get_layout_metadata(self, layout_name):
        ...
        parsed_layout_metadata['miniLayoutDict'] = dict(layout_metadata['miniLayout'][0])
        parsed_layout_metadata['layoutSectionsDataFrame'] = parse_layoutSections(layout_metadata['layoutSections'][0])
        parsed_layout_metadata['platformActionListDataFrame'] = parse_platformActionList(layout_metadata['platformActionList'][0])
        parsed_layout_metadata['quickActionListDataFrame'] = parse_quickActionList(layout_metadata['quickActionList'][0])
        parsed_layout_metadata['relatedListDataFrame'] = pd.DataFrame(layout_metadata['relatedLists'][0])
