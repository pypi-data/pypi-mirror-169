...
class TestZohoAPIConfig:
    def test_api_base_url(self):
        assert ZohoAPIConfig().api_base_url == "https://https://www.zohoapis.eu/crm/v3/"
...
class TestZohoClient:
    ...
    def test__get_page_without_next_url(
        ...
        requests_mock.get(
            "https://https//www.zohoapis.eu/crm/v3/testmodule", json=fake_response
        )
    ...
    def test__get_page_with_next_url(
        ...
        zoho_client._request_headers = {"authorization": "fake"}
        requests_mock.get(
            "https://https//www.zohoapis.eu/crm/v3/testmodule",
            json={
