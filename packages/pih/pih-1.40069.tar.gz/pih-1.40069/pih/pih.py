    ...
    class MESSAGE:
        ...
        class COMMAND:
            ...
            def service_started(role: ServiceRoles) -> bool:
                service_role_value: ServiceRoleValue = role.value
                return PIH.log_command(LogCommands.SERVICE_STARTED, (role.name, service_role_value.description, service_role_value.host, service_role_value.port, service_role_value.pid, service_role_value.ppid))
