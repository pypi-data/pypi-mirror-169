...
class PIH:
    ...
    class UPDATER:
        ...
        @staticmethod
        def update_for_role(value: ServiceRoles, show_output: bool = False) -> bool:
            ...
            remote_executor_command_list: List[str] = PIH.PSTOOLS.create_remote_executor_for_service_role_value(
                service_role_value, False, False)
            command_list: List[str] = remote_executor_command_list + \
                PIH.UPDATER.get_updater_command_list()
            process_result: CompletedProcess[str] = PIH.PSTOOLS.run_command(
    ...
    class PSTOOLS:
        ...
        @staticmethod
        def run_command(command_list: List[str], show_output: bool) -> CompletedProcess[str]:
            if show_output:
        ...
        def telephone(format: bool = True, telephone_prefix: str = CONST.PHONE_PREFIX) -> str:
            while True:
                ...
                telephone = PIH.INPUT.input(
                    telephone_prefix if use_telephone_prefix else "")
