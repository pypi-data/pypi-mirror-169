...
class QueryLog:
    ...
    def from_dict(obj: Any) -> 'QueryLog':
        ...
        return QueryLog(id, bytes_read, bytes_written, content, duration, email, platform, rows_read, rows_written, sources, start_time, targets, type, user_id)
...
class MetadataChangeEvent:
    ...
    def from_dict(obj: Any) -> 'MetadataChangeEvent':
        ...
        query_logs = from_union([lambda x: from_list(QueryLog.from_dict, x), from_none], obj.get("queryLogs"))
    ...
    def to_dict(self) -> dict:
        ...
        result["queryLogs"] = from_union([lambda x: from_list(lambda x: to_class(QueryLog, x), x), from_none], self.query_logs)
