...
def hs300option_compare(option1,option2,loc1='best',loc2='best'):
    ...
    plot2_line2(df12,ticker1,colname1,label1, \
               df12,ticker2,colname2,label2, \
...
def fin_option_maturity_risk_sse(option,exercise,date,measure='delta',graph=True,loc1='best',loc2='best'):
    ...
    #绘图：看涨+看跌
    ticker1=option+"看涨期权"; colname1=measure; label1=measure
    ticker2=option+"看跌期权"; colname2=measure; label2=measure
    ylabeltxt="风险指标"
    ...
    plot2_line2(df9C,ticker1,colname1,label1, \
               df9P,ticker2,colname2,label2, \
               ylabeltxt,titletxt,footnote, \
               twinx=False, \
               loc1=loc1,loc2=loc2, \
               date_range=False,date_freq=False)        
