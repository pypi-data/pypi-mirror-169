...
class ReporteBase(ApiCammesa):
    ...
    def __init__(
        ...
        if (periodo is None): 
            ...
            try:
                print("Recordar: El parámetro periodo sobreescribe los parametros fecha_i y fecha_f.")
    ...
    def periodo(self,val):
        if not (val is None):
            self.fecha_i, self.fecha_f = self.__check_periodo(self,val)
