...
Welcome to `video_grabber` contributor's guide.
...
If you experience bugs or general issues with `video_grabber`, please have a look
...
You can help improve `video_grabber` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`video_grabber` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `video_grabber`'s files. While this mechanism can
...
```
conda create -n video_grabber python=3 six virtualenv pytest pytest-cov
conda activate video_grabber
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/video_grabber.git
   cd video_grabber
   ```
...
5. Install [pre-commit]:
   ...
   `video_grabber` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/video_grabber
[issue tracker]: https://github.com/<USERNAME>/video_grabber/issues
