"use strict";
(self["webpackChunkjijzeptlab_themes"] = self["webpackChunkjijzeptlab_themes"] || []).push([["lib_index_js"],{
...
const plugin = {
    ...
    autoStart: true,
    requires: [_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.IThemeManager, _jupyterlab_settingregistry__WEBPACK_IMPORTED_MODULE_1__.ISettingRegistry],
    activate: (app, manager, settingRegistry) => {
        console.log('JupyterLab extension jijzeptlab_themes is activated!');
...
//# sourceMappingURL=lib_index_js.b13e1eb23567db04dded.js.map