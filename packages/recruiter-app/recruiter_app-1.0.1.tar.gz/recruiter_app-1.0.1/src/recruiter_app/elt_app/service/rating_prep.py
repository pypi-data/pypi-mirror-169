...
class RatingEngine:
    ...
    def __init__(self, jd_name):
        ...
        self.so_skill_tag_map = get_skill_tag_map(pd.read_csv("config_files/config/so_skills_count.csv"))
        self.gh_skill_tag_map = get_skill_tag_map(pd.read_csv("config_files/config/gh_skills_count.csv"))
