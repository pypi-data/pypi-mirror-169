...
class _deconvolve:
    ...
    def __call__( self, imagename=None, startmodel=None, deconvolver=None, scales=None, smallscalebias=None, restoration=None, restoringbeam=None, niter=None, gain=None, threshold=None, nsigma=None, interactive=None, fastnoise=None, usemask=None, mask=None, pbmask=None, sidelobethreshold=None, noisethreshold=None, lownoisethreshold=None, negativethreshold=None, smoothfactor=None, minbeamfrac=None, cutthreshold=None, growiterations=None, dogrowprune=None, verbose=None ):
        ...
        _arguments = [imagename,startmodel,deconvolver,scales,smallscalebias,restoration,restoringbeam,niter,gain,threshold,nsigma,interactive,fastnoise,usemask,mask,pbmask,sidelobethreshold,noisethreshold,lownoisethreshold,negativethreshold,smoothfactor,minbeamfrac,cutthreshold,growiterations,dogrowprune,verbose]
        _invocation_parameters = OrderedDict( )
